...
describe('línea canónica vs. línea con simulaciones', () => {
  // El optimizador deja sus amortizaciones marcadas `simulacion: true` dentro
  // del préstamo. No aparecen en la lista de gastos —no son gastos— pero sí
  // movían la curva de saldo, mientras los resúmenes del dashboard las
    ...
    loans: [
      {
        ...
        amortizaciones: [
          ...
          { _id: 'opt_2030-05_l1', fecha: '2030-05-15', cantidad: 15000, simulacion: true },
        ],
      },
  ...
  it('detecta que hay simulaciones, incluso escondidas dentro de un préstamo real', () => {
    ...
    const soloAmort: Parameters<typeof haySimulaciones>[0] = {
      loans: [{ _id: 'l1', amortizaciones: [{ _id: 'opt_x', simulacion: true }] }],
      expenses: [],
      nominas: [],
      accounts: [],
    };
