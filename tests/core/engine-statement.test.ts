...
const accounts: StatementAccount[] = [
  ...
  },
  {
    ...
    saldoInicial: 10000,
    historicoSaldos: [{ fecha: '2026-01-15', saldo: 14000 }],
    aportaciones: [{ fecha: '2024-06-01', cantidad: 9000 }],
    planAportaciones: [{ _id: 'pa1', importe: 200, periodicidad: 'mensual', fechaInicio: '2026-02-10', cuentaOrigen: 'default' }],
  },
  {
    _id: 'fondo2',
    nombre: 'Indexado B',
  ...
  },
  {
    ...
    grupoNomina: 'casa',
    saldoInicial: 0,
    historicoSaldos: [{ fecha: '2026-01-01', saldo: 20000 }],
    aportaciones: [{ fecha: '2015-01-01', cantidad: 12000 }],
  },
];
...
const expenses: any[] = [
  ...
  },
  {
    ...
    tags: [],
    cuenta: 'fondo1',
    cuentaDestino: 'default',
  },
  {
    _id: 't3',
    activo: true,
    concepto: 'Rescate plan',
    cuantia: 2000,
    tipo: 'transferencia',
    tipoFrecuencia: 'extraordinario',
