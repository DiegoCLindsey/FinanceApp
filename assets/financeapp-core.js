var FinanceAppBundle=function($t){"use strict";var fc=Object.defineProperty;var vc=($t,V,G)=>V in $t?fc($t,V,{enumerable:!0,configurable:!0,writable:!0,value:G}):$t[V]=G;var ps=($t,V,G)=>vc($t,typeof V!="symbol"?V+"":V,G);function V(t){const e=t.getFullYear(),a=String(t.getMonth()+1).padStart(2,"0"),o=String(t.getDate()).padStart(2,"0");return`${e}-${a}-${o}`}function G(t){const[e,a,o]=t.split("-").map(Number);return new Date(e,a-1,o)}function Y(){return V(new Date)}function Ce(t,e){return new Date(t,e+1,0).getDate()}function ma(t,e,a){return V(new Date(t,e,Math.min(a,Ce(t,e))))}function fe(t,e,a){if(!a)return null;if(a.startsWith("dia:")){const o=a.slice(4);if(o==="ultimo")return V(new Date(t,e+1,0));const s=parseInt(o);if(!isNaN(s))return ma(t,e,s)}if(a.startsWith("nthweekday:")){const o=a.split(":"),s=parseInt(o[1]),n=parseInt(o[2]);if(s===-1){const r=new Date(t,e+1,0);for(;r.getDay()!==n;)r.setDate(r.getDate()-1);return V(r)}const i=new Date(t,e,1);for(;i.getDay()!==n;)i.setDate(i.getDate()+1);return i.setDate(i.getDate()+(s-1)*7),i.getMonth()!==e&&i.setDate(i.getDate()-7),V(i)}return null}function fa(t,e){if(!e)return t;const a=G(t);return fe(a.getFullYear(),a.getMonth(),e)??t}const ms=["domingo","lunes","martes","miércoles","jueves","viernes","sábado"],fs={"-1":"último",1:"1º",2:"2º",3:"3º",4:"4º",5:"5º"};function je(t){if(!t)return"";if(t.startsWith("dia:")){const e=t.slice(4);return e==="ultimo"?"Último día del mes":`Día ${e} del mes`}if(t.startsWith("nthweekday:")){const e=t.split(":"),a=e[1],o=parseInt(e[2]);return`${fs[a]||a+"º"} ${ms[o]} del mes`}return t}function Jt(t,e){const a=Date.UTC(t.getFullYear(),t.getMonth(),t.getDate()),o=Date.UTC(e.getFullYear(),e.getMonth(),e.getDate());return Math.round((o-a)/864e5)}function It(t){return Math.sign(t)*Math.round(Math.abs(t)*100)}function et(t){return t/100}function W(t){return et(It(t))}function j(t){return new Intl.NumberFormat("es-ES",{style:"currency",currency:"EUR"}).format(t||0)}function va(t){return(t||0).toFixed(2)+"%"}function Rt(t,e,a){const o=e/100/12;return o===0?t/a:t*o*Math.pow(1+o,a)/(Math.pow(1+o,a)-1)}function ga(t,e,a,o=0){const s=Rt(t,e,a),n=t*(1-o/100);let i=e/100/12;for(let r=0;r<200;r++){const d=s*(1-Math.pow(1+i,-a))/i-n,b=s*(a*Math.pow(1+i,-(a+1))/i-(1-Math.pow(1+i,-a))/(i*i)),u=i-d/b;if(Math.abs(u-i)<1e-10){i=u;break}i=u}return(Math.pow(1+i,12)-1)*100}function ba(t,e,a,o,s=0,n=[],i={}){const r=[];let l=t;const d=G(o),b=e/100/12;let u=a,p=Rt(l,e,u);const y=[...n].sort((I,A)=>I.fecha.localeCompare(A.fecha));let g=0;for(let I=1;I<=a*2&&l>.01;I++){const A=new Date(d);d.setMonth(d.getMonth()+1);const v=fa(V(A),i.diaPago||"");for(;g<y.length&&y[g].fecha<=v;){const $=y[g],m=$.cantidad*(s/100);if(l-=$.cantidad,l=Math.max(0,l),$.tipo==="plazo"?u=Math.ceil(-Math.log(1-l*b/p)/Math.log(1+b)):(u=a-I+1,p=Rt(l,e,u)),r.push({mes:"AMORT",fecha:$.fecha,cuota:0,interes:0,amortizacion:$.cantidad,comisionAmort:m,capitalPendiente:l,esAmortizacion:!0,simulacion:$.simulacion||!1}),g++,l<.01)break}if(l<.01)break;const h=l*b,f=Math.min(p-h,l);if(l-=f,l<.01&&(l=0),r.push({mes:I,fecha:v,cuota:p,interes:h,amortizacion:f,comisionAmort:0,capitalPendiente:l,esAmortizacion:!1,simulacion:!1}),u--,u<=0||l<.01)break}return r}const ha=new Map;function at(t){var A;const e=t.amortizaciones||[],a=`${t.capital}|${t.tin}|${t.meses}|${t.fechaInicio}|${t.comisionAmort||0}|${t.comisionApertura||0}|${t.diaPago||""}|${e.slice().sort((v,h)=>`${v.fecha}|${v.cantidad}|${v.tipo||""}`.localeCompare(`${h.fecha}|${h.cantidad}|${h.tipo||""}`)).map(v=>`${v.fecha}:${v.cantidad}:${v.tipo||""}`).join(";")}`,o=ha.get(a);if(o)return o;const{capital:s,tin:n,meses:i,fechaInicio:r,comisionAmort:l,comisionApertura:d}=t,b=ba(s,n,i,r,l||0,e,t),u=b.reduce((v,h)=>v+h.interes,0),p=b.reduce((v,h)=>v+h.comisionAmort,0),y=s*((d||0)/100),g=b.filter(v=>!v.esAmortizacion),I={cuota:Rt(s,n,i),totalIntereses:u,tae:ga(s,n,i,d||0),costoTotal:u+p+y,comAp:y,totalComAm:p,fechaFin:((A=g.slice(-1)[0])==null?void 0:A.fecha)||"",mesesReales:g.length,tabla:b};return ha.set(a,I),I}function ya(t){const e=at(t),a=at({...t,amortizaciones:[]}),o=a.totalIntereses-e.totalIntereses,s=a.mesesReales-e.mesesReales,n=e.totalComAm;return{...e,sinAmort:a,ahorroIntereses:o,ahorroTiempo:s,costeTotalAmort:n,ahorroNeto:o-n,totalPagado:t.capital+e.totalIntereses+e.comAp+e.totalComAm}}function pt(t,e,a){if(!t||t.length===0)return 1;const o=G(e),s=G(a);if(s<=o)return 1;const n=[...t].sort((l,d)=>l.year-d.year);let i=1,r=new Date(o);for(;r<s;){const l=r.getFullYear(),d=n.filter(I=>I.year<=l),b=d.length>0?d[d.length-1]:n[0],u=(b?b.tasa:0)/100,p=new Date(l+1,0,1),y=p<s?p:s,g=Jt(r,y);i*=Math.pow(1+u,g/365.25),r=y}return i}function xa(t,e,a,o=0){const s=G(e),n=G(a);if(n<=s)return o;const i=Jt(s,n),r=t?[...t].sort((b,u)=>b.year-u.year):[];let l=0,d=new Date(s);for(;d<n;){const b=d.getFullYear(),u=new Date(b+1,0,1),p=u<n?u:n,y=Jt(d,p),g=r.filter(v=>v.year<=b),I=g.length>0?g[g.length-1]:null,A=I!==null?I.tasa:o;l+=A*y,d=p}return i>0?l/i:o}function $a(t,e){return((1+t/100)/(1+e/100)-1)*100}function vs(t,e,a,o){const s=pt(e,a,o);return s>0?t/s:t}function gs(t,e){const a=e.saludUmbralAhorroVerde??20,o=e.saludUmbralAhorroAmarillo??10,s=e.saludUmbralDTIVerde??30,n=e.saludUmbralDTIAmarillo??40,i=e.saludRegla||[50,30,20],r=e.saludExcluirHipoteca||!1,{ingresos:l=0,cuotas:d=0,cuotasHipoteca:b=0,gastosBasicos:u=0,gastosOtros:p=0,amortizaciones:y=0}=t,g=l-d-y-u-p,I=g,A=l>0?I/l*100:null,v=r?d-b:d,h=l>0?v/l*100:null,f=l>0?d/l*100:null,$=l>0?(u+d+y)/l*100:null,m=l>0?p/l*100:null,x=(w,E,_)=>w===null?"neutral":w>=E?"verde":w>=_?"amarillo":"rojo",S=(w,E,_)=>w===null?"neutral":w<=E?"verde":w<=_?"amarillo":"rojo";return{ingresos:l,cuotas:d,cuotasHipoteca:b,gastosBasicos:u,gastosOtros:p,amortizaciones:y,ahorroBruto:g,ahorroReal:I,tasaAhorro:A,dti:h,dtiTotal:f,excluyeHipoteca:r,pctNecesidades:$,pctDeseos:m,semAhorro:x(A,a,o),semDTI:S(h,s,n),semNecesidades:S($,i[0],i[0]+15),semDeseos:S(m,i[1],i[1]+10),semAhorroRegla:x(A,i[2],i[2]*.5),umbralAhorroVerde:a,umbralAhorroAmarillo:o,umbralDTIVerde:s,umbralDTIAmarillo:n,regla:i}}function mt(t){return(t==null?void 0:t.modeloFondo)||(t!=null&&t.esFondoPension?"pension":"cuenta")}function rt(t){const e=[...t.historicoSaldos||[]].sort((a,o)=>o.fecha.localeCompare(a.fecha));return e.length>0?e[0].saldo:t.saldoInicial||0}function Wt(t,e){const a=t.fechaInicialSaldo||"";if(!a||e>=a){const o=[];a&&o.push({fecha:a,saldo:t.saldoInicial||0,prioridad:-1}),(t.historicoSaldos||[]).forEach((n,i)=>{n.fecha>=a&&o.push({...n,prioridad:i})}),o.sort((n,i)=>i.fecha.localeCompare(n.fecha)||i.prioridad-n.prioridad);const s=o.find(n=>n.fecha<=e);return s?s.saldo:t.saldoInicial||0}else{const s=[...t.historicoSaldos||[]].sort((n,i)=>i.fecha.localeCompare(n.fecha)).find(n=>n.fecha<=e);return s?s.saldo:0}}function Ee(t,e){const a=t.cuentaIds&&t.cuentaIds.length>0?t.cuentaIds:null;return a?e.filter(o=>a.includes(o._id)):e.filter(o=>o.activo&&!o.simulacion)}function Ia(t,e,a=0){const o=Ee(t,e).reduce((s,n)=>s+rt(n),0);return t.usarColchon!==!1?Math.max(0,o-a):o}function bs(t,e,a){if(!t.targetAmount||t.targetAmount<=0)return null;const o=Ee(t,e);if(o.length===0)return null;const s=a.hoy??new Date,n=a.horizonteMeses??120,i=t.usarColchon!==!1,r=o.map(l=>({acc:l,eventos:a.extractoCuenta(l),cursor:0,saldo:rt(l)}));for(let l=1;l<=n;l++){const d=new Date(s.getFullYear(),s.getMonth()+l,1),b=`${d.getFullYear()}-${String(d.getMonth()+1).padStart(2,"0")}`,u=V(new Date(d.getFullYear(),d.getMonth()+1,0));let p=0;for(const g of r){for(;g.cursor<g.eventos.length&&g.eventos[g.cursor].fecha<=u;)g.saldo=g.eventos[g.cursor].saldoAcum??g.saldo,g.cursor++;p+=g.saldo}const y=i?a.colchonEnFecha(u):0;if(p-y>=t.targetAmount)return b}return null}function Aa(t,e){const a=t.escenarioIds||[];return a.length===0?!0:!!e&&a.includes(e)}function Sa(t,e){const a=o=>Aa(o,e);return{loans:t.loans.filter(a).map(o=>({...o,amortizaciones:(o.amortizaciones||[]).filter(a)})),expenses:t.expenses.filter(a),nominas:t.nominas.filter(a),accounts:t.accounts.filter(a)}}const ze=t=>t.slice(0,7);function hs(t){const[e,a]=t.split("-").map(Number);return`${a===12?e+1:e}-${String(a===12?1:a+1).padStart(2,"0")}`}function _e(t,e,a){if(t.length===0)return[];const o=new Map;for(const d of t)d.saldoAcum!==void 0&&o.set(ze(d.fecha),d.saldoAcum);const s=t[0];let n=(s.saldoAcum??0)-(s.delta??0);const i=ze(e||s.fecha),r=ze(a||t[t.length-1].fecha);if(r<i)return[];const l=[];for(let d=i;d<=r;d=hs(d)){const b=o.get(d);b!==void 0&&(n=b);const[u,p]=d.split("-").map(Number);l.push({x:G(V(new Date(u,p-1,15))).getTime(),mes:d,y:n})}return l}function Fe(t,e){let a=null;for(const o of t){if(o.fecha>e)break;o.saldoAcum!==void 0&&(a=o.saldoAcum)}return a}function ys(t){const e=a=>!a.simulacion;return{loans:t.loans.filter(e).map(a=>({...a,amortizaciones:(a.amortizaciones||[]).filter(e)})),expenses:t.expenses.filter(e),nominas:t.nominas.filter(e),accounts:t.accounts.filter(e)}}function xs(t){const e=a=>!!a.simulacion;return t.loans.some(a=>e(a)||(a.amortizaciones||[]).some(e))||t.expenses.some(e)||t.nominas.some(e)||t.accounts.some(e)}const gt=[[0,19],[12450,24],[20200,30],[35200,37],[6e4,45],[3e5,47]];function ut(t,e){const a=[...e].sort((n,i)=>n[0]-i[0]);let o=0,s=t;for(let n=a.length-1;n>=0;n--){const[i,r]=a[n];s<=i||(o+=(s-i)*(r/100),s=i)}return o}function Pe(t,e){const a=Math.max(0,t-(e||0)),o=t*.0635,s=Math.min(2e3,a),n=Math.max(0,a-o-s),i=n<=15876?7302:n<=21622?Math.max(0,7302-1.75*(n-15876)):0;return{baseIRPF:a,cotizSS:o,gastosArt19:s,RNT:n,reducArt20:i,baseImponible:Math.max(0,n-i)}}function St(t,e){return Pe(t,e).baseImponible}function Ma(t,e){return ut(t,e)/12}const Et=[[0,19],[6e3,21],[5e4,23],[2e5,27],[3e5,28]];function De(t,e){if(!t||t<=0)return 0;const a=e||Et;let o=0,s=t;for(let n=0;n<a.length;n++){const[i,r]=a[n],l=n<a.length-1?a[n+1][0]:1/0,d=Math.min(s,l-i);if(!(d<=0)&&(o+=d*(r/100),s-=d,s<=0))break}return o}function Ot(t,e){if(mt(t)!=="inversion")return null;const a=rt(t),o=(t.aportaciones||[]).reduce((i,r)=>i+r.cantidad,0)||t.saldoInicial||0,s=Math.max(0,a-o),n=De(s,e);return{saldo:a,costBase:o,plusvalia:s,impuesto:n,neto:a-n}}function ve(t,e=new Date){var p;if(mt(t)!=="pension")return null;const a=t.bloqueoMeses||120,o=rt(t),s=V(new Date(e.getFullYear(),e.getMonth()-a,e.getDate())),n=[...t.aportaciones||[]].sort((y,g)=>y.fecha.localeCompare(g.fecha));let i=0;const r=n.reduce((y,g)=>y+g.cantidad,0);for(const y of n)y.fecha<=s&&(i+=y.cantidad);const l=Math.max(0,o-r),d=r>0?i/r:0,b=Math.min(o,i+l*d),u=Math.max(0,o-b);return{saldo:o,disponible:b,bloqueado:u,costBase:r,beneficio:l,numAportaciones:n.length,proxDesbloqueo:((p=n.find(y=>y.fecha>s))==null?void 0:p.fecha)||null}}function wa(t,e,a){const o=a!==void 0?a:t.impuestoRetirada;if(mt(t)!=="pension"||!o)return 0;const s=rt(t);if(s<=0)return 0;const n=(t.aportaciones||[]).reduce((d,b)=>d+b.cantidad,0),i=Math.max(0,s-n);if(i<=0)return 0;const r=i/s;return+(e*r*o/100).toFixed(2)}function Te(t,e,a){var l;const o=t.grupoNomina;if(!o)return t.impuestoRetirada||0;const n=(e||[]).filter(d=>(d.grupoNomina||"")===o&&d.activo!==!1).reduce((d,b)=>d+(b.bruto||0)*(b.nPagas||12),0),i=[...a||[]].sort((d,b)=>d[0]-b[0]);let r=((l=i[0])==null?void 0:l[1])||19;for(const[d,b]of i)if(n>=d)r=b;else break;return r}const Ne=6.35;function zt(t){return(t.retribucionFlexible||[]).reduce((e,a)=>e+(a.importe||0)*12,0)}function Ca(t){return Math.max(0,(t.bruto||0)-zt(t))}function $s(t){return[...t].sort((e,a)=>(a.bruto||0)-(e.bruto||0)||String(e._id).localeCompare(String(a._id)))}function Is(t){const e=t.reduce((i,r)=>i+(r.bruto||0),0),a=t.reduce((i,r)=>i+zt(r),0),o=Math.max(0,e-a),s=St(e,a),n=new Map;for(const i of t)n.set(i._id,o>0?s*(Ca(i)/o):0);return n}function Re(t,e,a){if(t.irpfModo==="manual")return Ca(t)*((t.irpfPct||0)/100);if(!e||e.length===0)return ut(St(t.bruto||0,zt(t)),a);const o=$s(e.filter(i=>i.irpfModo!=="manual")),s=Is(e);let n=0;for(const i of o){const r=s.get(i._id)??0;if(i._id===t._id)return ut(n+r,a)-ut(n,a);n+=r}return ut(St(t.bruto||0,zt(t)),a)}function As(t,e){return t.reduce((a,o)=>a+Re(o,t,e),0)}function Ss(t,e){var s;const a=[...e||[]].sort((n,i)=>n[0]-i[0]);let o=((s=a[0])==null?void 0:s[1])??19;for(const[n,i]of a)if(t>=n)o=i;else break;return o}function ja(t,e){if(!t||t.length===0)return 0;const a=t.reduce((s,n)=>s+(n.bruto||0),0),o=t.reduce((s,n)=>s+zt(n),0);return Ss(St(a,o),e)}function Oe(t,e,a){const o=t.bruto||0,s=zt(t),n=Math.max(0,o-s),i=t.nPagas||12,r=t.ssPct??Ne,l=n*(r/100),d=Re(t,e,a);return{brutoAnual:o,flexAnual:s,baseDineraria:n,nPagas:i,ssPct:r,ssAnual:l,irpfAnual:d,irpfPct:n>0?d/n*100:0,netoPorPaga:(n-l-d)/i}}function Ms(t){const e=new Map,a=[];for(const o of t){const s=o.grupoNomina||"";if(!s){a.push(o);continue}const n=e.get(s)??[];n.push(o),e.set(s,n)}return{grupos:e,sueltas:a}}const _t=1500;function Ea(t){const e=t.cuantia||0,a=Math.max(1,t.frecuencia||1);return t.tipoFrecuencia==="mensual"?e*12/a:t.tipoFrecuencia==="diaria"?e*365.25/a:e}const Kt=t=>{const e=typeof t=="number"?t:parseFloat(String(t??""));return Number.isFinite(e)?e:0};function ws(t,e){const a=t.grupoNomina||"";return a?e.filter(o=>(o.grupoNomina||"")===a):null}function za(t,e){return t.reduce((a,o)=>a+Re(o,ws(o,t),e),0)}function _a(t){const{nominas:e,tramosGeneral:a,tramosAhorro:o}=t,s=t.extras??{},n=e.reduce((w,E)=>w+(E.bruto||0),0),i=e.reduce((w,E)=>w+zt(E),0),r=Pe(n,i),l=t.aportacionesPension,d=_t,b=Math.min(l,d),u=Math.max(0,r.RNT-r.reducArt20-b),p=Kt(s.capInmobiliario),y=Kt(s.capMobiliario),g=Kt(s.gananciasFondos),I=Kt(s.otrasCorto),A=Kt(s.retCapital),v=Math.max(0,u+t.otrosIngresos+p+I),h=Math.max(0,y+g),f=ut(v,a),$=ut(h,o),m=f+$,x=za(e,a),S=x+A;return{brutoTotal:n,flexTotal:i,brutoIRPF:r.baseIRPF,cotizSS:r.cotizSS,gastosArt19:r.gastosArt19,RNT:r.RNT,reducArt20:r.reducArt20,aportPP:l,limPP:d,deducPP:b,RNTred:u,otrosIngresos:t.otrosIngresos,capInmobiliario:p,capMobiliario:y,gananciasFondos:g,otrasCorto:I,baseGeneral:v,baseAhorro:h,cuotaGen:f,cuotaAho:$,cuotaIntegra:m,retNomina:x,retCapital:A,totalRet:S,resultado:m-S}}const Cs=Object.freeze(Object.defineProperty({__proto__:null,LIMITE_APORTACION_PENSION:_t,TRAMOS_AHORRO_DEFAULT:Et,TRAMOS_IRPF_DEFAULT:gt,ajustarFechaPago:fa,ajustarPrecioReal:vs,calcBaseImponibleTrabajo:St,calcFactorInflacion:pt,calcFondoInversion:Ot,calcFondosPension:ve,calcGananciasCapital:De,calcIRPF:ut,calcImpuestoPension:wa,calcInflacionMediaAnual:xa,calcSaludFinanciera:gs,calcTAE:ga,calcTipoMarginalPension:Te,calcTipoRealFisher:$a,calcularDeclaracion:_a,clampedDate:ma,cuentasDelObjetivo:Ee,cuotaMensual:Rt,desgloseBaseTrabajo:Pe,diasEntre:Jt,filtrarPorEscenario:Sa,formatEUR:j,formatLocalDate:V,formatPct:va,fromCents:et,haySimulaciones:xs,ingresoAnual:Ea,labelDiaPago:je,lastDayOfMonth:Ce,modeloFondoDe:mt,parseLocalDate:G,proyectarFechaCumplimiento:bs,resolverDiaEfectivo:fe,resumenPrestamo:at,resumenPrestamoConAhorro:ya,retencionMensual:Ma,retencionesNomina:za,roundMoney:W,saldoEnFecha:Wt,saldoEnFechaExtracto:Fe,saldoParaObjetivo:Ia,saldoRealCuenta:rt,serieMensual:_e,sinSimulaciones:ys,tablaAmortizacion:ba,toCents:It,todayISO:Y,visibleEnEscenario:Aa},Symbol.toStringTag,{value:"Module"}));function Qt(t,e,a=null){const o=[],s=G(e.start),n=G(e.end);for(const i of t){if(!i.activo||a&&a.length>0&&!a.includes(i.cuenta||"default"))continue;const r=G(i.fechaInicio||e.start),l=i.fechaFin?G(i.fechaFin):n,d=i.cuantia,b=u=>o.push({fecha:u,concepto:i.concepto,cuantia:d,tipo:i.tipo,tags:i.tags||[],cuenta:i.cuenta||"default",sourceId:i._id,sourceType:"expense"});if(i.tipoFrecuencia==="extraordinario")r>=s&&r<=n&&r<=l&&b(i.fechaInicio);else if(i.tipoFrecuencia==="mensual"){const u=Math.max(1,i.frecuencia||1);let p=r.getFullYear(),y=r.getMonth();const g=Math.ceil(240/u)+2;for(let I=0;I<g;I++){const A=fe(p,y,i.diaPago||"")||(()=>{const h=r.getDate(),f=new Date(p,y+1,0).getDate();return V(new Date(p,y,Math.min(h,f)))})(),v=G(A);if(v>n||v>l)break;v>=s&&v>=r&&b(A),y+=u,y>=12&&(p+=Math.floor(y/12),y=y%12)}}else if(i.tipoFrecuencia==="diaria"){const u=Math.max(1,i.frecuencia||1)*864e5;let p=new Date(Math.max(r.getTime(),s.getTime()));if(r<s){const y=Math.ceil((s.getTime()-r.getTime())/u);p=new Date(r.getTime()+y*u)}for(;p<=n&&p<=l;)b(V(p)),p=new Date(p.getTime()+u)}}return o}function Fa(t,e,a=null){const o=[];for(const s of t){if(!s.activo||a&&a.length>0&&!a.includes(s.cuenta||"default"))continue;const{tabla:n}=at(s);for(const i of n)i.fecha>=e.start&&i.fecha<=e.end&&(i.esAmortizacion?o.push({fecha:i.fecha,concepto:`Amort. ${s.nombre}`,cuantia:-(i.amortizacion+i.comisionAmort),tipo:"gasto",tags:["amortizacion",...s.tags||[]],cuenta:s.cuenta||"default",sourceId:s._id,sourceType:"loan-amort",simulacion:i.simulacion||!1}):o.push({fecha:i.fecha,concepto:`Cuota ${s.nombre}`,cuantia:-i.cuota,tipo:"gasto",tags:["prestamo",...s.tags||[]],cuenta:s.cuenta||"default",sourceId:s._id,sourceType:"loan",simulacion:s.simulacion||!1}))}return o}function Pa(t,e,a=null,o={accounts:[]}){const s=[],n=G(e.start),i=G(e.end),r=o.accounts||[],l=o.nominas||[],d=o.resolverTramosIRPF||(()=>gt),b=o.resolverTramosGanancias||(()=>Et),u=p=>{var y;return((y=r.find(g=>g._id===p))==null?void 0:y.nombre)??p};for(const p of t){if(!p.activo||p.tipo!=="transferencia"||a&&a.length>0&&!(a.includes(p.cuenta||"default")||a.includes(p.cuentaDestino||"default")))continue;const y=G(p.fechaInicio||e.start),g=p.fechaFin?G(p.fechaFin):i,I=A=>{const v=r.find(D=>D._id===(p.cuenta||"default")),h=r.find(D=>D._id===(p.cuentaDestino||"default")),f=mt(v),$=mt(h),m=f==="inversion"&&$==="inversion"||f==="pension"&&$==="pension",x=["transferencia",...m?["traspaso"]:[],...p.tags||[]],S=m?"traspaso-out":"transfer-out",w=m?"traspaso-in":"transfer-in",E=!a||a.length===0||a.includes(p.cuenta||"default"),_=!a||a.length===0||a.includes(p.cuentaDestino||"default");if(E&&s.push({fecha:A,concepto:`Transf. → ${u(p.cuentaDestino||"default")}: ${p.concepto}`,cuantia:p.cuantia,tipo:"gasto",tags:x,cuenta:p.cuenta||"default",sourceId:p._id,sourceType:S}),_&&s.push({fecha:A,concepto:`Transf. ← ${u(p.cuenta||"default")}: ${p.concepto}`,cuantia:p.cuantia,tipo:"ingreso",tags:x,cuenta:p.cuentaDestino||"default",sourceId:p._id,sourceType:w}),E&&!m&&v){if(f==="inversion"){const D=parseInt(A.slice(0,4)),C=Ot(v,b(D));if(C&&C.saldo>0&&C.plusvalia>0){const M=Math.min(1,p.cuantia/C.saldo),F=C.plusvalia*M*.19;F>.01&&s.push({fecha:A,concepto:`Retención IRPF reembolso ${v.nombre} (19% s/plusvalía)`,cuantia:F,tipo:"gasto",tags:["impuesto","capital-mobiliario","retencion"],cuenta:p.cuenta||"default",sourceId:p._id,sourceType:"investment-tax"})}}else if(f==="pension"){const D=d(parseInt(A.slice(0,4))),C=Te(v,l,D),M=wa(v,p.cuantia,C||void 0);if(M>0){const z=v.grupoNomina?`IRPF rescate ${v.nombre} (tipo marginal grupo "${v.grupoNomina}": ${C}%)`:`Retención rescate ${v.nombre} (${v.impuestoRetirada}% s/beneficio)`;s.push({fecha:A,concepto:z,cuantia:M,tipo:"gasto",tags:["impuesto","rendimientos-trabajo","pension"],cuenta:p.cuenta||"default",sourceId:p._id,sourceType:"pension-tax"})}}}};if(p.tipoFrecuencia==="extraordinario")y>=n&&y<=i&&y<=g&&I(p.fechaInicio);else if(p.tipoFrecuencia==="mensual"){const A=Math.max(1,p.frecuencia||1);let v=y.getFullYear(),h=y.getMonth();const f=Math.ceil(240/A)+2;for(let $=0;$<f;$++){const m=fe(v,h,p.diaPago||"")||(()=>{const S=y.getDate(),w=new Date(v,h+1,0).getDate();return V(new Date(v,h,Math.min(S,w)))})(),x=G(m);if(x>i||x>g)break;x>=n&&x>=y&&I(m),h+=A,h>=12&&(v+=Math.floor(h/12),h=h%12)}}else if(p.tipoFrecuencia==="diaria"){const A=Math.max(1,p.frecuencia||1)*864e5;let v=new Date(Math.max(y.getTime(),n.getTime()));if(y<n){const h=Math.ceil((n.getTime()-y.getTime())/A);v=new Date(y.getTime()+h*A)}for(;v<=i&&v<=g;)I(V(v)),v=new Date(v.getTime()+A)}}return s}function Da(t,e,a=null){const o=[],s=G(e.start),n=G(e.end);for(const i of t){const r=mt(i);if(r==="cuenta"||!i.activo)continue;const l=i.planAportaciones||[];for(const d of l){if(!d.importe||d.importe<=0)continue;const b=G(d.fechaInicio||e.start),u=d.fechaFin?G(d.fechaFin):n,p=d.cuentaOrigen||"default",y=!a||!a.length||a.includes(p),g=!a||!a.length||a.includes(i._id),I=r==="pension"?"pension":"capital-mobiliario",A=m=>{y&&o.push({fecha:m,concepto:`Aportación → ${i.nombre}`,cuantia:d.importe,tipo:"gasto",tags:["aportacion","transferencia",I],cuenta:p,sourceId:d._id,sourceType:"aportacion-out"}),g&&o.push({fecha:m,concepto:`Aportación ${i.nombre} (${d.periodicidad||"mensual"})`,cuantia:d.importe,tipo:"ingreso",tags:["aportacion","transferencia",I],cuenta:i._id,sourceId:d._id,sourceType:"aportacion-in"})},v={mensual:1,trimestral:3,semestral:6,anual:12}[d.periodicidad||"mensual"]||1;let h=b.getFullYear(),f=b.getMonth();const $=Math.ceil(240/v)+2;for(let m=0;m<$;m++){const x=new Date(h,f+1,0).getDate(),S=V(new Date(h,f,Math.min(b.getDate(),x))),w=G(S);if(w>n||w>u)break;w>=s&&w>=b&&A(S),f+=v,f>=12&&(h+=Math.floor(f/12),f=f%12)}}}return o}function Ta(t,e,a=null,o=[]){const s=[];for(const n of t){if(!n.activo||!n.interes||n.interes<=0||a&&a.length>0&&!a.includes(n._id))continue;const i=G(e.start),r=G(e.end),l=n.periodoCobro||"mensual",d=l==="mensual",b=d?null:{diario:864e5,semanal:7*864e5}[l]||864e5,u=d?1/12:b/(365.25*864e5);let p=Wt(n,e.start);const y=o.filter(A=>A.cuenta===n._id).map(A=>({fecha:A.fecha,delta:A.tipo==="ingreso"?Math.abs(A.cuantia):-Math.abs(A.cuantia)})).sort((A,v)=>A.fecha.localeCompare(v.fecha));let g=0,I=new Date(i);for(;I<=r;){const A=d?new Date(I.getFullYear(),I.getMonth()+1,I.getDate()):new Date(I.getTime()+b),v=new Date(Math.min(A.getTime(),r.getTime()+1)),h=V(v);let f=0;for(;g<y.length&&y[g].fecha<h;)f+=y[g].delta,g++;const $=p,m=p+f,x=Math.max(0,($+m)/2);p=m;const S=d?u:(v.getTime()-I.getTime())/(365.25*864e5),w=x*(Math.pow(1+n.interes/100,S)-1);w>.001&&s.push({fecha:V(I),concepto:`Interés ${n.nombre}`,cuantia:w,tipo:"ingreso",tags:["interes","cuenta"],cuenta:n._id,sourceId:n._id,sourceType:"account-interest"}),I=A}}return s}function Na(t,e,a,o=null){const s=[],n=e||gt;for(const i of t){if(!i.activo||i.tipo!=="ingreso"||!i.sujetoIRPF)continue;const r=i.cuantia*(i.tipoFrecuencia==="mensual"?12:1),l=Ma(r,n),d={...i,_id:i._id+"_irpf",concepto:`IRPF salario ${i.concepto}`,tipo:"gasto",cuantia:l,tags:["irpf","fiscal"]};s.push(...Qt([d],a,o))}return s}const js=[5,11,2,8],Es={transporte:"Transporte",restaurante:"Restaurante",otros:"Beneficio"};function Ra(t,e,a=null,o=[],s=()=>gt){const n=[],i=G(e.start),r=G(e.end),l=o.length>0,d={};for(const p of t){const y=p.grupoNomina||"";d[y]||(d[y]=[]),d[y].push(p)}for(const p of Object.keys(d))d[p].sort((y,g)=>(g.bruto||0)-(y.bruto||0));function b(p,y){if(!l||!p.mesActualizacionIPC)return p.bruto||0;const g=p.fechaInicio||e.start,I=G(g),A=G(y);let v=0;for(let f=I.getFullYear();f<=A.getFullYear();f++){const $=new Date(f,p.mesActualizacionIPC-1,1);$>I&&$<=A&&v++}if(v===0)return p.bruto||0;const h=V(new Date(I.getFullYear()+v,0,1));return(p.bruto||0)*pt(o,g,h)}function u(p,y){const g=b(p,y),I=(p.retribucionFlexible||[]).reduce((D,C)=>D+(C.importe||0)*12,0),A=Math.max(0,g-I);if(p.irpfModo==="manual")return A*((p.irpfPct||0)/100);const v=s(parseInt(y.slice(0,4))),h=p.grupoNomina||"";if(!h)return ut(St(g,I),v);const f=d[h].filter(D=>D.activo),$=f.reduce((D,C)=>D+b(C,y),0),m=f.reduce((D,C)=>D+(C.retribucionFlexible||[]).reduce((M,z)=>M+(z.importe||0)*12,0),0),x=Math.max(0,$-m),S=St($,m),w=Math.max(0,g-I),E=x>0?S*(w/x):0,_=f.filter(D=>D._id!==p._id&&(D.bruto||0)>(p.bruto||0)).reduce((D,C)=>{const M=(C.retribucionFlexible||[]).reduce((F,T)=>F+(T.importe||0)*12,0),z=Math.max(0,b(C,y)-M);return D+(x>0?S*(z/x):0)},0);return ut(_+E,v)-ut(_,v)}for(const p of t){if(!p.activo)continue;const y=p.cuenta||"default";if(a&&a.length>0&&!a.includes(y))continue;const g=Math.max(1,p.nPagas||12),I=G(p.fechaInicio||e.start),A=p.fechaFin?G(p.fechaFin):r,v=h=>{const f=b(p,h),$=u(p,h),m=(p.retribucionFlexible||[]).reduce((M,z)=>M+(z.importe||0)*12,0),x=Math.max(0,f-m),S=(p.ssPct??6.35)/100,w=x*S,E=x/g,_=$/g,D=w/g,C=p.representacion==="simplificado"?E-D-_:E;n.push({fecha:h,concepto:p.nombre,cuantia:C,tipo:"ingreso",cuenta:y,tags:p.tags||[],sourceId:p._id,sourceType:"nomina"}),p.representacion==="detallado"&&(D>0&&n.push({fecha:h,concepto:`SS ${p.nombre}`,cuantia:D,tipo:"gasto",cuenta:y,tags:["seguridad-social","fiscal"],sourceId:p._id+"_ss",sourceType:"nomina"}),_>0&&n.push({fecha:h,concepto:`IRPF ${p.nombre}`,cuantia:_,tipo:"gasto",cuenta:y,tags:["irpf","fiscal"],sourceId:p._id+"_irpf",sourceType:"nomina"}));for(const M of p.retribucionFlexible||[])!M.cuenta||!(M.importe>0)||a&&a.length>0&&!a.includes(M.cuenta)||n.push({fecha:h,concepto:`${p.nombre} — ${Es[M.tipo]||M.tipo}`,cuantia:M.importe,tipo:"ingreso",cuenta:M.cuenta,tags:["retribucion-flexible",M.tipo],sourceId:`${p._id}_flex_${M._id||M.tipo}`,sourceType:"nomina"})};if(g<=12){const h=g===12?1:Math.round(12/g),f=I.getDate();let $=I.getFullYear(),m=I.getMonth();for(let x=0;x<300;x++){const S=new Date($,m+1,0).getDate(),w=new Date($,m,Math.min(f,S));if(w>r||w>A)break;w>=i&&w>=I&&v(V(w)),m+=h,m>=12&&($+=Math.floor(m/12),m=m%12)}}else{const h=g-12,f=I.getDate();let $=I.getFullYear(),m=I.getMonth();for(let w=0;w<300;w++){const E=new Date($,m+1,0).getDate(),_=new Date($,m,Math.min(f,E));if(_>r||_>A)break;_>=i&&_>=I&&v(V(_)),m++,m>=12&&($++,m=0)}const x=Math.max(I.getFullYear(),i.getFullYear()),S=Math.min((p.fechaFin?A:r).getFullYear(),r.getFullYear());for(let w=x;w<=S;w++)for(const E of js.slice(0,h)){const _=new Date(w,E,15);_>=i&&_<=r&&_>=I&&_<=A&&v(V(_))}}}return n}function Oa(t,e,a,o=null,s="default"){const n=[];if(!e||e.length===0)return n;const i=G(a.start),r=G(a.end),l=Y(),d=t.filter(u=>u.activo&&u.tipo==="gasto"&&u.tipoFrecuencia==="mensual");let b=new Date(i.getFullYear(),i.getMonth(),1);for(;b<=r;){const u=b.getFullYear(),p=b.getMonth(),y=u+"-"+String(p+1).padStart(2,"0"),g=y+"-01",I=V(new Date(u,p+1,0)),A=V(new Date(u,p,15));let v=0;for(const h of d){if(o&&o.length>0&&!o.includes(h.cuenta||"default")||h.fechaInicio&&h.fechaInicio>I||h.fechaFin&&h.fechaFin<g)continue;const f=h.fechaInicio||l,$=pt(e,f,A);if($<=1)continue;const m=Math.max(1,h.frecuencia||1);v+=h.cuantia*($-1)/m}v>.01&&n.push({fecha:A,concepto:"Incremento coste de vida",cuantia:v,tipo:"gasto",tags:["inflacion"],cuenta:s,sourceId:"inflacion_vida_"+y,sourceType:"inflacion"}),b=new Date(u,p+1,1)}return n}function qa(t,e,a,o="default"){const s=[];if(!e||e.length===0||t<=0)return s;const n=G(a.start),i=G(a.end),r=[...e].sort((d,b)=>d.year-b.year);let l=new Date(n.getFullYear(),n.getMonth(),1);for(;l<=i;){const d=l.getFullYear(),b=l.getMonth(),u=d+"-"+String(b+1).padStart(2,"0"),p=V(new Date(d,b,15)),y=r.filter(h=>h.year<=d),g=y.length>0?y[y.length-1]:r[0],I=g?g.tasa/100:0,A=Math.pow(1+I,1/12)-1,v=t*A;v>.01&&s.push({fecha:p,concepto:"Pérdida ahorro por inflación",cuantia:v,tipo:"gasto",tags:["inflacion"],cuenta:o,sourceId:"inflacion_ahorro_"+u,sourceType:"inflacion"}),l=new Date(d,b+1,1)}return s}function La(t,e,a){const o=a.fechaReferencia||a.dashboardStart,s=o<a.dashboardStart?a.dashboardStart:o>a.dashboardEnd?a.dashboardEnd:o,n=e.reduce((u,p)=>u+Wt(p,s),0),i=t.filter(u=>u.fecha<s),r=t.filter(u=>u.fecha>=s),l=[];let d=n;for(const u of[...i].reverse()){const p=u.tipo==="ingreso"?Math.abs(u.cuantia):-Math.abs(u.cuantia);l.unshift({...u,delta:p,saldoAcum:d}),d-=p}const b=[];d=n;for(const u of r){const p=u.tipo==="ingreso"?Math.abs(u.cuantia):-Math.abs(u.cuantia);d+=p,b.push({...u,delta:p,saldoAcum:d})}return[...l,...b]}function zs(t,e,a,o=null){const s=e.filter(n=>n.activo&&(!o||o.length===0||o.includes(n._id)));return La([...t].sort((n,i)=>n.fecha.localeCompare(i.fecha)),s,a)}function Xt(t){const{loans:e,expenses:a,accounts:o,config:s}=t,n=t.filtroAccounts??null,i=t.nominas??[],r=t.inflacionPeriodos??[],l={start:s.dashboardStart,end:s.dashboardEnd},d=a.filter(I=>I.tipo!=="transferencia"),b=a.filter(I=>I.tipo==="transferencia"),u={accounts:o,nominas:i,resolverTramosIRPF:t.resolverTramosIRPF,resolverTramosGanancias:t.resolverTramosGanancias};let p=[];p=p.concat(Qt(d,l,n)),p=p.concat(Fa(e,l,n)),p=p.concat(Pa(b,l,n,u)),p=p.concat(Da(o,l,n));const y=Ta(o,l,n,p);if(p=p.concat(y),p=p.concat(Na(a,s.tramos_irpf,l,n)),p=p.concat(Ra(i,l,n,r,t.resolverTramosIRPF)),s.usarInflacion&&r.length>0){const I=(o.find(h=>h.activo&&h.esCuentaPrincipal)||o.find(h=>h.activo)||{_id:"default"})._id;p=p.concat(Oa(d,r,l,n,I));const v=o.filter(h=>h.activo&&(!n||n.length===0||n.includes(h._id))).reduce((h,f)=>h+Wt(f,s.dashboardStart),0);p=p.concat(qa(v,r,l,I))}p.sort((I,A)=>I.fecha.localeCompare(A.fecha));const g=o.filter(I=>I.activo&&(!n||n.length===0||n.includes(I._id)));return La(p,g,s)}function _s(t,e,a=null){const o=Y(),n=e.filter(r=>r.activo&&(!a||a.length===0||a.includes(r._id))).reduce((r,l)=>r+rt(l),0),i=t.filter(r=>r.fecha<=o);return i.length===0?n:i[i.length-1].saldoAcum}function Ba(t,e){const a=new Map;for(const o of t)if(o.tipo===e&&!(o.sourceType==="transfer-out"||o.sourceType==="transfer-in"||o.sourceType==="loan-amort"))for(const s of o.tags||["sin_tag"])a.set(s,(a.get(s)||0)+Math.abs(o.cuantia));return a}function Fs(t,e){const a=[];let o=!1;for(let s=0;s<t.length;s++){const n=t[s],i=n.saldoAcum;i<0&&(s===0||t[s-1].saldoAcum>=0)&&a.push({tipo:"saldo_negativo",fecha:n.fecha,saldo:i,mensaje:`Saldo negativo (${j(i)}) a partir del ${n.fecha}`}),e>0&&(i<e&&!o?(o=!0,a.push({tipo:"bajo_colchon",fecha:n.fecha,saldo:i,mensaje:`Saldo por debajo del colchón (${j(i)} < ${j(e)}) desde ${n.fecha}`})):i>=e&&o&&(o=!1,a.push({tipo:"recuperacion_colchon",fecha:n.fecha,saldo:i,mensaje:`Recuperación del colchón el ${n.fecha} (${j(i)})`})))}return a}function Ps(t,e){const a=t.filter(i=>i.tipo==="gasto"&&i.sourceType!=="loan-amort").reduce((i,r)=>i+Math.abs(r.cuantia),0),o=G(e.dashboardStart),s=G(e.dashboardEnd),n=Math.max(1,(s.getTime()-o.getTime())/(30.44*864e5));return a/n}function Ds(t,e,a=Y()){const o=new Set,s=e.map(r=>{const l=r.fechaInicialSaldo||"",d={};l&&l<=a&&(d[l]=r.saldoInicial||0);for(const b of r.historicoSaldos||[])b.fecha<=a&&(!l||b.fecha>=l)&&(d[b.fecha]=b.saldo);return Object.keys(d).forEach(b=>o.add(b)),d}),n={};for(const r of[...o].sort()){let l=0;for(let d=0;d<e.length;d++){const b=Object.entries(s[d]).filter(([u])=>u<=r);b.length>0?(b.sort(([u],[p])=>p.localeCompare(u)),l+=b[0][1]):l+=e[d].saldoInicial||0}n[r]=l}const i=[];for(const[r,l]of Object.entries(n).sort(([d],[b])=>d.localeCompare(b))){const d=t.filter(y=>y.fecha<=r),b=d.length>0?d[d.length-1].saldoAcum:null;if(b===null)continue;const u=l-b,p=b!==0?u/Math.abs(b)*100:0;i.push({cuenta:"Total",fecha:r,estimado:b,real:l,desv:u,pct:p})}return i}const Ts=Object.freeze(Object.defineProperty({__proto__:null,calcDesviacion:Ds,detectarPuntosCriticos:Fs,mediaMensualGastos:Ps},Symbol.toStringTag,{value:"Module"}));function Zt(t,e=new Date){const a=V(e),o=new Date(e);o.setMonth(o.getMonth()+1);const s=V(o),n=t.filter(r=>r.basico&&r.activo&&r.tipo==="gasto");return Qt(n,{start:a,end:s}).reduce((r,l)=>r+Math.abs(l.cuantia),0)}function qe(t){return(t||[]).filter(e=>e.basico&&e.activo&&!e.simulacion).reduce((e,a)=>e+Rt(a.capital,a.tin,a.meses),0)}function ka(t,e,a,o){return e.colchonTipo==="fijo"&&(e.colchonFijo||0)>0?e.colchonFijo:(Zt(t,o)+qe(a))*(e.colchonMeses||6)}function Ha(t,e,a,o,s){const i=[...e.colchonPuntos||[]].sort((l,d)=>l.fecha.localeCompare(d.fecha)).filter(l=>l.fecha<=o).pop();return i?i.tipo==="fijo"?i.importe||0:(Zt(t,s)+qe(a))*(i.meses||6):ka(t,e,a,s)}function ge(t,e,a,o,s,n=!1,i){const r=[...t.puntos||[]].sort((b,u)=>b.fecha.localeCompare(u.fecha)),l=r.filter(b=>b.fecha<=s).pop()||(n?r[0]:null);return l?l.tipo==="fijo"?l.importe||0:(Zt(e,i)+qe(o))*(l.meses||1):0}function Ns(t){return typeof t.delta=="number"?t.delta:t.tipo==="ingreso"?Math.abs(t.cuantia):-Math.abs(t.cuantia)}function Rs(t,e){const a={};for(const o of e)a[o._id]=rt(o);return t.map(o=>(o.cuenta&&a[o.cuenta]!==void 0&&(a[o.cuenta]+=Ns(o)),{fecha:o.fecha,saldos:{...a}}))}function Os(t,e,a,o,s,n,i){const r=[];for(const l of(t||[]).filter(d=>d.activo!==!1)){let d=!1;for(let b=0;b<e.length;b++){const u=e[b],p=ge(l,o,s,n,u.fecha,!1,i);if(p<=0){d=!1;continue}const y=!l.cuentas||l.cuentas.length===0?u.saldoAcum:l.cuentas.reduce((g,I)=>{var A,v;return g+(((v=(A=a[b])==null?void 0:A.saldos)==null?void 0:v[I])||0)},0);y<p&&!d?(d=!0,r.push({tipo:"bajo_margen",fecha:u.fecha,saldo:y,target:p,nombre:l.nombre,mensaje:`⚠ ${l.nombre}: ${j(y)} < ${j(p)} desde ${u.fecha}`})):y>=p&&d&&(d=!1,r.push({tipo:"recuperacion_margen",fecha:u.fecha,saldo:y,target:p,nombre:l.nombre,mensaje:`✓ ${l.nombre}: recuperado el ${u.fecha}`}))}}return r}const qs=Object.freeze(Object.defineProperty({__proto__:null,calcColchon:ka,calcColchonEnFecha:Ha,calcGastoBasicoMensual:Zt,calcMargenEnFecha:ge,detectarCrucesMargenes:Os,saldosPorCuentaEnExtracto:Rs},Symbol.toStringTag,{value:"Module"}));function Ls(t){if(!t||t.showColchon===!1)return null;const e=t.colchonPuntos??[];return e.length>0?{nombre:"Colchón",puntos:[...e]}:t.colchonTipo==="fijo"&&(t.colchonFijo||0)>0?{nombre:"Colchón",puntos:[{fecha:"1970-01-01",tipo:"fijo",importe:t.colchonFijo}]}:{nombre:"Colchón",puntos:[{fecha:"1970-01-01",tipo:"meses",meses:t.colchonMeses||6}]}}function Ga(t,e){return Jt(G(t),G(e))}const Bs=["enero","febrero","marzo","abril","mayo","junio","julio","agosto","septiembre","octubre","noviembre","diciembre"];function Va(t,e){const[a,o,s]=t.split("-").map(Number),n=t.slice(0,4)===e.slice(0,4);return`${s} de ${Bs[o-1]}${n?"":` de ${a}`}`}function Ua(t){return t<=0?"hoy":t===1?"mañana":t<7?`en ${t} días`:t<14?"en una semana":t<31?`en ${Math.round(t/7)} semanas`:t<45?"en un mes":`en ${Math.round(t/30)} meses`}function ks(t,e={}){const{hoy:a=Y(),horizonteCritico:o=365,horizonteAviso:s=120,maximo:n=4,incertidumbre:i}=e,r=[];for(const u of t.puntosCriticos??[])u.tipo==="saldo_negativo"?r.push({id:"saldo-negativo",gravedad:"critico",fecha:u.fecha,distancia:Math.abs(u.saldo),titulo:p=>p?"Podrías quedarte en números rojos":"Te quedas en números rojos",detalle:p=>`El ${p} el saldo proyectado baja a ${j(u.saldo)}.`}):u.tipo==="bajo_colchon"&&r.push({id:"bajo-colchon",gravedad:"aviso",fecha:u.fecha,distancia:Math.abs(u.saldo),titulo:p=>p?"Podrías bajar de tu colchón":"Bajas de tu colchón",detalle:p=>`El ${p} el saldo queda en ${j(u.saldo)}, por debajo del colchón.`});for(const u of t.crucesMargenes??[])u.tipo==="bajo_margen"&&r.push({id:`margen:${u.nombre}`,gravedad:"aviso",fecha:u.fecha,distancia:Math.max(0,u.target-u.saldo),titulo:p=>p?`Podrías bajar de «${u.nombre}»`:`Bajas de «${u.nombre}»`,detalle:p=>`El ${p} tendrías ${j(u.saldo)}, y el margen pide ${j(u.target)}.`});const l=new Map;for(const u of r){const p=l.get(u.id);(!p||u.fecha<p.fecha)&&l.set(u.id,u)}const d=[];for(const u of l.values()){const p=Ga(a,u.fecha);if(p<0||p>(u.gravedad==="critico"?o:s))continue;const y=i?i(p):0,g=y>0&&u.distancia<y;d.push({id:u.id,gravedad:u.gravedad,fecha:u.fecha,dias:p,plazo:Ua(p),titulo:u.titulo(g),detalle:u.detalle(Va(u.fecha,a)),incierto:g})}const b={critico:0,aviso:1};return d.sort((u,p)=>u.fecha.localeCompare(p.fecha)||b[u.gravedad]-b[p.gravedad]),d.slice(0,n)}const Hs=Object.freeze(Object.defineProperty({__proto__:null,colchonComoMargen:Ls,construirAvisos:ks,describirPlazo:Ua,diasEntreISO:Ga,fechaEnPalabras:Va},Symbol.toStringTag,{value:"Module"}));class Gs extends Error{constructor(a,o){super(`La funcionalidad "${a}" está desactivada; no se puede ${o}. Actívala en ⚙ Funcionalidades.`);ps(this,"featureId");this.name="FeatureDeshabilitadaError",this.featureId=a}}let te=null;function Vs(t){const e=te;return te=t,()=>{te=e}}function Ya(t){return te?te(t):!0}function Ja(t,e){if(!Ya(t))throw new Gs(t,e)}const Wa=[];function Le(){const t=new Map,e=new WeakMap;let a=1,o=0,s=0;const n=l=>{if(!l||typeof l!="object")return 0;const d=e.get(l);if(d)return d;const b=a++;return e.set(l,b),b},i=l=>l.map(d=>[d._id,d.capital,d.tin,d.meses,d.fechaInicio,d.comisionAmort||0,d.comisionApertura||0,d.diaPago||"",d.activo?1:0,d.cuenta||"",(d.amortizaciones||[]).map(b=>`${b.fecha}:${b.cantidad}:${b.tipo||""}`).sort().join(",")].join("|")).join(";");function r(l){const d=[i(l.loans),n(l.expenses),n(l.accounts),n(l.nominas),n(l.inflacionPeriodos),l.config.dashboardStart,l.config.dashboardEnd,l.config.fechaReferencia||"",l.config.usarInflacion?1:0,(l.filtroAccounts||[]).join(",")].join("#"),b=t.get(d);if(b)return s++,b;o++;const u=Xt(l);return t.set(d,u),u}return{statement:r,stats:()=>({hits:s,misses:o}),clear:()=>t.clear()}}function Be(t,e,a,o,s={},n=Le()){Ja("optimizador","calcular el plan de amortizaciones");const{frecuencia:i=1,mesesHorizonte:r=36,minAmortizable:l=500,tipoAmort:d="plazo",fechaPrimeraAmort:b=null,loanIds:u=null,nominas:p=Wa,sourceAccountId:y=null,selectedMarginIds:g=null,hoy:I=new Date}=s,A=V(I),v=Math.min(120,Math.max(1,r)),h=a.filter(O=>O.activo),f=h.map(O=>O._id),$=h.find(O=>O.esCuentaPrincipal)||h[0],m=y&&f.includes(y)?h.find(O=>O._id===y):$,x=m==null?void 0:m._id,S=t.filter(O=>O.activo&&!O.simulacion&&(!u||u.includes(O._id))).sort((O,H)=>H.tin-O.tin),w=!!g&&g.length>0,E=(o.margenesSeguridad||[]).filter(O=>O.activo!==!1).filter(O=>!O.cuentas||O.cuentas.length===0||O.cuentas.includes(x)).filter(O=>!w||g.includes(O._id));if(S.length===0)return{plan:[],margenesAplicados:E.length,totalAmortizado:0,totalComisiones:0,totalAhorroIntereses:0,resumenPorLoan:[]};const _={};for(const O of S)_[O._id]=[];const D=[];function C(O){const H=new Date(I.getFullYear(),I.getMonth()+O,1),U=H.getFullYear(),K=H.getMonth(),Q=`${U}-${String(K+1).padStart(2,"0")}`,st=V(new Date(U,K,Math.min(15,new Date(U,K+1,0).getDate())));return{label:Q,dia15:st}}function M(O,H){const U=[...O.amortizaciones||[],..._[O._id]],{tabla:K}=at({...O,amortizaciones:U}),Q=K.filter(nt=>nt.fecha<=H);if(Q.length>0)return Q[Q.length-1].capitalPendiente;const st=U.filter(nt=>nt.fecha<=H).reduce((nt,vt)=>nt+vt.cantidad,0);return Math.max(0,O.capital-st)}function z(O){const H=t.map(it=>({...it,amortizaciones:[...it.amortizaciones||[],..._[it._id]||[]]})),U={...o,dashboardStart:A,dashboardEnd:O},K=n.statement({loans:H,expenses:e,accounts:a,config:U,filtroAccounts:null,nominas:p}),Q=h.reduce((it,Yt)=>it+rt(Yt),0),st=m?rt(m):0,nt=Q>0?st/Q:1;let vt=st,pe=Q;for(const it of K){const Yt=it.delta??(it.tipo==="ingreso"?Math.abs(it.cuantia):-Math.abs(it.cuantia));it.cuenta===x?vt+=Yt:f.includes(it.cuenta)||(vt+=Yt*nt),pe=it.saldoAcum}return{source:vt,total:pe}}function F(O){const{source:H}=z(O);if(H<=0)return H;let U=0;for(const K of E){const Q=ge(K,e,o,t,O,!0,I);Q>U&&(U=Q)}return H-U}const T=2;let R=0;if(b){for(let O=0;O<v;O++)if(C(O).dia15>=b){R=O;break}}for(let O=0;O<v;O++){if((O-R)%i!==0||O<R)continue;const{label:H,dia15:U}=C(O);if(U<A)continue;const K=F(U)-T;if(K<l)continue;let Q=K,st=0;for(const nt of S){if(Q<l)break;const vt=M(nt,U);if(vt<1)continue;const pe=nt.comisionAmort||0,it=1+pe/100,Yt=Math.floor(Q/it),ds=Math.min(Yt,vt);if(ds<l)continue;const me=Math.min(Math.floor(ds),Math.floor(vt)),us=+(me*pe/100).toFixed(2),pa=me+us;pa>Q||(_[nt._id].push({_id:`opt_${H}_${nt._id}`,fecha:U,cantidad:me,tipo:d,simulacion:!0}),st+=pa,D.push({mes:H,fechaAmort:U,loanId:nt._id,loanNombre:nt.nombre,tin:nt.tin,capitalAntes:vt,cantidadAmort:me,comision:us,capitalDespues:Math.max(0,vt-me),saldoDisponible:K+T,excedente:K,saldoDespues:K+T-st,tipoAmort:d}),Q-=pa)}}const P=D.reduce((O,H)=>O+H.cantidadAmort,0),B=D.reduce((O,H)=>O+H.comision,0),L=S.map(O=>{const H=_[O._id];if(!H.length)return null;const U=at(O),K=at({...O,amortizaciones:[...O.amortizaciones||[],...H]});return{loanId:O._id,nombre:O.nombre,tin:O.tin,fechaFinSin:U.fechaFin,fechaFinCon:K.fechaFin,mesesAhorrados:U.mesesReales-K.mesesReales,interesesSin:U.totalIntereses,interesesCon:K.totalIntereses,ahorroIntereses:U.totalIntereses-K.totalIntereses,numAmortizaciones:H.length,totalAmortizado:H.reduce((Q,st)=>Q+st.cantidad,0)}}).filter(O=>O!==null),k=L.reduce((O,H)=>O+H.ahorroIntereses,0);return{plan:D,margenesAplicados:E.length,totalAmortizado:P,totalComisiones:B,totalAhorroIntereses:k,resumenPorLoan:L}}function Ka(t,e,a,o,s={},n){Ja("comparador-frecuencias","comparar frecuencias de amortización");const{horizonte:i=60,minAmortizable:r=500,tipoAmort:l="plazo",fechaObjetivo:d=null,frecuencias:b=[1,2,3,6,12],fechaPrimeraAmort:u=null,loanIds:p=null,nominas:y=Wa,sourceAccountId:g=null,selectedMarginIds:I=null,hoy:A=new Date}=s,v=n??Le(),h=V(A),f=d||V(new Date(A.getFullYear(),A.getMonth()+i,1));function $(S){const w=t.map(C=>({...C,amortizaciones:[...C.amortizaciones||[],...S[C._id]||[]]})),E={...o,dashboardStart:h,dashboardEnd:f},_=v.statement({loans:w,expenses:e,accounts:a,config:E,filtroAccounts:null,nominas:y});if(_.length===0)return a.filter(C=>C.activo).reduce((C,M)=>C+rt(M),0);const D=_.filter(C=>C.fecha<=f);return D.length>0?D[D.length-1].saldoAcum:_[0].saldoAcum}const m=$({}),x=b.map(S=>{const w=Be(t,e,a,o,{frecuencia:S,mesesHorizonte:i,minAmortizable:r,tipoAmort:l,fechaPrimeraAmort:u,loanIds:p,nominas:y,sourceAccountId:g,selectedMarginIds:I,hoy:A},v),E={};for(const D of t)E[D._id]=[];for(const D of w.plan)E[D.loanId].push({_id:D.mes+"_"+D.loanId,fecha:D.fechaAmort,cantidad:D.cantidadAmort,tipo:l,simulacion:!0});const _=$(E);return{frecuencia:S,label:S===1?"Mensual":`Cada ${S} meses`,numAmortizaciones:w.plan.length,totalAmortizado:w.totalAmortizado,totalComisiones:w.totalComisiones,ahorroIntereses:w.totalAhorroIntereses,saldoObjetivo:_,gananciaSaldo:_-m,valorTotal:w.totalAhorroIntereses+(_-m),plan:w.plan,resumenPorLoan:w.resumenPorLoan}}).filter(S=>S.numAmortizaciones>0);if(x.length>0){const S=Math.max(...x.map(_=>_.ahorroIntereses)),w=Math.max(...x.map(_=>_.saldoObjetivo)),E=Math.max(...x.map(_=>_.valorTotal));x.forEach(_=>{_.esMejorIntereses=_.ahorroIntereses===S,_.esMejorSaldo=_.saldoObjetivo===w,_.esMejorValor=_.valorTotal===E})}return{resultados:x,saldoBase:m,fechaObjetivo:f}}const Us=Object.freeze(Object.defineProperty({__proto__:null,compararFrecuencias:Ka,createStatementMemo:Le,defaultHoyISO:Y,optimizarAmortizaciones:Be},Symbol.toStringTag,{value:"Module"})),Ys=30.44*864e5;function Qa(t){const e=t.getFullYear(),a=t.getMonth();return{desde:V(new Date(e,a,1)),hasta:V(new Date(e,a,Ce(e,a)))}}function Xa(t){const[e,a]=t.split("-").map(Number);return Qa(new Date(e,a-1,1))}function Js(t,e){return Math.max(1,(G(e).getTime()-G(t).getTime())/Ys)}const Ws=t=>t.filter(e=>e.sourceType!=="transfer-out"&&e.sourceType!=="transfer-in"),Mt=t=>t.reduce((e,a)=>e+Math.abs(a.cuantia),0);function Ks(t,e){const a=new Map(e.map(n=>[n._id,n.clasificacion]));let o=0,s=0;for(const n of t){if(n.tipo!=="gasto"||n.sourceType!=="expense")continue;const i=a.get(n.sourceId??"");i!==null&&(i==="deseo"?s+=Math.abs(n.cuantia):o+=Math.abs(n.cuantia))}return{basicos:o,deseo:s}}function Qs(t,e){const a=e.entreMeses&&e.entreMeses>0?e.entreMeses:1,o=p=>p.sourceType==="loan"&&p.tipo==="gasto",s=e.loanIdsIniciados,n=Mt(t.filter(p=>p.tipo==="ingreso")),i=Mt(t.filter(p=>o(p)&&(!s||s.has(p.sourceId??"")))),r=Mt(t.filter(p=>o(p)&&e.hipotecaIds.has(p.sourceId??""))),l=Mt(t.filter(p=>p.sourceType==="loan-amort")),d=Mt(t.filter(p=>p.sourceType==="account-interest")),{basicos:b,deseo:u}=Ks(t,e.expenses);return{ingresos:n/a,cuotas:i/a,cuotasHipoteca:r/a,amortizaciones:l/a,gastosBasicos:b/a,gastosDeseo:u/a,gastosTotales:(i+b+u)/a,intereses:d/a}}function Za(t,e){return t.reduce((a,o)=>{const s=at(o).tabla.filter(n=>!n.esAmortizacion&&n.fecha<=e);return a+(s.length>0?s[s.length-1].capitalPendiente:o.capital||0)},0)}function Xs(t,e,a,o){const s=t.filter(d=>d.activo&&!d.simulacion&&(d.fechaInicio||"")<=a),n=s.reduce((d,b)=>{if((b.amortizaciones||[]).filter(g=>g.fecha>=e&&g.fecha<=a).length===0)return d;const p=at(b).totalIntereses,y=at({...b,amortizaciones:(b.amortizaciones||[]).filter(g=>g.fecha<e||g.fecha>a)}).totalIntereses;return d+Math.max(0,y-p)},0),i=s.filter(d=>d.mostrarFechaFinEnDashboard!==!1).map(d=>({loan:d,fechaFin:at(d).fechaFin})).filter(d=>!!d.fechaFin&&d.fechaFin>=e&&d.fechaFin<=a),r=s.map(d=>at(d).tabla),l=d=>{const{desde:b,hasta:u}=Xa(d);return r.reduce((p,y)=>{const g=y.find(I=>!I.esAmortizacion&&I.fecha>=b&&I.fecha<=u);return p+(g?g.cuota:0)},0)};return{deudaInicio:Za(s,e),deudaFin:Za(s,a),ahorroIntereses:n,ahorroInteresesMes:o>0?n/o:0,cuotasInicio:l(e.slice(0,7)),cuotasFin:l(a.slice(0,7)),finEnPeriodo:i}}function Zs(t,e){return e.filter(a=>a.activo&&(a.interes??0)>0).map(a=>({nombre:a.nombre,interes:a.interes,total:Mt(t.filter(o=>o.sourceType==="account-interest"&&o.sourceId===a._id))})).filter(a=>a.total>0).sort((a,o)=>o.total-a.total)}function to(t,e=new Set,a="desglosado"){if(e.size===0)return Ba(t,"gasto");const o=new Map;for(const s of t){if(s.tipo!=="gasto")continue;const n=s.tags||[],i=n.filter(d=>e.has(d)),r=n.filter(d=>!e.has(d)),l=a==="porgrupos"&&i.length>0?i:r;for(const d of l)o.set(d,(o.get(d)||0)+Math.abs(s.cuantia))}return o}function tn(t,e={}){const a=e.activos,o=e.entreMeses&&e.entreMeses>0?e.entreMeses:1;return[...to(t,e.grupoTags,e.modo).entries()].filter(([s])=>!a||a.size===0||a.has(s)).map(([s,n])=>({tag:s,total:n/o})).sort((s,n)=>n.total-s.total)}function en(t,e){const a=e.reduce((o,s)=>o+rt(s),0);return{saldoBase:a,saldoFinal:t.length>0?t[t.length-1].saldoAcum??a:a,totalGastos:Mt(t.filter(o=>o.tipo==="gasto")),totalIngresos:Mt(t.filter(o=>o.tipo==="ingreso")),tags:[...new Set(t.flatMap(o=>o.tags||[]))]}}function an(t,e){return t.filter(a=>a.activo&&(!e||e.length===0||e.includes(a._id)))}function on(t,e="hipoteca"){return new Set(t.filter(a=>(a.tags||[]).includes(e)).map(a=>a._id))}function sn(t,e){return new Set(t.filter(a=>(a.fechaInicio||"")<=e).map(a=>a._id))}function nn(t,e){if(t.length===0)return[];const a=d=>e==="mes"?d.slice(0,7):d.slice(0,4),o=d=>e==="mes"?`${d}-01`:`${d}-01-01`,s=t[0],n=s.delta??(s.tipo==="ingreso"?Math.abs(s.cuantia):-Math.abs(s.cuantia));let i=(s.saldoAcum??0)-n;const r=[];let l=null;for(const d of t){const b=a(d.fecha),u=d.saldoAcum??i;(!l||l.periodo!==b)&&(l&&(i=l.cierre),l={periodo:b,inicio:o(b),apertura:i,cierre:u,maximo:Math.max(i,u),minimo:Math.min(i,u),eventos:0},r.push(l)),l.cierre=u,u>l.maximo&&(l.maximo=u),u<l.minimo&&(l.minimo=u),l.eventos+=1}return r}const rn=Object.freeze(Object.defineProperty({__proto__:null,agruparOHLC:nn,cuentasVisibles:an,gastoPorTagOrdenado:tn,idsHipoteca:on,idsPrestamosIniciados:sn,interesesPorCuenta:Zs,mesesDelPeriodo:Js,metricasFlujo:Qs,rangoMes:Xa,rangoMesDe:Qa,resumenPrestamosPeriodo:Xs,sinTransferencias:Ws,sumarGastosPorTag:to,totalesPeriodo:en},Symbol.toStringTag,{value:"Module"}));function ln(t,e,a){const o=t||[];if(!o.length)return e;const s=o.find(i=>i.año===a);if(s)return s.tramos;const n=o.filter(i=>i.año<a).sort((i,r)=>r.año-i.año);return n.length?n[0].tramos:e}function bt(t,e){return a=>ln(t,e,a)}const ee=8,eo=[[0,19],[12450,24],[20200,30],[35200,37],[6e4,45],[3e5,47]],ao=[[0,19],[6e3,21],[5e4,23],[2e5,27],[3e5,28]];function ke(t){return{_id:"default",nombre:"Default",descripcion:"Cuenta principal",saldo:0,saldoInicial:0,fechaInicialSaldo:t,historicoSaldos:[],interes:0,periodoCobro:"mensual",activo:!0,simulacion:!1,esCuentaPrincipal:!0,modeloFondo:"cuenta",aportaciones:[],planAportaciones:[],escenarioIds:[]}}function oo(t,e){return{dashboardStart:t,dashboardEnd:e,fechaReferencia:t,colchonMeses:6,colchonTipo:"meses",colchonFijo:0,colchonPuntos:[],showColchon:!0,margenesSeguridad:[],usarInflacion:!1,tramos_irpf:eo,tramosGananciasCapital:ao,showExecSummary:!0,showCriticos:!0,showHistorico:!0,histCuenta:"",analisisCollapsed:!1,activeTagsFilter:[],tagCategorias:[],tagGrupos:[],saludUmbralAhorroVerde:20,saludUmbralAhorroAmarillo:10,saludUmbralDTIVerde:30,saludUmbralDTIAmarillo:40,saludRegla:[50,30,20],saludExcluirHipoteca:!1,saludTagHipoteca:"hipoteca",storageMode:"local",autoSave:!1,autoSaveInterval:15,autoLogoutMinutos:0,onboardingDone:!1,escenarioActivo:null,features:{}}}function so(t,e){return{loans:[],expenses:[],accounts:[ke(t)],nominas:[],goals:[],planes:[],transacciones:[],puntosControl:[],inflacion:[],tramosIRPFHistorico:[],tramosGananciasCapitalHistorico:[],escenarios:[],config:oo(t,e)}}const ht=t=>Array.isArray(t)?t:[],cn=t=>t&&typeof t=="object"&&!Array.isArray(t)?t:{};function ae(t){if(Array.isArray(t.escenarioIds))return t;const e=t.escenarioId?[t.escenarioId]:[],{escenarioId:a,...o}=t;return{...o,escenarioIds:e}}function no(t){if(!t||typeof t!="string")return"";if(t.startsWith("dia:")||t.startsWith("nthweekday:"))return t;if(t==="ultimo")return"dia:ultimo";if(t==="primer-lunes")return"nthweekday:1:1";const e=parseInt(t);return isNaN(e)?"":`dia:${e}`}function He(t){const{varianza:e,inflacion:a,...o}=t;return o}function dn(t,e){const{hoyISO:a,finISO:o}=e,s={...t},n=cn(t.config),r={...oo(a,o)};for(const[b,u]of Object.entries(n))u!=null&&(r[b]=u);delete r.saldoInicial,delete r.saldoInicialFecha,delete r.inflacionGlobal,delete r.showMC,delete r.mcIteraciones,(!Array.isArray(r.tramos_irpf)||r.tramos_irpf.length===0)&&(r.tramos_irpf=eo),(!Array.isArray(r.tramosGananciasCapital)||r.tramosGananciasCapital.length===0)&&(r.tramosGananciasCapital=ao),(!Array.isArray(r.saludRegla)||r.saludRegla.length!==3)&&(r.saludRegla=[50,30,20]),(typeof r.features!="object"||r.features===null||Array.isArray(r.features))&&(r.features={}),s.config=r;let l=ht(t.accounts).map(b=>{const u={saldoInicial:0,fechaInicialSaldo:a,historicoSaldos:[],interes:0,periodoCobro:"mensual",activo:!0,simulacion:!1,esCuentaPrincipal:!1,aportaciones:[],planAportaciones:[],bloqueoMeses:120,impuestoRetirada:0,grupoNomina:"",...b};return u.modeloFondo||(u.modeloFondo=u.esFondoPension?"pension":"cuenta"),delete u.esFondoPension,Array.isArray(u.historicoSaldos)||(u.historicoSaldos=[]),ae(u)});l.length===0&&(l=[ke(a)]);const d=l.filter(b=>b.esCuentaPrincipal);if(d.length===0){const b=l.find(u=>u._id==="default")||l[0];l=l.map(u=>({...u,esCuentaPrincipal:u._id===b._id}))}else if(d.length>1){let b=!1;l=l.map(u=>u.esCuentaPrincipal?b?{...u,esCuentaPrincipal:!1}:(b=!0,u):u)}return s.accounts=l,s.expenses=ht(t.expenses).map(b=>{const u={basico:!1,activo:!0,tags:[],historialPrecios:[],...b};return Array.isArray(u.tags)||(u.tags=[]),Array.isArray(u.historialPrecios)||(u.historialPrecios=[]),u.diaPago=no(u.diaPago),He(ae(u))}),s.loans=ht(t.loans).map(b=>{const u={tipoTasa:"fijo",mostrarFechaFinEnDashboard:!0,basico:!0,tags:[],activo:!0,amortizaciones:[],...b};return Array.isArray(u.tags)||(u.tags=[]),u.diaPago=no(u.diaPago),u.amortizaciones=ht(u.amortizaciones).map(p=>ae(p)),He(ae(u))}),s.nominas=ht(t.nominas).map(b=>{const u={activo:!0,nPagas:12,irpfModo:"auto",irpfPct:0,bruto:0,representacion:"detallado",tags:[],fechaFin:null,cuenta:"default",grupoNomina:"",mesActualizacionIPC:null,retribucionFlexible:[],...b};return Array.isArray(u.tags)||(u.tags=[]),Array.isArray(u.retribucionFlexible)||(u.retribucionFlexible=[]),He(ae(u))}),s.goals=ht(t.goals).map((b,u)=>{const p=Array.isArray(b.cuentaIds)?b.cuentaIds:b.cuentaId?[b.cuentaId]:[],{cuentaId:y,...g}=b;return{prioridad:u+1,completado:!1,usarColchon:!0,targetAmount:0,...g,cuentaIds:p}}),s.inflacion=ht(t.inflacion),s.tramosIRPFHistorico=ht(t.tramosIRPFHistorico),s.tramosGananciasCapitalHistorico=ht(t.tramosGananciasCapitalHistorico),s.escenarios=ht(t.escenarios).map(({inversiones:b,...u})=>u),s}const qt=t=>Array.isArray(t)?t:[];let Ge=0;function un(t){return Ge+=1,`${t}_${Ge.toString(36)}`}const pn=t=>typeof t=="string"&&/^\d{4}-\d{2}-\d{2}$/.test(t),mn=t=>typeof t=="number"&&Number.isFinite(t);function fn(t,e){const a={...t};Ge=0;const o=qt(t.transacciones),s=qt(t.puntosControl),n=[...s],i=new Set(s.map(d=>`${d.cuentaId}|${d.fecha}`)),r=(d,b,u,p)=>{if(!pn(b)||!mn(u))return;const y=`${d}|${b}`;i.has(y)||(i.add(y),n.push({_id:un("pc"),fecha:b,cuentaId:d,saldoCts:It(u),...typeof p=="string"&&p?{nota:p}:{}}))};for(const d of qt(t.accounts)){const b=typeof d._id=="string"?d._id:null;if(b)for(const u of qt(d.historicoSaldos))r(b,u.fecha,u.saldo,u.nota)}const l=qt(t.history);if(l.length>0){const d=qt(t.accounts),b=d.find(p=>p.esCuentaPrincipal)||d.find(p=>p.activo)||d[0],u=typeof(b==null?void 0:b._id)=="string"?b._id:"default";for(const p of l){const y=typeof p.cuenta=="string"?p.cuenta:typeof p.cuentaId=="string"?p.cuentaId:u;r(y,p.fecha,p.saldo,p.nota)}}return delete a.history,a.transacciones=o,a.puntosControl=n.sort((d,b)=>String(d.fecha).localeCompare(String(b.fecha))),a}const Ve=t=>Array.isArray(t)?t:[],vn=t=>typeof t=="string"&&/^\d{4}-\d{2}-\d{2}$/.test(t),gn=t=>typeof t=="number"&&Number.isFinite(t)&&t>0;let Ue=0;function bn(){return Ue+=1,`tx_hp_${Ue.toString(36)}`}function hn(t,e){const a={...t};Ue=0;const o=[...Ve(t.transacciones)],s=new Set(o.map(i=>`${i.estimacionId}|${i.fecha}|${i.importeCts}`)),n=Ve(t.expenses).map(i=>{const r=Ve(i.historialPrecios),l=typeof i._id=="string"?i._id:null,d=typeof i.cuenta=="string"&&i.cuenta?i.cuenta:"default",b=i.tipo==="ingreso"?"ingreso":"gasto",u=Array.isArray(i.tags)?i.tags.filter(g=>typeof g=="string"):[];if(l)for(const g of r){if(!g||!vn(g.fecha)||!gn(g.cuantia))continue;const I=b==="ingreso"?It(g.cuantia):-It(g.cuantia),A=`${l}|${g.fecha}|${I}`;s.has(A)||(s.add(A),o.push({_id:bn(),fecha:g.fecha,cuentaId:d,importeCts:I,concepto:typeof i.concepto=="string"?i.concepto:"Movimiento",tags:u,estimacionId:l,tipo:b,origen:"importado",nota:typeof g.nota=="string"&&g.nota?g.nota:"Importado del historial de precios"}))}const{historialPrecios:p,...y}=i;return y});return a.expenses=n,a.transacciones=o.sort((i,r)=>String(i.fecha).localeCompare(String(r.fecha))),a}const io=t=>Array.isArray(t)?t:[],wt=(t,e="")=>typeof t=="string"&&t.trim()?t:e,Lt=(t,e=0)=>typeof t=="number"&&Number.isFinite(t)?t:e,yn=t=>typeof t=="string"&&/^\d{4}-\d{2}/.test(t)?t.slice(0,7):null;function xn(t,e){var b;const a={...t};if(Array.isArray(a.planes))return a;const o=io(a.goals),s=io(a.accounts),n=s.map(u=>{const p=Lt(u.bloqueoMeses,0);return{_id:`veh_${wt(u._id,"x")}`,nombre:wt(u.nombre,"Cuenta"),rentabilidadRealAnual:Lt(u.interes,0)/100,liquidez:u.modeloFondo==="pension"?"BLOQUEADA_HASTA_JUBILACION":p>0?"MEDIA":"INMEDIATA",fiscalidadRetirada:Lt(u.impuestoRetirada,0)/100,topeAportacionAnual:u.modeloFondo==="pension"?It(1500):null,riesgo:u.modeloFondo==="pension"?"MEDIO":"NULO",cuentaId:wt(u._id,""),prestamoId:null,esDeuda:!1,revisarRentabilidad:Lt(u.interes,0)>0}}),i=new Map(s.map((u,p)=>[wt(u._id,""),n[p]._id])),r=((b=n[0])==null?void 0:b._id)??"",l=o.map((u,p)=>{const y=Array.isArray(u.cuentaIds)?u.cuentaIds.map(I=>wt(I,"")):[],g=yn(u.targetDate);return{_id:wt(u._id,`obj_mig_${p}`),nombre:wt(u.nombre,`Objetivo ${p+1}`),tipo:"AHORRO_OBJETIVO",importeObjetivo:It(Lt(u.targetAmount,0)),fechaLimite:g,prioridad:Lt(u.prioridad,p+1),modoAsignacion:g?"CUOTA_POR_FECHA":"ABSORBE_TODO",vehiculoId:i.get(y[0])??r,saldoActual:0,estado:u.completado===!0?"COMPLETADO":"PENDIENTE",notas:wt(u.notas,"")}}),d={_id:"plan_base",nombre:"Plan base",fechaInicio:e.hoyISO.slice(0,7),horizonteMeses:480,pctDisfrute:0,notas:o.length>0?"Creado al migrar los objetivos de ahorro anteriores. Revisa los saldos de partida y las rentabilidades reales.":"",activo:!0,perfil:{netoMensual:0,gastosFijosMensuales:0,manual:!1},vehiculos:n,objetivos:l,eventos:[],creadoEn:e.hoyISO};return a.planes=[d],a}const $n=[{version:5,describe:"Formaliza el esquema; limpia restos de features eliminadas; añade config.features",migrate:dn},{version:6,describe:"Contabilidad real: crea transacciones y puntosControl (importa historicoSaldos y la clave history)",migrate:fn},{version:7,describe:"Retira historialPrecios: cada entrada pasa a ser una transacción real enlazada a su estimación",migrate:hn},{version:8,describe:"Gestor de objetivos: absorbe `goals` dentro de un Plan, con un vehículo por cuenta",migrate:xn}],In=["history"];function ro(t,e,a){let o=t;const s=[];for(const n of[...$n].sort((i,r)=>i.version-r.version))(e??0)>=n.version||(o=n.migrate(o,a),s.push(n.version));return{state:o,applied:s}}const Bt="state_",Ye="state__schemaVersion",lo="financeapp_",co="state__modificadoEn";function An(t=localStorage,e=lo){const a=o=>`${e}${o}`;return{get(o){try{const s=t.getItem(a(o));return s===null?null:JSON.parse(s)}catch{return null}},set(o,s){try{t.setItem(a(o),JSON.stringify(s)),o!==co&&t.setItem(a(co),JSON.stringify(Date.now()))}catch(n){console.error("No se pudo guardar en localStorage:",o,n)}},remove(o){try{t.removeItem(a(o))}catch{}},keys(){const o=[];for(let s=0;s<t.length;s++){const n=t.key(s);n!=null&&n.startsWith(e)&&o.push(n.slice(e.length))}return o}}}function Sn(t=localStorage,e=lo){const a=[];for(let s=0;s<t.length;s++){const n=t.key(s);n!=null&&n.startsWith(Bt)&&!n.startsWith(e)&&a.push(n)}const o=[];for(const s of a)try{const n=t.getItem(s);n!==null&&t.getItem(`${e}${s}`)===null&&(t.setItem(`${e}${s}`,n),o.push(s)),t.removeItem(s)}catch{}return o}function Mn({ventanaMs:t=15e3,ahora:e=()=>Date.now()}={}){let a=null;function o(){return a?e()-a.cuando>t?(a=null,null):a:null}return{registrar(s){a={...s,cuando:e()}},pendiente:o,tomar(){const s=o();return a=null,s},limpiar(){a=null}}}const wn={expenses:{articulo:"El",que:"gasto"},accounts:{articulo:"La",que:"cuenta"},loans:{articulo:"El",que:"préstamo"},nominas:{articulo:"La",que:"nómina"},escenarios:{articulo:"El",que:"supuesto"},planes:{articulo:"El",que:"plan"},goals:{articulo:"El",que:"objetivo"},inflacion:{articulo:"El",que:"periodo de inflación"},transacciones:{articulo:"El",que:"movimiento"},puntosControl:{articulo:"El",que:"punto de control"}};function Cn(t,e){const a=wn[t]??{articulo:"El",que:"elemento"},o=e.concepto??e.nombre??e.titulo??(e.year!==void 0?String(e.year):null);return o?`${a.articulo} ${a.que} «${String(o)}»`:`${a.articulo} ${a.que}`}function jn(t){return V(new Date(t.getFullYear()+1,t.getMonth(),t.getDate()))}function En({adapter:t,hoy:e=new Date}){const a=V(e),o=jn(e);let s=so(a,o);const n=new Set;let i=[];const r=Mn();function l(C){for(const M of n)M(C)}function d(C){t.set(`${Bt}${C}`,s[C])}function b(){const C={};for(const T of Object.keys(s)){const R=t.get(`${Bt}${T}`);R!==null&&(C[T]=R)}for(const T of In){const R=t.get(`${Bt}${T}`);R!==null&&(C[T]=R)}const M=t.get(Ye),{state:z,applied:F}=ro(C,M,{hoyISO:a,finISO:o});if(s=z,u(),F.length>0){for(const T of Object.keys(s))d(T);t.set(Ye,ee)}return i=F,{applied:F}}function u(){if(!Array.isArray(s.accounts)||s.accounts.length===0){s.accounts=[ke(a)],d("accounts");return}const C=s.accounts.filter(M=>M.esCuentaPrincipal);if(C.length===0)s.accounts=s.accounts.map((M,z)=>z===0?{...M,esCuentaPrincipal:!0}:M),d("accounts");else if(C.length>1){let M=!1;s.accounts=s.accounts.map(z=>z.esCuentaPrincipal?M?{...z,esCuentaPrincipal:!1}:(M=!0,z):z),d("accounts")}}function p(C){return s[C]}function y(C,M){s[C]=M,d(C),l(C)}function g(C){y("config",{...s.config,...C})}function I(C){return n.add(C),()=>n.delete(C)}function A(){return Date.now().toString(36)+Math.random().toString(36).slice(2,7)}function v(C,M){const z=[...s[C]],F={...M,_id:A()};return z.push(F),y(C,z),F}function h(C,M,z){const F=s[C].map(T=>T._id===M?{...T,...z}:T);y(C,F)}function f(C,M){const z=s[C],F=z.findIndex(T=>T._id===M);F<0||(r.registrar({col:C,item:z[F],indice:F}),y(C,z.filter((T,R)=>R!==F)))}function $(){const C=r.tomar();if(!C)return null;const M=[...s[C.col]];return M.splice(Math.min(C.indice,M.length),0,C.item),y(C.col,M),C}function m(){return r.pendiente()}function x(){const C=s.accounts||[],M=C.find(z=>z.esCuentaPrincipal&&z.activo)||C.find(z=>z.activo);return M?M._id:"default"}function S(C){var M;return((M=s.accounts.find(z=>z._id===C))==null?void 0:M.nombre)??C}function w(){return bt(s.tramosIRPFHistorico,s.config.tramos_irpf)}function E(){return bt(s.tramosGananciasCapitalHistorico,s.config.tramosGananciasCapital)}function _(){return structuredClone(s)}function D(C,M=null){const{state:z,applied:F}=ro(C,M,{hoyISO:a,finISO:o});s=z,u();for(const T of Object.keys(s))d(T);t.set(Ye,ee);for(const T of Object.keys(s))l(T);return{applied:F}}return{load:b,get:p,set:y,patchConfig:g,subscribe:I,addItem:v,updateItem:h,removeItem:f,deshacerBorrado:$,borradoPendiente:m,getPrincipalAccountId:x,accountName:S,resolverTramosIRPF:w,resolverTramosGanancias:E,snapshot:_,replaceAll:D,get schemaVersion(){return ee},get migrationsApplied(){return[...i]},get today(){return a||Y()}}}function zn(){let t=0,e=null;const a=new Set;function o(s){t+=1,e=s;for(const n of a)try{n(t,s)}catch(i){console.error("[cambios] un suscriptor ha fallado:",i)}return t}return{revision:()=>t,ultimoOrigen:()=>e,marcar:o,suscribir(s){return a.add(s),()=>a.delete(s)},crearMarca(s){let n=t;return{nombre:s,pendiente:()=>t>n,alDia:i=>{n=Math.max(n,i??t)},vista:()=>n}}}}const oe=Object.keys(so("1970-01-01","1970-01-01"));function uo(t){const e={};for(const a of oe){const o=t.get(`${Bt}${a}`);o!=null&&(e[a]=o)}return e}function _n(t,e){const a=[];for(const o of oe){const s=e[o];s!=null&&(t(`${Bt}${o}`,s),a.push(o))}return a}function Fn(t){return oe.filter(e=>t[e]===void 0||t[e]===null)}function Pn(t){var i,r;const e=l=>{const d=t[l];return Array.isArray(d)?d:[]};if(!oe.filter(l=>l!=="config"&&l!=="accounts"&&l!=="planes").every(l=>e(l).length===0))return!1;const o=e("planes");return o.length===0||o.length===1&&((i=o[0])==null?void 0:i._id)==="plan_base"&&!(Array.isArray((r=o[0])==null?void 0:r.objetivos)&&o[0].objetivos.length>0)?e("accounts").every(l=>l._id==="default"&&!(typeof l.saldoInicial=="number"&&l.saldoInicial!==0)&&!(Array.isArray(l.historicoSaldos)&&l.historicoSaldos.length>0)):!1}const X={nucleo:"Esenciales",dinero:"Mi dinero",planificacion:"Planificación",analisis:"Análisis del dashboard",datos:"Datos y sincronización"},Ct=[{id:"dashboard",nombre:"Dashboard",descripcion:"Saldo actual, extracto proyectado y evolución. No se puede desactivar.",grupo:X.nucleo,porDefecto:!0,nucleo:!0},{id:"expenses",nombre:"Gastos e ingresos",descripcion:"Estimaciones recurrentes y extraordinarias, transferencias entre cuentas y etiquetas.",grupo:X.dinero,porDefecto:!0},{id:"loans",nombre:"Préstamos",descripcion:"Tablas de amortización, TAE y amortizaciones anticipadas.",grupo:X.dinero,porDefecto:!0},{id:"nominas",nombre:"Nóminas",descripcion:"Salarios con IRPF por tramos, pagas extra y retribución flexible.",grupo:X.dinero,porDefecto:!0},{id:"accounts",nombre:"Cuentas y ahorro",descripcion:"Cuentas, fondos de inversión, planes de pensiones y puntos de control de saldo.",grupo:X.dinero,porDefecto:!0},{id:"goals",nombre:"Objetivos de ahorro (antiguos)",descripcion:"Solo lectura: la copia previa al planificador. Los objetivos se gestionan en «Objetivos financieros». Apagada de fábrica; enciéndela si quieres revisar los antiguos antes de descartarlos.",grupo:X.dinero,porDefecto:!1,dependencias:["accounts"]},{id:"contabilidad",nombre:"Contabilidad real",descripcion:"Registro de gastos e ingresos reales y análisis de precisión de las estimaciones.",grupo:X.dinero,porDefecto:!0,dependencias:["accounts"]},{id:"supuestos",nombre:"Supuestos",descripcion:"Puntos de guardado sobre los que probar cambios, con biblioteca revisitable.",grupo:X.planificacion,porDefecto:!0},{id:"inflacion",nombre:"Inflación",descripcion:"Tasas anuales de IPC que encarecen los gastos y erosionan el ahorro.",grupo:X.planificacion,porDefecto:!1},{id:"fiscalidad",nombre:"Fiscalidad",descripcion:"Simulador de la declaración de la renta y tablas de tramos por ejercicio.",grupo:X.planificacion,porDefecto:!1},{id:"margenes",nombre:"Márgenes de seguridad",descripcion:"Umbrales mínimos de saldo por cuenta, con avisos al cruzarlos.",grupo:X.planificacion,porDefecto:!1},{id:"planner",nombre:"Objetivos financieros",descripcion:"Plan a largo plazo: objetivos que compiten por el flujo mensual y se encadenan al completarse.",grupo:X.planificacion,porDefecto:!0},{id:"optimizador",nombre:"Optimizador de amortizaciones",descripcion:"Planifica amortizaciones anticipadas con el excedente disponible cada mes.",grupo:X.planificacion,porDefecto:!1,dependencias:["loans"]},{id:"comparador-frecuencias",nombre:"Comparador de frecuencias",descripcion:"Compara amortizar cada mes, cada trimestre, etc. por ahorro de intereses.",grupo:X.planificacion,porDefecto:!1,dependencias:["optimizador"]},{id:"resumen-ejecutivo",nombre:"Resumen ejecutivo",descripcion:"Titulares del periodo: ingresos, gastos, ahorro y saldo final estimado.",grupo:X.analisis,porDefecto:!0},{id:"velas-saldo",nombre:"Velas del saldo",descripcion:"Apertura, cierre, máximo y mínimo del saldo por mes o por año.",grupo:X.analisis,porDefecto:!0},{id:"graficos-etiquetas",nombre:"Gráficos por etiqueta",descripcion:"Reparto y media mensual del gasto por etiqueta, con grupos de etiquetas.",grupo:X.analisis,porDefecto:!0},{id:"puntos-criticos",nombre:"Puntos críticos",descripcion:"Avisos de saldo negativo o por debajo del colchón en la proyección.",grupo:X.analisis,porDefecto:!0},{id:"precision-estimaciones",nombre:"Precisión de estimaciones",descripcion:"Acierto de cada estimación frente al gasto real, con ajuste sugerido.",grupo:X.analisis,porDefecto:!0,dependencias:["contabilidad","expenses"]},{id:"sync-nube",nombre:"Sincronización en la nube",descripcion:"Copia cifrada en Firebase o Dropbox, además del almacenamiento local.",grupo:X.datos,porDefecto:!0},{id:"autoguardado",nombre:"Autoguardado",descripcion:"Sube una copia a la nube cada cierto intervalo automáticamente.",grupo:X.datos,porDefecto:!1,dependencias:["sync-nube"]}],Dn=new Map(Ct.map(t=>[t.id,t]));function se(t){return Dn.get(t)}function po(t){return Ct.filter(e=>(e.dependencias||[]).includes(t))}function Je(){const t={};for(const e of Ct)t[e.id]=e.porDefecto;return t}function mo(){const t=[],e=new Map;for(const a of Ct)e.has(a.grupo)||(e.set(a.grupo,[]),t.push(a.grupo)),e.get(a.grupo).push(a);return t.map(a=>({grupo:a,features:e.get(a)}))}function Tn(t){function e(){return{...Je(),...t.get("config").features||{}}}function a(u){t.patchConfig({features:u})}function o(u,p=e(),y=new Set){const g=se(u);if(!g)return!1;if(g.nucleo)return!0;if(p[u]===!1)return!1;if(y.has(u))return!0;y.add(u);for(const I of g.dependencias||[])if(!o(I,p,y))return!1;return!0}function s(u,p=e()){const y=se(u);return y?(y.dependencias||[]).filter(g=>!o(g,p)):[]}function n(u,p){var f;const y=se(u);if(!y)return{cambiadas:[]};if(y.nucleo)return{cambiadas:[],motivo:"nucleo-inmutable"};const g=e(),I=new Map(Ct.map($=>[$.id,o($.id,g)])),A={...g,[u]:p};let v;if(p){const $=[...y.dependencias||[]];for(;$.length;){const m=$.pop();A[m]===!1&&(A[m]=!0,v="dependencias-activadas"),$.push(...((f=se(m))==null?void 0:f.dependencias)||[])}}else{const $=po(u).map(m=>m.id);for(;$.length;){const m=$.pop();A[m]!==!1&&(A[m]=!1,v="cascada-apagado"),$.push(...po(m).map(x=>x.id))}}return a(A),{cambiadas:Ct.filter($=>o($.id,A)!==I.get($.id)).map($=>$.id),motivo:v}}function i(){const u=e();return Ct.map(p=>{const y=s(p.id,u);return{...p,activa:o(p.id,u),...y.length>0&&u[p.id]!==!1?{bloqueadaPor:y}:{}}})}function r(){const u=e();return mo().map(({grupo:p,features:y})=>({grupo:p,features:y.map(g=>{const I=s(g.id,u);return{...g,activa:o(g.id,u),...I.length>0&&u[g.id]!==!1?{bloqueadaPor:I}:{}}})}))}function l(){a(Je())}function d(u){return{_app:"financeapp",_tipo:"feature-profile",_v:1,...u?{nombre:u}:{},features:e()}}function b(u){const p=u,y=p&&typeof p=="object"&&p.features&&typeof p.features=="object"?p.features:null;if(!y)throw new Error('El perfil no tiene una sección "features" válida');const g=Je(),I=[],A=[];for(const[v,h]of Object.entries(y)){if(!se(v)){A.push(v);continue}if(typeof h!="boolean"){A.push(v);continue}g[v]=h,I.push(v)}return a(g),{aplicadas:I,ignoradas:A}}return{isEnabled:u=>o(u),setEnabled:n,estado:i,estadoPorGrupo:r,reset:l,exportProfile:d,importProfile:b,bloqueadaPor:u=>s(u)}}const ne=t=>t.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;");function kt(t,e,a="ok"){if(t.notify)return t.notify(e,a);const o=globalThis.UI;if(o!=null&&o.toast)return o.toast(e,a);console.info("[FinanceApp]",e)}function Nn(t){var s,n;const a=(((s=t.bloqueadaPor)==null?void 0:s.length)??0)>0?`<div style="font-size:11px;color:var(--yellow);margin-top:3px">Requiere: ${(n=t.bloqueadaPor)==null?void 0:n.map(ne).join(", ")}</div>`:"",o=t.nucleo?'<span style="font-size:10px;color:var(--text3);border:1px solid var(--border2);border-radius:3px;padding:1px 5px;margin-left:6px">siempre activa</span>':"";return`
    <div style="display:flex;gap:12px;align-items:flex-start;padding:9px 0;border-bottom:1px solid var(--border)">
      <label class="toggle" style="margin-top:2px">
        <input type="checkbox" data-feature-toggle="${ne(t.id)}" ${t.activa?"checked":""} ${t.nucleo?"disabled":""}/>
        <span class="toggle-slider"></span>
      </label>
      <div style="flex:1;min-width:0">
        <div style="font-size:13px;color:var(--text);font-weight:500">${ne(t.nombre)}${o}</div>
        <div style="font-size:12px;color:var(--text2);line-height:1.5;margin-top:2px">${ne(t.descripcion)}</div>
        ${a}
      </div>
    </div>`}function Rn(t){return`
    ...
    <div style="max-height:min(58vh,520px);overflow-y:auto;padding-right:4px">${t.estadoPorGrupo().map(({grupo:o,features:s})=>`
      <div style="margin-bottom:18px">
        <div class="card-title" style="margin-bottom:6px">${ne(o)}</div>
        ${s.map(Nn).join("")}
      </div>`).join("")}</div>
    ...
    <input type="file" data-feature-file accept=".json" style="display:none"/>`}function On(t){var s;const e=t.getElementById("modal-overlay"),a=t.getElementById("modal-content");if(e&&a)return{overlay:e,content:a,cerrar:()=>e.classList.add("hidden")};let o=t.getElementById("fa-features-overlay");return o||(o=t.createElement("div"),o.id="fa-features-overlay",o.className="modal-overlay",o.innerHTML='<div class="modal-box"><button class="modal-close" data-feature-close>×</button><div id="fa-features-content"></div></div>',t.body.appendChild(o),o.addEventListener("click",n=>{n.target===o&&(o==null||o.classList.add("hidden"))}),(s=o.querySelector("[data-feature-close]"))==null||s.addEventListener("click",()=>o==null?void 0:o.classList.add("hidden"))),{overlay:o,content:t.getElementById("fa-features-content"),cerrar:()=>o==null?void 0:o.classList.add("hidden")}}function qn(t){const e=t.document??document,{flags:a}=t;function o(i){i.innerHTML=`<div class="modal-title">Funcionalidades</div>${Rn(a)}`,s(i)}function s(i){var l,d,b;i.querySelectorAll("[data-feature-toggle]").forEach(u=>{u.addEventListener("change",()=>{var g;const p=u.dataset.featureToggle,y=a.setEnabled(p,u.checked);y.motivo==="dependencias-activadas"&&kt(t,"Se han activado también las funcionalidades necesarias"),y.motivo==="cascada-apagado"&&kt(t,"Se han desactivado las funcionalidades que dependían de esta","warn"),(g=t.onChange)==null||g.call(t,y.cambiadas),o(i)})});const r=i.querySelector("[data-feature-file]");(l=i.querySelector('[data-feature-action="export"]'))==null||l.addEventListener("click",()=>{const u=a.exportProfile(),p=new Blob([JSON.stringify(u,null,2)],{type:"application/json"}),y=URL.createObjectURL(p),g=e.createElement("a");g.href=y,g.download=`financeapp-funcionalidades-${new Date().toISOString().slice(0,10)}.json`,g.click(),URL.revokeObjectURL(y),kt(t,"Perfil de funcionalidades guardado")}),(d=i.querySelector('[data-feature-action="import"]'))==null||d.addEventListener("click",()=>r==null?void 0:r.click()),r==null||r.addEventListener("change",async()=>{var p,y;const u=(p=r.files)==null?void 0:p[0];if(u)try{const{aplicadas:g,ignoradas:I}=a.importProfile(JSON.parse(await u.text()));kt(t,I.length>0?`Perfil cargado (${g.length} aplicadas, ${I.length} ignoradas por ser de otra versión)`:`Perfil cargado (${g.length} funcionalidades)`),(y=t.onChange)==null||y.call(t,g),o(i)}catch(g){kt(t,"No se pudo cargar el perfil: "+g.message,"err")}finally{r.value=""}}),(b=i.querySelector('[data-feature-action="reset"]'))==null||b.addEventListener("click",()=>{var u;a.reset(),kt(t,"Funcionalidades restablecidas"),(u=t.onChange)==null||u.call(t,[]),o(i)})}function n(){const i=On(e);o(i.content),i.overlay.classList.remove("hidden")}return{open:n,renderInto:o}}const fo={expenses:"expenses",loans:"loans",nominas:"nominas",accounts:"accounts",supuestos:"escenarios",inflacion:"inflacion",fiscalidad:"rentas",margenes:"margenes"};function vo(t,e){t.querySelectorAll("[data-feature]").forEach(a=>{const o=a.dataset.feature;if(!o)return;const s=e(o);a.style.display=s?"":"none",s?(a.removeAttribute("aria-hidden"),"disabled"in a&&(a.disabled=!1)):(a.setAttribute("aria-hidden","true"),"disabled"in a&&(a.disabled=!0))})}function Ln({flags:t,document:e=document,router:a,rutasExtra:o}){function s(){const r=e.querySelector(".nav-btn.active[data-view]");return(r==null?void 0:r.dataset.view)??null}function n(){let r=!1;const l=Object.entries((o==null?void 0:o())??{}).map(([d,b])=>[b,d]);for(const[d,b]of[...Object.entries(fo),...l]){const u=t.isEnabled(d),p=e.querySelector(`.nav-btn[data-view="${b}"]`);p&&(p.style.display=u?"":"none"),!u&&s()===b&&(r=!0)}if(e.querySelectorAll(".nav-section").forEach(d=>{const b=[...d.querySelectorAll(".nav-btn[data-view]")];if(b.length===0)return;const u=b.some(p=>p.style.display!=="none");d.style.display=u?"":"none"}),vo(e,d=>t.isEnabled(d)),r){const d=a??globalThis.Router;d==null||d.navigate("dashboard")}}function i(r=e.body){if(typeof MutationObserver>"u")return()=>{};let l=!1;const d=new MutationObserver(()=>{if(!l){l=!0;try{vo(e,b=>t.isEnabled(b))}finally{l=!1}}});return d.observe(r,{childList:!0,subtree:!0}),()=>d.disconnect()}return{apply:n,observar:i,vistaPara:r=>fo[r]}}const Bn="toast toast-deshacer";function kn(t){const{store:e,rerender:a,duracionMs:o=12e3}=t,s=t.contenedor??(()=>document.getElementById("toast-container"));let n=null,i=null,r=null;function l(){i&&clearTimeout(i),i=null,n==null||n.remove(),n=null}function d(u){const p=s();if(!p)return;l();const y=document.createElement("div");y.className=Bn,y.style.display="flex",y.style.alignItems="center",y.style.gap="12px";const g=document.createElement("span");g.textContent=`${Cn(u.col,u.item)} se ha eliminado.`,g.style.flex="1";const I=document.createElement("button");I.type="button",I.className="btn-secondary btn-sm",I.textContent="Deshacer",I.style.flexShrink="0",I.addEventListener("click",()=>{const A=e.deshacerBorrado();if(l(),!A)return;const v=s();if(v){const h=document.createElement("div");h.className="toast toast-ok",h.textContent="Deshecho.",v.appendChild(h),setTimeout(()=>h.remove(),2500)}a==null||a()}),y.appendChild(g),y.appendChild(I),p.appendChild(y),n=y,i=setTimeout(l,o)}const b=e.subscribe(()=>{const u=e.borradoPendiente();if(!u){r=null,l();return}u!==r&&(r=u,d(u))});return()=>{b(),l()}}function be(t){return String(t??"").normalize("NFD").replace(/[\u0300-\u036f]/g,"").toLowerCase().trim()}function go(t,e){const a=be(t),o=be(e);if(!o)return-1;const s=a.indexOf(o);return s<0?-1:s===0?0:/[\s\-/_(«"']/.test(a[s-1])?1:2}const Ft=t=>{const e=Number(t);return Number.isFinite(e)?`${e.toLocaleString("es-ES",{minimumFractionDigits:2,maximumFractionDigits:2})} €`:""};function Hn(t){const e=[],a=o=>{var s,n;return((n=(s=t.accounts)==null?void 0:s.find(i=>i._id===o))==null?void 0:n.nombre)??""};for(const o of t.expenses??[]){const s=o.tipo==="ingreso";e.push({tipo:s?"ingreso":"gasto",etiqueta:s?"Ingreso":"Gasto",id:o._id,titulo:o.concepto,detalle:[Ft(o.cuantia),a(o.cuenta)].filter(Boolean).join(" · "),ruta:"expenses",extra:[...o.tags??[],a(o.cuenta)].join(" ")})}for(const o of t.accounts??[])e.push({tipo:"cuenta",etiqueta:"Cuenta",id:o._id,titulo:o.nombre,detalle:Ft(o.saldoInicial),ruta:"accounts"});for(const o of t.loans??[])e.push({tipo:"prestamo",etiqueta:"Préstamo",id:o._id,titulo:o.nombre,detalle:Ft(o.capital),ruta:"loans",extra:[...o.tags??[],a(o.cuenta)].join(" ")});for(const o of t.nominas??[])e.push({tipo:"nomina",etiqueta:"Nómina",id:o._id,titulo:o.nombre,detalle:`${Ft(o.bruto)} brutos`,ruta:"nominas"});for(const o of t.escenarios??[])e.push({tipo:"supuesto",etiqueta:"Supuesto",id:o._id,titulo:o.nombre,detalle:o.descripcion??"",ruta:"escenarios"});for(const o of t.planes??[]){e.push({tipo:"plan",etiqueta:"Plan",id:o._id,titulo:o.nombre,detalle:o.notas??"",ruta:"planner"});for(const s of o.objetivos??[])e.push({tipo:"objetivo",etiqueta:"Objetivo",id:s._id,titulo:s.nombre,detalle:[s.importeObjetivo!==null?Ft(s.importeObjetivo/100):"",o.nombre].filter(Boolean).join(" · "),ruta:"planner"})}for(const o of t.goals??[])e.push({tipo:"objetivo",etiqueta:"Objetivo",id:o._id,titulo:o.nombre,detalle:Ft(o.targetAmount),ruta:"accounts"});for(const o of t.transacciones??[])e.push({tipo:"movimiento",etiqueta:"Movimiento",id:o._id,titulo:o.concepto,detalle:[o.fecha,Ft(o.importeCts/100),a(o.cuentaId)].filter(Boolean).join(" · "),ruta:"contabilidad",extra:(o.tags??[]).join(" ")});return e}function Gn(t,e,a={}){const{maximo:o=12,rutasDisponibles:s=null}=a,n=be(e);if(n.length<2)return[];const i=l=>s===null||s.includes(l),r=[];for(const l of Hn(t)){if(!i(l.ruta))continue;const d=go(l.titulo,n),b=d>=0?-1:Math.min(go(l.extra??"",n),2);if(d<0&&b<0)continue;const u=d>=0?d:3;r.push({tipo:l.tipo,etiqueta:l.etiqueta,id:l.id,titulo:l.titulo,detalle:l.detalle,ruta:l.ruta,peso:u*1e3+Math.min(999,be(l.titulo).length)})}return r.sort((l,d)=>l.peso-d.peso||l.titulo.localeCompare(d.titulo,"es")),r.slice(0,o)}const Vn="buscador-overlay",bo="btn-buscador";function Un(t){const e=t.doc??document,a=t.rutasDisponibles??(()=>null);let o=null,s=null,n=null,i=[],r=0;function l(){const $=e.createElement("div");$.id=Vn,$.className="modal-overlay",$.style.alignItems="flex-start",$.style.paddingTop="10vh";const m=e.createElement("div");m.className="modal-box",m.style.maxWidth="560px",m.style.padding="14px";const x=e.createElement("input");x.type="search",x.className="form-input",x.placeholder="Buscar gastos, cuentas, préstamos, movimientos…",x.setAttribute("aria-label","Buscar en toda la aplicación"),x.autocomplete="off";const S=e.createElement("div");return S.style.marginTop="10px",S.style.maxHeight="52vh",S.style.overflowY="auto",m.appendChild(x),m.appendChild(S),$.appendChild(m),e.body.appendChild($),$.addEventListener("click",w=>{w.target===$&&I()}),x.addEventListener("input",()=>{r=0,b()}),x.addEventListener("keydown",y),o=$,s=x,n=S,$}function d(){if(n){if(n.textContent="",i.length===0){const $=e.createElement("div");$.style.padding="14px 4px",$.style.fontSize="13px",$.style.color="var(--text3)";const m=(s==null?void 0:s.value.trim())??"";$.textContent=m.length<2?"Escribe al menos dos letras.":"Nada que se parezca a eso.",n.appendChild($);return}i.forEach(($,m)=>{const x=e.createElement("button");x.type="button",x.className="buscador-fila",x.dataset.indice=String(m),m===r&&x.classList.add("activa");const S=e.createElement("div");S.style.minWidth="0";const w=e.createElement("div");w.textContent=$.titulo,w.style.fontSize="13px",w.style.overflow="hidden",w.style.textOverflow="ellipsis",w.style.whiteSpace="nowrap";const E=e.createElement("div");E.textContent=$.detalle,E.style.fontSize="11px",E.style.color="var(--text3)",E.style.overflow="hidden",E.style.textOverflow="ellipsis",E.style.whiteSpace="nowrap",S.appendChild(w),$.detalle&&S.appendChild(E);const _=e.createElement("span");_.className="tag",_.textContent=$.etiqueta,_.style.flexShrink="0",x.appendChild(S),x.appendChild(_),x.addEventListener("click",()=>p(m)),n.appendChild(x)})}}function b(){const $=(s==null?void 0:s.value)??"";i=Gn(t.estado(),$,{rutasDisponibles:a()}),r>=i.length&&(r=Math.max(0,i.length-1)),d()}function u($){var m,x;i.length!==0&&(r=(r+$+i.length)%i.length,d(),(x=(m=n==null?void 0:n.querySelector(".buscador-fila.activa"))==null?void 0:m.scrollIntoView)==null||x.call(m,{block:"nearest"}))}function p($){const m=i[$];m&&(I(),t.navegar(m.ruta))}function y($){$.key==="Escape"?($.preventDefault(),I()):$.key==="ArrowDown"?($.preventDefault(),u(1)):$.key==="ArrowUp"?($.preventDefault(),u(-1)):$.key==="Enter"&&($.preventDefault(),p(r))}function g(){const $=o??l();$.classList.remove("hidden"),$.style.display="",r=0,s&&(s.value="",s.focus()),b()}function I(){o&&(o.style.display="none",i=[])}function A(){return!!o&&o.style.display!=="none"}function v($){($.ctrlKey||$.metaKey)&&($.key==="k"||$.key==="K")&&($.preventDefault(),A()?I():g())}e.addEventListener("keydown",v);let h=null;function f(){const $=e.getElementById("period-bar");if(!$||e.getElementById(bo))return;const m=e.createElement("button");m.id=bo,m.type="button",m.className="btn-secondary",m.title="Buscar en toda la aplicación (Ctrl+K)",m.setAttribute("aria-label","Buscar"),m.textContent="🔍 Buscar",m.style.marginLeft="auto",m.addEventListener("click",g),$.appendChild(m),h=m}return f(),()=>{e.removeEventListener("keydown",v),h==null||h.remove(),o==null||o.remove(),o=null,s=null,n=null}}const We="aviso-guardado";function Yn(t){const e=t.doc??document,a=t.contenedor??(()=>e.getElementById("toast-container")),o=t.msExito??1800,s=t.cambios.crearMarca("guardado");let n="oculto",i=!1,r=null,l=null;function d(){var g;r&&clearTimeout(r),r=null,(g=e.getElementById(We))==null||g.remove()}function b(){if(n==="oculto")return d();const g=a();if(!g)return;let I=e.getElementById(We);I||(I=e.createElement("div"),I.id=We,g.appendChild(I)),I.className=`toast toast-guardado toast-guardado--${n}`,I.style.display="flex",I.style.alignItems="center",I.style.gap="12px",I.textContent="";const A=e.createElement("span");if(A.style.flex="1",I.appendChild(A),n==="pendiente")A.textContent="Tienes cambios sin guardar.",I.appendChild(u("Guardar ahora","btn-primary btn-sm",()=>void p())),I.appendChild(u("Ocultar","btn-secondary btn-sm",()=>{i=!0,n="oculto",b()}));else if(n==="subiendo"){A.textContent="Subiendo…";const v=e.createElement("span");v.className="guardado-giro",v.setAttribute("aria-hidden","true"),I.appendChild(v)}else n==="guardado"?A.textContent="¡Guardado!":n==="error"&&(A.textContent="No se ha podido guardar.",I.appendChild(u("Reintentar","btn-primary btn-sm",()=>void p())))}function u(g,I,A){const v=e.createElement("button");return v.type="button",v.className=I,v.textContent=g,v.style.flexShrink="0",v.addEventListener("click",A),v}async function p(){if(l)return l;r&&clearTimeout(r);const g=t.cambios.revision();return n="subiendo",b(),l=(async()=>{try{await t.guardar(),s.alDia(g),n="guardado",b(),r=setTimeout(()=>{n=s.pendiente()?"pendiente":"oculto",n==="pendiente"&&(i=!1),b()},o)}catch(I){console.error("[guardado] no se ha podido subir la copia:",I),n="error",b()}finally{l=null}})(),l}const y=t.cambios.suscribir(()=>{t.hayDestino()&&(i=!1,n!=="subiendo"&&(n="pendiente",b()))});return{estado:()=>i&&n==="oculto"?"oculto":n,guardarAhora:p,detener(){y(),d()}}}function Jn({document:t=document,isEnabled:e}={}){const a=new Map;let o=null;function s(g){return`view-${g}`}function n(g){const I=t.getElementById(s(g.route));if(I)return I;const A=t.querySelector(".view-container");if(!A)return null;const v=t.createElement("div");return v.id=s(g.route),v.className="view hidden",A.appendChild(v),v}function i(g){if(t.querySelector(`.nav-btn[data-view="${g.route}"]`))return;const I=t.querySelectorAll(".nav-section"),A=I[g.seccion??Math.max(0,I.length-1)];if(!A)return;const v=t.createElement("button");v.className="nav-btn",v.dataset.view=g.route,v.innerHTML=`${g.iconoPath?`<svg viewBox="0 0 24 24"><path d="${g.iconoPath}"/></svg>`:""}<span>${g.nombre}</span>`,A.appendChild(v),v.addEventListener("click",()=>{const h=globalThis.Router;h==null||h.navigate(g.route)})}function r(g){a.set(g.route,g),n(g),i(g)}function l(){return[...a.keys()].filter(g=>{const I=a.get(g);return!e||e(I.flagId??I.id)})}function d(g){return l().includes(g)}function b(g){const I=a.get(g);if(!I||e&&!e(I.flagId??I.id))return!1;const A=n(I);if(!A)return!1;if(o&&o!==g){const v=a.get(o),h=t.getElementById(s(o));v!=null&&v.unmount&&h&&v.unmount(h)}return I.mount(A),o=g,!0}function u(){o&&b(o)}function p(){const g={};for(const[I,A]of a)g[I]=A.flagId??A.id;return g}function y(){for(const g of a.values())n(g),i(g)}return{register:r,routes:l,has:d,mount:b,rerender:u,flagPorRuta:p,attachToShell:y,get activa(){return o}}}function c(t){return String(t??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function Pt(t){return`<span style="color:${t<0?"var(--red)":t>0?"var(--accent)":"var(--text2)"}">${c(j(t))}</span>`}function ho(t){return t===null?'<span style="color:var(--text3);font-size:12px">sin datos</span>':`<span style="color:${t>=90?"var(--accent)":t>=70?"var(--yellow)":"var(--red)"};font-weight:600">${t.toFixed(1)}%</span>`}function yo(t){return t.length===0?'<span style="color:var(--text3);font-size:11px">—</span>':t.map(e=>`<span class="tag">${c(e)}</span>`).join(" ")}const Wn=["enero","febrero","marzo","abril","mayo","junio","julio","agosto","septiembre","octubre","noviembre","diciembre"];function Ke(t){const[e,a]=t.split("-").map(Number);return`${Wn[a-1]} ${e}`}function q(t,e="ok"){const a=globalThis.UI;if(a!=null&&a.toast)return a.toast(t,e);console.info("[FinanceApp]",t)}function Z(t){const e=globalThis.UI;return e!=null&&e.confirm?e.confirm(t):typeof confirm=="function"?confirm(t):!0}function N(t,e,a){t.addEventListener("click",o=>{var n;const s=(n=o.target)==null?void 0:n.closest(e);s&&t.contains(s)&&a(s,o)})}function J(t,e,a){t.addEventListener("change",o=>{var n;const s=(n=o.target)==null?void 0:n.closest(e);s&&t.contains(s)&&a(s,o)})}function ft(t,e){var a;return((a=t.querySelector(e))==null?void 0:a.value)??""}function xo(t,e){const a=parseFloat(ft(t,e));return Number.isFinite(a)?a:0}function Kn(t){const[e,a]=t.split("-").map(Number),o=new Date(e,a,0).getDate();return{desde:`${t}-01`,hasta:`${t}-${String(o).padStart(2,"0")}`}}function Qn(t,e){const{ledger:a}=t,o=(t.hoy??Y)(),s=t.accounts().filter(h=>h.activo),{desde:n,hasta:i}=Kn(e.mes),r={cuentaId:e.cuentaId||void 0,desde:n,hasta:i,texto:e.filtroTexto||void 0},l=a.transacciones(r),d=t.estimaciones().filter(h=>h.tipo!=="transferencia"),b=l.filter(h=>h.importeCts<0).reduce((h,f)=>h+f.importeCts,0),u=l.filter(h=>h.importeCts>0).reduce((h,f)=>h+f.importeCts,0),p=e.cuentaId?a.saldoCuenta(e.cuentaId,i):a.saldoTotal(i),y=e.cuentaId?a.puntosControl(e.cuentaId):a.puntosControl(),g=s.map(h=>`<option value="${c(h._id)}"${h._id===e.cuentaId?" selected":""}>${c(h.nombre)}</option>`).join(""),I=h=>'<option value="">— sin asignar —</option>'+d.map(f=>`<option value="${c(f._id)}"${f._id===h?" selected":""}>${c(f.concepto)} (${c(j(f.cuantia))})</option>`).join(""),A=l.map(h=>{var f;return`
      <tr data-tx="${c(h._id)}" style="border-bottom:1px solid var(--border)">
        ...
        <td style="padding:7px 8px">${yo(h.tags)}</td>
    ...
    <div class="grid-2 mb-14" style="align-items:start">
      <div class="card">
        ...
        <div style="display:flex;gap:14px;flex-wrap:wrap;margin-bottom:12px;font-size:12px">
          ...
          <span>Ingresos: ${Pt(et(u))}</span>
          <span>Neto: ${Pt(et(u+b))}</span>
    ...
    </div>`}function Xn(t,e,a,o){const{ledger:s}=e;J(t,"#acc-cuenta",i=>{a.cuentaId=i.value,o()}),J(t,"#acc-mes",i=>{a.mes=i.value||a.mes,o()});const n=t.querySelector("#acc-buscar");n==null||n.addEventListener("input",()=>{a.filtroTexto=n.value,clearTimeout(n._t),n._t=window.setTimeout(o,200)}),N(t,"#nt-guardar",()=>{const i=ft(t,"#nt-concepto").trim(),r=xo(t,"#nt-importe");if(!i)return q("Indica un concepto","err");if(!(r>0))return q("Indica un importe mayor que cero","err");const l=ft(t,"#nt-tags").split(",").map(d=>d.trim().toLowerCase()).filter(Boolean);s.registrar({fecha:ft(t,"#nt-fecha")||(e.hoy??Y)(),cuentaId:ft(t,"#nt-cuenta"),importe:r,concepto:i,tags:l,tipo:ft(t,"#nt-tipo"),estimacionId:ft(t,"#nt-estimacion")||null}),q("Movimiento registrado"),e.onDatosCambiados(),o()}),N(t,"[data-tx-borrar]",i=>{const r=i.dataset.txBorrar;Z("¿Eliminar este movimiento?")&&(s.eliminar(r),q("Movimiento eliminado"),e.onDatosCambiados(),o())}),N(t,"[data-tx-editar]",i=>{const r=i.dataset.txEditar,l=s.transacciones().find(u=>u._id===r);if(!l)return;const d=window.prompt(`Importe de "${l.concepto}" (€)`,String(Math.abs(et(l.importeCts))));if(d===null)return;const b=parseFloat(d.replace(",","."));if(!Number.isFinite(b)||b<=0)return q("Importe no válido","err");s.actualizar(r,{importe:b}),q("Movimiento actualizado"),e.onDatosCambiados(),o()}),J(t,"[data-tx-estimacion]",i=>{const r=i.getAttribute("data-tx-estimacion");s.asignarEstimacion(r,i.value||null),q("Asignación actualizada"),e.onDatosCambiados()}),N(t,"#pc-guardar",()=>{if(ft(t,"#pc-saldo").trim()==="")return q("Indica el saldo","err");const r=xo(t,"#pc-saldo");s.registrarPuntoControl(ft(t,"#pc-cuenta"),ft(t,"#pc-fecha")||(e.hoy??Y)(),r,ft(t,"#pc-nota").trim()||void 0),q("Saldo real registrado"),e.onDatosCambiados(),o()}),N(t,"[data-pc-borrar]",i=>{Z("¿Eliminar este punto de control?")&&(s.eliminarPuntoControl(i.dataset.pcBorrar),q("Punto de control eliminado"),e.onDatosCambiados(),o())})}function Qe(t,e,a={}){const{umbralPrecision:o=90,variacionMinimaPct:s=5}=a;if(t.precision===null||t.mediaRealReciente===null||t.meses.length===0||t.precision>=o)return null;const n=W(t.mediaRealReciente),i=W(n-e),r=e!==0?i/Math.abs(e)*100:n!==0?100:0;if(Math.abs(r)<s)return null;const l=t.meses.slice(-3).length;return{estimacionId:t.estimacionId,concepto:t.concepto,cuantiaActual:W(e),cuantiaSugerida:n,diferencia:i,variacionPct:r,precision:t.precision,mesesConsiderados:l,motivo:i>0?`El gasto real de los últimos ${l} meses supera lo estimado`:`El gasto real de los últimos ${l} meses es inferior a lo estimado`}}function Zn(t){function e(){return`exp_${Date.now().toString(36)}${Math.random().toString(36).slice(2,7)}`}function a(n,i,r={}){const l=r.hoy??Y(),d=t.get("expenses"),b=d.find(g=>g._id===n);if(!b)throw new Error(`La estimación ${n} no existe`);const u={...b,fechaFin:l},p={...b,_id:e(),cuantia:W(i),fechaInicio:l,fechaFin:b.fechaFin??null,ajustadaDesdeId:b._id,ajustadaEn:l},y=d.map(g=>g._id===n?u:g);return y.push(p),t.set("expenses",y),{estimacionCerrada:u,estimacionNueva:p}}function o(n,i={}){const r=[],l=[];for(const d of n)try{r.push(a(d.estimacionId,d.cuantiaSugerida,i))}catch(b){l.push({estimacionId:d.estimacionId,error:b.message})}return{aplicadas:r,errores:l}}function s(n){const i=t.get("expenses"),r=new Map(i.map(I=>[I._id,I])),l=r.get(n);if(!l)return[];const d=[];let b=l;const u=new Set;for(;b!=null&&b.ajustadaDesdeId&&!u.has(b._id);){u.add(b._id);const I=r.get(b.ajustadaDesdeId);if(!I)break;d.unshift(I),b=I}const p=[];let y=l;const g=new Set([l._id]);for(;;){const I=i.find(A=>A.ajustadaDesdeId===y._id&&!g.has(A._id));if(!I)break;g.add(I._id),p.push(I),y=I}return[...d,l,...p]}return{aplicar:a,aplicarTodas:o,cadena:s}}function Xe(t){const e=t.estimaciones(),a=new Map(e.map(o=>[o._id,o]));return t.precision.analizarTodas(e).map(o=>{const s=a.get(o.estimacionId);return{analisis:o,estimacion:s,sugerencia:Qe(o,s.cuantia)}}).filter(o=>!!o.estimacion)}function ti(t){const e=Xe(t),a=e.filter(l=>l.analisis.precision!==null),o=e.filter(l=>l.sugerencia!==null),s=t.precision.analizarPorTag(e.map(l=>l.analisis));if(a.length===0)return`
      <div class="card mb-14">
      ...
      </div>`;const n=a.map(({analisis:l,estimacion:d,sugerencia:b})=>{const u=l.meses.slice(-6).map(p=>`${Ke(p.mes)}: ${j(p.estimado)} → ${j(p.real)} (${p.precision.toFixed(0)}%)`).join(" · ");return`
      <tr style="border-bottom:1px solid var(--border)">
        <td style="padding:8px">
          <div style="font-size:13px;color:var(--text)">${c(d.concepto)}</div>
          <div style="margin-top:3px">${yo(l.tags)}</div>
        ...
        <td style="padding:8px;text-align:right;white-space:nowrap">${ho(l.precision)}</td>
      ...
      <tr style="border-bottom:1px solid var(--border)">
        ...
        <td style="padding:7px 8px;text-align:right">${ho(l.precision)}</td>
      </tr>`).join(""),r=(l,d="left")=>`<th style="padding:7px 8px;text-align:${d};font-size:10px;text-transform:uppercase;color:var(--text3);font-family:var(--font-mono)">${l}</th>`;return`
    <div class="card mb-14">
    ...
    </div>`}function ei(t,e,a){N(t,"[data-sugerir]",o=>{const s=o.dataset.sugerir,n=Xe(e).find(l=>l.analisis.estimacionId===s);if(!(n!=null&&n.sugerencia))return;const i=n.sugerencia,r=`${i.concepto}
...
¿Continuar?`))return;const{aplicadas:n,errores:i}=e.adjuster.aplicarTodas(o,{hoy:e.hoy()});q(i.length>0?`${n.length} ajustadas, ${i.length} con error`:`${n.length} estimaciones ajustadas`,i.length>0?"warn":"ok"),e.onDatosCambiados(),a()})}const ai=[";",",","	","|"],oi={fecha:["fecha","f. valor","fecha valor","fecha operacion","date","f.operacion","f. operacion"],concepto:["concepto","descripcion","detalle","movimiento","referencia","description","observaciones"],importe:["importe","cantidad","amount","euros","import"],debe:["debe","cargo","salida","pago","debito"],haber:["haber","abono","entrada","ingreso","credito"]};function he(t){return t.normalize("NFD").replace(/[̀-ͯ]/g,"").toLowerCase().trim()}function ye(t,e){const a=[];let o="",s=!1;for(let n=0;n<t.length;n++){const i=t[n];s?i==='"'?t[n+1]==='"'?(o+='"',n++):s=!1:o+=i:i==='"'?s=!0:i===e?(a.push(o.trim()),o=""):o+=i}return a.push(o.trim()),a}function si(t){let e=";",a=-1;for(const o of ai){const s=t.slice(0,20).map(l=>ye(l,o).length),n=Math.max(...s);if(n<2)continue;const r=s.filter(l=>l===n).length*10+n;r>a&&(a=r,e=o)}return e}function ie(t){let e=(t??"").trim();if(!e)return null;let a=!1;if(/^\(.*\)$/.test(e)&&(a=!0,e=e.slice(1,-1).trim()),e.endsWith("-")&&(a=!0,e=e.slice(0,-1).trim()),e.startsWith("-")&&(a=!0,e=e.slice(1).trim()),e.startsWith("+")&&(e=e.slice(1).trim()),e=e.replace(/[€$£\s  ]/g,""),!e)return null;const o=e.lastIndexOf(","),s=e.lastIndexOf(".");let n="";o>=0&&s>=0?n=o>s?",":".":o>=0?n=/,\d{3}$/.test(e)&&e.replace(/,/g,"").length>3?"":",":s>=0&&(n=/\.\d{3}$/.test(e)&&e.replace(/\./g,"").length>3?"":".");let i,r="0";if(n){const b=n===","?o:s;i=e.slice(0,b).replace(/[.,]/g,""),r=e.slice(b+1).replace(/[.,]/g,"")}else i=e.replace(/[.,]/g,"");if(!/^\d*$/.test(i)||!/^\d*$/.test(r)||i===""&&r==="")return null;const l=(r+"00").slice(0,2),d=Number(i||"0")*100+Number(l);return Number.isFinite(d)?a?-d:d:null}function Ze(t){const e=(t??"").trim();if(!e)return null;let a=e.match(/^(\d{4})[-/](\d{1,2})[-/](\d{1,2})/);if(a)return $o(Number(a[1]),Number(a[2]),Number(a[3]));if(a=e.match(/^(\d{1,2})[-/.](\d{1,2})[-/.](\d{2,4})/),a){let o=Number(a[3]);return o<100&&(o+=o<70?2e3:1900),$o(o,Number(a[2]),Number(a[1]))}return null}function $o(t,e,a){if(e<1||e>12||a<1||a>31)return null;const o=new Date(t,e-1,a);return o.getFullYear()!==t||o.getMonth()!==e-1||o.getDate()!==a?null:`${t}-${String(e).padStart(2,"0")}-${String(a).padStart(2,"0")}`}function Io(t){const e=t.filter(a=>a.trim());return e.length===0?0:e.filter(a=>Ze(a)!==null).length/e.length}function Ao(t){const e=t.filter(a=>a.trim());return e.length===0?0:e.filter(a=>ie(a)!==null).length/e.length}function ni(t,e){const a={fecha:-1,concepto:-1,importe:-1,debe:-1,haber:-1},o=new Set,s=n=>e.map(i=>i[n]??"");for(const n of["fecha","importe","debe","haber","concepto"])for(let i=0;i<t.length;i++){if(o.has(i))continue;const r=he(t[i]);if(r&&oi[n].some(l=>r===l||r.startsWith(l)||r.includes(l))){if(n==="importe"&&he(t[i]).includes("saldo"))continue;a[n]=i,o.add(i);break}}if(a.fecha<0){let n=-1,i=.6;for(let r=0;r<t.length;r++){if(o.has(r))continue;const l=Io(s(r));l>i&&(i=l,n=r)}n>=0&&(a.fecha=n,o.add(n))}if(a.importe<0&&a.debe<0&&a.haber<0){let n=-1,i=.6;for(let r=0;r<t.length;r++){if(o.has(r)||he(t[r]).includes("saldo"))continue;const l=Ao(s(r));l>i&&(i=l,n=r)}n>=0&&(a.importe=n,o.add(n))}if(a.concepto<0){let n=-1,i=0;for(let r=0;r<t.length;r++){if(o.has(r))continue;const l=s(r);if(Ao(l)>.5||Io(l)>.5)continue;const d=l.reduce((b,u)=>b+u.length,0)/Math.max(1,l.length);d>i&&(i=d,n=r)}n>=0&&(a.concepto=n)}return a}function ii(t){const e=t.replace(/^﻿/,"").split(/\r\n|\n|\r/).filter(b=>b.trim()!=="");if(e.length===0)return{separador:";",cabeceras:[],filas:[],lineaCabecera:0,mapeo:{fecha:-1,concepto:-1,importe:-1,debe:-1,haber:-1}};const a=si(e),o=e.map(b=>ye(b,a).length),s=Math.max(...o);let n=o.findIndex(b=>b===s);n<0&&(n=0);const i=ye(e[n],a);let r=e.slice(n+1).map(b=>ye(b,a));const l=Ze(i[0]??"")!==null||i.some(b=>ie(b)!==null&&/\d/.test(b));l&&(r=[i,...r]);const d=ni(l?i.map(()=>""):i,r.slice(0,40));return{separador:a,cabeceras:l?i.map((b,u)=>`Columna ${u+1}`):i,filas:r,lineaCabecera:n+1,mapeo:d}}function So(t,e,a){return`${t}|${e}|${he(a).replace(/\s+/g," ")}`}function ri(t,e,a=[]){const o=new Set(a.map(n=>So(n.fecha,n.importeCts,n.concepto))),s=new Set;return t.filas.map((n,i)=>{const r=[],l=e.fecha>=0?Ze(n[e.fecha]??""):null;e.fecha<0?r.push("sin columna de fecha"):l||r.push(`fecha ilegible: «${n[e.fecha]??""}»`);let d=null;if(e.importe>=0)d=ie(n[e.importe]??""),d===null&&r.push(`importe ilegible: «${n[e.importe]??""}»`);else if(e.debe>=0||e.haber>=0){const p=e.debe>=0?ie(n[e.debe]??""):null,y=e.haber>=0?ie(n[e.haber]??""):null;p===null&&y===null?r.push("sin importe en Debe ni en Haber"):p!==null&&p!==0?d=-Math.abs(p):y!==null&&y!==0?d=Math.abs(y):d=0}else r.push("sin columna de importe");d===0&&r.push("importe cero");const b=(e.concepto>=0?n[e.concepto]??"":"").trim()||"Movimiento importado";let u=!1;if(l&&d!==null){const p=So(l,d,b);u=o.has(p)||s.has(p),s.add(p)}return{linea:t.lineaCabecera+1+i,fecha:l,concepto:b,importeCts:d,errores:r,duplicada:u}})}function li(t,e){const a=t.filter(s=>s.errores.length===0&&(e||!s.duplicada)),o=a.map(s=>s.fecha).filter(s=>!!s).sort();return{total:t.length,importables:a.length,conError:t.filter(s=>s.errores.length>0).length,duplicadas:t.filter(s=>s.duplicada).length,sumaCts:a.reduce((s,n)=>s+(n.importeCts??0),0),desde:o[0]??null,hasta:o[o.length-1]??null}}function xe(){return{abierto:!1,nombreFichero:"",analisis:null,mapeo:null,filas:[],cuentaId:"",incluirDuplicadas:!1,error:""}}const ci=[{clave:"fecha",etiqueta:"Fecha"},{clave:"concepto",etiqueta:"Concepto"},{clave:"importe",etiqueta:"Importe (con signo)"},{clave:"debe",etiqueta:"Debe (salidas)"},{clave:"haber",etiqueta:"Haber (entradas)"}];function ta(t,e){if(!e.analisis||!e.mapeo){e.filas=[];return}const a=t.ledger.transacciones(e.cuentaId?{cuentaId:e.cuentaId}:{}).map(o=>({fecha:o.fecha,importeCts:o.importeCts,concepto:o.concepto}));e.filas=ri(e.analisis,e.mapeo,a)}function di(t,e){const a=t.accounts().filter(s=>s.activo);if(!e.abierto)return`
      <div class="card">
    ...
    <div class="card">
      ...
      ${e.analisis&&e.mapeo?pi(e,e.analisis,e.mapeo):ui()}
    ...
    <div class="text-sm" style="color:var(--text3);line-height:1.7">
      ...
      antes de importar.
    </div>`}function pi(t,e,a){const o=li(t.filas,t.incluirDuplicadas),s=r=>`<option value="-1"${r<0?" selected":""}>— ninguna —</option>`+e.cabeceras.map((l,d)=>`<option value="${d}"${d===r?" selected":""}>${c(l||`Columna ${d+1}`)}</option>`).join(""),n=t.filas.filter(r=>r.errores.length>0),i=t.filas.slice(0,12);return`
    ...
    <div class="table-wrap mb-12">
      <table style="min-width:420px">
        ...
        <tbody>
          ${i.map(r=>{const l=r.errores.length>0,d=l?r.errores[0]:r.duplicada?"repetido":"se importa",b=l?"var(--red)":r.duplicada?"var(--yellow)":"var(--accent)";return`<tr style="${l?"opacity:0.55":""}">
                ...
                <td style="font-size:11px;color:${b}">${c(d)}</td>
              </tr>`}).join("")}
        </tbody>
      </table>
    </div>
    ...
    ${t.cuentaId?"":'<div class="text-sm mt-8" style="color:var(--yellow);text-align:right">Elige antes la cuenta de destino.</div>'}`}function mi(t,e,a,o){N(t,"[data-imp-abrir]",()=>{const n=e.accounts().filter(i=>i.activo);Object.assign(a,xe(),{abierto:!0,cuentaId:n.length===1?n[0]._id:""}),o()}),N(t,"[data-imp-cerrar]",()=>{Object.assign(a,xe()),o()}),J(t,"#imp-cuenta",n=>{a.cuentaId=n.value,ta(e,a),o()}),J(t,"#imp-duplicadas",n=>{a.incluirDuplicadas=n.checked,o()}),J(t,"[data-imp-col]",n=>{const i=n,r=i.dataset.impCol;a.mapeo&&(a.mapeo[r]=Number(i.value),ta(e,a),o())});const s=t.querySelector("#imp-fichero");s==null||s.addEventListener("change",()=>{var i;const n=(i=s.files)==null?void 0:i[0];n&&fi(n).then(r=>{const l=ii(r);a.nombreFichero=n.name,a.error=l.filas.length===0?"El fichero no tiene ninguna línea de datos reconocible.":"",a.analisis=l,a.mapeo={...l.mapeo},ta(e,a),o()}).catch(r=>{a.error=`No se ha podido leer el fichero: ${r.message}`,o()})}),N(t,"[data-imp-confirmar]",()=>{if(!a.cuentaId)return;const n=a.filas.filter(i=>i.errores.length===0&&(a.incluirDuplicadas||!i.duplicada));if(n.length!==0){for(const i of n)e.ledger.registrar({fecha:i.fecha,cuentaId:a.cuentaId,importe:Math.abs(et(i.importeCts)),tipo:i.importeCts<0?"gasto":"ingreso",concepto:i.concepto,origen:"importado"});q(`${n.length} movimiento${n.length!==1?"s":""} importado${n.length!==1?"s":""}`),Object.assign(a,xe()),e.onDatosCambiados(),o()}})}function fi(t){return t.arrayBuffer().then(e=>{const a=new TextDecoder("utf-8").decode(e);if(!a.includes("�"))return a;try{return new TextDecoder("iso-8859-1").decode(e)}catch{return a}})}function vi(t,e){if(t===0)return e===0?100:0;const a=Math.abs(e-t)/Math.abs(t);return Math.max(0,Math.min(100,(1-a)*100))}function gi(t,e){const a=G(t),o=[];for(let s=1;s<=e;s++){const n=new Date(a.getFullYear(),a.getMonth()-s,1);o.push(`${n.getFullYear()}-${String(n.getMonth()+1).padStart(2,"0")}`)}return o.reverse()}function bi(t){const[e,a]=t.split("-").map(Number),o=new Date(e,a,0);return{inicio:`${t}-01`,fin:`${t}-${String(o.getDate()).padStart(2,"0")}`}}function Mo(t,e){const{inicio:a,fin:o}=bi(e);return Qt([t],{start:a,end:o}).reduce((n,i)=>n+Math.abs(i.cuantia),0)}function hi(t){function e(s,n={}){var $;const{mesesHistorial:i=12,mesesMedia:r=3,hoy:l=Y()}=n,d=t.transacciones({estimacionId:s._id}),u=d.length===0&&((($=s.tags)==null?void 0:$.length)??0)>0?t.transacciones({tags:s.tags}):d,p=new Map;for(const m of u){const x=m.fecha.slice(0,7);p.set(x,(p.get(x)??0)+Math.abs(m.importeCts)/100)}const y=[];for(const m of gi(l,i)){const x=p.get(m);if(x===void 0)continue;const S=W(Mo(s,m));y.push({mes:m,estimado:S,real:W(x),desviacion:W(x-S),precision:vi(S,x)})}const g=W(y.reduce((m,x)=>m+x.estimado,0)),I=W(y.reduce((m,x)=>m+x.real,0)),A=y.reduce((m,x)=>m+Math.abs(x.estimado),0),v=y.length===0?null:A>0?y.reduce((m,x)=>m+x.precision*Math.abs(x.estimado),0)/A:y.reduce((m,x)=>m+x.precision,0)/y.length,h=y.slice(-r),f=h.length>0?W(h.reduce((m,x)=>m+x.real,0)/h.length):null;return{estimacionId:s._id,concepto:s.concepto,tags:s.tags??[],meses:y,estimadoTotal:g,realTotal:I,desviacionTotal:W(I-g),precision:v,mediaRealReciente:f,infraestimada:I>g}}function a(s,n={}){return s.filter(i=>i.tipo!=="transferencia").map(i=>e(i,n)).sort((i,r)=>i.precision===null&&r.precision===null?i.concepto.localeCompare(r.concepto):i.precision===null?1:r.precision===null?-1:i.precision-r.precision)}function o(s){const n=new Map;for(const i of s)if(i.precision!==null)for(const r of i.tags.length>0?i.tags:["sin_tag"]){const l=n.get(r)??{estimado:0,real:0,pesoPrecision:0,peso:0,n:0};l.estimado+=i.estimadoTotal,l.real+=i.realTotal,l.pesoPrecision+=i.precision*Math.abs(i.estimadoTotal),l.peso+=Math.abs(i.estimadoTotal),l.n+=1,n.set(r,l)}return[...n.entries()].map(([i,r])=>({tag:i,estimadoTotal:W(r.estimado),realTotal:W(r.real),desviacionTotal:W(r.real-r.estimado),precision:r.peso>0?r.pesoPrecision/r.peso:null,estimaciones:r.n})).sort((i,r)=>(i.precision??101)-(r.precision??101))}return{analizarEstimacion:e,analizarTodas:a,analizarPorTag:o}}function yi(t){const[e,a]=t.split("-").map(Number),o=new Date(e,a,0).getDate();return{desde:`${t}-01`,hasta:`${t}-${String(o).padStart(2,"0")}`}}function xi(t){const[e,a]=t.slice(0,7).split("-").map(Number),o=new Date(e,a-2,1);return`${o.getFullYear()}-${String(o.getMonth()+1).padStart(2,"0")}`}function $i(t){return t.normalize("NFD").replace(/[̀-ͯ]/g,"").toLowerCase().replace(/\d+/g,"").replace(/\s+/g," ").trim()}function Ii(t,e,a){const o=new Map(e.map(n=>[n._id,[]])),s=e.filter(n=>{var i;return!a(n._id)&&(((i=n.tags)==null?void 0:i.length)??0)>0});for(const n of t){if(n.estimacionId&&o.has(n.estimacionId)){o.get(n.estimacionId).push(n);continue}if(n.estimacionId)continue;let i=null,r=0;for(const l of s){const d=(l.tags??[]).filter(b=>n.tags.includes(b)).length;d!==0&&(d>r||d===r&&i&&l._id<i._id)&&(i=l,r=d)}i&&o.get(i._id).push(n)}return o}function Ai(t,e,a,o={}){const{desde:s,hasta:n}=yi(a),i=t.transacciones({desde:s,hasta:n}),r=i.filter(f=>f.importeCts<0),l=i.filter(f=>f.importeCts>0),d=e.filter(f=>f.tipo==="gasto"&&f.activo!==!1),b=new Map((o.analisis??[]).map(f=>[f.estimacionId,f])),u=new Set(d.filter(f=>t.transacciones({estimacionId:f._id}).length>0).map(f=>f._id)),p=Ii(r,d,f=>u.has(f)),y=new Set,g=d.map(f=>{const $=p.get(f._id)??[];for(const w of $)y.add(w._id);const m=W($.reduce((w,E)=>w+Math.abs(E.importeCts)/100,0)),x=W(Mo(f,a)),S=b.get(f._id);return{estimacionId:f._id,concepto:f.concepto,tags:f.tags??[],estimado:x,real:m,desviacion:W(m-x),sinMovimiento:$.length===0,sugerencia:S?Qe(S,f.cuantia,{hoy:o.hoy}):null}}),I=new Map;for(const f of r){if(y.has(f._id))continue;const $=$i(f.concepto),m=I.get($)??{concepto:f.concepto,total:0,movimientos:0};m.total=W(m.total+Math.abs(f.importeCts)/100),m.movimientos+=1,I.set($,m)}const A=[...I.values()].sort((f,$)=>$.total-f.total),v=W(g.reduce((f,$)=>f+$.estimado,0)),h=W(r.reduce((f,$)=>f+Math.abs($.importeCts)/100,0));return{mes:a,estimado:v,real:h,desviacion:W(h-v),ingresosReales:W(l.reduce((f,$)=>f+$.importeCts/100,0)),filas:g.sort((f,$)=>Math.abs($.desviacion)-Math.abs(f.desviacion)),sinEstimacion:A,totalSinEstimacion:W(A.reduce((f,$)=>f+$.total,0)),vacio:i.length===0}}function wo(t){const e=new Set;for(const a of t.transacciones())e.add(a.fecha.slice(0,7));return[...e].sort().reverse()}function Si(){return{mes:""}}function ea(t,e){if(e.mes)return e.mes;const a=wo(t.ledger),o=xi((t.hoy??Y)());return a.includes(o)?o:a[0]??o}function aa(t,e){const a=(t.hoy??Y)(),o=t.estimaciones(),s=t.precision.analizarTodas(o,{hoy:a});return Ai(t.ledger,o,e,{analisis:s,hoy:a})}function Mi(t,e){const a=ea(t,e),o=wo(t.ledger);o.includes(a)||o.unshift(a);const s=aa(t,a),n=`
    ...
    <div class="card">
      ...
      ${wi(s)}
      ${Ci(s)}
    </div>`}function wi(t){const e=t.filas.filter(o=>o.estimado>0||o.real>0);if(e.length===0)return'<div class="text-sm" style="color:var(--text3)">No tienes estimaciones de gasto activas para este mes.</div>';const a=e.filter(o=>o.sugerencia);return`
    ...
    ${a.length>0?`<div class="flex justify-between items-center mb-12" style="gap:10px;flex-wrap:wrap">
           ...
           </div>`:""}`}function Ci(t){return t.sinEstimacion.length===0?`<div class="alert-card alert-info">
    ...
    ${t.sinEstimacion.length>10?`<div class="text-sm mt-8" style="color:var(--text3)">…y ${t.sinEstimacion.length-10} concepto(s) más.</div>`:""}`}function ji(t,e,a,o){J(t,"#cie-mes",s=>{a.mes=s.value,o()}),N(t,"[data-cie-ajustar]",s=>{const n=s.dataset.cieAjustar,r=aa(e,ea(e,a)).filas.find(l=>l.estimacionId===n);r!=null&&r.sugerencia&&(e.adjuster.aplicar(r.sugerencia.estimacionId,r.sugerencia.cuantiaSugerida,{hoy:(e.hoy??Y)()}),q(`«${r.concepto}» ajustada a ${j(r.sugerencia.cuantiaSugerida)}`),e.onDatosCambiados(),o())}),N(t,"[data-cie-ajustar-todas]",()=>{const n=aa(e,ea(e,a)).filas.map(l=>l.sugerencia).filter(l=>l!==null);if(n.length===0)return;const{aplicadas:i,errores:r}=e.adjuster.aplicarTodas(n,{hoy:(e.hoy??Y)()});q(`${i.length} estimación${i.length!==1?"es":""} ajustada${i.length!==1?"s":""}`+(r.length>0?` · ${r.length} con error`:"")),e.onDatosCambiados(),o()})}const Ei="M20 4H4c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 14H4V8h16v10zM6 10h5v2H6v-2zm0 4h8v2H6v-2z";function zi(t){const e={cuentaId:"",mes:(t.hoy??Y)().slice(0,7),filtroTexto:""},a=xe(),o=Si(),s=()=>{var u;return(u=t.onDatosCambiados)==null?void 0:u.call(t)},n=t.hoy??Y,i={ledger:t.ledger,accounts:t.accounts,estimaciones:t.estimaciones,tagsConocidas:()=>t.tags.todas(),onDatosCambiados:s,hoy:n},r={ledger:t.ledger,accounts:t.accounts,onDatosCambiados:s},l={ledger:t.ledger,precision:t.precision,adjuster:t.adjuster,estimaciones:t.estimaciones,onDatosCambiados:s,hoy:n},d={precision:t.precision,adjuster:t.adjuster,estimaciones:t.estimaciones,onDatosCambiados:s,hoy:n};function b(u){const p=t.ledger.saldoTotal(n()),y=t.ledger.ultimaFecha(),g=t.ledger.transacciones().length;u.innerHTML=`
      ...
      <div id="acc-precision" data-feature="precision-estimaciones"></div>`;const I=u.querySelector("#acc-importar"),A=u.querySelector("#acc-cierre"),v=u.querySelector("#acc-transacciones"),h=u.querySelector("#acc-precision");I.innerHTML=di(r,a),A.innerHTML=Mi(l,o),v.innerHTML=Qn(i,e),h.innerHTML=ti(d);const f=()=>b(u);mi(I,r,a,f),ji(A,l,o,f),Xn(v,i,e,f),ei(h,d,f)}return{id:"contabilidad",route:"contabilidad",nombre:"Contabilidad",flagId:"contabilidad",seccion:1,iconoPath:Ei,mount:b}}const _i="M12 1L3 5v6c0 5.55 3.84 10.74 9 12 5.16-1.26 9-6.45 9-12V5l-9-4zm0 4l5 2.18V11c0 3.5-2.33 6.79-5 7.93-2.67-1.14-5-4.43-5-7.93V7.18L12 5z";function oa(){return Date.now().toString(36)+Math.random().toString(36).slice(2,6)}function Fi(t){const{store:e}=t,a=t.hoy??Y,o=()=>G(a()),s=()=>e.get("config").margenesSeguridad??[];function n(y){var g;e.patchConfig({margenesSeguridad:y}),(g=t.onDatosCambiados)==null||g.call(t)}function i(y,g){const I=s().map(v=>({...v,puntos:(v.puntos??[]).map(h=>({...h}))})),A=I.find(v=>v._id===y);A&&(g(A),n(I))}function r(y){const g=e.get("config"),I=ge(y,e.get("expenses"),g,e.get("loans"),a(),!1,o());return j(I)}function l(y,g,I){const A=g.tipo==="fijo",v=A?"":`<span class="text-sm" style="color:var(--text3)">${c(j((g.meses??0)*I))}</span>`;return`
      ...
      </tr>`}function d(y,g,I){const A=y.cuentas&&y.cuentas.length>0?y.cuentas.map($=>{var m;return((m=g.find(x=>x._id===$))==null?void 0:m.nombre)??$}).join(", "):"Todas las cuentas activas",h=[...y.puntos??[]].sort(($,m)=>$.fecha.localeCompare(m.fecha)).map($=>l(y,$,I)).join(""),f=y.activo?`
      ...
      ${g.length===0?`<div class="card" style="padding:24px;text-align:center">
             ...
             </div>`:g.map(h=>d(h,I,A)).join("")}`;const v=()=>p(y);N(y,"[data-nuevo-margen]",()=>u(null,v)),N(y,"[data-editar-margen]",h=>u(h.getAttribute("data-editar-margen"),v)),N(y,"[data-borrar-margen]",h=>{Z("¿Eliminar este margen de seguridad?")&&(n(s().filter(f=>f._id!==h.getAttribute("data-borrar-margen"))),q("Margen eliminado"),v())}),J(y,"[data-toggle-margen]",h=>{const f=h.getAttribute("data-toggle-margen");i(f,$=>{$.activo=h.checked}),v()}),N(y,"[data-add-punto]",h=>{const f=h.getAttribute("data-add-punto");i(f,$=>{$.puntos=[...$.puntos??[],{_id:oa(),fecha:Y(),tipo:"fijo",importe:0,meses:1}]}),v()}),N(y,"[data-borrar-punto]",h=>{const f=h.closest("[data-punto]");if(!f)return;const $=f.dataset.margen,m=f.dataset.punto;i($,x=>{x.puntos=(x.puntos??[]).filter(S=>S._id!==m)}),v()}),J(y,"[data-campo]",h=>{const f=h.closest("[data-punto]");if(!f)return;const $=h.getAttribute("data-campo"),m=h.value;i(f.dataset.margen,x=>{const S=(x.puntos??[]).find(w=>w._id===f.dataset.punto);S&&($==="fecha"?S.fecha=m:$==="tipo"?S.tipo=m:$==="importe"?S.importe=parseFloat(m)||0:S.meses=parseFloat(m)||0)}),v()})}return{id:"margenes",route:"margenes",nombre:"Márgenes de seguridad",flagId:"margenes",seccion:2,iconoPath:_i,mount:p}}const Pi="https://api.worldbank.org/v2/country/ES/indicator/FP.CPI.TOTL.ZG?format=json&mrv=65&per_page=65";function Di(t){const e=Array.isArray(t)?t[1]??[]:[];return Array.isArray(e)?e.filter(a=>a&&a.value!==null&&a.value!==void 0&&Number.isFinite(Number(a.value))).map(a=>({year:parseInt(a.date),tasa:parseFloat(Number(a.value).toFixed(2))})).filter(a=>Number.isFinite(a.year)).sort((a,o)=>a.year-o.year):[]}function Ti({fetchImpl:t,url:e=Pi}={}){let a=null,o=!1;async function s(n=!1){if(a&&!n)return a;if(o)return null;o=!0;try{const r=await(t??fetch)(e);if(!r.ok)throw new Error(`HTTP ${r.status}`);return a=Di(await r.json()),a}catch(i){return console.error("[inflacion] No se pudo cargar el IPC del Banco Mundial:",i),null}finally{o=!1}}return{obtener:s,invalidar:()=>{a=null},get enCache(){return a}}}const Ni="M16 6l2.29 2.29-4.88 4.88-4-4L2 16.59 3.41 18l6-6 4 4 6.3-6.29L22 12V6z";function Ri(t){return t>5?"var(--red)":t>2.5?"var(--yellow)":"var(--accent)"}function Oi(t){const{store:e}=t,a=t.ipc??Ti(),o=()=>e.get("inflacion")??[];function s(){var u;(u=t.onDatosCambiados)==null||u.call(t)}function n(u,p){if(!u||u.length===0)return`
        ...
        </div>`;const y=new Set(o().map(h=>h.year)),g=u.filter(h=>h.year>=p).reverse(),I=g.filter(h=>!y.has(h.year)).length,A=[...new Set(u.map(h=>h.year))].sort((h,f)=>h-f),v=g.map(h=>`
        <div style="display:grid;grid-template-columns:20px 60px 80px 1fr;gap:10px;align-items:center;padding:5px 0;border-bottom:1px solid var(--border)">
          ...
          <span style="font-family:var(--font-mono);font-weight:600;color:${Ri(h.tasa)}">${h.tasa.toFixed(2)}%</span>
      ...
      </div>`}function i(u){return!u||u.length===0?2e3:Math.max(u[0].year,new Date().getFullYear()-25)}async function r(u){const p=document.getElementById("modal-overlay"),y=document.getElementById("modal-content");if(!p||!y)return;y.innerHTML=`
      ...
      </div>`}function b(u){const p=o(),y=e.get("config").usarInflacion||!1,g=[...p].sort((x,S)=>S.year-x.year),I=Y(),A=new Date().getFullYear(),v=V(new Date(A+5,0,1)),h=V(new Date(A+10,0,1)),f=y&&p.length>0?pt(p,I,v):null,$=y&&p.length>0?pt(p,I,h):null;u.innerHTML=`
      <div class="page-header">
      ...
      <div class="card" style="padding:0;overflow:hidden">
        ...
        ${g.length===0?'<div class="text-sm" style="text-align:center;padding:30px;color:var(--text2)">Sin periodos configurados. Añade el primer registro.</div>':g.map(x=>d(x,I)).join("")}
      </div>
      ...
      </div>`;const m=()=>b(u);J(u,"[data-toggle-inflacion]",x=>{const S=x.checked;e.patchConfig({usarInflacion:S}),q(S?"Estimaciones de inflación activadas":"Estimaciones de inflación desactivadas"),s(),m()}),N(u,"[data-nuevo-periodo]",()=>l(null,m)),N(u,"[data-editar-periodo]",x=>l(x.getAttribute("data-editar-periodo"),m)),N(u,"[data-importar-ipc]",()=>void r(m)),N(u,"[data-borrar-periodo]",x=>{Z("¿Eliminar este periodo de inflación?")&&(e.removeItem("inflacion",x.getAttribute("data-borrar-periodo")),q("Periodo eliminado"),s(),m())})}return{id:"inflacion",route:"inflacion",nombre:"Inflación",flagId:"inflacion",seccion:2,iconoPath:Ni,mount:b}}const qi=[...Array.from({length:31},(t,e)=>String(e+1)),"ultimo"],Li=[["1","1º"],["2","2º"],["3","3º"],["4","4º"],["5","5º"],["-1","Último"]],Bi=[["1","lunes"],["2","martes"],["3","miércoles"],["4","jueves"],["5","viernes"],["6","sábado"],["0","domingo"]];function ki(t){const e=t||"";if(e.startsWith("dia:"))return{modo:"dia",dia:e.slice(4)||"1",nth:"1",wd:"1"};if(e.startsWith("nthweekday:")){const[,a="1",o="1"]=e.split(":");return{modo:"nthweekday",dia:"1",nth:a,wd:o}}return{modo:"none",dia:"1",nth:"1",wd:"1"}}const sa=(t,e)=>t.map(([a,o])=>`<option value="${c(a)}"${a===e?" selected":""}>${c(o)}</option>`).join("");function Co(t,e="dp"){const{modo:a,dia:o,nth:s,wd:n}=ki(t),i=sa(qi.map(r=>[r,r==="ultimo"?"Último día":r]),o);return`<div class="form-group" data-diapago="${c(e)}">
    ...
    <div class="flex gap-8 items-center" style="flex-wrap:wrap;row-gap:6px">
    ...
    </div>`}function u(v){const h=i(),f=r();v.innerHTML=`
      <div class="page-header">
      ...
      <div class="filter-bar">
        ...
        <select class="form-select" data-f-cuenta>${d(a.cuenta,!0)}</select>
      ...
      <div class="grid-3 mt-8">
        ...
        <div class="form-group"><label class="form-label">Tipo frecuencia</label>
          <select class="form-select" id="ef-tipo-frec">
            ${Gi.map(([x,S])=>`<option value="${x}"${((v==null?void 0:v.tipoFrecuencia)??"mensual")===x?" selected":""}>${c(S)}</option>`).join("")}
          </select>
        </div>
      </div>
      <div class="grid-2 mt-8">
        ...
        <div class="form-group"><label class="form-label">Cuenta</label>
          <select class="form-select" id="ef-cuenta">${d((v==null?void 0:v.cuenta)??"default")}</select></div>
      </div>
      <div id="ef-destino-wrap" class="mt-8"${h?"":' style="display:none"'}>
        <div class="form-group"><label class="form-label">Cuenta destino</label>
          <select class="form-select" id="ef-cuenta-dest">${d((v==null?void 0:v.cuentaDestino)??"default")}</select></div>
      </div>
      ...
      <details class="form-advanced mt-12"${v!=null&&v._id?" open":""}>
        ...
        <div class="form-advanced-body">
          ...
          <div class="mt-8">${Co(v==null?void 0:v.diaPago,"exp")}</div>
    ...
    <div class="loan-card-body" data-body-loan="${c(t._id)}">
      ...
      ${o?`<div class="card" style="background:var(--bg3);padding:12px;margin-bottom:12px">
               ...
               ${d!==null?`<div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(160px,1fr));gap:8px;margin-bottom:10px">
                        ...
                        <div title="Intereses ahorrados en euros de hoy, descontando la inflación proyectada">
                          ...
                          <div class="num pos" style="color:var(--yellow)">${c(j(d))}</div>
                        </div>
      ...
      <div class="table-wrap"><table>
        ...
        <tbody>${a.tabla.map(y=>Wi(y,n,e)).join("")}</tbody>
      </table></div>

      ${o?`<div class="card-title mt-12">Amortizaciones programadas</div>
             ${(t.amortizaciones||[]).map((y,g)=>Ki(t._id,y,l[g]??null,e)).join("")}`:""}
    </div>
  </div>`}function Ji(t,e,a,o){const s=t.tipoTasa==="variable"?'<div class="text-sm mt-8" style="color:var(--text3)">⚠ Tipo variable: el beneficio real dependerá de cómo evolucione el índice de referencia.</div>':"";if(o!==null){const r=o-a,l=r>=0;return`<div class="card mb-12" style="background:var(--bg3);padding:12px">
    ...
    ${s}
  </div>`}function Wi(t,e,a){let o="";if(e&&!t.esAmortizacion){const s=pt(a.periodos,a.hoy,t.fecha);o=c(j(s>0?t.cuota/s:t.cuota))}return`<tr ${t.esAmortizacion?'style="background:var(--yellow-dim)"':""}>
   ...
   ${o?`<span class="text-sm" style="margin-left:6px">${c(o)}</span>`:""}`;function le(t,e,a){return t.length===0?"":`<div class="form-group mt-8"><label class="form-label">Supuestos</label>
    ...
    </div></div>`}const Qi=(t,e)=>t.filter(a=>a.activo!==!1).map(a=>`<option value="${c(a._id)}"${a._id===e?" selected":""}>${c(a.nombre)}</option>`).join("");function Xi(t,e,a,o=Y()){return`
    <div class="grid-2">
      ...
      <div class="form-advanced-body">
        <div class="grid-2 mt-8">
          <div class="form-group"><label class="form-label">Cuenta bancaria</label>
            <select class="form-select" id="f-cuenta">${Qi(e,(t==null?void 0:t.cuenta)??"default")}</select></div>
          ${Co(t==null?void 0:t.diaPago,"loan")}
        </div>
        <div class="mt-8">
    ...
    </div>`}function Zi(t,e,a,o=Y()){return`
    <div class="grid-2">
    ...
    <div class="flex gap-8 mt-16" style="justify-content:flex-end">
    ...
    </div>`}const _o="opt_",Fo=t=>String(t).startsWith(_o);function tr(t){let e=null,a=null;const o=()=>document.getElementById("modal-overlay"),s=()=>document.getElementById("modal-content");function n(f,$){const m=o(),x=s();return!m||!x?null:(x.innerHTML=`<div class="modal-title">${c(f)}</div>${$}`,m.classList.remove("hidden"),x)}const i=()=>{var f;return(f=o())==null?void 0:f.classList.add("hidden")};function r(){let f=!1;for(const $ of t.loans()){const m=($.amortizaciones||[]).filter(x=>!Fo(x._id));m.length!==($.amortizaciones||[]).length&&(t.guardarAmortizaciones($._id,m),f=!0)}return f}function l(f){try{return f()}catch($){return q($ instanceof Error?$.message:"No se ha podido completar el cálculo","err"),null}}function d(){var E,_;if(!Ya("optimizador")){q("El optimizador de amortizaciones está desactivado. Actívalo en ⚙ Funcionalidades.","err");return}const f=t.loans().filter(D=>D.activo&&!D.simulacion);if(f.length===0){q("No hay préstamos activos para optimizar","err");return}const $=t.config(),m=t.accounts().filter(D=>D.activo&&!D.simulacion),x=((E=m.find(D=>D.esCuentaPrincipal))==null?void 0:E._id)??((_=m[0])==null?void 0:_._id)??"",S=$.dashboardEnd||`${Number(t.hoy().slice(0,4))+5}-01-01`,w=n("✨ Optimizar amortizaciones",`
      ...
      <div style="max-height:300px;overflow-y:auto">
        <table class="table-wrap" style="width:100%">
          ...
          <tbody>${_.plan.map(M=>Po(M,!0)).join("")}</tbody>
        </table>
      </div>
      ...
      <div class="flex gap-8 mt-16" style="justify-content:flex-end">
        <button class="btn-secondary" data-opt-volver>← Cambiar parámetros</button>
        <button class="btn-secondary" data-cancelar>Cerrar</button>
      </div>`);F&&(N(F,"[data-opt-volver]",d),N(F,"[data-cancelar]",i),N(F,"[data-opt-usar]",T=>A(Number(T.getAttribute("data-opt-usar")))))}function A(f){var m;const $=e==null?void 0:e.resultados.find(x=>x.frecuencia===f);$&&(r(),v($.plan,((m=$.plan[0])==null?void 0:m.tipoAmort)||"plazo",{titulo:`✨ Plan ${$.label} · aplicado`,resumen:$,fechaObjetivo:e==null?void 0:e.fechaObjetivo}))}function v(f,$,m){if(f.length===0)return;const x=new Map;for(const w of f){const E=x.get(w.loanId)??[];E.push({_id:`${_o}${w.mes}_${w.loanId}`,fecha:w.fechaAmort,cantidad:w.cantidadAmort,tipo:$,simulacion:!0}),x.set(w.loanId,E)}let S=0;for(const w of t.loans()){const E=x.get(w._id);if(!E)continue;const _=(w.amortizaciones||[]).filter(D=>!Fo(D._id));t.guardarAmortizaciones(w._id,[..._,...E]),S+=1}q(`Plan aplicado: ${f.length} amortizaciones en ${S} préstamo${S!==1?"s":""} (simulación)`),m?h(m):i(),t.refrescar([...x.keys()])}function h({titulo:f,resumen:$,fechaObjetivo:m}){const x=n(f,`
      <div class="grid-4 mb-14" style="gap:10px">
      ...
      <div style="max-height:260px;overflow-y:auto">
        <table class="table-wrap" style="width:100%">
          ...
          <tbody>${$.plan.map(S=>Po(S,!1)).join("")}</tbody>
        </table>
      </div>
      ...
      <div class="flex gap-8 mt-12" style="justify-content:flex-end">
        <button class="btn-secondary" data-cancelar>Cerrar</button>
      </div>`);x&&N(x,"[data-cancelar]",i)}return{abrir:d,get planManual(){return a},get comparativa(){return e}}}function Po(t,e){const a=t.comision>0?`<br><span style="font-size:9px;color:var(--text3)">+${c(j(t.comision))} com.</span>`:"";return`<tr>
  ...
  </tr>`}function Do(t){return`<div class="card mb-8" style="padding:12px">
  ...
  </div>`}const er="M11.8 10.9c-2.27-.59-3-1.2-3-2.15 0-1.09 1.01-1.85 2.7-1.85 1.78 0 2.44.85 2.5 2.1h2.21c-.07-1.72-1.12-3.3-3.21-3.81V3h-3v2.16c-1.94.42-3.5 1.68-3.5 3.61 0 2.31 1.91 3.46 4.7 4.13 2.5.6 3 1.48 3 2.41 0 .69-.49 1.79-2.7 1.79-2.06 0-2.87-.92-2.98-2.1h-2.2c.12 2.19 1.76 3.42 3.68 3.83V21h3v-2.15c1.95-.37 3.5-1.5 3.5-3.55 0-2.84-2.43-3.81-4.7-4.4z";function ar(t){const e=t.hoy??Y;let a=!1;const o=new Set;let s=null;const n=()=>{var m;return(m=t.onDatosCambiados)==null?void 0:m.call(t)},i=()=>t.store.get("escenarios"),r=m=>{var x;return((x=i().find(S=>S._id===m))==null?void 0:x.nombre)??m};function l(m){if(!m.activo||m.simulacion)return!1;const x=at(m).tabla.filter(S=>!S.esAmortizacion);return x.length===0?!0:x[x.length-1].fecha<e()}function d(m,x){const S=e(),w=S.slice(0,7),E=new Map;let _=0;for(const D of m){if(!D.activo||D.simulacion||x.has(D._id)||(D.fechaInicio||"")>S)continue;const C=at(D).tabla.filter(z=>!z.esAmortizacion&&z.fecha.startsWith(w)),M=C.length>0?C[0].cuota:0;E.set(D._id,M),_+=M}return{porLoan:E,total:_,activos:[...E.values()].filter(D=>D>0).length}}function b(m){const x=t.store.get("config"),S=x.dashboardStart,w=x.dashboardEnd,E=Math.max(1,(G(w).getTime()-G(S).getTime())/(30.44*864e5));let _=0;for(const D of m)!D.activo||D.simulacion||(_+=at(D).tabla.filter(C=>!C.esAmortizacion&&C.fecha>=S&&C.fecha<=w).reduce((C,M)=>C+M.cuota,0));return{media:_/E,desde:S,hasta:w}}function u(m){const x=[...t.store.get("loans")].sort((z,F)=>F.tin-z.tin),S=new Set(x.filter(l).map(z=>z._id)),w=a?x:x.filter(z=>!S.has(z._id)),E=d(x,S),_=b(x),D=t.store.get("config"),C=t.store.get("inflacion"),M=new Date(G(e())).toLocaleDateString("es-ES",{month:"long",year:"numeric"});m.innerHTML=`
      <div class="page-header">
   ...
   <input class="form-input" type="${a}" id="${t}" value="${c(o)}" placeholder="${c(s)}"/></div>`,ir=(t,e)=>t.filter(a=>a.activo!==!1).map(a=>`<option value="${c(a._id)}"${a._id===e?" selected":""}>${c(a.nombre)}</option>`).join("");function rr(t,e){const a=t.map((n,i)=>{const r=e.find(b=>b._id===n.cuenta),l=or[n.tipo],d=l!=null&&n.importe>l;return`<div class="flex gap-8 items-center" style="padding:5px 0;border-bottom:1px solid var(--border)">
    ...
    <button class="btn-secondary btn-sm mt-6" data-flex-anadir>+ Añadir componente</button>`}function lr(t,e){const a=e.hoy??Y(),o=(t==null?void 0:t.nPagas)??12,s=[12,14,16].includes(o);return`
    <div class="grid-2">
    ...
    <div class="grid-2 mt-8">
      ...
      <div class="form-group"><label class="form-label">Cuenta</label>
        <select class="form-select" id="nf-cuenta">${ir(e.accounts,(t==null?void 0:t.cuenta)??e.cuentaPrincipal)}</select></div>
    </div>
        ...
        <div class="grid-2 mt-8">
          ...
          <div class="form-group"><label class="form-label">Mes actualización IPC (opcional)</label>
            <select class="form-select" id="nf-mes-ipc">
              ...
              ${nr.map((n,i)=>`<option value="${i+1}"${(t==null?void 0:t.mesActualizacionIPC)===i+1?" selected":""}>${c(n)} (${i+1})</option>`).join("")}
            </select>
          </div>
        </div>
        <div class="grid-2 mt-8">
    ...
    <div style="margin-top:8px;display:grid;grid-template-columns:1fr 1fr;gap:4px">
      ...
      <span style="color:var(--text2)">Neto dinerario:</span><span class="pos">${c(j(d))}</span>
      ...
      <span style="color:var(--text2)">En predicciones:</span><span style="font-size:11px">${s.representacion==="simplificado"?`ingreso ${c(j(y))}/paga`:`ingreso ${c(j(b))} − SS ${c(j(u))} − IRPF ${c(j(p))}`}${n>0?" + recargas flex":""}</span>
    </div>${I}`}function dr(t,e,a,o){const s=()=>{const r=t.querySelector("#flex-comp-container");r&&(r.innerHTML=rr(e,a.accounts))},n=()=>{const r=t.querySelector("#nf-preview");r&&(r.innerHTML=cr(t,e,a,o))},i=()=>{var l,d;const r=(b,u)=>{const p=t.querySelector(b);p&&(p.style.display=u?"":"none")};r("#nf-custom-pagas-wrap",((l=t.querySelector("#nf-npagas"))==null?void 0:l.value)==="custom"),r("#nf-irpfpct-wrap",((d=t.querySelector("#nf-irpfmodo"))==null?void 0:d.value)==="manual"),n()};t.addEventListener("input",r=>{var l;(l=r.target)!=null&&l.closest("#nf-bruto, #nf-irpfpct, #nf-npagas-custom, #nf-grupo, #nf-sspct")&&n()}),J(t,"#nf-npagas, #nf-irpfmodo, #nf-representacion",i),N(t,"[data-flex-anadir]",()=>{var d,b,u;const r=((d=t.querySelector("#fc-tipo"))==null?void 0:d.value)||"transporte",l=parseFloat(((b=t.querySelector("#fc-importe"))==null?void 0:b.value)??"")||0;if(!l)return q("Importe requerido","err");e.push({_id:Date.now().toString(36),tipo:r,importe:l,cuenta:((u=t.querySelector("#fc-cuenta"))==null?void 0:u.value)||""}),s(),n()}),N(t,"[data-flex-borrar]",r=>{e.splice(Number(r.getAttribute("data-flex-borrar")),1),s(),n()}),s(),n()}const No=t=>t.slice(0,3).map(([,e])=>`${e}%`).join(" · ")+(t.length>3?" …":"");function ur(t){let e=null,a=[];const o=()=>document.getElementById("modal-overlay"),s=()=>document.getElementById("modal-content"),n=()=>{var p;return(p=o())==null?void 0:p.classList.add("hidden")},i=()=>t.store.get("config").tramos_irpf??gt;function r(p,y){const g=o(),I=s();return!g||!I?null:(I.innerHTML=`<div class="modal-title">${c(p)}</div>${y}`,g.classList.remove("hidden"),N(I,"[data-cerrar]",n),I)}function l(){e=null;const p=[...t.store.get("tramosIRPFHistorico")].sort((I,A)=>I.año-A.año),y="display:grid;grid-template-columns:90px 1fr auto;gap:0;padding:10px 12px;border-top:1px solid var(--border);align-items:center",g=r("Tramos IRPF por ejercicio",`
      <div class="text-sm mb-12" style="color:var(--text2)">
      ...
      <div style="border:1px solid var(--border);border-radius:var(--radius);overflow:hidden;margin-bottom:14px">
        ...
        ${p.map(I=>`<div style="${y}">
              ...
              <span class="text-sm" style="color:var(--text2)">${c(No(I.tramos))}</span>
      ...
      </div>`);if(!A)return;const v=()=>{const f=A.querySelector("#irpf-tramos-rows");f&&(f.innerHTML=d())};N(A,"[data-volver]",l),N(A,"[data-tr-anadir]",()=>{b(A),a.push([0,0]),v()}),N(A,"[data-tr-borrar]",f=>{b(A),a.splice(Number(f.getAttribute("data-tr-borrar")),1),v()}),N(A,"[data-tr-guardar]",()=>{b(A);const f=[...a].sort(($,m)=>$[0]-m[0]);if(f.length===0)return q("Añade al menos un tramo","err");e==="default"?(t.store.patchConfig({tramos_irpf:f}),q("Tabla por defecto guardada")):(t.store.set("tramosIRPFHistorico",t.store.get("tramosIRPFHistorico").map($=>$.año===e?{...$,tramos:f}:$)),q(`Tabla ${e} guardada`)),t.onDatosCambiados(),l()})}return{abrir:l}}const Ro=1500,Dt=(t,e,a,o,s="")=>`<div class="form-group"><label class="form-label">${c(e)}</label>
   <input class="form-input" type="${a}" id="${t}" value="${c(o)}" placeholder="${c(s)}"/></div>`,pr=(t,e,a,o)=>`<div class="form-group"><label class="form-label">${c(e)}</label>
   <select class="form-select" id="${t}">
     ${a.map(([s,n])=>`<option value="${c(s)}"${s===o?" selected":""}>${c(n)}</option>`).join("")}
   </select></div>`,mr=t=>(t.modeloFondo||"cuenta")==="pension";function fr(t,e,a,o){return t.length===0?`<div class="card text-sm" style="padding:24px;text-align:center;color:var(--text2)">
      Sin planes de pensiones. Crea uno con el botón "+ Nuevo plan de pensiones".
    </div>`:`<div class="grid-3">${t.map(s=>vr(s,e,a,o)).join("")}</div>`}function vr(t,e,a,o){const s=ve(t);if(!s)return"";const n=Te(t,e,a),i=o.slice(0,4),r=(t.aportaciones||[]).filter(d=>d.fecha>=`${i}-01-01`).reduce((d,b)=>d+b.cantidad,0),l=Math.min(r,Ro)*(n/100);return`<div class="card">
    ...
    <div style="margin-top:10px;padding:8px;background:var(--bg3);border-radius:var(--radius);border:1px solid var(--border)">
      ...
      <div class="flex justify-between mb-4"><span class="text-sm" style="color:var(--text2)">Aportado</span><span class="num ${r>Ro?"neg":""}">${c(j(r))}</span></div>
  ...
  </div>`}function gr(t){return`<div>${t.map((a,o)=>`<div class="flex gap-8 items-center" style="padding:4px 0;border-bottom:1px solid var(--border)">
    ...
    <button class="btn-secondary btn-sm mt-6" data-aport-anadir>+ Añadir aportación</button>`}function br(t,e){const a=[...(t==null?void 0:t.historicoSaldos)??[]].sort((i,r)=>r.fecha.localeCompare(i.fecha)),o=a[0]?a[0].saldo:(t==null?void 0:t.saldo)??0,s=[...new Set(e.nominas.filter(i=>i.grupoNomina).map(i=>i.grupoNomina))],n=!!(t!=null&&t.grupoNomina);return`
    <div class="grid-2">
    ...
    <div class="grid-2 mt-8">
      ...
      ${pr("pen-periodo","Capitalización",[["diario","Diario"],["mensual","Mensual"],["anual","Anual"]],(t==null?void 0:t.periodoCobro)??"mensual")}
    </div>
    <div class="grid-2 mt-8">
    ...
    <div class="flex gap-8 mt-16" style="justify-content:flex-end">
    ...
    </div>`}function hr(t,e,a){const o=()=>{const s=t.querySelector("#pen-aport-container");s&&(s.innerHTML=gr(e))};J(t,"#pen-grupo",s=>{const n=t.querySelector("#pen-impuesto-wrap");n&&(n.style.display=s.value?"none":"")}),N(t,"[data-aport-anadir]",()=>{var n,i,r,l;const s=parseFloat(((n=t.querySelector("#paport-importe"))==null?void 0:n.value)??"")||0;if(!s)return q("Importe requerido","err");e.push({_id:Date.now().toString(36),importe:s,periodicidad:((i=t.querySelector("#paport-periodo"))==null?void 0:i.value)||"mensual",fechaInicio:((r=t.querySelector("#paport-inicio"))==null?void 0:r.value)||a,fechaFin:((l=t.querySelector("#paport-fin"))==null?void 0:l.value)||""}),o()}),N(t,"[data-aport-borrar]",s=>{e.splice(Number(s.getAttribute("data-aport-borrar")),1),o()}),o()}function yr(t,e,a,o){var A;const s=v=>{var h;return((h=t.querySelector(v))==null?void 0:h.value)??""},n=(v,h=0)=>{const f=parseFloat(s(v));return Number.isFinite(f)?f:h},i=v=>{var h;return!!((h=t.querySelector(v))!=null&&h.checked)},r=s("#pen-nombre").trim();if(!r)return{datos:{},error:"Nombre obligatorio"};const l=n("#pen-saldo"),d=s("#pen-grupo"),b={nombre:r,grupoNomina:d,saldo:l,saldoInicial:n("#pen-saldo-ini"),fechaInicialSaldo:s("#pen-fecha-ini")||o,interes:n("#pen-interes"),periodoCobro:s("#pen-periodo")||"mensual",modeloFondo:"pension",bloqueoMeses:parseInt(s("#pen-bloqueo"),10)||120,impuestoRetirada:d?0:n("#pen-impuesto"),planAportaciones:e,descripcion:s("#pen-desc").trim(),activo:i("#pen-activo"),simulacion:i("#pen-sim"),escenarioIds:[...t.querySelectorAll(".pen-escenario:checked")].map(v=>v.value)},u=[...(a==null?void 0:a.historicoSaldos)??[]],p=[...(a==null?void 0:a.aportaciones)??[]],g=((A=[...u].sort((v,h)=>h.fecha.localeCompare(v.fecha))[0])==null?void 0:A.saldo)??(a==null?void 0:a.saldo)??null,I=Date.now().toString(36);return a?(g===null||Math.abs(l-g)>.005)&&(u.push({_id:I,fecha:o,saldo:l,nota:"Actualización manual"}),l>(g??0)&&p.push({_id:`${I}a`,fecha:o,cantidad:l-(g??0)})):l>0&&(u.push({_id:I,fecha:o,saldo:l,nota:"Saldo inicial"}),p.push({_id:`${I}a`,fecha:b.fechaInicialSaldo??o,cantidad:l})),{datos:{...b,historicoSaldos:u,aportaciones:p}}}const xr="M20 6h-3V4c0-1.11-.89-2-2-2H9c-1.11 0-2 .89-2 2v2H4c-1.11 0-1.99.89-1.99 2L2 19c0 1.11.89 2 2 2h16c1.11 0 2-.89 2-2V8c0-1.11-.89-2-2-2zm-5 0H9V4h6v2z";function $r(t){const e=t.hoy??Y,a=()=>{var A;return(A=t.onDatosCambiados)==null?void 0:A.call(t)};function o(){const A=t.store.get("config");return bt(t.store.get("tramosIRPFHistorico"),A.tramos_irpf??gt)(Number(e().slice(0,4)))}function s(A,v,h){const f=Oe(A,v,h),$=!!v&&A.irpfModo!=="manual",m=[A.mesActualizacionIPC?`<span class="badge badge-blue" title="Actualización IPC en el mes ${A.mesActualizacionIPC}">IPC m${A.mesActualizacionIPC}</span>`:"",f.flexAnual>0?`<span class="badge" style="background:rgba(99,214,160,0.12);color:#63d6a0" title="Retribución flexible exenta de IRPF y SS">RF ${c(j(f.flexAnual))}/año</span>`:"",Math.abs(f.ssPct-6.35)>.01?`<span class="badge" style="background:rgba(255,200,80,0.12);color:var(--yellow)" title="Cotización SS del empleado personalizada">SS ${f.ssPct.toFixed(2)}%</span>`:""].join("");return`<div class="exp-table-row">
      <div>
    ...
    </div>`}const n=A=>{var v;return((v=t.store.get("accounts").find(h=>h._id===(A||"default")))==null?void 0:v.nombre)??(A||"default")};function i(A,v,h){const f=v.reduce((x,S)=>x+(S.bruto||0),0),$=As(v,h),m=f>0?$/f*100:0;return`<div style="margin-bottom:16px">
    ...
    </div>`}function r(A){const v=o(),h=[...t.store.get("nominas")].sort((S,w)=>(w.bruto||0)-(S.bruto||0)),{grupos:f,sueltas:$}=Ms(h),m=t.store.get("accounts").filter(mr),x=h.filter(S=>S.activo!==!1);A.innerHTML=`
      <div class="page-header">
      ...
      <div>${fr(m,x,v,e())}</div>`}const l=()=>document.getElementById("modal-overlay"),d=()=>document.getElementById("modal-content"),b=()=>{var A;return(A=l())==null?void 0:A.classList.add("hidden")};function u(A,v){const h=l(),f=d();return!h||!f?null:(f.innerHTML=`<div class="modal-title">${c(A)}</div>${v}`,h.classList.remove("hidden"),N(f,"[data-cancelar]",b),f)}function p(A,v){const h=A?t.store.get("nominas").find(x=>x._id===A)??null:null,f=[...(h==null?void 0:h.retribucionFlexible)??[]].map(x=>({...x})),$={accounts:t.store.get("accounts"),escenarios:t.store.get("escenarios"),nominas:t.store.get("nominas"),cuentaPrincipal:t.store.getPrincipalAccountId(),tramos:o(),hoy:e()},m=u(A?"Editar nómina":"Nueva nómina",lr(h,$));m&&(dr(m,f,$,A??""),N(m,"[data-guardar-nomina]",x=>{const S=To(m,f);if(!S.nombre||S.bruto<=0)return q("Nombre y bruto anual son obligatorios","err");const w=x.getAttribute("data-guardar-nomina")||"",E={...S,activo:!0,tags:["nomina"]};w?(t.store.updateItem("nominas",w,E),q("Nómina actualizada")):(t.store.addItem("nominas",E),q("Nómina creada")),a(),b(),v()}))}function y(A,v){const h=A?t.store.get("accounts").find(m=>m._id===A)??null:null,f=[...(h==null?void 0:h.planAportaciones)??[]].map(m=>({...m})),$=u(A?"Editar plan de pensiones":"Nuevo plan de pensiones",br(h,{nominas:t.store.get("nominas"),escenarios:t.store.get("escenarios"),hoy:e()}));$&&(hr($,f,e()),N($,"[data-guardar-pension]",m=>{const{datos:x,error:S}=yr($,f,h,e());if(S)return q(S,"err");const w=m.getAttribute("data-guardar-pension")||"";w?(t.store.updateItem("accounts",w,x),q("Plan actualizado")):(t.store.addItem("accounts",x),q("Plan creado")),a(),b(),v()}))}function g(A,v,h){N(A,"[data-nueva-nomina]",()=>p(null,v)),N(A,"[data-editar-nom]",f=>p(f.getAttribute("data-editar-nom"),v)),N(A,"[data-borrar-nom]",f=>{Z("¿Eliminar esta nómina?")&&(t.store.removeItem("nominas",f.getAttribute("data-borrar-nom")),q("Eliminada"),a(),v())}),J(A,"[data-activo-nom]",f=>{const $=f;t.store.updateItem("nominas",$.getAttribute("data-activo-nom"),{activo:$.checked}),a(),v()}),N(A,"[data-tramos]",()=>h.abrir()),N(A,"[data-nueva-pension]",()=>y(null,v)),N(A,"[data-editar-pension]",f=>y(f.getAttribute("data-editar-pension"),v)),N(A,"[data-borrar-pension]",f=>{Z("¿Eliminar este plan de pensiones?")&&(t.store.removeItem("accounts",f.getAttribute("data-borrar-pension")),q("Plan eliminado"),a(),v())})}let I=null;return{id:"nominas",route:"nominas",nombre:"Nóminas",flagId:"nominas",seccion:1,iconoPath:xr,mount(A){const v=()=>r(A);I??(I=ur({store:t.store,onDatosCambiados:()=>{a(),v()},año:()=>Number(e().slice(0,4))})),r(A),A.dataset.wired!=="1"&&(g(A,v,I),A.dataset.wired="1")}}}const Ir="M3 17.25V21h3.75L17.81 9.94l-3.75-3.75L3 17.25zM20.71 7.04c.39-.39.39-1.02 0-1.41l-2.34-2.34c-.39-.39-1.02-.39-1.41 0l-1.83 1.83 3.75 3.75 1.83-1.83z",Ar="M13 3c-4.97 0-9 4.03-9 9H1l3.89 3.89.07.14L9 12H6c0-3.87 3.13-7 7-7s7 3.13 7 7-3.13 7-7 7c-1.93 0-3.68-.79-4.94-2.06l-1.42 1.42C8.27 19.99 10.51 21 13 21c4.97 0 9-4.03 9-9s-4.03-9-9-9zm-1 5v5l4.28 2.54.72-1.21-3.5-2.08V8H12z",Oo={transporte:{label:"Transporte",limiteAnual:1500},restaurante:{label:"Restaurante",limiteAnual:2640},otros:{label:"Otros",limiteAnual:null}},Sr={entradas:[],salidas:[],totalAportaciones:0,totalReembolsos:0,retencion:0};function Mr(t,e){const a=t.filter(l=>l.activo&&mt(l)==="inversion");if(a.length===0)return"";let o=0,s=0,n=0,i=0;for(const l of a){const d=Ot(l,e);d&&(o+=d.saldo,s+=d.costBase,n+=d.plusvalia,i+=d.impuesto)}const r=s>0?(n/s*100).toFixed(1):"0";return`
    <div class="card mb-14" style="border-color:rgba(16,185,129,0.3)">
    ...
    </div>`}function wr(t,e){if(!t.activo||!t.interes||t.interes<=0)return"";const{dashboardStart:a,dashboardEnd:o}=e.config,s=Math.max(1,(G(o).getTime()-G(a).getTime())/(30.44*864e5)),n=Wt(t,a),i=n*(Math.pow(1+t.interes/100,s/12)-1);let r="";if(e.config.usarInflacion&&e.inflacion.length>0){const l=n*(pt(e.inflacion,a,o)-1),d=i-l;r=`
      ...
      <div class="flex justify-between mt-6">
        ...
        <span class="num" style="color:${d>=0?"var(--accent)":"var(--red)"};font-weight:600">${c(j(d))}</span>
  ...
  </div>`}function Cr(t,e){const a=Oo[t.tipoBeneficio??""]??{label:"Beneficio",limiteAnual:null},{limiteAnual:o}=a,s=e.nominas.flatMap(y=>(y.retribucionFlexible??[]).filter(g=>g.cuenta===t._id).map(g=>({nomina:y,importe:g.importe}))),n=s.reduce((y,g)=>y+g.importe,0),i=n*12,r=o!==null&&i>o,l=o!==null?Math.min(i,o):i,d=t.grupoNomina?e.nominas.filter(y=>(y.grupoNomina||"")===t.grupoNomina&&y.activo!==!1):s.slice(0,1).map(y=>y.nomina),b=ja(d,e.tramosIRPF),u=l*b/100,p=t.grupoNomina?`grupo "${t.grupoNomina}", tipo marginal ${b}%`:`tipo marginal ${b}%`;return`<div style="margin-top:10px;padding:10px;background:var(--bg3);border-radius:var(--radius);border:1px solid rgba(99,214,160,0.35)">
    ...
    ${u>0?`<div class="flex justify-between mb-5"><span class="text-sm" style="color:var(--text2)">Ahorro IRPF estimado</span>
             <span class="num pos" title="Importe exento × ${c(p)}">≈ ${c(j(u))}/año <span style="font-size:10px;color:var(--text3)">(${c(b)}%)</span></span></div>`:""}
  ...
  </div>`}function jr(t){const e=ve(t);return e?`<div style="margin-top:10px;padding:10px;background:var(--bg3);border-radius:var(--radius);border:1px solid var(--yellow-dark, #7a6010)">
  ...
  </div>`:""}function Er(t,e){const a=Ot(t,e.tramosGanancias);if(!a)return"";const o=e.config,s=e.flujos(t._id),n=G(o.dashboardStart),i=G(o.dashboardEnd),r=Math.max(0,(i.getTime()-n.getTime())/(30.44*864e5)),l=a.saldo+s.totalAportaciones-s.totalReembolsos,d=t.interes>0?Math.pow(1+t.interes/100,1/12)-1:0,b=l>0&&r>0?Math.max(0,l*Math.pow(1+d,r)):Math.max(0,l),u=a.costBase+s.totalAportaciones,p=Math.max(0,b-u),y=De(p,e.tramosGanancias),g=p>0?(y/p*100).toFixed(1):"0",I=t.interes>0?`${t.interes}% anual`:"sin rentabilidad",A=a.saldo>0?(a.plusvalia/a.saldo*100).toFixed(1):"0",v=(S,w,E)=>S.map(_=>`<div class="flex justify-between mt-4">
  ...
  </div>`}const _r=[["cuenta","Cuenta bancaria"],["inversion","Fondo de inversión"],["beneficio","Tarjeta beneficio"]];function Fr(t){return`<div>${t.map((a,o)=>`<div class="flex gap-8 items-center" style="padding:4px 0;border-bottom:1px solid var(--border)">
        <span style="min-width:70px;font-size:12px">${c(a.fechaInicio||"—")}</span>
        <span style="flex:1;font-size:12px">${c(j(a.importe))} / ${c(a.periodicidad)}</span>
        <span style="min-width:70px;font-size:12px;color:var(--text3)">${c(a.fechaFin||"indefinido")}</span>
        <button class="btn-danger btn-sm" data-aport-borrar="${o}">✕</button>
    ...
    <button class="btn-secondary btn-sm mt-6" data-aport-anadir>+ Añadir aportación</button>`}function Pr(t,e){const a=t?mt(t):"cuenta",o=[...new Set(e.nominas.filter(n=>n.grupoNomina).map(n=>n.grupoNomina))],s=n=>n?"":' style="display:none"';return`
    <div class="grid-2">
      ${tt("ac-nombre","Nombre","text",(t==null?void 0:t.nombre)??"","Ej: Cuenta ING, Fondo Vanguard")}
      ${Ht("ac-modelo","Tipo",_r,a)}
    </div>
    <div class="grid-2 mt-8">
    ...
    </div>`}function Dr(t,e,a){const o=()=>{const s=t.querySelector("#ac-aport-container");s&&(s.innerHTML=Fr(e))};J(t,"#ac-modelo",s=>{const n=s.value,i=(r,l)=>{const d=t.querySelector(r);d&&(d.style.display=l?"":"none")};i("#ac-inversion-hint",n==="inversion"),i("#ac-beneficio-fields",n==="beneficio")}),N(t,"[data-aport-anadir]",()=>{var n,i,r,l;const s=parseFloat(((n=t.querySelector("#aport-importe"))==null?void 0:n.value)??"")||0;if(!s)return q("Importe requerido","err");e.push({_id:Date.now().toString(36),importe:s,periodicidad:((i=t.querySelector("#aport-periodo"))==null?void 0:i.value)||"mensual",fechaInicio:((r=t.querySelector("#aport-inicio"))==null?void 0:r.value)||a,fechaFin:((l=t.querySelector("#aport-fin"))==null?void 0:l.value)||""}),o()}),N(t,"[data-aport-borrar]",s=>{e.splice(Number(s.getAttribute("data-aport-borrar")),1),o()}),o()}function Tr(t,e,a,o,s){const n=g=>{var I;return((I=t.querySelector(g))==null?void 0:I.value)??""},i=(g,I=0)=>{const A=parseFloat(n(g));return Number.isFinite(A)?A:I},r=g=>{var I;return!!((I=t.querySelector(g))!=null&&I.checked)},l=n("#ac-nombre").trim();if(!l)return{datos:{},error:"Nombre obligatorio"};const d=n("#ac-modelo")||"cuenta",b=d==="beneficio",u=i("#ac-saldo"),p={nombre:l,saldo:u,saldoInicial:i("#ac-saldo-ini"),fechaInicialSaldo:n("#ac-fecha-ini")||s,interes:i("#ac-interes"),periodoCobro:n("#ac-periodo")||"mensual",descripcion:n("#ac-desc").trim(),activo:r("#ac-activo"),simulacion:r("#ac-sim"),escenarioIds:[...t.querySelectorAll(".ac-escenario:checked")].map(g=>g.value),modeloFondo:d,planAportaciones:e,tipoBeneficio:b?n("#ac-tipo-beneficio")||"transporte":void 0,grupoNomina:b?n("#ac-beneficio-grupo"):(a==null?void 0:a.grupoNomina)??"",...a?{}:{historicoSaldos:[],aportaciones:[],esCuentaPrincipal:!1}};if(!a&&u<=0)return{datos:p};if(!(o===null||Math.abs(u-o)>.005))return{datos:p};if(d==="inversion"&&u>(o??0)){const g=Date.now().toString(36);p.aportaciones=[...(a==null?void 0:a.aportaciones)??[],{_id:`${g}a`,fecha:a?s:p.fechaInicialSaldo??s,cantidad:u-(o??0)}]}return{datos:p,punto:{fecha:s,saldo:u,nota:a?"Actualización manual":"Saldo inicial"}}}function ia(t){return[...t].sort((e,a)=>a.fecha.localeCompare(e.fecha)).map(e=>({_id:e._id,fecha:e.fecha,saldo:et(e.saldoCts),nota:e.nota}))}function Nr(t,e,a,o,s){const n=a.map(i=>`<div class="flex gap-8 items-center" style="padding:8px 0;border-bottom:1px solid var(--border)">
    ...
    <div class="flex gap-8 mt-12" style="justify-content:flex-end">
    ...
    </div>`}const qo=t=>t.slice(0,3).map(([,e])=>`${e}%`).join(" · ")+(t.length>3?" …":"");function Rr(t){let e=null,a=[];const o=()=>document.getElementById("modal-overlay"),s=()=>document.getElementById("modal-content"),n=()=>{var p;return(p=o())==null?void 0:p.classList.add("hidden")},i=()=>t.store.get("config").tramosGananciasCapital??Et;function r(p,y){const g=o(),I=s();return!g||!I?null:(I.innerHTML=`<div class="modal-title">${c(p)}</div>${y}`,g.classList.remove("hidden"),N(I,"[data-cerrar]",n),I)}function l(){e=null;const p=[...t.store.get("tramosGananciasCapitalHistorico")].sort((I,A)=>I.año-A.año),y="display:grid;grid-template-columns:90px 1fr auto;gap:0;padding:10px 12px;border-top:1px solid var(--border);align-items:center",g=r("Tramos — Ganancias de capital",`
      <div class="text-sm mb-12" style="color:var(--text2)">
      ...
      <div style="border:1px solid var(--border);border-radius:var(--radius);overflow:hidden;margin-bottom:14px">
        ...
        <div style="${y}">
          <span style="font-weight:600;font-size:13px">Por defecto</span>
          <span class="text-sm" style="color:var(--text2)">${c(qo(i()))}</span>
          <button class="btn-secondary btn-sm" data-editar-tg="default">Editar</button>
        </div>
        ${p.map(I=>`<div style="${y}">
              <span style="font-weight:600;font-size:13px">${I.año}</span>
              <span class="text-sm" style="color:var(--text2)">${c(qo(I.tramos))}</span>
              <div class="flex gap-6">
      ...
      <div class="flex gap-8 mt-16" style="justify-content:flex-end">
        ...
        </div>`).join("")}function b(p){a=[...p.querySelectorAll("[data-tg-min]")].map((y,g)=>{const I=p.querySelector(`[data-tg-pct="${g}"]`);return[parseFloat(y.value)||0,parseFloat((I==null?void 0:I.value)??"")||0]})}function u(p){var v;e=p;const y=t.store.get("tramosGananciasCapitalHistorico");a=(p==="default"?i():((v=y.find(h=>h.año===p))==null?void 0:v.tramos)??i()).map(h=>[...h]);const I=r(`Ganancias de capital — ${p==="default"?"Por defecto":p}`,`
      ...
      </div>`);if(!I)return;const A=()=>{const h=I.querySelector("#tg-rows");h&&(h.innerHTML=d())};N(I,"[data-volver-tg]",l),N(I,"[data-tg-anadir]",()=>{b(I),a.push([0,0]),A()}),N(I,"[data-tg-borrar]",h=>{b(I),a.splice(Number(h.getAttribute("data-tg-borrar")),1),A()}),N(I,"[data-tg-guardar]",()=>{b(I);const h=[...a].sort((f,$)=>f[0]-$[0]);if(h.length===0)return q("Añade al menos un tramo","err");e==="default"?(t.store.patchConfig({tramosGananciasCapital:h}),q("Tabla por defecto guardada")):(t.store.set("tramosGananciasCapitalHistorico",t.store.get("tramosGananciasCapitalHistorico").map(f=>f.año===e?{...f,tramos:h}:f)),q(`Tabla ${e} guardada`)),t.onDatosCambiados(),l()})}return{abrir:l}}function Or(t){function e(){if(t.navegar)return t.navegar("planner");const n=globalThis.Router;n==null||n.navigate("planner")}function a(n,i,r){const l=Ia(n,i,r),d=n.targetAmount||0,b=d>0?Math.min(100,l/d*100):0;return`
      ...
      </div>`}function o(n){const i=t.store.get("goals");if(i.length===0){n.innerHTML="",n.style.display="none";return}n.style.display="";const r=t.store.get("accounts"),l=t.colchonEnFecha(t.hoy()),d=[...i].sort((b,u)=>(b.prioridad||99)-(u.prioridad||99));n.innerHTML=`
      <div class="flex justify-between items-center mb-12" style="gap:10px;flex-wrap:wrap">
...
Esto recalibra el punto de arranque del dashboard.`)){for(const T of M)t.store.updateItem("accounts",T._id,{saldoInicial:S(T)??T.saldoInicial??0,fechaInicialSaldo:z});q("Saldo base actualizado"),a(),C()}}function _(C,M,z){N(C,"[data-nueva-acc]",()=>x(null,M)),N(C,"[data-editar-acc]",F=>x(F.getAttribute("data-editar-acc"),M)),N(C,"[data-tramos-ganancias]",()=>z.abrir()),N(C,"[data-reset-base]",()=>E(M)),N(C,"[data-hist-acc]",F=>w(F.getAttribute("data-hist-acc"),M)),N(C,"[data-principal-acc]",F=>{const T=F.getAttribute("data-principal-acc");t.store.set("accounts",t.store.get("accounts").map(R=>({...R,esCuentaPrincipal:R._id===T}))),q("Cuenta marcada como principal"),a(),M()}),N(C,"[data-borrar-acc]",F=>{const T=F.getAttribute("data-borrar-acc");if(t.store.get("accounts").length<=1)return q("Debe existir al menos una cuenta","err");if(!Z("¿Eliminar cuenta?"))return;t.store.removeItem("accounts",T);const P=t.store.get("accounts");P.length>0&&!P.some(B=>B.esCuentaPrincipal)&&t.store.set("accounts",P.map((B,L)=>L===0?{...B,esCuentaPrincipal:!0}:B)),q("Cuenta eliminada"),a(),M()}),N(C,"[data-inv-modo]",F=>{const[T,R]=(F.getAttribute("data-inv-modo")||"").split("|");s.set(T,R==="real"?"real":"proyeccion"),M()}),I.wire(C,M)}let D=null;return{id:"accounts",route:"accounts",nombre:"Cuentas y ahorro",flagId:"accounts",seccion:1,iconoPath:qr,mount(C){const M=()=>v(C);D??(D=Rr({store:t.store,onDatosCambiados:()=>{a(),M()},año:()=>Number(e().slice(0,4))})),v(C),C.dataset.wired!=="1"&&(_(C,M,D),C.dataset.wired="1")}}}const ot=(t,e,a="var(--text)",o=!1)=>`<tr>
  ...
  </tr>`,ra=t=>`<tr><td colspan="2" style="padding:12px 10px 4px;font-size:11px;font-weight:700;color:var(--text3);letter-spacing:.5px;border-top:1px solid var(--border)">${c(t)}</td></tr>`;function Lo(t){const a=t.capMobiliario!==0||t.gananciasFondos!==0?`${ot("Capital mobiliario (dividendos, intereses)",t.capMobiliario,"var(--text)",!0)}
    ...
    <div class="grid-2" style="gap:16px;align-items:start">
      ...
      <div class="card" style="padding:16px">
        ...
        <div id="renta-cuadro">${Lo(t.declaracion)}</div>
      </div>
  ...
  </table>`}const Hr=(t,e,a)=>`<div class="card" style="text-align:center;padding:48px">
    ...
    <div class="text-sm" style="color:var(--text2);max-width:380px;margin:0 auto">${a}</div>
  </div>`,ct=(t,e,a="")=>`<div class="stat-card"><div class="stat-label">${c(t)}</div><div class="stat-value ${a}">${c(e)}</div></div>`,yt=(t,e,a="")=>`<div class="flex justify-between mb-5"><span class="text-sm" style="color:var(--text2)">${c(t)}</span><span class="num ${a}">${c(e)}</span></div>`;function Gr(t,e,a){const o=t.filter(l=>(l.modeloFondo||"cuenta")==="inversion");if(o.length===0)return Hr("📈","Sin fondos de inversión",'Ve a <strong>Cuentas y Ahorro</strong> y crea una cuenta de tipo "Fondo de inversión" para ver aquí su análisis fiscal.');let s=0,n=0,i=0;const r=o.map(l=>{const d=Ot(l,e);if(!d)return"";s+=d.saldo,n+=d.costBase,i+=d.impuesto;const b=d.costBase>0?d.plusvalia/d.costBase*100:0,u=(l.escenarioIds||[]).map(p=>`<span class="badge badge-yellow">🔭 ${c(a(p))}</span>`).join("");return`
        <div class="card mb-10">
          ...
          <div class="grid-2" style="gap:8px;margin-bottom:8px">
            ${ct("Valor actual",j(d.saldo))}
            ${ct("Coste base (aportado)",j(d.costBase))}
          </div>
          <div class="grid-2" style="gap:8px">
            ${ct(`Plusvalía latente (${b>=0?"+":""}${b.toFixed(1)}%)`,j(d.plusvalia),d.plusvalia>=0?"pos":"neg")}
            ${ct("Imp. ganancias de capital (est.)",j(d.impuesto),"neg")}
          </div>
          <div class="flex justify-between mt-10" style="padding-top:8px;border-top:1px solid var(--border)">
            ...
            <span class="num pos" style="font-weight:700;font-size:15px">${c(j(d.neto))}</span>
          </div>
        </div>`}).join("");return`
    ...
    <div class="card mt-16">
      ...
      <div class="text-sm mt-8" style="color:var(--text3)">
    ...
    </div>`}function Vr(t){const{nominas:e,planes:a,tramos:o}=t,s=y=>y.grupoNomina?e.filter(g=>(g.grupoNomina||"")===y.grupoNomina):null,n=e.map(y=>({n:y,d:Oe(y,s(y),o)})),i=n.reduce((y,g)=>y+g.d.brutoAnual,0),r=n.reduce((y,g)=>y+g.d.irpfAnual,0),l=n.reduce((y,g)=>y+g.d.ssAnual,0),d=n.length===0?'<div class="text-sm" style="color:var(--text3);padding:12px 0">Sin nóminas activas. Configúralas en el módulo <strong>Nóminas</strong>.</div>':n.map(({n:y,d:g})=>`
        <div class="card">
        ...
        </div>`).join(""),b=ja(e,o),u=`${t.hoy.slice(0,4)}-01-01`,p=a.length===0?'<div class="text-sm" style="color:var(--text3);padding:12px 0">Sin planes de pensiones. Créalos en <strong>Nóminas</strong>.</div>':a.map(y=>{const g=ve(y);if(!g)return"";const I=(y.aportaciones||[]).filter(f=>f.fecha>=u).reduce((f,$)=>f+$.cantidad,0),v=Math.min(I,_t)*b/100,h=I>_t;return`
        <div class="card">
    ...
    </div>`}const ko=[["declaracion","Declaración Renta"],["mobiliario","Capital Mobiliario"],["trabajo","Rendimientos del Trabajo"],["inmobiliario","Capital Inmobiliario"]],Yr="M14 2H6c-1.1 0-2 .9-2 2v16c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V8l-6-6zm4 18H6V4h7v5h5v11zM8 15h8v2H8v-2zm0-4h8v2H8v-2zm0-4h4v2H8V7z";function Jr(t){const e=t.hoy??Y;let a="declaracion",o={};const s=()=>t.store.get("config"),n=()=>Number(e().slice(0,4)),i=()=>t.store.get("nominas").filter(h=>h.activo),r=()=>t.store.get("accounts").filter(h=>(h.modeloFondo||"cuenta")==="pension"),l=h=>{var f;return((f=t.store.get("escenarios").find($=>$._id===h))==null?void 0:f.nombre)??h},d=()=>bt(t.store.get("tramosIRPFHistorico"),s().tramos_irpf??gt)(n()),b=()=>bt(t.store.get("tramosGananciasCapitalHistorico"),s().tramosGananciasCapital??Et)(n());function u(){const h=`${n()}-01-01`,f=t.store.get("nominas").filter(x=>x.activo&&!x.simulacion),$=r().reduce((x,S)=>x+(S.aportaciones||[]).filter(w=>w.fecha>=h).reduce((w,E)=>w+E.cantidad,0),0),m=t.store.get("expenses").filter(x=>x.activo&&x.sujetoIRPF&&x.tipo==="ingreso").reduce((x,S)=>x+Ea(S),0);return _a({nominas:f,aportacionesPension:$,otrosIngresos:m,extras:o,tramosGeneral:d(),tramosAhorro:b()})}function p(){const h=d(),f=i(),$=M=>M.grupoNomina?f.filter(z=>(z.grupoNomina||"")===M.grupoNomina):null,m=f.map(M=>Oe(M,$(M),h)),x=m.reduce((M,z)=>M+z.brutoAnual,0),S=m.reduce((M,z)=>M+z.irpfAnual,0),w=m.reduce((M,z)=>M+z.ssAnual,0),E=t.store.get("accounts").filter(M=>(M.modeloFondo||"cuenta")==="inversion");let _=0,D=0;for(const M of E){const z=Ot(M,b());z&&(_+=z.plusvalia,D+=z.impuesto)}if(x<=0&&E.length===0)return"";const C=(M,z,F)=>`<div class="exec-item"><div class="exec-item-label">${c(M)}</div><div class="exec-item-val ${F}">${c(z)}</div></div>`;return`<div class="exec-summary mb-14">
    ...
    </div>`}function y(){return a==="mobiliario"?Gr(t.store.get("accounts"),b(),l):a==="trabajo"?Vr({nominas:i(),planes:r(),tramos:d(),hoy:e()}):a==="inmobiliario"?Ur():kr({año:n(),extras:o,declaracion:u(),nominas:i().map(h=>({nombre:h.nombre,bruto:h.bruto||0})),planes:r().map(h=>h.nombre)})}function g(h,f){const $=a===h;return`<button data-tab-fisc="${h}" style="
    ...
    ">${c(f)}</button>`}function I(h){const f=h.querySelector("#fisc-tabs"),$=h.querySelector("#fisc-tab-content");f&&(f.innerHTML=ko.map(([m,x])=>g(m,x)).join("")),$&&($.innerHTML=y())}function A(h){h.innerHTML=`
    ...
    </div>`}function p(){if(o){try{o.destroy()}catch{}o=null}}function y(x){const S=s(),w=r(null),E=[{label:"Base (sin supuesto)",color:"#6b7280",esBase:!0,puntos:_e(w.eventos,S.dashboardStart,S.dashboardEnd)}];return x.forEach((_,D)=>{const{eventos:C,horizonte:M}=r(_);E.push({label:_.nombre,color:_.color||Tt[D%Tt.length],puntos:_e(C,S.dashboardStart,M)})}),E}function g(x,S){p();const w=x.querySelector("#chart-comparacion");w&&(o=Wr(w,y(S)))}function I(x){p();const S=new Set(t.store.get("accounts").map(_=>_._id));for(const _ of[...a])S.has(_)||a.delete(_);const w=n(),E=s().escenarioActivo||null;x.innerHTML=`
      <div class="page-header">
      ...
      ${w.length===0?`<div class="card mb-14" style="padding:20px 24px">
             ...
             </div>`:`<div>${w.map(_=>d(_,E)).join("")}</div>
      ...
      </div>`,E.classList.remove("hidden"),N(_,"[data-cancelar]",h),N(_,"[data-color-esc]",C=>{const M=C.getAttribute("data-color-esc");_.querySelector("#esc-color").value=M;for(const z of _.querySelectorAll("[data-color-esc]"))z.style.border=z.getAttribute("data-color-esc")===M?"2px solid white":"2px solid transparent"}),N(_,"[data-guardar-esc]",C=>{const M=_.querySelector("#esc-nombre").value.trim();if(!M)return q("El nombre es obligatorio","err");const z={nombre:M,fechaFin:_.querySelector("#esc-fecha-fin").value||null,color:_.querySelector("#esc-color").value||Tt[0],descripcion:_.querySelector("#esc-desc").value.trim()},F=C.getAttribute("data-guardar-esc")||"";F?(t.store.updateItem("escenarios",F,z),q("Escenario actualizado")):(t.store.addItem("escenarios",z),q("Escenario creado")),e(),h(),S()})}function $(x,S){if(!Z("¿Eliminar este escenario? Los elementos asignados perderán esta asignación."))return;const w=E=>E.map(_=>({..._,escenarioIds:(_.escenarioIds||[]).filter(D=>D!==x)}));t.store.set("loans",w(t.store.get("loans")).map(E=>({...E,amortizaciones:w(E.amortizaciones||[])}))),t.store.set("expenses",w(t.store.get("expenses"))),t.store.set("nominas",w(t.store.get("nominas"))),t.store.set("accounts",w(t.store.get("accounts"))),s().escenarioActivo===x&&t.store.patchConfig({escenarioActivo:null}),t.store.removeItem("escenarios",x),q("Escenario eliminado"),e(),S()}function m(x,S){N(x,"[data-nuevo-esc]",()=>f(null,S)),N(x,"[data-editar-esc]",w=>f(w.getAttribute("data-editar-esc"),S)),N(x,"[data-borrar-esc]",w=>$(w.getAttribute("data-borrar-esc"),S)),N(x,"[data-activar-esc]",w=>{const E=w.getAttribute("data-activar-esc");t.store.patchConfig({escenarioActivo:E}),q(`Escenario "${i(E)}" activado`),e(),S()}),N(x,"[data-desactivar-esc]",()=>{t.store.patchConfig({escenarioActivo:null}),q("Volviendo a la realidad base"),e(),S()}),N(x,"[data-toggle-cuenta]",w=>{const E=w.getAttribute("data-toggle-cuenta");a.has(E)?a.delete(E):a.add(E);const _=x.querySelector("#esc-pastillas");_&&(_.innerHTML=u());const D=n(),C=x.querySelector("#esc-comparativa");C&&(C.innerHTML=b(D)),g(x,D)})}return{id:"escenarios",route:"escenarios",nombre:"Supuestos",flagId:"supuestos",seccion:2,iconoPath:Qr,mount(x){const S=()=>I(x);I(x),x.dataset.wired!=="1"&&(m(x,S),x.dataset.wired="1")},unmount(){p()}}}const Zr=1e-12,Go=t=>Math.abs(t)<Zr,Vo=t=>t/12;function tl(t,e,a,o){if(a<=0)return Math.max(0,Math.ceil(t-e));const s=t-e;if(s<=0)return 0;const n=Vo(o);if(Go(n))return Math.ceil(s/a);const i=Math.pow(1+n,a),r=(t-e*i)*n/(i-1);return r<=0?0:Math.ceil(r)}function el(t,e){const a=Vo(e);return Go(a)?0:Math.round(t*a)}function Uo({rentaNetaMensual:t,tasaRetiroSeguro:e,tipoFiscalEfectivo:a}){if(e<=0)throw new RangeError("La tasa de retiro seguro tiene que ser mayor que cero.");if(a>=1)throw new RangeError("El tipo fiscal efectivo no puede llegar al 100 %.");const o=Math.round(t*12/(1-a));return{retiroBrutoAnual:o,capitalNecesario:Math.round(o/e)}}function Yo(t,e){const[a,o]=t.split("-").map(Number),s=a*12+(o-1)+e,n=Math.floor(s/12),i=s%12+1;return`${n}-${String(i).padStart(2,"0")}`}function la(t,e){const[a,o]=t.split("-").map(Number),[s,n]=e.split("-").map(Number);return(s-a)*12+(n-o)}const Jo=t=>Number(t.slice(0,4));function Ae(t){return t.rentaDeseada?Uo(t.rentaDeseada).capitalNecesario:t.importeObjetivo??0}const al={_id:"__sin_vehiculo__"};function Se(t){var h,f,$;const e=Math.max(0,Math.floor(t.horizonteMeses)),a=new Map(t.vehiculos.map(m=>[m._id,m])),o=[...t.objetivos].sort((m,x)=>m.prioridad-x.prioridad).map(m=>({def:m,objetivo:Ae(m),saldo:m.saldoActual,estado:Ae(m)>0&&m.saldoActual>=Ae(m)&&m.modoAsignacion!=="ABSORBE_RESIDUAL"?"COMPLETADO":"PENDIENTE",vehiculo:a.get(m.vehiculoId),aportadoEnAño:0,añoEnCurso:Jo(t.fechaInicio),ultimaSolicitud:0,solicitadoAcumulado:0,mesesReclamando:0})),s=new Map;for(const m of t.eventos){const x=s.get(m.fecha)??[];x.push(m),s.set(m.fecha,x)}const n=[],i=[],r=[];let l=t.perfil.netoMensual,d=t.perfil.gastosFijosMensuales,b=0,u=0;const p=[];for(let m=0;m<e;m++){const x=Yo(t.fechaInicio,m),S=Jo(x);for(const P of s.get(x)??[])if(P.tipo==="CAMBIO_INGRESOS")l=P.importe;else if(P.tipo==="CAMBIO_GASTOS_FIJOS")d=P.importe;else if(P.tipo==="NUEVA_DEUDA")d+=P.importe;else if(P.tipo==="INYECCION_CAPITAL"){const B=P.objetivoDestinoId?o.find(L=>L.def._id===P.objetivoDestinoId):void 0;B?B.saldo+=P.importe:l+=P.importe}for(const P of o)P.añoEnCurso!==S&&(P.añoEnCurso=S,P.aportadoEnAño=0);const w=Math.max(0,l-d),E=Math.round(w*ol(t.pctDisfrute));let _=w-E;const D=_,C=o.filter(P=>P.estado!=="COMPLETADO"),M=[];let z=0;const F=C.filter(P=>P.def.modoAsignacion==="ABSORBE_RESIDUAL"),T=C.filter(P=>P.def.modoAsignacion!=="ABSORBE_RESIDUAL");for(const P of T){const B=sl(P,x,m,t);P.ultimaSolicitud=B,B>0&&(P.solicitadoAcumulado+=B,P.mesesReclamando+=1),(P.def.modoAsignacion==="CUOTA_POR_FECHA"||P.def.modoAsignacion==="FIJO")&&(z+=B);const L=Math.max(0,Math.min(B,_));_-=L,P.saldo+=L,P.aportadoEnAño+=L,b+=L,L>0&&P.estado==="PENDIENTE"&&(P.estado="EN_CURSO"),M.push({objetivoId:P.def._id,asignado:L,solicitado:B,saldoTrasMes:P.saldo})}if(F.length>0&&_>0){const P=F.map(k=>Math.max(0,k.def.pesoResidual??1)),B=P.reduce((k,O)=>k+O,0)||F.length;let L=0;F.forEach((k,O)=>{const H=O===F.length-1?_-L:Math.floor(_*P[O]/B);L+=H,k.saldo+=H,k.aportadoEnAño+=H,b+=H,H>0&&k.estado==="PENDIENTE"&&(k.estado="EN_CURSO"),M.push({objetivoId:k.def._id,asignado:H,solicitado:0,saldoTrasMes:k.saldo})}),_-=L}else for(const P of F)M.push({objetivoId:P.def._id,asignado:0,solicitado:0,saldoTrasMes:P.saldo});z>D&&p.push({mes:x,deficit:z-D});for(const P of o)P.saldo<=0||(P.saldo+=el(P.saldo,((h=P.vehiculo)==null?void 0:h.rentabilidadRealAnual)??0));for(const P of o)P.estado!=="COMPLETADO"&&(P.def.modoAsignacion==="ABSORBE_RESIDUAL"&&P.objetivo<=0||P.objetivo>0&&P.saldo>=P.objetivo&&(P.estado="COMPLETADO",i.push({objetivoId:P.def._id,nombre:P.def.nombre,mes:x,indice:m,importeFinal:P.saldo,cuotaLiberada:P.ultimaSolicitud})));for(const P of o)M.some(B=>B.objetivoId===P.def._id)||M.push({objetivoId:P.def._id,asignado:0,solicitado:0,saldoTrasMes:P.saldo});const R=o.reduce((P,B)=>P+B.saldo,0);if(u+=E,n.push({indice:m,mes:x,netoMensual:l,gastosFijos:d,sobrante:w,disfrute:E,disponible:D,sinAsignar:_,asignaciones:M.sort((P,B)=>Wo(o,P.objetivoId)-Wo(o,B.objetivoId)),patrimonioTotal:R}),o.length>0&&o.every(P=>P.estado==="COMPLETADO"))break}const y=[];if(p.length>0){const m=Math.round(p.reduce((x,S)=>x+S.deficit,0)/p.length);r.push({severidad:"error",codigo:"INVIABLE",mensaje:`El plan no cabe en el flujo de caja durante ${p.length} mes${p.length!==1?"es":""} (desde ${p[0].mes}). Déficit medio: ${(m/100).toFixed(2)} €/mes.`,mes:p[0].mes,deficitMensual:m});for(const x of o)x.estado!=="COMPLETADO"&&x.def.fechaLimite&&x.def.modoAsignacion==="CUOTA_POR_FECHA"&&(x.estado="INVIABLE");y.push(...il(o,t,m))}for(const m of o){const x=(f=m.vehiculo)==null?void 0:f.topeAportacionAnual;x&&m.def.modoAsignacion==="FIJO"&&(m.def.importeFijoMensual??0)*12>x&&r.push({severidad:"atencion",codigo:"TOPE_FISCAL",objetivoId:m.def._id,mensaje:`«${m.def.nombre}» pide ${((m.def.importeFijoMensual??0)/100).toFixed(2)} €/mes, que supera el tope anual de ${(x/100).toFixed(2)} €. Se aporta hasta el tope y se reanuda en enero.`})}for(const m of o)m.estado!=="COMPLETADO"&&m.objetivo>0&&m.def.modoAsignacion!=="ABSORBE_RESIDUAL"&&r.push({severidad:"atencion",codigo:"NUNCA_COMPLETADO",objetivoId:m.def._id,mensaje:`«${m.def.nombre}» no se completa dentro del horizonte de ${e} meses.`});const g=o.find(m=>m.def.tipo==="INVERSION_PERPETUA"),I=g?i.find(m=>m.objetivoId===g.def._id):void 0,A={};for(const m of o){const x=(($=m.vehiculo)==null?void 0:$._id)??al._id;A[x]=(A[x]??0)+m.saldo}const v={};for(const m of o)v[m.def._id]=m.estado;return{viable:p.length===0,mesesSimulados:n.length,serieMensual:n,hitos:i,fases:nl(n,i),avisos:r,propuestas:y,estadoFinal:v,resumen:{patrimonioFinal:o.reduce((m,x)=>m+x.saldo,0),patrimonioPorVehiculo:A,totalAportado:b,totalDisfrute:u,mesIndependencia:(I==null?void 0:I.mes)??null}}}const ol=t=>Number.isFinite(t)?Math.min(1,Math.max(0,t)):0,Wo=(t,e)=>t.findIndex(a=>a.def._id===e);function sl(t,e,a,o){var n,i;const s=Math.max(0,t.objetivo-t.saldo);switch(t.def.modoAsignacion){case"ABSORBE_TODO":return s;case"FIJO":{const r=t.def.importeFijoMensual??0,l=(n=t.vehiculo)==null?void 0:n.topeAportacionAnual;if(!l)return t.objetivo>0?Math.min(r,s):r;const d=Math.max(0,l-t.aportadoEnAño),b=Math.min(r,d);return t.objetivo>0?Math.min(b,s):b}case"CUOTA_POR_FECHA":{if(s<=0)return 0;const r=t.def.fechaLimite?la(e,t.def.fechaLimite):o.horizonteMeses-a;return tl(t.objetivo,t.saldo,Math.max(0,r),((i=t.vehiculo)==null?void 0:i.rentabilidadRealAnual)??0)}default:return 0}}function nl(t,e){if(t.length===0)return[];const o=[0,...[...new Set(e.map(n=>n.indice))].sort((n,i)=>n-i).map(n=>n+1)].filter((n,i,r)=>r.indexOf(n)===i&&n<t.length),s=[];for(let n=0;n<o.length;n++){const i=o[n],r=(n+1<o.length?o[n+1]:t.length)-1;if(r<i)continue;const l=new Set;for(let d=i;d<=r;d++)for(const b of t[d].asignaciones)b.asignado>0&&l.add(b.objetivoId);s.push({desde:t[i].mes,hasta:t[r].mes,meses:r-i+1,objetivosActivos:[...l]})}return s}function il(t,e,a){const o=[],s=Math.max(0,e.perfil.netoMensual-e.perfil.gastosFijosMensuales);if(s>0&&e.pctDisfrute>0){const l=Math.ceil(Math.min(e.pctDisfrute,a/s)*100);if(l>0){const d=Math.round(e.pctDisfrute*100);o.push({clase:"REDUCIR_DISFRUTE",magnitud:l,mensaje:`Bajar el disfrute ${l} punto${l!==1?"s":""} (del ${d} % al ${Math.max(0,d-l)} %) libera ${(Math.min(a,s*e.pctDisfrute)/100).toFixed(0)} €/mes.`})}}const n=t.filter(l=>l.def.modoAsignacion==="CUOTA_POR_FECHA"&&l.def.fechaLimite&&l.estado!=="COMPLETADO"),i=l=>l.mesesReclamando>0?l.solicitadoAcumulado/l.mesesReclamando:0,r=[...n].sort((l,d)=>i(d)-i(l))[0];if(r){const l=Math.max(0,r.objetivo-r.saldo),d=i(r),b=Math.max(1,la(e.fechaInicio,r.def.fechaLimite)),u=Math.max(1,d-a),p=Math.ceil(l/u),y=Math.max(1,p-b);o.push({clase:"RETRASAR_FECHA",objetivoId:r.def._id,magnitud:y,mensaje:`Retrasar «${r.def.nombre}» ${y} mes${y!==1?"es":""}, hasta ${Yo(r.def.fechaLimite,y)}, baja su cuota a lo que cabe en el flujo.`});const g=Math.min(Math.round(a*b),Math.max(0,r.objetivo-1));g>0&&o.push({clase:"REDUCIR_IMPORTE",objetivoId:r.def._id,magnitud:g,mensaje:`O reducir «${r.def.nombre}» en ${(g/100).toFixed(0)} €, de ${(r.objetivo/100).toFixed(0)} € a ${((r.objetivo-g)/100).toFixed(0)} €.`})}return n.length>1&&o.push({clase:"REORDENAR",magnitud:n.length,mensaje:`Hay ${n.length} objetivos con fecha compitiendo a la vez. Escalonarlos reparte la carga en vez de acumularla.`}),o.length===0&&o.push({clase:"REDUCIR_IMPORTE",magnitud:a,mensaje:`Faltan ${(a/100).toFixed(0)} €/mes. Hay que recortar aportaciones fijas, subir ingresos o bajar gastos por esa cantidad.`}),o}const rl=()=>globalThis.Chart??null,Me=["#2ee6a8","#4d9fff","#a855f7","#f97316","#eab308","#22d3ee","#fb7185","#34d399"],Ko=new WeakMap;function ll(t,e,a){const o=rl();if(!o)return null;const s=Ko.get(t);if(s)try{s.destroy()}catch{}const n=new Map,i=new Map(e.objetivos.map(y=>[y._id,y.vehiculoId])),r=new Set(e.objetivos.map(y=>y.vehiculoId));for(const y of r)n.set(y,[]);for(const y of a.serieMensual){const g=new Map;for(const I of y.asignaciones){const A=i.get(I.objetivoId);A&&g.set(A,(g.get(A)??0)+I.saldoTrasMes)}for(const I of r)n.get(I).push((g.get(I)??0)/100)}const l=y=>{var g;return((g=e.vehiculos.find(I=>I._id===y))==null?void 0:g.nombre)??"Sin vehículo"},d=[...r],b=d.map((y,g)=>a.serieMensual.map((I,A)=>d.slice(0,g+1).reduce((v,h)=>v+(n.get(h)[A]??0),0))),u=d.map((y,g)=>({label:l(y),data:b[g],borderColor:Me[g%Me.length],backgroundColor:`${Me[g%Me.length]}33`,fill:g===0?"origin":"-1",borderWidth:1.5,pointRadius:0,tension:.25})),p=new o(t,{type:"line",data:{labels:a.serieMensual.map(y=>y.mes),datasets:u},options:{responsive:!0,maintainAspectRatio:!1,interaction:{mode:"index",intersect:!1},plugins:{legend:{labels:{color:"#a9b6cc",font:{size:11},boxWidth:12}},tooltip:{backgroundColor:"#111a28",borderColor:"rgba(255,255,255,0.12)",borderWidth:1,titleColor:"#a9b6cc",bodyColor:"#eef3fb",callbacks:{label:y=>{const g=y.datasetIndex>0?y.chart.data.datasets[y.datasetIndex-1].data[y.dataIndex]??0:0;return` ${y.dataset.label}: ${j(y.parsed.y-g)}`}}}},scales:{x:{ticks:{color:"#6b7b96",maxTicksLimit:12},grid:{display:!1}},y:{ticks:{color:"#6b7b96",callback:y=>j(y)},grid:{color:"rgba(255,255,255,0.07)"}}}}});return Ko.set(t,p),p}const ca=t=>j(t/100),cl={CUOTA_POR_FECHA:"Cuota para llegar a la fecha",ABSORBE_TODO:"Se lleva todo lo disponible",ABSORBE_RESIDUAL:"Recibe lo que sobre",FIJO:"Importe fijo al mes"},dl={CUOTA_POR_FECHA:"Se recalcula cada mes con el saldo real: si un mes va sobrado, el siguiente pide menos.",ABSORBE_TODO:"Reclama todo el capital disponible hasta completarse. Es el modo típico de amortizar deuda.",ABSORBE_RESIDUAL:"No reclama nada; recoge lo que quede tras servir a los de prioridad superior.",FIJO:"Aporta siempre lo mismo, respetando el tope anual del vehículo si lo tiene."},Qo={COMPLETADO:"var(--accent)",EN_CURSO:"var(--text)",PENDIENTE:"var(--text3)",INVIABLE:"var(--red)"};function ul(t,e){if(t.objetivos.length===0)return`<div class="card" style="text-align:center;padding:34px 20px">
    ...
    ${a.map(n=>{var i;return pl(n,e,o,(i=s(n.vehiculoId))==null?void 0:i.nombre)}).join("")}`}function pl(t,e,a,o){const s=Ae(t),n=e.estadoFinal[t._id]??t.estado,i=a==null?void 0:a.asignaciones.find(u=>u.objetivoId===t._id),r=(i==null?void 0:i.solicitado)??0,l=e.hitos.find(u=>u.objetivoId===t._id),d=s>0?Math.min(100,t.saldoActual/s*100):0,b=e.avisos.filter(u=>u.objetivoId===t._id);return`
    <div class="card mb-10" draggable="true" data-pl-objetivo="${c(t._id)}"
         style="padding:14px 16px;border-left:3px solid ${Qo[n]??"var(--text3)"};cursor:grab">
      <div style="display:flex;justify-content:space-between;align-items:flex-start;gap:12px;flex-wrap:wrap">
        <div style="flex:1;min-width:220px">
          <div style="display:flex;align-items:center;gap:8px;flex-wrap:wrap">
            ...
            <span class="badge" style="font-size:10px;background:var(--bg3);color:var(--text2)">${c(cl[t.modoAsignacion])}</span>
          ...
          <div class="text-sm" style="color:var(--text3);margin-top:4px">${c(dl[t.modoAsignacion])}</div>
        </div>
      ...
      ${s>0?`<div class="goal-bar" style="margin-top:10px"><div class="goal-bar-fill" style="width:${d.toFixed(1)}%;background:${Qo[n]??"var(--accent)"}"></div></div>`:""}
    ...
    <div class="card mb-14" style="padding:12px 16px">
      ...
      <div style="display:flex;gap:8px;flex-wrap:wrap">
        ${Xo.map(o=>`<button class="btn-secondary btn-sm" data-pl-plantilla="${c(o.id)}"
    ...
    ${e.length===0?`<div class="card" style="text-align:center;padding:30px 20px">
             ...
             ${e.map(o=>xl(o,t,a(o.objetivoDestinoId))).join("")}
           </div>`}`}function xl(t,e,a){const o=la(e.fechaInicio,t.fecha),s=o<0?"antes del inicio del plan":o===0?"en el primer mes":`dentro de ${o} mes${o!==1?"es":""}`,n=o<0||o>=e.horizonteMeses;return`
    <div style="display:flex;gap:12px;align-items:flex-start;padding:10px 0;border-bottom:1px solid var(--border)">
      <div style="font-size:16px;flex-shrink:0;width:24px;text-align:center">${hl[t.tipo]}</div>
      <div style="flex:1;min-width:0">
        <div style="display:flex;align-items:center;gap:8px;flex-wrap:wrap">
        ...
        <div style="font-size:12px;margin-top:3px">${c(fl(t,a))}</div>
    ...
    </div>`}function $l(t,e,a,o){const s=t.campos.map(i=>{const r=o[i.id];return`<div class="form-group">
    ...
    </div>`}function Zo(t,e){var o;const a={};for(const s of e.campos){const n=((o=t.querySelector(`#ev-${s.id}`))==null?void 0:o.value)??"",i=parseFloat(String(n).replace(",","."));a[s.id]=Number.isFinite(i)?Math.round(i*100):0}return a}const Il=(t,e)=>bl(t.calcular(e)),Al=[-2,-1,0,1,2],Sl=[-10,0,10],Ml=[-20,0,20];function ts(t){return t.hitos.length===0?null:Math.max(...t.hitos.map(e=>e.indice))}function wl(t,e,a,o,s){const n={};for(const l of o.hitos)n[l.objetivoId]=l.mes;const i=ts(o),r=s?ts(s):i;return{etiqueta:t,delta:e,esBase:a,viable:o.viable,hitos:n,desplazamientoMeses:i!==null&&r!==null?i-r:null,patrimonioFinal:o.resumen.patrimonioFinal}}function Cl(t,e,a){if(a===0)return t;switch(e){case"rentabilidad":return{...t,vehiculos:t.vehiculos.map(o=>({...o,rentabilidadRealAnual:Math.max(0,o.rentabilidadRealAnual+a/100)}))};case"disfrute":return{...t,pctDisfrute:Math.min(1,Math.max(0,t.pctDisfrute+a/100))};case"ingresos":return{...t,perfil:{...t.perfil,netoMensual:Math.max(0,Math.round(t.perfil.netoMensual*(1+a/100)))}}}}const jl=t=>t>0?`+${t}`:String(t);function da(t,e,a,o,s,n){const i=Se(t),r=s.map(l=>wl(l===0?"Plan actual":`${jl(l)} ${n}`,l,l===0,l===0?i:Se(Cl(t,e,l)),i));return{palanca:e,titulo:a,descripcion:o,variantes:r}}function El(t){return[da(t,"rentabilidad","Rentabilidad de los vehículos","Mueve la rentabilidad real de todos los vehículos a la vez. Es la palanca que menos controlas.",Al,"puntos"),da(t,"disfrute","Porcentaje de disfrute","Lo que apartas para gastar en vez de asignar a objetivos. Es la palanca que más controlas.",Sl,"puntos"),da(t,"ingresos","Ingresos","Un ascenso, un cambio de trabajo o una reducción de jornada.",Ml,"%")]}function zl(t){if(t===null)return"no comparable";if(t===0)return"sin cambio";const e=Math.abs(t),a=Math.floor(e/12),o=e%12,s=[a>0?`${a} año${a!==1?"s":""}`:"",o>0?`${o} mes${o!==1?"es":""}`:""].filter(Boolean).join(" y ");return t<0?`${s} antes`:`${s} más tarde`}const es=t=>j(t/100);function _l(t,e,a){return`
    ${Fl(t,e)}
    ${t.length>1?Pl(t):""}
    ${Dl(a)}`}function Fl(t,e){return`<div class="card mb-14">
  ...
  </div>`}function Pl(t){const e=t.slice(0,3),a=e.map(r=>({plan:r,res:Se(r)})),o=gl(a.map(({plan:r,res:l})=>({nombre:r.nombre,hitos:l.hitos}))),s=["Hito",...e.map(r=>r.nombre)].map((r,l)=>`<th style="text-align:${l===0?"left":"right"};padding:6px 8px;font-size:11px;color:var(--text3)">${c(r)}</th>`).join(""),n=o.map(r=>`<tr>
      <td style="padding:5px 8px;font-size:12px">${c(r.nombre)}</td>
      ${r.meses.map((l,d)=>{const b=r.diferencias[d],u=b===null||b===0?"var(--text2)":b<0?"var(--accent)":"var(--red)",p=d===0||b===null||b===0?"":`<div style="font-size:10px;color:${u}">${b>0?"+":""}${b} m</div>`;return`<td style="text-align:right;padding:5px 8px;font-family:var(--font-mono);font-size:11px;color:${u}">
            ${c(l??"no llega")}${p}
          </td>`}).join("")}
    ...
    <div style="display:flex;gap:18px;flex-wrap:wrap;margin-bottom:14px">${a.map(({plan:r,res:l})=>`<div style="flex:1;min-width:150px">
      ...
      <div style="font-family:var(--font-mono);font-size:15px;font-weight:700">${c(es(l.resumen.patrimonioFinal))}</div>
  ...
  </div>`}function Dl(t){return t?`<div class="card">
    <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:12px;flex-wrap:wrap;gap:8px">
    ...
    </div>`}function Tl(t){return`<div style="margin-bottom:18px">
    ...
    ${t.variantes.map(e=>{const a=e.desplazamientoMeses,o=a===null?"var(--text3)":a===0?"var(--text2)":a<0?"var(--accent)":"var(--red)";return`<div style="display:flex;justify-content:space-between;align-items:center;gap:10px;padding:5px 0;font-size:12px;${e.esBase?"border-top:1px solid var(--border);border-bottom:1px solid var(--border);":""}">
        ...
        <span style="display:flex;gap:14px;align-items:baseline">
          <span style="color:${o};font-size:11px">${c(zl(a))}</span>
          <span style="font-family:var(--font-mono);font-size:11px;color:var(--text3);min-width:88px;text-align:right">${c(es(e.patrimonioFinal))}</span>
        </span>
      </div>`}).join("")}
  </div>`}const At=t=>j(t/100);function Nl(t,e,a=0){return`
    ${Rl(e)}
    ${Ol(t,e)}
    <div class="card mb-14">
    ...
    ${ql(e)}
    ${Ll(t,e)}
    ${Bl(t,e,a)}`}function Rl(t){if(t.avisos.length===0&&t.propuestas.length===0)return"";const e={error:"var(--red)",atencion:"var(--yellow)",info:"var(--text2)"},a=t.avisos.map(i=>`<div style="display:flex;gap:8px;font-size:12px;line-height:1.6;margin-bottom:5px">
    ...
    ${a}${o}
  </div>`}function Ol(t,e){const a=(s,n,i="")=>`<div class="stat-card">
  ...
  </div>`}function ql(t){return t.hitos.length===0?`<div class="card mb-14"><div class="card-title mb-8">Hitos</div>
  ...
  </div>`}function Ll(t,e){if(e.fases.length<=1)return"";const a=o=>{var s;return((s=t.objetivos.find(n=>n._id===o))==null?void 0:s.nombre)??o};return`<div class="card mb-14">
    ...
    ${e.fases.map((o,s)=>`<div style="display:flex;gap:12px;align-items:flex-start;padding:8px 0;border-bottom:1px solid var(--border)">
  ...
  </div>`}const de=60;function Bl(t,e,a=0){if(e.serieMensual.length===0)return"";const o=[...t.objetivos].sort((b,u)=>b.prioridad-u.prioridad),s=Math.ceil(e.serieMensual.length/de),n=Math.min(Math.max(0,a),s-1),i=e.serieMensual.slice(n*de,(n+1)*de),r=["Mes","Disponible",...o.map(b=>b.nombre),"Sin asignar","Patrimonio"].map(b=>`<th style="text-align:right;padding:5px 8px;font-size:10px;color:var(--text3);font-weight:600;white-space:nowrap">${c(b)}</th>`).join(""),l=i.map(b=>{const u=o.map(p=>{const y=b.asignaciones.find(I=>I.objetivoId===p._id),g=(y==null?void 0:y.asignado)??0;return`<td style="text-align:right;padding:4px 8px;font-family:var(--font-mono);color:${g>0?"var(--text)":"var(--text3)"}">${c(g>0?At(g):"·")}</td>`}).join("");return`<tr>
        ...
        <td style="text-align:right;padding:4px 8px;font-family:var(--font-mono);color:var(--accent)">${c(At(b.patrimonioTotal))}</td>
      </tr>`}).join(""),d=s>1?`<div style="display:flex;justify-content:space-between;align-items:center;gap:10px;margin-top:10px;flex-wrap:wrap">
           ...
           <span class="text-sm" style="color:var(--text3)">
             Meses ${n*de+1}–${Math.min((n+1)*de,e.serieMensual.length)} de ${e.serieMensual.length}
           </span>
...
`)}const Vt=t=>{const e=typeof t=="number"?t:parseFloat(String(t).replace(",","."));return Number.isFinite(e)?Math.round(e*100):0},ue=t=>(t/100).toFixed(2),as=t=>(t*100).toFixed(2),Ut=t=>{const e=parseFloat(String(t).replace(",","."));return Number.isFinite(e)?e/100:0},Hl=[["AHORRO_OBJETIVO","Ahorrar una cantidad"],["AMORTIZAR_DEUDA","Amortizar deuda"],["INVERSION_PERPETUA","Independencia económica"],["APORTACION_FIJA","Aportación periódica"]],Gl=[["CUOTA_POR_FECHA","Cuota para llegar a la fecha"],["ABSORBE_TODO","Se lleva todo lo disponible"],["ABSORBE_RESIDUAL","Recibe lo que sobre"],["FIJO","Importe fijo al mes"]],Vl=[["INMEDIATA","Inmediata"],["MEDIA","Media (con preaviso o penalización)"],["BLOQUEADA_HASTA_JUBILACION","Bloqueada hasta la jubilación"]],Ul=[["NULO","Nulo"],["BAJO","Bajo"],["MEDIO","Medio"],["ALTO","Alto"]],os={AHORRO_OBJETIVO:"CUOTA_POR_FECHA",AMORTIZAR_DEUDA:"ABSORBE_TODO",INVERSION_PERPETUA:"ABSORBE_RESIDUAL",APORTACION_FIJA:"FIJO"},lt=(t,e,a,o,s="",n="")=>`<div class="form-group">
    ...
    ${s?`<div class="text-sm mt-4" style="color:var(--text3)">${s}</div>`:""}
  </div>`;function Yl(t,e,a){var l,d,b;const o=t===null,s=(t==null?void 0:t.tipo)??"AHORRO_OBJETIVO",n=(t==null?void 0:t.modoAsignacion)??os[s],i=!!(t!=null&&t.rentaDeseada),r=e.length>0?e.map(u=>[u._id,u.nombre]):[["","— no hay vehículos: crea uno primero —"]];return`
    <div class="grid-2" style="gap:10px">
    ...
    <div class="grid-2" style="gap:10px">
      ${Nt("ob-tipo","Tipo",Hl,s)}
      ${Nt("ob-modo","Cómo pide dinero",Gl,n)}
    </div>
      ...
      <div class="card mb-12" style="background:var(--bg3);padding:12px">
        ...
        <div id="ob-renta-campos" style="display:${i?"block":"none"}">
          <div class="grid-2" style="gap:10px">
            ...
            ${lt("ob-swr","Tasa de retiro seguro (%)","number",((((d=t==null?void 0:t.rentaDeseada)==null?void 0:d.tasaRetiroSeguro)??.04)*100).toFixed(2),"",'step="0.1"')}
          </div>
    ...
    </div>`}function Jl(t,e,a){var d;const o=b=>{var u;return((u=t.querySelector(`#${b}`))==null?void 0:u.value)??""},s=o("ob-nombre").trim();if(!s)return null;const n=o("ob-tipo"),i=o("ob-modo"),r=((d=t.querySelector('input[name="ob-derivar"]:checked'))==null?void 0:d.value)==="renta",l=n==="INVERSION_PERPETUA"&&r;return{_id:(e==null?void 0:e._id)??`obj_${Date.now().toString(36)}${Math.random().toString(36).slice(2,6)}`,nombre:s,tipo:n,importeObjetivo:l?null:Vt(o("ob-importe")),fechaLimite:o("ob-fecha")||null,prioridad:Math.max(1,Number(o("ob-prioridad"))||a),modoAsignacion:i,vehiculoId:o("ob-vehiculo"),saldoActual:Vt(o("ob-saldo")),estado:(e==null?void 0:e.estado)??"PENDIENTE",notas:o("ob-notas"),...i==="FIJO"?{importeFijoMensual:Vt(o("ob-fijo"))}:{},...i==="ABSORBE_RESIDUAL"?{pesoResidual:Math.max(0,Number(o("ob-peso"))||1)}:{},...l?{rentaDeseada:{rentaNetaMensual:Vt(o("ob-renta")),tasaRetiroSeguro:Ut(o("ob-swr")),tipoFiscalEfectivo:Ut(o("ob-fiscal"))}}:{rentaDeseada:null}}}function Wl(t){const e=a=>{var o;return((o=t.querySelector(`#${a}`))==null?void 0:o.value)??""};try{const{capitalNecesario:a}=Uo({rentaNetaMensual:Vt(e("ob-renta")),tasaRetiroSeguro:Ut(e("ob-swr")),tipoFiscalEfectivo:Ut(e("ob-fiscal"))});return`${(a/100).toLocaleString("es-ES",{minimumFractionDigits:0,maximumFractionDigits:0})} €`}catch{return"no calculable con esos parámetros"}}function Kl(t,e,a){const o=t===null,s=!!(t!=null&&t.esDeuda),n=[["","— ninguna —"],...e.map(r=>[r._id,r.nombre])],i=[["","— ninguno —"],...a.map(r=>[r._id,`${r.nombre} (${r.tin} % TIN)`])];return`
    ...
    <div class="grid-2" style="gap:10px">
      ${lt("ve-rent","Rentabilidad REAL anual (%)","number",as((t==null?void 0:t.rentabilidadRealAnual)??0),"Nominal menos inflación. Un fondo al 7 % nominal con 2 % de inflación son 5 %",'step="0.1"')}
      ${lt("ve-fiscal","Fiscalidad al retirar (%)","number",as((t==null?void 0:t.fiscalidadRetirada)??0),"Tipo efectivo sobre la plusvalía",'step="0.5"')}
    </div>

    <div class="grid-2" style="gap:10px">
      ${Nt("ve-liquidez","Liquidez",Vl,(t==null?void 0:t.liquidez)??"INMEDIATA")}
      ${Nt("ve-riesgo","Riesgo",Ul,(t==null?void 0:t.riesgo)??"NULO")}
    </div>
    ...
    <div class="flex gap-8 mt-16" style="justify-content:flex-end;flex-wrap:wrap">
    ...
    </div>`}function Ql(t,e){var i;const a=r=>{var l;return((l=t.querySelector(`#${r}`))==null?void 0:l.value)??""},o=a("ve-nombre").trim();if(!o)return null;const s=((i=t.querySelector("#ve-deuda"))==null?void 0:i.checked)??!1,n=a("ve-tope").trim();return{_id:(e==null?void 0:e._id)??`veh_${Date.now().toString(36)}${Math.random().toString(36).slice(2,6)}`,nombre:o,rentabilidadRealAnual:Ut(a("ve-rent")),liquidez:a("ve-liquidez"),fiscalidadRetirada:Ut(a("ve-fiscal")),topeAportacionAnual:n?Vt(n):null,riesgo:a("ve-riesgo"),cuentaId:a("ve-cuenta")||null,prestamoId:s&&a("ve-prestamo")||null,esDeuda:s}}const Xl={CUOTA_POR_FECHA:"Cada mes calcula lo que hace falta para llegar a la fecha, con el saldo que lleva. Si un mes va sobrado, el siguiente pide menos.",ABSORBE_TODO:"Reclama todo lo disponible hasta completarse. Los de menor prioridad no reciben nada mientras tanto.",ABSORBE_RESIDUAL:"No reclama nada: recoge lo que quede tras servir a los de arriba. Es el modo del cubo de largo plazo.",FIJO:"Aporta siempre lo mismo. Si el vehículo tiene tope anual, se aporta hasta agotarlo y se reanuda en enero."},Zl="M3 3v18h18v-2H5V3H3zm4 12h2v-5H7v5zm4 0h2V7h-2v8zm4 0h2v-3h-2v3z",ss=t=>{const e=parseFloat(String(t).replace(",","."));return Number.isFinite(e)?Math.round(e*100):0},we=t=>(t/100).toFixed(2);function tc(t){const e=t.hoy??Y;let a="config",o=null,s=0,n=null;function i(){const M=t.store.get("planes");return M.find(z=>z.activo)??M[0]??null}function r(){const M=i();return M||t.store.addItem("planes",{nombre:"Plan base",fechaInicio:e().slice(0,7),horizonteMeses:480,pctDisfrute:0,activo:!0,perfil:{netoMensual:0,gastosFijosMensuales:0,manual:!1},vehiculos:[],objetivos:[],eventos:[],creadoEn:e()})}function l(M){var F;const z=i();z&&(t.store.updateItem("planes",z._id,M),n=null,o=null,(F=t.onDatosCambiados)==null||F.call(t))}function d(){const z=t.store.get("nominas").filter(R=>R.activo).reduce((R,P)=>R+(P.bruto||0),0),F=Math.round(z*.75/12),T=t.store.get("expenses").filter(R=>R.activo&&R.basico&&R.tipo==="gasto").reduce((R,P)=>R+(P.cuantia||0),0);return{neto:Math.round(F*100),gastos:Math.round(T*100)}}function b(M){return n||(n=Se(M)),n}function u(M){const z=d(),F=Math.max(0,M.perfil.netoMensual-M.perfil.gastosFijosMensuales),T=Math.round(M.pctDisfrute*100);return`
      <div class="card mb-14">
      ...
      </div>`}const y=()=>document.getElementById("modal-overlay"),g=()=>document.getElementById("modal-content"),I=()=>{var M;return(M=y())==null?void 0:M.classList.add("hidden")};function A(M,z){const F=y(),T=g();return!F||!T?null:(T.innerHTML=`<div class="modal-title">${c(M)}</div>${z}`,F.classList.remove("hidden"),T)}function v(M){l({objetivos:M})}function h(M,z){const F=i();if(!F)return;const T=z?F.objetivos.find(k=>k._id===z)??null:null,R=F.objetivos.reduce((k,O)=>Math.max(k,O.prioridad),0)+1,P=A(T?`Editar «${T.nombre}»`:"Nuevo objetivo",Yl(T,F.vehiculos,R));if(!P)return;const B=()=>{var U;const k=(U=P.querySelector("#ob-modo"))==null?void 0:U.value,O=P.querySelector("#ob-modo-ayuda");O&&k&&(O.textContent=Xl[k]);const H=(K,Q)=>{const st=P.querySelector(K);st&&(st.style.display=Q?"block":"none")};H("#ob-bloque-fijo",k==="FIJO"),H("#ob-bloque-residual",k==="ABSORBE_RESIDUAL")};B();const L=()=>{const k=P.querySelector("#ob-capital-derivado");k&&(k.textContent=Wl(P))};L(),J(P,"#ob-modo",B),J(P,"#ob-tipo",()=>{const k=P.querySelector("#ob-tipo").value,O=P.querySelector("#ob-modo");O&&(O.value=os[k]);const H=P.querySelector("#ob-bloque-perpetua");H&&(H.style.display=k==="INVERSION_PERPETUA"?"block":"none"),B()}),J(P,'input[name="ob-derivar"]',()=>{var U;const k=((U=P.querySelector('input[name="ob-derivar"]:checked'))==null?void 0:U.value)==="renta",O=P.querySelector("#ob-renta-campos"),H=P.querySelector("#ob-bloque-importe");O&&(O.style.display=k?"block":"none"),H&&(H.style.display=k?"none":"block"),L()}),J(P,"#ob-renta, #ob-swr, #ob-fiscal",L),N(P,"[data-ob-cancelar]",I),N(P,"[data-ob-guardar]",()=>{const k=Jl(P,T,R);if(!k){q("El objetivo necesita un nombre","err");return}if(!k.vehiculoId){q("Crea antes un vehículo donde meter el dinero","err");return}const O=F.objetivos.filter(H=>H._id!==k._id);v([...O,k]),I(),q(T?"Objetivo actualizado":`Objetivo «${k.nombre}» creado`),D(M)}),N(P,"[data-ob-borrar]",()=>{T&&Z(`¿Borrar «${T.nombre}»? Esto no se puede deshacer.`)&&(v(F.objetivos.filter(k=>k._id!==T._id)),I(),q("Objetivo borrado"),D(M))})}function f(M,z){const F=i();if(!F)return;const T=z?F.vehiculos.find(L=>L._id===z)??null:null,R=t.store.get("accounts").filter(L=>L.activo).map(L=>({_id:L._id,nombre:L.nombre})),P=t.store.get("loans").filter(L=>L.activo&&!L.simulacion).map(L=>({_id:L._id,nombre:L.nombre,tin:L.tin})),B=A(T?`Editar «${T.nombre}»`:"Nuevo vehículo",Kl(T,R,P));B&&(J(B,"#ve-deuda",()=>{const L=B.querySelector("#ve-deuda").checked,k=B.querySelector("#ve-bloque-prestamo");k&&(k.style.display=L?"block":"none")}),J(B,"#ve-prestamo",()=>{const L=B.querySelector("#ve-prestamo").value,k=P.find(U=>U._id===L);if(!k)return;const O=B.querySelector("#ve-rent"),H=B.querySelector("#ve-nombre");O&&(O.value=String(k.tin)),H&&!H.value.trim()&&(H.value=`Amortizar ${k.nombre}`)}),N(B,"[data-ve-cancelar]",I),N(B,"[data-ve-guardar]",()=>{const L=Ql(B,T);if(!L){q("El vehículo necesita un nombre","err");return}const k=F.vehiculos.filter(O=>O._id!==L._id);l({vehiculos:[...k,L]}),I(),q(T?"Vehículo actualizado":`Vehículo «${L.nombre}» creado`),D(M)}),N(B,"[data-ve-borrar]",()=>{if(!T)return;const L=F.objetivos.filter(k=>k.vehiculoId===T._id);if(L.length>0){q(`No se puede borrar: lo usan ${L.length} objetivo${L.length!==1?"s":""}`,"err");return}Z(`¿Borrar el vehículo «${T.nombre}»?`)&&(l({vehiculos:F.vehiculos.filter(k=>k._id!==T._id)}),I(),q("Vehículo borrado"),D(M))}))}function $(M,z,F){const T=i();if(!T||z===F)return;const R=[...T.objetivos].sort((k,O)=>k.prioridad-O.prioridad),P=R.findIndex(k=>k._id===z),B=R.findIndex(k=>k._id===F);if(P<0||B<0)return;const[L]=R.splice(P,1);R.splice(B,0,L),v(R.map((k,O)=>({...k,prioridad:O+1}))),D(M)}function m(M){return M.vehiculos.length===0?`<div class="card mb-14" style="padding:12px 16px;background:rgba(255,209,102,0.06);border-color:rgba(255,209,102,0.28)">
        <div class="text-sm" style="color:var(--text2);line-height:1.7">
      ...
      <div id="pl-cuerpo">${_(z,F)}</div>`,a==="simulacion"){const P=M.querySelector("#pl-chart");P&&ll(P,z,F)}C(M)}function C(M){N(M,"[data-pl-tab]",F=>{a=F.dataset.plTab,D(M)}),J(M,"#pl-disfrute",F=>{const T=Number(F.value)/100,R=M.querySelector("#pl-pct-val");R&&(R.textContent=`${Math.round(T*100)} %`);const P=i();if(!P)return;const B=Math.max(0,P.perfil.netoMensual-P.perfil.gastosFijosMensuales)*(1-T),L=M.querySelector("#pl-disponible");L&&(L.textContent=j(B/100))}),N(M,"[data-pl-usar-sugerido]",()=>{const F=d(),T=M.querySelector("#pl-neto"),R=M.querySelector("#pl-gastos");T&&(T.value=we(F.neto)),R&&(R.value=we(F.gastos))}),N(M,"[data-pl-guardar]",()=>{const F=T=>{var R;return((R=M.querySelector(T))==null?void 0:R.value)??""};l({perfil:{netoMensual:ss(F("#pl-neto")),gastosFijosMensuales:ss(F("#pl-gastos")),manual:!0},pctDisfrute:Math.min(1,Math.max(0,Number(F("#pl-disfrute"))/100)),fechaInicio:F("#pl-inicio")||e().slice(0,7),horizonteMeses:Math.min(600,Math.max(1,Number(F("#pl-horizonte"))||480))}),q("Plan guardado"),D(M)}),N(M,"[data-pl-plantilla]",F=>x(M,F.dataset.plPlantilla??"",null)),N(M,"[data-pl-editar-evento]",F=>{var P;const T=F.dataset.plEditarEvento??"",R=(P=i())==null?void 0:P.eventos.find(B=>B._id===T);R&&x(M,S(R),T)}),N(M,"[data-pl-duplicar]",()=>{var P;const F=i();if(!F)return;const T=window.prompt("Nombre del plan nuevo:",`${F.nombre} (copia)`);if(!(T!=null&&T.trim()))return;const R=vl(F,T.trim(),`plan_${Date.now().toString(36)}`,e());t.store.addItem("planes",R),(P=t.onDatosCambiados)==null||P.call(t),q(`Plan «${R.nombre}» creado. Actívalo para editarlo.`),D(M)}),N(M,"[data-pl-activar]",F=>{var R;const T=F.dataset.plActivar;if(T){for(const P of t.store.get("planes"))t.store.updateItem("planes",P._id,{activo:P._id===T});n=null,o=null,(R=t.onDatosCambiados)==null||R.call(t),q("Plan activo cambiado"),D(M)}}),N(M,"[data-pl-renombrar]",F=>{var B;const T=F.dataset.plRenombrar,R=t.store.get("planes").find(L=>L._id===T);if(!R)return;const P=window.prompt("Nuevo nombre:",R.nombre);P!=null&&P.trim()&&(t.store.updateItem("planes",R._id,{nombre:P.trim()}),(B=t.onDatosCambiados)==null||B.call(t),D(M))}),N(M,"[data-pl-borrar-plan]",F=>{var B;const T=F.dataset.plBorrarPlan,R=t.store.get("planes").find(L=>L._id===T);if(!R||!Z(`¿Borrar el plan «${R.nombre}» con sus ${R.objetivos.length} objetivos? No se puede deshacer.`))return;t.store.removeItem("planes",R._id);const P=t.store.get("planes");R.activo&&P.length>0&&t.store.updateItem("planes",P[0]._id,{activo:!0}),n=null,o=null,(B=t.onDatosCambiados)==null||B.call(t),q("Plan borrado"),D(M)}),N(M,"[data-pl-sensibilidad]",()=>{const F=i();F&&(o=El(F),D(M))}),N(M,"[data-pl-pagina]",F=>{s=Number(F.dataset.plPagina)||0,D(M)}),N(M,"[data-pl-exportar]",w),N(M,"[data-pl-importar]",()=>E(M)),N(M,"[data-pl-nuevo-objetivo]",()=>h(M,null)),N(M,"[data-pl-nuevo-vehiculo]",()=>f(M,null)),N(M,"[data-pl-editar-vehiculo]",F=>f(M,F.dataset.plEditarVehiculo??null)),N(M,"[data-pl-editar-objetivo]",F=>h(M,F.dataset.plEditarObjetivo??null));let z=null;M.querySelectorAll("[data-pl-objetivo]").forEach(F=>{F.addEventListener("dragstart",()=>{z=F.dataset.plObjetivo??null,F.style.opacity="0.45"}),F.addEventListener("dragend",()=>{F.style.opacity="",M.querySelectorAll("[data-pl-objetivo]").forEach(T=>T.style.borderTop="")}),F.addEventListener("dragover",T=>{T.preventDefault(),z&&F.dataset.plObjetivo!==z&&(F.style.borderTop="2px solid var(--accent)")}),F.addEventListener("dragleave",()=>{F.style.borderTop=""}),F.addEventListener("drop",T=>{T.preventDefault(),F.style.borderTop="";const R=F.dataset.plObjetivo;z&&R&&$(M,z,R),z=null})}),N(M,"[data-pl-csv]",()=>{const F=i();if(!F||!n)return;const T=new Blob(["\uFEFF"+kl(F,n)],{type:"text/csv;charset=utf-8"}),R=URL.createObjectURL(T),P=document.createElement("a");P.href=R,P.download=`plan-${F.nombre.replace(/[^\w-]+/g,"_")}-${e()}.csv`,P.click(),URL.revokeObjectURL(R),q(`CSV exportado (${n.serieMensual.length} meses)`)}),N(M,"[data-pl-guardar-notas]",()=>{var F;l({notas:((F=M.querySelector("#pl-notas"))==null?void 0:F.value)??""}),q("Notas guardadas")})}return{id:"planner",route:"planner",nombre:"Objetivos financieros",seccion:2,iconoPath:Zl,mount:D}}function ns(t,e,a=!1){const o=Math.abs(It(e));return t==="ingreso"?o:t==="gasto"||a?-o:o}function ec(t){function e(f){return`${f}_${Date.now().toString(36)}${Math.random().toString(36).slice(2,7)}`}function a(f={}){var m;const $=(m=f.texto)==null?void 0:m.trim().toLowerCase();return t.get("transacciones").filter(x=>!(f.cuentaId&&x.cuentaId!==f.cuentaId||f.desde&&x.fecha<f.desde||f.hasta&&x.fecha>f.hasta||f.tipo&&x.tipo!==f.tipo||f.estimacionId&&x.estimacionId!==f.estimacionId||f.tags&&f.tags.length>0&&!f.tags.some(S=>x.tags.includes(S))||$&&!x.concepto.toLowerCase().includes($))).sort((x,S)=>x.fecha.localeCompare(S.fecha)||x._id.localeCompare(S._id))}function o(f){const $={_id:e("tx"),fecha:f.fecha,cuentaId:f.cuentaId,importeCts:ns(f.tipo,f.importe,f.negativo),concepto:f.concepto,tags:f.tags??[],estimacionId:f.estimacionId??null,tipo:f.tipo,origen:f.origen??"manual",...f.nota?{nota:f.nota}:{}};return t.set("transacciones",[...t.get("transacciones"),$]),$}function s(f,$){t.set("transacciones",t.get("transacciones").map(m=>{if(m._id!==f)return m;const{importe:x,...S}=$,w={...m,...S};return x!==void 0&&(w.importeCts=ns(w.tipo,x,w.importeCts<0)),w}))}function n(f){t.set("transacciones",t.get("transacciones").filter($=>$._id!==f))}function i(f,$){s(f,{estimacionId:$})}function r(f){return t.get("puntosControl").filter($=>!f||$.cuentaId===f).sort(($,m)=>$.fecha.localeCompare(m.fecha))}function l(f,$,m,x){const S={_id:e("pc"),fecha:$,cuentaId:f,saldoCts:It(m),...x?{nota:x}:{}},w=t.get("puntosControl").filter(E=>!(E.cuentaId===f&&E.fecha===$));return t.set("puntosControl",[...w,S].sort((E,_)=>E.fecha.localeCompare(_.fecha))),b(f),S}function d(f){const $=t.get("puntosControl").find(m=>m._id===f);t.set("puntosControl",t.get("puntosControl").filter(m=>m._id!==f)),$&&b($.cuentaId)}function b(f){const $=r(f),m=t.get("accounts");m.some(x=>x._id===f)&&t.set("accounts",m.map(x=>x._id===f?{...x,historicoSaldos:$.map(S=>({_id:S._id,fecha:S.fecha,saldo:et(S.saldoCts),...S.nota?{nota:S.nota}:{}}))}:x))}function u(f,$=Y()){const m=r(f).filter(E=>E.fecha<=$).pop(),x=m==null?void 0:m.fecha,S=(m==null?void 0:m.saldoCts)??0;return t.get("transacciones").filter(E=>E.cuentaId===f&&E.fecha<=$&&(x===void 0||E.fecha>x)).reduce((E,_)=>E+_.importeCts,S)}function p(f,$){return et(u(f,$))}function y(f=Y(),$){const m=$??t.get("accounts").filter(x=>x.activo).map(x=>x._id);return et(m.reduce((x,S)=>x+u(S,f),0))}function g(){return t.get("transacciones").length>0||t.get("puntosControl").length>0}function I(){const f=[...t.get("transacciones").map($=>$.fecha),...t.get("puntosControl").map($=>$.fecha)];return f.length>0?f.sort().pop()??null:null}function A(f={}){return et(a(f).reduce(($,m)=>$+m.importeCts,0))}function v(f={}){const $=new Map;for(const m of a(f)){const x=m.fecha.slice(0,7);$.set(x,($.get(x)??0)+m.importeCts)}return new Map([...$.entries()].sort(([m],[x])=>m.localeCompare(x)).map(([m,x])=>[m,et(x)]))}function h(f={}){const $=new Map;for(const m of a(f))for(const x of m.tags.length>0?m.tags:["sin_tag"])$.set(x,($.get(x)??0)+m.importeCts);return new Map([...$.entries()].map(([m,x])=>[m,et(x)]))}return{transacciones:a,registrar:o,actualizar:s,eliminar:n,asignarEstimacion:i,puntosControl:r,registrarPuntoControl:l,eliminarPuntoControl:d,saldoCuenta:p,saldoCuentaCts:u,saldoTotal:y,tieneDatos:g,ultimaFecha:I,total:A,totalPorMes:v,totalPorTag:h}}function xt(t){return t.trim().toLowerCase()}function ac(t){function e(){const d=new Map,b=(u,p)=>{const y=xt(u);if(!y)return;const g=d.get(y)??{tag:y,estimaciones:0,reales:0,total:0};g[p]+=1,g.total+=1,d.set(y,g)};for(const u of t.get("expenses"))for(const p of u.tags??[])b(p,"estimaciones");for(const u of t.get("transacciones"))for(const p of u.tags??[])b(p,"reales");return[...d.values()].sort((u,p)=>p.total-u.total||u.tag.localeCompare(p.tag))}function a(){return e().map(d=>d.tag)}function o(d){return e().filter(b=>d==="estimaciones"?b.reales===0:b.estimaciones===0).map(b=>b.tag)}function s(d,b,u){const p=xt(b),y=(d??[]).map(xt);if(!y.includes(p))return d??[];const g=y.filter(I=>I!==p);return u===null?[...new Set(g)]:[...new Set([...g,xt(u)])]}function n(d,b){const u=xt(b);if(!u)throw new Error("El nuevo nombre de la etiqueta no puede estar vacío");return l(d,u)}function i(d,b){let u=0;for(const p of d)xt(p)!==xt(b)&&(u+=l(p,xt(b)).cambiados);return{cambiados:u}}function r(d){return l(d,null)}function l(d,b){let u=0;const p=t.get("expenses").map(S=>{const w=s(S.tags,d,b);return w!==S.tags&&(u+=1),w===S.tags?S:{...S,tags:w}});t.set("expenses",p);const y=t.get("transacciones").map(S=>{const w=s(S.tags,d,b);return w!==S.tags&&(u+=1),w===S.tags?S:{...S,tags:w}});t.set("transacciones",y);const g=t.get("loans").map(S=>{const w=s(S.tags,d,b);return w!==S.tags&&(u+=1),w===S.tags?S:{...S,tags:w}});t.set("loans",g);const I=t.get("nominas").map(S=>{const w=s(S.tags,d,b);return w!==S.tags&&(u+=1),w===S.tags?S:{...S,tags:w}});t.set("nominas",I);const A=t.get("config"),v=xt(d),h=S=>{const w=(S??[]).map(xt);if(!w.includes(v))return S??[];const E=w.filter(_=>_!==v);return b===null?[...new Set(E)]:[...new Set([...E,b])]},f={},$=h(A.activeTagsFilter),m=h(A.tagCategorias),x=h(A.tagGrupos);return $!==A.activeTagsFilter&&(f.activeTagsFilter=$),m!==A.tagCategorias&&(f.tagCategorias=m),x!==A.tagGrupos&&(f.tagGrupos=x),Object.keys(f).length>0&&t.patchConfig(f),{cambiados:u}}return{uso:e,todas:a,soloEn:o,renombrar:n,fusionar:i,eliminar:r}}const oc=3;function is(t){return t<.005?0:t}function sc(t){if(t.length<2)return null;const e=t.reduce((o,s)=>o+s,0)/t.length,a=t.reduce((o,s)=>o+(s-e)**2,0)/(t.length-1);return Math.sqrt(a)}function nc(t){const e=[],a=[],o=[];for(const i of t){if(i.meses.length<oc)continue;const r=sc(i.meses.map(l=>l.desviacion));r!==null&&(e.push(r),a.push(r/Math.sqrt(i.meses.length)),o.push(i.meses.length))}if(e.length===0)return{sigmaMensual:0,sigmaDeriva:0,estimaciones:0,mesesMinimos:0,mesesMaximos:0,fiable:!1};const s=Math.sqrt(e.reduce((i,r)=>i+r*r,0)),n=Math.sqrt(a.reduce((i,r)=>i+r*r,0));return{sigmaMensual:is(s),sigmaDeriva:is(n),estimaciones:e.length,mesesMinimos:Math.min(...o),mesesMaximos:Math.max(...o),fiable:!0}}function rs(t,e,a=1,o=0){if(e<=0)return 0;const s=Math.max(0,t)*Math.sqrt(e),n=Math.max(0,o)*e;return s===0&&n===0?0:W(a*Math.hypot(s,n))}function ic(t,e,a={}){if(!e.fiable||t.length===0)return[];const{z:o=1}=a,s=a.desde??t[0].fecha,[n,i]=s.slice(0,7).split("-").map(Number);return t.map(r=>{const[l,d]=r.fecha.slice(0,7).split("-").map(Number),b=Math.max(0,(l-n)*12+(d-i)),u=rs(e.sigmaMensual,b,o,e.sigmaDeriva);return{fecha:r.fecha,saldo:r.saldoAcum,arriba:W(r.saldoAcum+u),abajo:W(r.saldoAcum-u)}})}function rc(t,e=1){if(!t.fiable)return"Necesita al menos 3 meses de contabilidad real para medir cuánto se desvían tus estimaciones.";if(t.sigmaMensual===0)return"Sin margen de error: tus estimaciones se desvían siempre lo mismo, así que no hay incertidumbre que dibujar. Si se desvían de forma sistemática, ajústalas desde el cierre de mes.";const a=e>=2?"95 %":"68 %",o=t.mesesMinimos===t.mesesMaximos?`${t.mesesMinimos}`:`${t.mesesMinimos}–${t.mesesMaximos}`;return`Banda de ±${e} desviación${e!==1?"es":""} típica${e!==1?"s":""} (${a} de los casos), medida sobre ${t.estimaciones} estimación${t.estimaciones!==1?"es":""} con ${o} mes${t.mesesMaximos!==1?"es":""} de datos reales. Se ensancha con el tiempo, y tanto más deprisa cuanto menos historial haya: tu gasto medio también es una estimación.`}const ua="financeapp_session",lc=["local","dropbox","firebase"];function cc(t){if(!t)return null;try{const e=JSON.parse(t);if(!e||!lc.includes(e.modo))return null;const a=Number(e.creadaEn),o=Number(e.ultimoUso);return!Number.isFinite(a)||!Number.isFinite(o)?null:{modo:e.modo,...typeof e.email=="string"?{email:e.email}:{},...typeof e.passphrase=="string"?{passphrase:e.passphrase}:{},creadaEn:a,ultimoUso:o}}catch{return null}}function dc({storage:t,autoLogoutMinutos:e=()=>0,ahora:a=()=>Date.now()}={}){const o=()=>t??(typeof localStorage<"u"?localStorage:null);function s(p){const y=o();if(y)try{p?y.setItem(ua,JSON.stringify(p)):y.removeItem(ua)}catch{}}function n(){const p=o();if(!p)return null;try{return cc(p.getItem(ua))}catch{return null}}function i(){const p=n();return p?(a()-p.ultimoUso)/6e4:null}function r(){const p=e();if(!Number.isFinite(p)||p<=0)return!1;const y=i();return y!==null&&y>=p}function l(){const p=n();return p?r()?(s(null),null):p:null}function d(p){const y=a(),g={modo:p.modo,...p.email?{email:p.email}:{},...p.passphrase?{passphrase:p.passphrase}:{},creadaEn:y,ultimoUso:y};return s(g),g}function b(){const p=n();p&&s({...p,ultimoUso:a()})}function u(){s(null)}return{abrir:d,leer:l,tocar:b,cerrar:u,caducada:r,inactividadMinutos:i,get activa(){return l()!==null}}}const ls=["pointerdown","keydown","visibilitychange"];function uc({sesion:t,onCaducada:e,intervaloMs:a=3e4,setIntervalImpl:o=setInterval,clearIntervalImpl:s=clearInterval,target:n=typeof document<"u"?document:void 0}){let i=!0;const r=()=>{i&&t.tocar()};for(const b of ls)n==null||n.addEventListener(b,r);const l=o(()=>{i&&t.caducada()&&(d(),t.cerrar(),e())},a);function d(){if(i){i=!1,s(l);for(const b of ls)n==null||n.removeEventListener(b,r)}}return d}const pc=[{minutos:0,etiqueta:"Nunca (solo manualmente)"},{minutos:15,etiqueta:"Tras 15 minutos de inactividad"},{minutos:60,etiqueta:"Tras 1 hora de inactividad"},{minutos:480,etiqueta:"Tras 8 horas de inactividad"},{minutos:10080,etiqueta:"Tras 7 días de inactividad"}];function cs(){if(typeof localStorage<"u"){const g=Sn();g.length>0&&console.info(`[FinanceApp] Recuperadas claves escritas fuera del espacio de nombres: ${g.join(", ")}`)}const t=An(),e=En({adapter:t}),a=zn(),{applied:o}=e.load();o.length>0&&console.info(`[FinanceApp] Migraciones aplicadas: ${o.join(", ")} (esquema v${ee})`),e.subscribe(g=>a.marcar(g));const s=Tn(e);Vs(g=>s.isEnabled(g));const n=dc({autoLogoutMinutos:()=>{var I,A;const g=(A=(I=globalThis.State)==null?void 0:I.get)==null?void 0:A.call(I,"config");return Number((g==null?void 0:g.autoLogoutMinutos)??e.get("config").autoLogoutMinutos??0)}}),i=ec(e),r=ac(e),l=hi(i),d=Zn(e),b=Jn({isEnabled:g=>s.isEnabled(g)}),u=Ln({flags:s,rutasExtra:()=>b.flagPorRuta()}),p=qn({flags:s,onChange:()=>{var g,I;b.attachToShell(),u.apply(),(I=(g=globalThis.Router)==null?void 0:g.rerender)==null||I.call(g)}}),y=()=>{var I,A,v,h,f,$;const g=globalThis;if((A=(I=g.State)==null?void 0:I.load)==null||A.call(I),((h=(v=g.Router)==null?void 0:v.current)==null?void 0:h.call(v))==="dashboard")try{($=(f=g.DashboardModule)==null?void 0:f.render)==null||$.call(f)}catch(m){console.error("[FinanceApp] No se ha podido repintar el cuadro de mando tras el cambio:",m)}};return b.register(Vi({store:e,onDatosCambiados:y})),b.register(ar({store:e,onDatosCambiados:y})),b.register($r({store:e,onDatosCambiados:y})),b.register(Br({store:e,ledger:i,mostrarObjetivos:()=>s.isEnabled("goals"),onDatosCambiados:y})),b.register(zi({ledger:i,tags:r,precision:l,adjuster:d,accounts:()=>e.get("accounts"),estimaciones:()=>e.get("expenses"),onDatosCambiados:y})),b.register(tc({store:e,onDatosCambiados:y})),b.register(Xr({store:e,onDatosCambiados:y})),b.register(Oi({store:e,onDatosCambiados:y})),b.register(Jr({store:e})),b.register(Fi({store:e,onDatosCambiados:y})),{version:ee,core:Cs,engine:{generarExtracto:Xt,recomputarSaldoAcum:zs,saldoHoy:_s,sumarPorTags:Ba,providers:{proyectarGastos:Qt,proyectarPrestamos:Fa,proyectarTransferencias:Pa,proyectarNominas:Ra,proyectarInteresesCuentas:Ta,proyectarAportaciones:Da,proyectarRetencionesFiscales:Na,proyectarInflacionGastos:Oa,proyectarPerdidaAhorro:qa},analysis:Ts,margins:qs,avisos:Hs,optimizer:Us,dashboard:rn},store:e,flags:s,featureRegistry:{all:Ct,porGrupo:mo},ui:{openFeatures:p.open,applyGating:u.apply,watchGating:()=>u.observar(),instalarDeshacer:()=>kn({store:e,rerender:()=>{var I,A,v,h;const g=globalThis;(A=(I=g.State)==null?void 0:I.load)==null||A.call(I),(h=(v=g.Router)==null?void 0:v.rerender)==null||h.call(v)}}),avisoGuardado:null,instalarBuscador:()=>Un({estado:()=>({accounts:e.get("accounts"),expenses:e.get("expenses"),loans:e.get("loans"),nominas:e.get("nominas"),escenarios:e.get("escenarios"),planes:e.get("planes"),goals:e.get("goals"),transacciones:e.get("transacciones")}),rutasDisponibles:()=>b.routes(),navegar:g=>{var I,A;return(A=(I=globalThis.Router)==null?void 0:I.navigate)==null?void 0:A.call(I,g)}})},app:b,session:Object.assign(n,{vigilar:g=>uc({sesion:n,onCaducada:g}),opciones:pc}),cambios:a,datos:{colecciones:oe,snapshot:()=>uo(t),aplicar:(g,{sellar:I=!0}={})=>{const v=_n(I?(h,f)=>t.set(h,f):(h,f)=>{const $=globalThis.StorageAdapter;$!=null&&$.setRestaurando?$.setRestaurando(h,f):t.set(h,f)},g);return e.load(),a.marcar("copia-restaurada"),v},faltantes:g=>Fn(g),esVacioOPorDefecto:()=>Pn(uo(t)),recargar:()=>{e.load(),a.marcar("recarga-externa")}},accounting:{ledger:i,tags:r,precision:l,adjuster:d,sugerirAjuste:Qe,medirVariabilidad:nc,bandaDeConfianza:ic,bandaAcumulada:rs,describirBanda:rc}}}function mc(){try{const t=cs();return window.FinanceApp=t,t}catch(t){const e=t;return window.FinanceAppError={mensaje:(e==null?void 0:e.message)??String(t),stack:e==null?void 0:e.stack},console.error("[FinanceApp] El paquete nuevo no pudo arrancar:",t),null}}const jt=typeof window<"u"?mc():null;if(jt){let t=!1;const e=()=>{if(jt.app.attachToShell(),jt.ui.applyGating(),!t){t=!0,jt.ui.watchGating(),jt.ui.instalarDeshacer(),jt.ui.instalarBuscador();const a=globalThis,o=()=>{var s,n,i,r;return(n=(s=a.FirebaseService)==null?void 0:s.isConnected)!=null&&n.call(s)?a.FirebaseService:(r=(i=a.DropboxService)==null?void 0:i.isConnected)!=null&&r.call(i)?a.DropboxService:null};jt.ui.avisoGuardado=Yn({cambios:jt.cambios,hayDestino:()=>o()!==null,guardar:async()=>{const s=o();if(!(s!=null&&s.uploadBackup))throw new Error("No hay ningún destino de copia conectado.");await s.uploadBackup()}})}};document.readyState==="loading"?document.addEventListener("DOMContentLoaded",e,{once:!0}):e(),document.addEventListener("click",a=>{const o=a.target;o!=null&&o.closest(".nav-btn[data-view]")&&setTimeout(e,0)})}return $t.bootstrap=cs,Object.defineProperty($t,Symbol.toStringTag,{value:"Module"}),$t}({});
