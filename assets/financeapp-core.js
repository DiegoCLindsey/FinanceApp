...
¿Continuar?`))return;const{aplicadas:s,errores:i}=e.adjuster.aplicarTodas(o,{hoy:e.hoy()});k(i.length>0?`${s.length} ajustadas, ${i.length} con error`:`${s.length} estimaciones ajustadas`,i.length>0?"warn":"ok"),e.onDatosCambiados(),a()})}const er=[";",",","	","|"],ar={fecha:["fecha","f. valor","fecha valor","fecha operacion","date","f.operacion","f. operacion"],concepto:["concepto","descripcion","detalle","movimiento","referencia","description","observaciones"],importe:["importe","cantidad","amount","euros","import"],debe:["debe","cargo","salida","pago","debito"],haber:["haber","abono","entrada","ingreso","credito"]};function Pe(t){return t.normalize("NFD").replace(/[̀-ͯ]/g,"").toLowerCase().trim()}function Fe(t,e){const a=[];let o="",n=!1;for(let s=0;s<t.length;s++){const i=t[s];n?i==='"'?t[s+1]==='"'?(o+='"',s++):n=!1:o+=i:i==='"'?n=!0:i===e?(a.push(o.trim()),o=""):o+=i}return a.push(o.trim()),a}function or(t){let e=";",a=-1;for(const o of er){const n=t.slice(0,20).map(l=>Fe(l,o).length),s=Math.max(...n);if(s<2)continue;const r=n.filter(l=>l===s).length*10+s;r>a&&(a=r,e=o)}return e}function be(t){let e=(t??"").trim();if(!e)return null;let a=!1;if(/^\(.*\)$/.test(e)&&(a=!0,e=e.slice(1,-1).trim()),e.endsWith("-")&&(a=!0,e=e.slice(0,-1).trim()),e.startsWith("-")&&(a=!0,e=e.slice(1).trim()),e.startsWith("+")&&(e=e.slice(1).trim()),e=e.replace(/[€$£\s  ]/g,""),!e)return null;const o=e.lastIndexOf(","),n=e.lastIndexOf(".");let s="";o>=0&&n>=0?s=o>n?",":".":o>=0?s=/,\d{3}$/.test(e)&&e.replace(/,/g,"").length>3?"":",":n>=0&&(s=/\.\d{3}$/.test(e)&&e.replace(/\./g,"").length>3?"":".");let i,r="0";if(s){const f=s===","?o:n;i=e.slice(0,f).replace(/[.,]/g,""),r=e.slice(f+1).replace(/[.,]/g,"")}else i=e.replace(/[.,]/g,"");if(!/^\d*$/.test(i)||!/^\d*$/.test(r)||i===""&&r==="")return null;const l=(r+"00").slice(0,2),u=Number(i||"0")*100+Number(l);return Number.isFinite(u)?a?-u:u:null}function ha(t){const e=(t??"").trim();if(!e)return null;let a=e.match(/^(\d{4})[-/](\d{1,2})[-/](\d{1,2})/);if(a)return Ko(Number(a[1]),Number(a[2]),Number(a[3]));if(a=e.match(/^(\d{1,2})[-/.](\d{1,2})[-/.](\d{2,4})/),a){let o=Number(a[3]);return o<100&&(o+=o<70?2e3:1900),Ko(o,Number(a[2]),Number(a[1]))}return null}function Ko(t,e,a){if(e<1||e>12||a<1||a>31)return null;const o=new Date(t,e-1,a);return o.getFullYear()!==t||o.getMonth()!==e-1||o.getDate()!==a?null:`${t}-${String(e).padStart(2,"0")}-${String(a).padStart(2,"0")}`}function Qo(t){const e=t.filter(a=>a.trim());return e.length===0?0:e.filter(a=>ha(a)!==null).length/e.length}function Xo(t){const e=t.filter(a=>a.trim());return e.length===0?0:e.filter(a=>be(a)!==null).length/e.length}function nr(t,e){const a={fecha:-1,concepto:-1,importe:-1,debe:-1,haber:-1},o=new Set,n=s=>e.map(i=>i[s]??"");for(const s of["fecha","importe","debe","haber","concepto"])for(let i=0;i<t.length;i++){if(o.has(i))continue;const r=Pe(t[i]);if(r&&ar[s].some(l=>r===l||r.startsWith(l)||r.includes(l))){if(s==="importe"&&Pe(t[i]).includes("saldo"))continue;a[s]=i,o.add(i);break}}if(a.fecha<0){let s=-1,i=.6;for(let r=0;r<t.length;r++){if(o.has(r))continue;const l=Qo(n(r));l>i&&(i=l,s=r)}s>=0&&(a.fecha=s,o.add(s))}if(a.importe<0&&a.debe<0&&a.haber<0){let s=-1,i=.6;for(let r=0;r<t.length;r++){if(o.has(r)||Pe(t[r]).includes("saldo"))continue;const l=Xo(n(r));l>i&&(i=l,s=r)}s>=0&&(a.importe=s,o.add(s))}if(a.concepto<0){let s=-1,i=0;for(let r=0;r<t.length;r++){if(o.has(r))continue;const l=n(r);if(Xo(l)>.5||Qo(l)>.5)continue;const u=l.reduce((f,c)=>f+c.length,0)/Math.max(1,l.length);u>i&&(i=u,s=r)}s>=0&&(a.concepto=s)}return a}function sr(t){const e=t.replace(/^﻿/,"").split(/\r\n|\n|\r/).filter(f=>f.trim()!=="");if(e.length===0)return{separador:";",cabeceras:[],filas:[],lineaCabecera:0,mapeo:{fecha:-1,concepto:-1,importe:-1,debe:-1,haber:-1}};const a=or(e),o=e.map(f=>Fe(f,a).length),n=Math.max(...o);let s=o.findIndex(f=>f===n);s<0&&(s=0);const i=Fe(e[s],a);let r=e.slice(s+1).map(f=>Fe(f,a));const l=ha(i[0]??"")!==null||i.some(f=>be(f)!==null&&/\d/.test(f));l&&(r=[i,...r]);const u=nr(l?i.map(()=>""):i,r.slice(0,40));return{separador:a,cabeceras:l?i.map((f,c)=>`Columna ${c+1}`):i,filas:r,lineaCabecera:s+1,mapeo:u}}function Zo(t,e,a){return`${t}|${e}|${Pe(a).replace(/\s+/g," ")}`}function ir(t,e,a=[]){const o=new Set(a.map(s=>Zo(s.fecha,s.importeCts,s.concepto))),n=new Set;return t.filas.map((s,i)=>{const r=[],l=e.fecha>=0?ha(s[e.fecha]??""):null;e.fecha<0?r.push("sin columna de fecha"):l||r.push(`fecha ilegible: «${s[e.fecha]??""}»`);let u=null;if(e.importe>=0)u=be(s[e.importe]??""),u===null&&r.push(`importe ilegible: «${s[e.importe]??""}»`);else if(e.debe>=0||e.haber>=0){const p=e.debe>=0?be(s[e.debe]??""):null,v=e.haber>=0?be(s[e.haber]??""):null;p===null&&v===null?r.push("sin importe en Debe ni en Haber"):p!==null&&p!==0?u=-Math.abs(p):v!==null&&v!==0?u=Math.abs(v):u=0}else r.push("sin columna de importe");u===0&&r.push("importe cero");const f=(e.concepto>=0?s[e.concepto]??"":"").trim()||"Movimiento importado";let c=!1;if(l&&u!==null){const p=Zo(l,u,f);c=o.has(p)||n.has(p),n.add(p)}return{linea:t.lineaCabecera+1+i,fecha:l,concepto:f,importeCts:u,errores:r,duplicada:c}})}function rr(t,e){const a=t.filter(n=>n.errores.length===0&&(e||!n.duplicada)),o=a.map(n=>n.fecha).filter(n=>!!n).sort();return{total:t.length,importables:a.length,conError:t.filter(n=>n.errores.length>0).length,duplicadas:t.filter(n=>n.duplicada).length,sumaCts:a.reduce((n,s)=>n+(s.importeCts??0),0),desde:o[0]??null,hasta:o[o.length-1]??null}}function De(){return{abierto:!1,nombreFichero:"",analisis:null,mapeo:null,filas:[],cuentaId:"",incluirDuplicadas:!1,error:""}}const lr=[{clave:"fecha",etiqueta:"Fecha"},{clave:"concepto",etiqueta:"Concepto"},{clave:"importe",etiqueta:"Importe (con signo)"},{clave:"debe",etiqueta:"Debe (salidas)"},{clave:"haber",etiqueta:"Haber (entradas)"}];function ya(t,e){if(!e.analisis||!e.mapeo){e.filas=[];return}const a=t.ledger.transacciones(e.cuentaId?{cuentaId:e.cuentaId}:{}).map(o=>({fecha:o.fecha,importeCts:o.importeCts,concepto:o.concepto}));e.filas=ir(e.analisis,e.mapeo,a)}function cr(t,e){const a=t.accounts().filter(n=>n.activo);if(!e.abierto)return`
    ...
    ${t.sinEstimacion.length>10?`<div class="text-sm mt-8" style="color:var(--text3)">…y ${t.sinEstimacion.length-10} concepto(s) más.</div>`:""}`}function Mr(t,e,a,o){U(t,"#cie-mes",n=>{a.mes=n.value,o()}),N(t,"[data-cie-ajustar]",n=>{const s=n.dataset.cieAjustar,r=$a(e,xa(e,a)).filas.find(l=>l.estimacionId===s);r!=null&&r.sugerencia&&(e.adjuster.aplicar(r.sugerencia.estimacionId,r.sugerencia.cuantiaSugerida,{hoy:(e.hoy??J)()}),k(`«${r.concepto}» ajustada a ${j(r.sugerencia.cuantiaSugerida)}`),e.onDatosCambiados(),o())}),N(t,"[data-cie-ajustar-todas]",()=>{const s=$a(e,xa(e,a)).filas.map(l=>l.sugerencia).filter(l=>l!==null);if(s.length===0)return;const{aplicadas:i,errores:r}=e.adjuster.aplicarTodas(s,{hoy:(e.hoy??J)()});k(`${i.length} estimación${i.length!==1?"es":""} ajustada${i.length!==1?"s":""}`+(r.length>0?` · ${r.length} con error`:"")),e.onDatosCambiados(),o()})}const Er="M20 4H4c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 14H4V8h16v10zM6 10h5v2H6v-2zm0 4h8v2H6v-2z";function _r(t){const e={cuentaId:"",mes:(t.hoy??J)().slice(0,7),filtroTexto:""},a=De(),o=Ar(),n=()=>{var c;return(c=t.onDatosCambiados)==null?void 0:c.call(t)},s=t.hoy??J,i={ledger:t.ledger,accounts:t.accounts,estimaciones:t.estimaciones,tagsConocidas:()=>t.tags.todas(),onDatosCambiados:n,hoy:s},r={ledger:t.ledger,accounts:t.accounts,onDatosCambiados:n},l={ledger:t.ledger,precision:t.precision,adjuster:t.adjuster,estimaciones:t.estimaciones,onDatosCambiados:n,hoy:s},u={precision:t.precision,adjuster:t.adjuster,estimaciones:t.estimaciones,onDatosCambiados:n,hoy:s};function f(c){const p=t.ledger.saldoTotal(s()),v=t.ledger.ultimaFecha(),b=t.ledger.transacciones().length;c.innerHTML=`
      ...
      <div id="acc-precision" data-feature="precision-estimaciones"></div>`;const I=c.querySelector("#acc-importar"),w=c.querySelector("#acc-cierre"),x=c.querySelector("#acc-transacciones"),g=c.querySelector("#acc-precision");I.innerHTML=cr(r,a),w.innerHTML=wr(l,o),x.innerHTML=Ki(i,e),g.innerHTML=Zi(u);const h=()=>f(c);pr(I,r,a,h),Mr(w,l,o,h),Qi(x,i,e,h),tr(g,u,h)}return{id:"contabilidad",route:"contabilidad",nombre:"Contabilidad",flagId:"contabilidad",seccion:1,iconoPath:Er,mount:f}}const jr="M12 1L3 5v6c0 5.55 3.84 10.74 9 12 5.16-1.26 9-6.45 9-12V5l-9-4zm0 4l5 2.18V11c0 3.5-2.33 6.79-5 7.93-2.67-1.14-5-4.43-5-7.93V7.18L12 5z";function Ia(){return Date.now().toString(36)+Math.random().toString(36).slice(2,6)}function zr(t){const{store:e}=t,a=t.hoy??J,o=()=>G(a()),n=()=>e.get("config").margenesSeguridad??[];function s(v){var b;e.patchConfig({margenesSeguridad:v}),(b=t.onDatosCambiados)==null||b.call(t)}function i(v,b){const I=n().map(x=>({...x,puntos:(x.puntos??[]).map(g=>({...g}))})),w=I.find(x=>x._id===v);w&&(b(w),s(I))}function r(v){const b=e.get("config"),I=Ee(v,e.get("expenses"),b,e.get("loans"),a(),!1,o());return j(I)}function l(v,b,I){const w=b.tipo==="fijo",x=w?"":`<span class="text-sm" style="color:var(--text3)">${d(j((b.meses??0)*I))}</span>`;return`
      <tr data-punto="${d(b._id)}" data-margen="${d(v._id)}">
        ...
        <td style="padding:4px 6px">
          ${w?`<input type="number" class="form-input" style="width:90px" value="${b.importe??0}" data-campo="importe"/>`:'<span style="color:var(--text3)">—</span>'}
        </td>
        <td style="padding:4px 6px">
          ${w?'<span style="color:var(--text3)">—</span>':`<input type="number" class="form-input" style="width:70px" value="${b.meses??0}" step="0.5" data-campo="meses"/>`}
        </td>
      ...
      </tr>`}function u(v,b,I){const w=v.cuentas&&v.cuentas.length>0?v.cuentas.map($=>{var m;return((m=b.find(y=>y._id===$))==null?void 0:m.nombre)??$}).join(", "):"Todas las cuentas activas",g=[...v.puntos??[]].sort(($,m)=>$.fecha.localeCompare(m.fecha)).map($=>l(v,$,I)).join(""),h=v.activo?`
      <div class="mt-8 text-sm" style="color:var(--text2)"><span style="color:var(--text3)">Cuentas:</span> ${d(w)}</div>
      ...
      <div class="card mb-8" style="padding:14px;border:1px solid var(--border)">
        ...
        ${h}
      </div>`}function f(v,b){const I=b?n().find(h=>h._id===b):null,w=e.get("accounts").filter(h=>h.activo),x=new Set((I==null?void 0:I.cuentas)??[]),g=w.map(h=>`
      ...
      </div>`}function c(v,b){const I=document.getElementById("modal-overlay"),w=document.getElementById("modal-content");!I||!w||(f(w,v),I.classList.remove("hidden"),U(w,".mg-acc-chip",x=>{const g=x,h=w.querySelector(`[data-chip="${g.value}"]`);h&&(h.style.cssText=`cursor:pointer;${g.checked?"border-color:var(--accent);color:var(--accent)":""}`)}),U(w,"#mg-p-tipo",x=>{const g=x.value==="fijo",h=w.querySelector("#mg-p-importe-wrap"),$=w.querySelector("#mg-p-meses-wrap");h&&(h.style.display=g?"":"none"),$&&($.style.display=g?"none":"")}),N(w,"[data-cerrar-form]",()=>I.classList.add("hidden")),N(w,"[data-guardar-margen]",x=>{var y,C,M,E,_;const g=x.getAttribute("data-guardar-margen")||"",h=((y=w.querySelector("#mg-nombre"))==null?void 0:y.value.trim())??"";if(!h)return k("El nombre es obligatorio","err");const $=[...w.querySelectorAll(".mg-acc-chip:checked")].map(P=>P.value),m=n().map(P=>({...P}));if(g){const P=m.findIndex(S=>S._id===g);if(P===-1)return k("Margen no encontrado","err");m[P]={...m[P],nombre:h,cuentas:$}}else{const P=((C=w.querySelector("#mg-p-tipo"))==null?void 0:C.value)??"fijo",S={_id:Ia(),fecha:((M=w.querySelector("#mg-p-fecha"))==null?void 0:M.value)||J(),tipo:P,importe:parseFloat(((E=w.querySelector("#mg-p-importe"))==null?void 0:E.value)??"0")||0,meses:parseFloat(((_=w.querySelector("#mg-p-meses"))==null?void 0:_.value)??"1")||1};m.push({_id:Ia(),nombre:h,activo:!0,cuentas:$,puntos:[S]})}s(m),k(g?"Margen actualizado":"Margen creado"),I.classList.add("hidden"),b()}))}function p(v){const b=n(),I=e.get("accounts"),w=de(e.get("expenses"),o());v.innerHTML=`
      <div class="page-header">
        <div>
      ...
      ${b.length===0?`<div class="card" style="padding:24px;text-align:center">
        ...
        </div>`;const v=new Set(o().map(g=>g.year)),b=c.filter(g=>g.year>=p).reverse(),I=b.filter(g=>!v.has(g.year)).length,w=[...new Set(c.map(g=>g.year))].sort((g,h)=>g-h),x=b.map(g=>`
      ...
      <div style="display:flex;gap:10px;align-items:center;margin-bottom:10px;flex-wrap:wrap">
        ...
        <select class="form-input" id="ipc-desde" style="width:auto;padding:4px 8px;font-size:12px">
          ${w.map(g=>`<option value="${g}"${g===p?" selected":""}>${g}</option>`).join("")}
        </select>
      ...
      </div>`,p.classList.remove("hidden");const b=(w,x)=>{const g=document.getElementById("ipc-body");g&&(g.innerHTML=s(w,x))},I=await a.obtener();b(I,i(I)),N(v,"[data-ipc-cerrar]",()=>p.classList.add("hidden")),U(v,"#ipc-desde",w=>{b(a.enCache,parseInt(w.value))}),N(v,"[data-ipc-recargar]",()=>{a.invalidar();const w=document.getElementById("ipc-body");w&&(w.innerHTML='<div style="text-align:center;padding:20px;color:var(--text3)">Recargando…</div>'),a.obtener(!0).then(x=>b(x,i(x)))}),N(v,"[data-ipc-importar]",()=>{const w=[...v.querySelectorAll(".ipc-chk:checked:not(:disabled)")];if(w.length===0)return k("Nada seleccionado","err");const x=new Set(o().map(h=>h.year));let g=0;for(const h of w){const $=parseInt(h.dataset.year??""),m=parseFloat(h.dataset.tasa??"");!Number.isFinite($)||!Number.isFinite(m)||x.has($)||(e.addItem("inflacion",{year:$,tasa:m}),x.add($),g++)}p.classList.add("hidden"),k(`${g} periodo${g!==1?"s":""} importado${g!==1?"s":""} correctamente`),n(),c()})}function l(c,p){var x;const v=document.getElementById("modal-overlay"),b=document.getElementById("modal-content");if(!v||!b)return;const I=c?o().find(g=>g._id===c):null;b.innerHTML=`
      ...
      </div>`,v.classList.remove("hidden");const w=()=>{var y;const g=parseFloat(((y=b.querySelector("#inf-tasa"))==null?void 0:y.value)??""),h=b.querySelector("#inf-preview");if(!h)return;if(!Number.isFinite(g)||g<=0){h.innerHTML="";return}const $=(Math.pow(1+g/100,1/12)-1)*100,m=Math.pow(1+g/100,5);h.innerHTML=`Con un ${g}% anual: <strong>${$.toFixed(3)}%/mes</strong> · factor acumulado a 5 años: <strong>×${m.toFixed(3)}</strong> (+${((m-1)*100).toFixed(1)}%)`};(x=b.querySelector("#inf-tasa"))==null||x.addEventListener("input",w),w(),N(b,"[data-inf-cerrar]",()=>v.classList.add("hidden")),N(b,"[data-inf-guardar]",g=>{const h=g.getAttribute("data-inf-guardar")||"",$=parseInt(b.querySelector("#inf-year").value),m=parseFloat(b.querySelector("#inf-tasa").value);if(!Number.isFinite($)||$<1900||$>2200)return k("Año inválido","err");if(!Number.isFinite(m)||m<0||m>100)return k("Tasa inválida (0–100%)","err");if(o().filter(C=>C._id!==h).some(C=>C.year===$))return k("Ya existe un periodo para ese año","err");h?(e.updateItem("inflacion",h,{year:$,tasa:m}),k("Periodo actualizado")):(e.addItem("inflacion",{year:$,tasa:m}),k("Periodo añadido")),v.classList.add("hidden"),n(),p()})}function u(c,p){const v=(Math.pow(1+c.tasa/100,.08333333333333333)-1)*100,b=`${c.year}-12-31`,I=b>p?ft([c],p,b):null;return`
      ...
      </div>`}function f(c){const p=o(),v=e.get("config").usarInflacion||!1,b=[...p].sort((y,C)=>C.year-y.year),I=J(),w=new Date().getFullYear(),x=V(new Date(w+5,0,1)),g=V(new Date(w+10,0,1)),h=v&&p.length>0?ft(p,I,x):null,$=v&&p.length>0?ft(p,I,g):null;c.innerHTML=`
      <div class="page-header">
    ...
    <div data-reparto-participantes="${d(o)}" style="margin-top:6px;${n?"":"display:none"}">
      ...
      </div>`}function p(x){const g=(x==null?void 0:x.tipo)==="transferencia",h=t.store.get("escenarios"),$=t.store.get("personas"),m=(x==null?void 0:x.escenarioIds)||[],y=(C,M,E,_,P="")=>`<div class="form-group"><label class="form-label">${d(M)}</label>
       <input class="form-input" type="${E}" id="${C}" value="${d(_)}" placeholder="${d(P)}"/></div>`;return`
      <div class="grid-2">
      ...
      <div class="grid-3 mt-8">
        ...
        <div class="form-group"><label class="form-label">Tipo frecuencia</label>
          <select class="form-select" id="ef-tipo-frec">
            ${Vr.map(([C,M])=>`<option value="${C}"${((x==null?void 0:x.tipoFrecuencia)??"mensual")===C?" selected":""}>${d(M)}</option>`).join("")}
          </select>
        </div>
      </div>
        ...
        <div class="form-advanced-body">
          ...
          ${h.length>0?`<div class="form-group mt-8"><label class="form-label">Supuestos</label>
                  <div style="display:flex;flex-wrap:wrap;gap:6px;margin-top:6px">
                    ${h.map(C=>`<label style="display:inline-flex;align-items:center;gap:5px;padding:4px 10px;background:var(--bg2);
                                border-radius:20px;cursor:pointer;font-size:12px;border:1px solid ${m.includes(C._id)?d(C.color||"var(--accent)"):"var(--border)"}">
                          <input type="checkbox" class="ef-escenario" value="${d(C._id)}"${m.includes(C._id)?" checked":""}/>
                          ${d(C.nombre)}
                        </label>`).join("")}
                  </div></div>`:""}
      ...
      </div>`}function v(x){var $;const g=(($=x.querySelector("#ef-tipo"))==null?void 0:$.value)??"gasto",h=(m,y)=>{const C=x.querySelector(m);C&&(C.style.display=y?"":"none")};h("#ef-destino-wrap",g==="transferencia"),h("#ef-basico-wrap",g!=="transferencia"),h("#ef-irpf-wrap",g==="ingreso"),h("#ef-clasificacion-wrap",g==="gasto")}function b(x,g,h){const $=document.getElementById("modal-overlay"),m=document.getElementById("modal-content");!$||!m||(m.innerHTML=`<div class="modal-title">${d(g)}</div>${p(x)}`,$.classList.remove("hidden"),U(m,"#ef-tipo",()=>v(m)),U(m,"[data-dp-modo]",()=>on(m)),U(m,'[data-reparto-modo="consumo"]',()=>Xt(m,"consumo")),U(m,'[data-reparto-modo="pago"]',()=>Xt(m,"pago")),N(m,"[data-cancelar]",()=>$.classList.add("hidden")),N(m,"[data-guardar]",y=>{I(m,y.getAttribute("data-guardar")||"")&&($.classList.add("hidden"),h())}))}function I(x,g){const h=P=>{var S;return((S=x.querySelector(P))==null?void 0:S.value)??""},$=P=>{var S;return!!((S=x.querySelector(P))!=null&&S.checked)},m=h("#ef-tipo")||"gasto",y=m==="transferencia",C=h("#ef-concepto").trim(),M=parseFloat(h("#ef-cuantia"));if(!C||!Number.isFinite(M))return k("Concepto y cuantía obligatorios","err"),!1;const E=h("#ef-clasificacion"),_={concepto:C,tipo:m,cuantia:M,frecuencia:parseInt(h("#ef-frecuencia"),10)||1,tipoFrecuencia:h("#ef-tipo-frec")||"mensual",fechaInicio:h("#ef-fecha-ini"),fechaFin:h("#ef-fecha-fin")||null,diaPago:nn(x),cuenta:h("#ef-cuenta"),cuentaDestino:y?h("#ef-cuenta-dest")||"default":void 0,activo:$("#ef-activo"),basico:!y&&$("#ef-basico"),sujetoIRPF:!y&&$("#ef-sujetoIRPF"),clasificacion:m==="gasto"?E||null:void 0,tags:y?["transferencia"]:h("#ef-tags").split(",").map(P=>P.trim()).filter(Boolean),escenarioIds:[...x.querySelectorAll(".ef-escenario:checked")].map(P=>P.value),repartoConsumo:y?void 0:Zt(x,"consumo"),repartoPago:y?void 0:Zt(x,"pago")};return g?(t.store.updateItem("expenses",g,_),k("Actualizado")):(t.store.addItem("expenses",_),k("Creado")),o(),!0}function w(x,g){const h=x.querySelector("[data-busqueda]");let $;h==null||h.addEventListener("input",()=>{clearTimeout($),$=setTimeout(()=>{a.busqueda=h.value,g();const m=x.querySelector("[data-busqueda]");m==null||m.focus(),m==null||m.setSelectionRange(m.value.length,m.value.length)},250)}),U(x,"[data-expirados]",m=>{a.mostrarExpirados=m.checked,g()}),U(x,"[data-f-tipo]",m=>{a.tipo=m.value,g()}),U(x,"[data-f-cuenta]",m=>{a.cuenta=m.value,g()}),U(x,"[data-f-desde]",m=>{a.desde=m.value,g()}),U(x,"[data-f-hasta]",m=>{a.hasta=m.value,g()}),N(x,"[data-limpiar]",()=>{a.tipo="",a.cuenta="",a.desde="",a.hasta="",a.busqueda="",a.tags=new Set,g()}),N(x,"[data-limpiar-tags]",()=>{a.tags=new Set,g()}),N(x,"[data-tag]",m=>{const y=m.getAttribute("data-tag");a.tags.has(y)?a.tags.delete(y):a.tags.add(y),g()}),N(x,"[data-orden]",m=>{const y=m.getAttribute("data-orden");a.orden===y?a.sentido=a.sentido===1?-1:1:(a.orden=y,a.sentido=1),g()}),N(x,"[data-nuevo]",()=>b(null,"Nuevo gasto/ingreso",g)),N(x,"[data-editar]",m=>{const y=t.store.get("expenses").find(C=>C._id===m.getAttribute("data-editar"));y&&b(y,"Editar",g)}),N(x,"[data-duplicar]",m=>{const y=t.store.get("expenses").find(E=>E._id===m.getAttribute("data-duplicar"));if(!y)return;const{_id:C,...M}=y;b({...M,concepto:`${y.concepto} (copia)`},"Duplicar movimiento",g)}),N(x,"[data-borrar]",m=>{tt("¿Eliminar?")&&(t.store.removeItem("expenses",m.getAttribute("data-borrar")),k("Eliminado"),o(),g())}),U(x,"[data-activo]",m=>{const y=m;t.store.updateItem("expenses",y.getAttribute("data-activo"),{activo:y.checked}),o(),g()})}return{id:"expenses",route:"expenses",nombre:"Gastos e Ingresos",flagId:"expenses",seccion:1,iconoPath:Gr,mount(x){const g=()=>c(x);c(x),x.dataset.wired!=="1"&&(w(x,g),x.dataset.wired="1")}}}function Te(t,e,a){return t.reduce((o,n)=>{if(n.esAmortizacion)return o;const s=ft(e,a,n.fecha);return o+(s>0?n.interes/s:n.interes)},0)}function rn(t,e,a,o){return t.reduce((n,s)=>{const i=ft(e,a,s.fecha),r=s.esAmortizacion?s.amortizacion+s.comisionAmort:s.cuota;return n+(i>0?r/i:r)},0)+o}function Yr(t,e,a){const o=t.amortizaciones||[];return o.map((n,s)=>{const i=at({...t,amortizaciones:o.slice(0,s)}),r=at({...t,amortizaciones:o.slice(0,s+1)});return{nominal:i.totalIntereses-r.totalIntereses,real:Te(i.tabla,e,a)-Te(r.tabla,e,a)}})}const Sa=(t,e,a="",o="")=>`<div class="stat-card">
   ...
   ${o?`<span class="text-sm" style="margin-left:6px">${d(o)}</span>`:""}`;function ye(t,e,a){return t.length===0?"":`<div class="form-group mt-8"><label class="form-label">Supuestos</label>
    ...
    <div class="flex gap-8 mt-16" style="justify-content:flex-end">
    ...
    </div>`}const ln="opt_",cn=t=>String(t).startsWith(ln);function el(t){let e=null,a=null;const o=()=>document.getElementById("modal-overlay"),n=()=>document.getElementById("modal-content");function s(h,$){const m=o(),y=n();return!m||!y?null:(y.innerHTML=`<div class="modal-title">${d(h)}</div>${$}`,m.classList.remove("hidden"),y)}const i=()=>{var h;return(h=o())==null?void 0:h.classList.add("hidden")};function r(){let h=!1;for(const $ of t.loans()){const m=($.amortizaciones||[]).filter(y=>!cn(y._id));m.length!==($.amortizaciones||[]).length&&(t.guardarAmortizaciones($._id,m),h=!0)}return h}function l(h){try{return h()}catch($){return k($ instanceof Error?$.message:"No se ha podido completar el cálculo","err"),null}}function u(){var E,_;if(!bo("optimizador")){k("El optimizador de amortizaciones está desactivado. Actívalo en ⚙ Funcionalidades.","err");return}const h=t.loans().filter(P=>P.activo&&!P.simulacion);if(h.length===0){k("No hay préstamos activos para optimizar","err");return}const $=t.config(),m=t.accounts().filter(P=>P.activo&&!P.simulacion),y=((E=m.find(P=>P.esCuentaPrincipal))==null?void 0:E._id)??((_=m[0])==null?void 0:_._id)??"",C=$.dashboardEnd||`${Number(t.hoy().slice(0,4))+5}-01-01`,M=s("✨ Optimizar amortizaciones",`
      ...
      <div class="grid-2 mt-8" style="gap:10px">
        ...
        ${et("opt-fecha-obj","Fecha objetivo para comparar saldo","date",C)}
      </div>
      <div class="flex gap-8 mt-16" style="justify-content:flex-end;flex-wrap:wrap">
        ...
        <button class="btn-primary" data-opt-calcular>Calcular plan manual</button>
      </div>`);M&&(f(M),U(M,".opt-acc-radio",()=>f(M)),N(M,"[data-opt-todos]",()=>{const P=[...M.querySelectorAll(".opt-loan-check")],S=P.every(A=>A.checked);P.forEach(A=>A.checked=!S)}),N(M,"[data-cancelar]",i),N(M,"[data-opt-calcular]",()=>b(M)),N(M,"[data-opt-comparar]",()=>I(M)))}function f(h){var M;const $=(M=h.querySelector(".opt-acc-radio:checked"))==null?void 0:M.value,y=(t.config().margenesSeguridad||[]).filter(E=>E.activo!==!1).filter(E=>!E.cuentas||E.cuentas.length===0||$&&E.cuentas.includes($)),C=h.querySelector("#opt-margenes-wrap");C&&(C.innerHTML=y.length===0?'<span class="text-sm" style="color:var(--yellow)">Sin márgenes configurados para esta cuenta. Define límites en <strong>Márgenes de seguridad</strong>.</span>':y.map(E=>`<label style="display:flex;align-items:center;gap:8px;padding:5px 8px;border-radius:6px;cursor:pointer;background:var(--bg2)">
              ...
              </label>`).join(""))}function c(h){var C,M,E,_;const $=(P,S,A=0)=>{var z;const F=parseFloat(((z=h.querySelector(P))==null?void 0:z.value)??"");return Number.isFinite(F)?Math.max(A,F):S},m=[...h.querySelectorAll(".opt-loan-check")],y=m.filter(P=>P.checked).map(P=>P.value);return{horizonte:Math.round($("#opt-horizonte",60,1)),frecuencia:Math.round($("#opt-frecuencia",1,1)),minAmortizable:$("#opt-min",500),tipoAmort:((C=h.querySelector("#opt-tipo"))==null?void 0:C.value)||"plazo",fechaObjetivo:((M=h.querySelector("#opt-fecha-obj"))==null?void 0:M.value)||null,fechaPrimeraAmort:((E=h.querySelector("#opt-fecha-primera"))==null?void 0:E.value)||null,loanIds:m.length===0||y.length===m.length?null:y,sourceAccountId:((_=h.querySelector(".opt-acc-radio:checked"))==null?void 0:_.value)??null,selectedMarginIds:[...h.querySelectorAll(".opt-margin-check:checked")].map(P=>P.value)}}const p=()=>({loans:t.loans(),expenses:t.expenses(),accounts:t.accounts(),config:t.config(),nominas:t.nominas()});function v(h,$=""){const m=s("Sin resultados",`<div style="text-align:center;padding:20px">
      ...
      </div>`);m&&(N(m,"[data-opt-volver]",u),N(m,"[data-cancelar]",i))}function b(h){const $=c(h);r()&&k("Plan anterior eliminado, recalculando…");const{loans:m,expenses:y,accounts:C,config:M,nominas:E}=p(),_=l(()=>sa(m,y,C,M,{frecuencia:$.frecuencia,mesesHorizonte:$.horizonte,minAmortizable:$.minAmortizable,tipoAmort:$.tipoAmort,fechaPrimeraAmort:$.fechaPrimeraAmort,loanIds:$.loanIds,nominas:E,sourceAccountId:$.sourceAccountId,selectedMarginIds:$.selectedMarginIds}));if(!_)return;if(_.plan.length===0){v(`No hay excedente suficiente respetando los ${_.margenesAplicados} márgenes de seguridad activos en los próximos ${$.horizonte} meses para generar amortizaciones por encima del mínimo de ${j($.minAmortizable)}.`,"Prueba a revisar los márgenes de seguridad, reducir el mínimo de amortización, o ampliar el horizonte.");return}a={plan:_.plan,tipoAmort:$.tipoAmort};const P=`✨ Plan de optimización · ${$.frecuencia===1?"Mensual":`Cada ${$.frecuencia} meses`} · ${$.horizonte}m`,S=s(P,`
      ...
      <div class="flex gap-8 mt-12" style="justify-content:flex-end;flex-wrap:wrap">
      ...
      </div>`);S&&(N(S,"[data-opt-volver]",u),N(S,"[data-cancelar]",i),N(S,"[data-opt-aplicar]",()=>{a&&x(a.plan,a.tipoAmort)}))}function I(h){const $=c(h);r();const{loans:m,expenses:y,accounts:C,config:M,nominas:E}=p(),_=l(()=>xo(m,y,C,M,{horizonte:$.horizonte,minAmortizable:$.minAmortizable,tipoAmort:$.tipoAmort,fechaObjetivo:$.fechaObjetivo,frecuencias:[1,2,3,6,12],fechaPrimeraAmort:$.fechaPrimeraAmort,loanIds:$.loanIds,nominas:E,sourceAccountId:$.sourceAccountId,selectedMarginIds:$.selectedMarginIds}));if(!_)return;if(_.resultados.length===0){v("No hay excedente suficiente en ninguna frecuencia.");return}e=_;const{resultados:P,saldoBase:S,fechaObjetivo:A}=_,F=P.map(T=>{const R=[T.esMejorIntereses&&"💰 +intereses",T.esMejorSaldo&&"🏦 +saldo",T.esMejorValor&&"⭐ +valor total"].filter(Boolean).join(" ");return`<tr style="${T.esMejorValor?"background:rgba(46,230,168,0.06);":""}">
        ...
        </tr>`}).join(""),z=s(`📊 Comparativa de frecuencias · hasta ${A}`,`
      <div class="auth-hint mb-12">
      ...
      <div class="flex gap-8 mt-16" style="justify-content:flex-end">
        <button class="btn-secondary" data-opt-volver>← Cambiar parámetros</button>
        <button class="btn-secondary" data-cancelar>Cerrar</button>
      </div>`);z&&(N(z,"[data-opt-volver]",u),N(z,"[data-cancelar]",i),N(z,"[data-opt-usar]",T=>w(Number(T.getAttribute("data-opt-usar")))))}function w(h){var m;const $=e==null?void 0:e.resultados.find(y=>y.frecuencia===h);$&&(r(),x($.plan,((m=$.plan[0])==null?void 0:m.tipoAmort)||"plazo",{titulo:`✨ Plan ${$.label} · aplicado`,resumen:$,fechaObjetivo:e==null?void 0:e.fechaObjetivo}))}function x(h,$,m){if(h.length===0)return;const y=new Map;for(const M of h){const E=y.get(M.loanId)??[];E.push({_id:`${ln}${M.mes}_${M.loanId}`,fecha:M.fechaAmort,cantidad:M.cantidadAmort,tipo:$,simulacion:!0}),y.set(M.loanId,E)}let C=0;for(const M of t.loans()){const E=y.get(M._id);if(!E)continue;const _=(M.amortizaciones||[]).filter(P=>!cn(P._id));t.guardarAmortizaciones(M._id,[..._,...E]),C+=1}k(`Plan aplicado: ${h.length} amortizaciones en ${C} préstamo${C!==1?"s":""} (simulación)`),m?g(m):i(),t.refrescar([...y.keys()])}function g({titulo:h,resumen:$,fechaObjetivo:m}){const y=s(h,`
      <div class="grid-4 mb-14" style="gap:10px">
      ...
      <div style="max-height:260px;overflow-y:auto">
        <table class="table-wrap" style="width:100%">
          ...
          <tbody>${$.plan.map(C=>dn(C,!1)).join("")}</tbody>
        </table>
      </div>
    ...
    <div class="grid-4" style="gap:8px;font-size:12px">
      ...
      ${P(null,"Todas")}
      ${_.map(S=>P(S._id,S.nombre)).join("")}
    </div>`}function f(E){if(!E.activo||E.simulacion)return!1;const _=at(E).tabla.filter(P=>!P.esAmortizacion);return _.length===0?!0:_[_.length-1].fecha<e()}function c(E,_){const P=e(),S=P.slice(0,7),A=new Map;let F=0;for(const z of E){if(!z.activo||z.simulacion||_.has(z._id)||(z.fechaInicio||"")>P)continue;const T=at(z).tabla.filter(D=>!D.esAmortizacion&&D.fecha.startsWith(S)),R=T.length>0?T[0].cuota:0;A.set(z._id,R),F+=R}return{porLoan:A,total:F,activos:[...A.values()].filter(z=>z>0).length}}function p(E){const _=e().slice(0,7),P=[];for(const S of E){if(!S.activo||S.simulacion)continue;const A=at(S).tabla.filter(z=>!z.esAmortizacion),F=A[A.length-1];F&&F.fecha.slice(0,7)===_&&P.push({loan:S,cuota:F.cuota})}return P}function v(E){return E.length<=1?E[0]??"":`${E.slice(0,-1).join(", ")} y ${E[E.length-1]}`}function b(E){const _=t.store.get("config"),P=_.dashboardStart,S=_.dashboardEnd,A=Math.max(1,(G(S).getTime()-G(P).getTime())/(30.44*864e5));let F=0;for(const z of E)!z.activo||z.simulacion||(F+=at(z).tabla.filter(T=>!T.esAmortizacion&&T.fecha>=P&&T.fecha<=S).reduce((T,R)=>T+R.cuota,0));return{media:F/A,desde:P,hasta:S}}function I(E){const _=t.store.get("personas"),P=Ce(_),S=[...t.store.get("loans")].sort((O,H)=>H.tin-O.tin),A=s?S.filter(O=>Ke(O.repartoConsumo,O.repartoPago,P).has(s)):S,F=new Set(A.filter(f).map(O=>O._id)),z=a?A:A.filter(O=>!F.has(O._id)),T=c(S,new Set(S.filter(f).map(O=>O._id))),R=b(S),D=p(S),L=t.store.get("config"),q=t.store.get("inflacion"),B=new Date(G(e())).toLocaleDateString("es-ES",{month:"long",year:"numeric"});E.innerHTML=`
      <div class="page-header">
      ...
      ${D.length>0?`<div class="card mb-14" style="padding:12px 16px;background:rgba(46,230,168,0.07);border:1px solid rgba(46,230,168,0.25)">
               <div style="display:flex;gap:10px;align-items:flex-start">
                 ...
                 <div style="font-size:13px;color:var(--text)">
                   Este mes se ${D.length===1?"acaba":"acaban"} ${d(v(D.map(O=>O.loan.nombre)))}
                   — te liberará <strong style="color:var(--accent)">${d(j(D.reduce((O,H)=>O+H.cuota,0)))}</strong> de cuotas para el mes que viene.
                 </div>
               </div>
             </div>`:""}
      ${T.total>0||R.media>.01?`<div class="card mb-14" style="padding:14px 18px">
               <div class="flex gap-24 items-center flex-wrap">
                 ...
                 ${R.media>.01?`<div>
                          ...
                          <div style="font-family:var(--font-mono);font-size:24px;font-weight:700;color:var(--text2);margin-top:2px">${d(j(R.media))}<span style="font-size:13px;font-weight:400;color:var(--text3);margin-left:4px">/mes</span></div>
                          <div class="text-sm" style="color:var(--text3);margin-top:2px">${d(R.desde)} → ${d(R.hasta)}</div>
                        </div>`:""}
               </div>
             </div>`:""}
      <div id="loans-list">
        ${z.length===0?'<div class="text-sm" style="text-align:center;padding:40px 0">Sin préstamos.</div>':z.map(O=>Jr(O,{periodos:q,usarInflacion:!!L.usarInflacion,hoy:e(),cuotaMes:T.porLoan.get(O._id)??0,completado:F.has(O._id),nombreEscenario:l,personas:_})).join("")}
      </div>`;for(const O of E.querySelectorAll("[data-body-loan]"))o.has(O.dataset.bodyLoan??"")&&O.classList.add("open")}const w=()=>document.getElementById("modal-overlay"),x=()=>document.getElementById("modal-content"),g=()=>{var E;return(E=w())==null?void 0:E.classList.add("hidden")};function h(E,_){const P=w(),S=x();return!P||!S?null:(S.innerHTML=`<div class="modal-title">${d(E)}</div>${_}`,P.classList.remove("hidden"),N(S,"[data-cancelar]",g),S)}function $(E,_){const P=E?t.store.get("loans").find(A=>A._id===E)??null:null,S=h(E?"Editar préstamo":"Nuevo préstamo",Zr(P,t.store.get("accounts"),r(),t.store.get("personas"),e()));S&&(S.addEventListener("change",A=>{const F=A.target;F!=null&&F.matches("[data-dp-modo]")&&on(S),F!=null&&F.matches('[data-reparto-modo="consumo"]')&&Xt(S,"consumo"),F!=null&&F.matches('[data-reparto-modo="pago"]')&&Xt(S,"pago")}),N(S,"[data-guardar-loan]",A=>{m(S,A.getAttribute("data-guardar-loan")||"")&&(g(),_())}))}function m(E,_){const P=D=>{var L;return((L=E.querySelector(D))==null?void 0:L.value)??""},S=D=>{var L;return!!((L=E.querySelector(D))!=null&&L.checked)},A=P("#f-nombre").trim(),F=parseFloat(P("#f-capital")),z=parseFloat(P("#f-tin")),T=parseInt(P("#f-meses"),10);if(!A||!Number.isFinite(F)||!Number.isFinite(z)||!Number.isFinite(T))return k("Completa los campos obligatorios","err"),!1;const R={nombre:A,capital:F,tin:z,meses:T,fechaInicio:P("#f-fecha"),comisionApertura:parseFloat(P("#f-com-ap"))||0,comisionAmort:parseFloat(P("#f-com-am"))||0,diaPago:nn(E),cuenta:P("#f-cuenta"),simulacion:S("#f-sim"),activo:S("#f-activo"),mostrarFechaFinEnDashboard:S("#f-mostrar-fin"),tipoTasa:P("#f-tipo-tasa"),basico:S("#f-basico"),tags:P("#f-tags").split(",").map(D=>D.trim()).filter(Boolean),escenarioIds:[...E.querySelectorAll(".loan-escenario:checked")].map(D=>D.value),repartoConsumo:Zt(E,"consumo"),repartoPago:Zt(E,"pago")};return _?(t.store.updateItem("loans",_,R),k("Préstamo actualizado")):(t.store.addItem("loans",{...R,amortizaciones:[]}),k("Préstamo creado")),i(),!0}function y(E,_,P){const S=t.store.get("loans").find(z=>z._id===E);if(!S)return;const A=_?(S.amortizaciones||[]).find(z=>z._id===_)??null:null,F=h(_?"Editar amortización":"Añadir amortización",tl(E,A,r(),e()));F&&N(F,"[data-guardar-amort]",z=>{const[T,R]=(z.getAttribute("data-guardar-amort")||"").split("|");C(F,T,R)&&(g(),P([T]))})}function C(E,_,P){var L;const S=q=>{var B;return((B=E.querySelector(q))==null?void 0:B.value)??""},A=S("#am-fecha"),F=parseFloat(S("#am-cant"));if(!A||!Number.isFinite(F)||F<=0)return k("Fecha y cantidad requeridas","err"),!1;const z=t.store.get("loans").find(q=>q._id===_);if(!z)return!1;const T={fecha:A,cantidad:F,tipo:S("#am-tipo"),simulacion:!!((L=E.querySelector("#am-sim"))!=null&&L.checked),escenarioIds:[...E.querySelectorAll(".amort-escenario:checked")].map(q=>q.value)},R=z.amortizaciones||[],D=P?R.map(q=>q._id===P?{...q,...T}:q):[...R,{_id:Date.now().toString(36),...T}];return t.store.updateItem("loans",_,{amortizaciones:D}),k(P?"Amortización actualizada":"Amortización añadida"),i(),!0}function M(E,_,P){N(E,"[data-toggle-finalizados]",()=>{a=!a,_()}),N(E,"[data-persona-tab]",S=>{s=S.getAttribute("data-persona-tab")||null,_()}),N(E,"[data-nuevo-loan]",()=>$(null,_)),N(E,"[data-optimizar]",()=>P.abrir()),N(E,"[data-toggle-loan]",(S,A)=>{var R;if((R=A.target)!=null&&R.closest("button"))return;const F=S.getAttribute("data-toggle-loan"),z=[...E.querySelectorAll("[data-body-loan]")].find(D=>D.dataset.bodyLoan===F);(z==null?void 0:z.classList.toggle("open"))?o.add(F):o.delete(F)}),N(E,"[data-editar-loan]",S=>$(S.getAttribute("data-editar-loan"),_)),N(E,"[data-borrar-loan]",S=>{if(!tt("¿Eliminar préstamo?"))return;const A=S.getAttribute("data-borrar-loan");t.store.removeItem("loans",A),o.delete(A),k("Eliminado"),i(),_()}),N(E,"[data-amort-loan]",S=>{const A=S.getAttribute("data-amort-loan");o.add(A),y(A,null,_)}),N(E,"[data-editar-amort]",S=>{const[A,F]=(S.getAttribute("data-editar-amort")||"").split("|");o.add(A),y(A,F,_)}),N(E,"[data-borrar-amort]",S=>{const[A,F]=(S.getAttribute("data-borrar-amort")||"").split("|"),z=t.store.get("loans").find(T=>T._id===A);z&&(t.store.updateItem("loans",A,{amortizaciones:(z.amortizaciones||[]).filter(T=>T._id!==F)}),k("Amortización eliminada"),i(),_([A]))})}return{id:"loans",route:"loans",nombre:"Préstamos",flagId:"loans",seccion:1,iconoPath:al,mount(E){const _=(P=[])=>{for(const S of P)o.add(S);I(E)};n??(n=el({loans:()=>t.store.get("loans"),expenses:()=>t.store.get("expenses"),accounts:()=>t.store.get("accounts"),nominas:()=>t.store.get("nominas"),config:()=>t.store.get("config"),guardarAmortizaciones:(P,S)=>{t.store.updateItem("loans",P,{amortizaciones:S}),i()},hoy:e,refrescar:_})),I(E),E.dataset.wired!=="1"&&(M(E,_,n),E.dataset.wired="1")}}}const nl={transporte:125,restaurante:220,otros:null},sl={transporte:"Transporte",restaurante:"Restaurante",otros:"Otros"},il=["Enero","Febrero","Marzo","Abril","Mayo","Junio","Julio","Agosto","Septiembre","Octubre","Noviembre","Diciembre"],ee=(t,e,a,o,n="")=>`<div class="form-group"><label class="form-label">${d(e)}</label>
   <input class="form-input" type="${a}" id="${t}" value="${d(o)}" placeholder="${d(n)}"/></div>`,rl=(t,e)=>t.filter(a=>a.activo!==!1).map(a=>`<option value="${d(a._id)}"${a._id===e?" selected":""}>${d(a.nombre)}</option>`).join("");function ll(t,e){const a=t.map((s,i)=>{const r=e.find(f=>f._id===s.cuenta),l=nl[s.tipo],u=l!=null&&s.importe>l;return`<div class="flex gap-8 items-center" style="padding:5px 0;border-bottom:1px solid var(--border)">
    ...
    <div style="margin-top:8px;display:grid;grid-template-columns:1fr 1fr;gap:4px">
      ...
      <div class="flex gap-8 mt-16" style="justify-content:flex-end">
      ...
      </div>`);b&&(N(b,"[data-editar-tabla]",I=>{const w=I.getAttribute("data-editar-tabla");c(w==="default"?"default":Number(w))}),N(b,"[data-borrar-tabla]",I=>{const w=Number(I.getAttribute("data-borrar-tabla"));tt(`¿Eliminar la tabla del ejercicio ${w}?`)&&(t.store.set("tramosIRPFHistorico",t.store.get("tramosIRPFHistorico").filter(x=>x.año!==w)),k(`Tabla ${w} eliminada`),t.onDatosCambiados(),l())}),N(b,"[data-anadir-anyo]",()=>{var x;const I=parseInt(((x=b.querySelector("#irpf-new-year"))==null?void 0:x.value)??"",10);if(!I||I<2e3||I>2100)return k("Año inválido","err");const w=t.store.get("tramosIRPFHistorico");if(w.some(g=>g.año===I))return k("Ya existe una tabla para ese año","err");t.store.set("tramosIRPFHistorico",[...w,{_id:Date.now().toString(36),año:I,tramos:i().map(g=>[...g])}]),t.onDatosCambiados(),c(I)}))}function u(){return a.map(([p,v],b)=>`<div class="grid-2 mt-8">
        ...
        </div>`).join("")}function f(p){a=[...p.querySelectorAll("[data-tr-min]")].map((b,I)=>{const w=p.querySelector(`[data-tr-pct="${I}"]`);return[parseFloat(b.value)||0,parseFloat((w==null?void 0:w.value)??"")||0]})}function c(p){var g;e=p;const v=t.store.get("tramosIRPFHistorico");a=(p==="default"?i():((g=v.find(h=>h.año===p))==null?void 0:g.tramos)??i()).map(h=>[...h]);const I=p==="default"?"tabla por defecto":`ejercicio ${p}`,w=r(`Tramos IRPF — ${p==="default"?"Por defecto":p}`,`
      ...
      </div>`);if(!w)return;const x=()=>{const h=w.querySelector("#irpf-tramos-rows");h&&(h.innerHTML=u())};N(w,"[data-volver]",l),N(w,"[data-tr-anadir]",()=>{f(w),a.push([0,0]),x()}),N(w,"[data-tr-borrar]",h=>{f(w),a.splice(Number(h.getAttribute("data-tr-borrar")),1),x()}),N(w,"[data-tr-guardar]",()=>{f(w);const h=[...a].sort(($,m)=>$[0]-m[0]);if(h.length===0)return k("Añade al menos un tramo","err");e==="default"?(t.store.patchConfig({tramos_irpf:h}),k("Tabla por defecto guardada")):(t.store.set("tramosIRPFHistorico",t.store.get("tramosIRPFHistorico").map($=>$.año===e?{...$,tramos:h}:$)),k(`Tabla ${e} guardada`)),t.onDatosCambiados(),l()})}return{abrir:l}}const fn=1500,Lt=(t,e,a,o,n="")=>`<div class="form-group"><label class="form-label">${d(e)}</label>
   ...
   <select class="form-select" id="${t}">
    ...
    <div class="flex gap-8 mt-16" style="justify-content:flex-end">
    ...
    </div>`}function s(){const g=t.store.get("config");return yt(t.store.get("tramosIRPFHistorico"),g.tramos_irpf??ht)(Number(e().slice(0,4)))}function i(g,h,$){const m=aa(g,h,$),y=!!h&&g.irpfModo!=="manual",C=wa(g.repartoConsumo,g.repartoPago,t.store.get("personas")),M=[g.mesActualizacionIPC?`<span class="badge badge-blue" title="Actualización IPC en el mes ${g.mesActualizacionIPC}">IPC m${g.mesActualizacionIPC}</span>`:"",m.flexAnual>0?`<span class="badge" style="background:rgba(99,214,160,0.12);color:#63d6a0" title="Retribución flexible exenta de IRPF y SS">RF ${d(j(m.flexAnual))}/año</span>`:"",Math.abs(m.ssPct-6.35)>.01?`<span class="badge" style="background:rgba(255,200,80,0.12);color:var(--yellow)" title="Cotización SS del empleado personalizada">SS ${m.ssPct.toFixed(2)}%</span>`:"",C?`<span class="badge" style="background:rgba(139,92,246,0.12);color:#a78bfa" title="${d(C)}">👥 reparto</span>`:""].join("");return`<div class="exp-table-row">
      <div>
    ...
    </div>`}const r=g=>{var h;return((h=t.store.get("accounts").find($=>$._id===(g||"default")))==null?void 0:h.nombre)??(g||"default")};function l(g,h,$){const m=h.reduce((M,E)=>M+(E.bruto||0),0),y=is(h,$),C=m>0?y/m*100:0;return`<div style="margin-bottom:16px">
      <div class="exp-table-head" style="background:var(--surface2);padding:8px 12px;border-radius:var(--radius) var(--radius) 0 0;flex-wrap:wrap;gap:6px">
        ...
        <span class="text-sm" style="color:var(--red)">IRPF efectivo: <strong>${C.toFixed(1)}%</strong> (${d(j(y))}/año)</span>
      </div>
      <div class="card" style="padding:0;overflow:hidden;border-radius:0 0 var(--radius) var(--radius)">
        ${h.map(M=>i(M,h,$)).join("")}
      </div>
    </div>`}function u(g){const h=s(),$=t.store.get("personas"),m=Ce($),y=[...t.store.get("nominas")].sort((S,A)=>(A.bruto||0)-(S.bruto||0)),C=o?y.filter(S=>Ke(S.repartoConsumo,S.repartoPago,m).has(o)):y,{grupos:M,sueltas:E}=ls(C),_=t.store.get("accounts").filter(fl),P=y.filter(S=>S.activo!==!1);g.innerHTML=`
      <div class="page-header">
      ...
      ${[...M.entries()].map(([S,A])=>l(S,A,h)).join("")}
    ...
    <div style="font-size:10px;color:var(--text3);margin-top:4px">
      ...
      · ${d(t.impuestoRetirada??0)}% sobre beneficio al retirar · ${e.numAportaciones} aportaciones
         ...
         <div style="border-top:1px solid var(--border);margin-top:6px;padding-top:6px">
           ...
           <div class="stat-card"><div class="stat-label">Neto actual</div><div class="stat-value pos">${d(j(a.neto))}</div><div class="stat-sub">${d(w)}% plusvalía</div></div>
    ...
    <div class="flex gap-8 mt-12" style="justify-content:flex-end">
    ...
    </div>`}const gn=t=>t.slice(0,3).map(([,e])=>`${e}%`).join(" · ")+(t.length>3?" …":"");function Ol(t){let e=null,a=[];const o=()=>document.getElementById("modal-overlay"),n=()=>document.getElementById("modal-content"),s=()=>{var p;return(p=o())==null?void 0:p.classList.add("hidden")},i=()=>t.store.get("config").tramosGananciasCapital??Pt;function r(p,v){const b=o(),I=n();return!b||!I?null:(I.innerHTML=`<div class="modal-title">${d(p)}</div>${v}`,b.classList.remove("hidden"),N(I,"[data-cerrar]",s),I)}function l(){e=null;const p=[...t.store.get("tramosGananciasCapitalHistorico")].sort((I,w)=>I.año-w.año),v="display:grid;grid-template-columns:90px 1fr auto;gap:0;padding:10px 12px;border-top:1px solid var(--border);align-items:center",b=r("Tramos — Ganancias de capital",`
      <div class="text-sm mb-12" style="color:var(--text2)">
      ...
      <div class="flex gap-8 mt-16" style="justify-content:flex-end">
        <button class="btn-secondary" data-cerrar>Cerrar</button>
      </div>`);b&&(N(b,"[data-editar-tg]",I=>{const w=I.getAttribute("data-editar-tg");c(w==="default"?"default":Number(w))}),N(b,"[data-borrar-tg]",I=>{const w=Number(I.getAttribute("data-borrar-tg"));tt(`¿Eliminar la tabla del ejercicio ${w}?`)&&(t.store.set("tramosGananciasCapitalHistorico",t.store.get("tramosGananciasCapitalHistorico").filter(x=>x.año!==w)),k(`Tabla ${w} eliminada`),t.onDatosCambiados(),l())}),N(b,"[data-anadir-anyo-tg]",()=>{var x;const I=parseInt(((x=b.querySelector("#tg-new-year"))==null?void 0:x.value)??"",10);if(!I||I<2e3||I>2100)return k("Año inválido","err");const w=t.store.get("tramosGananciasCapitalHistorico");if(w.some(g=>g.año===I))return k("Ya existe una tabla para ese año","err");t.store.set("tramosGananciasCapitalHistorico",[...w,{_id:Date.now().toString(36),año:I,tramos:i().map(g=>[...g])}]),t.onDatosCambiados(),c(I)}))}function u(){return a.map(([p,v],b)=>`<div class="grid-2 mt-8">
      ...
      </div>`);if(!I)return;const w=()=>{const g=I.querySelector("#tg-rows");g&&(g.innerHTML=u())};N(I,"[data-volver-tg]",l),N(I,"[data-tg-anadir]",()=>{f(I),a.push([0,0]),w()}),N(I,"[data-tg-borrar]",g=>{f(I),a.splice(Number(g.getAttribute("data-tg-borrar")),1),w()}),N(I,"[data-tg-guardar]",()=>{f(I);const g=[...a].sort((h,$)=>h[0]-$[0]);if(g.length===0)return k("Añade al menos un tramo","err");e==="default"?(t.store.patchConfig({tramosGananciasCapital:g}),k("Tabla por defecto guardada")):(t.store.set("tramosGananciasCapitalHistorico",t.store.get("tramosGananciasCapitalHistorico").map(h=>h.año===e?{...h,tramos:g}:h)),k(`Tabla ${e} guardada`)),t.onDatosCambiados(),l()})}return{abrir:l}}function ql(t){function e(){if(t.navegar)return t.navegar("planner");const s=globalThis.Router;s==null||s.navigate("planner")}function a(s,i,r){const l=Va(s,i,r),u=s.targetAmount||0,f=u>0?Math.min(100,l/u*100):0;return`
      ...
      </div>`}function n(s,i){N(s,"[data-ir-planner]",()=>e()),N(s,"[data-descartar-goals]",()=>{const r=t.store.get("goals").length;if(tt(`Se van a borrar ${r} objetivo${r!==1?"s":""} de ahorro antiguos. ¿Seguro?`)){for(const l of[...t.store.get("goals")])t.store.removeItem("goals",l._id);k("Objetivos antiguos descartados"),t.onDatosCambiados(),i()}})}return{render:o,wire:n}}const Ll="M11.8 10.9c-2.27-.59-3-1.2-3-2.15 0-1.09 1.01-1.85 2.7-1.85 1.78 0 2.44.85 2.5 2.1h2.21c-.07-1.72-1.12-3.3-3.21-3.81V3h-3v2.16c-1.94.42-3.5 1.68-3.5 3.61 0 2.31 1.91 3.46 4.7 4.13 2.5.6 3 1.48 3 2.41 0 .69-.49 1.79-2.7 1.79-2.06 0-2.87-.92-2.98-2.1h-2.2c.12 2.19 1.76 3.42 3.68 3.83V21h3v-2.15c1.95-.37 3.5-1.5 3.5-3.55 0-2.84-2.43-3.81-4.7-4.4z",kl=120;function Bl(t){const e=t.hoy??J,a=()=>{var S;return(S=t.onDatosCambiados)==null?void 0:S.call(t)},o=t.mostrarObjetivos??(()=>!0),n=new Map,s=()=>t.store.get("config"),i=()=>t.store.get("escenarios"),r=S=>{var A;return((A=i().find(F=>F._id===S))==null?void 0:A.nombre)??S},l=S=>{var A;return((A=t.store.get("accounts").find(F=>F._id===S))==null?void 0:A.nombre)??S},u=()=>yt(t.store.get("tramosIRPFHistorico"),s().tramos_irpf??ht)(Number(e().slice(0,4))),f=()=>yt(t.store.get("tramosGananciasCapitalHistorico"),s().tramosGananciasCapital??Pt),c=()=>f()(Number(e().slice(0,4))),p=S=>mo(t.store.get("expenses"),s(),t.store.get("loans"),S);function v(){const S=s(),A=t.store.get("accounts"),F=ce({loans:[],expenses:t.store.get("expenses").filter(L=>L.tipo==="transferencia"),accounts:A,config:{dashboardStart:S.dashboardStart,dashboardEnd:S.dashboardEnd,fechaReferencia:S.dashboardStart},nominas:[],resolverTramosGanancias:f()}),z=new Map,T=L=>{let q=z.get(L);return q||(q={entradas:[],salidas:[],totalAportaciones:0,totalReembolsos:0,retencion:0},z.set(L,q)),q},R=(L,q)=>{const B=`${q.sourceId}`,O=L.find(Y=>Y.concepto===B),H=O??{concepto:B,contraparte:"",total:0,ocurrencias:0};H.total+=Math.abs(q.cuantia),H.ocurrencias+=1,O||L.push(H)};for(const L of F){if(!L.cuenta)continue;const q=T(L.cuenta);L.sourceType==="transfer-in"||L.sourceType==="traspaso-in"?(q.totalAportaciones+=Math.abs(L.cuantia),R(q.entradas,L)):L.sourceType==="transfer-out"||L.sourceType==="traspaso-out"?(q.totalReembolsos+=Math.abs(L.cuantia),R(q.salidas,L)):L.sourceType==="investment-tax"&&(q.retencion+=Math.abs(L.cuantia))}const D=t.store.get("expenses");for(const L of z.values())for(const[q,B]of[[L.entradas,"cuenta"],[L.salidas,"cuentaDestino"]])for(const O of q){const H=D.find(Y=>Y._id===O.concepto);O.contraparte=l((H==null?void 0:H[B])??"default"),O.concepto=(H==null?void 0:H.concepto)||(B==="cuenta"?"Aportación":"Reembolso")}return z}function b(){const S=new Map,A=s(),F=e(),z=new Date(Number(F.slice(0,4)),Number(F.slice(5,7))-1+kl+1,0),T=`${z.getFullYear()}-${String(z.getMonth()+1).padStart(2,"0")}-${String(z.getDate()).padStart(2,"0")}`;return R=>{const D=S.get(R._id);if(D)return D;const L=ce({loans:t.store.get("loans"),expenses:t.store.get("expenses"),accounts:t.store.get("accounts"),config:{...A,dashboardStart:F,dashboardEnd:T,fechaReferencia:F},filtroAccounts:[R._id],nominas:t.store.get("nominas"),inflacionPeriodos:t.store.get("inflacion"),resolverTramosIRPF:yt(t.store.get("tramosIRPFHistorico"),A.tramos_irpf??ht),resolverTramosGanancias:f()}).map(q=>({fecha:q.fecha,saldoAcum:q.saldoAcum}));return S.set(R._id,L),L}}const I=ql({store:t.store,colchonEnFecha:p,extractoCuenta:S=>w(S),hoy:e,onDatosCambiados:a});let w=b();function x(S){w=b();const F=t.store.get("accounts").filter(D=>vt(D)!=="pension"),z=v(),T={config:s(),inflacion:t.store.get("inflacion"),nominas:t.store.get("nominas"),tramosIRPF:u(),tramosGanancias:c(),nombreEscenario:r,flujos:D=>z.get(D)??Sl,invModo:D=>n.get(D)??"proyeccion"};S.innerHTML=`
      <div class="page-header">
      ...
      ${o()?'<div class="card mt-14" id="goals-section"></div>':""}`;const R=S.querySelector("#goals-section");R&&I.render(R)}const g=()=>document.getElementById("modal-overlay"),h=()=>document.getElementById("modal-content"),$=()=>{var S;return(S=g())==null?void 0:S.classList.add("hidden")};function m(S,A){const F=g(),z=h();return!F||!z?null:(z.innerHTML=S?`<div class="modal-title">${d(S)}</div>${A}`:A,F.classList.remove("hidden"),N(z,"[data-cancelar]",$),z)}function y(S,A){const F=S?t.store.get("accounts").find(D=>D._id===S)??null:null,z=[...(F==null?void 0:F.planAportaciones)??[]].map(D=>({...D})),T=F?C(F):null,R=m(S?"Editar cuenta / fondo":"Nueva cuenta / fondo",Dl(F,{escenarios:i(),nominas:t.store.get("nominas"),hoy:e(),saldoActual:T??0}));R&&(Tl(R,z,e()),N(R,"[data-guardar-acc]",D=>{const L=D.getAttribute("data-guardar-acc")||"",{datos:q,punto:B,error:O}=Nl(R,z,F,T,e());if(O)return k(O,"err");let H=L;L?t.store.updateItem("accounts",L,q):H=t.store.addItem("accounts",q)._id,B&&t.ledger.registrarPuntoControl(H,B.fecha,B.saldo,B.nota),k(L?"Actualizada":"Cuenta / fondo creado"),a(),$(),A()}))}function C(S){const A=t.ledger.puntosControl(S._id);return A.length>0?Ca(A)[0].saldo:S.saldo??null}function M(S,A){const F=t.store.get("accounts").find(R=>R._id===S);if(!F)return;const z=m("Histórico de saldos",Rl(F.nombre,S,Ca(t.ledger.puntosControl(S)),F.saldoInicial||0,e()));if(!z)return;const T=()=>{A(),M(S,A)};N(z,"[data-hist-anadir]",()=>{var q,B,O;const R=((q=z.querySelector("#hi-fecha"))==null?void 0:q.value)??"",D=parseFloat(((B=z.querySelector("#hi-saldo"))==null?void 0:B.value)??""),L=((O=z.querySelector("#hi-nota"))==null?void 0:O.value.trim())??"";if(!R||!Number.isFinite(D))return k("Fecha y saldo requeridos","err");t.ledger.registrarPuntoControl(S,R,D,L||void 0),k("Punto añadido"),a(),T()}),N(z,"[data-hist-borrar]",R=>{const[,D]=(R.getAttribute("data-hist-borrar")||"").split("|");t.ledger.eliminarPuntoControl(D),k("Eliminado"),a(),T()}),N(z,"[data-hist-inicial]",R=>{const[D,L]=(R.getAttribute("data-hist-inicial")||"").split("|"),q=t.ledger.puntosControl(D).find(O=>O._id===L);if(!q)return;const B=Ca([q])[0].saldo;t.store.updateItem("accounts",D,{saldoInicial:B,fechaInicialSaldo:q.fecha}),k(`Punto inicial → ${q.fecha} (${j(B)})`),a(),T()})}function E(S){const A=t.store.get("accounts").filter(T=>T.activo);if(A.length===0)return k("No hay cuentas activas","err");const F=e(),z=A.map(T=>`• ${T.nombre}: ${j(C(T)??T.saldoInicial??0)}`).join(`
`);if(tt(`¿Actualizar el saldo inicial de estas cuentas a su saldo actual (${F})?

${z}

Esto recalibra el punto de arranque del dashboard.`)){for(const T of A)t.store.updateItem("accounts",T._id,{saldoInicial:C(T)??T.saldoInicial??0,fechaInicialSaldo:F});k("Saldo base actualizado"),a(),S()}}function _(S,A,F){N(S,"[data-nueva-acc]",()=>y(null,A)),N(S,"[data-editar-acc]",z=>y(z.getAttribute("data-editar-acc"),A)),N(S,"[data-tramos-ganancias]",()=>F.abrir()),N(S,"[data-reset-base]",()=>E(A)),N(S,"[data-hist-acc]",z=>M(z.getAttribute("data-hist-acc"),A)),N(S,"[data-principal-acc]",z=>{const T=z.getAttribute("data-principal-acc");t.store.set("accounts",t.store.get("accounts").map(R=>({...R,esCuentaPrincipal:R._id===T}))),k("Cuenta marcada como principal"),a(),A()}),N(S,"[data-borrar-acc]",z=>{const T=z.getAttribute("data-borrar-acc");if(t.store.get("accounts").length<=1)return k("Debe existir al menos una cuenta","err");if(!tt("¿Eliminar cuenta?"))return;t.store.removeItem("accounts",T);const D=t.store.get("accounts");D.length>0&&!D.some(L=>L.esCuentaPrincipal)&&t.store.set("accounts",D.map((L,q)=>q===0?{...L,esCuentaPrincipal:!0}:L)),k("Cuenta eliminada"),a(),A()}),N(S,"[data-inv-modo]",z=>{const[T,R]=(z.getAttribute("data-inv-modo")||"").split("|");n.set(T,R==="real"?"real":"proyeccion"),A()}),I.wire(S,A)}let P=null;return{id:"accounts",route:"accounts",nombre:"Cuentas y ahorro",flagId:"accounts",seccion:1,iconoPath:Ll,mount(S){const A=()=>x(S);P??(P=Ol({store:t.store,onDatosCambiados:()=>{a(),A()},año:()=>Number(e().slice(0,4))})),x(S),S.dataset.wired!=="1"&&(_(S,A,P),S.dataset.wired="1")}}}const ot=(t,e,a="var(--text)",o=!1)=>`<tr>
    ...
    </div>`}const yn=[["declaracion","Declaración Renta"],["mobiliario","Capital Mobiliario"],["trabajo","Rendimientos del Trabajo"],["inmobiliario","Capital Inmobiliario"]],Jl="M14 2H6c-1.1 0-2 .9-2 2v16c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V8l-6-6zm4 18H6V4h7v5h5v11zM8 15h8v2H8v-2zm0-4h8v2H8v-2zm0-4h4v2H8V7z";function Wl(t){const e=t.hoy??J;let a="declaracion",o={};const n=()=>t.store.get("config"),s=()=>Number(e().slice(0,4)),i=()=>t.store.get("nominas").filter(g=>g.activo),r=()=>t.store.get("accounts").filter(g=>(g.modeloFondo||"cuenta")==="pension"),l=g=>{var h;return((h=t.store.get("escenarios").find($=>$._id===g))==null?void 0:h.nombre)??g},u=()=>yt(t.store.get("tramosIRPFHistorico"),n().tramos_irpf??ht)(s()),f=()=>yt(t.store.get("tramosGananciasCapitalHistorico"),n().tramosGananciasCapital??Pt)(s());function c(){const g=`${s()}-01-01`,h=t.store.get("nominas").filter(y=>y.activo&&!y.simulacion),$=r().reduce((y,C)=>y+(C.aportaciones||[]).filter(M=>M.fecha>=g).reduce((M,E)=>M+E.cantidad,0),0),m=t.store.get("expenses").filter(y=>y.activo&&y.sujetoIRPF&&y.tipo==="ingreso").reduce((y,C)=>y+Xa(C),0);return to({nominas:h,aportacionesPension:$,otrosIngresos:m,extras:o,tramosGeneral:u(),tramosAhorro:f()})}function p(){const g=u(),h=i(),$=A=>A.grupoNomina?h.filter(F=>(F.grupoNomina||"")===A.grupoNomina):null,m=h.map(A=>aa(A,$(A),g)),y=m.reduce((A,F)=>A+F.brutoAnual,0),C=m.reduce((A,F)=>A+F.irpfAnual,0),M=m.reduce((A,F)=>A+F.ssAnual,0),E=t.store.get("accounts").filter(A=>(A.modeloFondo||"cuenta")==="inversion");let _=0,P=0;for(const A of E){const F=Vt(A,f());F&&(_+=F.plusvalia,P+=F.impuesto)}if(y<=0&&E.length===0)return"";const S=(A,F,z)=>`<div class="exec-item"><div class="exec-item-label">${d(A)}</div><div class="exec-item-val ${z}">${d(F)}</div></div>`;return`<div class="exec-summary mb-14">
      ${y>0?S("IRPF trabajo",`${j(C)}/año`,"neg"):""}
      ${y>0?S("Neto trabajo",`${j(y-M-C)}/año`,"pos"):""}
      ${E.length>0?S("Plusvalía latente",j(_),_>=0?"pos":"neg"):""}
      ${E.length>0?S("Imp. potencial (inversión)",j(P),"neg"):""}
    ...
    ">${d(h)}</button>`}function I(g){const h=g.querySelector("#fisc-tabs"),$=g.querySelector("#fisc-tab-content");h&&(h.innerHTML=yn.map(([m,y])=>b(m,y)).join("")),$&&($.innerHTML=v())}function w(g){g.innerHTML=`
      ...
      <div class="flex gap-12 items-center" style="flex-wrap:wrap;margin-bottom:10px">
        ...
        <div class="flex gap-8">
          ${M?'<button class="btn-secondary btn-sm" data-desactivar-esc>Desactivar</button>':`<button class="btn-primary btn-sm" data-activar-esc="${d(y._id)}">Activar</button>`}
    ...
    </div>`}function f(y){const C=n().dashboardEnd,M=Je(r(null).eventos,C);return`
      ...
      <table style="width:100%;font-size:13px;border-collapse:collapse">
        ...
        <tbody>${y.map(_=>{const{eventos:P}=r(_),S=_.fechaFin||C,A=Je(P,S),F=A!==null&&M!==null?A-M:null;return`<tr>
      ...
      <span style="font-size:12px;color:var(--text3);margin-right:4px">Cuentas:</span>${y.map(M=>{const E=a.has(M._id);return`<button data-toggle-cuenta="${d(M._id)}" style="padding:4px 10px;border-radius:20px;
    ...
    </div>`}function p(){if(o){try{o.destroy()}catch{}o=null}}function v(y){const C=n(),M=r(null),E=[{label:"Base (sin supuesto)",color:"#6b7280",esBase:!0,puntos:Ye(M.eventos,C.dashboardStart,C.dashboardEnd)}];return y.forEach((_,P)=>{const{eventos:S,horizonte:A}=r(_);E.push({label:_.nombre,color:_.color||kt[P%kt.length],puntos:Ye(S,C.dashboardStart,A)})}),E}function b(y,C){p();const M=y.querySelector("#chart-comparacion");M&&(o=Kl(M,v(C)))}function I(y){p();const C=new Set(t.store.get("accounts").map(_=>_._id));for(const _ of[...a])C.has(_)||a.delete(_);const M=s(),E=n().escenarioActivo||null;y.innerHTML=`
      <div class="page-header">
      ...
      ${M.length===0?`<div class="card mb-14" style="padding:20px 24px">
             ...
             <div class="card mt-12" style="padding:14px" id="esc-comparativa">${f(M)}</div>`}`,M.length>0&&b(y,M)}const w=()=>document.getElementById("modal-overlay"),x=()=>document.getElementById("modal-content"),g=()=>{var y;return(y=w())==null?void 0:y.classList.add("hidden")};function h(y,C){const M=y?s().find(S=>S._id===y)??null:null,E=w(),_=x();if(!E||!_)return;const P=(M==null?void 0:M.color)||kt[0];_.innerHTML=`
      ...
      <div class="form-group mt-8">
        ...
        <div style="display:flex;gap:8px;flex-wrap:wrap;margin-top:6px">
          ${kt.map(S=>`<div data-color-esc="${S}" style="width:26px;height:26px;border-radius:50%;background:${S};cursor:pointer;
              border:2px solid ${S===P?"white":"transparent"};transition:border .15s"></div>`).join("")}
        </div>
...
`)}const ae=t=>{const e=typeof t=="number"?t:parseFloat(String(t).replace(",","."));return Number.isFinite(e)?Math.round(e*100):0},Ie=t=>(t/100).toFixed(2),Fn=t=>(t*100).toFixed(2),oe=t=>{const e=parseFloat(String(t).replace(",","."));return Number.isFinite(e)?e/100:0},Gc=[["AHORRO_OBJETIVO","Ahorrar una cantidad"],["AMORTIZAR_DEUDA","Amortizar deuda"],["INVERSION_PERPETUA","Independencia económica"],["APORTACION_FIJA","Aportación periódica"]],Vc=[["CUOTA_POR_FECHA","Cuota para llegar a la fecha"],["ABSORBE_TODO","Se lleva todo lo disponible"],["ABSORBE_RESIDUAL","Recibe lo que sobre"],["FIJO","Importe fijo al mes"]],Uc=[["INMEDIATA","Inmediata"],["MEDIA","Media (con preaviso o penalización)"],["BLOQUEADA_HASTA_JUBILACION","Bloqueada hasta la jubilación"]],Yc=[["NULO","Nulo"],["BAJO","Bajo"],["MEDIO","Medio"],["ALTO","Alto"]],Dn={AHORRO_OBJETIVO:"CUOTA_POR_FECHA",AMORTIZAR_DEUDA:"ABSORBE_TODO",INVERSION_PERPETUA:"ABSORBE_RESIDUAL",APORTACION_FIJA:"FIJO"},lt=(t,e,a,o,n="",s="")=>`<div class="form-group">
    ...
    <div class="flex gap-8 mt-16" style="justify-content:flex-end;flex-wrap:wrap">
      ...
      <div class="card mb-14">
        ...
        <div class="form-group mt-8">
          ...
          <div class="text-sm mt-4" style="color:var(--text3)">
            ...
            quedan <strong id="pl-disponible">${d(j(z*(1-A.pctDisfrute)/100))}</strong>/mes para los objetivos.
          </div>
        </div>
      ...
      </div>`}const v=()=>document.getElementById("modal-overlay"),b=()=>document.getElementById("modal-content"),I=()=>{var A;return(A=v())==null?void 0:A.classList.add("hidden")};function w(A,F){const z=v(),T=b();return!z||!T?null:(T.innerHTML=`<div class="modal-title">${d(A)}</div>${F}`,z.classList.remove("hidden"),T)}function x(A){l({objetivos:A})}function g(A,F){const z=i();if(!z)return;const T=F?z.objetivos.find(B=>B._id===F)??null:null,R=z.objetivos.reduce((B,O)=>Math.max(B,O.prioridad),0)+1,D=w(T?`Editar «${T.nombre}»`:"Nuevo objetivo",Jc(T,z.vehiculos,R));if(!D)return;const L=()=>{var Y;const B=(Y=D.querySelector("#ob-modo"))==null?void 0:Y.value,O=D.querySelector("#ob-modo-ayuda");O&&B&&(O.textContent=Zc[B]);const H=(K,Q)=>{const nt=D.querySelector(K);nt&&(nt.style.display=Q?"block":"none")};H("#ob-bloque-fijo",B==="FIJO"),H("#ob-bloque-residual",B==="ABSORBE_RESIDUAL")};L();const q=()=>{const B=D.querySelector("#ob-capital-derivado");B&&(B.textContent=Kc(D))};q(),U(D,"#ob-modo",L),U(D,"#ob-tipo",()=>{const B=D.querySelector("#ob-tipo").value,O=D.querySelector("#ob-modo");O&&(O.value=Dn[B]);const H=D.querySelector("#ob-bloque-perpetua");H&&(H.style.display=B==="INVERSION_PERPETUA"?"block":"none"),L()}),U(D,'input[name="ob-derivar"]',()=>{var Y;const B=((Y=D.querySelector('input[name="ob-derivar"]:checked'))==null?void 0:Y.value)==="renta",O=D.querySelector("#ob-renta-campos"),H=D.querySelector("#ob-bloque-importe");O&&(O.style.display=B?"block":"none"),H&&(H.style.display=B?"none":"block"),q()}),U(D,"#ob-renta, #ob-swr, #ob-fiscal",q),N(D,"[data-ob-cancelar]",I),N(D,"[data-ob-guardar]",()=>{const B=Wc(D,T,R);if(!B){k("El objetivo necesita un nombre","err");return}if(!B.vehiculoId){k("Crea antes un vehículo donde meter el dinero","err");return}const O=z.objetivos.filter(H=>H._id!==B._id);x([...O,B]),I(),k(T?"Objetivo actualizado":`Objetivo «${B.nombre}» creado`),P(A)}),N(D,"[data-ob-borrar]",()=>{T&&tt(`¿Borrar «${T.nombre}»? Esto no se puede deshacer.`)&&(x(z.objetivos.filter(B=>B._id!==T._id)),I(),k("Objetivo borrado"),P(A))})}function h(A,F){const z=i();if(!z)return;const T=F?z.vehiculos.find(q=>q._id===F)??null:null,R=t.store.get("accounts").filter(q=>q.activo).map(q=>({_id:q._id,nombre:q.nombre})),D=t.store.get("loans").filter(q=>q.activo&&!q.simulacion).map(q=>({_id:q._id,nombre:q.nombre,tin:q.tin})),L=w(T?`Editar «${T.nombre}»`:"Nuevo vehículo",Qc(T,R,D));L&&(U(L,"#ve-deuda",()=>{const q=L.querySelector("#ve-deuda").checked,B=L.querySelector("#ve-bloque-prestamo");B&&(B.style.display=q?"block":"none")}),U(L,"#ve-prestamo",()=>{const q=L.querySelector("#ve-prestamo").value,B=D.find(Y=>Y._id===q);if(!B)return;const O=L.querySelector("#ve-rent"),H=L.querySelector("#ve-nombre");O&&(O.value=String(B.tin)),H&&!H.value.trim()&&(H.value=`Amortizar ${B.nombre}`)}),N(L,"[data-ve-cancelar]",I),N(L,"[data-ve-guardar]",()=>{const q=Xc(L,T);if(!q){k("El vehículo necesita un nombre","err");return}const B=z.vehiculos.filter(O=>O._id!==q._id);l({vehiculos:[...B,q]}),I(),k(T?"Vehículo actualizado":`Vehículo «${q.nombre}» creado`),P(A)}),N(L,"[data-ve-borrar]",()=>{if(!T)return;const q=z.objetivos.filter(B=>B.vehiculoId===T._id);if(q.length>0){k(`No se puede borrar: lo usan ${q.length} objetivo${q.length!==1?"s":""}`,"err");return}tt(`¿Borrar el vehículo «${T.nombre}»?`)&&(l({vehiculos:z.vehiculos.filter(B=>B._id!==T._id)}),I(),k("Vehículo borrado"),P(A))}))}function $(A,F,z){const T=i();if(!T||F===z)return;const R=[...T.objetivos].sort((B,O)=>B.prioridad-O.prioridad),D=R.findIndex(B=>B._id===F),L=R.findIndex(B=>B._id===z);if(D<0||L<0)return;const[q]=R.splice(D,1);R.splice(L,0,q),x(R.map((B,O)=>({...B,prioridad:O+1}))),P(A)}function m(A){return A.vehiculos.length===0?`<div class="card mb-14" style="padding:12px 16px;background:rgba(255,209,102,0.06);border-color:rgba(255,209,102,0.28)">
        <div class="text-sm" style="color:var(--text2);line-height:1.7">
      ...
      <div style="display:flex;gap:8px;flex-wrap:wrap">
        ${A.vehiculos.map(F=>{const z=A.objetivos.filter(T=>T.vehiculoId===F._id).length;return`<button class="btn-secondary btn-sm" data-pl-editar-vehiculo="${d(F._id)}"
    ...
    </div>`}function y(A,F,z){const T=i(),R=fc(F);if(!T||!R)return;const D=z?T.eventos.find(O=>O._id===z)??null:null,L={};R.id==="hijo"&&(L.actuales=T.perfil.gastosFijosMensuales),R.id==="subida-sueldo"&&(L.actual=T.perfil.netoMensual);const q=w(D?`Editar evento · ${R.nombre}`:R.nombre,Ic(R,D,T,L));if(!q)return;const B=()=>{const O=q.querySelector("#ev-resultado");O&&(O.textContent=Ac(R,jn(q,R)))};B();for(const O of R.campos)U(q,`#ev-${O.id}`,B);N(q,"[data-ev-cancelar]",I),N(q,"[data-ev-guardar]",()=>{var K,Q;const O=((K=q.querySelector("#ev-fecha"))==null?void 0:K.value)??"";if(!O){k("El evento necesita un mes","err");return}const H=jn(q,R),Y={_id:(D==null?void 0:D._id)??`ev_${Date.now().toString(36)}${Math.random().toString(36).slice(2,6)}`,fecha:O,tipo:R.tipo,importe:R.calcular(H),objetivoDestinoId:((Q=q.querySelector("#ev-destino"))==null?void 0:Q.value)||null,notas:R.resumir(H)};l({eventos:[...T.eventos.filter(nt=>nt._id!==Y._id),Y]}),I(),k(D?"Evento actualizado":"Evento añadido"),P(A)}),N(q,"[data-ev-borrar]",()=>{!D||!tt("¿Borrar este evento?")||(l({eventos:T.eventos.filter(O=>O._id!==D._id)}),I(),k("Evento borrado"),P(A))})}function C(A){var F;switch(A.tipo){case"CAMBIO_GASTOS_FIJOS":return"hijo";case"CAMBIO_INGRESOS":return"subida-sueldo";case"NUEVA_DEUDA":return"nueva-hipoteca";case"INYECCION_CAPITAL":return(F=A.notas)!=null&&F.includes("hipoteca")?"venta-vivienda":"inyeccion"}}function M(){const A=i();if(!A)return;const F=new Blob([JSON.stringify(A,null,2)],{type:"application/json"}),z=URL.createObjectURL(F),T=document.createElement("a");T.href=z,T.download=`plan-${A.nombre.replace(/[^\w-]+/g,"_")}-${e()}.json`,T.click(),URL.revokeObjectURL(z),k("Plan exportado")}function E(A){const F=document.createElement("input");F.type="file",F.accept="application/json,.json",F.addEventListener("change",async()=>{var T,R;const z=(T=F.files)==null?void 0:T[0];if(z)try{const D=JSON.parse(await z.text());if(!D||!Array.isArray(D.objetivos)||!Array.isArray(D.vehiculos)||!D.perfil){k("Ese fichero no es un plan de objetivos","err");return}const L=`${D.nombre??"Importado"} (importado)`,q=t.store.addItem("planes",{...D,nombre:L,activo:!1,creadoEn:e()});s=null,o=null,(R=t.onDatosCambiados)==null||R.call(t),k(`Plan «${q.nombre}» importado`),P(A)}catch(D){console.error("[Planner] Importación fallida:",D),k("No se ha podido leer el fichero","err")}}),F.click()}function _(A,F){switch(a){case"config":return c(A);case"objetivos":return pc(A,F);case"simulacion":return Rc(A,F,n);case"eventos":return xc(A);case"escenarios":return Pc(t.store.get("planes"),A._id,o)}}function P(A){const F=r(),z=f(F),T=(D,L)=>`<button class="period-btn ${a===D?"active":""}" data-pl-tab="${D}">${L}</button>`,R=z.viable?'<span class="badge badge-green">Plan viable</span>':'<span class="badge badge-red">No cabe en el flujo</span>';if(A.innerHTML=`
      <div class="page-header">
      ...
      <div id="pl-cuerpo">${_(F,z)}</div>`,a==="simulacion"){const D=A.querySelector("#pl-chart");D&&cc(D,F,z)}S(A)}function S(A){N(A,"[data-pl-tab]",z=>{a=z.dataset.plTab,P(A)}),U(A,"#pl-disfrute",z=>{const T=Number(z.value)/100,R=A.querySelector("#pl-pct-val");R&&(R.textContent=`${Math.round(T*100)} %`);const D=i();if(!D)return;const L=Math.max(0,D.perfil.netoMensual-D.perfil.gastosFijosMensuales)*(1-T),q=A.querySelector("#pl-disponible");q&&(q.textContent=j(L/100))}),N(A,"[data-pl-usar-sugerido]",()=>{const z=u(),T=A.querySelector("#pl-neto"),R=A.querySelector("#pl-gastos");T&&(T.value=Le(z.neto)),R&&(R.value=Le(z.gastos))}),N(A,"[data-pl-guardar]",()=>{const z=T=>{var R;return((R=A.querySelector(T))==null?void 0:R.value)??""};l({perfil:{netoMensual:Tn(z("#pl-neto")),gastosFijosMensuales:Tn(z("#pl-gastos")),manual:!0},pctDisfrute:Math.min(1,Math.max(0,Number(z("#pl-disfrute"))/100)),fechaInicio:z("#pl-inicio")||e().slice(0,7),horizonteMeses:Math.min(600,Math.max(1,Number(z("#pl-horizonte"))||480))}),k("Plan guardado"),P(A)}),N(A,"[data-pl-plantilla]",z=>y(A,z.dataset.plPlantilla??"",null)),N(A,"[data-pl-editar-evento]",z=>{var D;const T=z.dataset.plEditarEvento??"",R=(D=i())==null?void 0:D.eventos.find(L=>L._id===T);R&&y(A,C(R),T)}),N(A,"[data-pl-duplicar]",()=>{var D;const z=i();if(!z)return;const T=window.prompt("Nombre del plan nuevo:",`${z.nombre} (copia)`);if(!(T!=null&&T.trim()))return;const R=gc(z,T.trim(),`plan_${Date.now().toString(36)}`,e());t.store.addItem("planes",R),(D=t.onDatosCambiados)==null||D.call(t),k(`Plan «${R.nombre}» creado. Actívalo para editarlo.`),P(A)}),N(A,"[data-pl-activar]",z=>{var R;const T=z.dataset.plActivar;if(T){for(const D of t.store.get("planes"))t.store.updateItem("planes",D._id,{activo:D._id===T});s=null,o=null,(R=t.onDatosCambiados)==null||R.call(t),k("Plan activo cambiado"),P(A)}}),N(A,"[data-pl-renombrar]",z=>{var L;const T=z.dataset.plRenombrar,R=t.store.get("planes").find(q=>q._id===T);if(!R)return;const D=window.prompt("Nuevo nombre:",R.nombre);D!=null&&D.trim()&&(t.store.updateItem("planes",R._id,{nombre:D.trim()}),(L=t.onDatosCambiados)==null||L.call(t),P(A))}),N(A,"[data-pl-borrar-plan]",z=>{var L;const T=z.dataset.plBorrarPlan,R=t.store.get("planes").find(q=>q._id===T);if(!R||!tt(`¿Borrar el plan «${R.nombre}» con sus ${R.objetivos.length} objetivos? No se puede deshacer.`))return;t.store.removeItem("planes",R._id);const D=t.store.get("planes");R.activo&&D.length>0&&t.store.updateItem("planes",D[0]._id,{activo:!0}),s=null,o=null,(L=t.onDatosCambiados)==null||L.call(t),k("Plan borrado"),P(A)}),N(A,"[data-pl-sensibilidad]",()=>{const z=i();z&&(o=jc(z),P(A))}),N(A,"[data-pl-pagina]",z=>{n=Number(z.dataset.plPagina)||0,P(A)}),N(A,"[data-pl-exportar]",M),N(A,"[data-pl-importar]",()=>E(A)),N(A,"[data-pl-nuevo-objetivo]",()=>g(A,null)),N(A,"[data-pl-nuevo-vehiculo]",()=>h(A,null)),N(A,"[data-pl-editar-vehiculo]",z=>h(A,z.dataset.plEditarVehiculo??null)),N(A,"[data-pl-editar-objetivo]",z=>g(A,z.dataset.plEditarObjetivo??null));let F=null;A.querySelectorAll("[data-pl-objetivo]").forEach(z=>{z.addEventListener("dragstart",()=>{F=z.dataset.plObjetivo??null,z.style.opacity="0.45"}),z.addEventListener("dragend",()=>{z.style.opacity="",A.querySelectorAll("[data-pl-objetivo]").forEach(T=>T.style.borderTop="")}),z.addEventListener("dragover",T=>{T.preventDefault(),F&&z.dataset.plObjetivo!==F&&(z.style.borderTop="2px solid var(--accent)")}),z.addEventListener("dragleave",()=>{z.style.borderTop=""}),z.addEventListener("drop",T=>{T.preventDefault(),z.style.borderTop="";const R=z.dataset.plObjetivo;F&&R&&$(A,F,R),F=null})}),N(A,"[data-pl-csv]",()=>{const z=i();if(!z||!s)return;const T=new Blob(["\uFEFF"+Hc(z,s)],{type:"text/csv;charset=utf-8"}),R=URL.createObjectURL(T),D=document.createElement("a");D.href=R,D.download=`plan-${z.nombre.replace(/[^\w-]+/g,"_")}-${e()}.csv`,D.click(),URL.revokeObjectURL(R),k(`CSV exportado (${s.serieMensual.length} meses)`)}),N(A,"[data-pl-guardar-notas]",()=>{var z;l({notas:((z=A.querySelector("#pl-notas"))==null?void 0:z.value)??""}),k("Notas guardadas")})}return{id:"planner",route:"planner",nombre:"Objetivos financieros",seccion:2,iconoPath:td,mount:P}}function Nn(t,e,a=!1){const o=Math.abs(mt(e));return t==="ingreso"?o:t==="gasto"||a?-o:o}function ad(t){function e(h){return`${h}_${Date.now().toString(36)}${Math.random().toString(36).slice(2,7)}`}function a(h={}){var m;const $=(m=h.texto)==null?void 0:m.trim().toLowerCase();return t.get("transacciones").filter(y=>!(h.cuentaId&&y.cuentaId!==h.cuentaId||h.desde&&y.fecha<h.desde||h.hasta&&y.fecha>h.hasta||h.tipo&&y.tipo!==h.tipo||h.estimacionId&&y.estimacionId!==h.estimacionId||h.tags&&h.tags.length>0&&!h.tags.some(C=>y.tags.includes(C))||$&&!y.concepto.toLowerCase().includes($))).sort((y,C)=>y.fecha.localeCompare(C.fecha)||y._id.localeCompare(C._id))}function o(h){const $={_id:e("tx"),fecha:h.fecha,cuentaId:h.cuentaId,importeCts:Nn(h.tipo,h.importe,h.negativo),concepto:h.concepto,tags:h.tags??[],estimacionId:h.estimacionId??null,tipo:h.tipo,origen:h.origen??"manual",...h.nota?{nota:h.nota}:{}};return t.set("transacciones",[...t.get("transacciones"),$]),$}function n(h,$){t.set("transacciones",t.get("transacciones").map(m=>{if(m._id!==h)return m;const{importe:y,...C}=$,M={...m,...C};return y!==void 0&&(M.importeCts=Nn(M.tipo,y,M.importeCts<0)),M}))}function s(h){t.set("transacciones",t.get("transacciones").filter($=>$._id!==h))}function i(h,$){n(h,{estimacionId:$})}function r(h){return t.get("puntosControl").filter($=>!h||$.cuentaId===h).sort(($,m)=>$.fecha.localeCompare(m.fecha))}function l(h,$,m,y){const C={_id:e("pc"),fecha:$,cuentaId:h,saldoCts:mt(m),...y?{nota:y}:{}},M=t.get("puntosControl").filter(E=>!(E.cuentaId===h&&E.fecha===$));return t.set("puntosControl",[...M,C].sort((E,_)=>E.fecha.localeCompare(_.fecha))),f(h),C}function u(h){const $=t.get("puntosControl").find(m=>m._id===h);t.set("puntosControl",t.get("puntosControl").filter(m=>m._id!==h)),$&&f($.cuentaId)}function f(h){const $=r(h),m=t.get("accounts");m.some(y=>y._id===h)&&t.set("accounts",m.map(y=>y._id===h?{...y,historicoSaldos:$.map(C=>({_id:C._id,fecha:C.fecha,saldo:X(C.saldoCts),...C.nota?{nota:C.nota}:{}}))}:y))}function c(h,$=J()){const m=r(h).filter(E=>E.fecha<=$).pop(),y=m==null?void 0:m.fecha,C=(m==null?void 0:m.saldoCts)??0;return t.get("transacciones").filter(E=>E.cuentaId===h&&E.fecha<=$&&(y===void 0||E.fecha>y)).reduce((E,_)=>E+_.importeCts,C)}function p(h,$){return X(c(h,$))}function v(h=J(),$){const m=$??t.get("accounts").filter(y=>y.activo).map(y=>y._id);return X(m.reduce((y,C)=>y+c(C,h),0))}function b(){return t.get("transacciones").length>0||t.get("puntosControl").length>0}function I(){const h=[...t.get("transacciones").map($=>$.fecha),...t.get("puntosControl").map($=>$.fecha)];return h.length>0?h.sort().pop()??null:null}function w(h={}){return X(a(h).reduce(($,m)=>$+m.importeCts,0))}function x(h={}){const $=new Map;for(const m of a(h)){const y=m.fecha.slice(0,7);$.set(y,($.get(y)??0)+m.importeCts)}return new Map([...$.entries()].sort(([m],[y])=>m.localeCompare(y)).map(([m,y])=>[m,X(y)]))}function g(h={}){const $=new Map;for(const m of a(h))for(const y of m.tags.length>0?m.tags:["sin_tag"])$.set(y,($.get(y)??0)+m.importeCts);return new Map([...$.entries()].map(([m,y])=>[m,X(y)]))}return{transacciones:a,registrar:o,actualizar:n,eliminar:s,asignarEstimacion:i,puntosControl:r,registrarPuntoControl:l,eliminarPuntoControl:u,saldoCuenta:p,saldoCuentaCts:c,saldoTotal:v,tieneDatos:b,ultimaFecha:I,total:w,totalPorMes:x,totalPorTag:g}}function At(t){return t.trim().toLowerCase()}function od(t){function e(){const u=new Map,f=(c,p)=>{const v=At(c);if(!v)return;const b=u.get(v)??{tag:v,estimaciones:0,reales:0,total:0};b[p]+=1,b.total+=1,u.set(v,b)};for(const c of t.get("expenses"))for(const p of c.tags??[])f(p,"estimaciones");for(const c of t.get("transacciones"))for(const p of c.tags??[])f(p,"reales");return[...u.values()].sort((c,p)=>p.total-c.total||c.tag.localeCompare(p.tag))}function a(){return e().map(u=>u.tag)}function o(u){return e().filter(f=>u==="estimaciones"?f.reales===0:f.estimaciones===0).map(f=>f.tag)}function n(u,f,c){const p=At(f),v=(u??[]).map(At);if(!v.includes(p))return u??[];const b=v.filter(I=>I!==p);return c===null?[...new Set(b)]:[...new Set([...b,At(c)])]}function s(u,f){const c=At(f);if(!c)throw new Error("El nuevo nombre de la etiqueta no puede estar vacío");return l(u,c)}function i(u,f){let c=0;for(const p of u)At(p)!==At(f)&&(c+=l(p,At(f)).cambiados);return{cambiados:c}}function r(u){return l(u,null)}function l(u,f){let c=0;const p=t.get("expenses").map(C=>{const M=n(C.tags,u,f);return M!==C.tags&&(c+=1),M===C.tags?C:{...C,tags:M}});t.set("expenses",p);const v=t.get("transacciones").map(C=>{const M=n(C.tags,u,f);return M!==C.tags&&(c+=1),M===C.tags?C:{...C,tags:M}});t.set("transacciones",v);const b=t.get("loans").map(C=>{const M=n(C.tags,u,f);return M!==C.tags&&(c+=1),M===C.tags?C:{...C,tags:M}});t.set("loans",b);const I=t.get("nominas").map(C=>{const M=n(C.tags,u,f);return M!==C.tags&&(c+=1),M===C.tags?C:{...C,tags:M}});t.set("nominas",I);const w=t.get("config"),x=At(u),g=C=>{const M=(C??[]).map(At);if(!M.includes(x))return C??[];const E=M.filter(_=>_!==x);return f===null?[...new Set(E)]:[...new Set([...E,f])]},h={},$=g(w.activeTagsFilter),m=g(w.tagCategorias),y=g(w.tagGrupos);return $!==w.activeTagsFilter&&(h.activeTagsFilter=$),m!==w.tagCategorias&&(h.tagCategorias=m),y!==w.tagGrupos&&(h.tagGrupos=y),Object.keys(h).length>0&&t.patchConfig(h),{cambiados:c}}return{uso:e,todas:a,soloEn:o,renombrar:s,fusionar:i,eliminar:r}}const nd=3;function Rn(t){return t<.005?0:t}function sd(t){if(t.length<2)return null;const e=t.reduce((o,n)=>o+n,0)/t.length,a=t.reduce((o,n)=>o+(n-e)**2,0)/(t.length-1);return Math.sqrt(a)}function id(t){const e=[],a=[],o=[];for(const i of t){if(i.meses.length<nd)continue;const r=sd(i.meses.map(l=>l.desviacion));r!==null&&(e.push(r),a.push(r/Math.sqrt(i.meses.length)),o.push(i.meses.length))}if(e.length===0)return{sigmaMensual:0,sigmaDeriva:0,estimaciones:0,mesesMinimos:0,mesesMaximos:0,fiable:!1};const n=Math.sqrt(e.reduce((i,r)=>i+r*r,0)),s=Math.sqrt(a.reduce((i,r)=>i+r*r,0));return{sigmaMensual:Rn(n),sigmaDeriva:Rn(s),estimaciones:e.length,mesesMinimos:Math.min(...o),mesesMaximos:Math.max(...o),fiable:!0}}function On(t,e,a=1,o=0){if(e<=0)return 0;const n=Math.max(0,t)*Math.sqrt(e),s=Math.max(0,o)*e;return n===0&&s===0?0:W(a*Math.hypot(n,s))}function rd(t,e,a={}){if(!e.fiable||t.length===0)return[];const{z:o=1}=a,n=a.desde??t[0].fecha,[s,i]=n.slice(0,7).split("-").map(Number);return t.map(r=>{const[l,u]=r.fecha.slice(0,7).split("-").map(Number),f=Math.max(0,(l-s)*12+(u-i)),c=On(e.sigmaMensual,f,o,e.sigmaDeriva);return{fecha:r.fecha,saldo:r.saldoAcum,arriba:W(r.saldoAcum+c),abajo:W(r.saldoAcum-c)}})}function ld(t,e=1){if(!t.fiable)return"Necesita al menos 3 meses de contabilidad real para medir cuánto se desvían tus estimaciones.";if(t.sigmaMensual===0)return"Sin margen de error: tus estimaciones se desvían siempre lo mismo, así que no hay incertidumbre que dibujar. Si se desvían de forma sistemática, ajústalas desde el cierre de mes.";const a=e>=2?"95 %":"68 %",o=t.mesesMinimos===t.mesesMaximos?`${t.mesesMinimos}`:`${t.mesesMinimos}–${t.mesesMaximos}`;return`Banda de ±${e} desviación${e!==1?"es":""} típica${e!==1?"s":""} (${a} de los casos), medida sobre ${t.estimaciones} estimación${t.estimaciones!==1?"es":""} con ${o} mes${t.mesesMaximos!==1?"es":""} de datos reales. Se ensancha con el tiempo, y tanto más deprisa cuanto menos historial haya: tu gasto medio también es una estimación.`}const za="financeapp_session",cd=["local","dropbox","firebase"];function dd(t){if(!t)return null;try{const e=JSON.parse(t);if(!e||!cd.includes(e.modo))return null;const a=Number(e.creadaEn),o=Number(e.ultimoUso);return!Number.isFinite(a)||!Number.isFinite(o)?null:{modo:e.modo,...typeof e.email=="string"?{email:e.email}:{},...typeof e.passphrase=="string"?{passphrase:e.passphrase}:{},creadaEn:a,ultimoUso:o}}catch{return null}}function ud({storage:t,autoLogoutMinutos:e=()=>0,ahora:a=()=>Date.now(),graciaActiva:o=()=>!1}={}){const n=()=>t??(typeof localStorage<"u"?localStorage:null);function s(v){const b=n();if(b)try{v?b.setItem(za,JSON.stringify(v)):b.removeItem(za)}catch{}}function i(){const v=n();if(!v)return null;try{return dd(v.getItem(za))}catch{return null}}function r(){const v=i();return v?(a()-v.ultimoUso)/6e4:null}function l(){const v=e();if(!Number.isFinite(v)||v<=0||o())return!1;const b=r();return b!==null&&b>=v}function u(){const v=i();return v?l()?(s(null),null):v:null}function f(v){const b=a(),I={modo:v.modo,...v.email?{email:v.email}:{},...v.passphrase?{passphrase:v.passphrase}:{},creadaEn:b,ultimoUso:b};return s(I),I}function c(){const v=i();v&&s({...v,ultimoUso:a()})}function p(){s(null)}return{abrir:f,leer:u,tocar:c,cerrar:p,caducada:l,inactividadMinutos:r,get activa(){return u()!==null}}}const qn=["pointerdown","keydown","visibilitychange"];function pd({sesion:t,onCaducada:e,intervaloMs:a=3e4,setIntervalImpl:o=setInterval,clearIntervalImpl:n=clearInterval,target:s=typeof document<"u"?document:void 0}){let i=!0;const r=()=>{i&&t.tocar()};for(const f of qn)s==null||s.addEventListener(f,r);const l=o(()=>{i&&t.caducada()&&(u(),t.cerrar(),e())},a);function u(){if(i){i=!1,n(l);for(const f of qn)s==null||s.removeEventListener(f,r)}}return u}const md=[{minutos:0,etiqueta:"Nunca (solo manualmente)"},{minutos:15,etiqueta:"Tras 15 minutos de inactividad"},{minutos:60,etiqueta:"Tras 1 hora de inactividad"},{minutos:480,etiqueta:"Tras 8 horas de inactividad"},{minutos:10080,etiqueta:"Tras 7 días de inactividad"}],fd="FinanceApp",vd=new TextEncoder().encode("financeapp-bio-passphrase-v1");function Ln(t){return new Uint8Array(new ArrayBuffer(t))}const Pa="financeapp_bio_credencial",Fa="financeapp_bio_secreto",Da="financeapp_bio_ultimo_desbloqueo",kn="financeapp_bio_gracia_min",gd=5;function bd(){return{create:t=>navigator.credentials.create(t),get:t=>navigator.credentials.get(t),async disponiblePlataforma(){if(typeof window>"u"||!window.PublicKeyCredential)return!1;try{return await PublicKeyCredential.isUserVerifyingPlatformAuthenticatorAvailable()}catch{return!1}}}}function ke(t){const e=t instanceof Uint8Array?t:new Uint8Array(t);let a="";for(const o of e)a+=String.fromCharCode(o);return btoa(a)}function Be(t){const e=atob(t),a=Ln(e.length);for(let o=0;o<e.length;o++)a[o]=e.charCodeAt(o);return a}function hd(t){return ke(t).replace(/\+/g,"-").replace(/\//g,"_").replace(/=+$/,"")}function yd(t){const e=t.replace(/-/g,"+").replace(/_/g,"/")+"=".repeat((4-t.length%4)%4);return Be(e)}function Bn(t){return t.getClientExtensionResults()}function xd(t={}){const e=t.webauthn??bd(),a=t.subtle??(typeof crypto<"u"?crypto.subtle:void 0),o=t.storage??(typeof localStorage<"u"?localStorage:void 0),n=t.ahora??(()=>Date.now()),s=t.randomBytes??(m=>crypto.getRandomValues(Ln(m)));function i(){if(!o)throw new Error("No hay almacenamiento local disponible.");return o}function r(){return e.disponiblePlataforma()}function l(){const m=o==null?void 0:o.getItem(Pa);if(!m)return null;try{const y=JSON.parse(m);return typeof y.credencialId!="string"||typeof y.salt!="string"?null:y}catch{return null}}function u(){return l()!==null}async function f(m){const y=await a.importKey("raw",m,"HKDF",!1,["deriveKey"]);return a.deriveKey({name:"HKDF",hash:"SHA-256",salt:new Uint8Array(0),info:vd},y,{name:"AES-GCM",length:256},!1,["encrypt","decrypt"])}async function c(m,y){const C=s(12),M=await a.encrypt({name:"AES-GCM",iv:C},m,new TextEncoder().encode(y));return`${ke(C)}:${ke(M)}`}async function p(m,y){const[C,M]=y.split(":"),E=Be(C),_=Be(M),P=await a.decrypt({name:"AES-GCM",iv:E},m,_);return new TextDecoder().decode(P)}async function v(m,y){var R,D;if(!m)throw new Error("No hay clave de cifrado que envolver.");const C=s(32),M=s(32),E=s(16),_=await e.create({publicKey:{challenge:M,rp:{name:fd},user:{id:E,name:"financeapp-local",displayName:"FinanceApp en este dispositivo"},pubKeyCredParams:[{type:"public-key",alg:-7},{type:"public-key",alg:-257}],authenticatorSelection:{authenticatorAttachment:"platform",userVerification:"required",residentKey:"required"},extensions:{prf:{eval:{first:C}}},timeout:6e4}});if(!_)throw new Error("No se ha podido crear la credencial biométrica.");const P=Bn(_);if(!((R=P.prf)!=null&&R.enabled))throw new Error("Este dispositivo o navegador no admite desbloqueo con huella (falta soporte de la extensión PRF).");let S=((D=P.prf.results)==null?void 0:D.first)??null;if(S||(S=await b(_.rawId,C)),!S)throw new Error("El sensor no ha devuelto material de cifrado.");const A=await f(S),F=await c(A,m),z={credencialId:hd(_.rawId),salt:ke(C),modo:y,creadaEn:n()},T=i();T.setItem(Pa,JSON.stringify(z)),T.setItem(Fa,F)}async function b(m,y){var M,E;const C=await e.get({publicKey:{challenge:s(32),allowCredentials:[{id:m,type:"public-key"}],userVerification:"required",extensions:{prf:{eval:{first:y}}},timeout:6e4}});return C?((E=(M=Bn(C).prf)==null?void 0:M.results)==null?void 0:E.first)??null:null}async function I(){const m=l();if(!m)throw new Error("No hay huella configurada en este dispositivo.");const y=o==null?void 0:o.getItem(Fa);if(!y)throw new Error("No hay clave guardada. Vuelve a activar el desbloqueo con huella.");const C=await b(yd(m.credencialId).buffer,Be(m.salt));if(!C)throw new Error("No se ha podido leer la huella. Inténtalo de nuevo o usa la clave.");const M=await f(C),E=await p(M,y);return x(),E}function w(){o==null||o.removeItem(Pa),o==null||o.removeItem(Fa),o==null||o.removeItem(Da)}function x(){o==null||o.setItem(Da,String(n()))}function g(){const m=o==null?void 0:o.getItem(kn);if(m==null)return gd;const y=Number(m);return Number.isFinite(y)&&y>0?y:0}function h(m){o==null||o.setItem(kn,String(Math.max(0,Math.floor(m)||0)))}function $(){if(!u())return!1;const m=g();if(m<=0)return!1;const y=o==null?void 0:o.getItem(Da),C=y?Number(y):NaN;return Number.isFinite(C)?n()-C<m*6e4:!1}return{disponible:r,registrada:u,leerCredencial:l,registrar:v,desbloquear:I,olvidar:w,marcarDesbloqueo:x,dentroDeGracia:$,graciaMinutos:g,configurarGracia:h}}function Hn(){if(typeof localStorage<"u"){const m=ii();m.length>0&&console.info(`[FinanceApp] Recuperadas claves escritas fuera del espacio de nombres: ${m.join(", ")}`)}const t=bi(),e=t.activo(),a=fe(e),o=Do(localStorage,a),n=ui({adapter:o}),s=pi(),{applied:i}=n.load();i.length>0&&console.info(`[FinanceApp] Migraciones aplicadas: ${i.join(", ")} (esquema v${pe})`),n.subscribe(m=>s.marcar(m));const r={listar:()=>t.listar(),activo:()=>t.listar().find(m=>m._id===e)??t.listar()[0],colecciones:Tt.filter(m=>m!=="config"),crear:m=>t.crear(m),renombrar:(m,y)=>t.renombrar(m,y),duplicar:(m,y)=>t.duplicar(m,y),eliminar:m=>t.eliminar(m),cambiarA:m=>t.establecerActivo(m),importarDesde:(m,y)=>{const C=hi(localStorage,m,y),M=yi(C),E=[];for(const _ of y){const P=M[_];if(!Array.isArray(P)||P.length===0)continue;const S=n.get(_);n.set(_,[...S,...P]),E.push(_)}return E.length>0&&s.marcar("importado-de-otro-proyecto"),{importadas:E}}},l=$i(n);Es(m=>l.isEnabled(m));const u=xd(),f=ud({autoLogoutMinutos:()=>{var y,C;const m=(C=(y=globalThis.State)==null?void 0:y.get)==null?void 0:C.call(y,"config");return Number((m==null?void 0:m.autoLogoutMinutos)??n.get("config").autoLogoutMinutos??0)},graciaActiva:()=>u.dentroDeGracia()}),c=ad(n),p=od(n),v=br(c),b=Xi(n),I=Yi({isEnabled:m=>l.isEnabled(m)}),w=qi({flags:l,rutasExtra:()=>I.flagPorRuta()}),x=Si({flags:l,onChange:()=>{var m,y;I.attachToShell(),w.apply(),(y=(m=globalThis.Router)==null?void 0:m.rerender)==null||y.call(m)}}),g=Fi({proyectos:r}),h=()=>{var y,C,M,E,_,P;const m=globalThis;if((C=(y=m.State)==null?void 0:y.load)==null||C.call(y),((E=(M=m.Router)==null?void 0:M.current)==null?void 0:E.call(M))==="dashboard")try{(P=(_=m.DashboardModule)==null?void 0:_.render)==null||P.call(_)}catch(S){console.error("[FinanceApp] No se ha podido repintar el cuadro de mando tras el cambio:",S)}},$=Oi({store:n,onDatosCambiados:h});return I.register(Ur({store:n,onDatosCambiados:h})),I.register(ol({store:n,onDatosCambiados:h})),I.register(Il({store:n,onDatosCambiados:h})),I.register(Bl({store:n,ledger:c,mostrarObjetivos:()=>l.isEnabled("goals"),onDatosCambiados:h})),I.register(_r({ledger:c,tags:p,precision:v,adjuster:b,accounts:()=>n.get("accounts"),estimaciones:()=>n.get("expenses"),onDatosCambiados:h})),I.register(ed({store:n,onDatosCambiados:h})),I.register(Zl({store:n,onDatosCambiados:h})),I.register(Rr({store:n,onDatosCambiados:h})),I.register(Wl({store:n})),I.register(zr({store:n,onDatosCambiados:h})),{version:pe,core:ds,engine:{generarExtracto:ce,recomputarSaldoAcum:ms,saldoHoy:fs,sumarPorTags:uo,providers:{proyectarGastos:le,proyectarPrestamos:eo,proyectarTransferencias:ao,proyectarNominas:io,proyectarInteresesCuentas:no,proyectarAportaciones:oo,proyectarRetencionesFiscales:so,proyectarInflacionGastos:ro,proyectarPerdidaAhorro:lo},analysis:hs,margins:Is,avisos:Cs,optimizer:_s,dashboard:Hs},store:n,flags:l,featureRegistry:{all:zt,porGrupo:Lo},ui:{openFeatures:x.open,openProyectos:g.open,openPersonas:$.open,applyGating:w.apply,watchGating:()=>w.observar(),instalarDeshacer:()=>ki({store:n,rerender:()=>{var y,C,M,E;const m=globalThis;(C=(y=m.State)==null?void 0:y.load)==null||C.call(y),(E=(M=m.Router)==null?void 0:M.rerender)==null||E.call(M)}}),avisoGuardado:null,instalarBuscador:()=>Vi({estado:()=>({accounts:n.get("accounts"),expenses:n.get("expenses"),loans:n.get("loans"),nominas:n.get("nominas"),escenarios:n.get("escenarios"),planes:n.get("planes"),goals:n.get("goals"),transacciones:n.get("transacciones")}),rutasDisponibles:()=>I.routes(),navegar:m=>{var y,C;return(C=(y=globalThis.Router)==null?void 0:y.navigate)==null?void 0:C.call(y,m)}})},app:I,session:Object.assign(f,{vigilar:m=>pd({sesion:f,onCaducada:m}),opciones:md}),biometria:u,cambios:s,datos:{colecciones:Tt,snapshot:()=>To(o),aplicar:(m,{sellar:y=!0}={})=>{const M=mi(y?(E,_)=>o.set(E,_):(E,_)=>{const P=globalThis.StorageAdapter;P!=null&&P.setRestaurando?P.setRestaurando(E,_):o.set(E,_)},m);return n.load(),s.marcar("copia-restaurada"),M},faltantes:m=>fi(m),esVacioOPorDefecto:()=>vi(To(o)),recargar:()=>{n.load(),s.marcar("recarga-externa")}},proyectos:r,accounting:{ledger:c,tags:p,precision:v,adjuster:b,sugerirAjuste:ga,medirVariabilidad:id,bandaDeConfianza:rd,bandaAcumulada:On,describirBanda:ld}}}function $d(){try{const t=Hn();return window.FinanceApp=t,t}catch(t){const e=t;return window.FinanceAppError={mensaje:(e==null?void 0:e.message)??String(t),stack:e==null?void 0:e.stack},console.error("[FinanceApp] El paquete nuevo no pudo arrancar:",t),null}}const pt=typeof window<"u"?$d():null;if(pt){let t=!1;const e=()=>{var a,o;if(pt.app.attachToShell(),pt.ui.applyGating(),!t){t=!0,pt.ui.watchGating(),pt.ui.instalarDeshacer(),pt.ui.instalarBuscador();const n=globalThis,s=()=>{var l,u,f,c;return(u=(l=n.FirebaseService)==null?void 0:l.isConnected)!=null&&u.call(l)?n.FirebaseService:(c=(f=n.DropboxService)==null?void 0:f.isConnected)!=null&&c.call(f)?n.DropboxService:null};pt.ui.avisoGuardado=Ui({cambios:pt.cambios,hayDestino:()=>s()!==null,guardar:async()=>{const l=s();if(!(l!=null&&l.uploadBackup))throw new Error("No hay ningún destino de copia conectado.");await l.uploadBackup()}});const i=document.getElementById("sidebar-proyecto-activo"),r=document.getElementById("sidebar-proyecto-activo-nombre");i&&r&&(r.textContent=pt.proyectos.activo().nombre,i.classList.remove("hidden"),i.addEventListener("click",()=>pt.ui.openProyectos())),(a=document.getElementById("btn-proyectos"))==null||a.addEventListener("click",()=>pt.ui.openProyectos()),(o=document.getElementById("btn-personas"))==null||o.addEventListener("click",()=>pt.ui.openPersonas())}};document.readyState==="loading"?document.addEventListener("DOMContentLoaded",e,{once:!0}):e(),document.addEventListener("click",a=>{const o=a.target;o!=null&&o.closest(".nav-btn[data-view]")&&setTimeout(e,0)})}return wt.bootstrap=Hn,Object.defineProperty(wt,Symbol.toStringTag,{value:"Module"}),wt}({});
