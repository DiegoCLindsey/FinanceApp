var FinanceAppBundle=function($t){"use strict";var Yl=Object.defineProperty;var Jl=($t,V,G)=>V in $t?Yl($t,V,{enumerable:!0,configurable:!0,writable:!0,value:G}):$t[V]=G;var ss=($t,V,G)=>Jl($t,typeof V!="symbol"?V+"":V,G);function V(t){const e=t.getFullYear(),a=String(t.getMonth()+1).padStart(2,"0"),o=String(t.getDate()).padStart(2,"0");return`${e}-${a}-${o}`}function G(t){const[e,a,o]=t.split("-").map(Number);return new Date(e,a-1,o)}function Y(){return V(new Date)}function Me(t,e){return new Date(t,e+1,0).getDate()}function ca(t,e,a){return V(new Date(t,e,Math.min(a,Me(t,e))))}function de(t,e,a){if(!a)return null;if(a.startsWith("dia:")){const o=a.slice(4);if(o==="ultimo")return V(new Date(t,e+1,0));const n=parseInt(o);if(!isNaN(n))return ca(t,e,n)}if(a.startsWith("nthweekday:")){const o=a.split(":"),n=parseInt(o[1]),s=parseInt(o[2]);if(n===-1){const r=new Date(t,e+1,0);for(;r.getDay()!==s;)r.setDate(r.getDate()-1);return V(r)}const i=new Date(t,e,1);for(;i.getDay()!==s;)i.setDate(i.getDate()+1);return i.setDate(i.getDate()+(n-1)*7),i.getMonth()!==e&&i.setDate(i.getDate()-7),V(i)}return null}function da(t,e){if(!e)return t;const a=G(t);return de(a.getFullYear(),a.getMonth(),e)??t}const ns=["domingo","lunes","martes","miércoles","jueves","viernes","sábado"],is={"-1":"último",1:"1º",2:"2º",3:"3º",4:"4º",5:"5º"};function Se(t){if(!t)return"";if(t.startsWith("dia:")){const e=t.slice(4);return e==="ultimo"?"Último día del mes":`Día ${e} del mes`}if(t.startsWith("nthweekday:")){const e=t.split(":"),a=e[1],o=parseInt(e[2]);return`${is[a]||a+"º"} ${ns[o]} del mes`}return t}function Vt(t,e){const a=Date.UTC(t.getFullYear(),t.getMonth(),t.getDate()),o=Date.UTC(e.getFullYear(),e.getMonth(),e.getDate());return Math.round((o-a)/864e5)}function It(t){return Math.sign(t)*Math.round(Math.abs(t)*100)}function et(t){return t/100}function W(t){return et(It(t))}function j(t){return new Intl.NumberFormat("es-ES",{style:"currency",currency:"EUR"}).format(t||0)}function ua(t){return(t||0).toFixed(2)+"%"}function Dt(t,e,a){const o=e/100/12;return o===0?t/a:t*o*Math.pow(1+o,a)/(Math.pow(1+o,a)-1)}function pa(t,e,a,o=0){const n=Dt(t,e,a),s=t*(1-o/100);let i=e/100/12;for(let r=0;r<200;r++){const p=n*(1-Math.pow(1+i,-a))/i-s,g=n*(a*Math.pow(1+i,-(a+1))/i-(1-Math.pow(1+i,-a))/(i*i)),u=i-p/g;if(Math.abs(u-i)<1e-10){i=u;break}i=u}return(Math.pow(1+i,12)-1)*100}function ma(t,e,a,o,n=0,s=[],i={}){const r=[];let l=t;const p=G(o),g=e/100/12;let u=a,d=Dt(l,e,u);const h=[...s].sort((I,A)=>I.fecha.localeCompare(A.fecha));let y=0;for(let I=1;I<=a*2&&l>.01;I++){const A=new Date(p);p.setMonth(p.getMonth()+1);const f=da(V(A),i.diaPago||"");for(;y<h.length&&h[y].fecha<=f;){const $=h[y],v=$.cantidad*(n/100);if(l-=$.cantidad,l=Math.max(0,l),$.tipo==="plazo"?u=Math.ceil(-Math.log(1-l*g/d)/Math.log(1+g)):(u=a-I+1,d=Dt(l,e,u)),r.push({mes:"AMORT",fecha:$.fecha,cuota:0,interes:0,amortizacion:$.cantidad,comisionAmort:v,capitalPendiente:l,esAmortizacion:!0,simulacion:$.simulacion||!1}),y++,l<.01)break}if(l<.01)break;const b=l*g,m=Math.min(d-b,l);if(l-=m,l<.01&&(l=0),r.push({mes:I,fecha:f,cuota:d,interes:b,amortizacion:m,comisionAmort:0,capitalPendiente:l,esAmortizacion:!1,simulacion:!1}),u--,u<=0||l<.01)break}return r}const fa=new Map;function at(t){var A;const e=t.amortizaciones||[],a=`${t.capital}|${t.tin}|${t.meses}|${t.fechaInicio}|${t.comisionAmort||0}|${t.comisionApertura||0}|${t.diaPago||""}|${e.slice().sort((f,b)=>`${f.fecha}|${f.cantidad}|${f.tipo||""}`.localeCompare(`${b.fecha}|${b.cantidad}|${b.tipo||""}`)).map(f=>`${f.fecha}:${f.cantidad}:${f.tipo||""}`).join(";")}`,o=fa.get(a);if(o)return o;const{capital:n,tin:s,meses:i,fechaInicio:r,comisionAmort:l,comisionApertura:p}=t,g=ma(n,s,i,r,l||0,e,t),u=g.reduce((f,b)=>f+b.interes,0),d=g.reduce((f,b)=>f+b.comisionAmort,0),h=n*((p||0)/100),y=g.filter(f=>!f.esAmortizacion),I={cuota:Dt(n,s,i),totalIntereses:u,tae:pa(n,s,i,p||0),costoTotal:u+d+h,comAp:h,totalComAm:d,fechaFin:((A=y.slice(-1)[0])==null?void 0:A.fecha)||"",mesesReales:y.length,tabla:g};return fa.set(a,I),I}function va(t){const e=at(t),a=at({...t,amortizaciones:[]}),o=a.totalIntereses-e.totalIntereses,n=a.mesesReales-e.mesesReales,s=e.totalComAm;return{...e,sinAmort:a,ahorroIntereses:o,ahorroTiempo:n,costeTotalAmort:s,ahorroNeto:o-s,totalPagado:t.capital+e.totalIntereses+e.comAp+e.totalComAm}}function pt(t,e,a){if(!t||t.length===0)return 1;const o=G(e),n=G(a);if(n<=o)return 1;const s=[...t].sort((l,p)=>l.year-p.year);let i=1,r=new Date(o);for(;r<n;){const l=r.getFullYear(),p=s.filter(I=>I.year<=l),g=p.length>0?p[p.length-1]:s[0],u=(g?g.tasa:0)/100,d=new Date(l+1,0,1),h=d<n?d:n,y=Vt(r,h);i*=Math.pow(1+u,y/365.25),r=h}return i}function ga(t,e,a,o=0){const n=G(e),s=G(a);if(s<=n)return o;const i=Vt(n,s),r=t?[...t].sort((g,u)=>g.year-u.year):[];let l=0,p=new Date(n);for(;p<s;){const g=p.getFullYear(),u=new Date(g+1,0,1),d=u<s?u:s,h=Vt(p,d),y=r.filter(f=>f.year<=g),I=y.length>0?y[y.length-1]:null,A=I!==null?I.tasa:o;l+=A*h,p=d}return i>0?l/i:o}function ba(t,e){return((1+t/100)/(1+e/100)-1)*100}function rs(t,e,a,o){const n=pt(e,a,o);return n>0?t/n:t}function ls(t,e){const a=e.saludUmbralAhorroVerde??20,o=e.saludUmbralAhorroAmarillo??10,n=e.saludUmbralDTIVerde??30,s=e.saludUmbralDTIAmarillo??40,i=e.saludRegla||[50,30,20],r=e.saludExcluirHipoteca||!1,{ingresos:l=0,cuotas:p=0,cuotasHipoteca:g=0,gastosBasicos:u=0,gastosOtros:d=0,amortizaciones:h=0}=t,y=l-p-h-u-d,I=y,A=l>0?I/l*100:null,f=r?p-g:p,b=l>0?f/l*100:null,m=l>0?p/l*100:null,$=l>0?(u+p+h)/l*100:null,v=l>0?d/l*100:null,x=(S,C,z)=>S===null?"neutral":S>=C?"verde":S>=z?"amarillo":"rojo",M=(S,C,z)=>S===null?"neutral":S<=C?"verde":S<=z?"amarillo":"rojo";return{ingresos:l,cuotas:p,cuotasHipoteca:g,gastosBasicos:u,gastosOtros:d,amortizaciones:h,ahorroBruto:y,ahorroReal:I,tasaAhorro:A,dti:b,dtiTotal:m,excluyeHipoteca:r,pctNecesidades:$,pctDeseos:v,semAhorro:x(A,a,o),semDTI:M(b,n,s),semNecesidades:M($,i[0],i[0]+15),semDeseos:M(v,i[1],i[1]+10),semAhorroRegla:x(A,i[2],i[2]*.5),umbralAhorroVerde:a,umbralAhorroAmarillo:o,umbralDTIVerde:n,umbralDTIAmarillo:s,regla:i}}function mt(t){return(t==null?void 0:t.modeloFondo)||(t!=null&&t.esFondoPension?"pension":"cuenta")}function rt(t){const e=[...t.historicoSaldos||[]].sort((a,o)=>o.fecha.localeCompare(a.fecha));return e.length>0?e[0].saldo:t.saldoInicial||0}function Ut(t,e){const a=t.fechaInicialSaldo||"";if(!a||e>=a){const o=[];a&&o.push({fecha:a,saldo:t.saldoInicial||0,prioridad:-1}),(t.historicoSaldos||[]).forEach((s,i)=>{s.fecha>=a&&o.push({...s,prioridad:i})}),o.sort((s,i)=>i.fecha.localeCompare(s.fecha)||i.prioridad-s.prioridad);const n=o.find(s=>s.fecha<=e);return n?n.saldo:t.saldoInicial||0}else{const n=[...t.historicoSaldos||[]].sort((s,i)=>i.fecha.localeCompare(s.fecha)).find(s=>s.fecha<=e);return n?n.saldo:0}}function we(t,e){const a=t.cuentaIds&&t.cuentaIds.length>0?t.cuentaIds:null;return a?e.filter(o=>a.includes(o._id)):e.filter(o=>o.activo&&!o.simulacion)}function ha(t,e,a=0){const o=we(t,e).reduce((n,s)=>n+rt(s),0);return t.usarColchon!==!1?Math.max(0,o-a):o}function cs(t,e,a){if(!t.targetAmount||t.targetAmount<=0)return null;const o=we(t,e);if(o.length===0)return null;const n=a.hoy??new Date,s=a.horizonteMeses??120,i=t.usarColchon!==!1,r=o.map(l=>({acc:l,eventos:a.extractoCuenta(l),cursor:0,saldo:rt(l)}));for(let l=1;l<=s;l++){const p=new Date(n.getFullYear(),n.getMonth()+l,1),g=`${p.getFullYear()}-${String(p.getMonth()+1).padStart(2,"0")}`,u=V(new Date(p.getFullYear(),p.getMonth()+1,0));let d=0;for(const y of r){for(;y.cursor<y.eventos.length&&y.eventos[y.cursor].fecha<=u;)y.saldo=y.eventos[y.cursor].saldoAcum??y.saldo,y.cursor++;d+=y.saldo}const h=i?a.colchonEnFecha(u):0;if(d-h>=t.targetAmount)return g}return null}function ya(t,e){const a=t.escenarioIds||[];return a.length===0?!0:!!e&&a.includes(e)}function xa(t,e){const a=o=>ya(o,e);return{loans:t.loans.filter(a).map(o=>({...o,amortizaciones:(o.amortizaciones||[]).filter(a)})),expenses:t.expenses.filter(a),nominas:t.nominas.filter(a),accounts:t.accounts.filter(a)}}const Ce=t=>t.slice(0,7);function ds(t){const[e,a]=t.split("-").map(Number);return`${a===12?e+1:e}-${String(a===12?1:a+1).padStart(2,"0")}`}function je(t,e,a){if(t.length===0)return[];const o=new Map;for(const p of t)p.saldoAcum!==void 0&&o.set(Ce(p.fecha),p.saldoAcum);const n=t[0];let s=(n.saldoAcum??0)-(n.delta??0);const i=Ce(e||n.fecha),r=Ce(a||t[t.length-1].fecha);if(r<i)return[];const l=[];for(let p=i;p<=r;p=ds(p)){const g=o.get(p);g!==void 0&&(s=g);const[u,d]=p.split("-").map(Number);l.push({x:G(V(new Date(u,d-1,15))).getTime(),mes:p,y:s})}return l}function ze(t,e){let a=null;for(const o of t){if(o.fecha>e)break;o.saldoAcum!==void 0&&(a=o.saldoAcum)}return a}function us(t){const e=a=>!a.simulacion;return{loans:t.loans.filter(e).map(a=>({...a,amortizaciones:(a.amortizaciones||[]).filter(e)})),expenses:t.expenses.filter(e),nominas:t.nominas.filter(e),accounts:t.accounts.filter(e)}}function ps(t){const e=a=>!!a.simulacion;return t.loans.some(a=>e(a)||(a.amortizaciones||[]).some(e))||t.expenses.some(e)||t.nominas.some(e)||t.accounts.some(e)}const gt=[[0,19],[12450,24],[20200,30],[35200,37],[6e4,45],[3e5,47]];function ut(t,e){const a=[...e].sort((s,i)=>s[0]-i[0]);let o=0,n=t;for(let s=a.length-1;s>=0;s--){const[i,r]=a[s];n<=i||(o+=(n-i)*(r/100),n=i)}return o}function Ee(t,e){const a=Math.max(0,t-(e||0)),o=t*.0635,n=Math.min(2e3,a),s=Math.max(0,a-o-n),i=s<=15876?7302:s<=21622?Math.max(0,7302-1.75*(s-15876)):0;return{baseIRPF:a,cotizSS:o,gastosArt19:n,RNT:s,reducArt20:i,baseImponible:Math.max(0,s-i)}}function Mt(t,e){return Ee(t,e).baseImponible}function $a(t,e){return ut(t,e)/12}const jt=[[0,19],[6e3,21],[5e4,23],[2e5,27],[3e5,28]];function Fe(t,e){if(!t||t<=0)return 0;const a=e||jt;let o=0,n=t;for(let s=0;s<a.length;s++){const[i,r]=a[s],l=s<a.length-1?a[s+1][0]:1/0,p=Math.min(n,l-i);if(!(p<=0)&&(o+=p*(r/100),n-=p,n<=0))break}return o}function Rt(t,e){if(mt(t)!=="inversion")return null;const a=rt(t),o=(t.aportaciones||[]).reduce((i,r)=>i+r.cantidad,0)||t.saldoInicial||0,n=Math.max(0,a-o),s=Fe(n,e);return{saldo:a,costBase:o,plusvalia:n,impuesto:s,neto:a-s}}function ue(t,e=new Date){var d;if(mt(t)!=="pension")return null;const a=t.bloqueoMeses||120,o=rt(t),n=V(new Date(e.getFullYear(),e.getMonth()-a,e.getDate())),s=[...t.aportaciones||[]].sort((h,y)=>h.fecha.localeCompare(y.fecha));let i=0;const r=s.reduce((h,y)=>h+y.cantidad,0);for(const h of s)h.fecha<=n&&(i+=h.cantidad);const l=Math.max(0,o-r),p=r>0?i/r:0,g=Math.min(o,i+l*p),u=Math.max(0,o-g);return{saldo:o,disponible:g,bloqueado:u,costBase:r,beneficio:l,numAportaciones:s.length,proxDesbloqueo:((d=s.find(h=>h.fecha>n))==null?void 0:d.fecha)||null}}function Ia(t,e,a){const o=a!==void 0?a:t.impuestoRetirada;if(mt(t)!=="pension"||!o)return 0;const n=rt(t);if(n<=0)return 0;const s=(t.aportaciones||[]).reduce((p,g)=>p+g.cantidad,0),i=Math.max(0,n-s);if(i<=0)return 0;const r=i/n;return+(e*r*o/100).toFixed(2)}function _e(t,e,a){var l;const o=t.grupoNomina;if(!o)return t.impuestoRetirada||0;const s=(e||[]).filter(p=>(p.grupoNomina||"")===o&&p.activo!==!1).reduce((p,g)=>p+(g.bruto||0)*(g.nPagas||12),0),i=[...a||[]].sort((p,g)=>p[0]-g[0]);let r=((l=i[0])==null?void 0:l[1])||19;for(const[p,g]of i)if(s>=p)r=g;else break;return r}const Pe=6.35;function zt(t){return(t.retribucionFlexible||[]).reduce((e,a)=>e+(a.importe||0)*12,0)}function Aa(t){return Math.max(0,(t.bruto||0)-zt(t))}function ms(t){return[...t].sort((e,a)=>(a.bruto||0)-(e.bruto||0)||String(e._id).localeCompare(String(a._id)))}function fs(t){const e=t.reduce((i,r)=>i+(r.bruto||0),0),a=t.reduce((i,r)=>i+zt(r),0),o=Math.max(0,e-a),n=Mt(e,a),s=new Map;for(const i of t)s.set(i._id,o>0?n*(Aa(i)/o):0);return s}function Te(t,e,a){if(t.irpfModo==="manual")return Aa(t)*((t.irpfPct||0)/100);if(!e||e.length===0)return ut(Mt(t.bruto||0,zt(t)),a);const o=ms(e.filter(i=>i.irpfModo!=="manual")),n=fs(e);let s=0;for(const i of o){const r=n.get(i._id)??0;if(i._id===t._id)return ut(s+r,a)-ut(s,a);s+=r}return ut(Mt(t.bruto||0,zt(t)),a)}function vs(t,e){return t.reduce((a,o)=>a+Te(o,t,e),0)}function gs(t,e){var n;const a=[...e||[]].sort((s,i)=>s[0]-i[0]);let o=((n=a[0])==null?void 0:n[1])??19;for(const[s,i]of a)if(t>=s)o=i;else break;return o}function Ma(t,e){if(!t||t.length===0)return 0;const a=t.reduce((n,s)=>n+(s.bruto||0),0),o=t.reduce((n,s)=>n+zt(s),0);return gs(Mt(a,o),e)}function De(t,e,a){const o=t.bruto||0,n=zt(t),s=Math.max(0,o-n),i=t.nPagas||12,r=t.ssPct??Pe,l=s*(r/100),p=Te(t,e,a);return{brutoAnual:o,flexAnual:n,baseDineraria:s,nPagas:i,ssPct:r,ssAnual:l,irpfAnual:p,irpfPct:s>0?p/s*100:0,netoPorPaga:(s-l-p)/i}}function bs(t){const e=new Map,a=[];for(const o of t){const n=o.grupoNomina||"";if(!n){a.push(o);continue}const s=e.get(n)??[];s.push(o),e.set(n,s)}return{grupos:e,sueltas:a}}const Et=1500;function Sa(t){const e=t.cuantia||0,a=Math.max(1,t.frecuencia||1);return t.tipoFrecuencia==="mensual"?e*12/a:t.tipoFrecuencia==="diaria"?e*365.25/a:e}const Yt=t=>{const e=typeof t=="number"?t:parseFloat(String(t??""));return Number.isFinite(e)?e:0};function hs(t,e){const a=t.grupoNomina||"";return a?e.filter(o=>(o.grupoNomina||"")===a):null}function wa(t,e){return t.reduce((a,o)=>a+Te(o,hs(o,t),e),0)}function Ca(t){const{nominas:e,tramosGeneral:a,tramosAhorro:o}=t,n=t.extras??{},s=e.reduce((S,C)=>S+(C.bruto||0),0),i=e.reduce((S,C)=>S+zt(C),0),r=Ee(s,i),l=t.aportacionesPension,p=Et,g=Math.min(l,p),u=Math.max(0,r.RNT-r.reducArt20-g),d=Yt(n.capInmobiliario),h=Yt(n.capMobiliario),y=Yt(n.gananciasFondos),I=Yt(n.otrasCorto),A=Yt(n.retCapital),f=Math.max(0,u+t.otrosIngresos+d+I),b=Math.max(0,h+y),m=ut(f,a),$=ut(b,o),v=m+$,x=wa(e,a),M=x+A;return{brutoTotal:s,flexTotal:i,brutoIRPF:r.baseIRPF,cotizSS:r.cotizSS,gastosArt19:r.gastosArt19,RNT:r.RNT,reducArt20:r.reducArt20,aportPP:l,limPP:p,deducPP:g,RNTred:u,otrosIngresos:t.otrosIngresos,capInmobiliario:d,capMobiliario:h,gananciasFondos:y,otrasCorto:I,baseGeneral:f,baseAhorro:b,cuotaGen:m,cuotaAho:$,cuotaIntegra:v,retNomina:x,retCapital:A,totalRet:M,resultado:v-M}}const ys=Object.freeze(Object.defineProperty({__proto__:null,LIMITE_APORTACION_PENSION:Et,TRAMOS_AHORRO_DEFAULT:jt,TRAMOS_IRPF_DEFAULT:gt,ajustarFechaPago:da,ajustarPrecioReal:rs,calcBaseImponibleTrabajo:Mt,calcFactorInflacion:pt,calcFondoInversion:Rt,calcFondosPension:ue,calcGananciasCapital:Fe,calcIRPF:ut,calcImpuestoPension:Ia,calcInflacionMediaAnual:ga,calcSaludFinanciera:ls,calcTAE:pa,calcTipoMarginalPension:_e,calcTipoRealFisher:ba,calcularDeclaracion:Ca,clampedDate:ca,cuentasDelObjetivo:we,cuotaMensual:Dt,desgloseBaseTrabajo:Ee,diasEntre:Vt,filtrarPorEscenario:xa,formatEUR:j,formatLocalDate:V,formatPct:ua,fromCents:et,haySimulaciones:ps,ingresoAnual:Sa,labelDiaPago:Se,lastDayOfMonth:Me,modeloFondoDe:mt,parseLocalDate:G,proyectarFechaCumplimiento:cs,resolverDiaEfectivo:de,resumenPrestamo:at,resumenPrestamoConAhorro:va,retencionMensual:$a,retencionesNomina:wa,roundMoney:W,saldoEnFecha:Ut,saldoEnFechaExtracto:ze,saldoParaObjetivo:ha,saldoRealCuenta:rt,serieMensual:je,sinSimulaciones:us,tablaAmortizacion:ma,toCents:It,todayISO:Y,visibleEnEscenario:ya},Symbol.toStringTag,{value:"Module"}));function Jt(t,e,a=null){const o=[],n=G(e.start),s=G(e.end);for(const i of t){if(!i.activo||a&&a.length>0&&!a.includes(i.cuenta||"default"))continue;const r=G(i.fechaInicio||e.start),l=i.fechaFin?G(i.fechaFin):s,p=i.cuantia,g=u=>o.push({fecha:u,concepto:i.concepto,cuantia:p,tipo:i.tipo,tags:i.tags||[],cuenta:i.cuenta||"default",sourceId:i._id,sourceType:"expense"});if(i.tipoFrecuencia==="extraordinario")r>=n&&r<=s&&r<=l&&g(i.fechaInicio);else if(i.tipoFrecuencia==="mensual"){const u=Math.max(1,i.frecuencia||1);let d=r.getFullYear(),h=r.getMonth();const y=Math.ceil(240/u)+2;for(let I=0;I<y;I++){const A=de(d,h,i.diaPago||"")||(()=>{const b=r.getDate(),m=new Date(d,h+1,0).getDate();return V(new Date(d,h,Math.min(b,m)))})(),f=G(A);if(f>s||f>l)break;f>=n&&f>=r&&g(A),h+=u,h>=12&&(d+=Math.floor(h/12),h=h%12)}}else if(i.tipoFrecuencia==="diaria"){const u=Math.max(1,i.frecuencia||1)*864e5;let d=new Date(Math.max(r.getTime(),n.getTime()));if(r<n){const h=Math.ceil((n.getTime()-r.getTime())/u);d=new Date(r.getTime()+h*u)}for(;d<=s&&d<=l;)g(V(d)),d=new Date(d.getTime()+u)}}return o}function ja(t,e,a=null){const o=[];for(const n of t){if(!n.activo||a&&a.length>0&&!a.includes(n.cuenta||"default"))continue;const{tabla:s}=at(n);for(const i of s)i.fecha>=e.start&&i.fecha<=e.end&&(i.esAmortizacion?o.push({fecha:i.fecha,concepto:`Amort. ${n.nombre}`,cuantia:-(i.amortizacion+i.comisionAmort),tipo:"gasto",tags:["amortizacion",...n.tags||[]],cuenta:n.cuenta||"default",sourceId:n._id,sourceType:"loan-amort",simulacion:i.simulacion||!1}):o.push({fecha:i.fecha,concepto:`Cuota ${n.nombre}`,cuantia:-i.cuota,tipo:"gasto",tags:["prestamo",...n.tags||[]],cuenta:n.cuenta||"default",sourceId:n._id,sourceType:"loan",simulacion:n.simulacion||!1}))}return o}function za(t,e,a=null,o={accounts:[]}){const n=[],s=G(e.start),i=G(e.end),r=o.accounts||[],l=o.nominas||[],p=o.resolverTramosIRPF||(()=>gt),g=o.resolverTramosGanancias||(()=>jt),u=d=>{var h;return((h=r.find(y=>y._id===d))==null?void 0:h.nombre)??d};for(const d of t){if(!d.activo||d.tipo!=="transferencia"||a&&a.length>0&&!(a.includes(d.cuenta||"default")||a.includes(d.cuentaDestino||"default")))continue;const h=G(d.fechaInicio||e.start),y=d.fechaFin?G(d.fechaFin):i,I=A=>{const f=r.find(E=>E._id===(d.cuenta||"default")),b=r.find(E=>E._id===(d.cuentaDestino||"default")),m=mt(f),$=mt(b),v=m==="inversion"&&$==="inversion"||m==="pension"&&$==="pension",x=["transferencia",...v?["traspaso"]:[],...d.tags||[]],M=v?"traspaso-out":"transfer-out",S=v?"traspaso-in":"transfer-in",C=!a||a.length===0||a.includes(d.cuenta||"default"),z=!a||a.length===0||a.includes(d.cuentaDestino||"default");if(C&&n.push({fecha:A,concepto:`Transf. → ${u(d.cuentaDestino||"default")}: ${d.concepto}`,cuantia:d.cuantia,tipo:"gasto",tags:x,cuenta:d.cuenta||"default",sourceId:d._id,sourceType:M}),z&&n.push({fecha:A,concepto:`Transf. ← ${u(d.cuenta||"default")}: ${d.concepto}`,cuantia:d.cuantia,tipo:"ingreso",tags:x,cuenta:d.cuentaDestino||"default",sourceId:d._id,sourceType:S}),C&&!v&&f){if(m==="inversion"){const E=parseInt(A.slice(0,4)),F=Rt(f,g(E));if(F&&F.saldo>0&&F.plusvalia>0){const w=Math.min(1,d.cuantia/F.saldo),T=F.plusvalia*w*.19;T>.01&&n.push({fecha:A,concepto:`Retención IRPF reembolso ${f.nombre} (19% s/plusvalía)`,cuantia:T,tipo:"gasto",tags:["impuesto","capital-mobiliario","retencion"],cuenta:d.cuenta||"default",sourceId:d._id,sourceType:"investment-tax"})}}else if(m==="pension"){const E=p(parseInt(A.slice(0,4))),F=_e(f,l,E),w=Ia(f,d.cuantia,F||void 0);if(w>0){const P=f.grupoNomina?`IRPF rescate ${f.nombre} (tipo marginal grupo "${f.grupoNomina}": ${F}%)`:`Retención rescate ${f.nombre} (${f.impuestoRetirada}% s/beneficio)`;n.push({fecha:A,concepto:P,cuantia:w,tipo:"gasto",tags:["impuesto","rendimientos-trabajo","pension"],cuenta:d.cuenta||"default",sourceId:d._id,sourceType:"pension-tax"})}}}};if(d.tipoFrecuencia==="extraordinario")h>=s&&h<=i&&h<=y&&I(d.fechaInicio);else if(d.tipoFrecuencia==="mensual"){const A=Math.max(1,d.frecuencia||1);let f=h.getFullYear(),b=h.getMonth();const m=Math.ceil(240/A)+2;for(let $=0;$<m;$++){const v=de(f,b,d.diaPago||"")||(()=>{const M=h.getDate(),S=new Date(f,b+1,0).getDate();return V(new Date(f,b,Math.min(M,S)))})(),x=G(v);if(x>i||x>y)break;x>=s&&x>=h&&I(v),b+=A,b>=12&&(f+=Math.floor(b/12),b=b%12)}}else if(d.tipoFrecuencia==="diaria"){const A=Math.max(1,d.frecuencia||1)*864e5;let f=new Date(Math.max(h.getTime(),s.getTime()));if(h<s){const b=Math.ceil((s.getTime()-h.getTime())/A);f=new Date(h.getTime()+b*A)}for(;f<=i&&f<=y;)I(V(f)),f=new Date(f.getTime()+A)}}return n}function Ea(t,e,a=null){const o=[],n=G(e.start),s=G(e.end);for(const i of t){const r=mt(i);if(r==="cuenta"||!i.activo)continue;const l=i.planAportaciones||[];for(const p of l){if(!p.importe||p.importe<=0)continue;const g=G(p.fechaInicio||e.start),u=p.fechaFin?G(p.fechaFin):s,d=p.cuentaOrigen||"default",h=!a||!a.length||a.includes(d),y=!a||!a.length||a.includes(i._id),I=r==="pension"?"pension":"capital-mobiliario",A=v=>{h&&o.push({fecha:v,concepto:`Aportación → ${i.nombre}`,cuantia:p.importe,tipo:"gasto",tags:["aportacion","transferencia",I],cuenta:d,sourceId:p._id,sourceType:"aportacion-out"}),y&&o.push({fecha:v,concepto:`Aportación ${i.nombre} (${p.periodicidad||"mensual"})`,cuantia:p.importe,tipo:"ingreso",tags:["aportacion","transferencia",I],cuenta:i._id,sourceId:p._id,sourceType:"aportacion-in"})},f={mensual:1,trimestral:3,semestral:6,anual:12}[p.periodicidad||"mensual"]||1;let b=g.getFullYear(),m=g.getMonth();const $=Math.ceil(240/f)+2;for(let v=0;v<$;v++){const x=new Date(b,m+1,0).getDate(),M=V(new Date(b,m,Math.min(g.getDate(),x))),S=G(M);if(S>s||S>u)break;S>=n&&S>=g&&A(M),m+=f,m>=12&&(b+=Math.floor(m/12),m=m%12)}}}return o}function Fa(t,e,a=null,o=[]){const n=[];for(const s of t){if(!s.activo||!s.interes||s.interes<=0||a&&a.length>0&&!a.includes(s._id))continue;const i=G(e.start),r=G(e.end),l=s.periodoCobro||"mensual",p=l==="mensual",g=p?null:{diario:864e5,semanal:7*864e5}[l]||864e5,u=p?1/12:g/(365.25*864e5);let d=Ut(s,e.start);const h=o.filter(A=>A.cuenta===s._id).map(A=>({fecha:A.fecha,delta:A.tipo==="ingreso"?Math.abs(A.cuantia):-Math.abs(A.cuantia)})).sort((A,f)=>A.fecha.localeCompare(f.fecha));let y=0,I=new Date(i);for(;I<=r;){const A=p?new Date(I.getFullYear(),I.getMonth()+1,I.getDate()):new Date(I.getTime()+g),f=new Date(Math.min(A.getTime(),r.getTime()+1)),b=V(f);let m=0;for(;y<h.length&&h[y].fecha<b;)m+=h[y].delta,y++;const $=d,v=d+m,x=Math.max(0,($+v)/2);d=v;const M=p?u:(f.getTime()-I.getTime())/(365.25*864e5),S=x*(Math.pow(1+s.interes/100,M)-1);S>.001&&n.push({fecha:V(I),concepto:`Interés ${s.nombre}`,cuantia:S,tipo:"ingreso",tags:["interes","cuenta"],cuenta:s._id,sourceId:s._id,sourceType:"account-interest"}),I=A}}return n}function _a(t,e,a,o=null){const n=[],s=e||gt;for(const i of t){if(!i.activo||i.tipo!=="ingreso"||!i.sujetoIRPF)continue;const r=i.cuantia*(i.tipoFrecuencia==="mensual"?12:1),l=$a(r,s),p={...i,_id:i._id+"_irpf",concepto:`IRPF salario ${i.concepto}`,tipo:"gasto",cuantia:l,tags:["irpf","fiscal"]};n.push(...Jt([p],a,o))}return n}const xs=[5,11,2,8],$s={transporte:"Transporte",restaurante:"Restaurante",otros:"Beneficio"};function Pa(t,e,a=null,o=[],n=()=>gt){const s=[],i=G(e.start),r=G(e.end),l=o.length>0,p={};for(const d of t){const h=d.grupoNomina||"";p[h]||(p[h]=[]),p[h].push(d)}for(const d of Object.keys(p))p[d].sort((h,y)=>(y.bruto||0)-(h.bruto||0));function g(d,h){if(!l||!d.mesActualizacionIPC)return d.bruto||0;const y=d.fechaInicio||e.start,I=G(y),A=G(h);let f=0;for(let m=I.getFullYear();m<=A.getFullYear();m++){const $=new Date(m,d.mesActualizacionIPC-1,1);$>I&&$<=A&&f++}if(f===0)return d.bruto||0;const b=V(new Date(I.getFullYear()+f,0,1));return(d.bruto||0)*pt(o,y,b)}function u(d,h){const y=g(d,h),I=(d.retribucionFlexible||[]).reduce((E,F)=>E+(F.importe||0)*12,0),A=Math.max(0,y-I);if(d.irpfModo==="manual")return A*((d.irpfPct||0)/100);const f=n(parseInt(h.slice(0,4))),b=d.grupoNomina||"";if(!b)return ut(Mt(y,I),f);const m=p[b].filter(E=>E.activo),$=m.reduce((E,F)=>E+g(F,h),0),v=m.reduce((E,F)=>E+(F.retribucionFlexible||[]).reduce((w,P)=>w+(P.importe||0)*12,0),0),x=Math.max(0,$-v),M=Mt($,v),S=Math.max(0,y-I),C=x>0?M*(S/x):0,z=m.filter(E=>E._id!==d._id&&(E.bruto||0)>(d.bruto||0)).reduce((E,F)=>{const w=(F.retribucionFlexible||[]).reduce((T,R)=>T+(R.importe||0)*12,0),P=Math.max(0,g(F,h)-w);return E+(x>0?M*(P/x):0)},0);return ut(z+C,f)-ut(z,f)}for(const d of t){if(!d.activo)continue;const h=d.cuenta||"default";if(a&&a.length>0&&!a.includes(h))continue;const y=Math.max(1,d.nPagas||12),I=G(d.fechaInicio||e.start),A=d.fechaFin?G(d.fechaFin):r,f=b=>{const m=g(d,b),$=u(d,b),v=(d.retribucionFlexible||[]).reduce((w,P)=>w+(P.importe||0)*12,0),x=Math.max(0,m-v),M=(d.ssPct??6.35)/100,S=x*M,C=x/y,z=$/y,E=S/y,F=d.representacion==="simplificado"?C-E-z:C;s.push({fecha:b,concepto:d.nombre,cuantia:F,tipo:"ingreso",cuenta:h,tags:d.tags||[],sourceId:d._id,sourceType:"nomina"}),d.representacion==="detallado"&&(E>0&&s.push({fecha:b,concepto:`SS ${d.nombre}`,cuantia:E,tipo:"gasto",cuenta:h,tags:["seguridad-social","fiscal"],sourceId:d._id+"_ss",sourceType:"nomina"}),z>0&&s.push({fecha:b,concepto:`IRPF ${d.nombre}`,cuantia:z,tipo:"gasto",cuenta:h,tags:["irpf","fiscal"],sourceId:d._id+"_irpf",sourceType:"nomina"}));for(const w of d.retribucionFlexible||[])!w.cuenta||!(w.importe>0)||a&&a.length>0&&!a.includes(w.cuenta)||s.push({fecha:b,concepto:`${d.nombre} — ${$s[w.tipo]||w.tipo}`,cuantia:w.importe,tipo:"ingreso",cuenta:w.cuenta,tags:["retribucion-flexible",w.tipo],sourceId:`${d._id}_flex_${w._id||w.tipo}`,sourceType:"nomina"})};if(y<=12){const b=y===12?1:Math.round(12/y),m=I.getDate();let $=I.getFullYear(),v=I.getMonth();for(let x=0;x<300;x++){const M=new Date($,v+1,0).getDate(),S=new Date($,v,Math.min(m,M));if(S>r||S>A)break;S>=i&&S>=I&&f(V(S)),v+=b,v>=12&&($+=Math.floor(v/12),v=v%12)}}else{const b=y-12,m=I.getDate();let $=I.getFullYear(),v=I.getMonth();for(let S=0;S<300;S++){const C=new Date($,v+1,0).getDate(),z=new Date($,v,Math.min(m,C));if(z>r||z>A)break;z>=i&&z>=I&&f(V(z)),v++,v>=12&&($++,v=0)}const x=Math.max(I.getFullYear(),i.getFullYear()),M=Math.min((d.fechaFin?A:r).getFullYear(),r.getFullYear());for(let S=x;S<=M;S++)for(const C of xs.slice(0,b)){const z=new Date(S,C,15);z>=i&&z<=r&&z>=I&&z<=A&&f(V(z))}}}return s}function Ta(t,e,a,o=null,n="default"){const s=[];if(!e||e.length===0)return s;const i=G(a.start),r=G(a.end),l=Y(),p=t.filter(u=>u.activo&&u.tipo==="gasto"&&u.tipoFrecuencia==="mensual");let g=new Date(i.getFullYear(),i.getMonth(),1);for(;g<=r;){const u=g.getFullYear(),d=g.getMonth(),h=u+"-"+String(d+1).padStart(2,"0"),y=h+"-01",I=V(new Date(u,d+1,0)),A=V(new Date(u,d,15));let f=0;for(const b of p){if(o&&o.length>0&&!o.includes(b.cuenta||"default")||b.fechaInicio&&b.fechaInicio>I||b.fechaFin&&b.fechaFin<y)continue;const m=b.fechaInicio||l,$=pt(e,m,A);if($<=1)continue;const v=Math.max(1,b.frecuencia||1);f+=b.cuantia*($-1)/v}f>.01&&s.push({fecha:A,concepto:"Incremento coste de vida",cuantia:f,tipo:"gasto",tags:["inflacion"],cuenta:n,sourceId:"inflacion_vida_"+h,sourceType:"inflacion"}),g=new Date(u,d+1,1)}return s}function Da(t,e,a,o="default"){const n=[];if(!e||e.length===0||t<=0)return n;const s=G(a.start),i=G(a.end),r=[...e].sort((p,g)=>p.year-g.year);let l=new Date(s.getFullYear(),s.getMonth(),1);for(;l<=i;){const p=l.getFullYear(),g=l.getMonth(),u=p+"-"+String(g+1).padStart(2,"0"),d=V(new Date(p,g,15)),h=r.filter(b=>b.year<=p),y=h.length>0?h[h.length-1]:r[0],I=y?y.tasa/100:0,A=Math.pow(1+I,1/12)-1,f=t*A;f>.01&&n.push({fecha:d,concepto:"Pérdida ahorro por inflación",cuantia:f,tipo:"gasto",tags:["inflacion"],cuenta:o,sourceId:"inflacion_ahorro_"+u,sourceType:"inflacion"}),l=new Date(p,g+1,1)}return n}function Ra(t,e,a){const o=a.fechaReferencia||a.dashboardStart,n=o<a.dashboardStart?a.dashboardStart:o>a.dashboardEnd?a.dashboardEnd:o,s=e.reduce((u,d)=>u+Ut(d,n),0),i=t.filter(u=>u.fecha<n),r=t.filter(u=>u.fecha>=n),l=[];let p=s;for(const u of[...i].reverse()){const d=u.tipo==="ingreso"?Math.abs(u.cuantia):-Math.abs(u.cuantia);l.unshift({...u,delta:d,saldoAcum:p}),p-=d}const g=[];p=s;for(const u of r){const d=u.tipo==="ingreso"?Math.abs(u.cuantia):-Math.abs(u.cuantia);p+=d,g.push({...u,delta:d,saldoAcum:p})}return[...l,...g]}function Is(t,e,a,o=null){const n=e.filter(s=>s.activo&&(!o||o.length===0||o.includes(s._id)));return Ra([...t].sort((s,i)=>s.fecha.localeCompare(i.fecha)),n,a)}function Wt(t){const{loans:e,expenses:a,accounts:o,config:n}=t,s=t.filtroAccounts??null,i=t.nominas??[],r=t.inflacionPeriodos??[],l={start:n.dashboardStart,end:n.dashboardEnd},p=a.filter(I=>I.tipo!=="transferencia"),g=a.filter(I=>I.tipo==="transferencia"),u={accounts:o,nominas:i,resolverTramosIRPF:t.resolverTramosIRPF,resolverTramosGanancias:t.resolverTramosGanancias};let d=[];d=d.concat(Jt(p,l,s)),d=d.concat(ja(e,l,s)),d=d.concat(za(g,l,s,u)),d=d.concat(Ea(o,l,s));const h=Fa(o,l,s,d);if(d=d.concat(h),d=d.concat(_a(a,n.tramos_irpf,l,s)),d=d.concat(Pa(i,l,s,r,t.resolverTramosIRPF)),n.usarInflacion&&r.length>0){const I=(o.find(b=>b.activo&&b.esCuentaPrincipal)||o.find(b=>b.activo)||{_id:"default"})._id;d=d.concat(Ta(p,r,l,s,I));const f=o.filter(b=>b.activo&&(!s||s.length===0||s.includes(b._id))).reduce((b,m)=>b+Ut(m,n.dashboardStart),0);d=d.concat(Da(f,r,l,I))}d.sort((I,A)=>I.fecha.localeCompare(A.fecha));const y=o.filter(I=>I.activo&&(!s||s.length===0||s.includes(I._id)));return Ra(d,y,n)}function As(t,e,a=null){const o=Y(),s=e.filter(r=>r.activo&&(!a||a.length===0||a.includes(r._id))).reduce((r,l)=>r+rt(l),0),i=t.filter(r=>r.fecha<=o);return i.length===0?s:i[i.length-1].saldoAcum}function Na(t,e){const a=new Map;for(const o of t)if(o.tipo===e&&!(o.sourceType==="transfer-out"||o.sourceType==="transfer-in"||o.sourceType==="loan-amort"))for(const n of o.tags||["sin_tag"])a.set(n,(a.get(n)||0)+Math.abs(o.cuantia));return a}function Ms(t,e){const a=[];let o=!1;for(let n=0;n<t.length;n++){const s=t[n],i=s.saldoAcum;i<0&&(n===0||t[n-1].saldoAcum>=0)&&a.push({tipo:"saldo_negativo",fecha:s.fecha,saldo:i,mensaje:`Saldo negativo (${j(i)}) a partir del ${s.fecha}`}),e>0&&(i<e&&!o?(o=!0,a.push({tipo:"bajo_colchon",fecha:s.fecha,saldo:i,mensaje:`Saldo por debajo del colchón (${j(i)} < ${j(e)}) desde ${s.fecha}`})):i>=e&&o&&(o=!1,a.push({tipo:"recuperacion_colchon",fecha:s.fecha,saldo:i,mensaje:`Recuperación del colchón el ${s.fecha} (${j(i)})`})))}return a}function Ss(t,e){const a=t.filter(i=>i.tipo==="gasto"&&i.sourceType!=="loan-amort").reduce((i,r)=>i+Math.abs(r.cuantia),0),o=G(e.dashboardStart),n=G(e.dashboardEnd),s=Math.max(1,(n.getTime()-o.getTime())/(30.44*864e5));return a/s}function ws(t,e,a=Y()){const o=new Set,n=e.map(r=>{const l=r.fechaInicialSaldo||"",p={};l&&l<=a&&(p[l]=r.saldoInicial||0);for(const g of r.historicoSaldos||[])g.fecha<=a&&(!l||g.fecha>=l)&&(p[g.fecha]=g.saldo);return Object.keys(p).forEach(g=>o.add(g)),p}),s={};for(const r of[...o].sort()){let l=0;for(let p=0;p<e.length;p++){const g=Object.entries(n[p]).filter(([u])=>u<=r);g.length>0?(g.sort(([u],[d])=>d.localeCompare(u)),l+=g[0][1]):l+=e[p].saldoInicial||0}s[r]=l}const i=[];for(const[r,l]of Object.entries(s).sort(([p],[g])=>p.localeCompare(g))){const p=t.filter(h=>h.fecha<=r),g=p.length>0?p[p.length-1].saldoAcum:null;if(g===null)continue;const u=l-g,d=g!==0?u/Math.abs(g)*100:0;i.push({cuenta:"Total",fecha:r,estimado:g,real:l,desv:u,pct:d})}return i}const Cs=Object.freeze(Object.defineProperty({__proto__:null,calcDesviacion:ws,detectarPuntosCriticos:Ms,mediaMensualGastos:Ss},Symbol.toStringTag,{value:"Module"}));function Qt(t,e=new Date){const a=V(e),o=new Date(e);o.setMonth(o.getMonth()+1);const n=V(o),s=t.filter(r=>r.basico&&r.activo&&r.tipo==="gasto");return Jt(s,{start:a,end:n}).reduce((r,l)=>r+Math.abs(l.cuantia),0)}function Re(t){return(t||[]).filter(e=>e.basico&&e.activo&&!e.simulacion).reduce((e,a)=>e+Dt(a.capital,a.tin,a.meses),0)}function Oa(t,e,a,o){return e.colchonTipo==="fijo"&&(e.colchonFijo||0)>0?e.colchonFijo:(Qt(t,o)+Re(a))*(e.colchonMeses||6)}function qa(t,e,a,o,n){const i=[...e.colchonPuntos||[]].sort((l,p)=>l.fecha.localeCompare(p.fecha)).filter(l=>l.fecha<=o).pop();return i?i.tipo==="fijo"?i.importe||0:(Qt(t,n)+Re(a))*(i.meses||6):Oa(t,e,a,n)}function pe(t,e,a,o,n,s=!1,i){const r=[...t.puntos||[]].sort((g,u)=>g.fecha.localeCompare(u.fecha)),l=r.filter(g=>g.fecha<=n).pop()||(s?r[0]:null);return l?l.tipo==="fijo"?l.importe||0:(Qt(e,i)+Re(o))*(l.meses||1):0}function js(t){return typeof t.delta=="number"?t.delta:t.tipo==="ingreso"?Math.abs(t.cuantia):-Math.abs(t.cuantia)}function zs(t,e){const a={};for(const o of e)a[o._id]=rt(o);return t.map(o=>(o.cuenta&&a[o.cuenta]!==void 0&&(a[o.cuenta]+=js(o)),{fecha:o.fecha,saldos:{...a}}))}function Es(t,e,a,o,n,s,i){const r=[];for(const l of(t||[]).filter(p=>p.activo!==!1)){let p=!1;for(let g=0;g<e.length;g++){const u=e[g],d=pe(l,o,n,s,u.fecha,!1,i);if(d<=0){p=!1;continue}const h=!l.cuentas||l.cuentas.length===0?u.saldoAcum:l.cuentas.reduce((y,I)=>{var A,f;return y+(((f=(A=a[g])==null?void 0:A.saldos)==null?void 0:f[I])||0)},0);h<d&&!p?(p=!0,r.push({tipo:"bajo_margen",fecha:u.fecha,saldo:h,target:d,nombre:l.nombre,mensaje:`⚠ ${l.nombre}: ${j(h)} < ${j(d)} desde ${u.fecha}`})):h>=d&&p&&(p=!1,r.push({tipo:"recuperacion_margen",fecha:u.fecha,saldo:h,target:d,nombre:l.nombre,mensaje:`✓ ${l.nombre}: recuperado el ${u.fecha}`}))}}return r}const Fs=Object.freeze(Object.defineProperty({__proto__:null,calcColchon:Oa,calcColchonEnFecha:qa,calcGastoBasicoMensual:Qt,calcMargenEnFecha:pe,detectarCrucesMargenes:Es,saldosPorCuentaEnExtracto:zs},Symbol.toStringTag,{value:"Module"}));function _s(t){if(!t||t.showColchon===!1)return null;const e=t.colchonPuntos??[];return e.length>0?{nombre:"Colchón",puntos:[...e]}:t.colchonTipo==="fijo"&&(t.colchonFijo||0)>0?{nombre:"Colchón",puntos:[{fecha:"1970-01-01",tipo:"fijo",importe:t.colchonFijo}]}:{nombre:"Colchón",puntos:[{fecha:"1970-01-01",tipo:"meses",meses:t.colchonMeses||6}]}}function La(t,e){return Vt(G(t),G(e))}const Ps=["enero","febrero","marzo","abril","mayo","junio","julio","agosto","septiembre","octubre","noviembre","diciembre"];function ka(t,e){const[a,o,n]=t.split("-").map(Number),s=t.slice(0,4)===e.slice(0,4);return`${n} de ${Ps[o-1]}${s?"":` de ${a}`}`}function Ba(t){return t<=0?"hoy":t===1?"mañana":t<7?`en ${t} días`:t<14?"en una semana":t<31?`en ${Math.round(t/7)} semanas`:t<45?"en un mes":`en ${Math.round(t/30)} meses`}function Ts(t,e={}){const{hoy:a=Y(),horizonteCritico:o=365,horizonteAviso:n=120,maximo:s=4,incertidumbre:i}=e,r=[];for(const u of t.puntosCriticos??[])u.tipo==="saldo_negativo"?r.push({id:"saldo-negativo",gravedad:"critico",fecha:u.fecha,distancia:Math.abs(u.saldo),titulo:d=>d?"Podrías quedarte en números rojos":"Te quedas en números rojos",detalle:d=>`El ${d} el saldo proyectado baja a ${j(u.saldo)}.`}):u.tipo==="bajo_colchon"&&r.push({id:"bajo-colchon",gravedad:"aviso",fecha:u.fecha,distancia:Math.abs(u.saldo),titulo:d=>d?"Podrías bajar de tu colchón":"Bajas de tu colchón",detalle:d=>`El ${d} el saldo queda en ${j(u.saldo)}, por debajo del colchón.`});for(const u of t.crucesMargenes??[])u.tipo==="bajo_margen"&&r.push({id:`margen:${u.nombre}`,gravedad:"aviso",fecha:u.fecha,distancia:Math.max(0,u.target-u.saldo),titulo:d=>d?`Podrías bajar de «${u.nombre}»`:`Bajas de «${u.nombre}»`,detalle:d=>`El ${d} tendrías ${j(u.saldo)}, y el margen pide ${j(u.target)}.`});const l=new Map;for(const u of r){const d=l.get(u.id);(!d||u.fecha<d.fecha)&&l.set(u.id,u)}const p=[];for(const u of l.values()){const d=La(a,u.fecha);if(d<0||d>(u.gravedad==="critico"?o:n))continue;const h=i?i(d):0,y=h>0&&u.distancia<h;p.push({id:u.id,gravedad:u.gravedad,fecha:u.fecha,dias:d,plazo:Ba(d),titulo:u.titulo(y),detalle:u.detalle(ka(u.fecha,a)),incierto:y})}const g={critico:0,aviso:1};return p.sort((u,d)=>u.fecha.localeCompare(d.fecha)||g[u.gravedad]-g[d.gravedad]),p.slice(0,s)}const Ds=Object.freeze(Object.defineProperty({__proto__:null,colchonComoMargen:_s,construirAvisos:Ts,describirPlazo:Ba,diasEntreISO:La,fechaEnPalabras:ka},Symbol.toStringTag,{value:"Module"}));class Rs extends Error{constructor(a,o){super(`La funcionalidad "${a}" está desactivada; no se puede ${o}. Actívala en ⚙ Funcionalidades.`);ss(this,"featureId");this.name="FeatureDeshabilitadaError",this.featureId=a}}let Kt=null;function Ns(t){const e=Kt;return Kt=t,()=>{Kt=e}}function Ha(t){return Kt?Kt(t):!0}function Ga(t,e){if(!Ha(t))throw new Rs(t,e)}const Va=[];function Ne(){const t=new Map,e=new WeakMap;let a=1,o=0,n=0;const s=l=>{if(!l||typeof l!="object")return 0;const p=e.get(l);if(p)return p;const g=a++;return e.set(l,g),g},i=l=>l.map(p=>[p._id,p.capital,p.tin,p.meses,p.fechaInicio,p.comisionAmort||0,p.comisionApertura||0,p.diaPago||"",p.activo?1:0,p.cuenta||"",(p.amortizaciones||[]).map(g=>`${g.fecha}:${g.cantidad}:${g.tipo||""}`).sort().join(",")].join("|")).join(";");function r(l){const p=[i(l.loans),s(l.expenses),s(l.accounts),s(l.nominas),s(l.inflacionPeriodos),l.config.dashboardStart,l.config.dashboardEnd,l.config.fechaReferencia||"",l.config.usarInflacion?1:0,(l.filtroAccounts||[]).join(",")].join("#"),g=t.get(p);if(g)return n++,g;o++;const u=Wt(l);return t.set(p,u),u}return{statement:r,stats:()=>({hits:n,misses:o}),clear:()=>t.clear()}}function Oe(t,e,a,o,n={},s=Ne()){Ga("optimizador","calcular el plan de amortizaciones");const{frecuencia:i=1,mesesHorizonte:r=36,minAmortizable:l=500,tipoAmort:p="plazo",fechaPrimeraAmort:g=null,loanIds:u=null,nominas:d=Va,sourceAccountId:h=null,selectedMarginIds:y=null,hoy:I=new Date}=n,A=V(I),f=Math.min(120,Math.max(1,r)),b=a.filter(N=>N.activo),m=b.map(N=>N._id),$=b.find(N=>N.esCuentaPrincipal)||b[0],v=h&&m.includes(h)?b.find(N=>N._id===h):$,x=v==null?void 0:v._id,M=t.filter(N=>N.activo&&!N.simulacion&&(!u||u.includes(N._id))).sort((N,H)=>H.tin-N.tin),S=!!y&&y.length>0,C=(o.margenesSeguridad||[]).filter(N=>N.activo!==!1).filter(N=>!N.cuentas||N.cuentas.length===0||N.cuentas.includes(x)).filter(N=>!S||y.includes(N._id));if(M.length===0)return{plan:[],margenesAplicados:C.length,totalAmortizado:0,totalComisiones:0,totalAhorroIntereses:0,resumenPorLoan:[]};const z={};for(const N of M)z[N._id]=[];const E=[];function F(N){const H=new Date(I.getFullYear(),I.getMonth()+N,1),U=H.getFullYear(),Q=H.getMonth(),K=`${U}-${String(Q+1).padStart(2,"0")}`,st=V(new Date(U,Q,Math.min(15,new Date(U,Q+1,0).getDate())));return{label:K,dia15:st}}function w(N,H){const U=[...N.amortizaciones||[],...z[N._id]],{tabla:Q}=at({...N,amortizaciones:U}),K=Q.filter(nt=>nt.fecha<=H);if(K.length>0)return K[K.length-1].capitalPendiente;const st=U.filter(nt=>nt.fecha<=H).reduce((nt,vt)=>nt+vt.cantidad,0);return Math.max(0,N.capital-st)}function P(N){const H=t.map(it=>({...it,amortizaciones:[...it.amortizaciones||[],...z[it._id]||[]]})),U={...o,dashboardStart:A,dashboardEnd:N},Q=s.statement({loans:H,expenses:e,accounts:a,config:U,filtroAccounts:null,nominas:d}),K=b.reduce((it,Gt)=>it+rt(Gt),0),st=v?rt(v):0,nt=K>0?st/K:1;let vt=st,le=K;for(const it of Q){const Gt=it.delta??(it.tipo==="ingreso"?Math.abs(it.cuantia):-Math.abs(it.cuantia));it.cuenta===x?vt+=Gt:m.includes(it.cuenta)||(vt+=Gt*nt),le=it.saldoAcum}return{source:vt,total:le}}function T(N){const{source:H}=P(N);if(H<=0)return H;let U=0;for(const Q of C){const K=pe(Q,e,o,t,N,!0,I);K>U&&(U=K)}return H-U}const R=2;let O=0;if(g){for(let N=0;N<f;N++)if(F(N).dia15>=g){O=N;break}}for(let N=0;N<f;N++){if((N-O)%i!==0||N<O)continue;const{label:H,dia15:U}=F(N);if(U<A)continue;const Q=T(U)-R;if(Q<l)continue;let K=Q,st=0;for(const nt of M){if(K<l)break;const vt=w(nt,U);if(vt<1)continue;const le=nt.comisionAmort||0,it=1+le/100,Gt=Math.floor(K/it),as=Math.min(Gt,vt);if(as<l)continue;const ce=Math.min(Math.floor(as),Math.floor(vt)),os=+(ce*le/100).toFixed(2),la=ce+os;la>K||(z[nt._id].push({_id:`opt_${H}_${nt._id}`,fecha:U,cantidad:ce,tipo:p,simulacion:!0}),st+=la,E.push({mes:H,fechaAmort:U,loanId:nt._id,loanNombre:nt.nombre,tin:nt.tin,capitalAntes:vt,cantidadAmort:ce,comision:os,capitalDespues:Math.max(0,vt-ce),saldoDisponible:Q+R,excedente:Q,saldoDespues:Q+R-st,tipoAmort:p}),K-=la)}}const _=E.reduce((N,H)=>N+H.cantidadAmort,0),k=E.reduce((N,H)=>N+H.comision,0),L=M.map(N=>{const H=z[N._id];if(!H.length)return null;const U=at(N),Q=at({...N,amortizaciones:[...N.amortizaciones||[],...H]});return{loanId:N._id,nombre:N.nombre,tin:N.tin,fechaFinSin:U.fechaFin,fechaFinCon:Q.fechaFin,mesesAhorrados:U.mesesReales-Q.mesesReales,interesesSin:U.totalIntereses,interesesCon:Q.totalIntereses,ahorroIntereses:U.totalIntereses-Q.totalIntereses,numAmortizaciones:H.length,totalAmortizado:H.reduce((K,st)=>K+st.cantidad,0)}}).filter(N=>N!==null),B=L.reduce((N,H)=>N+H.ahorroIntereses,0);return{plan:E,margenesAplicados:C.length,totalAmortizado:_,totalComisiones:k,totalAhorroIntereses:B,resumenPorLoan:L}}function Ua(t,e,a,o,n={},s){Ga("comparador-frecuencias","comparar frecuencias de amortización");const{horizonte:i=60,minAmortizable:r=500,tipoAmort:l="plazo",fechaObjetivo:p=null,frecuencias:g=[1,2,3,6,12],fechaPrimeraAmort:u=null,loanIds:d=null,nominas:h=Va,sourceAccountId:y=null,selectedMarginIds:I=null,hoy:A=new Date}=n,f=s??Ne(),b=V(A),m=p||V(new Date(A.getFullYear(),A.getMonth()+i,1));function $(M){const S=t.map(F=>({...F,amortizaciones:[...F.amortizaciones||[],...M[F._id]||[]]})),C={...o,dashboardStart:b,dashboardEnd:m},z=f.statement({loans:S,expenses:e,accounts:a,config:C,filtroAccounts:null,nominas:h});if(z.length===0)return a.filter(F=>F.activo).reduce((F,w)=>F+rt(w),0);const E=z.filter(F=>F.fecha<=m);return E.length>0?E[E.length-1].saldoAcum:z[0].saldoAcum}const v=$({}),x=g.map(M=>{const S=Oe(t,e,a,o,{frecuencia:M,mesesHorizonte:i,minAmortizable:r,tipoAmort:l,fechaPrimeraAmort:u,loanIds:d,nominas:h,sourceAccountId:y,selectedMarginIds:I,hoy:A},f),C={};for(const E of t)C[E._id]=[];for(const E of S.plan)C[E.loanId].push({_id:E.mes+"_"+E.loanId,fecha:E.fechaAmort,cantidad:E.cantidadAmort,tipo:l,simulacion:!0});const z=$(C);return{frecuencia:M,label:M===1?"Mensual":`Cada ${M} meses`,numAmortizaciones:S.plan.length,totalAmortizado:S.totalAmortizado,totalComisiones:S.totalComisiones,ahorroIntereses:S.totalAhorroIntereses,saldoObjetivo:z,gananciaSaldo:z-v,valorTotal:S.totalAhorroIntereses+(z-v),plan:S.plan,resumenPorLoan:S.resumenPorLoan}}).filter(M=>M.numAmortizaciones>0);if(x.length>0){const M=Math.max(...x.map(z=>z.ahorroIntereses)),S=Math.max(...x.map(z=>z.saldoObjetivo)),C=Math.max(...x.map(z=>z.valorTotal));x.forEach(z=>{z.esMejorIntereses=z.ahorroIntereses===M,z.esMejorSaldo=z.saldoObjetivo===S,z.esMejorValor=z.valorTotal===C})}return{resultados:x,saldoBase:v,fechaObjetivo:m}}const Os=Object.freeze(Object.defineProperty({__proto__:null,compararFrecuencias:Ua,createStatementMemo:Ne,defaultHoyISO:Y,optimizarAmortizaciones:Oe},Symbol.toStringTag,{value:"Module"})),qs=30.44*864e5;function Ya(t){const e=t.getFullYear(),a=t.getMonth();return{desde:V(new Date(e,a,1)),hasta:V(new Date(e,a,Me(e,a)))}}function Ja(t){const[e,a]=t.split("-").map(Number);return Ya(new Date(e,a-1,1))}function Ls(t,e){return Math.max(1,(G(e).getTime()-G(t).getTime())/qs)}const ks=t=>t.filter(e=>e.sourceType!=="transfer-out"&&e.sourceType!=="transfer-in"),St=t=>t.reduce((e,a)=>e+Math.abs(a.cuantia),0);function Bs(t,e){const a=new Map(e.map(s=>[s._id,s.clasificacion]));let o=0,n=0;for(const s of t){if(s.tipo!=="gasto"||s.sourceType!=="expense")continue;const i=a.get(s.sourceId??"");i!==null&&(i==="deseo"?n+=Math.abs(s.cuantia):o+=Math.abs(s.cuantia))}return{basicos:o,deseo:n}}function Hs(t,e){const a=e.entreMeses&&e.entreMeses>0?e.entreMeses:1,o=d=>d.sourceType==="loan"&&d.tipo==="gasto",n=e.loanIdsIniciados,s=St(t.filter(d=>d.tipo==="ingreso")),i=St(t.filter(d=>o(d)&&(!n||n.has(d.sourceId??"")))),r=St(t.filter(d=>o(d)&&e.hipotecaIds.has(d.sourceId??""))),l=St(t.filter(d=>d.sourceType==="loan-amort")),p=St(t.filter(d=>d.sourceType==="account-interest")),{basicos:g,deseo:u}=Bs(t,e.expenses);return{ingresos:s/a,cuotas:i/a,cuotasHipoteca:r/a,amortizaciones:l/a,gastosBasicos:g/a,gastosDeseo:u/a,gastosTotales:(i+g+u)/a,intereses:p/a}}function Wa(t,e){return t.reduce((a,o)=>{const n=at(o).tabla.filter(s=>!s.esAmortizacion&&s.fecha<=e);return a+(n.length>0?n[n.length-1].capitalPendiente:o.capital||0)},0)}function Gs(t,e,a,o){const n=t.filter(p=>p.activo&&!p.simulacion&&(p.fechaInicio||"")<=a),s=n.reduce((p,g)=>{if((g.amortizaciones||[]).filter(y=>y.fecha>=e&&y.fecha<=a).length===0)return p;const d=at(g).totalIntereses,h=at({...g,amortizaciones:(g.amortizaciones||[]).filter(y=>y.fecha<e||y.fecha>a)}).totalIntereses;return p+Math.max(0,h-d)},0),i=n.filter(p=>p.mostrarFechaFinEnDashboard!==!1).map(p=>({loan:p,fechaFin:at(p).fechaFin})).filter(p=>!!p.fechaFin&&p.fechaFin>=e&&p.fechaFin<=a),r=n.map(p=>at(p).tabla),l=p=>{const{desde:g,hasta:u}=Ja(p);return r.reduce((d,h)=>{const y=h.find(I=>!I.esAmortizacion&&I.fecha>=g&&I.fecha<=u);return d+(y?y.cuota:0)},0)};return{deudaInicio:Wa(n,e),deudaFin:Wa(n,a),ahorroIntereses:s,ahorroInteresesMes:o>0?s/o:0,cuotasInicio:l(e.slice(0,7)),cuotasFin:l(a.slice(0,7)),finEnPeriodo:i}}function Vs(t,e){return e.filter(a=>a.activo&&(a.interes??0)>0).map(a=>({nombre:a.nombre,interes:a.interes,total:St(t.filter(o=>o.sourceType==="account-interest"&&o.sourceId===a._id))})).filter(a=>a.total>0).sort((a,o)=>o.total-a.total)}function Qa(t,e=new Set,a="desglosado"){if(e.size===0)return Na(t,"gasto");const o=new Map;for(const n of t){if(n.tipo!=="gasto")continue;const s=n.tags||[],i=s.filter(p=>e.has(p)),r=s.filter(p=>!e.has(p)),l=a==="porgrupos"&&i.length>0?i:r;for(const p of l)o.set(p,(o.get(p)||0)+Math.abs(n.cuantia))}return o}function Us(t,e={}){const a=e.activos,o=e.entreMeses&&e.entreMeses>0?e.entreMeses:1;return[...Qa(t,e.grupoTags,e.modo).entries()].filter(([n])=>!a||a.size===0||a.has(n)).map(([n,s])=>({tag:n,total:s/o})).sort((n,s)=>s.total-n.total)}function Ys(t,e){const a=e.reduce((o,n)=>o+rt(n),0);return{saldoBase:a,saldoFinal:t.length>0?t[t.length-1].saldoAcum??a:a,totalGastos:St(t.filter(o=>o.tipo==="gasto")),totalIngresos:St(t.filter(o=>o.tipo==="ingreso")),tags:[...new Set(t.flatMap(o=>o.tags||[]))]}}function Js(t,e){return t.filter(a=>a.activo&&(!e||e.length===0||e.includes(a._id)))}function Ws(t,e="hipoteca"){return new Set(t.filter(a=>(a.tags||[]).includes(e)).map(a=>a._id))}function Qs(t,e){return new Set(t.filter(a=>(a.fechaInicio||"")<=e).map(a=>a._id))}function Ks(t,e){if(t.length===0)return[];const a=p=>e==="mes"?p.slice(0,7):p.slice(0,4),o=p=>e==="mes"?`${p}-01`:`${p}-01-01`,n=t[0],s=n.delta??(n.tipo==="ingreso"?Math.abs(n.cuantia):-Math.abs(n.cuantia));let i=(n.saldoAcum??0)-s;const r=[];let l=null;for(const p of t){const g=a(p.fecha),u=p.saldoAcum??i;(!l||l.periodo!==g)&&(l&&(i=l.cierre),l={periodo:g,inicio:o(g),apertura:i,cierre:u,maximo:Math.max(i,u),minimo:Math.min(i,u),eventos:0},r.push(l)),l.cierre=u,u>l.maximo&&(l.maximo=u),u<l.minimo&&(l.minimo=u),l.eventos+=1}return r}const Xs=Object.freeze(Object.defineProperty({__proto__:null,agruparOHLC:Ks,cuentasVisibles:Js,gastoPorTagOrdenado:Us,idsHipoteca:Ws,idsPrestamosIniciados:Qs,interesesPorCuenta:Vs,mesesDelPeriodo:Ls,metricasFlujo:Hs,rangoMes:Ja,rangoMesDe:Ya,resumenPrestamosPeriodo:Gs,sinTransferencias:ks,sumarGastosPorTag:Qa,totalesPeriodo:Ys},Symbol.toStringTag,{value:"Module"}));function Zs(t,e,a){const o=t||[];if(!o.length)return e;const n=o.find(i=>i.año===a);if(n)return n.tramos;const s=o.filter(i=>i.año<a).sort((i,r)=>r.año-i.año);return s.length?s[0].tramos:e}function bt(t,e){return a=>Zs(t,e,a)}const Xt=8,Ka=[[0,19],[12450,24],[20200,30],[35200,37],[6e4,45],[3e5,47]],Xa=[[0,19],[6e3,21],[5e4,23],[2e5,27],[3e5,28]];function qe(t){return{_id:"default",nombre:"Default",descripcion:"Cuenta principal",saldo:0,saldoInicial:0,fechaInicialSaldo:t,historicoSaldos:[],interes:0,periodoCobro:"mensual",activo:!0,simulacion:!1,esCuentaPrincipal:!0,modeloFondo:"cuenta",aportaciones:[],planAportaciones:[],escenarioIds:[]}}function Za(t,e){return{dashboardStart:t,dashboardEnd:e,fechaReferencia:t,colchonMeses:6,colchonTipo:"meses",colchonFijo:0,colchonPuntos:[],showColchon:!0,margenesSeguridad:[],usarInflacion:!1,tramos_irpf:Ka,tramosGananciasCapital:Xa,showExecSummary:!0,showCriticos:!0,showHistorico:!0,histCuenta:"",analisisCollapsed:!1,activeTagsFilter:[],tagCategorias:[],tagGrupos:[],saludUmbralAhorroVerde:20,saludUmbralAhorroAmarillo:10,saludUmbralDTIVerde:30,saludUmbralDTIAmarillo:40,saludRegla:[50,30,20],saludExcluirHipoteca:!1,saludTagHipoteca:"hipoteca",storageMode:"local",autoSave:!1,autoSaveInterval:15,autoLogoutMinutos:0,onboardingDone:!1,escenarioActivo:null,features:{}}}function tn(t,e){return{loans:[],expenses:[],accounts:[qe(t)],nominas:[],goals:[],planes:[],transacciones:[],puntosControl:[],inflacion:[],tramosIRPFHistorico:[],tramosGananciasCapitalHistorico:[],escenarios:[],config:Za(t,e)}}const ht=t=>Array.isArray(t)?t:[],en=t=>t&&typeof t=="object"&&!Array.isArray(t)?t:{};function Zt(t){if(Array.isArray(t.escenarioIds))return t;const e=t.escenarioId?[t.escenarioId]:[],{escenarioId:a,...o}=t;return{...o,escenarioIds:e}}function to(t){if(!t||typeof t!="string")return"";if(t.startsWith("dia:")||t.startsWith("nthweekday:"))return t;if(t==="ultimo")return"dia:ultimo";if(t==="primer-lunes")return"nthweekday:1:1";const e=parseInt(t);return isNaN(e)?"":`dia:${e}`}function Le(t){const{varianza:e,inflacion:a,...o}=t;return o}function an(t,e){const{hoyISO:a,finISO:o}=e,n={...t},s=en(t.config),r={...Za(a,o)};for(const[g,u]of Object.entries(s))u!=null&&(r[g]=u);delete r.saldoInicial,delete r.saldoInicialFecha,delete r.inflacionGlobal,delete r.showMC,delete r.mcIteraciones,(!Array.isArray(r.tramos_irpf)||r.tramos_irpf.length===0)&&(r.tramos_irpf=Ka),(!Array.isArray(r.tramosGananciasCapital)||r.tramosGananciasCapital.length===0)&&(r.tramosGananciasCapital=Xa),(!Array.isArray(r.saludRegla)||r.saludRegla.length!==3)&&(r.saludRegla=[50,30,20]),(typeof r.features!="object"||r.features===null||Array.isArray(r.features))&&(r.features={}),n.config=r;let l=ht(t.accounts).map(g=>{const u={saldoInicial:0,fechaInicialSaldo:a,historicoSaldos:[],interes:0,periodoCobro:"mensual",activo:!0,simulacion:!1,esCuentaPrincipal:!1,aportaciones:[],planAportaciones:[],bloqueoMeses:120,impuestoRetirada:0,grupoNomina:"",...g};return u.modeloFondo||(u.modeloFondo=u.esFondoPension?"pension":"cuenta"),delete u.esFondoPension,Array.isArray(u.historicoSaldos)||(u.historicoSaldos=[]),Zt(u)});l.length===0&&(l=[qe(a)]);const p=l.filter(g=>g.esCuentaPrincipal);if(p.length===0){const g=l.find(u=>u._id==="default")||l[0];l=l.map(u=>({...u,esCuentaPrincipal:u._id===g._id}))}else if(p.length>1){let g=!1;l=l.map(u=>u.esCuentaPrincipal?g?{...u,esCuentaPrincipal:!1}:(g=!0,u):u)}return n.accounts=l,n.expenses=ht(t.expenses).map(g=>{const u={basico:!1,activo:!0,tags:[],historialPrecios:[],...g};return Array.isArray(u.tags)||(u.tags=[]),Array.isArray(u.historialPrecios)||(u.historialPrecios=[]),u.diaPago=to(u.diaPago),Le(Zt(u))}),n.loans=ht(t.loans).map(g=>{const u={tipoTasa:"fijo",mostrarFechaFinEnDashboard:!0,basico:!0,tags:[],activo:!0,amortizaciones:[],...g};return Array.isArray(u.tags)||(u.tags=[]),u.diaPago=to(u.diaPago),u.amortizaciones=ht(u.amortizaciones).map(d=>Zt(d)),Le(Zt(u))}),n.nominas=ht(t.nominas).map(g=>{const u={activo:!0,nPagas:12,irpfModo:"auto",irpfPct:0,bruto:0,representacion:"detallado",tags:[],fechaFin:null,cuenta:"default",grupoNomina:"",mesActualizacionIPC:null,retribucionFlexible:[],...g};return Array.isArray(u.tags)||(u.tags=[]),Array.isArray(u.retribucionFlexible)||(u.retribucionFlexible=[]),Le(Zt(u))}),n.goals=ht(t.goals).map((g,u)=>{const d=Array.isArray(g.cuentaIds)?g.cuentaIds:g.cuentaId?[g.cuentaId]:[],{cuentaId:h,...y}=g;return{prioridad:u+1,completado:!1,usarColchon:!0,targetAmount:0,...y,cuentaIds:d}}),n.inflacion=ht(t.inflacion),n.tramosIRPFHistorico=ht(t.tramosIRPFHistorico),n.tramosGananciasCapitalHistorico=ht(t.tramosGananciasCapitalHistorico),n.escenarios=ht(t.escenarios).map(({inversiones:g,...u})=>u),n}const Nt=t=>Array.isArray(t)?t:[];let ke=0;function on(t){return ke+=1,`${t}_${ke.toString(36)}`}const sn=t=>typeof t=="string"&&/^\d{4}-\d{2}-\d{2}$/.test(t),nn=t=>typeof t=="number"&&Number.isFinite(t);function rn(t,e){const a={...t};ke=0;const o=Nt(t.transacciones),n=Nt(t.puntosControl),s=[...n],i=new Set(n.map(p=>`${p.cuentaId}|${p.fecha}`)),r=(p,g,u,d)=>{if(!sn(g)||!nn(u))return;const h=`${p}|${g}`;i.has(h)||(i.add(h),s.push({_id:on("pc"),fecha:g,cuentaId:p,saldoCts:It(u),...typeof d=="string"&&d?{nota:d}:{}}))};for(const p of Nt(t.accounts)){const g=typeof p._id=="string"?p._id:null;if(g)for(const u of Nt(p.historicoSaldos))r(g,u.fecha,u.saldo,u.nota)}const l=Nt(t.history);if(l.length>0){const p=Nt(t.accounts),g=p.find(d=>d.esCuentaPrincipal)||p.find(d=>d.activo)||p[0],u=typeof(g==null?void 0:g._id)=="string"?g._id:"default";for(const d of l){const h=typeof d.cuenta=="string"?d.cuenta:typeof d.cuentaId=="string"?d.cuentaId:u;r(h,d.fecha,d.saldo,d.nota)}}return delete a.history,a.transacciones=o,a.puntosControl=s.sort((p,g)=>String(p.fecha).localeCompare(String(g.fecha))),a}const Be=t=>Array.isArray(t)?t:[],ln=t=>typeof t=="string"&&/^\d{4}-\d{2}-\d{2}$/.test(t),cn=t=>typeof t=="number"&&Number.isFinite(t)&&t>0;let He=0;function dn(){return He+=1,`tx_hp_${He.toString(36)}`}function un(t,e){const a={...t};He=0;const o=[...Be(t.transacciones)],n=new Set(o.map(i=>`${i.estimacionId}|${i.fecha}|${i.importeCts}`)),s=Be(t.expenses).map(i=>{const r=Be(i.historialPrecios),l=typeof i._id=="string"?i._id:null,p=typeof i.cuenta=="string"&&i.cuenta?i.cuenta:"default",g=i.tipo==="ingreso"?"ingreso":"gasto",u=Array.isArray(i.tags)?i.tags.filter(y=>typeof y=="string"):[];if(l)for(const y of r){if(!y||!ln(y.fecha)||!cn(y.cuantia))continue;const I=g==="ingreso"?It(y.cuantia):-It(y.cuantia),A=`${l}|${y.fecha}|${I}`;n.has(A)||(n.add(A),o.push({_id:dn(),fecha:y.fecha,cuentaId:p,importeCts:I,concepto:typeof i.concepto=="string"?i.concepto:"Movimiento",tags:u,estimacionId:l,tipo:g,origen:"importado",nota:typeof y.nota=="string"&&y.nota?y.nota:"Importado del historial de precios"}))}const{historialPrecios:d,...h}=i;return h});return a.expenses=s,a.transacciones=o.sort((i,r)=>String(i.fecha).localeCompare(String(r.fecha))),a}const eo=t=>Array.isArray(t)?t:[],wt=(t,e="")=>typeof t=="string"&&t.trim()?t:e,Ot=(t,e=0)=>typeof t=="number"&&Number.isFinite(t)?t:e,pn=t=>typeof t=="string"&&/^\d{4}-\d{2}/.test(t)?t.slice(0,7):null;function mn(t,e){var g;const a={...t};if(Array.isArray(a.planes))return a;const o=eo(a.goals),n=eo(a.accounts),s=n.map(u=>{const d=Ot(u.bloqueoMeses,0);return{_id:`veh_${wt(u._id,"x")}`,nombre:wt(u.nombre,"Cuenta"),rentabilidadRealAnual:Ot(u.interes,0)/100,liquidez:u.modeloFondo==="pension"?"BLOQUEADA_HASTA_JUBILACION":d>0?"MEDIA":"INMEDIATA",fiscalidadRetirada:Ot(u.impuestoRetirada,0)/100,topeAportacionAnual:u.modeloFondo==="pension"?It(1500):null,riesgo:u.modeloFondo==="pension"?"MEDIO":"NULO",cuentaId:wt(u._id,""),prestamoId:null,esDeuda:!1,revisarRentabilidad:Ot(u.interes,0)>0}}),i=new Map(n.map((u,d)=>[wt(u._id,""),s[d]._id])),r=((g=s[0])==null?void 0:g._id)??"",l=o.map((u,d)=>{const h=Array.isArray(u.cuentaIds)?u.cuentaIds.map(I=>wt(I,"")):[],y=pn(u.targetDate);return{_id:wt(u._id,`obj_mig_${d}`),nombre:wt(u.nombre,`Objetivo ${d+1}`),tipo:"AHORRO_OBJETIVO",importeObjetivo:It(Ot(u.targetAmount,0)),fechaLimite:y,prioridad:Ot(u.prioridad,d+1),modoAsignacion:y?"CUOTA_POR_FECHA":"ABSORBE_TODO",vehiculoId:i.get(h[0])??r,saldoActual:0,estado:u.completado===!0?"COMPLETADO":"PENDIENTE",notas:wt(u.notas,"")}}),p={_id:"plan_base",nombre:"Plan base",fechaInicio:e.hoyISO.slice(0,7),horizonteMeses:480,pctDisfrute:0,notas:o.length>0?"Creado al migrar los objetivos de ahorro anteriores. Revisa los saldos de partida y las rentabilidades reales.":"",activo:!0,perfil:{netoMensual:0,gastosFijosMensuales:0,manual:!1},vehiculos:s,objetivos:l,eventos:[],creadoEn:e.hoyISO};return a.planes=[p],a}const fn=[{version:5,describe:"Formaliza el esquema; limpia restos de features eliminadas; añade config.features",migrate:an},{version:6,describe:"Contabilidad real: crea transacciones y puntosControl (importa historicoSaldos y la clave history)",migrate:rn},{version:7,describe:"Retira historialPrecios: cada entrada pasa a ser una transacción real enlazada a su estimación",migrate:un},{version:8,describe:"Gestor de objetivos: absorbe `goals` dentro de un Plan, con un vehículo por cuenta",migrate:mn}],vn=["history"];function ao(t,e,a){let o=t;const n=[];for(const s of[...fn].sort((i,r)=>i.version-r.version))(e??0)>=s.version||(o=s.migrate(o,a),n.push(s.version));return{state:o,applied:n}}const me="state_",Ge="state__schemaVersion",oo="financeapp_",so="state__modificadoEn";function gn(t=localStorage,e=oo){const a=o=>`${e}${o}`;return{get(o){try{const n=t.getItem(a(o));return n===null?null:JSON.parse(n)}catch{return null}},set(o,n){try{t.setItem(a(o),JSON.stringify(n)),o!==so&&t.setItem(a(so),JSON.stringify(Date.now()))}catch(s){console.error("No se pudo guardar en localStorage:",o,s)}},remove(o){try{t.removeItem(a(o))}catch{}},keys(){const o=[];for(let n=0;n<t.length;n++){const s=t.key(n);s!=null&&s.startsWith(e)&&o.push(s.slice(e.length))}return o}}}function bn(t=localStorage,e=oo){const a=[];for(let n=0;n<t.length;n++){const s=t.key(n);s!=null&&s.startsWith(me)&&!s.startsWith(e)&&a.push(s)}const o=[];for(const n of a)try{const s=t.getItem(n);s!==null&&t.getItem(`${e}${n}`)===null&&(t.setItem(`${e}${n}`,s),o.push(n)),t.removeItem(n)}catch{}return o}function hn(t){return V(new Date(t.getFullYear()+1,t.getMonth(),t.getDate()))}function yn({adapter:t,hoy:e=new Date}){const a=V(e),o=hn(e);let n=tn(a,o);const s=new Set;let i=[];function r(C){for(const z of s)z(C)}function l(C){t.set(`${me}${C}`,n[C])}function p(){const C={};for(const w of Object.keys(n)){const P=t.get(`${me}${w}`);P!==null&&(C[w]=P)}for(const w of vn){const P=t.get(`${me}${w}`);P!==null&&(C[w]=P)}const z=t.get(Ge),{state:E,applied:F}=ao(C,z,{hoyISO:a,finISO:o});if(n=E,g(),F.length>0){for(const w of Object.keys(n))l(w);t.set(Ge,Xt)}return i=F,{applied:F}}function g(){if(!Array.isArray(n.accounts)||n.accounts.length===0){n.accounts=[qe(a)],l("accounts");return}const C=n.accounts.filter(z=>z.esCuentaPrincipal);if(C.length===0)n.accounts=n.accounts.map((z,E)=>E===0?{...z,esCuentaPrincipal:!0}:z),l("accounts");else if(C.length>1){let z=!1;n.accounts=n.accounts.map(E=>E.esCuentaPrincipal?z?{...E,esCuentaPrincipal:!1}:(z=!0,E):E),l("accounts")}}function u(C){return n[C]}function d(C,z){n[C]=z,l(C),r(C)}function h(C){d("config",{...n.config,...C})}function y(C){return s.add(C),()=>s.delete(C)}function I(){return Date.now().toString(36)+Math.random().toString(36).slice(2,7)}function A(C,z){const E=[...n[C]],F={...z,_id:I()};return E.push(F),d(C,E),F}function f(C,z,E){const F=n[C].map(w=>w._id===z?{...w,...E}:w);d(C,F)}function b(C,z){const E=n[C].filter(F=>F._id!==z);d(C,E)}function m(){const C=n.accounts||[],z=C.find(E=>E.esCuentaPrincipal&&E.activo)||C.find(E=>E.activo);return z?z._id:"default"}function $(C){var z;return((z=n.accounts.find(E=>E._id===C))==null?void 0:z.nombre)??C}function v(){return bt(n.tramosIRPFHistorico,n.config.tramos_irpf)}function x(){return bt(n.tramosGananciasCapitalHistorico,n.config.tramosGananciasCapital)}function M(){return structuredClone(n)}function S(C,z=null){const{state:E,applied:F}=ao(C,z,{hoyISO:a,finISO:o});n=E,g();for(const w of Object.keys(n))l(w);t.set(Ge,Xt);for(const w of Object.keys(n))r(w);return{applied:F}}return{load:p,get:u,set:d,patchConfig:h,subscribe:y,addItem:A,updateItem:f,removeItem:b,getPrincipalAccountId:m,accountName:$,resolverTramosIRPF:v,resolverTramosGanancias:x,snapshot:M,replaceAll:S,get schemaVersion(){return Xt},get migrationsApplied(){return[...i]},get today(){return a||Y()}}}const X={nucleo:"Esenciales",dinero:"Mi dinero",planificacion:"Planificación",analisis:"Análisis del dashboard",datos:"Datos y sincronización"},Ct=[{id:"dashboard",nombre:"Dashboard",descripcion:"Saldo actual, extracto proyectado y evolución. No se puede desactivar.",grupo:X.nucleo,porDefecto:!0,nucleo:!0},{id:"expenses",nombre:"Gastos e ingresos",descripcion:"Estimaciones recurrentes y extraordinarias, transferencias entre cuentas y etiquetas.",grupo:X.dinero,porDefecto:!0},{id:"loans",nombre:"Préstamos",descripcion:"Tablas de amortización, TAE y amortizaciones anticipadas.",grupo:X.dinero,porDefecto:!0},{id:"nominas",nombre:"Nóminas",descripcion:"Salarios con IRPF por tramos, pagas extra y retribución flexible.",grupo:X.dinero,porDefecto:!0},{id:"accounts",nombre:"Cuentas y ahorro",descripcion:"Cuentas, fondos de inversión, planes de pensiones y puntos de control de saldo.",grupo:X.dinero,porDefecto:!0},{id:"goals",nombre:"Objetivos de ahorro (antiguos)",descripcion:"Solo lectura: la copia previa al planificador. Los objetivos se gestionan en «Objetivos financieros». Apagada de fábrica; enciéndela si quieres revisar los antiguos antes de descartarlos.",grupo:X.dinero,porDefecto:!1,dependencias:["accounts"]},{id:"contabilidad",nombre:"Contabilidad real",descripcion:"Registro de gastos e ingresos reales y análisis de precisión de las estimaciones.",grupo:X.dinero,porDefecto:!0,dependencias:["accounts"]},{id:"supuestos",nombre:"Supuestos",descripcion:"Puntos de guardado sobre los que probar cambios, con biblioteca revisitable.",grupo:X.planificacion,porDefecto:!0},{id:"inflacion",nombre:"Inflación",descripcion:"Tasas anuales de IPC que encarecen los gastos y erosionan el ahorro.",grupo:X.planificacion,porDefecto:!1},{id:"fiscalidad",nombre:"Fiscalidad",descripcion:"Simulador de la declaración de la renta y tablas de tramos por ejercicio.",grupo:X.planificacion,porDefecto:!1},{id:"margenes",nombre:"Márgenes de seguridad",descripcion:"Umbrales mínimos de saldo por cuenta, con avisos al cruzarlos.",grupo:X.planificacion,porDefecto:!1},{id:"planner",nombre:"Objetivos financieros",descripcion:"Plan a largo plazo: objetivos que compiten por el flujo mensual y se encadenan al completarse.",grupo:X.planificacion,porDefecto:!0},{id:"optimizador",nombre:"Optimizador de amortizaciones",descripcion:"Planifica amortizaciones anticipadas con el excedente disponible cada mes.",grupo:X.planificacion,porDefecto:!1,dependencias:["loans"]},{id:"comparador-frecuencias",nombre:"Comparador de frecuencias",descripcion:"Compara amortizar cada mes, cada trimestre, etc. por ahorro de intereses.",grupo:X.planificacion,porDefecto:!1,dependencias:["optimizador"]},{id:"resumen-ejecutivo",nombre:"Resumen ejecutivo",descripcion:"Titulares del periodo: ingresos, gastos, ahorro y saldo final estimado.",grupo:X.analisis,porDefecto:!0},{id:"velas-saldo",nombre:"Velas del saldo",descripcion:"Apertura, cierre, máximo y mínimo del saldo por mes o por año.",grupo:X.analisis,porDefecto:!0},{id:"graficos-etiquetas",nombre:"Gráficos por etiqueta",descripcion:"Reparto y media mensual del gasto por etiqueta, con grupos de etiquetas.",grupo:X.analisis,porDefecto:!0},{id:"puntos-criticos",nombre:"Puntos críticos",descripcion:"Avisos de saldo negativo o por debajo del colchón en la proyección.",grupo:X.analisis,porDefecto:!0},{id:"precision-estimaciones",nombre:"Precisión de estimaciones",descripcion:"Acierto de cada estimación frente al gasto real, con ajuste sugerido.",grupo:X.analisis,porDefecto:!0,dependencias:["contabilidad","expenses"]},{id:"sync-nube",nombre:"Sincronización en la nube",descripcion:"Copia cifrada en Firebase o Dropbox, además del almacenamiento local.",grupo:X.datos,porDefecto:!0},{id:"autoguardado",nombre:"Autoguardado",descripcion:"Sube una copia a la nube cada cierto intervalo automáticamente.",grupo:X.datos,porDefecto:!1,dependencias:["sync-nube"]}],xn=new Map(Ct.map(t=>[t.id,t]));function te(t){return xn.get(t)}function no(t){return Ct.filter(e=>(e.dependencias||[]).includes(t))}function Ve(){const t={};for(const e of Ct)t[e.id]=e.porDefecto;return t}function io(){const t=[],e=new Map;for(const a of Ct)e.has(a.grupo)||(e.set(a.grupo,[]),t.push(a.grupo)),e.get(a.grupo).push(a);return t.map(a=>({grupo:a,features:e.get(a)}))}function $n(t){function e(){return{...Ve(),...t.get("config").features||{}}}function a(u){t.patchConfig({features:u})}function o(u,d=e(),h=new Set){const y=te(u);if(!y)return!1;if(y.nucleo)return!0;if(d[u]===!1)return!1;if(h.has(u))return!0;h.add(u);for(const I of y.dependencias||[])if(!o(I,d,h))return!1;return!0}function n(u,d=e()){const h=te(u);return h?(h.dependencias||[]).filter(y=>!o(y,d)):[]}function s(u,d){var m;const h=te(u);if(!h)return{cambiadas:[]};if(h.nucleo)return{cambiadas:[],motivo:"nucleo-inmutable"};const y=e(),I=new Map(Ct.map($=>[$.id,o($.id,y)])),A={...y,[u]:d};let f;if(d){const $=[...h.dependencias||[]];for(;$.length;){const v=$.pop();A[v]===!1&&(A[v]=!0,f="dependencias-activadas"),$.push(...((m=te(v))==null?void 0:m.dependencias)||[])}}else{const $=no(u).map(v=>v.id);for(;$.length;){const v=$.pop();A[v]!==!1&&(A[v]=!1,f="cascada-apagado"),$.push(...no(v).map(x=>x.id))}}return a(A),{cambiadas:Ct.filter($=>o($.id,A)!==I.get($.id)).map($=>$.id),motivo:f}}function i(){const u=e();return Ct.map(d=>{const h=n(d.id,u);return{...d,activa:o(d.id,u),...h.length>0&&u[d.id]!==!1?{bloqueadaPor:h}:{}}})}function r(){const u=e();return io().map(({grupo:d,features:h})=>({grupo:d,features:h.map(y=>{const I=n(y.id,u);return{...y,activa:o(y.id,u),...I.length>0&&u[y.id]!==!1?{bloqueadaPor:I}:{}}})}))}function l(){a(Ve())}function p(u){return{_app:"financeapp",_tipo:"feature-profile",_v:1,...u?{nombre:u}:{},features:e()}}function g(u){const d=u,h=d&&typeof d=="object"&&d.features&&typeof d.features=="object"?d.features:null;if(!h)throw new Error('El perfil no tiene una sección "features" válida');const y=Ve(),I=[],A=[];for(const[f,b]of Object.entries(h)){if(!te(f)){A.push(f);continue}if(typeof b!="boolean"){A.push(f);continue}y[f]=b,I.push(f)}return a(y),{aplicadas:I,ignoradas:A}}return{isEnabled:u=>o(u),setEnabled:s,estado:i,estadoPorGrupo:r,reset:l,exportProfile:p,importProfile:g,bloqueadaPor:u=>n(u)}}const ee=t=>t.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;");function qt(t,e,a="ok"){if(t.notify)return t.notify(e,a);const o=globalThis.UI;if(o!=null&&o.toast)return o.toast(e,a);console.info("[FinanceApp]",e)}function In(t){var n,s;const a=(((n=t.bloqueadaPor)==null?void 0:n.length)??0)>0?`<div style="font-size:11px;color:var(--yellow);margin-top:3px">Requiere: ${(s=t.bloqueadaPor)==null?void 0:s.map(ee).join(", ")}</div>`:"",o=t.nucleo?'<span style="font-size:10px;color:var(--text3);border:1px solid var(--border2);border-radius:3px;padding:1px 5px;margin-left:6px">siempre activa</span>':"";return`
    ...
    <input type="file" data-feature-file accept=".json" style="display:none"/>`}function Mn(t){var n;const e=t.getElementById("modal-overlay"),a=t.getElementById("modal-content");if(e&&a)return{overlay:e,content:a,cerrar:()=>e.classList.add("hidden")};let o=t.getElementById("fa-features-overlay");return o||(o=t.createElement("div"),o.id="fa-features-overlay",o.className="modal-overlay",o.innerHTML='<div class="modal-box"><button class="modal-close" data-feature-close>×</button><div id="fa-features-content"></div></div>',t.body.appendChild(o),o.addEventListener("click",s=>{s.target===o&&(o==null||o.classList.add("hidden"))}),(n=o.querySelector("[data-feature-close]"))==null||n.addEventListener("click",()=>o==null?void 0:o.classList.add("hidden"))),{overlay:o,content:t.getElementById("fa-features-content"),cerrar:()=>o==null?void 0:o.classList.add("hidden")}}function Sn(t){const e=t.document??document,{flags:a}=t;function o(i){i.innerHTML=`<div class="modal-title">Funcionalidades</div>${An(a)}`,n(i)}function n(i){var l,p,g;i.querySelectorAll("[data-feature-toggle]").forEach(u=>{u.addEventListener("change",()=>{var y;const d=u.dataset.featureToggle,h=a.setEnabled(d,u.checked);h.motivo==="dependencias-activadas"&&qt(t,"Se han activado también las funcionalidades necesarias"),h.motivo==="cascada-apagado"&&qt(t,"Se han desactivado las funcionalidades que dependían de esta","warn"),(y=t.onChange)==null||y.call(t,h.cambiadas),o(i)})});const r=i.querySelector("[data-feature-file]");(l=i.querySelector('[data-feature-action="export"]'))==null||l.addEventListener("click",()=>{const u=a.exportProfile(),d=new Blob([JSON.stringify(u,null,2)],{type:"application/json"}),h=URL.createObjectURL(d),y=e.createElement("a");y.href=h,y.download=`financeapp-funcionalidades-${new Date().toISOString().slice(0,10)}.json`,y.click(),URL.revokeObjectURL(h),qt(t,"Perfil de funcionalidades guardado")}),(p=i.querySelector('[data-feature-action="import"]'))==null||p.addEventListener("click",()=>r==null?void 0:r.click()),r==null||r.addEventListener("change",async()=>{var d,h;const u=(d=r.files)==null?void 0:d[0];if(u)try{const{aplicadas:y,ignoradas:I}=a.importProfile(JSON.parse(await u.text()));qt(t,I.length>0?`Perfil cargado (${y.length} aplicadas, ${I.length} ignoradas por ser de otra versión)`:`Perfil cargado (${y.length} funcionalidades)`),(h=t.onChange)==null||h.call(t,y),o(i)}catch(y){qt(t,"No se pudo cargar el perfil: "+y.message,"err")}finally{r.value=""}}),(g=i.querySelector('[data-feature-action="reset"]'))==null||g.addEventListener("click",()=>{var u;a.reset(),qt(t,"Funcionalidades restablecidas"),(u=t.onChange)==null||u.call(t,[]),o(i)})}function s(){const i=Mn(e);o(i.content),i.overlay.classList.remove("hidden")}return{open:s,renderInto:o}}const ro={expenses:"expenses",loans:"loans",nominas:"nominas",accounts:"accounts",supuestos:"escenarios",inflacion:"inflacion",fiscalidad:"rentas",margenes:"margenes"};function lo(t,e){t.querySelectorAll("[data-feature]").forEach(a=>{const o=a.dataset.feature;if(!o)return;const n=e(o);a.style.display=n?"":"none",n?(a.removeAttribute("aria-hidden"),"disabled"in a&&(a.disabled=!1)):(a.setAttribute("aria-hidden","true"),"disabled"in a&&(a.disabled=!0))})}function wn({flags:t,document:e=document,router:a,rutasExtra:o}){function n(){const r=e.querySelector(".nav-btn.active[data-view]");return(r==null?void 0:r.dataset.view)??null}function s(){let r=!1;const l=Object.entries((o==null?void 0:o())??{}).map(([p,g])=>[g,p]);for(const[p,g]of[...Object.entries(ro),...l]){const u=t.isEnabled(p),d=e.querySelector(`.nav-btn[data-view="${g}"]`);d&&(d.style.display=u?"":"none"),!u&&n()===g&&(r=!0)}if(e.querySelectorAll(".nav-section").forEach(p=>{const g=[...p.querySelectorAll(".nav-btn[data-view]")];if(g.length===0)return;const u=g.some(d=>d.style.display!=="none");p.style.display=u?"":"none"}),lo(e,p=>t.isEnabled(p)),r){const p=a??globalThis.Router;p==null||p.navigate("dashboard")}}function i(r=e.body){if(typeof MutationObserver>"u")return()=>{};let l=!1;const p=new MutationObserver(()=>{if(!l){l=!0;try{lo(e,g=>t.isEnabled(g))}finally{l=!1}}});return p.observe(r,{childList:!0,subtree:!0}),()=>p.disconnect()}return{apply:s,observar:i,vistaPara:r=>ro[r]}}function Cn({document:t=document,isEnabled:e}={}){const a=new Map;let o=null;function n(y){return`view-${y}`}function s(y){const I=t.getElementById(n(y.route));if(I)return I;const A=t.querySelector(".view-container");if(!A)return null;const f=t.createElement("div");return f.id=n(y.route),f.className="view hidden",A.appendChild(f),f}function i(y){if(t.querySelector(`.nav-btn[data-view="${y.route}"]`))return;const I=t.querySelectorAll(".nav-section"),A=I[y.seccion??Math.max(0,I.length-1)];if(!A)return;const f=t.createElement("button");f.className="nav-btn",f.dataset.view=y.route,f.innerHTML=`${y.iconoPath?`<svg viewBox="0 0 24 24"><path d="${y.iconoPath}"/></svg>`:""}<span>${y.nombre}</span>`,A.appendChild(f),f.addEventListener("click",()=>{const b=globalThis.Router;b==null||b.navigate(y.route)})}function r(y){a.set(y.route,y),s(y),i(y)}function l(){return[...a.keys()].filter(y=>{const I=a.get(y);return!e||e(I.flagId??I.id)})}function p(y){return l().includes(y)}function g(y){const I=a.get(y);if(!I||e&&!e(I.flagId??I.id))return!1;const A=s(I);if(!A)return!1;if(o&&o!==y){const f=a.get(o),b=t.getElementById(n(o));f!=null&&f.unmount&&b&&f.unmount(b)}return I.mount(A),o=y,!0}function u(){o&&g(o)}function d(){const y={};for(const[I,A]of a)y[I]=A.flagId??A.id;return y}function h(){for(const y of a.values())s(y),i(y)}return{register:r,routes:l,has:p,mount:g,rerender:u,flagPorRuta:d,attachToShell:h,get activa(){return o}}}function c(t){return String(t??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function Ft(t){return`<span style="color:${t<0?"var(--red)":t>0?"var(--accent)":"var(--text2)"}">${c(j(t))}</span>`}function co(t){return t===null?'<span style="color:var(--text3);font-size:12px">sin datos</span>':`<span style="color:${t>=90?"var(--accent)":t>=70?"var(--yellow)":"var(--red)"};font-weight:600">${t.toFixed(1)}%</span>`}function uo(t){return t.length===0?'<span style="color:var(--text3);font-size:11px">—</span>':t.map(e=>`<span class="tag">${c(e)}</span>`).join(" ")}const jn=["enero","febrero","marzo","abril","mayo","junio","julio","agosto","septiembre","octubre","noviembre","diciembre"];function Ue(t){const[e,a]=t.split("-").map(Number);return`${jn[a-1]} ${e}`}function q(t,e="ok"){const a=globalThis.UI;if(a!=null&&a.toast)return a.toast(t,e);console.info("[FinanceApp]",t)}function Z(t){const e=globalThis.UI;return e!=null&&e.confirm?e.confirm(t):typeof confirm=="function"?confirm(t):!0}function D(t,e,a){t.addEventListener("click",o=>{var s;const n=(s=o.target)==null?void 0:s.closest(e);n&&t.contains(n)&&a(n,o)})}function J(t,e,a){t.addEventListener("change",o=>{var s;const n=(s=o.target)==null?void 0:s.closest(e);n&&t.contains(n)&&a(n,o)})}function ft(t,e){var a;return((a=t.querySelector(e))==null?void 0:a.value)??""}function po(t,e){const a=parseFloat(ft(t,e));return Number.isFinite(a)?a:0}function zn(t){const[e,a]=t.split("-").map(Number),o=new Date(e,a,0).getDate();return{desde:`${t}-01`,hasta:`${t}-${String(o).padStart(2,"0")}`}}function En(t,e){const{ledger:a}=t,o=(t.hoy??Y)(),n=t.accounts().filter(b=>b.activo),{desde:s,hasta:i}=zn(e.mes),r={cuentaId:e.cuentaId||void 0,desde:s,hasta:i,texto:e.filtroTexto||void 0},l=a.transacciones(r),p=t.estimaciones().filter(b=>b.tipo!=="transferencia"),g=l.filter(b=>b.importeCts<0).reduce((b,m)=>b+m.importeCts,0),u=l.filter(b=>b.importeCts>0).reduce((b,m)=>b+m.importeCts,0),d=e.cuentaId?a.saldoCuenta(e.cuentaId,i):a.saldoTotal(i),h=e.cuentaId?a.puntosControl(e.cuentaId):a.puntosControl(),y=n.map(b=>`<option value="${c(b._id)}"${b._id===e.cuentaId?" selected":""}>${c(b.nombre)}</option>`).join(""),I=b=>'<option value="">— sin asignar —</option>'+p.map(m=>`<option value="${c(m._id)}"${m._id===b?" selected":""}>${c(m.concepto)} (${c(j(m.cuantia))})</option>`).join(""),A=l.map(b=>{var m;return`
      <tr data-tx="${c(b._id)}" style="border-bottom:1px solid var(--border)">
        ...
        <td style="padding:7px 8px">${uo(b.tags)}</td>
        <td style="padding:7px 8px;font-size:12px;color:var(--text2)">${c(((m=t.accounts().find($=>$._id===b.cuentaId))==null?void 0:m.nombre)??b.cuentaId)}</td>
      ...
      </tr>`}).join(""),f=h.slice().reverse().slice(0,8).map(b=>{var m;return`
      <div style="display:flex;align-items:center;gap:10px;padding:5px 0;border-bottom:1px solid var(--border);font-size:12px">
        ...
        <span style="color:var(--text3)">${c(((m=t.accounts().find($=>$._id===b.cuentaId))==null?void 0:m.nombre)??b.cuentaId)}</span>
    ...
    <div class="grid-2 mb-14" style="align-items:start">
      <div class="card">
        ...
        <div style="display:flex;gap:14px;flex-wrap:wrap;margin-bottom:12px;font-size:12px">
          <span>Gastos: ${Ft(et(g))}</span>
          <span>Ingresos: ${Ft(et(u))}</span>
          <span>Neto: ${Ft(et(u+g))}</span>
    ...
    </div>`}function Fn(t,e,a,o){const{ledger:n}=e;J(t,"#acc-cuenta",i=>{a.cuentaId=i.value,o()}),J(t,"#acc-mes",i=>{a.mes=i.value||a.mes,o()});const s=t.querySelector("#acc-buscar");s==null||s.addEventListener("input",()=>{a.filtroTexto=s.value,clearTimeout(s._t),s._t=window.setTimeout(o,200)}),D(t,"#nt-guardar",()=>{const i=ft(t,"#nt-concepto").trim(),r=po(t,"#nt-importe");if(!i)return q("Indica un concepto","err");if(!(r>0))return q("Indica un importe mayor que cero","err");const l=ft(t,"#nt-tags").split(",").map(p=>p.trim().toLowerCase()).filter(Boolean);n.registrar({fecha:ft(t,"#nt-fecha")||(e.hoy??Y)(),cuentaId:ft(t,"#nt-cuenta"),importe:r,concepto:i,tags:l,tipo:ft(t,"#nt-tipo"),estimacionId:ft(t,"#nt-estimacion")||null}),q("Movimiento registrado"),e.onDatosCambiados(),o()}),D(t,"[data-tx-borrar]",i=>{const r=i.dataset.txBorrar;Z("¿Eliminar este movimiento?")&&(n.eliminar(r),q("Movimiento eliminado"),e.onDatosCambiados(),o())}),D(t,"[data-tx-editar]",i=>{const r=i.dataset.txEditar,l=n.transacciones().find(u=>u._id===r);if(!l)return;const p=window.prompt(`Importe de "${l.concepto}" (€)`,String(Math.abs(et(l.importeCts))));if(p===null)return;const g=parseFloat(p.replace(",","."));if(!Number.isFinite(g)||g<=0)return q("Importe no válido","err");n.actualizar(r,{importe:g}),q("Movimiento actualizado"),e.onDatosCambiados(),o()}),J(t,"[data-tx-estimacion]",i=>{const r=i.getAttribute("data-tx-estimacion");n.asignarEstimacion(r,i.value||null),q("Asignación actualizada"),e.onDatosCambiados()}),D(t,"#pc-guardar",()=>{if(ft(t,"#pc-saldo").trim()==="")return q("Indica el saldo","err");const r=po(t,"#pc-saldo");n.registrarPuntoControl(ft(t,"#pc-cuenta"),ft(t,"#pc-fecha")||(e.hoy??Y)(),r,ft(t,"#pc-nota").trim()||void 0),q("Saldo real registrado"),e.onDatosCambiados(),o()}),D(t,"[data-pc-borrar]",i=>{Z("¿Eliminar este punto de control?")&&(n.eliminarPuntoControl(i.dataset.pcBorrar),q("Punto de control eliminado"),e.onDatosCambiados(),o())})}function Ye(t,e,a={}){const{umbralPrecision:o=90,variacionMinimaPct:n=5}=a;if(t.precision===null||t.mediaRealReciente===null||t.meses.length===0||t.precision>=o)return null;const s=W(t.mediaRealReciente),i=W(s-e),r=e!==0?i/Math.abs(e)*100:s!==0?100:0;if(Math.abs(r)<n)return null;const l=t.meses.slice(-3).length;return{estimacionId:t.estimacionId,concepto:t.concepto,cuantiaActual:W(e),cuantiaSugerida:s,diferencia:i,variacionPct:r,precision:t.precision,mesesConsiderados:l,motivo:i>0?`El gasto real de los últimos ${l} meses supera lo estimado`:`El gasto real de los últimos ${l} meses es inferior a lo estimado`}}function _n(t){function e(){return`exp_${Date.now().toString(36)}${Math.random().toString(36).slice(2,7)}`}function a(s,i,r={}){const l=r.hoy??Y(),p=t.get("expenses"),g=p.find(y=>y._id===s);if(!g)throw new Error(`La estimación ${s} no existe`);const u={...g,fechaFin:l},d={...g,_id:e(),cuantia:W(i),fechaInicio:l,fechaFin:g.fechaFin??null,ajustadaDesdeId:g._id,ajustadaEn:l},h=p.map(y=>y._id===s?u:y);return h.push(d),t.set("expenses",h),{estimacionCerrada:u,estimacionNueva:d}}function o(s,i={}){const r=[],l=[];for(const p of s)try{r.push(a(p.estimacionId,p.cuantiaSugerida,i))}catch(g){l.push({estimacionId:p.estimacionId,error:g.message})}return{aplicadas:r,errores:l}}function n(s){const i=t.get("expenses"),r=new Map(i.map(I=>[I._id,I])),l=r.get(s);if(!l)return[];const p=[];let g=l;const u=new Set;for(;g!=null&&g.ajustadaDesdeId&&!u.has(g._id);){u.add(g._id);const I=r.get(g.ajustadaDesdeId);if(!I)break;p.unshift(I),g=I}const d=[];let h=l;const y=new Set([l._id]);for(;;){const I=i.find(A=>A.ajustadaDesdeId===h._id&&!y.has(A._id));if(!I)break;y.add(I._id),d.push(I),h=I}return[...p,l,...d]}return{aplicar:a,aplicarTodas:o,cadena:n}}function Je(t){const e=t.estimaciones(),a=new Map(e.map(o=>[o._id,o]));return t.precision.analizarTodas(e).map(o=>{const n=a.get(o.estimacionId);return{analisis:o,estimacion:n,sugerencia:Ye(o,n.cuantia)}}).filter(o=>!!o.estimacion)}function Pn(t){const e=Je(t),a=e.filter(l=>l.analisis.precision!==null),o=e.filter(l=>l.sugerencia!==null),n=t.precision.analizarPorTag(e.map(l=>l.analisis));if(a.length===0)return`
      <div class="card mb-14">
      ...
      </div>`;const s=a.map(({analisis:l,estimacion:p,sugerencia:g})=>{const u=l.meses.slice(-6).map(d=>`${Ue(d.mes)}: ${j(d.estimado)} → ${j(d.real)} (${d.precision.toFixed(0)}%)`).join(" · ");return`
      <tr style="border-bottom:1px solid var(--border)">
        ...
        <td style="padding:8px;text-align:right;white-space:nowrap">
          ${g?`<button class="btn-secondary" data-sugerir="${c(l.estimacionId)}" style="padding:4px 9px;font-size:11px"
                   title="${c(g.motivo)}">Sugerir ajuste → ${c(j(g.cuantiaSugerida))}</button>`:'<span style="font-size:11px;color:var(--text3)">sin ajuste necesario</span>'}
        </td>
      </tr>`}).join(""),i=n.map(l=>`
      <tr style="border-bottom:1px solid var(--border)">
    ...
    </div>`}function Tn(t,e,a){D(t,"[data-sugerir]",o=>{const n=o.dataset.sugerir,s=Je(e).find(l=>l.analisis.estimacionId===n);if(!(s!=null&&s.sugerencia))return;const i=s.sugerencia,r=`${i.concepto}
...
La estimación actual se cerrará hoy y se creará su continuación con el nuevo importe. ¿Aplicar?`;Z(r)&&(e.adjuster.aplicar(n,i.cuantiaSugerida,{hoy:e.hoy()}),q(`Estimación ajustada a ${j(i.cuantiaSugerida)}`),e.onDatosCambiados(),a())}),D(t,"#ajustar-todas",()=>{const o=Je(e).map(r=>r.sugerencia).filter(r=>r!==null);if(o.length===0)return;const n=o.map(r=>`• ${r.concepto}: ${j(r.cuantiaActual)} → ${j(r.cuantiaSugerida)}`).join(`
`);if(!Z(`Se van a ajustar ${o.length} estimaciones:

${n}

¿Continuar?`))return;const{aplicadas:s,errores:i}=e.adjuster.aplicarTodas(o,{hoy:e.hoy()});q(i.length>0?`${s.length} ajustadas, ${i.length} con error`:`${s.length} estimaciones ajustadas`,i.length>0?"warn":"ok"),e.onDatosCambiados(),a()})}const Dn=[";",",","	","|"],Rn={fecha:["fecha","f. valor","fecha valor","fecha operacion","date","f.operacion","f. operacion"],concepto:["concepto","descripcion","detalle","movimiento","referencia","description","observaciones"],importe:["importe","cantidad","amount","euros","import"],debe:["debe","cargo","salida","pago","debito"],haber:["haber","abono","entrada","ingreso","credito"]};function fe(t){return t.normalize("NFD").replace(/[̀-ͯ]/g,"").toLowerCase().trim()}function ve(t,e){const a=[];let o="",n=!1;for(let s=0;s<t.length;s++){const i=t[s];n?i==='"'?t[s+1]==='"'?(o+='"',s++):n=!1:o+=i:i==='"'?n=!0:i===e?(a.push(o.trim()),o=""):o+=i}return a.push(o.trim()),a}function Nn(t){let e=";",a=-1;for(const o of Dn){const n=t.slice(0,20).map(l=>ve(l,o).length),s=Math.max(...n);if(s<2)continue;const r=n.filter(l=>l===s).length*10+s;r>a&&(a=r,e=o)}return e}function ae(t){let e=(t??"").trim();if(!e)return null;let a=!1;if(/^\(.*\)$/.test(e)&&(a=!0,e=e.slice(1,-1).trim()),e.endsWith("-")&&(a=!0,e=e.slice(0,-1).trim()),e.startsWith("-")&&(a=!0,e=e.slice(1).trim()),e.startsWith("+")&&(e=e.slice(1).trim()),e=e.replace(/[€$£\s  ]/g,""),!e)return null;const o=e.lastIndexOf(","),n=e.lastIndexOf(".");let s="";o>=0&&n>=0?s=o>n?",":".":o>=0?s=/,\d{3}$/.test(e)&&e.replace(/,/g,"").length>3?"":",":n>=0&&(s=/\.\d{3}$/.test(e)&&e.replace(/\./g,"").length>3?"":".");let i,r="0";if(s){const g=s===","?o:n;i=e.slice(0,g).replace(/[.,]/g,""),r=e.slice(g+1).replace(/[.,]/g,"")}else i=e.replace(/[.,]/g,"");if(!/^\d*$/.test(i)||!/^\d*$/.test(r)||i===""&&r==="")return null;const l=(r+"00").slice(0,2),p=Number(i||"0")*100+Number(l);return Number.isFinite(p)?a?-p:p:null}function We(t){const e=(t??"").trim();if(!e)return null;let a=e.match(/^(\d{4})[-/](\d{1,2})[-/](\d{1,2})/);if(a)return mo(Number(a[1]),Number(a[2]),Number(a[3]));if(a=e.match(/^(\d{1,2})[-/.](\d{1,2})[-/.](\d{2,4})/),a){let o=Number(a[3]);return o<100&&(o+=o<70?2e3:1900),mo(o,Number(a[2]),Number(a[1]))}return null}function mo(t,e,a){if(e<1||e>12||a<1||a>31)return null;const o=new Date(t,e-1,a);return o.getFullYear()!==t||o.getMonth()!==e-1||o.getDate()!==a?null:`${t}-${String(e).padStart(2,"0")}-${String(a).padStart(2,"0")}`}function fo(t){const e=t.filter(a=>a.trim());return e.length===0?0:e.filter(a=>We(a)!==null).length/e.length}function vo(t){const e=t.filter(a=>a.trim());return e.length===0?0:e.filter(a=>ae(a)!==null).length/e.length}function On(t,e){const a={fecha:-1,concepto:-1,importe:-1,debe:-1,haber:-1},o=new Set,n=s=>e.map(i=>i[s]??"");for(const s of["fecha","importe","debe","haber","concepto"])for(let i=0;i<t.length;i++){if(o.has(i))continue;const r=fe(t[i]);if(r&&Rn[s].some(l=>r===l||r.startsWith(l)||r.includes(l))){if(s==="importe"&&fe(t[i]).includes("saldo"))continue;a[s]=i,o.add(i);break}}if(a.fecha<0){let s=-1,i=.6;for(let r=0;r<t.length;r++){if(o.has(r))continue;const l=fo(n(r));l>i&&(i=l,s=r)}s>=0&&(a.fecha=s,o.add(s))}if(a.importe<0&&a.debe<0&&a.haber<0){let s=-1,i=.6;for(let r=0;r<t.length;r++){if(o.has(r)||fe(t[r]).includes("saldo"))continue;const l=vo(n(r));l>i&&(i=l,s=r)}s>=0&&(a.importe=s,o.add(s))}if(a.concepto<0){let s=-1,i=0;for(let r=0;r<t.length;r++){if(o.has(r))continue;const l=n(r);if(vo(l)>.5||fo(l)>.5)continue;const p=l.reduce((g,u)=>g+u.length,0)/Math.max(1,l.length);p>i&&(i=p,s=r)}s>=0&&(a.concepto=s)}return a}function qn(t){const e=t.replace(/^﻿/,"").split(/\r\n|\n|\r/).filter(g=>g.trim()!=="");if(e.length===0)return{separador:";",cabeceras:[],filas:[],lineaCabecera:0,mapeo:{fecha:-1,concepto:-1,importe:-1,debe:-1,haber:-1}};const a=Nn(e),o=e.map(g=>ve(g,a).length),n=Math.max(...o);let s=o.findIndex(g=>g===n);s<0&&(s=0);const i=ve(e[s],a);let r=e.slice(s+1).map(g=>ve(g,a));const l=We(i[0]??"")!==null||i.some(g=>ae(g)!==null&&/\d/.test(g));l&&(r=[i,...r]);const p=On(l?i.map(()=>""):i,r.slice(0,40));return{separador:a,cabeceras:l?i.map((g,u)=>`Columna ${u+1}`):i,filas:r,lineaCabecera:s+1,mapeo:p}}function go(t,e,a){return`${t}|${e}|${fe(a).replace(/\s+/g," ")}`}function Ln(t,e,a=[]){const o=new Set(a.map(s=>go(s.fecha,s.importeCts,s.concepto))),n=new Set;return t.filas.map((s,i)=>{const r=[],l=e.fecha>=0?We(s[e.fecha]??""):null;e.fecha<0?r.push("sin columna de fecha"):l||r.push(`fecha ilegible: «${s[e.fecha]??""}»`);let p=null;if(e.importe>=0)p=ae(s[e.importe]??""),p===null&&r.push(`importe ilegible: «${s[e.importe]??""}»`);else if(e.debe>=0||e.haber>=0){const d=e.debe>=0?ae(s[e.debe]??""):null,h=e.haber>=0?ae(s[e.haber]??""):null;d===null&&h===null?r.push("sin importe en Debe ni en Haber"):d!==null&&d!==0?p=-Math.abs(d):h!==null&&h!==0?p=Math.abs(h):p=0}else r.push("sin columna de importe");p===0&&r.push("importe cero");const g=(e.concepto>=0?s[e.concepto]??"":"").trim()||"Movimiento importado";let u=!1;if(l&&p!==null){const d=go(l,p,g);u=o.has(d)||n.has(d),n.add(d)}return{linea:t.lineaCabecera+1+i,fecha:l,concepto:g,importeCts:p,errores:r,duplicada:u}})}function kn(t,e){const a=t.filter(n=>n.errores.length===0&&(e||!n.duplicada)),o=a.map(n=>n.fecha).filter(n=>!!n).sort();return{total:t.length,importables:a.length,conError:t.filter(n=>n.errores.length>0).length,duplicadas:t.filter(n=>n.duplicada).length,sumaCts:a.reduce((n,s)=>n+(s.importeCts??0),0),desde:o[0]??null,hasta:o[o.length-1]??null}}function ge(){return{abierto:!1,nombreFichero:"",analisis:null,mapeo:null,filas:[],cuentaId:"",incluirDuplicadas:!1,error:""}}const Bn=[{clave:"fecha",etiqueta:"Fecha"},{clave:"concepto",etiqueta:"Concepto"},{clave:"importe",etiqueta:"Importe (con signo)"},{clave:"debe",etiqueta:"Debe (salidas)"},{clave:"haber",etiqueta:"Haber (entradas)"}];function Qe(t,e){if(!e.analisis||!e.mapeo){e.filas=[];return}const a=t.ledger.transacciones(e.cuentaId?{cuentaId:e.cuentaId}:{}).map(o=>({fecha:o.fecha,importeCts:o.importeCts,concepto:o.concepto}));e.filas=Ln(e.analisis,e.mapeo,a)}function Hn(t,e){const a=t.accounts().filter(n=>n.activo);if(!e.abierto)return`
      <div class="card">
    ...
    <div class="card">
      ...
      ${e.analisis&&e.mapeo?Vn(e,e.analisis,e.mapeo):Gn()}
    ...
    <div class="text-sm" style="color:var(--text3);line-height:1.7">
      ...
      antes de importar.
    </div>`}function Vn(t,e,a){const o=kn(t.filas,t.incluirDuplicadas),n=r=>`<option value="-1"${r<0?" selected":""}>— ninguna —</option>`+e.cabeceras.map((l,p)=>`<option value="${p}"${p===r?" selected":""}>${c(l||`Columna ${p+1}`)}</option>`).join(""),s=t.filas.filter(r=>r.errores.length>0),i=t.filas.slice(0,12);return`
    ...
    <div class="table-wrap mb-12">
      <table style="min-width:420px">
        ...
        <tbody>
          ${i.map(r=>{const l=r.errores.length>0,p=l?r.errores[0]:r.duplicada?"repetido":"se importa",g=l?"var(--red)":r.duplicada?"var(--yellow)":"var(--accent)";return`<tr style="${l?"opacity:0.55":""}">
                ...
                <td style="font-size:11px;color:${g}">${c(p)}</td>
              </tr>`}).join("")}
        </tbody>
      </table>
    </div>
    ...
    ${t.cuentaId?"":'<div class="text-sm mt-8" style="color:var(--yellow);text-align:right">Elige antes la cuenta de destino.</div>'}`}function Un(t,e,a,o){D(t,"[data-imp-abrir]",()=>{const s=e.accounts().filter(i=>i.activo);Object.assign(a,ge(),{abierto:!0,cuentaId:s.length===1?s[0]._id:""}),o()}),D(t,"[data-imp-cerrar]",()=>{Object.assign(a,ge()),o()}),J(t,"#imp-cuenta",s=>{a.cuentaId=s.value,Qe(e,a),o()}),J(t,"#imp-duplicadas",s=>{a.incluirDuplicadas=s.checked,o()}),J(t,"[data-imp-col]",s=>{const i=s,r=i.dataset.impCol;a.mapeo&&(a.mapeo[r]=Number(i.value),Qe(e,a),o())});const n=t.querySelector("#imp-fichero");n==null||n.addEventListener("change",()=>{var i;const s=(i=n.files)==null?void 0:i[0];s&&Yn(s).then(r=>{const l=qn(r);a.nombreFichero=s.name,a.error=l.filas.length===0?"El fichero no tiene ninguna línea de datos reconocible.":"",a.analisis=l,a.mapeo={...l.mapeo},Qe(e,a),o()}).catch(r=>{a.error=`No se ha podido leer el fichero: ${r.message}`,o()})}),D(t,"[data-imp-confirmar]",()=>{if(!a.cuentaId)return;const s=a.filas.filter(i=>i.errores.length===0&&(a.incluirDuplicadas||!i.duplicada));if(s.length!==0){for(const i of s)e.ledger.registrar({fecha:i.fecha,cuentaId:a.cuentaId,importe:Math.abs(et(i.importeCts)),tipo:i.importeCts<0?"gasto":"ingreso",concepto:i.concepto,origen:"importado"});q(`${s.length} movimiento${s.length!==1?"s":""} importado${s.length!==1?"s":""}`),Object.assign(a,ge()),e.onDatosCambiados(),o()}})}function Yn(t){return t.arrayBuffer().then(e=>{const a=new TextDecoder("utf-8").decode(e);if(!a.includes("�"))return a;try{return new TextDecoder("iso-8859-1").decode(e)}catch{return a}})}function Jn(t,e){if(t===0)return e===0?100:0;const a=Math.abs(e-t)/Math.abs(t);return Math.max(0,Math.min(100,(1-a)*100))}function Wn(t,e){const a=G(t),o=[];for(let n=1;n<=e;n++){const s=new Date(a.getFullYear(),a.getMonth()-n,1);o.push(`${s.getFullYear()}-${String(s.getMonth()+1).padStart(2,"0")}`)}return o.reverse()}function Qn(t){const[e,a]=t.split("-").map(Number),o=new Date(e,a,0);return{inicio:`${t}-01`,fin:`${t}-${String(o.getDate()).padStart(2,"0")}`}}function bo(t,e){const{inicio:a,fin:o}=Qn(e);return Jt([t],{start:a,end:o}).reduce((s,i)=>s+Math.abs(i.cuantia),0)}function Kn(t){function e(n,s={}){var $;const{mesesHistorial:i=12,mesesMedia:r=3,hoy:l=Y()}=s,p=t.transacciones({estimacionId:n._id}),u=p.length===0&&((($=n.tags)==null?void 0:$.length)??0)>0?t.transacciones({tags:n.tags}):p,d=new Map;for(const v of u){const x=v.fecha.slice(0,7);d.set(x,(d.get(x)??0)+Math.abs(v.importeCts)/100)}const h=[];for(const v of Wn(l,i)){const x=d.get(v);if(x===void 0)continue;const M=W(bo(n,v));h.push({mes:v,estimado:M,real:W(x),desviacion:W(x-M),precision:Jn(M,x)})}const y=W(h.reduce((v,x)=>v+x.estimado,0)),I=W(h.reduce((v,x)=>v+x.real,0)),A=h.reduce((v,x)=>v+Math.abs(x.estimado),0),f=h.length===0?null:A>0?h.reduce((v,x)=>v+x.precision*Math.abs(x.estimado),0)/A:h.reduce((v,x)=>v+x.precision,0)/h.length,b=h.slice(-r),m=b.length>0?W(b.reduce((v,x)=>v+x.real,0)/b.length):null;return{estimacionId:n._id,concepto:n.concepto,tags:n.tags??[],meses:h,estimadoTotal:y,realTotal:I,desviacionTotal:W(I-y),precision:f,mediaRealReciente:m,infraestimada:I>y}}function a(n,s={}){return n.filter(i=>i.tipo!=="transferencia").map(i=>e(i,s)).sort((i,r)=>i.precision===null&&r.precision===null?i.concepto.localeCompare(r.concepto):i.precision===null?1:r.precision===null?-1:i.precision-r.precision)}function o(n){const s=new Map;for(const i of n)if(i.precision!==null)for(const r of i.tags.length>0?i.tags:["sin_tag"]){const l=s.get(r)??{estimado:0,real:0,pesoPrecision:0,peso:0,n:0};l.estimado+=i.estimadoTotal,l.real+=i.realTotal,l.pesoPrecision+=i.precision*Math.abs(i.estimadoTotal),l.peso+=Math.abs(i.estimadoTotal),l.n+=1,s.set(r,l)}return[...s.entries()].map(([i,r])=>({tag:i,estimadoTotal:W(r.estimado),realTotal:W(r.real),desviacionTotal:W(r.real-r.estimado),precision:r.peso>0?r.pesoPrecision/r.peso:null,estimaciones:r.n})).sort((i,r)=>(i.precision??101)-(r.precision??101))}return{analizarEstimacion:e,analizarTodas:a,analizarPorTag:o}}function Xn(t){const[e,a]=t.split("-").map(Number),o=new Date(e,a,0).getDate();return{desde:`${t}-01`,hasta:`${t}-${String(o).padStart(2,"0")}`}}function Zn(t){const[e,a]=t.slice(0,7).split("-").map(Number),o=new Date(e,a-2,1);return`${o.getFullYear()}-${String(o.getMonth()+1).padStart(2,"0")}`}function ti(t){return t.normalize("NFD").replace(/[̀-ͯ]/g,"").toLowerCase().replace(/\d+/g,"").replace(/\s+/g," ").trim()}function ei(t,e,a){const o=new Map(e.map(s=>[s._id,[]])),n=e.filter(s=>{var i;return!a(s._id)&&(((i=s.tags)==null?void 0:i.length)??0)>0});for(const s of t){if(s.estimacionId&&o.has(s.estimacionId)){o.get(s.estimacionId).push(s);continue}if(s.estimacionId)continue;let i=null,r=0;for(const l of n){const p=(l.tags??[]).filter(g=>s.tags.includes(g)).length;p!==0&&(p>r||p===r&&i&&l._id<i._id)&&(i=l,r=p)}i&&o.get(i._id).push(s)}return o}function ai(t,e,a,o={}){const{desde:n,hasta:s}=Xn(a),i=t.transacciones({desde:n,hasta:s}),r=i.filter(m=>m.importeCts<0),l=i.filter(m=>m.importeCts>0),p=e.filter(m=>m.tipo==="gasto"&&m.activo!==!1),g=new Map((o.analisis??[]).map(m=>[m.estimacionId,m])),u=new Set(p.filter(m=>t.transacciones({estimacionId:m._id}).length>0).map(m=>m._id)),d=ei(r,p,m=>u.has(m)),h=new Set,y=p.map(m=>{const $=d.get(m._id)??[];for(const S of $)h.add(S._id);const v=W($.reduce((S,C)=>S+Math.abs(C.importeCts)/100,0)),x=W(bo(m,a)),M=g.get(m._id);return{estimacionId:m._id,concepto:m.concepto,tags:m.tags??[],estimado:x,real:v,desviacion:W(v-x),sinMovimiento:$.length===0,sugerencia:M?Ye(M,m.cuantia,{hoy:o.hoy}):null}}),I=new Map;for(const m of r){if(h.has(m._id))continue;const $=ti(m.concepto),v=I.get($)??{concepto:m.concepto,total:0,movimientos:0};v.total=W(v.total+Math.abs(m.importeCts)/100),v.movimientos+=1,I.set($,v)}const A=[...I.values()].sort((m,$)=>$.total-m.total),f=W(y.reduce((m,$)=>m+$.estimado,0)),b=W(r.reduce((m,$)=>m+Math.abs($.importeCts)/100,0));return{mes:a,estimado:f,real:b,desviacion:W(b-f),ingresosReales:W(l.reduce((m,$)=>m+$.importeCts/100,0)),filas:y.sort((m,$)=>Math.abs($.desviacion)-Math.abs(m.desviacion)),sinEstimacion:A,totalSinEstimacion:W(A.reduce((m,$)=>m+$.total,0)),vacio:i.length===0}}function ho(t){const e=new Set;for(const a of t.transacciones())e.add(a.fecha.slice(0,7));return[...e].sort().reverse()}function oi(){return{mes:""}}function Ke(t,e){if(e.mes)return e.mes;const a=ho(t.ledger),o=Zn((t.hoy??Y)());return a.includes(o)?o:a[0]??o}function Xe(t,e){const a=(t.hoy??Y)(),o=t.estimaciones(),n=t.precision.analizarTodas(o,{hoy:a});return ai(t.ledger,o,e,{analisis:n,hoy:a})}function si(t,e){const a=Ke(t,e),o=ho(t.ledger);o.includes(a)||o.unshift(a);const n=Xe(t,a),s=`
    ...
    <div class="card">
      ...
      ${ni(n)}
      ${ii(n)}
    </div>`}function ni(t){const e=t.filas.filter(o=>o.estimado>0||o.real>0);if(e.length===0)return'<div class="text-sm" style="color:var(--text3)">No tienes estimaciones de gasto activas para este mes.</div>';const a=e.filter(o=>o.sugerencia);return`
    ...
    ${a.length>0?`<div class="flex justify-between items-center mb-12" style="gap:10px;flex-wrap:wrap">
           ...
           </div>`:""}`}function ii(t){return t.sinEstimacion.length===0?`<div class="alert-card alert-info">
    ...
    ${t.sinEstimacion.length>10?`<div class="text-sm mt-8" style="color:var(--text3)">…y ${t.sinEstimacion.length-10} concepto(s) más.</div>`:""}`}function ri(t,e,a,o){J(t,"#cie-mes",n=>{a.mes=n.value,o()}),D(t,"[data-cie-ajustar]",n=>{const s=n.dataset.cieAjustar,r=Xe(e,Ke(e,a)).filas.find(l=>l.estimacionId===s);r!=null&&r.sugerencia&&(e.adjuster.aplicar(r.sugerencia.estimacionId,r.sugerencia.cuantiaSugerida,{hoy:(e.hoy??Y)()}),q(`«${r.concepto}» ajustada a ${j(r.sugerencia.cuantiaSugerida)}`),e.onDatosCambiados(),o())}),D(t,"[data-cie-ajustar-todas]",()=>{const s=Xe(e,Ke(e,a)).filas.map(l=>l.sugerencia).filter(l=>l!==null);if(s.length===0)return;const{aplicadas:i,errores:r}=e.adjuster.aplicarTodas(s,{hoy:(e.hoy??Y)()});q(`${i.length} estimación${i.length!==1?"es":""} ajustada${i.length!==1?"s":""}`+(r.length>0?` · ${r.length} con error`:"")),e.onDatosCambiados(),o()})}const li="M20 4H4c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 14H4V8h16v10zM6 10h5v2H6v-2zm0 4h8v2H6v-2z";function ci(t){const e={cuentaId:"",mes:(t.hoy??Y)().slice(0,7),filtroTexto:""},a=ge(),o=oi(),n=()=>{var u;return(u=t.onDatosCambiados)==null?void 0:u.call(t)},s=t.hoy??Y,i={ledger:t.ledger,accounts:t.accounts,estimaciones:t.estimaciones,tagsConocidas:()=>t.tags.todas(),onDatosCambiados:n,hoy:s},r={ledger:t.ledger,accounts:t.accounts,onDatosCambiados:n},l={ledger:t.ledger,precision:t.precision,adjuster:t.adjuster,estimaciones:t.estimaciones,onDatosCambiados:n,hoy:s},p={precision:t.precision,adjuster:t.adjuster,estimaciones:t.estimaciones,onDatosCambiados:n,hoy:s};function g(u){const d=t.ledger.saldoTotal(s()),h=t.ledger.ultimaFecha(),y=t.ledger.transacciones().length;u.innerHTML=`
      ...
      <div id="acc-precision" data-feature="precision-estimaciones"></div>`;const I=u.querySelector("#acc-importar"),A=u.querySelector("#acc-cierre"),f=u.querySelector("#acc-transacciones"),b=u.querySelector("#acc-precision");I.innerHTML=Hn(r,a),A.innerHTML=si(l,o),f.innerHTML=En(i,e),b.innerHTML=Pn(p);const m=()=>g(u);Un(I,r,a,m),ri(A,l,o,m),Fn(f,i,e,m),Tn(b,p,m)}return{id:"contabilidad",route:"contabilidad",nombre:"Contabilidad",flagId:"contabilidad",seccion:1,iconoPath:li,mount:g}}const di="M12 1L3 5v6c0 5.55 3.84 10.74 9 12 5.16-1.26 9-6.45 9-12V5l-9-4zm0 4l5 2.18V11c0 3.5-2.33 6.79-5 7.93-2.67-1.14-5-4.43-5-7.93V7.18L12 5z";function Ze(){return Date.now().toString(36)+Math.random().toString(36).slice(2,6)}function ui(t){const{store:e}=t,a=t.hoy??Y,o=()=>G(a()),n=()=>e.get("config").margenesSeguridad??[];function s(h){var y;e.patchConfig({margenesSeguridad:h}),(y=t.onDatosCambiados)==null||y.call(t)}function i(h,y){const I=n().map(f=>({...f,puntos:(f.puntos??[]).map(b=>({...b}))})),A=I.find(f=>f._id===h);A&&(y(A),s(I))}function r(h){const y=e.get("config"),I=pe(h,e.get("expenses"),y,e.get("loans"),a(),!1,o());return j(I)}function l(h,y,I){const A=y.tipo==="fijo",f=A?"":`<span class="text-sm" style="color:var(--text3)">${c(j((y.meses??0)*I))}</span>`;return`
      ...
      </tr>`}function p(h,y,I){const A=h.cuentas&&h.cuentas.length>0?h.cuentas.map($=>{var v;return((v=y.find(x=>x._id===$))==null?void 0:v.nombre)??$}).join(", "):"Todas las cuentas activas",b=[...h.puntos??[]].sort(($,v)=>$.fecha.localeCompare(v.fecha)).map($=>l(h,$,I)).join(""),m=h.activo?`
      ...
      <div class="card mb-8" style="padding:14px;border:1px solid var(--border)">
        ...
        ${m}
      </div>`}function g(h,y){const I=y?n().find(m=>m._id===y):null,A=e.get("accounts").filter(m=>m.activo),f=new Set((I==null?void 0:I.cuentas)??[]),b=A.map(m=>`
      ...
      </div>`}function u(h,y){const I=document.getElementById("modal-overlay"),A=document.getElementById("modal-content");!I||!A||(g(A,h),I.classList.remove("hidden"),J(A,".mg-acc-chip",f=>{const b=f,m=A.querySelector(`[data-chip="${b.value}"]`);m&&(m.style.cssText=`cursor:pointer;${b.checked?"border-color:var(--accent);color:var(--accent)":""}`)}),J(A,"#mg-p-tipo",f=>{const b=f.value==="fijo",m=A.querySelector("#mg-p-importe-wrap"),$=A.querySelector("#mg-p-meses-wrap");m&&(m.style.display=b?"":"none"),$&&($.style.display=b?"none":"")}),D(A,"[data-cerrar-form]",()=>I.classList.add("hidden")),D(A,"[data-guardar-margen]",f=>{var x,M,S,C,z;const b=f.getAttribute("data-guardar-margen")||"",m=((x=A.querySelector("#mg-nombre"))==null?void 0:x.value.trim())??"";if(!m)return q("El nombre es obligatorio","err");const $=[...A.querySelectorAll(".mg-acc-chip:checked")].map(E=>E.value),v=n().map(E=>({...E}));if(b){const E=v.findIndex(F=>F._id===b);if(E===-1)return q("Margen no encontrado","err");v[E]={...v[E],nombre:m,cuentas:$}}else{const E=((M=A.querySelector("#mg-p-tipo"))==null?void 0:M.value)??"fijo",F={_id:Ze(),fecha:((S=A.querySelector("#mg-p-fecha"))==null?void 0:S.value)||Y(),tipo:E,importe:parseFloat(((C=A.querySelector("#mg-p-importe"))==null?void 0:C.value)??"0")||0,meses:parseFloat(((z=A.querySelector("#mg-p-meses"))==null?void 0:z.value)??"1")||1};v.push({_id:Ze(),nombre:m,activo:!0,cuentas:$,puntos:[F]})}s(v),q(b?"Margen actualizado":"Margen creado"),I.classList.add("hidden"),y()}))}function d(h){const y=n(),I=e.get("accounts"),A=Qt(e.get("expenses"),o());h.innerHTML=`
      <div class="page-header">
        <div>
      ...
      ${y.length===0?`<div class="card" style="padding:24px;text-align:center">
             ...
             </div>`:y.map(b=>p(b,I,A)).join("")}`;const f=()=>d(h);D(h,"[data-nuevo-margen]",()=>u(null,f)),D(h,"[data-editar-margen]",b=>u(b.getAttribute("data-editar-margen"),f)),D(h,"[data-borrar-margen]",b=>{Z("¿Eliminar este margen de seguridad?")&&(s(n().filter(m=>m._id!==b.getAttribute("data-borrar-margen"))),q("Margen eliminado"),f())}),J(h,"[data-toggle-margen]",b=>{const m=b.getAttribute("data-toggle-margen");i(m,$=>{$.activo=b.checked}),f()}),D(h,"[data-add-punto]",b=>{const m=b.getAttribute("data-add-punto");i(m,$=>{$.puntos=[...$.puntos??[],{_id:Ze(),fecha:Y(),tipo:"fijo",importe:0,meses:1}]}),f()}),D(h,"[data-borrar-punto]",b=>{const m=b.closest("[data-punto]");if(!m)return;const $=m.dataset.margen,v=m.dataset.punto;i($,x=>{x.puntos=(x.puntos??[]).filter(M=>M._id!==v)}),f()}),J(h,"[data-campo]",b=>{const m=b.closest("[data-punto]");if(!m)return;const $=b.getAttribute("data-campo"),v=b.value;i(m.dataset.margen,x=>{const M=(x.puntos??[]).find(S=>S._id===m.dataset.punto);M&&($==="fecha"?M.fecha=v:$==="tipo"?M.tipo=v:$==="importe"?M.importe=parseFloat(v)||0:M.meses=parseFloat(v)||0)}),f()})}return{id:"margenes",route:"margenes",nombre:"Márgenes de seguridad",flagId:"margenes",seccion:2,iconoPath:di,mount:d}}const pi="https://api.worldbank.org/v2/country/ES/indicator/FP.CPI.TOTL.ZG?format=json&mrv=65&per_page=65";function mi(t){const e=Array.isArray(t)?t[1]??[]:[];return Array.isArray(e)?e.filter(a=>a&&a.value!==null&&a.value!==void 0&&Number.isFinite(Number(a.value))).map(a=>({year:parseInt(a.date),tasa:parseFloat(Number(a.value).toFixed(2))})).filter(a=>Number.isFinite(a.year)).sort((a,o)=>a.year-o.year):[]}function fi({fetchImpl:t,url:e=pi}={}){let a=null,o=!1;async function n(s=!1){if(a&&!s)return a;if(o)return null;o=!0;try{const r=await(t??fetch)(e);if(!r.ok)throw new Error(`HTTP ${r.status}`);return a=mi(await r.json()),a}catch(i){return console.error("[inflacion] No se pudo cargar el IPC del Banco Mundial:",i),null}finally{o=!1}}return{obtener:n,invalidar:()=>{a=null},get enCache(){return a}}}const vi="M16 6l2.29 2.29-4.88 4.88-4-4L2 16.59 3.41 18l6-6 4 4 6.3-6.29L22 12V6z";function gi(t){return t>5?"var(--red)":t>2.5?"var(--yellow)":"var(--accent)"}function bi(t){const{store:e}=t,a=t.ipc??fi(),o=()=>e.get("inflacion")??[];function n(){var u;(u=t.onDatosCambiados)==null||u.call(t)}function s(u,d){if(!u||u.length===0)return`
        ...
        </div>`;const h=new Set(o().map(b=>b.year)),y=u.filter(b=>b.year>=d).reverse(),I=y.filter(b=>!h.has(b.year)).length,A=[...new Set(u.map(b=>b.year))].sort((b,m)=>b-m),f=y.map(b=>`
        <div style="display:grid;grid-template-columns:20px 60px 80px 1fr;gap:10px;align-items:center;padding:5px 0;border-bottom:1px solid var(--border)">
          <input type="checkbox" class="ipc-chk" data-year="${b.year}" data-tasa="${b.tasa}" ${h.has(b.year)?"disabled":"checked"}/>
          <span style="font-family:var(--font-mono);font-weight:600">${b.year}</span>
          <span style="font-family:var(--font-mono);font-weight:600;color:${gi(b.tasa)}">${b.tasa.toFixed(2)}%</span>
          ${h.has(b.year)?'<span style="font-size:10px;color:var(--text3)">ya guardado</span>':'<span style="font-size:10px;color:var(--accent)">nuevo</span>'}
        </div>`).join("");return`
      ...
      </div>`}function i(u){return!u||u.length===0?2e3:Math.max(u[0].year,new Date().getFullYear()-25)}async function r(u){const d=document.getElementById("modal-overlay"),h=document.getElementById("modal-content");if(!d||!h)return;h.innerHTML=`
      ...
      </div>`,d.classList.remove("hidden");const y=(A,f)=>{const b=document.getElementById("ipc-body");b&&(b.innerHTML=s(A,f))},I=await a.obtener();y(I,i(I)),D(h,"[data-ipc-cerrar]",()=>d.classList.add("hidden")),J(h,"#ipc-desde",A=>{y(a.enCache,parseInt(A.value))}),D(h,"[data-ipc-recargar]",()=>{a.invalidar();const A=document.getElementById("ipc-body");A&&(A.innerHTML='<div style="text-align:center;padding:20px;color:var(--text3)">Recargando…</div>'),a.obtener(!0).then(f=>y(f,i(f)))}),D(h,"[data-ipc-importar]",()=>{const A=[...h.querySelectorAll(".ipc-chk:checked:not(:disabled)")];if(A.length===0)return q("Nada seleccionado","err");const f=new Set(o().map(m=>m.year));let b=0;for(const m of A){const $=parseInt(m.dataset.year??""),v=parseFloat(m.dataset.tasa??"");!Number.isFinite($)||!Number.isFinite(v)||f.has($)||(e.addItem("inflacion",{year:$,tasa:v}),f.add($),b++)}d.classList.add("hidden"),q(`${b} periodo${b!==1?"s":""} importado${b!==1?"s":""} correctamente`),n(),u()})}function l(u,d){var f;const h=document.getElementById("modal-overlay"),y=document.getElementById("modal-content");if(!h||!y)return;const I=u?o().find(b=>b._id===u):null;y.innerHTML=`
      ...
      </div>`,h.classList.remove("hidden");const A=()=>{var x;const b=parseFloat(((x=y.querySelector("#inf-tasa"))==null?void 0:x.value)??""),m=y.querySelector("#inf-preview");if(!m)return;if(!Number.isFinite(b)||b<=0){m.innerHTML="";return}const $=(Math.pow(1+b/100,1/12)-1)*100,v=Math.pow(1+b/100,5);m.innerHTML=`Con un ${b}% anual: <strong>${$.toFixed(3)}%/mes</strong> · factor acumulado a 5 años: <strong>×${v.toFixed(3)}</strong> (+${((v-1)*100).toFixed(1)}%)`};(f=y.querySelector("#inf-tasa"))==null||f.addEventListener("input",A),A(),D(y,"[data-inf-cerrar]",()=>h.classList.add("hidden")),D(y,"[data-inf-guardar]",b=>{const m=b.getAttribute("data-inf-guardar")||"",$=parseInt(y.querySelector("#inf-year").value),v=parseFloat(y.querySelector("#inf-tasa").value);if(!Number.isFinite($)||$<1900||$>2200)return q("Año inválido","err");if(!Number.isFinite(v)||v<0||v>100)return q("Tasa inválida (0–100%)","err");if(o().filter(M=>M._id!==m).some(M=>M.year===$))return q("Ya existe un periodo para ese año","err");m?(e.updateItem("inflacion",m,{year:$,tasa:v}),q("Periodo actualizado")):(e.addItem("inflacion",{year:$,tasa:v}),q("Periodo añadido")),h.classList.add("hidden"),n(),d()})}function p(u,d){const h=(Math.pow(1+u.tasa/100,.08333333333333333)-1)*100,y=`${u.year}-12-31`,I=y>d?pt([u],d,y):null;return`
      ...
      </div>`}function g(u){const d=o(),h=e.get("config").usarInflacion||!1,y=[...d].sort((x,M)=>M.year-x.year),I=Y(),A=new Date().getFullYear(),f=V(new Date(A+5,0,1)),b=V(new Date(A+10,0,1)),m=h&&d.length>0?pt(d,I,f):null,$=h&&d.length>0?pt(d,I,b):null;u.innerHTML=`
      <div class="page-header">
      ...
      <div class="card" style="padding:0;overflow:hidden">
        ...
        ${y.length===0?'<div class="text-sm" style="text-align:center;padding:30px;color:var(--text2)">Sin periodos configurados. Añade el primer registro.</div>':y.map(x=>p(x,I)).join("")}
      </div>
      ...
      </div>`;const v=()=>g(u);J(u,"[data-toggle-inflacion]",x=>{const M=x.checked;e.patchConfig({usarInflacion:M}),q(M?"Estimaciones de inflación activadas":"Estimaciones de inflación desactivadas"),n(),v()}),D(u,"[data-nuevo-periodo]",()=>l(null,v)),D(u,"[data-editar-periodo]",x=>l(x.getAttribute("data-editar-periodo"),v)),D(u,"[data-importar-ipc]",()=>void r(v)),D(u,"[data-borrar-periodo]",x=>{Z("¿Eliminar este periodo de inflación?")&&(e.removeItem("inflacion",x.getAttribute("data-borrar-periodo")),q("Periodo eliminado"),n(),v())})}return{id:"inflacion",route:"inflacion",nombre:"Inflación",flagId:"inflacion",seccion:2,iconoPath:vi,mount:g}}const hi=[...Array.from({length:31},(t,e)=>String(e+1)),"ultimo"],yi=[["1","1º"],["2","2º"],["3","3º"],["4","4º"],["5","5º"],["-1","Último"]],xi=[["1","lunes"],["2","martes"],["3","miércoles"],["4","jueves"],["5","viernes"],["6","sábado"],["0","domingo"]];function $i(t){const e=t||"";if(e.startsWith("dia:"))return{modo:"dia",dia:e.slice(4)||"1",nth:"1",wd:"1"};if(e.startsWith("nthweekday:")){const[,a="1",o="1"]=e.split(":");return{modo:"nthweekday",dia:"1",nth:a,wd:o}}return{modo:"none",dia:"1",nth:"1",wd:"1"}}const ta=(t,e)=>t.map(([a,o])=>`<option value="${c(a)}"${a===e?" selected":""}>${c(o)}</option>`).join("");function yo(t,e="dp"){const{modo:a,dia:o,nth:n,wd:s}=$i(t),i=ta(hi.map(r=>[r,r==="ultimo"?"Último día":r]),o);return`<div class="form-group" data-diapago="${c(e)}">
    ...
    <div class="flex gap-8 items-center" style="flex-wrap:wrap;row-gap:6px">
      ...
      <span data-dp-nth class="flex gap-8 items-center"${a!=="nthweekday"?' style="display:none"':""}>
        el
        <select class="form-select" data-dp-n style="width:auto;min-width:72px">${ta(yi,n)}</select>
        <select class="form-select" data-dp-wd style="width:auto;min-width:105px">${ta(xi,s)}</select>
        del mes
      </span>
    </div>
  </div>`}function xo(t){var o,n,s;const e=t.querySelector("[data-diapago]");if(!e)return;const a=((o=e.querySelector("[data-dp-modo]"))==null?void 0:o.value)??"none";(n=e.querySelector("[data-dp-dia]"))==null||n.style.setProperty("display",a==="dia"?"":"none"),(s=e.querySelector("[data-dp-nth]"))==null||s.style.setProperty("display",a==="nthweekday"?"":"none")}function $o(t){const e=t.querySelector("[data-diapago]");if(!e)return"";const a=n=>{var s;return((s=e.querySelector(n))==null?void 0:s.value)??""},o=a("[data-dp-modo]");return o==="dia"?`dia:${a("[data-dp-dnum]")}`:o==="nthweekday"?`nthweekday:${a("[data-dp-n]")}:${a("[data-dp-wd]")}`:""}const Ii="M11.8 10.9c-2.27-.59-3-1.2-3-2.15 0-1.09 1.01-1.85 2.7-1.85 1.78 0 2.44.85 2.5 2.1h2.21c-.07-1.72-1.12-3.3-3.21-3.81V3h-3v2.16c-1.94.42-3.5 1.68-3.5 3.61 0 2.31 1.91 3.46 4.7 4.13 2.5.6 3 1.48 3 2.41 0 .69-.49 1.79-2.7 1.79-2.06 0-2.87-.92-2.98-2.1h-2.2c.12 2.19 1.76 3.42 3.68 3.83V21h3v-2.15c1.95-.37 3.5-1.5 3.5-3.55 0-2.84-2.43-3.81-4.7-4.4z",Ai=[["extraordinario","Único / Extraordinario"],["diaria","Diaria"],["mensual","Mensual"]];function Mi(t){const e=t.hoy??Y,a={mostrarExpirados:!1,orden:"concepto",sentido:1,tipo:"",cuenta:"",desde:"",hasta:"",busqueda:"",tags:new Set},o=()=>{var f;return(f=t.onDatosCambiados)==null?void 0:f.call(t)},n=()=>t.store.get("accounts"),s=f=>{var b;return((b=n().find(m=>m._id===(f||"default")))==null?void 0:b.nombre)??(f||"default")};function i(){const f=e();let b=[...t.store.get("expenses")];if(a.mostrarExpirados||(b=b.filter(m=>!m.fechaFin||m.fechaFin>=f)),a.tipo&&(b=b.filter(m=>m.tipo===a.tipo)),a.cuenta&&(b=b.filter(m=>(m.cuenta||"default")===a.cuenta)),a.desde&&(b=b.filter(m=>(m.fechaInicio??"")>=a.desde)),a.hasta&&(b=b.filter(m=>(m.fechaInicio??"")<=a.hasta)),a.busqueda){const m=a.busqueda.toLowerCase();b=b.filter($=>$.concepto.toLowerCase().includes(m))}return a.tags.size>0&&(b=b.filter(m=>(m.tags||[]).some($=>a.tags.has($)))),b.sort((m,$)=>{const v=m[a.orden]??"",x=$[a.orden]??"";return typeof v=="number"&&typeof x=="number"?(v-x)*a.sentido:String(v).localeCompare(String(x))*a.sentido})}function r(){return[...new Set(t.store.get("expenses").flatMap(f=>f.tags||[]))].filter(Boolean).sort()}function l(f,b){const m=a.orden===f?a.sentido===1?"↑":"↓":"";return`<span class="exp-col-head" data-orden="${f}">${c(b)} <span class="sort-arrow">${m}</span></span>`}function p(f,b=!1){return(b?'<option value="">Todas las cuentas</option>':"")+n().filter($=>$.activo!==!1).map($=>`<option value="${c($._id)}"${$._id===f?" selected":""}>${c($.nombre)}</option>`).join("")}function g(f){const b=f.tipo==="transferencia",m=Se(f.diaPago??""),$=f.tipoFrecuencia==="extraordinario"?"Único":`Cada ${f.frecuencia??1} ${f.tipoFrecuencia==="diaria"?"día(s)":"mes(es)"}${m?` · ${m}`:""}`,v=!!f.fechaFin&&f.fechaFin<e(),x=b?'<span class="badge badge-purple">⇄ transf.</span>':f.tipo==="ingreso"?'<span class="badge badge-active">ingreso</span>':'<span class="badge badge-red">gasto</span>',M=b?`${c(s(f.cuenta))} → ${c(s(f.cuentaDestino))}`:c(s(f.cuenta)),S=(f.tags||[]).map(C=>`<span class="tag${a.tags.has(C)?" active":""}" data-tag="${c(C)}" title="Filtrar por ${c(C)}">${c(C)}</span>`).join("");return`<div class="exp-table-row">
      <div>
        <div style="font-weight:500">${c(f.concepto)}</div>
        <div class="tag-list mt-4">${S}</div>
      </div>
      <div>${x}</div>
      <div class="num ${f.tipo==="ingreso"?"pos":b?"":"neg"}">${b?"⇄ ":""}${c(j(f.cuantia))}</div>
    ...
    </div>`}function u(f){const b=i(),m=r();f.innerHTML=`
      <div class="page-header">
      ...
      <div class="card" style="padding:0;overflow:hidden">
        ...
        ${b.length===0?'<div class="text-sm" style="text-align:center;padding:30px">Sin resultados.</div>':b.map(g).join("")}
      </div>`}function d(f){const b=(f==null?void 0:f.tipo)==="transferencia",m=t.store.get("escenarios"),$=(f==null?void 0:f.escenarioIds)||[],v=(x,M,S,C,z="")=>`<div class="form-group"><label class="form-label">${c(M)}</label>
      ...
      <div class="grid-3 mt-8">
        ...
        <div class="form-group"><label class="form-label">Tipo frecuencia</label>
          <select class="form-select" id="ef-tipo-frec">
            ${Ai.map(([x,M])=>`<option value="${x}"${((f==null?void 0:f.tipoFrecuencia)??"mensual")===x?" selected":""}>${c(M)}</option>`).join("")}
          </select>
        </div>
      </div>
      ...
      </div>`}function h(f){var $;const b=(($=f.querySelector("#ef-tipo"))==null?void 0:$.value)??"gasto",m=(v,x)=>{const M=f.querySelector(v);M&&(M.style.display=x?"":"none")};m("#ef-destino-wrap",b==="transferencia"),m("#ef-basico-wrap",b!=="transferencia"),m("#ef-irpf-wrap",b==="ingreso"),m("#ef-clasificacion-wrap",b==="gasto")}function y(f,b,m){const $=document.getElementById("modal-overlay"),v=document.getElementById("modal-content");!$||!v||(v.innerHTML=`<div class="modal-title">${c(b)}</div>${d(f)}`,$.classList.remove("hidden"),J(v,"#ef-tipo",()=>h(v)),J(v,"[data-dp-modo]",()=>xo(v)),D(v,"[data-cancelar]",()=>$.classList.add("hidden")),D(v,"[data-guardar]",x=>{I(v,x.getAttribute("data-guardar")||"")&&($.classList.add("hidden"),m())}))}function I(f,b){const m=E=>{var F;return((F=f.querySelector(E))==null?void 0:F.value)??""},$=E=>{var F;return!!((F=f.querySelector(E))!=null&&F.checked)},v=m("#ef-tipo")||"gasto",x=v==="transferencia",M=m("#ef-concepto").trim(),S=parseFloat(m("#ef-cuantia"));if(!M||!Number.isFinite(S))return q("Concepto y cuantía obligatorios","err"),!1;const C=m("#ef-clasificacion"),z={concepto:M,tipo:v,cuantia:S,frecuencia:parseInt(m("#ef-frecuencia"),10)||1,tipoFrecuencia:m("#ef-tipo-frec")||"mensual",fechaInicio:m("#ef-fecha-ini"),fechaFin:m("#ef-fecha-fin")||null,diaPago:$o(f),cuenta:m("#ef-cuenta"),cuentaDestino:x?m("#ef-cuenta-dest")||"default":void 0,activo:$("#ef-activo"),basico:!x&&$("#ef-basico"),sujetoIRPF:!x&&$("#ef-sujetoIRPF"),clasificacion:v==="gasto"?C||null:void 0,tags:x?["transferencia"]:m("#ef-tags").split(",").map(E=>E.trim()).filter(Boolean),escenarioIds:[...f.querySelectorAll(".ef-escenario:checked")].map(E=>E.value)};return b?(t.store.updateItem("expenses",b,z),q("Actualizado")):(t.store.addItem("expenses",z),q("Creado")),o(),!0}function A(f,b){const m=f.querySelector("[data-busqueda]");let $;m==null||m.addEventListener("input",()=>{clearTimeout($),$=setTimeout(()=>{a.busqueda=m.value,b();const v=f.querySelector("[data-busqueda]");v==null||v.focus(),v==null||v.setSelectionRange(v.value.length,v.value.length)},250)}),J(f,"[data-expirados]",v=>{a.mostrarExpirados=v.checked,b()}),J(f,"[data-f-tipo]",v=>{a.tipo=v.value,b()}),J(f,"[data-f-cuenta]",v=>{a.cuenta=v.value,b()}),J(f,"[data-f-desde]",v=>{a.desde=v.value,b()}),J(f,"[data-f-hasta]",v=>{a.hasta=v.value,b()}),D(f,"[data-limpiar]",()=>{a.tipo="",a.cuenta="",a.desde="",a.hasta="",a.busqueda="",a.tags=new Set,b()}),D(f,"[data-limpiar-tags]",()=>{a.tags=new Set,b()}),D(f,"[data-tag]",v=>{const x=v.getAttribute("data-tag");a.tags.has(x)?a.tags.delete(x):a.tags.add(x),b()}),D(f,"[data-orden]",v=>{const x=v.getAttribute("data-orden");a.orden===x?a.sentido=a.sentido===1?-1:1:(a.orden=x,a.sentido=1),b()}),D(f,"[data-nuevo]",()=>y(null,"Nuevo gasto/ingreso",b)),D(f,"[data-editar]",v=>{const x=t.store.get("expenses").find(M=>M._id===v.getAttribute("data-editar"));x&&y(x,"Editar",b)}),D(f,"[data-duplicar]",v=>{const x=t.store.get("expenses").find(C=>C._id===v.getAttribute("data-duplicar"));if(!x)return;const{_id:M,...S}=x;y({...S,concepto:`${x.concepto} (copia)`},"Duplicar movimiento",b)}),D(f,"[data-borrar]",v=>{Z("¿Eliminar?")&&(t.store.removeItem("expenses",v.getAttribute("data-borrar")),q("Eliminado"),o(),b())}),J(f,"[data-activo]",v=>{const x=v;t.store.updateItem("expenses",x.getAttribute("data-activo"),{activo:x.checked}),o(),b()})}return{id:"expenses",route:"expenses",nombre:"Gastos e Ingresos",flagId:"expenses",seccion:1,iconoPath:Ii,mount(f){const b=()=>u(f);u(f),f.dataset.wired!=="1"&&(A(f,b),f.dataset.wired="1")}}}function be(t,e,a){return t.reduce((o,n)=>{if(n.esAmortizacion)return o;const s=pt(e,a,n.fecha);return o+(s>0?n.interes/s:n.interes)},0)}function Io(t,e,a,o){return t.reduce((n,s)=>{const i=pt(e,a,s.fecha),r=s.esAmortizacion?s.amortizacion+s.comisionAmort:s.cuota;return n+(i>0?r/i:r)},0)+o}function Si(t,e,a){const o=t.amortizaciones||[];return o.map((n,s)=>{const i=at({...t,amortizaciones:o.slice(0,s)}),r=at({...t,amortizaciones:o.slice(0,s+1)});return{nominal:i.totalIntereses-r.totalIntereses,real:be(i.tabla,e,a)-be(r.tabla,e,a)}})}const ea=(t,e,a="",o="")=>`<div class="stat-card">
     <div class="stat-label">${c(t)}</div>
     <div class="stat-value ${o}">${e}</div>
     ${a}
   </div>`;function wi(t,e){const a=va(t),o=(t.amortizaciones||[]).length>0,n=e.periodos.length>0,s=e.usarInflacion&&n,i=n?ga(e.periodos,t.fechaInicio||e.hoy,a.fechaFin||e.hoy,0):0,r=n?ba(t.tin||0,i):null,l=o&&n?Si(t,e.periodos,e.hoy):[],p=l.length?be(a.sinAmort.tabla,e.periodos,e.hoy)-be(a.tabla,e.periodos,e.hoy):null,g=p===null?null:p-a.costeTotalAmort,u=s?Io(a.tabla,e.periodos,e.hoy,a.comAp):null,d=s&&o?Io(a.sinAmort.tabla,e.periodos,e.hoy,a.comAp):null;return`<div class="loan-card" style="${e.completado?"opacity:0.65":""}">
    ...
    <div class="loan-card-body" data-body-loan="${c(t._id)}">
      ...
      ${o?`<div class="card" style="background:var(--bg3);padding:12px;margin-bottom:12px">
               ...
               ${p!==null?`<div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(160px,1fr));gap:8px;margin-bottom:10px">
                        ...
                        <div title="Ahorro neto en euros de hoy">
                          ...
                          <div class="num ${(g??0)>=0?"pos":"neg"}" style="color:var(--yellow)">${c(j(g??0))}</div>
                        </div>
      ...
      <div class="table-wrap"><table>
        ...
        <tbody>${a.tabla.map(h=>ji(h,s,e)).join("")}</tbody>
      </table></div>

      ${o?`<div class="card-title mt-12">Amortizaciones programadas</div>
             ${(t.amortizaciones||[]).map((h,y)=>zi(t._id,h,l[y]??null,e)).join("")}`:""}
    </div>
  </div>`}function Ci(t,e,a,o){const n=t.tipoTasa==="variable"?'<div class="text-sm mt-8" style="color:var(--text3)">⚠ Tipo variable: el beneficio real dependerá de cómo evolucione el índice de referencia.</div>':"";if(o!==null){const r=o-a,l=r>=0;return`<div class="card mb-12" style="background:var(--bg3);padding:12px">
    ...
    ${n}
  </div>`}function ji(t,e,a){let o="";if(e&&!t.esAmortizacion){const n=pt(a.periodos,a.hoy,t.fecha);o=c(j(n>0?t.cuota/n:t.cuota))}return`<tr ${t.esAmortizacion?'style="background:var(--yellow-dim)"':""}>
  ...
  </tr>`}function zi(t,e,a,o){const n=(e.escenarioIds||[]).map(s=>`<span class="badge badge-yellow">🔭 ${c(o.nombreEscenario(s))}</span>`).join("");return`<div class="amort-item" style="flex-wrap:wrap">
   ...
   ${o?`<span class="text-sm" style="margin-left:6px">${c(o)}</span>`:""}`;function se(t,e,a){return t.length===0?"":`<div class="form-group mt-8"><label class="form-label">Supuestos</label>
    ...
    </div></div>`}const Ei=(t,e)=>t.filter(a=>a.activo!==!1).map(a=>`<option value="${c(a._id)}"${a._id===e?" selected":""}>${c(a.nombre)}</option>`).join("");function Fi(t,e,a,o=Y()){return`
    <div class="grid-2">
      ...
      <div class="form-advanced-body">
        <div class="grid-2 mt-8">
          <div class="form-group"><label class="form-label">Cuenta bancaria</label>
            <select class="form-select" id="f-cuenta">${Ei(e,(t==null?void 0:t.cuenta)??"default")}</select></div>
    ...
    </div>`}function _i(t,e,a,o=Y()){return`
    <div class="grid-2">
    ...
    <div class="flex gap-8 mt-16" style="justify-content:flex-end">
    ...
    </div>`}const Ao="opt_",Mo=t=>String(t).startsWith(Ao);function Pi(t){let e=null,a=null;const o=()=>document.getElementById("modal-overlay"),n=()=>document.getElementById("modal-content");function s(m,$){const v=o(),x=n();return!v||!x?null:(x.innerHTML=`<div class="modal-title">${c(m)}</div>${$}`,v.classList.remove("hidden"),x)}const i=()=>{var m;return(m=o())==null?void 0:m.classList.add("hidden")};function r(){let m=!1;for(const $ of t.loans()){const v=($.amortizaciones||[]).filter(x=>!Mo(x._id));v.length!==($.amortizaciones||[]).length&&(t.guardarAmortizaciones($._id,v),m=!0)}return m}function l(m){try{return m()}catch($){return q($ instanceof Error?$.message:"No se ha podido completar el cálculo","err"),null}}function p(){var C,z;if(!Ha("optimizador")){q("El optimizador de amortizaciones está desactivado. Actívalo en ⚙ Funcionalidades.","err");return}const m=t.loans().filter(E=>E.activo&&!E.simulacion);if(m.length===0){q("No hay préstamos activos para optimizar","err");return}const $=t.config(),v=t.accounts().filter(E=>E.activo&&!E.simulacion),x=((C=v.find(E=>E.esCuentaPrincipal))==null?void 0:C._id)??((z=v[0])==null?void 0:z._id)??"",M=$.dashboardEnd||`${Number(t.hoy().slice(0,4))+5}-01-01`,S=s("✨ Optimizar amortizaciones",`
      ...
      <div style="max-height:300px;overflow-y:auto">
        <table class="table-wrap" style="width:100%">
          ...
          <tbody>${z.plan.map(w=>So(w,!0)).join("")}</tbody>
        </table>
      </div>
      ...
      <div class="flex gap-8 mt-12" style="justify-content:flex-end;flex-wrap:wrap">
        ...
        </tr>`}).join(""),T=s(`📊 Comparativa de frecuencias · hasta ${w}`,`
      <div class="auth-hint mb-12">
      ...
      <div class="flex gap-8 mt-16" style="justify-content:flex-end">
        <button class="btn-secondary" data-opt-volver>← Cambiar parámetros</button>
        <button class="btn-secondary" data-cancelar>Cerrar</button>
      </div>`);T&&(D(T,"[data-opt-volver]",p),D(T,"[data-cancelar]",i),D(T,"[data-opt-usar]",R=>A(Number(R.getAttribute("data-opt-usar")))))}function A(m){var v;const $=e==null?void 0:e.resultados.find(x=>x.frecuencia===m);$&&(r(),f($.plan,((v=$.plan[0])==null?void 0:v.tipoAmort)||"plazo",{titulo:`✨ Plan ${$.label} · aplicado`,resumen:$,fechaObjetivo:e==null?void 0:e.fechaObjetivo}))}function f(m,$,v){if(m.length===0)return;const x=new Map;for(const S of m){const C=x.get(S.loanId)??[];C.push({_id:`${Ao}${S.mes}_${S.loanId}`,fecha:S.fechaAmort,cantidad:S.cantidadAmort,tipo:$,simulacion:!0}),x.set(S.loanId,C)}let M=0;for(const S of t.loans()){const C=x.get(S._id);if(!C)continue;const z=(S.amortizaciones||[]).filter(E=>!Mo(E._id));t.guardarAmortizaciones(S._id,[...z,...C]),M+=1}q(`Plan aplicado: ${m.length} amortizaciones en ${M} préstamo${M!==1?"s":""} (simulación)`),v?b(v):i(),t.refrescar([...x.keys()])}function b({titulo:m,resumen:$,fechaObjetivo:v}){const x=s(m,`
      <div class="grid-4 mb-14" style="gap:10px">
      ...
      <div style="max-height:260px;overflow-y:auto">
        <table class="table-wrap" style="width:100%">
          ...
          <tbody>${$.plan.map(M=>So(M,!1)).join("")}</tbody>
        </table>
      </div>
      ...
      <div class="flex gap-8 mt-12" style="justify-content:flex-end">
        <button class="btn-secondary" data-cancelar>Cerrar</button>
      </div>`);x&&D(x,"[data-cancelar]",i)}return{abrir:p,get planManual(){return a},get comparativa(){return e}}}function So(t,e){const a=t.comision>0?`<br><span style="font-size:9px;color:var(--text3)">+${c(j(t.comision))} com.</span>`:"";return`<tr>
    ...
    <div class="grid-4" style="gap:8px;font-size:12px">
  ...
  </div>`}const Ti="M11.8 10.9c-2.27-.59-3-1.2-3-2.15 0-1.09 1.01-1.85 2.7-1.85 1.78 0 2.44.85 2.5 2.1h2.21c-.07-1.72-1.12-3.3-3.21-3.81V3h-3v2.16c-1.94.42-3.5 1.68-3.5 3.61 0 2.31 1.91 3.46 4.7 4.13 2.5.6 3 1.48 3 2.41 0 .69-.49 1.79-2.7 1.79-2.06 0-2.87-.92-2.98-2.1h-2.2c.12 2.19 1.76 3.42 3.68 3.83V21h3v-2.15c1.95-.37 3.5-1.5 3.5-3.55 0-2.84-2.43-3.81-4.7-4.4z";function Di(t){const e=t.hoy??Y;let a=!1;const o=new Set;let n=null;const s=()=>{var v;return(v=t.onDatosCambiados)==null?void 0:v.call(t)},i=()=>t.store.get("escenarios"),r=v=>{var x;return((x=i().find(M=>M._id===v))==null?void 0:x.nombre)??v};function l(v){if(!v.activo||v.simulacion)return!1;const x=at(v).tabla.filter(M=>!M.esAmortizacion);return x.length===0?!0:x[x.length-1].fecha<e()}function p(v,x){const M=e(),S=M.slice(0,7),C=new Map;let z=0;for(const E of v){if(!E.activo||E.simulacion||x.has(E._id)||(E.fechaInicio||"")>M)continue;const F=at(E).tabla.filter(P=>!P.esAmortizacion&&P.fecha.startsWith(S)),w=F.length>0?F[0].cuota:0;C.set(E._id,w),z+=w}return{porLoan:C,total:z,activos:[...C.values()].filter(E=>E>0).length}}function g(v){const x=t.store.get("config"),M=x.dashboardStart,S=x.dashboardEnd,C=Math.max(1,(G(S).getTime()-G(M).getTime())/(30.44*864e5));let z=0;for(const E of v)!E.activo||E.simulacion||(z+=at(E).tabla.filter(F=>!F.esAmortizacion&&F.fecha>=M&&F.fecha<=S).reduce((F,w)=>F+w.cuota,0));return{media:z/C,desde:M,hasta:S}}function u(v){const x=[...t.store.get("loans")].sort((P,T)=>T.tin-P.tin),M=new Set(x.filter(l).map(P=>P._id)),S=a?x:x.filter(P=>!M.has(P._id)),C=p(x,M),z=g(x),E=t.store.get("config"),F=t.store.get("inflacion"),w=new Date(G(e())).toLocaleDateString("es-ES",{month:"long",year:"numeric"});v.innerHTML=`
      <div class="page-header">
      ...
      <div id="loans-list">
        ${S.length===0?'<div class="text-sm" style="text-align:center;padding:40px 0">Sin préstamos.</div>':S.map(P=>wi(P,{periodos:F,usarInflacion:!!E.usarInflacion,hoy:e(),cuotaMes:C.porLoan.get(P._id)??0,completado:M.has(P._id),nombreEscenario:r})).join("")}
      </div>`;for(const P of v.querySelectorAll("[data-body-loan]"))o.has(P.dataset.bodyLoan??"")&&P.classList.add("open")}const d=()=>document.getElementById("modal-overlay"),h=()=>document.getElementById("modal-content"),y=()=>{var v;return(v=d())==null?void 0:v.classList.add("hidden")};function I(v,x){const M=d(),S=h();return!M||!S?null:(S.innerHTML=`<div class="modal-title">${c(v)}</div>${x}`,M.classList.remove("hidden"),D(S,"[data-cancelar]",y),S)}function A(v,x){const M=v?t.store.get("loans").find(C=>C._id===v)??null:null,S=I(v?"Editar préstamo":"Nuevo préstamo",Fi(M,t.store.get("accounts"),i(),e()));S&&(S.addEventListener("change",C=>{var z;(z=C.target)!=null&&z.matches("[data-dp-modo]")&&xo(S)}),D(S,"[data-guardar-loan]",C=>{f(S,C.getAttribute("data-guardar-loan")||"")&&(y(),x())}))}function f(v,x){const M=P=>{var T;return((T=v.querySelector(P))==null?void 0:T.value)??""},S=P=>{var T;return!!((T=v.querySelector(P))!=null&&T.checked)},C=M("#f-nombre").trim(),z=parseFloat(M("#f-capital")),E=parseFloat(M("#f-tin")),F=parseInt(M("#f-meses"),10);if(!C||!Number.isFinite(z)||!Number.isFinite(E)||!Number.isFinite(F))return q("Completa los campos obligatorios","err"),!1;const w={nombre:C,capital:z,tin:E,meses:F,fechaInicio:M("#f-fecha"),comisionApertura:parseFloat(M("#f-com-ap"))||0,comisionAmort:parseFloat(M("#f-com-am"))||0,diaPago:$o(v),cuenta:M("#f-cuenta"),simulacion:S("#f-sim"),activo:S("#f-activo"),mostrarFechaFinEnDashboard:S("#f-mostrar-fin"),tipoTasa:M("#f-tipo-tasa"),basico:S("#f-basico"),tags:M("#f-tags").split(",").map(P=>P.trim()).filter(Boolean),escenarioIds:[...v.querySelectorAll(".loan-escenario:checked")].map(P=>P.value)};return x?(t.store.updateItem("loans",x,w),q("Préstamo actualizado")):(t.store.addItem("loans",{...w,amortizaciones:[]}),q("Préstamo creado")),s(),!0}function b(v,x,M){const S=t.store.get("loans").find(E=>E._id===v);if(!S)return;const C=x?(S.amortizaciones||[]).find(E=>E._id===x)??null:null,z=I(x?"Editar amortización":"Añadir amortización",_i(v,C,i(),e()));z&&D(z,"[data-guardar-amort]",E=>{const[F,w]=(E.getAttribute("data-guardar-amort")||"").split("|");m(z,F,w)&&(y(),M([F]))})}function m(v,x,M){var T;const S=R=>{var O;return((O=v.querySelector(R))==null?void 0:O.value)??""},C=S("#am-fecha"),z=parseFloat(S("#am-cant"));if(!C||!Number.isFinite(z)||z<=0)return q("Fecha y cantidad requeridas","err"),!1;const E=t.store.get("loans").find(R=>R._id===x);if(!E)return!1;const F={fecha:C,cantidad:z,tipo:S("#am-tipo"),simulacion:!!((T=v.querySelector("#am-sim"))!=null&&T.checked),escenarioIds:[...v.querySelectorAll(".amort-escenario:checked")].map(R=>R.value)},w=E.amortizaciones||[],P=M?w.map(R=>R._id===M?{...R,...F}:R):[...w,{_id:Date.now().toString(36),...F}];return t.store.updateItem("loans",x,{amortizaciones:P}),q(M?"Amortización actualizada":"Amortización añadida"),s(),!0}function $(v,x,M){D(v,"[data-toggle-finalizados]",()=>{a=!a,x()}),D(v,"[data-nuevo-loan]",()=>A(null,x)),D(v,"[data-optimizar]",()=>M.abrir()),D(v,"[data-toggle-loan]",(S,C)=>{var w;if((w=C.target)!=null&&w.closest("button"))return;const z=S.getAttribute("data-toggle-loan"),E=[...v.querySelectorAll("[data-body-loan]")].find(P=>P.dataset.bodyLoan===z);(E==null?void 0:E.classList.toggle("open"))?o.add(z):o.delete(z)}),D(v,"[data-editar-loan]",S=>A(S.getAttribute("data-editar-loan"),x)),D(v,"[data-borrar-loan]",S=>{if(!Z("¿Eliminar préstamo?"))return;const C=S.getAttribute("data-borrar-loan");t.store.removeItem("loans",C),o.delete(C),q("Eliminado"),s(),x()}),D(v,"[data-amort-loan]",S=>{const C=S.getAttribute("data-amort-loan");o.add(C),b(C,null,x)}),D(v,"[data-editar-amort]",S=>{const[C,z]=(S.getAttribute("data-editar-amort")||"").split("|");o.add(C),b(C,z,x)}),D(v,"[data-borrar-amort]",S=>{const[C,z]=(S.getAttribute("data-borrar-amort")||"").split("|"),E=t.store.get("loans").find(F=>F._id===C);E&&(t.store.updateItem("loans",C,{amortizaciones:(E.amortizaciones||[]).filter(F=>F._id!==z)}),q("Amortización eliminada"),s(),x([C]))})}return{id:"loans",route:"loans",nombre:"Préstamos",flagId:"loans",seccion:1,iconoPath:Ti,mount(v){const x=(M=[])=>{for(const S of M)o.add(S);u(v)};n??(n=Pi({loans:()=>t.store.get("loans"),expenses:()=>t.store.get("expenses"),accounts:()=>t.store.get("accounts"),nominas:()=>t.store.get("nominas"),config:()=>t.store.get("config"),guardarAmortizaciones:(M,S)=>{t.store.updateItem("loans",M,{amortizaciones:S}),s()},hoy:e,refrescar:x})),u(v),v.dataset.wired!=="1"&&($(v,x,n),v.dataset.wired="1")}}}const Ri={transporte:125,restaurante:220,otros:null},Ni={transporte:"Transporte",restaurante:"Restaurante",otros:"Otros"},Oi=["Enero","Febrero","Marzo","Abril","Mayo","Junio","Julio","Agosto","Septiembre","Octubre","Noviembre","Diciembre"],kt=(t,e,a,o,n="")=>`<div class="form-group"><label class="form-label">${c(e)}</label>
   <input class="form-input" type="${a}" id="${t}" value="${c(o)}" placeholder="${c(n)}"/></div>`,qi=(t,e)=>t.filter(a=>a.activo!==!1).map(a=>`<option value="${c(a._id)}"${a._id===e?" selected":""}>${c(a.nombre)}</option>`).join("");function Li(t,e){const a=t.map((s,i)=>{const r=e.find(g=>g._id===s.cuenta),l=Ri[s.tipo],p=l!=null&&s.importe>l;return`<div class="flex gap-8 items-center" style="padding:5px 0;border-bottom:1px solid var(--border)">
        <span class="badge badge-blue" style="min-width:88px;text-align:center">${c(Ni[s.tipo]??s.tipo)}</span>
    ...
    <button class="btn-secondary btn-sm mt-6" data-flex-anadir>+ Añadir componente</button>`}function ki(t,e){const a=e.hoy??Y(),o=(t==null?void 0:t.nPagas)??12,n=[12,14,16].includes(o);return`
    <div class="grid-2">
    ...
    <div class="grid-2 mt-8">
      ...
      <div class="form-group"><label class="form-label">Cuenta</label>
        <select class="form-select" id="nf-cuenta">${qi(e.accounts,(t==null?void 0:t.cuenta)??e.cuentaPrincipal)}</select></div>
    </div>
        ...
        <div class="grid-2 mt-8">
          ...
          <div class="form-group"><label class="form-label">Mes actualización IPC (opcional)</label>
            <select class="form-select" id="nf-mes-ipc">
              ...
              ${Oi.map((s,i)=>`<option value="${i+1}"${(t==null?void 0:t.mesActualizacionIPC)===i+1?" selected":""}>${c(s)} (${i+1})</option>`).join("")}
            </select>
          </div>
        </div>
        <div class="grid-2 mt-8">
    ...
    <div style="margin-top:8px;display:grid;grid-template-columns:1fr 1fr;gap:4px">
      ...
      <span style="color:var(--text2)">En predicciones:</span><span style="font-size:11px">${n.representacion==="simplificado"?`ingreso ${c(j(h))}/paga`:`ingreso ${c(j(g))} − SS ${c(j(u))} − IRPF ${c(j(d))}`}${s>0?" + recargas flex":""}</span>
    </div>${I}`}function Hi(t,e,a,o){const n=()=>{const r=t.querySelector("#flex-comp-container");r&&(r.innerHTML=Li(e,a.accounts))},s=()=>{const r=t.querySelector("#nf-preview");r&&(r.innerHTML=Bi(t,e,a,o))},i=()=>{var l,p;const r=(g,u)=>{const d=t.querySelector(g);d&&(d.style.display=u?"":"none")};r("#nf-custom-pagas-wrap",((l=t.querySelector("#nf-npagas"))==null?void 0:l.value)==="custom"),r("#nf-irpfpct-wrap",((p=t.querySelector("#nf-irpfmodo"))==null?void 0:p.value)==="manual"),s()};t.addEventListener("input",r=>{var l;(l=r.target)!=null&&l.closest("#nf-bruto, #nf-irpfpct, #nf-npagas-custom, #nf-grupo, #nf-sspct")&&s()}),J(t,"#nf-npagas, #nf-irpfmodo, #nf-representacion",i),D(t,"[data-flex-anadir]",()=>{var p,g,u;const r=((p=t.querySelector("#fc-tipo"))==null?void 0:p.value)||"transporte",l=parseFloat(((g=t.querySelector("#fc-importe"))==null?void 0:g.value)??"")||0;if(!l)return q("Importe requerido","err");e.push({_id:Date.now().toString(36),tipo:r,importe:l,cuenta:((u=t.querySelector("#fc-cuenta"))==null?void 0:u.value)||""}),n(),s()}),D(t,"[data-flex-borrar]",r=>{e.splice(Number(r.getAttribute("data-flex-borrar")),1),n(),s()}),n(),s()}const jo=t=>t.slice(0,3).map(([,e])=>`${e}%`).join(" · ")+(t.length>3?" …":"");function Gi(t){let e=null,a=[];const o=()=>document.getElementById("modal-overlay"),n=()=>document.getElementById("modal-content"),s=()=>{var d;return(d=o())==null?void 0:d.classList.add("hidden")},i=()=>t.store.get("config").tramos_irpf??gt;function r(d,h){const y=o(),I=n();return!y||!I?null:(I.innerHTML=`<div class="modal-title">${c(d)}</div>${h}`,y.classList.remove("hidden"),D(I,"[data-cerrar]",s),I)}function l(){e=null;const d=[...t.store.get("tramosIRPFHistorico")].sort((I,A)=>I.año-A.año),h="display:grid;grid-template-columns:90px 1fr auto;gap:0;padding:10px 12px;border-top:1px solid var(--border);align-items:center",y=r("Tramos IRPF por ejercicio",`
      <div class="text-sm mb-12" style="color:var(--text2)">
      ...
      <div class="flex gap-8 mt-16" style="justify-content:flex-end">
        ...
        </div>`).join("")}function g(d){a=[...d.querySelectorAll("[data-tr-min]")].map((y,I)=>{const A=d.querySelector(`[data-tr-pct="${I}"]`);return[parseFloat(y.value)||0,parseFloat((A==null?void 0:A.value)??"")||0]})}function u(d){var b;e=d;const h=t.store.get("tramosIRPFHistorico");a=(d==="default"?i():((b=h.find(m=>m.año===d))==null?void 0:b.tramos)??i()).map(m=>[...m]);const I=d==="default"?"tabla por defecto":`ejercicio ${d}`,A=r(`Tramos IRPF — ${d==="default"?"Por defecto":d}`,`
      ...
      </div>`);if(!A)return;const f=()=>{const m=A.querySelector("#irpf-tramos-rows");m&&(m.innerHTML=p())};D(A,"[data-volver]",l),D(A,"[data-tr-anadir]",()=>{g(A),a.push([0,0]),f()}),D(A,"[data-tr-borrar]",m=>{g(A),a.splice(Number(m.getAttribute("data-tr-borrar")),1),f()}),D(A,"[data-tr-guardar]",()=>{g(A);const m=[...a].sort(($,v)=>$[0]-v[0]);if(m.length===0)return q("Añade al menos un tramo","err");e==="default"?(t.store.patchConfig({tramos_irpf:m}),q("Tabla por defecto guardada")):(t.store.set("tramosIRPFHistorico",t.store.get("tramosIRPFHistorico").map($=>$.año===e?{...$,tramos:m}:$)),q(`Tabla ${e} guardada`)),t.onDatosCambiados(),l()})}return{abrir:l}}const zo=1500,_t=(t,e,a,o,n="")=>`<div class="form-group"><label class="form-label">${c(e)}</label>
   <input class="form-input" type="${a}" id="${t}" value="${c(o)}" placeholder="${c(n)}"/></div>`,Vi=(t,e,a,o)=>`<div class="form-group"><label class="form-label">${c(e)}</label>
   <select class="form-select" id="${t}">
     ${a.map(([n,s])=>`<option value="${c(n)}"${n===o?" selected":""}>${c(s)}</option>`).join("")}
   </select></div>`,Ui=t=>(t.modeloFondo||"cuenta")==="pension";function Yi(t,e,a,o){return t.length===0?`<div class="card text-sm" style="padding:24px;text-align:center;color:var(--text2)">
      Sin planes de pensiones. Crea uno con el botón "+ Nuevo plan de pensiones".
    </div>`:`<div class="grid-3">${t.map(n=>Ji(n,e,a,o)).join("")}</div>`}function Ji(t,e,a,o){const n=ue(t);if(!n)return"";const s=_e(t,e,a),i=o.slice(0,4),r=(t.aportaciones||[]).filter(p=>p.fecha>=`${i}-01-01`).reduce((p,g)=>p+g.cantidad,0),l=Math.min(r,zo)*(s/100);return`<div class="card">
    ...
    <div style="margin-top:10px;padding:8px;background:var(--bg3);border-radius:var(--radius);border:1px solid var(--border)">
      ...
      <div class="flex justify-between mb-4"><span class="text-sm" style="color:var(--text2)">Aportado</span><span class="num ${r>zo?"neg":""}">${c(j(r))}</span></div>
  ...
  </div>`}function Wi(t){return`<div>${t.map((a,o)=>`<div class="flex gap-8 items-center" style="padding:4px 0;border-bottom:1px solid var(--border)">
    ...
    <button class="btn-secondary btn-sm mt-6" data-aport-anadir>+ Añadir aportación</button>`}function Qi(t,e){const a=[...(t==null?void 0:t.historicoSaldos)??[]].sort((i,r)=>r.fecha.localeCompare(i.fecha)),o=a[0]?a[0].saldo:(t==null?void 0:t.saldo)??0,n=[...new Set(e.nominas.filter(i=>i.grupoNomina).map(i=>i.grupoNomina))],s=!!(t!=null&&t.grupoNomina);return`
    <div class="grid-2">
    ...
    <div class="grid-2 mt-8">
      ...
      ${Vi("pen-periodo","Capitalización",[["diario","Diario"],["mensual","Mensual"],["anual","Anual"]],(t==null?void 0:t.periodoCobro)??"mensual")}
    </div>
    <div class="grid-2 mt-8">
    ...
    <div class="flex gap-8 mt-16" style="justify-content:flex-end">
    ...
    </div>`}function Ki(t,e,a){const o=()=>{const n=t.querySelector("#pen-aport-container");n&&(n.innerHTML=Wi(e))};J(t,"#pen-grupo",n=>{const s=t.querySelector("#pen-impuesto-wrap");s&&(s.style.display=n.value?"none":"")}),D(t,"[data-aport-anadir]",()=>{var s,i,r,l;const n=parseFloat(((s=t.querySelector("#paport-importe"))==null?void 0:s.value)??"")||0;if(!n)return q("Importe requerido","err");e.push({_id:Date.now().toString(36),importe:n,periodicidad:((i=t.querySelector("#paport-periodo"))==null?void 0:i.value)||"mensual",fechaInicio:((r=t.querySelector("#paport-inicio"))==null?void 0:r.value)||a,fechaFin:((l=t.querySelector("#paport-fin"))==null?void 0:l.value)||""}),o()}),D(t,"[data-aport-borrar]",n=>{e.splice(Number(n.getAttribute("data-aport-borrar")),1),o()}),o()}function Xi(t,e,a,o){var A;const n=f=>{var b;return((b=t.querySelector(f))==null?void 0:b.value)??""},s=(f,b=0)=>{const m=parseFloat(n(f));return Number.isFinite(m)?m:b},i=f=>{var b;return!!((b=t.querySelector(f))!=null&&b.checked)},r=n("#pen-nombre").trim();if(!r)return{datos:{},error:"Nombre obligatorio"};const l=s("#pen-saldo"),p=n("#pen-grupo"),g={nombre:r,grupoNomina:p,saldo:l,saldoInicial:s("#pen-saldo-ini"),fechaInicialSaldo:n("#pen-fecha-ini")||o,interes:s("#pen-interes"),periodoCobro:n("#pen-periodo")||"mensual",modeloFondo:"pension",bloqueoMeses:parseInt(n("#pen-bloqueo"),10)||120,impuestoRetirada:p?0:s("#pen-impuesto"),planAportaciones:e,descripcion:n("#pen-desc").trim(),activo:i("#pen-activo"),simulacion:i("#pen-sim"),escenarioIds:[...t.querySelectorAll(".pen-escenario:checked")].map(f=>f.value)},u=[...(a==null?void 0:a.historicoSaldos)??[]],d=[...(a==null?void 0:a.aportaciones)??[]],y=((A=[...u].sort((f,b)=>b.fecha.localeCompare(f.fecha))[0])==null?void 0:A.saldo)??(a==null?void 0:a.saldo)??null,I=Date.now().toString(36);return a?(y===null||Math.abs(l-y)>.005)&&(u.push({_id:I,fecha:o,saldo:l,nota:"Actualización manual"}),l>(y??0)&&d.push({_id:`${I}a`,fecha:o,cantidad:l-(y??0)})):l>0&&(u.push({_id:I,fecha:o,saldo:l,nota:"Saldo inicial"}),d.push({_id:`${I}a`,fecha:g.fechaInicialSaldo??o,cantidad:l})),{datos:{...g,historicoSaldos:u,aportaciones:d}}}const Zi="M20 6h-3V4c0-1.11-.89-2-2-2H9c-1.11 0-2 .89-2 2v2H4c-1.11 0-1.99.89-1.99 2L2 19c0 1.11.89 2 2 2h16c1.11 0 2-.89 2-2V8c0-1.11-.89-2-2-2zm-5 0H9V4h6v2z";function tr(t){const e=t.hoy??Y,a=()=>{var A;return(A=t.onDatosCambiados)==null?void 0:A.call(t)};function o(){const A=t.store.get("config");return bt(t.store.get("tramosIRPFHistorico"),A.tramos_irpf??gt)(Number(e().slice(0,4)))}function n(A,f,b){const m=De(A,f,b),$=!!f&&A.irpfModo!=="manual",v=[A.mesActualizacionIPC?`<span class="badge badge-blue" title="Actualización IPC en el mes ${A.mesActualizacionIPC}">IPC m${A.mesActualizacionIPC}</span>`:"",m.flexAnual>0?`<span class="badge" style="background:rgba(99,214,160,0.12);color:#63d6a0" title="Retribución flexible exenta de IRPF y SS">RF ${c(j(m.flexAnual))}/año</span>`:"",Math.abs(m.ssPct-6.35)>.01?`<span class="badge" style="background:rgba(255,200,80,0.12);color:var(--yellow)" title="Cotización SS del empleado personalizada">SS ${m.ssPct.toFixed(2)}%</span>`:""].join("");return`<div class="exp-table-row">
      <div>
    ...
    </div>`}const s=A=>{var f;return((f=t.store.get("accounts").find(b=>b._id===(A||"default")))==null?void 0:f.nombre)??(A||"default")};function i(A,f,b){const m=f.reduce((x,M)=>x+(M.bruto||0),0),$=vs(f,b),v=m>0?$/m*100:0;return`<div style="margin-bottom:16px">
      ...
      <div class="card" style="padding:0;overflow:hidden;border-radius:0 0 var(--radius) var(--radius)">
        ${f.map(x=>n(x,f,b)).join("")}
      </div>
    </div>`}function r(A){const f=o(),b=[...t.store.get("nominas")].sort((M,S)=>(S.bruto||0)-(M.bruto||0)),{grupos:m,sueltas:$}=bs(b),v=t.store.get("accounts").filter(Ui),x=b.filter(M=>M.activo!==!1);A.innerHTML=`
      <div class="page-header">
      ...
      <div>${Yi(v,x,f,e())}</div>`}const l=()=>document.getElementById("modal-overlay"),p=()=>document.getElementById("modal-content"),g=()=>{var A;return(A=l())==null?void 0:A.classList.add("hidden")};function u(A,f){const b=l(),m=p();return!b||!m?null:(m.innerHTML=`<div class="modal-title">${c(A)}</div>${f}`,b.classList.remove("hidden"),D(m,"[data-cancelar]",g),m)}function d(A,f){const b=A?t.store.get("nominas").find(x=>x._id===A)??null:null,m=[...(b==null?void 0:b.retribucionFlexible)??[]].map(x=>({...x})),$={accounts:t.store.get("accounts"),escenarios:t.store.get("escenarios"),nominas:t.store.get("nominas"),cuentaPrincipal:t.store.getPrincipalAccountId(),tramos:o(),hoy:e()},v=u(A?"Editar nómina":"Nueva nómina",ki(b,$));v&&(Hi(v,m,$,A??""),D(v,"[data-guardar-nomina]",x=>{const M=Co(v,m);if(!M.nombre||M.bruto<=0)return q("Nombre y bruto anual son obligatorios","err");const S=x.getAttribute("data-guardar-nomina")||"",C={...M,activo:!0,tags:["nomina"]};S?(t.store.updateItem("nominas",S,C),q("Nómina actualizada")):(t.store.addItem("nominas",C),q("Nómina creada")),a(),g(),f()}))}function h(A,f){const b=A?t.store.get("accounts").find(v=>v._id===A)??null:null,m=[...(b==null?void 0:b.planAportaciones)??[]].map(v=>({...v})),$=u(A?"Editar plan de pensiones":"Nuevo plan de pensiones",Qi(b,{nominas:t.store.get("nominas"),escenarios:t.store.get("escenarios"),hoy:e()}));$&&(Ki($,m,e()),D($,"[data-guardar-pension]",v=>{const{datos:x,error:M}=Xi($,m,b,e());if(M)return q(M,"err");const S=v.getAttribute("data-guardar-pension")||"";S?(t.store.updateItem("accounts",S,x),q("Plan actualizado")):(t.store.addItem("accounts",x),q("Plan creado")),a(),g(),f()}))}function y(A,f,b){D(A,"[data-nueva-nomina]",()=>d(null,f)),D(A,"[data-editar-nom]",m=>d(m.getAttribute("data-editar-nom"),f)),D(A,"[data-borrar-nom]",m=>{Z("¿Eliminar esta nómina?")&&(t.store.removeItem("nominas",m.getAttribute("data-borrar-nom")),q("Eliminada"),a(),f())}),J(A,"[data-activo-nom]",m=>{const $=m;t.store.updateItem("nominas",$.getAttribute("data-activo-nom"),{activo:$.checked}),a(),f()}),D(A,"[data-tramos]",()=>b.abrir()),D(A,"[data-nueva-pension]",()=>h(null,f)),D(A,"[data-editar-pension]",m=>h(m.getAttribute("data-editar-pension"),f)),D(A,"[data-borrar-pension]",m=>{Z("¿Eliminar este plan de pensiones?")&&(t.store.removeItem("accounts",m.getAttribute("data-borrar-pension")),q("Plan eliminado"),a(),f())})}let I=null;return{id:"nominas",route:"nominas",nombre:"Nóminas",flagId:"nominas",seccion:1,iconoPath:Zi,mount(A){const f=()=>r(A);I??(I=Gi({store:t.store,onDatosCambiados:()=>{a(),f()},año:()=>Number(e().slice(0,4))})),r(A),A.dataset.wired!=="1"&&(y(A,f,I),A.dataset.wired="1")}}}const er="M3 17.25V21h3.75L17.81 9.94l-3.75-3.75L3 17.25zM20.71 7.04c.39-.39.39-1.02 0-1.41l-2.34-2.34c-.39-.39-1.02-.39-1.41 0l-1.83 1.83 3.75 3.75 1.83-1.83z",ar="M13 3c-4.97 0-9 4.03-9 9H1l3.89 3.89.07.14L9 12H6c0-3.87 3.13-7 7-7s7 3.13 7 7-3.13 7-7 7c-1.93 0-3.68-.79-4.94-2.06l-1.42 1.42C8.27 19.99 10.51 21 13 21c4.97 0 9-4.03 9-9s-4.03-9-9-9zm-1 5v5l4.28 2.54.72-1.21-3.5-2.08V8H12z",Eo={transporte:{label:"Transporte",limiteAnual:1500},restaurante:{label:"Restaurante",limiteAnual:2640},otros:{label:"Otros",limiteAnual:null}},or={entradas:[],salidas:[],totalAportaciones:0,totalReembolsos:0,retencion:0};function sr(t,e){const a=t.filter(l=>l.activo&&mt(l)==="inversion");if(a.length===0)return"";let o=0,n=0,s=0,i=0;for(const l of a){const p=Rt(l,e);p&&(o+=p.saldo,n+=p.costBase,s+=p.plusvalia,i+=p.impuesto)}const r=n>0?(s/n*100).toFixed(1):"0";return`
    ...
    </div>`}function nr(t,e){if(!t.activo||!t.interes||t.interes<=0)return"";const{dashboardStart:a,dashboardEnd:o}=e.config,n=Math.max(1,(G(o).getTime()-G(a).getTime())/(30.44*864e5)),s=Ut(t,a),i=s*(Math.pow(1+t.interes/100,n/12)-1);let r="";if(e.config.usarInflacion&&e.inflacion.length>0){const l=s*(pt(e.inflacion,a,o)-1),p=i-l;r=`
  ...
  </div>`}function ir(t,e){const a=Eo[t.tipoBeneficio??""]??{label:"Beneficio",limiteAnual:null},{limiteAnual:o}=a,n=e.nominas.flatMap(h=>(h.retribucionFlexible??[]).filter(y=>y.cuenta===t._id).map(y=>({nomina:h,importe:y.importe}))),s=n.reduce((h,y)=>h+y.importe,0),i=s*12,r=o!==null&&i>o,l=o!==null?Math.min(i,o):i,p=t.grupoNomina?e.nominas.filter(h=>(h.grupoNomina||"")===t.grupoNomina&&h.activo!==!1):n.slice(0,1).map(h=>h.nomina),g=Ma(p,e.tramosIRPF),u=l*g/100,d=t.grupoNomina?`grupo "${t.grupoNomina}", tipo marginal ${g}%`:`tipo marginal ${g}%`;return`<div style="margin-top:10px;padding:10px;background:var(--bg3);border-radius:var(--radius);border:1px solid rgba(99,214,160,0.35)">
    ...
    ${u>0?`<div class="flex justify-between mb-5"><span class="text-sm" style="color:var(--text2)">Ahorro IRPF estimado</span>
             <span class="num pos" title="Importe exento × ${c(d)}">≈ ${c(j(u))}/año <span style="font-size:10px;color:var(--text3)">(${c(g)}%)</span></span></div>`:""}
  ...
  </div>`}function rr(t){const e=ue(t);return e?`<div style="margin-top:10px;padding:10px;background:var(--bg3);border-radius:var(--radius);border:1px solid var(--yellow-dark, #7a6010)">
    ...
    <div style="font-size:10px;color:var(--text3);margin-top:4px">
      ...
      · ${c(t.impuestoRetirada??0)}% sobre beneficio al retirar · ${e.numAportaciones} aportaciones
  ...
  </div>`:""}function lr(t,e){const a=Rt(t,e.tramosGanancias);if(!a)return"";const o=e.config,n=e.flujos(t._id),s=G(o.dashboardStart),i=G(o.dashboardEnd),r=Math.max(0,(i.getTime()-s.getTime())/(30.44*864e5)),l=a.saldo+n.totalAportaciones-n.totalReembolsos,p=t.interes>0?Math.pow(1+t.interes/100,1/12)-1:0,g=l>0&&r>0?Math.max(0,l*Math.pow(1+p,r)):Math.max(0,l),u=a.costBase+n.totalAportaciones,d=Math.max(0,g-u),h=Fe(d,e.tramosGanancias),y=d>0?(h/d*100).toFixed(1):"0",I=t.interes>0?`${t.interes}% anual`:"sin rentabilidad",A=a.saldo>0?(a.plusvalia/a.saldo*100).toFixed(1):"0",f=(M,S,C)=>M.map(z=>`<div class="flex justify-between mt-4">
         ...
         <div style="border-top:1px solid var(--border);margin-top:6px;padding-top:6px">
           ...
           <div class="stat-card"><div class="stat-label">Valor proyectado</div><div class="stat-value pos">${c(j(g))}</div><div class="stat-sub">${c(I)} · ${c(o.dashboardEnd)}</div></div>
           <div class="stat-card"><div class="stat-label">Valor neto proyectado</div><div class="stat-value pos">${c(j(g-h))}</div><div class="stat-sub">${c(y)}% imp. efectivo</div></div>
         </div>`;return`
    ...
    <div class="flex justify-between items-center mb-12">
      ...
      <div class="flex gap-8">
        ...
        <button class="btn-icon" data-hist-acc="${c(t._id)}" title="Histórico de saldos"><svg viewBox="0 0 24 24"><path d="${ar}"/></svg></button>
        <button class="btn-icon" data-editar-acc="${c(t._id)}" title="Editar"><svg viewBox="0 0 24 24"><path d="${er}"/></svg></button>
  ...
  </div>`}const dr=[["cuenta","Cuenta bancaria"],["inversion","Fondo de inversión"],["beneficio","Tarjeta beneficio"]];function ur(t){return`<div>${t.map((a,o)=>`<div class="flex gap-8 items-center" style="padding:4px 0;border-bottom:1px solid var(--border)">
        <span style="min-width:70px;font-size:12px">${c(a.fechaInicio||"—")}</span>
        <span style="flex:1;font-size:12px">${c(j(a.importe))} / ${c(a.periodicidad)}</span>
        <span style="min-width:70px;font-size:12px;color:var(--text3)">${c(a.fechaFin||"indefinido")}</span>
        <button class="btn-danger btn-sm" data-aport-borrar="${o}">✕</button>
    ...
    <button class="btn-secondary btn-sm mt-6" data-aport-anadir>+ Añadir aportación</button>`}function pr(t,e){const a=t?mt(t):"cuenta",o=[...new Set(e.nominas.filter(s=>s.grupoNomina).map(s=>s.grupoNomina))],n=s=>s?"":' style="display:none"';return`
    <div class="grid-2">
      ${tt("ac-nombre","Nombre","text",(t==null?void 0:t.nombre)??"","Ej: Cuenta ING, Fondo Vanguard")}
      ${Lt("ac-modelo","Tipo",dr,a)}
    </div>
    <div class="grid-2 mt-8">
    ...
    <div class="flex gap-8 mt-12" style="justify-content:flex-end">
    ...
    </div>`}const Fo=t=>t.slice(0,3).map(([,e])=>`${e}%`).join(" · ")+(t.length>3?" …":"");function gr(t){let e=null,a=[];const o=()=>document.getElementById("modal-overlay"),n=()=>document.getElementById("modal-content"),s=()=>{var d;return(d=o())==null?void 0:d.classList.add("hidden")},i=()=>t.store.get("config").tramosGananciasCapital??jt;function r(d,h){const y=o(),I=n();return!y||!I?null:(I.innerHTML=`<div class="modal-title">${c(d)}</div>${h}`,y.classList.remove("hidden"),D(I,"[data-cerrar]",s),I)}function l(){e=null;const d=[...t.store.get("tramosGananciasCapitalHistorico")].sort((I,A)=>I.año-A.año),h="display:grid;grid-template-columns:90px 1fr auto;gap:0;padding:10px 12px;border-top:1px solid var(--border);align-items:center",y=r("Tramos — Ganancias de capital",`
      <div class="text-sm mb-12" style="color:var(--text2)">
      ...
      <div class="flex gap-8 mt-16" style="justify-content:flex-end">
        ...
        </div>`).join("")}function g(d){a=[...d.querySelectorAll("[data-tg-min]")].map((h,y)=>{const I=d.querySelector(`[data-tg-pct="${y}"]`);return[parseFloat(h.value)||0,parseFloat((I==null?void 0:I.value)??"")||0]})}function u(d){var f;e=d;const h=t.store.get("tramosGananciasCapitalHistorico");a=(d==="default"?i():((f=h.find(b=>b.año===d))==null?void 0:f.tramos)??i()).map(b=>[...b]);const I=r(`Ganancias de capital — ${d==="default"?"Por defecto":d}`,`
      ...
      </div>`);if(!I)return;const A=()=>{const b=I.querySelector("#tg-rows");b&&(b.innerHTML=p())};D(I,"[data-volver-tg]",l),D(I,"[data-tg-anadir]",()=>{g(I),a.push([0,0]),A()}),D(I,"[data-tg-borrar]",b=>{g(I),a.splice(Number(b.getAttribute("data-tg-borrar")),1),A()}),D(I,"[data-tg-guardar]",()=>{g(I);const b=[...a].sort((m,$)=>m[0]-$[0]);if(b.length===0)return q("Añade al menos un tramo","err");e==="default"?(t.store.patchConfig({tramosGananciasCapital:b}),q("Tabla por defecto guardada")):(t.store.set("tramosGananciasCapitalHistorico",t.store.get("tramosGananciasCapitalHistorico").map(m=>m.año===e?{...m,tramos:b}:m)),q(`Tabla ${e} guardada`)),t.onDatosCambiados(),l()})}return{abrir:l}}function br(t){function e(){if(t.navegar)return t.navegar("planner");const s=globalThis.Router;s==null||s.navigate("planner")}function a(s,i,r){const l=ha(s,i,r),p=s.targetAmount||0,g=p>0?Math.min(100,l/p*100):0;return`
      ...
      </div>`}function o(s){const i=t.store.get("goals");if(i.length===0){s.innerHTML="",s.style.display="none";return}s.style.display="";const r=t.store.get("accounts"),l=t.colchonEnFecha(t.hoy()),p=[...i].sort((g,u)=>(g.prioridad||99)-(u.prioridad||99));s.innerHTML=`
      <div class="flex justify-between items-center mb-12" style="gap:10px;flex-wrap:wrap">
      ...
      </div>`}function n(s,i){D(s,"[data-ir-planner]",()=>e()),D(s,"[data-descartar-goals]",()=>{const r=t.store.get("goals").length;if(Z(`Se van a borrar ${r} objetivo${r!==1?"s":""} de ahorro antiguos. ¿Seguro?`)){for(const l of[...t.store.get("goals")])t.store.removeItem("goals",l._id);q("Objetivos antiguos descartados"),t.onDatosCambiados(),i()}})}return{render:o,wire:n}}const hr="M11.8 10.9c-2.27-.59-3-1.2-3-2.15 0-1.09 1.01-1.85 2.7-1.85 1.78 0 2.44.85 2.5 2.1h2.21c-.07-1.72-1.12-3.3-3.21-3.81V3h-3v2.16c-1.94.42-3.5 1.68-3.5 3.61 0 2.31 1.91 3.46 4.7 4.13 2.5.6 3 1.48 3 2.41 0 .69-.49 1.79-2.7 1.79-2.06 0-2.87-.92-2.98-2.1h-2.2c.12 2.19 1.76 3.42 3.68 3.83V21h3v-2.15c1.95-.37 3.5-1.5 3.5-3.55 0-2.84-2.43-3.81-4.7-4.4z",yr=120;function xr(t){const e=t.hoy??Y,a=()=>{var F;return(F=t.onDatosCambiados)==null?void 0:F.call(t)},o=t.mostrarObjetivos??(()=>!0),n=new Map,s=()=>t.store.get("config"),i=()=>t.store.get("escenarios"),r=F=>{var w;return((w=i().find(P=>P._id===F))==null?void 0:w.nombre)??F},l=F=>{var w;return((w=t.store.get("accounts").find(P=>P._id===F))==null?void 0:w.nombre)??F},p=()=>bt(t.store.get("tramosIRPFHistorico"),s().tramos_irpf??gt)(Number(e().slice(0,4))),g=()=>bt(t.store.get("tramosGananciasCapitalHistorico"),s().tramosGananciasCapital??jt),u=()=>g()(Number(e().slice(0,4))),d=F=>qa(t.store.get("expenses"),s(),t.store.get("loans"),F);function h(){const F=s(),w=t.store.get("accounts"),P=Wt({loans:[],expenses:t.store.get("expenses").filter(k=>k.tipo==="transferencia"),accounts:w,config:{dashboardStart:F.dashboardStart,dashboardEnd:F.dashboardEnd,fechaReferencia:F.dashboardStart},nominas:[],resolverTramosGanancias:g()}),T=new Map,R=k=>{let L=T.get(k);return L||(L={entradas:[],salidas:[],totalAportaciones:0,totalReembolsos:0,retencion:0},T.set(k,L)),L},O=(k,L)=>{const B=`${L.sourceId}`,N=k.find(U=>U.concepto===B),H=N??{concepto:B,contraparte:"",total:0,ocurrencias:0};H.total+=Math.abs(L.cuantia),H.ocurrencias+=1,N||k.push(H)};for(const k of P){if(!k.cuenta)continue;const L=R(k.cuenta);k.sourceType==="transfer-in"||k.sourceType==="traspaso-in"?(L.totalAportaciones+=Math.abs(k.cuantia),O(L.entradas,k)):k.sourceType==="transfer-out"||k.sourceType==="traspaso-out"?(L.totalReembolsos+=Math.abs(k.cuantia),O(L.salidas,k)):k.sourceType==="investment-tax"&&(L.retencion+=Math.abs(k.cuantia))}const _=t.store.get("expenses");for(const k of T.values())for(const[L,B]of[[k.entradas,"cuenta"],[k.salidas,"cuentaDestino"]])for(const N of L){const H=_.find(U=>U._id===N.concepto);N.contraparte=l((H==null?void 0:H[B])??"default"),N.concepto=(H==null?void 0:H.concepto)||(B==="cuenta"?"Aportación":"Reembolso")}return T}function y(){const F=new Map,w=s(),P=e(),T=new Date(Number(P.slice(0,4)),Number(P.slice(5,7))-1+yr+1,0),R=`${T.getFullYear()}-${String(T.getMonth()+1).padStart(2,"0")}-${String(T.getDate()).padStart(2,"0")}`;return O=>{const _=F.get(O._id);if(_)return _;const k=Wt({loans:t.store.get("loans"),expenses:t.store.get("expenses"),accounts:t.store.get("accounts"),config:{...w,dashboardStart:P,dashboardEnd:R,fechaReferencia:P},filtroAccounts:[O._id],nominas:t.store.get("nominas"),inflacionPeriodos:t.store.get("inflacion"),resolverTramosIRPF:bt(t.store.get("tramosIRPFHistorico"),w.tramos_irpf??gt),resolverTramosGanancias:g()}).map(L=>({fecha:L.fecha,saldoAcum:L.saldoAcum}));return F.set(O._id,k),k}}const I=br({store:t.store,colchonEnFecha:d,extractoCuenta:F=>A(F),hoy:e,onDatosCambiados:a});let A=y();function f(F){A=y();const P=t.store.get("accounts").filter(_=>mt(_)!=="pension"),T=h(),R={config:s(),inflacion:t.store.get("inflacion"),nominas:t.store.get("nominas"),tramosIRPF:p(),tramosGanancias:u(),nombreEscenario:r,flujos:_=>T.get(_)??or,invModo:_=>n.get(_)??"proyeccion"};F.innerHTML=`
      <div class="page-header">
      ...
      ${sr(P,R.tramosGanancias)}
      <div class="grid-3">${P.map(_=>cr(_,R)).join("")}</div>
      ${o()?'<div class="card mt-14" id="goals-section"></div>':""}`;const O=F.querySelector("#goals-section");O&&I.render(O)}const b=()=>document.getElementById("modal-overlay"),m=()=>document.getElementById("modal-content"),$=()=>{var F;return(F=b())==null?void 0:F.classList.add("hidden")};function v(F,w){const P=b(),T=m();return!P||!T?null:(T.innerHTML=F?`<div class="modal-title">${c(F)}</div>${w}`:w,P.classList.remove("hidden"),D(T,"[data-cancelar]",$),T)}function x(F,w){const P=F?t.store.get("accounts").find(_=>_._id===F)??null:null,T=[...(P==null?void 0:P.planAportaciones)??[]].map(_=>({..._})),R=P?M(P):null,O=v(F?"Editar cuenta / fondo":"Nueva cuenta / fondo",pr(P,{escenarios:i(),nominas:t.store.get("nominas"),hoy:e(),saldoActual:R??0}));O&&(mr(O,T,e()),D(O,"[data-guardar-acc]",_=>{const k=_.getAttribute("data-guardar-acc")||"",{datos:L,punto:B,error:N}=fr(O,T,P,R,e());if(N)return q(N,"err");let H=k;k?t.store.updateItem("accounts",k,L):H=t.store.addItem("accounts",L)._id,B&&t.ledger.registrarPuntoControl(H,B.fecha,B.saldo,B.nota),q(k?"Actualizada":"Cuenta / fondo creado"),a(),$(),w()}))}function M(F){const w=t.ledger.puntosControl(F._id);return w.length>0?aa(w)[0].saldo:F.saldo??null}function S(F,w){const P=t.store.get("accounts").find(O=>O._id===F);if(!P)return;const T=v("Histórico de saldos",vr(P.nombre,F,aa(t.ledger.puntosControl(F)),P.saldoInicial||0,e()));if(!T)return;const R=()=>{w(),S(F,w)};D(T,"[data-hist-anadir]",()=>{var L,B,N;const O=((L=T.querySelector("#hi-fecha"))==null?void 0:L.value)??"",_=parseFloat(((B=T.querySelector("#hi-saldo"))==null?void 0:B.value)??""),k=((N=T.querySelector("#hi-nota"))==null?void 0:N.value.trim())??"";if(!O||!Number.isFinite(_))return q("Fecha y saldo requeridos","err");t.ledger.registrarPuntoControl(F,O,_,k||void 0),q("Punto añadido"),a(),R()}),D(T,"[data-hist-borrar]",O=>{const[,_]=(O.getAttribute("data-hist-borrar")||"").split("|");t.ledger.eliminarPuntoControl(_),q("Eliminado"),a(),R()}),D(T,"[data-hist-inicial]",O=>{const[_,k]=(O.getAttribute("data-hist-inicial")||"").split("|"),L=t.ledger.puntosControl(_).find(N=>N._id===k);if(!L)return;const B=aa([L])[0].saldo;t.store.updateItem("accounts",_,{saldoInicial:B,fechaInicialSaldo:L.fecha}),q(`Punto inicial → ${L.fecha} (${j(B)})`),a(),R()})}function C(F){const w=t.store.get("accounts").filter(R=>R.activo);if(w.length===0)return q("No hay cuentas activas","err");const P=e(),T=w.map(R=>`• ${R.nombre}: ${j(M(R)??R.saldoInicial??0)}`).join(`
`);if(Z(`¿Actualizar el saldo inicial de estas cuentas a su saldo actual (${P})?

${T}

Esto recalibra el punto de arranque del dashboard.`)){for(const R of w)t.store.updateItem("accounts",R._id,{saldoInicial:M(R)??R.saldoInicial??0,fechaInicialSaldo:P});q("Saldo base actualizado"),a(),F()}}function z(F,w,P){D(F,"[data-nueva-acc]",()=>x(null,w)),D(F,"[data-editar-acc]",T=>x(T.getAttribute("data-editar-acc"),w)),D(F,"[data-tramos-ganancias]",()=>P.abrir()),D(F,"[data-reset-base]",()=>C(w)),D(F,"[data-hist-acc]",T=>S(T.getAttribute("data-hist-acc"),w)),D(F,"[data-principal-acc]",T=>{const R=T.getAttribute("data-principal-acc");t.store.set("accounts",t.store.get("accounts").map(O=>({...O,esCuentaPrincipal:O._id===R}))),q("Cuenta marcada como principal"),a(),w()}),D(F,"[data-borrar-acc]",T=>{const R=T.getAttribute("data-borrar-acc");if(t.store.get("accounts").length<=1)return q("Debe existir al menos una cuenta","err");if(!Z("¿Eliminar cuenta?"))return;t.store.removeItem("accounts",R);const _=t.store.get("accounts");_.length>0&&!_.some(k=>k.esCuentaPrincipal)&&t.store.set("accounts",_.map((k,L)=>L===0?{...k,esCuentaPrincipal:!0}:k)),q("Cuenta eliminada"),a(),w()}),D(F,"[data-inv-modo]",T=>{const[R,O]=(T.getAttribute("data-inv-modo")||"").split("|");n.set(R,O==="real"?"real":"proyeccion"),w()}),I.wire(F,w)}let E=null;return{id:"accounts",route:"accounts",nombre:"Cuentas y ahorro",flagId:"accounts",seccion:1,iconoPath:hr,mount(F){const w=()=>f(F);E??(E=gr({store:t.store,onDatosCambiados:()=>{a(),w()},año:()=>Number(e().slice(0,4))})),f(F),F.dataset.wired!=="1"&&(z(F,w,E),F.dataset.wired="1")}}}const ot=(t,e,a="var(--text)",o=!1)=>`<tr>
  ...
  </div>`;function $r(t){const e=t.extras,a=t.nominas.length===0?`<div class="auth-hint mb-12" style="border-color:var(--yellow)">
  ...
  </table>`}const Ir=(t,e,a)=>`<div class="card" style="text-align:center;padding:48px">
    ...
    <div class="text-sm" style="color:var(--text2);max-width:380px;margin:0 auto">${a}</div>
        ...
        <div class="card mb-10">
          ...
          <div class="grid-2" style="gap:8px">
            ${ct(`Plusvalía latente (${g>=0?"+":""}${g.toFixed(1)}%)`,j(p.plusvalia),p.plusvalia>=0?"pos":"neg")}
      ...
      <div class="text-sm mt-8" style="color:var(--text3)">
    ...
    </div>`}function Mr(t){const{nominas:e,planes:a,tramos:o}=t,n=h=>h.grupoNomina?e.filter(y=>(y.grupoNomina||"")===h.grupoNomina):null,s=e.map(h=>({n:h,d:De(h,n(h),o)})),i=s.reduce((h,y)=>h+y.d.brutoAnual,0),r=s.reduce((h,y)=>h+y.d.irpfAnual,0),l=s.reduce((h,y)=>h+y.d.ssAnual,0),p=s.length===0?'<div class="text-sm" style="color:var(--text3);padding:12px 0">Sin nóminas activas. Configúralas en el módulo <strong>Nóminas</strong>.</div>':s.map(({n:h,d:y})=>`
        <div class="card">
        ...
        <div class="card">
          ...
          <div style="margin-top:10px;padding:10px;background:var(--bg3);border-radius:var(--radius);border:1px solid var(--border)">
            ...
            ${yt(`Ahorro IRPF est. (marginal ${g} %)`,j(f),"pos")}
            ${b?`<div class="text-sm mt-6" style="color:var(--red)">⚠ La aportación supera el límite deducible (${c(j(Et))})</div>`:""}
          </div>
    ...
    </div>`}const To=[["declaracion","Declaración Renta"],["mobiliario","Capital Mobiliario"],["trabajo","Rendimientos del Trabajo"],["inmobiliario","Capital Inmobiliario"]],wr="M14 2H6c-1.1 0-2 .9-2 2v16c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V8l-6-6zm4 18H6V4h7v5h5v11zM8 15h8v2H8v-2zm0-4h8v2H8v-2zm0-4h4v2H8V7z";function Cr(t){const e=t.hoy??Y;let a="declaracion",o={};const n=()=>t.store.get("config"),s=()=>Number(e().slice(0,4)),i=()=>t.store.get("nominas").filter(b=>b.activo),r=()=>t.store.get("accounts").filter(b=>(b.modeloFondo||"cuenta")==="pension"),l=b=>{var m;return((m=t.store.get("escenarios").find($=>$._id===b))==null?void 0:m.nombre)??b},p=()=>bt(t.store.get("tramosIRPFHistorico"),n().tramos_irpf??gt)(s()),g=()=>bt(t.store.get("tramosGananciasCapitalHistorico"),n().tramosGananciasCapital??jt)(s());function u(){const b=`${s()}-01-01`,m=t.store.get("nominas").filter(x=>x.activo&&!x.simulacion),$=r().reduce((x,M)=>x+(M.aportaciones||[]).filter(S=>S.fecha>=b).reduce((S,C)=>S+C.cantidad,0),0),v=t.store.get("expenses").filter(x=>x.activo&&x.sujetoIRPF&&x.tipo==="ingreso").reduce((x,M)=>x+Sa(M),0);return Ca({nominas:m,aportacionesPension:$,otrosIngresos:v,extras:o,tramosGeneral:p(),tramosAhorro:g()})}function d(){const b=p(),m=i(),$=w=>w.grupoNomina?m.filter(P=>(P.grupoNomina||"")===w.grupoNomina):null,v=m.map(w=>De(w,$(w),b)),x=v.reduce((w,P)=>w+P.brutoAnual,0),M=v.reduce((w,P)=>w+P.irpfAnual,0),S=v.reduce((w,P)=>w+P.ssAnual,0),C=t.store.get("accounts").filter(w=>(w.modeloFondo||"cuenta")==="inversion");let z=0,E=0;for(const w of C){const P=Rt(w,g());P&&(z+=P.plusvalia,E+=P.impuesto)}if(x<=0&&C.length===0)return"";const F=(w,P,T)=>`<div class="exec-item"><div class="exec-item-label">${c(w)}</div><div class="exec-item-val ${T}">${c(P)}</div></div>`;return`<div class="exec-summary mb-14">
    ...
    </div>`}function h(){return a==="mobiliario"?Ar(t.store.get("accounts"),g(),l):a==="trabajo"?Mr({nominas:i(),planes:r(),tramos:p(),hoy:e()}):a==="inmobiliario"?Sr():$r({año:s(),extras:o,declaracion:u(),nominas:i().map(b=>({nombre:b.nombre,bruto:b.bruto||0})),planes:r().map(b=>b.nombre)})}function y(b,m){const $=a===b;return`<button data-tab-fisc="${b}" style="
    ...
    ">${c(m)}</button>`}function I(b){const m=b.querySelector("#fisc-tabs"),$=b.querySelector("#fisc-tab-content");m&&(m.innerHTML=To.map(([v,x])=>y(v,x)).join("")),$&&($.innerHTML=h())}function A(b){b.innerHTML=`
      ...
      <div id="fisc-tab-content">${h()}</div>`}function f(b){D(b,"[data-tab-fisc]",m=>{a=m.getAttribute("data-tab-fisc")||"declaracion",I(b)}),b.addEventListener("input",m=>{var M;if(!((M=m.target)==null?void 0:M.closest("[data-rex]")))return;const v=S=>{var C;return((C=b.querySelector(`#${S}`))==null?void 0:C.value)??"0"};o={capInmobiliario:parseFloat(v("rex-inmobiliario"))||0,capMobiliario:parseFloat(v("rex-mobiliario"))||0,gananciasFondos:parseFloat(v("rex-ganancias"))||0,otrasCorto:parseFloat(v("rex-otras"))||0,retCapital:parseFloat(v("rex-ret-cap"))||0};const x=b.querySelector("#renta-cuadro");x&&(x.innerHTML=_o(u()))})}return{id:"fiscalidad",route:"rentas",nombre:"Fiscalidad",flagId:"fiscalidad",seccion:2,iconoPath:wr,mount(b){A(b),b.dataset.wired!=="1"&&(f(b),b.dataset.wired="1")}}}const Do=()=>globalThis.Chart??null;function jr(t,e){const a=Do();if(!a)return null;const o=e.map(n=>({label:n.label,data:n.puntos.map(s=>({x:s.x,y:s.y})),borderColor:n.esBase?"#6b7280":n.color,backgroundColor:n.esBase?"transparent":`${n.color}18`,borderWidth:n.esBase?1.5:2,...n.esBase?{borderDash:[4,3]}:{fill:!1},pointRadius:2,tension:.3}));return new a(t,{type:"line",data:{datasets:o},options:{responsive:!0,interaction:{mode:"index",intersect:!1},plugins:{legend:{labels:{color:"var(--text2)",font:{size:11}}},tooltip:{callbacks:{label:n=>`${n.dataset.label}: ${j(n.parsed.y)}`}}},scales:{x:{type:"time",time:{unit:"month",displayFormats:{month:"MMM yy"}},ticks:{color:"var(--text3)",maxTicksLimit:12},grid:{color:"rgba(255,255,255,0.04)"}},y:{ticks:{color:"var(--text3)",callback:n=>j(n)},grid:{color:"rgba(255,255,255,0.04)"}}}}})}const zr=()=>Do()!==null,Pt=["#6366f1","#f59e0b","#10b981","#ef4444","#8b5cf6","#06b6d4","#f97316","#ec4899"],Er="M17 8C8 10 5.9 16.17 3.82 21h2.24c.38-1.35.86-2.63 1.47-3.8C9.44 16.16 12.05 15 16 15c-.02 3.31-.02 6 0 9h2V9l-1-1zm-4.5 3.5l-1.5 1.5L12.5 14H10v-2.5L8.5 10 10 8.5V6h2.5l1.5-1.5L15.5 6H18v2.5L19.5 10 18 11.5V14h-2.5l-1-1z";function Fr(t){const e=()=>{var x;return(x=t.onDatosCambiados)==null?void 0:x.call(t)},a=new Set;let o=null;const n=()=>t.store.get("config"),s=()=>t.store.get("escenarios"),i=x=>{var M;return x?((M=s().find(S=>S._id===x))==null?void 0:M.nombre)??x:"Base"};function r(x){const M=n(),S=xa({loans:t.store.get("loans"),expenses:t.store.get("expenses"),nominas:t.store.get("nominas"),accounts:t.store.get("accounts")},(x==null?void 0:x._id)??null),C=a.size>0?S.accounts.filter(w=>!a.has(w._id)):S.accounts,z=a.size>0?C.map(w=>w._id):null,E=x!=null&&x.fechaFin&&x.fechaFin>M.dashboardEnd?x.fechaFin:M.dashboardEnd;return{eventos:Wt({loans:S.loans,expenses:S.expenses,accounts:C,config:{...M,dashboardEnd:E},filtroAccounts:z,nominas:S.nominas,inflacionPeriodos:t.store.get("inflacion"),resolverTramosIRPF:bt(t.store.get("tramosIRPFHistorico"),M.tramos_irpf??gt),resolverTramosGanancias:bt(t.store.get("tramosGananciasCapitalHistorico"),M.tramosGananciasCapital??jt)}),horizonte:E}}function l(x){const M=t.store.get("loans"),S=F=>(F.escenarioIds||[]).includes(x),C=[[M.filter(S).length,"préstamo","préstamos"],[M.flatMap(F=>F.amortizaciones||[]).filter(S).length,"amortización","amortizaciones"],[t.store.get("expenses").filter(S).length,"gasto","gastos"],[t.store.get("accounts").filter(S).length,"cuenta","cuentas"],[t.store.get("nominas").filter(S).length,"nómina","nóminas"]],z=C.reduce((F,[w])=>F+w,0),E=C.filter(([F])=>F>0).map(([F,w,P])=>`${F} ${F===1?w:P}`).join(" · ");return{total:z,texto:E}}function p(x,M){const S=M===x._id,C=x.color||Pt[0],{total:z,texto:E}=l(x._id);return`<div class="card mb-12" style="border-left:3px solid ${c(C)};padding:14px 16px">
    ...
    </div>`}function g(x){const M=n().dashboardEnd,S=ze(r(null).eventos,M);return`
    ...
    </div>`}function d(){if(o){try{o.destroy()}catch{}o=null}}function h(x){const M=n(),S=r(null),C=[{label:"Base (sin supuesto)",color:"#6b7280",esBase:!0,puntos:je(S.eventos,M.dashboardStart,M.dashboardEnd)}];return x.forEach((z,E)=>{const{eventos:F,horizonte:w}=r(z);C.push({label:z.nombre,color:z.color||Pt[E%Pt.length],puntos:je(F,M.dashboardStart,w)})}),C}function y(x,M){d();const S=x.querySelector("#chart-comparacion");S&&(o=jr(S,h(M)))}function I(x){d();const M=new Set(t.store.get("accounts").map(z=>z._id));for(const z of[...a])M.has(z)||a.delete(z);const S=s(),C=n().escenarioActivo||null;x.innerHTML=`
      <div class="page-header">
      ...
      ${S.length===0?`<div class="card mb-14" style="padding:20px 24px">
             ...
             </div>`:`<div>${S.map(z=>p(z,C)).join("")}</div>
             <div class="card-title mt-24" style="margin-bottom:12px">Comparativa de supuestos</div>
             <div class="card" style="padding:16px">
               <div id="esc-pastillas">${u()}</div>
               ${zr()?'<canvas id="chart-comparacion" height="160"></canvas>':'<div class="text-sm" style="color:var(--text3);padding:12px 0">El gráfico necesita Chart.js, que no se ha podido cargar. La tabla de abajo tiene los mismos datos.</div>'}
             </div>
             <div class="card mt-12" style="padding:14px" id="esc-comparativa">${g(S)}</div>`}`,S.length>0&&y(x,S)}const A=()=>document.getElementById("modal-overlay"),f=()=>document.getElementById("modal-content"),b=()=>{var x;return(x=A())==null?void 0:x.classList.add("hidden")};function m(x,M){const S=x?s().find(F=>F._id===x)??null:null,C=A(),z=f();if(!C||!z)return;const E=(S==null?void 0:S.color)||Pt[0];z.innerHTML=`
      ...
      </div>`,C.classList.remove("hidden"),D(z,"[data-cancelar]",b),D(z,"[data-color-esc]",F=>{const w=F.getAttribute("data-color-esc");z.querySelector("#esc-color").value=w;for(const P of z.querySelectorAll("[data-color-esc]"))P.style.border=P.getAttribute("data-color-esc")===w?"2px solid white":"2px solid transparent"}),D(z,"[data-guardar-esc]",F=>{const w=z.querySelector("#esc-nombre").value.trim();if(!w)return q("El nombre es obligatorio","err");const P={nombre:w,fechaFin:z.querySelector("#esc-fecha-fin").value||null,color:z.querySelector("#esc-color").value||Pt[0],descripcion:z.querySelector("#esc-desc").value.trim()},T=F.getAttribute("data-guardar-esc")||"";T?(t.store.updateItem("escenarios",T,P),q("Escenario actualizado")):(t.store.addItem("escenarios",P),q("Escenario creado")),e(),b(),M()})}function $(x,M){if(!Z("¿Eliminar este escenario? Los elementos asignados perderán esta asignación."))return;const S=C=>C.map(z=>({...z,escenarioIds:(z.escenarioIds||[]).filter(E=>E!==x)}));t.store.set("loans",S(t.store.get("loans")).map(C=>({...C,amortizaciones:S(C.amortizaciones||[])}))),t.store.set("expenses",S(t.store.get("expenses"))),t.store.set("nominas",S(t.store.get("nominas"))),t.store.set("accounts",S(t.store.get("accounts"))),n().escenarioActivo===x&&t.store.patchConfig({escenarioActivo:null}),t.store.removeItem("escenarios",x),q("Escenario eliminado"),e(),M()}function v(x,M){D(x,"[data-nuevo-esc]",()=>m(null,M)),D(x,"[data-editar-esc]",S=>m(S.getAttribute("data-editar-esc"),M)),D(x,"[data-borrar-esc]",S=>$(S.getAttribute("data-borrar-esc"),M)),D(x,"[data-activar-esc]",S=>{const C=S.getAttribute("data-activar-esc");t.store.patchConfig({escenarioActivo:C}),q(`Escenario "${i(C)}" activado`),e(),M()}),D(x,"[data-desactivar-esc]",()=>{t.store.patchConfig({escenarioActivo:null}),q("Volviendo a la realidad base"),e(),M()}),D(x,"[data-toggle-cuenta]",S=>{const C=S.getAttribute("data-toggle-cuenta");a.has(C)?a.delete(C):a.add(C);const z=x.querySelector("#esc-pastillas");z&&(z.innerHTML=u());const E=s(),F=x.querySelector("#esc-comparativa");F&&(F.innerHTML=g(E)),y(x,E)})}return{id:"escenarios",route:"escenarios",nombre:"Supuestos",flagId:"supuestos",seccion:2,iconoPath:Er,mount(x){const M=()=>I(x);I(x),x.dataset.wired!=="1"&&(v(x,M),x.dataset.wired="1")},unmount(){d()}}}const _r=1e-12,Ro=t=>Math.abs(t)<_r,No=t=>t/12;function Pr(t,e,a,o){if(a<=0)return Math.max(0,Math.ceil(t-e));const n=t-e;if(n<=0)return 0;const s=No(o);if(Ro(s))return Math.ceil(n/a);const i=Math.pow(1+s,a),r=(t-e*i)*s/(i-1);return r<=0?0:Math.ceil(r)}function Tr(t,e){const a=No(e);return Ro(a)?0:Math.round(t*a)}function Oo({rentaNetaMensual:t,tasaRetiroSeguro:e,tipoFiscalEfectivo:a}){if(e<=0)throw new RangeError("La tasa de retiro seguro tiene que ser mayor que cero.");if(a>=1)throw new RangeError("El tipo fiscal efectivo no puede llegar al 100 %.");const o=Math.round(t*12/(1-a));return{retiroBrutoAnual:o,capitalNecesario:Math.round(o/e)}}function qo(t,e){const[a,o]=t.split("-").map(Number),n=a*12+(o-1)+e,s=Math.floor(n/12),i=n%12+1;return`${s}-${String(i).padStart(2,"0")}`}function sa(t,e){const[a,o]=t.split("-").map(Number),[n,s]=e.split("-").map(Number);return(n-a)*12+(s-o)}const Lo=t=>Number(t.slice(0,4));function ye(t){return t.rentaDeseada?Oo(t.rentaDeseada).capitalNecesario:t.importeObjetivo??0}const Dr={_id:"__sin_vehiculo__"};function xe(t){var b,m,$;const e=Math.max(0,Math.floor(t.horizonteMeses)),a=new Map(t.vehiculos.map(v=>[v._id,v])),o=[...t.objetivos].sort((v,x)=>v.prioridad-x.prioridad).map(v=>({def:v,objetivo:ye(v),saldo:v.saldoActual,estado:ye(v)>0&&v.saldoActual>=ye(v)&&v.modoAsignacion!=="ABSORBE_RESIDUAL"?"COMPLETADO":"PENDIENTE",vehiculo:a.get(v.vehiculoId),aportadoEnAño:0,añoEnCurso:Lo(t.fechaInicio),ultimaSolicitud:0,solicitadoAcumulado:0,mesesReclamando:0})),n=new Map;for(const v of t.eventos){const x=n.get(v.fecha)??[];x.push(v),n.set(v.fecha,x)}const s=[],i=[],r=[];let l=t.perfil.netoMensual,p=t.perfil.gastosFijosMensuales,g=0,u=0;const d=[];for(let v=0;v<e;v++){const x=qo(t.fechaInicio,v),M=Lo(x);for(const _ of n.get(x)??[])if(_.tipo==="CAMBIO_INGRESOS")l=_.importe;else if(_.tipo==="CAMBIO_GASTOS_FIJOS")p=_.importe;else if(_.tipo==="NUEVA_DEUDA")p+=_.importe;else if(_.tipo==="INYECCION_CAPITAL"){const k=_.objetivoDestinoId?o.find(L=>L.def._id===_.objetivoDestinoId):void 0;k?k.saldo+=_.importe:l+=_.importe}for(const _ of o)_.añoEnCurso!==M&&(_.añoEnCurso=M,_.aportadoEnAño=0);const S=Math.max(0,l-p),C=Math.round(S*Rr(t.pctDisfrute));let z=S-C;const E=z,F=o.filter(_=>_.estado!=="COMPLETADO"),w=[];let P=0;const T=F.filter(_=>_.def.modoAsignacion==="ABSORBE_RESIDUAL"),R=F.filter(_=>_.def.modoAsignacion!=="ABSORBE_RESIDUAL");for(const _ of R){const k=Nr(_,x,v,t);_.ultimaSolicitud=k,k>0&&(_.solicitadoAcumulado+=k,_.mesesReclamando+=1),(_.def.modoAsignacion==="CUOTA_POR_FECHA"||_.def.modoAsignacion==="FIJO")&&(P+=k);const L=Math.max(0,Math.min(k,z));z-=L,_.saldo+=L,_.aportadoEnAño+=L,g+=L,L>0&&_.estado==="PENDIENTE"&&(_.estado="EN_CURSO"),w.push({objetivoId:_.def._id,asignado:L,solicitado:k,saldoTrasMes:_.saldo})}if(T.length>0&&z>0){const _=T.map(B=>Math.max(0,B.def.pesoResidual??1)),k=_.reduce((B,N)=>B+N,0)||T.length;let L=0;T.forEach((B,N)=>{const H=N===T.length-1?z-L:Math.floor(z*_[N]/k);L+=H,B.saldo+=H,B.aportadoEnAño+=H,g+=H,H>0&&B.estado==="PENDIENTE"&&(B.estado="EN_CURSO"),w.push({objetivoId:B.def._id,asignado:H,solicitado:0,saldoTrasMes:B.saldo})}),z-=L}else for(const _ of T)w.push({objetivoId:_.def._id,asignado:0,solicitado:0,saldoTrasMes:_.saldo});P>E&&d.push({mes:x,deficit:P-E});for(const _ of o)_.saldo<=0||(_.saldo+=Tr(_.saldo,((b=_.vehiculo)==null?void 0:b.rentabilidadRealAnual)??0));for(const _ of o)_.estado!=="COMPLETADO"&&(_.def.modoAsignacion==="ABSORBE_RESIDUAL"&&_.objetivo<=0||_.objetivo>0&&_.saldo>=_.objetivo&&(_.estado="COMPLETADO",i.push({objetivoId:_.def._id,nombre:_.def.nombre,mes:x,indice:v,importeFinal:_.saldo,cuotaLiberada:_.ultimaSolicitud})));for(const _ of o)w.some(k=>k.objetivoId===_.def._id)||w.push({objetivoId:_.def._id,asignado:0,solicitado:0,saldoTrasMes:_.saldo});const O=o.reduce((_,k)=>_+k.saldo,0);if(u+=C,s.push({indice:v,mes:x,netoMensual:l,gastosFijos:p,sobrante:S,disfrute:C,disponible:E,sinAsignar:z,asignaciones:w.sort((_,k)=>ko(o,_.objetivoId)-ko(o,k.objetivoId)),patrimonioTotal:O}),o.length>0&&o.every(_=>_.estado==="COMPLETADO"))break}const h=[];if(d.length>0){const v=Math.round(d.reduce((x,M)=>x+M.deficit,0)/d.length);r.push({severidad:"error",codigo:"INVIABLE",mensaje:`El plan no cabe en el flujo de caja durante ${d.length} mes${d.length!==1?"es":""} (desde ${d[0].mes}). Déficit medio: ${(v/100).toFixed(2)} €/mes.`,mes:d[0].mes,deficitMensual:v});for(const x of o)x.estado!=="COMPLETADO"&&x.def.fechaLimite&&x.def.modoAsignacion==="CUOTA_POR_FECHA"&&(x.estado="INVIABLE");h.push(...qr(o,t,v))}for(const v of o){const x=(m=v.vehiculo)==null?void 0:m.topeAportacionAnual;x&&v.def.modoAsignacion==="FIJO"&&(v.def.importeFijoMensual??0)*12>x&&r.push({severidad:"atencion",codigo:"TOPE_FISCAL",objetivoId:v.def._id,mensaje:`«${v.def.nombre}» pide ${((v.def.importeFijoMensual??0)/100).toFixed(2)} €/mes, que supera el tope anual de ${(x/100).toFixed(2)} €. Se aporta hasta el tope y se reanuda en enero.`})}for(const v of o)v.estado!=="COMPLETADO"&&v.objetivo>0&&v.def.modoAsignacion!=="ABSORBE_RESIDUAL"&&r.push({severidad:"atencion",codigo:"NUNCA_COMPLETADO",objetivoId:v.def._id,mensaje:`«${v.def.nombre}» no se completa dentro del horizonte de ${e} meses.`});const y=o.find(v=>v.def.tipo==="INVERSION_PERPETUA"),I=y?i.find(v=>v.objetivoId===y.def._id):void 0,A={};for(const v of o){const x=(($=v.vehiculo)==null?void 0:$._id)??Dr._id;A[x]=(A[x]??0)+v.saldo}const f={};for(const v of o)f[v.def._id]=v.estado;return{viable:d.length===0,mesesSimulados:s.length,serieMensual:s,hitos:i,fases:Or(s,i),avisos:r,propuestas:h,estadoFinal:f,resumen:{patrimonioFinal:o.reduce((v,x)=>v+x.saldo,0),patrimonioPorVehiculo:A,totalAportado:g,totalDisfrute:u,mesIndependencia:(I==null?void 0:I.mes)??null}}}const Rr=t=>Number.isFinite(t)?Math.min(1,Math.max(0,t)):0,ko=(t,e)=>t.findIndex(a=>a.def._id===e);function Nr(t,e,a,o){var s,i;const n=Math.max(0,t.objetivo-t.saldo);switch(t.def.modoAsignacion){case"ABSORBE_TODO":return n;case"FIJO":{const r=t.def.importeFijoMensual??0,l=(s=t.vehiculo)==null?void 0:s.topeAportacionAnual;if(!l)return t.objetivo>0?Math.min(r,n):r;const p=Math.max(0,l-t.aportadoEnAño),g=Math.min(r,p);return t.objetivo>0?Math.min(g,n):g}case"CUOTA_POR_FECHA":{if(n<=0)return 0;const r=t.def.fechaLimite?sa(e,t.def.fechaLimite):o.horizonteMeses-a;return Pr(t.objetivo,t.saldo,Math.max(0,r),((i=t.vehiculo)==null?void 0:i.rentabilidadRealAnual)??0)}default:return 0}}function Or(t,e){if(t.length===0)return[];const o=[0,...[...new Set(e.map(s=>s.indice))].sort((s,i)=>s-i).map(s=>s+1)].filter((s,i,r)=>r.indexOf(s)===i&&s<t.length),n=[];for(let s=0;s<o.length;s++){const i=o[s],r=(s+1<o.length?o[s+1]:t.length)-1;if(r<i)continue;const l=new Set;for(let p=i;p<=r;p++)for(const g of t[p].asignaciones)g.asignado>0&&l.add(g.objetivoId);n.push({desde:t[i].mes,hasta:t[r].mes,meses:r-i+1,objetivosActivos:[...l]})}return n}function qr(t,e,a){const o=[],n=Math.max(0,e.perfil.netoMensual-e.perfil.gastosFijosMensuales);if(n>0&&e.pctDisfrute>0){const l=Math.ceil(Math.min(e.pctDisfrute,a/n)*100);if(l>0){const p=Math.round(e.pctDisfrute*100);o.push({clase:"REDUCIR_DISFRUTE",magnitud:l,mensaje:`Bajar el disfrute ${l} punto${l!==1?"s":""} (del ${p} % al ${Math.max(0,p-l)} %) libera ${(Math.min(a,n*e.pctDisfrute)/100).toFixed(0)} €/mes.`})}}const s=t.filter(l=>l.def.modoAsignacion==="CUOTA_POR_FECHA"&&l.def.fechaLimite&&l.estado!=="COMPLETADO"),i=l=>l.mesesReclamando>0?l.solicitadoAcumulado/l.mesesReclamando:0,r=[...s].sort((l,p)=>i(p)-i(l))[0];if(r){const l=Math.max(0,r.objetivo-r.saldo),p=i(r),g=Math.max(1,sa(e.fechaInicio,r.def.fechaLimite)),u=Math.max(1,p-a),d=Math.ceil(l/u),h=Math.max(1,d-g);o.push({clase:"RETRASAR_FECHA",objetivoId:r.def._id,magnitud:h,mensaje:`Retrasar «${r.def.nombre}» ${h} mes${h!==1?"es":""}, hasta ${qo(r.def.fechaLimite,h)}, baja su cuota a lo que cabe en el flujo.`});const y=Math.min(Math.round(a*g),Math.max(0,r.objetivo-1));y>0&&o.push({clase:"REDUCIR_IMPORTE",objetivoId:r.def._id,magnitud:y,mensaje:`O reducir «${r.def.nombre}» en ${(y/100).toFixed(0)} €, de ${(r.objetivo/100).toFixed(0)} € a ${((r.objetivo-y)/100).toFixed(0)} €.`})}return s.length>1&&o.push({clase:"REORDENAR",magnitud:s.length,mensaje:`Hay ${s.length} objetivos con fecha compitiendo a la vez. Escalonarlos reparte la carga en vez de acumularla.`}),o.length===0&&o.push({clase:"REDUCIR_IMPORTE",magnitud:a,mensaje:`Faltan ${(a/100).toFixed(0)} €/mes. Hay que recortar aportaciones fijas, subir ingresos o bajar gastos por esa cantidad.`}),o}const Lr=()=>globalThis.Chart??null,$e=["#2ee6a8","#4d9fff","#a855f7","#f97316","#eab308","#22d3ee","#fb7185","#34d399"],Bo=new WeakMap;function kr(t,e,a){const o=Lr();if(!o)return null;const n=Bo.get(t);if(n)try{n.destroy()}catch{}const s=new Map,i=new Map(e.objetivos.map(h=>[h._id,h.vehiculoId])),r=new Set(e.objetivos.map(h=>h.vehiculoId));for(const h of r)s.set(h,[]);for(const h of a.serieMensual){const y=new Map;for(const I of h.asignaciones){const A=i.get(I.objetivoId);A&&y.set(A,(y.get(A)??0)+I.saldoTrasMes)}for(const I of r)s.get(I).push((y.get(I)??0)/100)}const l=h=>{var y;return((y=e.vehiculos.find(I=>I._id===h))==null?void 0:y.nombre)??"Sin vehículo"},p=[...r],g=p.map((h,y)=>a.serieMensual.map((I,A)=>p.slice(0,y+1).reduce((f,b)=>f+(s.get(b)[A]??0),0))),u=p.map((h,y)=>({label:l(h),data:g[y],borderColor:$e[y%$e.length],backgroundColor:`${$e[y%$e.length]}33`,fill:y===0?"origin":"-1",borderWidth:1.5,pointRadius:0,tension:.25})),d=new o(t,{type:"line",data:{labels:a.serieMensual.map(h=>h.mes),datasets:u},options:{responsive:!0,maintainAspectRatio:!1,interaction:{mode:"index",intersect:!1},plugins:{legend:{labels:{color:"#a9b6cc",font:{size:11},boxWidth:12}},tooltip:{backgroundColor:"#111a28",borderColor:"rgba(255,255,255,0.12)",borderWidth:1,titleColor:"#a9b6cc",bodyColor:"#eef3fb",callbacks:{label:h=>{const y=h.datasetIndex>0?h.chart.data.datasets[h.datasetIndex-1].data[h.dataIndex]??0:0;return` ${h.dataset.label}: ${j(h.parsed.y-y)}`}}}},scales:{x:{ticks:{color:"#6b7b96",maxTicksLimit:12},grid:{display:!1}},y:{ticks:{color:"#6b7b96",callback:h=>j(h)},grid:{color:"rgba(255,255,255,0.07)"}}}}});return Bo.set(t,d),d}const na=t=>j(t/100),Br={CUOTA_POR_FECHA:"Cuota para llegar a la fecha",ABSORBE_TODO:"Se lleva todo lo disponible",ABSORBE_RESIDUAL:"Recibe lo que sobre",FIJO:"Importe fijo al mes"},Hr={CUOTA_POR_FECHA:"Se recalcula cada mes con el saldo real: si un mes va sobrado, el siguiente pide menos.",ABSORBE_TODO:"Reclama todo el capital disponible hasta completarse. Es el modo típico de amortizar deuda.",ABSORBE_RESIDUAL:"No reclama nada; recoge lo que quede tras servir a los de prioridad superior.",FIJO:"Aporta siempre lo mismo, respetando el tope anual del vehículo si lo tiene."},Ho={COMPLETADO:"var(--accent)",EN_CURSO:"var(--text)",PENDIENTE:"var(--text3)",INVIABLE:"var(--red)"};function Gr(t,e){if(t.objetivos.length===0)return`<div class="card" style="text-align:center;padding:34px 20px">
    ...
    ${a.map(s=>{var i;return Vr(s,e,o,(i=n(s.vehiculoId))==null?void 0:i.nombre)}).join("")}`}function Vr(t,e,a,o){const n=ye(t),s=e.estadoFinal[t._id]??t.estado,i=a==null?void 0:a.asignaciones.find(u=>u.objetivoId===t._id),r=(i==null?void 0:i.solicitado)??0,l=e.hitos.find(u=>u.objetivoId===t._id),p=n>0?Math.min(100,t.saldoActual/n*100):0,g=e.avisos.filter(u=>u.objetivoId===t._id);return`
      ...
      <div style="display:flex;justify-content:space-between;align-items:flex-start;gap:12px;flex-wrap:wrap">
        <div style="flex:1;min-width:220px">
          <div style="display:flex;align-items:center;gap:8px;flex-wrap:wrap">
            ...
            <span class="badge" style="font-size:10px;background:var(--bg3);color:var(--text2)">${c(Br[t.modoAsignacion])}</span>
          ...
          <div class="text-sm" style="color:var(--text3);margin-top:4px">${c(Hr[t.modoAsignacion])}</div>
        </div>
    ...
    ${e.length===0?`<div class="card" style="text-align:center;padding:30px 20px">
             ...
             ${e.map(o=>Zr(o,t,a(o.objetivoDestinoId))).join("")}
           </div>`}`}function Zr(t,e,a){const o=sa(e.fechaInicio,t.fecha),n=o<0?"antes del inicio del plan":o===0?"en el primer mes":`dentro de ${o} mes${o!==1?"es":""}`,s=o<0||o>=e.horizonteMeses;return`
    <div style="display:flex;gap:12px;align-items:flex-start;padding:10px 0;border-bottom:1px solid var(--border)">
      <div style="font-size:16px;flex-shrink:0;width:24px;text-align:center">${Kr[t.tipo]}</div>
      <div style="flex:1;min-width:0">
        <div style="display:flex;align-items:center;gap:8px;flex-wrap:wrap">
    ...
    </div>`}function tl(t,e,a,o){const n=t.campos.map(i=>{const r=o[i.id];return`<div class="form-group">
    ...
    </div>`}function Vo(t,e){var o;const a={};for(const n of e.campos){const s=((o=t.querySelector(`#ev-${n.id}`))==null?void 0:o.value)??"",i=parseFloat(String(s).replace(",","."));a[n.id]=Number.isFinite(i)?Math.round(i*100):0}return a}const el=(t,e)=>Qr(t.calcular(e)),al=[-2,-1,0,1,2],ol=[-10,0,10],sl=[-20,0,20];function Uo(t){return t.hitos.length===0?null:Math.max(...t.hitos.map(e=>e.indice))}function nl(t,e,a,o,n){const s={};for(const l of o.hitos)s[l.objetivoId]=l.mes;const i=Uo(o),r=n?Uo(n):i;return{etiqueta:t,delta:e,esBase:a,viable:o.viable,hitos:s,desplazamientoMeses:i!==null&&r!==null?i-r:null,patrimonioFinal:o.resumen.patrimonioFinal}}function il(t,e,a){if(a===0)return t;switch(e){case"rentabilidad":return{...t,vehiculos:t.vehiculos.map(o=>({...o,rentabilidadRealAnual:Math.max(0,o.rentabilidadRealAnual+a/100)}))};case"disfrute":return{...t,pctDisfrute:Math.min(1,Math.max(0,t.pctDisfrute+a/100))};case"ingresos":return{...t,perfil:{...t.perfil,netoMensual:Math.max(0,Math.round(t.perfil.netoMensual*(1+a/100)))}}}}const rl=t=>t>0?`+${t}`:String(t);function ia(t,e,a,o,n,s){const i=xe(t),r=n.map(l=>nl(l===0?"Plan actual":`${rl(l)} ${s}`,l,l===0,l===0?i:xe(il(t,e,l)),i));return{palanca:e,titulo:a,descripcion:o,variantes:r}}function ll(t){return[ia(t,"rentabilidad","Rentabilidad de los vehículos","Mueve la rentabilidad real de todos los vehículos a la vez. Es la palanca que menos controlas.",al,"puntos"),ia(t,"disfrute","Porcentaje de disfrute","Lo que apartas para gastar en vez de asignar a objetivos. Es la palanca que más controlas.",ol,"puntos"),ia(t,"ingresos","Ingresos","Un ascenso, un cambio de trabajo o una reducción de jornada.",sl,"%")]}function cl(t){if(t===null)return"no comparable";if(t===0)return"sin cambio";const e=Math.abs(t),a=Math.floor(e/12),o=e%12,n=[a>0?`${a} año${a!==1?"s":""}`:"",o>0?`${o} mes${o!==1?"es":""}`:""].filter(Boolean).join(" y ");return t<0?`${n} antes`:`${n} más tarde`}const Yo=t=>j(t/100);function dl(t,e,a){return`
    ${ul(t,e)}
    ${t.length>1?pl(t):""}
    ${ml(a)}`}function ul(t,e){return`<div class="card mb-14">
  ...
  </div>`}function pl(t){const e=t.slice(0,3),a=e.map(r=>({plan:r,res:xe(r)})),o=Wr(a.map(({plan:r,res:l})=>({nombre:r.nombre,hitos:l.hitos}))),n=["Hito",...e.map(r=>r.nombre)].map((r,l)=>`<th style="text-align:${l===0?"left":"right"};padding:6px 8px;font-size:11px;color:var(--text3)">${c(r)}</th>`).join(""),s=o.map(r=>`<tr>
      <td style="padding:5px 8px;font-size:12px">${c(r.nombre)}</td>
      ${r.meses.map((l,p)=>{const g=r.diferencias[p],u=g===null||g===0?"var(--text2)":g<0?"var(--accent)":"var(--red)",d=p===0||g===null||g===0?"":`<div style="font-size:10px;color:${u}">${g>0?"+":""}${g} m</div>`;return`<td style="text-align:right;padding:5px 8px;font-family:var(--font-mono);font-size:11px;color:${u}">
            ${c(l??"no llega")}${d}
          </td>`}).join("")}
  ...
  </div>`}function ml(t){return t?`<div class="card">
    <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:12px;flex-wrap:wrap;gap:8px">
    ...
    </div>`}function fl(t){return`<div style="margin-bottom:18px">
    ...
    ${t.variantes.map(e=>{const a=e.desplazamientoMeses,o=a===null?"var(--text3)":a===0?"var(--text2)":a<0?"var(--accent)":"var(--red)";return`<div style="display:flex;justify-content:space-between;align-items:center;gap:10px;padding:5px 0;font-size:12px;${e.esBase?"border-top:1px solid var(--border);border-bottom:1px solid var(--border);":""}">
        ...
        <span style="display:flex;gap:14px;align-items:baseline">
          <span style="color:${o};font-size:11px">${c(cl(a))}</span>
  ...
  </div>`}const At=t=>j(t/100);function vl(t,e,a=0){return`
    ${gl(e)}
    ${bl(t,e)}
    <div class="card mb-14">
    ...
    ${hl(e)}
    ${yl(t,e)}
    ${xl(t,e,a)}`}function gl(t){if(t.avisos.length===0&&t.propuestas.length===0)return"";const e={error:"var(--red)",atencion:"var(--yellow)",info:"var(--text2)"},a=t.avisos.map(i=>`<div style="display:flex;gap:8px;font-size:12px;line-height:1.6;margin-bottom:5px">
    ...
    ${a}${o}
  </div>`}function bl(t,e){const a=(n,s,i="")=>`<div class="stat-card">
  ...
  </div>`}function hl(t){return t.hitos.length===0?`<div class="card mb-14"><div class="card-title mb-8">Hitos</div>
  ...
  </div>`}function yl(t,e){if(e.fases.length<=1)return"";const a=o=>{var n;return((n=t.objetivos.find(s=>s._id===o))==null?void 0:n.nombre)??o};return`<div class="card mb-14">
  ...
  </div>`}const ie=60;function xl(t,e,a=0){if(e.serieMensual.length===0)return"";const o=[...t.objetivos].sort((g,u)=>g.prioridad-u.prioridad),n=Math.ceil(e.serieMensual.length/ie),s=Math.min(Math.max(0,a),n-1),i=e.serieMensual.slice(s*ie,(s+1)*ie),r=["Mes","Disponible",...o.map(g=>g.nombre),"Sin asignar","Patrimonio"].map(g=>`<th style="text-align:right;padding:5px 8px;font-size:10px;color:var(--text3);font-weight:600;white-space:nowrap">${c(g)}</th>`).join(""),l=i.map(g=>{const u=o.map(d=>{const h=g.asignaciones.find(I=>I.objetivoId===d._id),y=(h==null?void 0:h.asignado)??0;return`<td style="text-align:right;padding:4px 8px;font-family:var(--font-mono);color:${y>0?"var(--text)":"var(--text3)"}">${c(y>0?At(y):"·")}</td>`}).join("");return`<tr>
    ...
    ${p}
  </div>`}function $l(t,e){const a=[...t.objetivos].sort((i,r)=>i.prioridad-r.prioridad),o=i=>(i/100).toFixed(2).replace(".",","),n=["Mes","Neto","Gastos fijos","Disfrute","Disponible",...a.map(i=>i.nombre),"Sin asignar","Patrimonio"],s=e.serieMensual.map(i=>[i.mes,o(i.netoMensual),o(i.gastosFijos),o(i.disfrute),o(i.disponible),...a.map(r=>{var l;return o(((l=i.asignaciones.find(p=>p.objetivoId===r._id))==null?void 0:l.asignado)??0)}),o(i.sinAsignar),o(i.patrimonioTotal)].join(";"));return[n.join(";"),...s].join(`
`)}const Bt=t=>{const e=typeof t=="number"?t:parseFloat(String(t).replace(",","."));return Number.isFinite(e)?Math.round(e*100):0},re=t=>(t/100).toFixed(2),Jo=t=>(t*100).toFixed(2),Ht=t=>{const e=parseFloat(String(t).replace(",","."));return Number.isFinite(e)?e/100:0},Il=[["AHORRO_OBJETIVO","Ahorrar una cantidad"],["AMORTIZAR_DEUDA","Amortizar deuda"],["INVERSION_PERPETUA","Independencia económica"],["APORTACION_FIJA","Aportación periódica"]],Al=[["CUOTA_POR_FECHA","Cuota para llegar a la fecha"],["ABSORBE_TODO","Se lleva todo lo disponible"],["ABSORBE_RESIDUAL","Recibe lo que sobre"],["FIJO","Importe fijo al mes"]],Ml=[["INMEDIATA","Inmediata"],["MEDIA","Media (con preaviso o penalización)"],["BLOQUEADA_HASTA_JUBILACION","Bloqueada hasta la jubilación"]],Sl=[["NULO","Nulo"],["BAJO","Bajo"],["MEDIO","Medio"],["ALTO","Alto"]],Wo={AHORRO_OBJETIVO:"CUOTA_POR_FECHA",AMORTIZAR_DEUDA:"ABSORBE_TODO",INVERSION_PERPETUA:"ABSORBE_RESIDUAL",APORTACION_FIJA:"FIJO"},lt=(t,e,a,o,n="",s="")=>`<div class="form-group">
    ...
    ${n?`<div class="text-sm mt-4" style="color:var(--text3)">${n}</div>`:""}
  </div>`;function wl(t,e,a){var l,p,g;const o=t===null,n=(t==null?void 0:t.tipo)??"AHORRO_OBJETIVO",s=(t==null?void 0:t.modoAsignacion)??Wo[n],i=!!(t!=null&&t.rentaDeseada),r=e.length>0?e.map(u=>[u._id,u.nombre]):[["","— no hay vehículos: crea uno primero —"]];return`
    <div class="grid-2" style="gap:10px">
    ...
    <div class="grid-2" style="gap:10px">
      ${Tt("ob-tipo","Tipo",Il,n)}
      ${Tt("ob-modo","Cómo pide dinero",Al,s)}
    </div>
    ...
    </div>`}function Cl(t,e,a){var p;const o=g=>{var u;return((u=t.querySelector(`#${g}`))==null?void 0:u.value)??""},n=o("ob-nombre").trim();if(!n)return null;const s=o("ob-tipo"),i=o("ob-modo"),r=((p=t.querySelector('input[name="ob-derivar"]:checked'))==null?void 0:p.value)==="renta",l=s==="INVERSION_PERPETUA"&&r;return{_id:(e==null?void 0:e._id)??`obj_${Date.now().toString(36)}${Math.random().toString(36).slice(2,6)}`,nombre:n,tipo:s,importeObjetivo:l?null:Bt(o("ob-importe")),fechaLimite:o("ob-fecha")||null,prioridad:Math.max(1,Number(o("ob-prioridad"))||a),modoAsignacion:i,vehiculoId:o("ob-vehiculo"),saldoActual:Bt(o("ob-saldo")),estado:(e==null?void 0:e.estado)??"PENDIENTE",notas:o("ob-notas"),...i==="FIJO"?{importeFijoMensual:Bt(o("ob-fijo"))}:{},...i==="ABSORBE_RESIDUAL"?{pesoResidual:Math.max(0,Number(o("ob-peso"))||1)}:{},...l?{rentaDeseada:{rentaNetaMensual:Bt(o("ob-renta")),tasaRetiroSeguro:Ht(o("ob-swr")),tipoFiscalEfectivo:Ht(o("ob-fiscal"))}}:{rentaDeseada:null}}}function jl(t){const e=a=>{var o;return((o=t.querySelector(`#${a}`))==null?void 0:o.value)??""};try{const{capitalNecesario:a}=Oo({rentaNetaMensual:Bt(e("ob-renta")),tasaRetiroSeguro:Ht(e("ob-swr")),tipoFiscalEfectivo:Ht(e("ob-fiscal"))});return`${(a/100).toLocaleString("es-ES",{minimumFractionDigits:0,maximumFractionDigits:0})} €`}catch{return"no calculable con esos parámetros"}}function zl(t,e,a){const o=t===null,n=!!(t!=null&&t.esDeuda),s=[["","— ninguna —"],...e.map(r=>[r._id,r.nombre])],i=[["","— ninguno —"],...a.map(r=>[r._id,`${r.nombre} (${r.tin} % TIN)`])];return`
    ...
    <div class="grid-2" style="gap:10px">
      ${Tt("ve-liquidez","Liquidez",Ml,(t==null?void 0:t.liquidez)??"INMEDIATA")}
      ${Tt("ve-riesgo","Riesgo",Sl,(t==null?void 0:t.riesgo)??"NULO")}
    </div>
    ...
    <div class="flex gap-8 mt-16" style="justify-content:flex-end;flex-wrap:wrap">
    ...
    </div>`}function El(t,e){var i;const a=r=>{var l;return((l=t.querySelector(`#${r}`))==null?void 0:l.value)??""},o=a("ve-nombre").trim();if(!o)return null;const n=((i=t.querySelector("#ve-deuda"))==null?void 0:i.checked)??!1,s=a("ve-tope").trim();return{_id:(e==null?void 0:e._id)??`veh_${Date.now().toString(36)}${Math.random().toString(36).slice(2,6)}`,nombre:o,rentabilidadRealAnual:Ht(a("ve-rent")),liquidez:a("ve-liquidez"),fiscalidadRetirada:Ht(a("ve-fiscal")),topeAportacionAnual:s?Bt(s):null,riesgo:a("ve-riesgo"),cuentaId:a("ve-cuenta")||null,prestamoId:n&&a("ve-prestamo")||null,esDeuda:n}}const Fl={CUOTA_POR_FECHA:"Cada mes calcula lo que hace falta para llegar a la fecha, con el saldo que lleva. Si un mes va sobrado, el siguiente pide menos.",ABSORBE_TODO:"Reclama todo lo disponible hasta completarse. Los de menor prioridad no reciben nada mientras tanto.",ABSORBE_RESIDUAL:"No reclama nada: recoge lo que quede tras servir a los de arriba. Es el modo del cubo de largo plazo.",FIJO:"Aporta siempre lo mismo. Si el vehículo tiene tope anual, se aporta hasta agotarlo y se reanuda en enero."},_l="M3 3v18h18v-2H5V3H3zm4 12h2v-5H7v5zm4 0h2V7h-2v8zm4 0h2v-3h-2v3z",Qo=t=>{const e=parseFloat(String(t).replace(",","."));return Number.isFinite(e)?Math.round(e*100):0},Ie=t=>(t/100).toFixed(2);function Pl(t){const e=t.hoy??Y;let a="config",o=null,n=0,s=null;function i(){const w=t.store.get("planes");return w.find(P=>P.activo)??w[0]??null}function r(){const w=i();return w||t.store.addItem("planes",{nombre:"Plan base",fechaInicio:e().slice(0,7),horizonteMeses:480,pctDisfrute:0,activo:!0,perfil:{netoMensual:0,gastosFijosMensuales:0,manual:!1},vehiculos:[],objetivos:[],eventos:[],creadoEn:e()})}function l(w){var T;const P=i();P&&(t.store.updateItem("planes",P._id,w),s=null,o=null,(T=t.onDatosCambiados)==null||T.call(t))}function p(){const P=t.store.get("nominas").filter(O=>O.activo).reduce((O,_)=>O+(_.bruto||0),0),T=Math.round(P*.75/12),R=t.store.get("expenses").filter(O=>O.activo&&O.basico&&O.tipo==="gasto").reduce((O,_)=>O+(_.cuantia||0),0);return{neto:Math.round(T*100),gastos:Math.round(R*100)}}function g(w){return s||(s=xe(w)),s}function u(w){const P=p(),T=Math.max(0,w.perfil.netoMensual-w.perfil.gastosFijosMensuales),R=Math.round(w.pctDisfrute*100);return`
      <div class="card mb-14">
        ...
        <div class="form-group mt-8">
          ...
          <div class="text-sm mt-4" style="color:var(--text3)">
            ...
            quedan <strong id="pl-disponible">${c(j(T*(1-w.pctDisfrute)/100))}</strong>/mes para los objetivos.
          </div>
        </div>
      ...
      </div>`}const h=()=>document.getElementById("modal-overlay"),y=()=>document.getElementById("modal-content"),I=()=>{var w;return(w=h())==null?void 0:w.classList.add("hidden")};function A(w,P){const T=h(),R=y();return!T||!R?null:(R.innerHTML=`<div class="modal-title">${c(w)}</div>${P}`,T.classList.remove("hidden"),R)}function f(w){l({objetivos:w})}function b(w,P){const T=i();if(!T)return;const R=P?T.objetivos.find(B=>B._id===P)??null:null,O=T.objetivos.reduce((B,N)=>Math.max(B,N.prioridad),0)+1,_=A(R?`Editar «${R.nombre}»`:"Nuevo objetivo",wl(R,T.vehiculos,O));if(!_)return;const k=()=>{var U;const B=(U=_.querySelector("#ob-modo"))==null?void 0:U.value,N=_.querySelector("#ob-modo-ayuda");N&&B&&(N.textContent=Fl[B]);const H=(Q,K)=>{const st=_.querySelector(Q);st&&(st.style.display=K?"block":"none")};H("#ob-bloque-fijo",B==="FIJO"),H("#ob-bloque-residual",B==="ABSORBE_RESIDUAL")};k();const L=()=>{const B=_.querySelector("#ob-capital-derivado");B&&(B.textContent=jl(_))};L(),J(_,"#ob-modo",k),J(_,"#ob-tipo",()=>{const B=_.querySelector("#ob-tipo").value,N=_.querySelector("#ob-modo");N&&(N.value=Wo[B]);const H=_.querySelector("#ob-bloque-perpetua");H&&(H.style.display=B==="INVERSION_PERPETUA"?"block":"none"),k()}),J(_,'input[name="ob-derivar"]',()=>{var U;const B=((U=_.querySelector('input[name="ob-derivar"]:checked'))==null?void 0:U.value)==="renta",N=_.querySelector("#ob-renta-campos"),H=_.querySelector("#ob-bloque-importe");N&&(N.style.display=B?"block":"none"),H&&(H.style.display=B?"none":"block"),L()}),J(_,"#ob-renta, #ob-swr, #ob-fiscal",L),D(_,"[data-ob-cancelar]",I),D(_,"[data-ob-guardar]",()=>{const B=Cl(_,R,O);if(!B){q("El objetivo necesita un nombre","err");return}if(!B.vehiculoId){q("Crea antes un vehículo donde meter el dinero","err");return}const N=T.objetivos.filter(H=>H._id!==B._id);f([...N,B]),I(),q(R?"Objetivo actualizado":`Objetivo «${B.nombre}» creado`),E(w)}),D(_,"[data-ob-borrar]",()=>{R&&Z(`¿Borrar «${R.nombre}»? Esto no se puede deshacer.`)&&(f(T.objetivos.filter(B=>B._id!==R._id)),I(),q("Objetivo borrado"),E(w))})}function m(w,P){const T=i();if(!T)return;const R=P?T.vehiculos.find(L=>L._id===P)??null:null,O=t.store.get("accounts").filter(L=>L.activo).map(L=>({_id:L._id,nombre:L.nombre})),_=t.store.get("loans").filter(L=>L.activo&&!L.simulacion).map(L=>({_id:L._id,nombre:L.nombre,tin:L.tin})),k=A(R?`Editar «${R.nombre}»`:"Nuevo vehículo",zl(R,O,_));k&&(J(k,"#ve-deuda",()=>{const L=k.querySelector("#ve-deuda").checked,B=k.querySelector("#ve-bloque-prestamo");B&&(B.style.display=L?"block":"none")}),J(k,"#ve-prestamo",()=>{const L=k.querySelector("#ve-prestamo").value,B=_.find(U=>U._id===L);if(!B)return;const N=k.querySelector("#ve-rent"),H=k.querySelector("#ve-nombre");N&&(N.value=String(B.tin)),H&&!H.value.trim()&&(H.value=`Amortizar ${B.nombre}`)}),D(k,"[data-ve-cancelar]",I),D(k,"[data-ve-guardar]",()=>{const L=El(k,R);if(!L){q("El vehículo necesita un nombre","err");return}const B=T.vehiculos.filter(N=>N._id!==L._id);l({vehiculos:[...B,L]}),I(),q(R?"Vehículo actualizado":`Vehículo «${L.nombre}» creado`),E(w)}),D(k,"[data-ve-borrar]",()=>{if(!R)return;const L=T.objetivos.filter(B=>B.vehiculoId===R._id);if(L.length>0){q(`No se puede borrar: lo usan ${L.length} objetivo${L.length!==1?"s":""}`,"err");return}Z(`¿Borrar el vehículo «${R.nombre}»?`)&&(l({vehiculos:T.vehiculos.filter(B=>B._id!==R._id)}),I(),q("Vehículo borrado"),E(w))}))}function $(w,P,T){const R=i();if(!R||P===T)return;const O=[...R.objetivos].sort((B,N)=>B.prioridad-N.prioridad),_=O.findIndex(B=>B._id===P),k=O.findIndex(B=>B._id===T);if(_<0||k<0)return;const[L]=O.splice(_,1);O.splice(k,0,L),f(O.map((B,N)=>({...B,prioridad:N+1}))),E(w)}function v(w){return w.vehiculos.length===0?`<div class="card mb-14" style="padding:12px 16px;background:rgba(255,209,102,0.06);border-color:rgba(255,209,102,0.28)">
        <div class="text-sm" style="color:var(--text2);line-height:1.7">
      ...
      <div style="display:flex;gap:8px;flex-wrap:wrap">
        ${w.vehiculos.map(P=>{const T=w.objetivos.filter(R=>R.vehiculoId===P._id).length;return`<button class="btn-secondary btn-sm" data-pl-editar-vehiculo="${c(P._id)}"
    ...
    </div>`}function x(w,P,T){const R=i(),O=Ur(P);if(!R||!O)return;const _=T?R.eventos.find(N=>N._id===T)??null:null,k={};O.id==="hijo"&&(k.actuales=R.perfil.gastosFijosMensuales),O.id==="subida-sueldo"&&(k.actual=R.perfil.netoMensual);const L=A(_?`Editar evento · ${O.nombre}`:O.nombre,tl(O,_,R,k));if(!L)return;const B=()=>{const N=L.querySelector("#ev-resultado");N&&(N.textContent=el(O,Vo(L,O)))};B();for(const N of O.campos)J(L,`#ev-${N.id}`,B);D(L,"[data-ev-cancelar]",I),D(L,"[data-ev-guardar]",()=>{var Q,K;const N=((Q=L.querySelector("#ev-fecha"))==null?void 0:Q.value)??"";if(!N){q("El evento necesita un mes","err");return}const H=Vo(L,O),U={_id:(_==null?void 0:_._id)??`ev_${Date.now().toString(36)}${Math.random().toString(36).slice(2,6)}`,fecha:N,tipo:O.tipo,importe:O.calcular(H),objetivoDestinoId:((K=L.querySelector("#ev-destino"))==null?void 0:K.value)||null,notas:O.resumir(H)};l({eventos:[...R.eventos.filter(st=>st._id!==U._id),U]}),I(),q(_?"Evento actualizado":"Evento añadido"),E(w)}),D(L,"[data-ev-borrar]",()=>{!_||!Z("¿Borrar este evento?")||(l({eventos:R.eventos.filter(N=>N._id!==_._id)}),I(),q("Evento borrado"),E(w))})}function M(w){var P;switch(w.tipo){case"CAMBIO_GASTOS_FIJOS":return"hijo";case"CAMBIO_INGRESOS":return"subida-sueldo";case"NUEVA_DEUDA":return"nueva-hipoteca";case"INYECCION_CAPITAL":return(P=w.notas)!=null&&P.includes("hipoteca")?"venta-vivienda":"inyeccion"}}function S(){const w=i();if(!w)return;const P=new Blob([JSON.stringify(w,null,2)],{type:"application/json"}),T=URL.createObjectURL(P),R=document.createElement("a");R.href=T,R.download=`plan-${w.nombre.replace(/[^\w-]+/g,"_")}-${e()}.json`,R.click(),URL.revokeObjectURL(T),q("Plan exportado")}function C(w){const P=document.createElement("input");P.type="file",P.accept="application/json,.json",P.addEventListener("change",async()=>{var R,O;const T=(R=P.files)==null?void 0:R[0];if(T)try{const _=JSON.parse(await T.text());if(!_||!Array.isArray(_.objetivos)||!Array.isArray(_.vehiculos)||!_.perfil){q("Ese fichero no es un plan de objetivos","err");return}const k=`${_.nombre??"Importado"} (importado)`,L=t.store.addItem("planes",{..._,nombre:k,activo:!1,creadoEn:e()});s=null,o=null,(O=t.onDatosCambiados)==null||O.call(t),q(`Plan «${L.nombre}» importado`),E(w)}catch(_){console.error("[Planner] Importación fallida:",_),q("No se ha podido leer el fichero","err")}}),P.click()}function z(w,P){switch(a){case"config":return u(w);case"objetivos":return Gr(w,P);case"simulacion":return vl(w,P,n);case"eventos":return Xr(w);case"escenarios":return dl(t.store.get("planes"),w._id,o)}}function E(w){const P=r(),T=g(P),R=(_,k)=>`<button class="period-btn ${a===_?"active":""}" data-pl-tab="${_}">${k}</button>`,O=T.viable?'<span class="badge badge-green">Plan viable</span>':'<span class="badge badge-red">No cabe en el flujo</span>';if(w.innerHTML=`
      <div class="page-header">
      ...
      <div id="pl-cuerpo">${z(P,T)}</div>`,a==="simulacion"){const _=w.querySelector("#pl-chart");_&&kr(_,P,T)}F(w)}function F(w){D(w,"[data-pl-tab]",T=>{a=T.dataset.plTab,E(w)}),J(w,"#pl-disfrute",T=>{const R=Number(T.value)/100,O=w.querySelector("#pl-pct-val");O&&(O.textContent=`${Math.round(R*100)} %`);const _=i();if(!_)return;const k=Math.max(0,_.perfil.netoMensual-_.perfil.gastosFijosMensuales)*(1-R),L=w.querySelector("#pl-disponible");L&&(L.textContent=j(k/100))}),D(w,"[data-pl-usar-sugerido]",()=>{const T=p(),R=w.querySelector("#pl-neto"),O=w.querySelector("#pl-gastos");R&&(R.value=Ie(T.neto)),O&&(O.value=Ie(T.gastos))}),D(w,"[data-pl-guardar]",()=>{const T=R=>{var O;return((O=w.querySelector(R))==null?void 0:O.value)??""};l({perfil:{netoMensual:Qo(T("#pl-neto")),gastosFijosMensuales:Qo(T("#pl-gastos")),manual:!0},pctDisfrute:Math.min(1,Math.max(0,Number(T("#pl-disfrute"))/100)),fechaInicio:T("#pl-inicio")||e().slice(0,7),horizonteMeses:Math.min(600,Math.max(1,Number(T("#pl-horizonte"))||480))}),q("Plan guardado"),E(w)}),D(w,"[data-pl-plantilla]",T=>x(w,T.dataset.plPlantilla??"",null)),D(w,"[data-pl-editar-evento]",T=>{var _;const R=T.dataset.plEditarEvento??"",O=(_=i())==null?void 0:_.eventos.find(k=>k._id===R);O&&x(w,M(O),R)}),D(w,"[data-pl-duplicar]",()=>{var _;const T=i();if(!T)return;const R=window.prompt("Nombre del plan nuevo:",`${T.nombre} (copia)`);if(!(R!=null&&R.trim()))return;const O=Jr(T,R.trim(),`plan_${Date.now().toString(36)}`,e());t.store.addItem("planes",O),(_=t.onDatosCambiados)==null||_.call(t),q(`Plan «${O.nombre}» creado. Actívalo para editarlo.`),E(w)}),D(w,"[data-pl-activar]",T=>{var O;const R=T.dataset.plActivar;if(R){for(const _ of t.store.get("planes"))t.store.updateItem("planes",_._id,{activo:_._id===R});s=null,o=null,(O=t.onDatosCambiados)==null||O.call(t),q("Plan activo cambiado"),E(w)}}),D(w,"[data-pl-renombrar]",T=>{var k;const R=T.dataset.plRenombrar,O=t.store.get("planes").find(L=>L._id===R);if(!O)return;const _=window.prompt("Nuevo nombre:",O.nombre);_!=null&&_.trim()&&(t.store.updateItem("planes",O._id,{nombre:_.trim()}),(k=t.onDatosCambiados)==null||k.call(t),E(w))}),D(w,"[data-pl-borrar-plan]",T=>{var k;const R=T.dataset.plBorrarPlan,O=t.store.get("planes").find(L=>L._id===R);if(!O||!Z(`¿Borrar el plan «${O.nombre}» con sus ${O.objetivos.length} objetivos? No se puede deshacer.`))return;t.store.removeItem("planes",O._id);const _=t.store.get("planes");O.activo&&_.length>0&&t.store.updateItem("planes",_[0]._id,{activo:!0}),s=null,o=null,(k=t.onDatosCambiados)==null||k.call(t),q("Plan borrado"),E(w)}),D(w,"[data-pl-sensibilidad]",()=>{const T=i();T&&(o=ll(T),E(w))}),D(w,"[data-pl-pagina]",T=>{n=Number(T.dataset.plPagina)||0,E(w)}),D(w,"[data-pl-exportar]",S),D(w,"[data-pl-importar]",()=>C(w)),D(w,"[data-pl-nuevo-objetivo]",()=>b(w,null)),D(w,"[data-pl-nuevo-vehiculo]",()=>m(w,null)),D(w,"[data-pl-editar-vehiculo]",T=>m(w,T.dataset.plEditarVehiculo??null)),D(w,"[data-pl-editar-objetivo]",T=>b(w,T.dataset.plEditarObjetivo??null));let P=null;w.querySelectorAll("[data-pl-objetivo]").forEach(T=>{T.addEventListener("dragstart",()=>{P=T.dataset.plObjetivo??null,T.style.opacity="0.45"}),T.addEventListener("dragend",()=>{T.style.opacity="",w.querySelectorAll("[data-pl-objetivo]").forEach(R=>R.style.borderTop="")}),T.addEventListener("dragover",R=>{R.preventDefault(),P&&T.dataset.plObjetivo!==P&&(T.style.borderTop="2px solid var(--accent)")}),T.addEventListener("dragleave",()=>{T.style.borderTop=""}),T.addEventListener("drop",R=>{R.preventDefault(),T.style.borderTop="";const O=T.dataset.plObjetivo;P&&O&&$(w,P,O),P=null})}),D(w,"[data-pl-csv]",()=>{const T=i();if(!T||!s)return;const R=new Blob(["\uFEFF"+$l(T,s)],{type:"text/csv;charset=utf-8"}),O=URL.createObjectURL(R),_=document.createElement("a");_.href=O,_.download=`plan-${T.nombre.replace(/[^\w-]+/g,"_")}-${e()}.csv`,_.click(),URL.revokeObjectURL(O),q(`CSV exportado (${s.serieMensual.length} meses)`)}),D(w,"[data-pl-guardar-notas]",()=>{var T;l({notas:((T=w.querySelector("#pl-notas"))==null?void 0:T.value)??""}),q("Notas guardadas")})}return{id:"planner",route:"planner",nombre:"Objetivos financieros",seccion:2,iconoPath:_l,mount:E}}function Ko(t,e,a=!1){const o=Math.abs(It(e));return t==="ingreso"?o:t==="gasto"||a?-o:o}function Tl(t){function e(m){return`${m}_${Date.now().toString(36)}${Math.random().toString(36).slice(2,7)}`}function a(m={}){var v;const $=(v=m.texto)==null?void 0:v.trim().toLowerCase();return t.get("transacciones").filter(x=>!(m.cuentaId&&x.cuentaId!==m.cuentaId||m.desde&&x.fecha<m.desde||m.hasta&&x.fecha>m.hasta||m.tipo&&x.tipo!==m.tipo||m.estimacionId&&x.estimacionId!==m.estimacionId||m.tags&&m.tags.length>0&&!m.tags.some(M=>x.tags.includes(M))||$&&!x.concepto.toLowerCase().includes($))).sort((x,M)=>x.fecha.localeCompare(M.fecha)||x._id.localeCompare(M._id))}function o(m){const $={_id:e("tx"),fecha:m.fecha,cuentaId:m.cuentaId,importeCts:Ko(m.tipo,m.importe,m.negativo),concepto:m.concepto,tags:m.tags??[],estimacionId:m.estimacionId??null,tipo:m.tipo,origen:m.origen??"manual",...m.nota?{nota:m.nota}:{}};return t.set("transacciones",[...t.get("transacciones"),$]),$}function n(m,$){t.set("transacciones",t.get("transacciones").map(v=>{if(v._id!==m)return v;const{importe:x,...M}=$,S={...v,...M};return x!==void 0&&(S.importeCts=Ko(S.tipo,x,S.importeCts<0)),S}))}function s(m){t.set("transacciones",t.get("transacciones").filter($=>$._id!==m))}function i(m,$){n(m,{estimacionId:$})}function r(m){return t.get("puntosControl").filter($=>!m||$.cuentaId===m).sort(($,v)=>$.fecha.localeCompare(v.fecha))}function l(m,$,v,x){const M={_id:e("pc"),fecha:$,cuentaId:m,saldoCts:It(v),...x?{nota:x}:{}},S=t.get("puntosControl").filter(C=>!(C.cuentaId===m&&C.fecha===$));return t.set("puntosControl",[...S,M].sort((C,z)=>C.fecha.localeCompare(z.fecha))),g(m),M}function p(m){const $=t.get("puntosControl").find(v=>v._id===m);t.set("puntosControl",t.get("puntosControl").filter(v=>v._id!==m)),$&&g($.cuentaId)}function g(m){const $=r(m),v=t.get("accounts");v.some(x=>x._id===m)&&t.set("accounts",v.map(x=>x._id===m?{...x,historicoSaldos:$.map(M=>({_id:M._id,fecha:M.fecha,saldo:et(M.saldoCts),...M.nota?{nota:M.nota}:{}}))}:x))}function u(m,$=Y()){const v=r(m).filter(C=>C.fecha<=$).pop(),x=v==null?void 0:v.fecha,M=(v==null?void 0:v.saldoCts)??0;return t.get("transacciones").filter(C=>C.cuentaId===m&&C.fecha<=$&&(x===void 0||C.fecha>x)).reduce((C,z)=>C+z.importeCts,M)}function d(m,$){return et(u(m,$))}function h(m=Y(),$){const v=$??t.get("accounts").filter(x=>x.activo).map(x=>x._id);return et(v.reduce((x,M)=>x+u(M,m),0))}function y(){return t.get("transacciones").length>0||t.get("puntosControl").length>0}function I(){const m=[...t.get("transacciones").map($=>$.fecha),...t.get("puntosControl").map($=>$.fecha)];return m.length>0?m.sort().pop()??null:null}function A(m={}){return et(a(m).reduce(($,v)=>$+v.importeCts,0))}function f(m={}){const $=new Map;for(const v of a(m)){const x=v.fecha.slice(0,7);$.set(x,($.get(x)??0)+v.importeCts)}return new Map([...$.entries()].sort(([v],[x])=>v.localeCompare(x)).map(([v,x])=>[v,et(x)]))}function b(m={}){const $=new Map;for(const v of a(m))for(const x of v.tags.length>0?v.tags:["sin_tag"])$.set(x,($.get(x)??0)+v.importeCts);return new Map([...$.entries()].map(([v,x])=>[v,et(x)]))}return{transacciones:a,registrar:o,actualizar:n,eliminar:s,asignarEstimacion:i,puntosControl:r,registrarPuntoControl:l,eliminarPuntoControl:p,saldoCuenta:d,saldoCuentaCts:u,saldoTotal:h,tieneDatos:y,ultimaFecha:I,total:A,totalPorMes:f,totalPorTag:b}}function xt(t){return t.trim().toLowerCase()}function Dl(t){function e(){const p=new Map,g=(u,d)=>{const h=xt(u);if(!h)return;const y=p.get(h)??{tag:h,estimaciones:0,reales:0,total:0};y[d]+=1,y.total+=1,p.set(h,y)};for(const u of t.get("expenses"))for(const d of u.tags??[])g(d,"estimaciones");for(const u of t.get("transacciones"))for(const d of u.tags??[])g(d,"reales");return[...p.values()].sort((u,d)=>d.total-u.total||u.tag.localeCompare(d.tag))}function a(){return e().map(p=>p.tag)}function o(p){return e().filter(g=>p==="estimaciones"?g.reales===0:g.estimaciones===0).map(g=>g.tag)}function n(p,g,u){const d=xt(g),h=(p??[]).map(xt);if(!h.includes(d))return p??[];const y=h.filter(I=>I!==d);return u===null?[...new Set(y)]:[...new Set([...y,xt(u)])]}function s(p,g){const u=xt(g);if(!u)throw new Error("El nuevo nombre de la etiqueta no puede estar vacío");return l(p,u)}function i(p,g){let u=0;for(const d of p)xt(d)!==xt(g)&&(u+=l(d,xt(g)).cambiados);return{cambiados:u}}function r(p){return l(p,null)}function l(p,g){let u=0;const d=t.get("expenses").map(M=>{const S=n(M.tags,p,g);return S!==M.tags&&(u+=1),S===M.tags?M:{...M,tags:S}});t.set("expenses",d);const h=t.get("transacciones").map(M=>{const S=n(M.tags,p,g);return S!==M.tags&&(u+=1),S===M.tags?M:{...M,tags:S}});t.set("transacciones",h);const y=t.get("loans").map(M=>{const S=n(M.tags,p,g);return S!==M.tags&&(u+=1),S===M.tags?M:{...M,tags:S}});t.set("loans",y);const I=t.get("nominas").map(M=>{const S=n(M.tags,p,g);return S!==M.tags&&(u+=1),S===M.tags?M:{...M,tags:S}});t.set("nominas",I);const A=t.get("config"),f=xt(p),b=M=>{const S=(M??[]).map(xt);if(!S.includes(f))return M??[];const C=S.filter(z=>z!==f);return g===null?[...new Set(C)]:[...new Set([...C,g])]},m={},$=b(A.activeTagsFilter),v=b(A.tagCategorias),x=b(A.tagGrupos);return $!==A.activeTagsFilter&&(m.activeTagsFilter=$),v!==A.tagCategorias&&(m.tagCategorias=v),x!==A.tagGrupos&&(m.tagGrupos=x),Object.keys(m).length>0&&t.patchConfig(m),{cambiados:u}}return{uso:e,todas:a,soloEn:o,renombrar:s,fusionar:i,eliminar:r}}const Rl=3;function Xo(t){return t<.005?0:t}function Nl(t){if(t.length<2)return null;const e=t.reduce((o,n)=>o+n,0)/t.length,a=t.reduce((o,n)=>o+(n-e)**2,0)/(t.length-1);return Math.sqrt(a)}function Ol(t){const e=[],a=[],o=[];for(const i of t){if(i.meses.length<Rl)continue;const r=Nl(i.meses.map(l=>l.desviacion));r!==null&&(e.push(r),a.push(r/Math.sqrt(i.meses.length)),o.push(i.meses.length))}if(e.length===0)return{sigmaMensual:0,sigmaDeriva:0,estimaciones:0,mesesMinimos:0,mesesMaximos:0,fiable:!1};const n=Math.sqrt(e.reduce((i,r)=>i+r*r,0)),s=Math.sqrt(a.reduce((i,r)=>i+r*r,0));return{sigmaMensual:Xo(n),sigmaDeriva:Xo(s),estimaciones:e.length,mesesMinimos:Math.min(...o),mesesMaximos:Math.max(...o),fiable:!0}}function Zo(t,e,a=1,o=0){if(e<=0)return 0;const n=Math.max(0,t)*Math.sqrt(e),s=Math.max(0,o)*e;return n===0&&s===0?0:W(a*Math.hypot(n,s))}function ql(t,e,a={}){if(!e.fiable||t.length===0)return[];const{z:o=1}=a,n=a.desde??t[0].fecha,[s,i]=n.slice(0,7).split("-").map(Number);return t.map(r=>{const[l,p]=r.fecha.slice(0,7).split("-").map(Number),g=Math.max(0,(l-s)*12+(p-i)),u=Zo(e.sigmaMensual,g,o,e.sigmaDeriva);return{fecha:r.fecha,saldo:r.saldoAcum,arriba:W(r.saldoAcum+u),abajo:W(r.saldoAcum-u)}})}function Ll(t,e=1){if(!t.fiable)return"Necesita al menos 3 meses de contabilidad real para medir cuánto se desvían tus estimaciones.";if(t.sigmaMensual===0)return"Sin margen de error: tus estimaciones se desvían siempre lo mismo, así que no hay incertidumbre que dibujar. Si se desvían de forma sistemática, ajústalas desde el cierre de mes.";const a=e>=2?"95 %":"68 %",o=t.mesesMinimos===t.mesesMaximos?`${t.mesesMinimos}`:`${t.mesesMinimos}–${t.mesesMaximos}`;return`Banda de ±${e} desviación${e!==1?"es":""} típica${e!==1?"s":""} (${a} de los casos), medida sobre ${t.estimaciones} estimación${t.estimaciones!==1?"es":""} con ${o} mes${t.mesesMaximos!==1?"es":""} de datos reales. Se ensancha con el tiempo, y tanto más deprisa cuanto menos historial haya: tu gasto medio también es una estimación.`}const ra="financeapp_session",kl=["local","dropbox","firebase"];function Bl(t){if(!t)return null;try{const e=JSON.parse(t);if(!e||!kl.includes(e.modo))return null;const a=Number(e.creadaEn),o=Number(e.ultimoUso);return!Number.isFinite(a)||!Number.isFinite(o)?null:{modo:e.modo,...typeof e.email=="string"?{email:e.email}:{},...typeof e.passphrase=="string"?{passphrase:e.passphrase}:{},creadaEn:a,ultimoUso:o}}catch{return null}}function Hl({storage:t,autoLogoutMinutos:e=()=>0,ahora:a=()=>Date.now()}={}){const o=()=>t??(typeof localStorage<"u"?localStorage:null);function n(d){const h=o();if(h)try{d?h.setItem(ra,JSON.stringify(d)):h.removeItem(ra)}catch{}}function s(){const d=o();if(!d)return null;try{return Bl(d.getItem(ra))}catch{return null}}function i(){const d=s();return d?(a()-d.ultimoUso)/6e4:null}function r(){const d=e();if(!Number.isFinite(d)||d<=0)return!1;const h=i();return h!==null&&h>=d}function l(){const d=s();return d?r()?(n(null),null):d:null}function p(d){const h=a(),y={modo:d.modo,...d.email?{email:d.email}:{},...d.passphrase?{passphrase:d.passphrase}:{},creadaEn:h,ultimoUso:h};return n(y),y}function g(){const d=s();d&&n({...d,ultimoUso:a()})}function u(){n(null)}return{abrir:p,leer:l,tocar:g,cerrar:u,caducada:r,inactividadMinutos:i,get activa(){return l()!==null}}}const ts=["pointerdown","keydown","visibilitychange"];function Gl({sesion:t,onCaducada:e,intervaloMs:a=3e4,setIntervalImpl:o=setInterval,clearIntervalImpl:n=clearInterval,target:s=typeof document<"u"?document:void 0}){let i=!0;const r=()=>{i&&t.tocar()};for(const g of ts)s==null||s.addEventListener(g,r);const l=o(()=>{i&&t.caducada()&&(p(),t.cerrar(),e())},a);function p(){if(i){i=!1,n(l);for(const g of ts)s==null||s.removeEventListener(g,r)}}return p}const Vl=[{minutos:0,etiqueta:"Nunca (solo manualmente)"},{minutos:15,etiqueta:"Tras 15 minutos de inactividad"},{minutos:60,etiqueta:"Tras 1 hora de inactividad"},{minutos:480,etiqueta:"Tras 8 horas de inactividad"},{minutos:10080,etiqueta:"Tras 7 días de inactividad"}];function es(){if(typeof localStorage<"u"){const d=bn();d.length>0&&console.info(`[FinanceApp] Recuperadas claves escritas fuera del espacio de nombres: ${d.join(", ")}`)}const t=yn({adapter:gn()}),{applied:e}=t.load();e.length>0&&console.info(`[FinanceApp] Migraciones aplicadas: ${e.join(", ")} (esquema v${Xt})`);const a=$n(t);Ns(d=>a.isEnabled(d));const o=Hl({autoLogoutMinutos:()=>{var h,y;const d=(y=(h=globalThis.State)==null?void 0:h.get)==null?void 0:y.call(h,"config");return Number((d==null?void 0:d.autoLogoutMinutos)??t.get("config").autoLogoutMinutos??0)}}),n=Tl(t),s=Dl(t),i=Kn(n),r=_n(t),l=Cn({isEnabled:d=>a.isEnabled(d)}),p=wn({flags:a,rutasExtra:()=>l.flagPorRuta()}),g=Sn({flags:a,onChange:()=>{var d,h;l.attachToShell(),p.apply(),(h=(d=globalThis.Router)==null?void 0:d.rerender)==null||h.call(d)}}),u=()=>{var h,y,I,A,f,b;const d=globalThis;if((y=(h=d.State)==null?void 0:h.load)==null||y.call(h),((A=(I=d.Router)==null?void 0:I.current)==null?void 0:A.call(I))==="dashboard")try{(b=(f=d.DashboardModule)==null?void 0:f.render)==null||b.call(f)}catch(m){console.error("[FinanceApp] No se ha podido repintar el cuadro de mando tras el cambio:",m)}};return l.register(Mi({store:t,onDatosCambiados:u})),l.register(Di({store:t,onDatosCambiados:u})),l.register(tr({store:t,onDatosCambiados:u})),l.register(xr({store:t,ledger:n,mostrarObjetivos:()=>a.isEnabled("goals"),onDatosCambiados:u})),l.register(ci({ledger:n,tags:s,precision:i,adjuster:r,accounts:()=>t.get("accounts"),estimaciones:()=>t.get("expenses"),onDatosCambiados:u})),l.register(Pl({store:t,onDatosCambiados:u})),l.register(Fr({store:t,onDatosCambiados:u})),l.register(bi({store:t,onDatosCambiados:u})),l.register(Cr({store:t})),l.register(ui({store:t,onDatosCambiados:u})),{version:Xt,core:ys,engine:{generarExtracto:Wt,recomputarSaldoAcum:Is,saldoHoy:As,sumarPorTags:Na,providers:{proyectarGastos:Jt,proyectarPrestamos:ja,proyectarTransferencias:za,proyectarNominas:Pa,proyectarInteresesCuentas:Fa,proyectarAportaciones:Ea,proyectarRetencionesFiscales:_a,proyectarInflacionGastos:Ta,proyectarPerdidaAhorro:Da},analysis:Cs,margins:Fs,avisos:Ds,optimizer:Os,dashboard:Xs},store:t,flags:a,featureRegistry:{all:Ct,porGrupo:io},ui:{openFeatures:g.open,applyGating:p.apply,watchGating:()=>p.observar()},app:l,session:Object.assign(o,{vigilar:d=>Gl({sesion:o,onCaducada:d}),opciones:Vl}),accounting:{ledger:n,tags:s,precision:i,adjuster:r,sugerirAjuste:Ye,medirVariabilidad:Ol,bandaDeConfianza:ql,bandaAcumulada:Zo,describirBanda:Ll}}}function Ul(){try{const t=es();return window.FinanceApp=t,t}catch(t){const e=t;return window.FinanceAppError={mensaje:(e==null?void 0:e.message)??String(t),stack:e==null?void 0:e.stack},console.error("[FinanceApp] El paquete nuevo no pudo arrancar:",t),null}}const Ae=typeof window<"u"?Ul():null;if(Ae){let t=!1;const e=()=>{Ae.app.attachToShell(),Ae.ui.applyGating(),t||(t=!0,Ae.ui.watchGating())};document.readyState==="loading"?document.addEventListener("DOMContentLoaded",e,{once:!0}):e(),document.addEventListener("click",a=>{const o=a.target;o!=null&&o.closest(".nav-btn[data-view]")&&setTimeout(e,0)})}return $t.bootstrap=es,Object.defineProperty($t,Symbol.toStringTag,{value:"Module"}),$t}({});
