var FinanceAppBundle=function($t){"use strict";var _l=Object.defineProperty;var Pl=($t,V,G)=>V in $t?_l($t,V,{enumerable:!0,configurable:!0,writable:!0,value:G}):$t[V]=G;var Zo=($t,V,G)=>Pl($t,typeof V!="symbol"?V+"":V,G);function V(t){const e=t.getFullYear(),a=String(t.getMonth()+1).padStart(2,"0"),o=String(t.getDate()).padStart(2,"0");return`${e}-${a}-${o}`}function G(t){const[e,a,o]=t.split("-").map(Number);return new Date(e,a-1,o)}function J(){return V(new Date)}function Se(t,e){return new Date(t,e+1,0).getDate()}function ca(t,e,a){return V(new Date(t,e,Math.min(a,Se(t,e))))}function ce(t,e,a){if(!a)return null;if(a.startsWith("dia:")){const o=a.slice(4);if(o==="ultimo")return V(new Date(t,e+1,0));const n=parseInt(o);if(!isNaN(n))return ca(t,e,n)}if(a.startsWith("nthweekday:")){const o=a.split(":"),n=parseInt(o[1]),s=parseInt(o[2]);if(n===-1){const r=new Date(t,e+1,0);for(;r.getDay()!==s;)r.setDate(r.getDate()-1);return V(r)}const i=new Date(t,e,1);for(;i.getDay()!==s;)i.setDate(i.getDate()+1);return i.setDate(i.getDate()+(n-1)*7),i.getMonth()!==e&&i.setDate(i.getDate()-7),V(i)}return null}function da(t,e){if(!e)return t;const a=G(t);return ce(a.getFullYear(),a.getMonth(),e)??t}const ts=["domingo","lunes","martes","miércoles","jueves","viernes","sábado"],es={"-1":"último",1:"1º",2:"2º",3:"3º",4:"4º",5:"5º"};function we(t){if(!t)return"";if(t.startsWith("dia:")){const e=t.slice(4);return e==="ultimo"?"Último día del mes":`Día ${e} del mes`}if(t.startsWith("nthweekday:")){const e=t.split(":"),a=e[1],o=parseInt(e[2]);return`${es[a]||a+"º"} ${ts[o]} del mes`}return t}function de(t,e){const a=Date.UTC(t.getFullYear(),t.getMonth(),t.getDate()),o=Date.UTC(e.getFullYear(),e.getMonth(),e.getDate());return Math.round((o-a)/864e5)}function It(t){return Math.sign(t)*Math.round(Math.abs(t)*100)}function et(t){return t/100}function Q(t){return et(It(t))}function j(t){return new Intl.NumberFormat("es-ES",{style:"currency",currency:"EUR"}).format(t||0)}function ua(t){return(t||0).toFixed(2)+"%"}function Dt(t,e,a){const o=e/100/12;return o===0?t/a:t*o*Math.pow(1+o,a)/(Math.pow(1+o,a)-1)}function pa(t,e,a,o=0){const n=Dt(t,e,a),s=t*(1-o/100);let i=e/100/12;for(let r=0;r<200;r++){const u=n*(1-Math.pow(1+i,-a))/i-s,b=n*(a*Math.pow(1+i,-(a+1))/i-(1-Math.pow(1+i,-a))/(i*i)),p=i-u/b;if(Math.abs(p-i)<1e-10){i=p;break}i=p}return(Math.pow(1+i,12)-1)*100}function ma(t,e,a,o,n=0,s=[],i={}){const r=[];let l=t;const u=G(o),b=e/100/12;let p=a,d=Dt(l,e,p);const h=[...s].sort((I,A)=>I.fecha.localeCompare(A.fecha));let y=0;for(let I=1;I<=a*2&&l>.01;I++){const A=new Date(u);u.setMonth(u.getMonth()+1);const f=da(V(A),i.diaPago||"");for(;y<h.length&&h[y].fecha<=f;){const $=h[y],v=$.cantidad*(n/100);if(l-=$.cantidad,l=Math.max(0,l),$.tipo==="plazo"?p=Math.ceil(-Math.log(1-l*b/d)/Math.log(1+b)):(p=a-I+1,d=Dt(l,e,p)),r.push({mes:"AMORT",fecha:$.fecha,cuota:0,interes:0,amortizacion:$.cantidad,comisionAmort:v,capitalPendiente:l,esAmortizacion:!0,simulacion:$.simulacion||!1}),y++,l<.01)break}if(l<.01)break;const g=l*b,m=Math.min(d-g,l);if(l-=m,l<.01&&(l=0),r.push({mes:I,fecha:f,cuota:d,interes:g,amortizacion:m,comisionAmort:0,capitalPendiente:l,esAmortizacion:!1,simulacion:!1}),p--,p<=0||l<.01)break}return r}const fa=new Map;function at(t){var A;const e=t.amortizaciones||[],a=`${t.capital}|${t.tin}|${t.meses}|${t.fechaInicio}|${t.comisionAmort||0}|${t.comisionApertura||0}|${t.diaPago||""}|${e.slice().sort((f,g)=>`${f.fecha}|${f.cantidad}|${f.tipo||""}`.localeCompare(`${g.fecha}|${g.cantidad}|${g.tipo||""}`)).map(f=>`${f.fecha}:${f.cantidad}:${f.tipo||""}`).join(";")}`,o=fa.get(a);if(o)return o;const{capital:n,tin:s,meses:i,fechaInicio:r,comisionAmort:l,comisionApertura:u}=t,b=ma(n,s,i,r,l||0,e,t),p=b.reduce((f,g)=>f+g.interes,0),d=b.reduce((f,g)=>f+g.comisionAmort,0),h=n*((u||0)/100),y=b.filter(f=>!f.esAmortizacion),I={cuota:Dt(n,s,i),totalIntereses:p,tae:pa(n,s,i,u||0),costoTotal:p+d+h,comAp:h,totalComAm:d,fechaFin:((A=y.slice(-1)[0])==null?void 0:A.fecha)||"",mesesReales:y.length,tabla:b};return fa.set(a,I),I}function va(t){const e=at(t),a=at({...t,amortizaciones:[]}),o=a.totalIntereses-e.totalIntereses,n=a.mesesReales-e.mesesReales,s=e.totalComAm;return{...e,sinAmort:a,ahorroIntereses:o,ahorroTiempo:n,costeTotalAmort:s,ahorroNeto:o-s,totalPagado:t.capital+e.totalIntereses+e.comAp+e.totalComAm}}function pt(t,e,a){if(!t||t.length===0)return 1;const o=G(e),n=G(a);if(n<=o)return 1;const s=[...t].sort((l,u)=>l.year-u.year);let i=1,r=new Date(o);for(;r<n;){const l=r.getFullYear(),u=s.filter(I=>I.year<=l),b=u.length>0?u[u.length-1]:s[0],p=(b?b.tasa:0)/100,d=new Date(l+1,0,1),h=d<n?d:n,y=de(r,h);i*=Math.pow(1+p,y/365.25),r=h}return i}function ga(t,e,a,o=0){const n=G(e),s=G(a);if(s<=n)return o;const i=de(n,s),r=t?[...t].sort((b,p)=>b.year-p.year):[];let l=0,u=new Date(n);for(;u<s;){const b=u.getFullYear(),p=new Date(b+1,0,1),d=p<s?p:s,h=de(u,d),y=r.filter(f=>f.year<=b),I=y.length>0?y[y.length-1]:null,A=I!==null?I.tasa:o;l+=A*h,u=d}return i>0?l/i:o}function ba(t,e){return((1+t/100)/(1+e/100)-1)*100}function as(t,e,a,o){const n=pt(e,a,o);return n>0?t/n:t}function os(t,e){const a=e.saludUmbralAhorroVerde??20,o=e.saludUmbralAhorroAmarillo??10,n=e.saludUmbralDTIVerde??30,s=e.saludUmbralDTIAmarillo??40,i=e.saludRegla||[50,30,20],r=e.saludExcluirHipoteca||!1,{ingresos:l=0,cuotas:u=0,cuotasHipoteca:b=0,gastosBasicos:p=0,gastosOtros:d=0,amortizaciones:h=0}=t,y=l-u-h-p-d,I=y,A=l>0?I/l*100:null,f=r?u-b:u,g=l>0?f/l*100:null,m=l>0?u/l*100:null,$=l>0?(p+u+h)/l*100:null,v=l>0?d/l*100:null,x=(w,C,z)=>w===null?"neutral":w>=C?"verde":w>=z?"amarillo":"rojo",S=(w,C,z)=>w===null?"neutral":w<=C?"verde":w<=z?"amarillo":"rojo";return{ingresos:l,cuotas:u,cuotasHipoteca:b,gastosBasicos:p,gastosOtros:d,amortizaciones:h,ahorroBruto:y,ahorroReal:I,tasaAhorro:A,dti:g,dtiTotal:m,excluyeHipoteca:r,pctNecesidades:$,pctDeseos:v,semAhorro:x(A,a,o),semDTI:S(g,n,s),semNecesidades:S($,i[0],i[0]+15),semDeseos:S(v,i[1],i[1]+10),semAhorroRegla:x(A,i[2],i[2]*.5),umbralAhorroVerde:a,umbralAhorroAmarillo:o,umbralDTIVerde:n,umbralDTIAmarillo:s,regla:i}}function mt(t){return(t==null?void 0:t.modeloFondo)||(t!=null&&t.esFondoPension?"pension":"cuenta")}function rt(t){const e=[...t.historicoSaldos||[]].sort((a,o)=>o.fecha.localeCompare(a.fecha));return e.length>0?e[0].saldo:t.saldoInicial||0}function Vt(t,e){const a=t.fechaInicialSaldo||"";if(!a||e>=a){const o=[];a&&o.push({fecha:a,saldo:t.saldoInicial||0,prioridad:-1}),(t.historicoSaldos||[]).forEach((s,i)=>{s.fecha>=a&&o.push({...s,prioridad:i})}),o.sort((s,i)=>i.fecha.localeCompare(s.fecha)||i.prioridad-s.prioridad);const n=o.find(s=>s.fecha<=e);return n?n.saldo:t.saldoInicial||0}else{const n=[...t.historicoSaldos||[]].sort((s,i)=>i.fecha.localeCompare(s.fecha)).find(s=>s.fecha<=e);return n?n.saldo:0}}function Me(t,e){const a=t.cuentaIds&&t.cuentaIds.length>0?t.cuentaIds:null;return a?e.filter(o=>a.includes(o._id)):e.filter(o=>o.activo&&!o.simulacion)}function ha(t,e,a=0){const o=Me(t,e).reduce((n,s)=>n+rt(s),0);return t.usarColchon!==!1?Math.max(0,o-a):o}function ss(t,e,a){if(!t.targetAmount||t.targetAmount<=0)return null;const o=Me(t,e);if(o.length===0)return null;const n=a.hoy??new Date,s=a.horizonteMeses??120,i=t.usarColchon!==!1,r=o.map(l=>({acc:l,eventos:a.extractoCuenta(l),cursor:0,saldo:rt(l)}));for(let l=1;l<=s;l++){const u=new Date(n.getFullYear(),n.getMonth()+l,1),b=`${u.getFullYear()}-${String(u.getMonth()+1).padStart(2,"0")}`,p=V(new Date(u.getFullYear(),u.getMonth()+1,0));let d=0;for(const y of r){for(;y.cursor<y.eventos.length&&y.eventos[y.cursor].fecha<=p;)y.saldo=y.eventos[y.cursor].saldoAcum??y.saldo,y.cursor++;d+=y.saldo}const h=i?a.colchonEnFecha(p):0;if(d-h>=t.targetAmount)return b}return null}function ya(t,e){const a=t.escenarioIds||[];return a.length===0?!0:!!e&&a.includes(e)}function xa(t,e){const a=o=>ya(o,e);return{loans:t.loans.filter(a).map(o=>({...o,amortizaciones:(o.amortizaciones||[]).filter(a)})),expenses:t.expenses.filter(a),nominas:t.nominas.filter(a),accounts:t.accounts.filter(a)}}const Ce=t=>t.slice(0,7);function ns(t){const[e,a]=t.split("-").map(Number);return`${a===12?e+1:e}-${String(a===12?1:a+1).padStart(2,"0")}`}function je(t,e,a){if(t.length===0)return[];const o=new Map;for(const u of t)u.saldoAcum!==void 0&&o.set(Ce(u.fecha),u.saldoAcum);const n=t[0];let s=(n.saldoAcum??0)-(n.delta??0);const i=Ce(e||n.fecha),r=Ce(a||t[t.length-1].fecha);if(r<i)return[];const l=[];for(let u=i;u<=r;u=ns(u)){const b=o.get(u);b!==void 0&&(s=b);const[p,d]=u.split("-").map(Number);l.push({x:G(V(new Date(p,d-1,15))).getTime(),mes:u,y:s})}return l}function ze(t,e){let a=null;for(const o of t){if(o.fecha>e)break;o.saldoAcum!==void 0&&(a=o.saldoAcum)}return a}function is(t){const e=a=>!a.simulacion;return{loans:t.loans.filter(e).map(a=>({...a,amortizaciones:(a.amortizaciones||[]).filter(e)})),expenses:t.expenses.filter(e),nominas:t.nominas.filter(e),accounts:t.accounts.filter(e)}}function rs(t){const e=a=>!!a.simulacion;return t.loans.some(a=>e(a)||(a.amortizaciones||[]).some(e))||t.expenses.some(e)||t.nominas.some(e)||t.accounts.some(e)}const gt=[[0,19],[12450,24],[20200,30],[35200,37],[6e4,45],[3e5,47]];function ut(t,e){const a=[...e].sort((s,i)=>s[0]-i[0]);let o=0,n=t;for(let s=a.length-1;s>=0;s--){const[i,r]=a[s];n<=i||(o+=(n-i)*(r/100),n=i)}return o}function Ee(t,e){const a=Math.max(0,t-(e||0)),o=t*.0635,n=Math.min(2e3,a),s=Math.max(0,a-o-n),i=s<=15876?7302:s<=21622?Math.max(0,7302-1.75*(s-15876)):0;return{baseIRPF:a,cotizSS:o,gastosArt19:n,RNT:s,reducArt20:i,baseImponible:Math.max(0,s-i)}}function St(t,e){return Ee(t,e).baseImponible}function $a(t,e){return ut(t,e)/12}const jt=[[0,19],[6e3,21],[5e4,23],[2e5,27],[3e5,28]];function Fe(t,e){if(!t||t<=0)return 0;const a=e||jt;let o=0,n=t;for(let s=0;s<a.length;s++){const[i,r]=a[s],l=s<a.length-1?a[s+1][0]:1/0,u=Math.min(n,l-i);if(!(u<=0)&&(o+=u*(r/100),n-=u,n<=0))break}return o}function Rt(t,e){if(mt(t)!=="inversion")return null;const a=rt(t),o=(t.aportaciones||[]).reduce((i,r)=>i+r.cantidad,0)||t.saldoInicial||0,n=Math.max(0,a-o),s=Fe(n,e);return{saldo:a,costBase:o,plusvalia:n,impuesto:s,neto:a-s}}function ue(t,e=new Date){var d;if(mt(t)!=="pension")return null;const a=t.bloqueoMeses||120,o=rt(t),n=V(new Date(e.getFullYear(),e.getMonth()-a,e.getDate())),s=[...t.aportaciones||[]].sort((h,y)=>h.fecha.localeCompare(y.fecha));let i=0;const r=s.reduce((h,y)=>h+y.cantidad,0);for(const h of s)h.fecha<=n&&(i+=h.cantidad);const l=Math.max(0,o-r),u=r>0?i/r:0,b=Math.min(o,i+l*u),p=Math.max(0,o-b);return{saldo:o,disponible:b,bloqueado:p,costBase:r,beneficio:l,numAportaciones:s.length,proxDesbloqueo:((d=s.find(h=>h.fecha>n))==null?void 0:d.fecha)||null}}function Ia(t,e,a){const o=a!==void 0?a:t.impuestoRetirada;if(mt(t)!=="pension"||!o)return 0;const n=rt(t);if(n<=0)return 0;const s=(t.aportaciones||[]).reduce((u,b)=>u+b.cantidad,0),i=Math.max(0,n-s);if(i<=0)return 0;const r=i/n;return+(e*r*o/100).toFixed(2)}function _e(t,e,a){var l;const o=t.grupoNomina;if(!o)return t.impuestoRetirada||0;const s=(e||[]).filter(u=>(u.grupoNomina||"")===o&&u.activo!==!1).reduce((u,b)=>u+(b.bruto||0)*(b.nPagas||12),0),i=[...a||[]].sort((u,b)=>u[0]-b[0]);let r=((l=i[0])==null?void 0:l[1])||19;for(const[u,b]of i)if(s>=u)r=b;else break;return r}const Pe=6.35;function zt(t){return(t.retribucionFlexible||[]).reduce((e,a)=>e+(a.importe||0)*12,0)}function Aa(t){return Math.max(0,(t.bruto||0)-zt(t))}function ls(t){return[...t].sort((e,a)=>(a.bruto||0)-(e.bruto||0)||String(e._id).localeCompare(String(a._id)))}function cs(t){const e=t.reduce((i,r)=>i+(r.bruto||0),0),a=t.reduce((i,r)=>i+zt(r),0),o=Math.max(0,e-a),n=St(e,a),s=new Map;for(const i of t)s.set(i._id,o>0?n*(Aa(i)/o):0);return s}function Te(t,e,a){if(t.irpfModo==="manual")return Aa(t)*((t.irpfPct||0)/100);if(!e||e.length===0)return ut(St(t.bruto||0,zt(t)),a);const o=ls(e.filter(i=>i.irpfModo!=="manual")),n=cs(e);let s=0;for(const i of o){const r=n.get(i._id)??0;if(i._id===t._id)return ut(s+r,a)-ut(s,a);s+=r}return ut(St(t.bruto||0,zt(t)),a)}function ds(t,e){return t.reduce((a,o)=>a+Te(o,t,e),0)}function us(t,e){var n;const a=[...e||[]].sort((s,i)=>s[0]-i[0]);let o=((n=a[0])==null?void 0:n[1])??19;for(const[s,i]of a)if(t>=s)o=i;else break;return o}function Sa(t,e){if(!t||t.length===0)return 0;const a=t.reduce((n,s)=>n+(s.bruto||0),0),o=t.reduce((n,s)=>n+zt(s),0);return us(St(a,o),e)}function De(t,e,a){const o=t.bruto||0,n=zt(t),s=Math.max(0,o-n),i=t.nPagas||12,r=t.ssPct??Pe,l=s*(r/100),u=Te(t,e,a);return{brutoAnual:o,flexAnual:n,baseDineraria:s,nPagas:i,ssPct:r,ssAnual:l,irpfAnual:u,irpfPct:s>0?u/s*100:0,netoPorPaga:(s-l-u)/i}}function ps(t){const e=new Map,a=[];for(const o of t){const n=o.grupoNomina||"";if(!n){a.push(o);continue}const s=e.get(n)??[];s.push(o),e.set(n,s)}return{grupos:e,sueltas:a}}const Et=1500;function wa(t){const e=t.cuantia||0,a=Math.max(1,t.frecuencia||1);return t.tipoFrecuencia==="mensual"?e*12/a:t.tipoFrecuencia==="diaria"?e*365.25/a:e}const Ut=t=>{const e=typeof t=="number"?t:parseFloat(String(t??""));return Number.isFinite(e)?e:0};function ms(t,e){const a=t.grupoNomina||"";return a?e.filter(o=>(o.grupoNomina||"")===a):null}function Ma(t,e){return t.reduce((a,o)=>a+Te(o,ms(o,t),e),0)}function Ca(t){const{nominas:e,tramosGeneral:a,tramosAhorro:o}=t,n=t.extras??{},s=e.reduce((w,C)=>w+(C.bruto||0),0),i=e.reduce((w,C)=>w+zt(C),0),r=Ee(s,i),l=t.aportacionesPension,u=Et,b=Math.min(l,u),p=Math.max(0,r.RNT-r.reducArt20-b),d=Ut(n.capInmobiliario),h=Ut(n.capMobiliario),y=Ut(n.gananciasFondos),I=Ut(n.otrasCorto),A=Ut(n.retCapital),f=Math.max(0,p+t.otrosIngresos+d+I),g=Math.max(0,h+y),m=ut(f,a),$=ut(g,o),v=m+$,x=Ma(e,a),S=x+A;return{brutoTotal:s,flexTotal:i,brutoIRPF:r.baseIRPF,cotizSS:r.cotizSS,gastosArt19:r.gastosArt19,RNT:r.RNT,reducArt20:r.reducArt20,aportPP:l,limPP:u,deducPP:b,RNTred:p,otrosIngresos:t.otrosIngresos,capInmobiliario:d,capMobiliario:h,gananciasFondos:y,otrasCorto:I,baseGeneral:f,baseAhorro:g,cuotaGen:m,cuotaAho:$,cuotaIntegra:v,retNomina:x,retCapital:A,totalRet:S,resultado:v-S}}const fs=Object.freeze(Object.defineProperty({__proto__:null,LIMITE_APORTACION_PENSION:Et,TRAMOS_AHORRO_DEFAULT:jt,TRAMOS_IRPF_DEFAULT:gt,ajustarFechaPago:da,ajustarPrecioReal:as,calcBaseImponibleTrabajo:St,calcFactorInflacion:pt,calcFondoInversion:Rt,calcFondosPension:ue,calcGananciasCapital:Fe,calcIRPF:ut,calcImpuestoPension:Ia,calcInflacionMediaAnual:ga,calcSaludFinanciera:os,calcTAE:pa,calcTipoMarginalPension:_e,calcTipoRealFisher:ba,calcularDeclaracion:Ca,clampedDate:ca,cuentasDelObjetivo:Me,cuotaMensual:Dt,desgloseBaseTrabajo:Ee,diasEntre:de,filtrarPorEscenario:xa,formatEUR:j,formatLocalDate:V,formatPct:ua,fromCents:et,haySimulaciones:rs,ingresoAnual:wa,labelDiaPago:we,lastDayOfMonth:Se,modeloFondoDe:mt,parseLocalDate:G,proyectarFechaCumplimiento:ss,resolverDiaEfectivo:ce,resumenPrestamo:at,resumenPrestamoConAhorro:va,retencionMensual:$a,retencionesNomina:Ma,roundMoney:Q,saldoEnFecha:Vt,saldoEnFechaExtracto:ze,saldoParaObjetivo:ha,saldoRealCuenta:rt,serieMensual:je,sinSimulaciones:is,tablaAmortizacion:ma,toCents:It,todayISO:J,visibleEnEscenario:ya},Symbol.toStringTag,{value:"Module"}));function Yt(t,e,a=null){const o=[],n=G(e.start),s=G(e.end);for(const i of t){if(!i.activo||a&&a.length>0&&!a.includes(i.cuenta||"default"))continue;const r=G(i.fechaInicio||e.start),l=i.fechaFin?G(i.fechaFin):s,u=i.cuantia,b=p=>o.push({fecha:p,concepto:i.concepto,cuantia:u,tipo:i.tipo,tags:i.tags||[],cuenta:i.cuenta||"default",sourceId:i._id,sourceType:"expense"});if(i.tipoFrecuencia==="extraordinario")r>=n&&r<=s&&r<=l&&b(i.fechaInicio);else if(i.tipoFrecuencia==="mensual"){const p=Math.max(1,i.frecuencia||1);let d=r.getFullYear(),h=r.getMonth();const y=Math.ceil(240/p)+2;for(let I=0;I<y;I++){const A=ce(d,h,i.diaPago||"")||(()=>{const g=r.getDate(),m=new Date(d,h+1,0).getDate();return V(new Date(d,h,Math.min(g,m)))})(),f=G(A);if(f>s||f>l)break;f>=n&&f>=r&&b(A),h+=p,h>=12&&(d+=Math.floor(h/12),h=h%12)}}else if(i.tipoFrecuencia==="diaria"){const p=Math.max(1,i.frecuencia||1)*864e5;let d=new Date(Math.max(r.getTime(),n.getTime()));if(r<n){const h=Math.ceil((n.getTime()-r.getTime())/p);d=new Date(r.getTime()+h*p)}for(;d<=s&&d<=l;)b(V(d)),d=new Date(d.getTime()+p)}}return o}function ja(t,e,a=null){const o=[];for(const n of t){if(!n.activo||a&&a.length>0&&!a.includes(n.cuenta||"default"))continue;const{tabla:s}=at(n);for(const i of s)i.fecha>=e.start&&i.fecha<=e.end&&(i.esAmortizacion?o.push({fecha:i.fecha,concepto:`Amort. ${n.nombre}`,cuantia:-(i.amortizacion+i.comisionAmort),tipo:"gasto",tags:["amortizacion",...n.tags||[]],cuenta:n.cuenta||"default",sourceId:n._id,sourceType:"loan-amort",simulacion:i.simulacion||!1}):o.push({fecha:i.fecha,concepto:`Cuota ${n.nombre}`,cuantia:-i.cuota,tipo:"gasto",tags:["prestamo",...n.tags||[]],cuenta:n.cuenta||"default",sourceId:n._id,sourceType:"loan",simulacion:n.simulacion||!1}))}return o}function za(t,e,a=null,o={accounts:[]}){const n=[],s=G(e.start),i=G(e.end),r=o.accounts||[],l=o.nominas||[],u=o.resolverTramosIRPF||(()=>gt),b=o.resolverTramosGanancias||(()=>jt),p=d=>{var h;return((h=r.find(y=>y._id===d))==null?void 0:h.nombre)??d};for(const d of t){if(!d.activo||d.tipo!=="transferencia"||a&&a.length>0&&!(a.includes(d.cuenta||"default")||a.includes(d.cuentaDestino||"default")))continue;const h=G(d.fechaInicio||e.start),y=d.fechaFin?G(d.fechaFin):i,I=A=>{const f=r.find(E=>E._id===(d.cuenta||"default")),g=r.find(E=>E._id===(d.cuentaDestino||"default")),m=mt(f),$=mt(g),v=m==="inversion"&&$==="inversion"||m==="pension"&&$==="pension",x=["transferencia",...v?["traspaso"]:[],...d.tags||[]],S=v?"traspaso-out":"transfer-out",w=v?"traspaso-in":"transfer-in",C=!a||a.length===0||a.includes(d.cuenta||"default"),z=!a||a.length===0||a.includes(d.cuentaDestino||"default");if(C&&n.push({fecha:A,concepto:`Transf. → ${p(d.cuentaDestino||"default")}: ${d.concepto}`,cuantia:d.cuantia,tipo:"gasto",tags:x,cuenta:d.cuenta||"default",sourceId:d._id,sourceType:S}),z&&n.push({fecha:A,concepto:`Transf. ← ${p(d.cuenta||"default")}: ${d.concepto}`,cuantia:d.cuantia,tipo:"ingreso",tags:x,cuenta:d.cuentaDestino||"default",sourceId:d._id,sourceType:w}),C&&!v&&f){if(m==="inversion"){const E=parseInt(A.slice(0,4)),F=Rt(f,b(E));if(F&&F.saldo>0&&F.plusvalia>0){const M=Math.min(1,d.cuantia/F.saldo),T=F.plusvalia*M*.19;T>.01&&n.push({fecha:A,concepto:`Retención IRPF reembolso ${f.nombre} (19% s/plusvalía)`,cuantia:T,tipo:"gasto",tags:["impuesto","capital-mobiliario","retencion"],cuenta:d.cuenta||"default",sourceId:d._id,sourceType:"investment-tax"})}}else if(m==="pension"){const E=u(parseInt(A.slice(0,4))),F=_e(f,l,E),M=Ia(f,d.cuantia,F||void 0);if(M>0){const P=f.grupoNomina?`IRPF rescate ${f.nombre} (tipo marginal grupo "${f.grupoNomina}": ${F}%)`:`Retención rescate ${f.nombre} (${f.impuestoRetirada}% s/beneficio)`;n.push({fecha:A,concepto:P,cuantia:M,tipo:"gasto",tags:["impuesto","rendimientos-trabajo","pension"],cuenta:d.cuenta||"default",sourceId:d._id,sourceType:"pension-tax"})}}}};if(d.tipoFrecuencia==="extraordinario")h>=s&&h<=i&&h<=y&&I(d.fechaInicio);else if(d.tipoFrecuencia==="mensual"){const A=Math.max(1,d.frecuencia||1);let f=h.getFullYear(),g=h.getMonth();const m=Math.ceil(240/A)+2;for(let $=0;$<m;$++){const v=ce(f,g,d.diaPago||"")||(()=>{const S=h.getDate(),w=new Date(f,g+1,0).getDate();return V(new Date(f,g,Math.min(S,w)))})(),x=G(v);if(x>i||x>y)break;x>=s&&x>=h&&I(v),g+=A,g>=12&&(f+=Math.floor(g/12),g=g%12)}}else if(d.tipoFrecuencia==="diaria"){const A=Math.max(1,d.frecuencia||1)*864e5;let f=new Date(Math.max(h.getTime(),s.getTime()));if(h<s){const g=Math.ceil((s.getTime()-h.getTime())/A);f=new Date(h.getTime()+g*A)}for(;f<=i&&f<=y;)I(V(f)),f=new Date(f.getTime()+A)}}return n}function Ea(t,e,a=null){const o=[],n=G(e.start),s=G(e.end);for(const i of t){const r=mt(i);if(r==="cuenta"||!i.activo)continue;const l=i.planAportaciones||[];for(const u of l){if(!u.importe||u.importe<=0)continue;const b=G(u.fechaInicio||e.start),p=u.fechaFin?G(u.fechaFin):s,d=u.cuentaOrigen||"default",h=!a||!a.length||a.includes(d),y=!a||!a.length||a.includes(i._id),I=r==="pension"?"pension":"capital-mobiliario",A=v=>{h&&o.push({fecha:v,concepto:`Aportación → ${i.nombre}`,cuantia:u.importe,tipo:"gasto",tags:["aportacion","transferencia",I],cuenta:d,sourceId:u._id,sourceType:"aportacion-out"}),y&&o.push({fecha:v,concepto:`Aportación ${i.nombre} (${u.periodicidad||"mensual"})`,cuantia:u.importe,tipo:"ingreso",tags:["aportacion","transferencia",I],cuenta:i._id,sourceId:u._id,sourceType:"aportacion-in"})},f={mensual:1,trimestral:3,semestral:6,anual:12}[u.periodicidad||"mensual"]||1;let g=b.getFullYear(),m=b.getMonth();const $=Math.ceil(240/f)+2;for(let v=0;v<$;v++){const x=new Date(g,m+1,0).getDate(),S=V(new Date(g,m,Math.min(b.getDate(),x))),w=G(S);if(w>s||w>p)break;w>=n&&w>=b&&A(S),m+=f,m>=12&&(g+=Math.floor(m/12),m=m%12)}}}return o}function Fa(t,e,a=null,o=[]){const n=[];for(const s of t){if(!s.activo||!s.interes||s.interes<=0||a&&a.length>0&&!a.includes(s._id))continue;const i=G(e.start),r=G(e.end),l=s.periodoCobro||"mensual",u=l==="mensual",b=u?null:{diario:864e5,semanal:7*864e5}[l]||864e5,p=u?1/12:b/(365.25*864e5);let d=Vt(s,e.start);const h=o.filter(A=>A.cuenta===s._id).map(A=>({fecha:A.fecha,delta:A.tipo==="ingreso"?Math.abs(A.cuantia):-Math.abs(A.cuantia)})).sort((A,f)=>A.fecha.localeCompare(f.fecha));let y=0,I=new Date(i);for(;I<=r;){const A=u?new Date(I.getFullYear(),I.getMonth()+1,I.getDate()):new Date(I.getTime()+b),f=new Date(Math.min(A.getTime(),r.getTime()+1)),g=V(f);let m=0;for(;y<h.length&&h[y].fecha<g;)m+=h[y].delta,y++;const $=d,v=d+m,x=Math.max(0,($+v)/2);d=v;const S=u?p:(f.getTime()-I.getTime())/(365.25*864e5),w=x*(Math.pow(1+s.interes/100,S)-1);w>.001&&n.push({fecha:V(I),concepto:`Interés ${s.nombre}`,cuantia:w,tipo:"ingreso",tags:["interes","cuenta"],cuenta:s._id,sourceId:s._id,sourceType:"account-interest"}),I=A}}return n}function _a(t,e,a,o=null){const n=[],s=e||gt;for(const i of t){if(!i.activo||i.tipo!=="ingreso"||!i.sujetoIRPF)continue;const r=i.cuantia*(i.tipoFrecuencia==="mensual"?12:1),l=$a(r,s),u={...i,_id:i._id+"_irpf",concepto:`IRPF salario ${i.concepto}`,tipo:"gasto",cuantia:l,tags:["irpf","fiscal"]};n.push(...Yt([u],a,o))}return n}const vs=[5,11,2,8],gs={transporte:"Transporte",restaurante:"Restaurante",otros:"Beneficio"};function Pa(t,e,a=null,o=[],n=()=>gt){const s=[],i=G(e.start),r=G(e.end),l=o.length>0,u={};for(const d of t){const h=d.grupoNomina||"";u[h]||(u[h]=[]),u[h].push(d)}for(const d of Object.keys(u))u[d].sort((h,y)=>(y.bruto||0)-(h.bruto||0));function b(d,h){if(!l||!d.mesActualizacionIPC)return d.bruto||0;const y=d.fechaInicio||e.start,I=G(y),A=G(h);let f=0;for(let m=I.getFullYear();m<=A.getFullYear();m++){const $=new Date(m,d.mesActualizacionIPC-1,1);$>I&&$<=A&&f++}if(f===0)return d.bruto||0;const g=V(new Date(I.getFullYear()+f,0,1));return(d.bruto||0)*pt(o,y,g)}function p(d,h){const y=b(d,h),I=(d.retribucionFlexible||[]).reduce((E,F)=>E+(F.importe||0)*12,0),A=Math.max(0,y-I);if(d.irpfModo==="manual")return A*((d.irpfPct||0)/100);const f=n(parseInt(h.slice(0,4))),g=d.grupoNomina||"";if(!g)return ut(St(y,I),f);const m=u[g].filter(E=>E.activo),$=m.reduce((E,F)=>E+b(F,h),0),v=m.reduce((E,F)=>E+(F.retribucionFlexible||[]).reduce((M,P)=>M+(P.importe||0)*12,0),0),x=Math.max(0,$-v),S=St($,v),w=Math.max(0,y-I),C=x>0?S*(w/x):0,z=m.filter(E=>E._id!==d._id&&(E.bruto||0)>(d.bruto||0)).reduce((E,F)=>{const M=(F.retribucionFlexible||[]).reduce((T,R)=>T+(R.importe||0)*12,0),P=Math.max(0,b(F,h)-M);return E+(x>0?S*(P/x):0)},0);return ut(z+C,f)-ut(z,f)}for(const d of t){if(!d.activo)continue;const h=d.cuenta||"default";if(a&&a.length>0&&!a.includes(h))continue;const y=Math.max(1,d.nPagas||12),I=G(d.fechaInicio||e.start),A=d.fechaFin?G(d.fechaFin):r,f=g=>{const m=b(d,g),$=p(d,g),v=(d.retribucionFlexible||[]).reduce((M,P)=>M+(P.importe||0)*12,0),x=Math.max(0,m-v),S=(d.ssPct??6.35)/100,w=x*S,C=x/y,z=$/y,E=w/y,F=d.representacion==="simplificado"?C-E-z:C;s.push({fecha:g,concepto:d.nombre,cuantia:F,tipo:"ingreso",cuenta:h,tags:d.tags||[],sourceId:d._id,sourceType:"nomina"}),d.representacion==="detallado"&&(E>0&&s.push({fecha:g,concepto:`SS ${d.nombre}`,cuantia:E,tipo:"gasto",cuenta:h,tags:["seguridad-social","fiscal"],sourceId:d._id+"_ss",sourceType:"nomina"}),z>0&&s.push({fecha:g,concepto:`IRPF ${d.nombre}`,cuantia:z,tipo:"gasto",cuenta:h,tags:["irpf","fiscal"],sourceId:d._id+"_irpf",sourceType:"nomina"}));for(const M of d.retribucionFlexible||[])!M.cuenta||!(M.importe>0)||a&&a.length>0&&!a.includes(M.cuenta)||s.push({fecha:g,concepto:`${d.nombre} — ${gs[M.tipo]||M.tipo}`,cuantia:M.importe,tipo:"ingreso",cuenta:M.cuenta,tags:["retribucion-flexible",M.tipo],sourceId:`${d._id}_flex_${M._id||M.tipo}`,sourceType:"nomina"})};if(y<=12){const g=y===12?1:Math.round(12/y),m=I.getDate();let $=I.getFullYear(),v=I.getMonth();for(let x=0;x<300;x++){const S=new Date($,v+1,0).getDate(),w=new Date($,v,Math.min(m,S));if(w>r||w>A)break;w>=i&&w>=I&&f(V(w)),v+=g,v>=12&&($+=Math.floor(v/12),v=v%12)}}else{const g=y-12,m=I.getDate();let $=I.getFullYear(),v=I.getMonth();for(let w=0;w<300;w++){const C=new Date($,v+1,0).getDate(),z=new Date($,v,Math.min(m,C));if(z>r||z>A)break;z>=i&&z>=I&&f(V(z)),v++,v>=12&&($++,v=0)}const x=Math.max(I.getFullYear(),i.getFullYear()),S=Math.min((d.fechaFin?A:r).getFullYear(),r.getFullYear());for(let w=x;w<=S;w++)for(const C of vs.slice(0,g)){const z=new Date(w,C,15);z>=i&&z<=r&&z>=I&&z<=A&&f(V(z))}}}return s}function Ta(t,e,a,o=null,n="default"){const s=[];if(!e||e.length===0)return s;const i=G(a.start),r=G(a.end),l=J(),u=t.filter(p=>p.activo&&p.tipo==="gasto"&&p.tipoFrecuencia==="mensual");let b=new Date(i.getFullYear(),i.getMonth(),1);for(;b<=r;){const p=b.getFullYear(),d=b.getMonth(),h=p+"-"+String(d+1).padStart(2,"0"),y=h+"-01",I=V(new Date(p,d+1,0)),A=V(new Date(p,d,15));let f=0;for(const g of u){if(o&&o.length>0&&!o.includes(g.cuenta||"default")||g.fechaInicio&&g.fechaInicio>I||g.fechaFin&&g.fechaFin<y)continue;const m=g.fechaInicio||l,$=pt(e,m,A);if($<=1)continue;const v=Math.max(1,g.frecuencia||1);f+=g.cuantia*($-1)/v}f>.01&&s.push({fecha:A,concepto:"Incremento coste de vida",cuantia:f,tipo:"gasto",tags:["inflacion"],cuenta:n,sourceId:"inflacion_vida_"+h,sourceType:"inflacion"}),b=new Date(p,d+1,1)}return s}function Da(t,e,a,o="default"){const n=[];if(!e||e.length===0||t<=0)return n;const s=G(a.start),i=G(a.end),r=[...e].sort((u,b)=>u.year-b.year);let l=new Date(s.getFullYear(),s.getMonth(),1);for(;l<=i;){const u=l.getFullYear(),b=l.getMonth(),p=u+"-"+String(b+1).padStart(2,"0"),d=V(new Date(u,b,15)),h=r.filter(g=>g.year<=u),y=h.length>0?h[h.length-1]:r[0],I=y?y.tasa/100:0,A=Math.pow(1+I,1/12)-1,f=t*A;f>.01&&n.push({fecha:d,concepto:"Pérdida ahorro por inflación",cuantia:f,tipo:"gasto",tags:["inflacion"],cuenta:o,sourceId:"inflacion_ahorro_"+p,sourceType:"inflacion"}),l=new Date(u,b+1,1)}return n}function Ra(t,e,a){const o=a.fechaReferencia||a.dashboardStart,n=o<a.dashboardStart?a.dashboardStart:o>a.dashboardEnd?a.dashboardEnd:o,s=e.reduce((p,d)=>p+Vt(d,n),0),i=t.filter(p=>p.fecha<n),r=t.filter(p=>p.fecha>=n),l=[];let u=s;for(const p of[...i].reverse()){const d=p.tipo==="ingreso"?Math.abs(p.cuantia):-Math.abs(p.cuantia);l.unshift({...p,delta:d,saldoAcum:u}),u-=d}const b=[];u=s;for(const p of r){const d=p.tipo==="ingreso"?Math.abs(p.cuantia):-Math.abs(p.cuantia);u+=d,b.push({...p,delta:d,saldoAcum:u})}return[...l,...b]}function bs(t,e,a,o=null){const n=e.filter(s=>s.activo&&(!o||o.length===0||o.includes(s._id)));return Ra([...t].sort((s,i)=>s.fecha.localeCompare(i.fecha)),n,a)}function Jt(t){const{loans:e,expenses:a,accounts:o,config:n}=t,s=t.filtroAccounts??null,i=t.nominas??[],r=t.inflacionPeriodos??[],l={start:n.dashboardStart,end:n.dashboardEnd},u=a.filter(I=>I.tipo!=="transferencia"),b=a.filter(I=>I.tipo==="transferencia"),p={accounts:o,nominas:i,resolverTramosIRPF:t.resolverTramosIRPF,resolverTramosGanancias:t.resolverTramosGanancias};let d=[];d=d.concat(Yt(u,l,s)),d=d.concat(ja(e,l,s)),d=d.concat(za(b,l,s,p)),d=d.concat(Ea(o,l,s));const h=Fa(o,l,s,d);if(d=d.concat(h),d=d.concat(_a(a,n.tramos_irpf,l,s)),d=d.concat(Pa(i,l,s,r,t.resolverTramosIRPF)),n.usarInflacion&&r.length>0){const I=(o.find(g=>g.activo&&g.esCuentaPrincipal)||o.find(g=>g.activo)||{_id:"default"})._id;d=d.concat(Ta(u,r,l,s,I));const f=o.filter(g=>g.activo&&(!s||s.length===0||s.includes(g._id))).reduce((g,m)=>g+Vt(m,n.dashboardStart),0);d=d.concat(Da(f,r,l,I))}d.sort((I,A)=>I.fecha.localeCompare(A.fecha));const y=o.filter(I=>I.activo&&(!s||s.length===0||s.includes(I._id)));return Ra(d,y,n)}function hs(t,e,a=null){const o=J(),s=e.filter(r=>r.activo&&(!a||a.length===0||a.includes(r._id))).reduce((r,l)=>r+rt(l),0),i=t.filter(r=>r.fecha<=o);return i.length===0?s:i[i.length-1].saldoAcum}function Na(t,e){const a=new Map;for(const o of t)if(o.tipo===e&&!(o.sourceType==="transfer-out"||o.sourceType==="transfer-in"||o.sourceType==="loan-amort"))for(const n of o.tags||["sin_tag"])a.set(n,(a.get(n)||0)+Math.abs(o.cuantia));return a}function ys(t,e){const a=[];let o=!1;for(let n=0;n<t.length;n++){const s=t[n],i=s.saldoAcum;i<0&&(n===0||t[n-1].saldoAcum>=0)&&a.push({tipo:"saldo_negativo",fecha:s.fecha,saldo:i,mensaje:`Saldo negativo (${j(i)}) a partir del ${s.fecha}`}),e>0&&(i<e&&!o?(o=!0,a.push({tipo:"bajo_colchon",fecha:s.fecha,saldo:i,mensaje:`Saldo por debajo del colchón (${j(i)} < ${j(e)}) desde ${s.fecha}`})):i>=e&&o&&(o=!1,a.push({tipo:"recuperacion_colchon",fecha:s.fecha,saldo:i,mensaje:`Recuperación del colchón el ${s.fecha} (${j(i)})`})))}return a}function xs(t,e){const a=t.filter(i=>i.tipo==="gasto"&&i.sourceType!=="loan-amort").reduce((i,r)=>i+Math.abs(r.cuantia),0),o=G(e.dashboardStart),n=G(e.dashboardEnd),s=Math.max(1,(n.getTime()-o.getTime())/(30.44*864e5));return a/s}function $s(t,e,a=J()){const o=new Set,n=e.map(r=>{const l=r.fechaInicialSaldo||"",u={};l&&l<=a&&(u[l]=r.saldoInicial||0);for(const b of r.historicoSaldos||[])b.fecha<=a&&(!l||b.fecha>=l)&&(u[b.fecha]=b.saldo);return Object.keys(u).forEach(b=>o.add(b)),u}),s={};for(const r of[...o].sort()){let l=0;for(let u=0;u<e.length;u++){const b=Object.entries(n[u]).filter(([p])=>p<=r);b.length>0?(b.sort(([p],[d])=>d.localeCompare(p)),l+=b[0][1]):l+=e[u].saldoInicial||0}s[r]=l}const i=[];for(const[r,l]of Object.entries(s).sort(([u],[b])=>u.localeCompare(b))){const u=t.filter(h=>h.fecha<=r),b=u.length>0?u[u.length-1].saldoAcum:null;if(b===null)continue;const p=l-b,d=b!==0?p/Math.abs(b)*100:0;i.push({cuenta:"Total",fecha:r,estimado:b,real:l,desv:p,pct:d})}return i}const Is=Object.freeze(Object.defineProperty({__proto__:null,calcDesviacion:$s,detectarPuntosCriticos:ys,mediaMensualGastos:xs},Symbol.toStringTag,{value:"Module"}));function Wt(t,e=new Date){const a=V(e),o=new Date(e);o.setMonth(o.getMonth()+1);const n=V(o),s=t.filter(r=>r.basico&&r.activo&&r.tipo==="gasto");return Yt(s,{start:a,end:n}).reduce((r,l)=>r+Math.abs(l.cuantia),0)}function Re(t){return(t||[]).filter(e=>e.basico&&e.activo&&!e.simulacion).reduce((e,a)=>e+Dt(a.capital,a.tin,a.meses),0)}function Oa(t,e,a,o){return e.colchonTipo==="fijo"&&(e.colchonFijo||0)>0?e.colchonFijo:(Wt(t,o)+Re(a))*(e.colchonMeses||6)}function qa(t,e,a,o,n){const i=[...e.colchonPuntos||[]].sort((l,u)=>l.fecha.localeCompare(u.fecha)).filter(l=>l.fecha<=o).pop();return i?i.tipo==="fijo"?i.importe||0:(Wt(t,n)+Re(a))*(i.meses||6):Oa(t,e,a,n)}function pe(t,e,a,o,n,s=!1,i){const r=[...t.puntos||[]].sort((b,p)=>b.fecha.localeCompare(p.fecha)),l=r.filter(b=>b.fecha<=n).pop()||(s?r[0]:null);return l?l.tipo==="fijo"?l.importe||0:(Wt(e,i)+Re(o))*(l.meses||1):0}function As(t,e){const a={};for(const o of e)a[o._id]=rt(o);return t.map(o=>(o.cuenta&&a[o.cuenta]!==void 0&&(a[o.cuenta]+=o.cuantia),{fecha:o.fecha,saldos:{...a}}))}function Ss(t,e,a,o,n,s,i){const r=[];for(const l of(t||[]).filter(u=>u.activo!==!1)){let u=!1;for(let b=0;b<e.length;b++){const p=e[b],d=pe(l,o,n,s,p.fecha,!1,i);if(d<=0){u=!1;continue}const h=!l.cuentas||l.cuentas.length===0?p.saldoAcum:l.cuentas.reduce((y,I)=>{var A,f;return y+(((f=(A=a[b])==null?void 0:A.saldos)==null?void 0:f[I])||0)},0);h<d&&!u?(u=!0,r.push({tipo:"bajo_margen",fecha:p.fecha,saldo:h,target:d,nombre:l.nombre,mensaje:`⚠ ${l.nombre}: ${j(h)} < ${j(d)} desde ${p.fecha}`})):h>=d&&u&&(u=!1,r.push({tipo:"recuperacion_margen",fecha:p.fecha,saldo:h,target:d,nombre:l.nombre,mensaje:`✓ ${l.nombre}: recuperado el ${p.fecha}`}))}}return r}const ws=Object.freeze(Object.defineProperty({__proto__:null,calcColchon:Oa,calcColchonEnFecha:qa,calcGastoBasicoMensual:Wt,calcMargenEnFecha:pe,detectarCrucesMargenes:Ss,saldosPorCuentaEnExtracto:As},Symbol.toStringTag,{value:"Module"}));class Ms extends Error{constructor(a,o){super(`La funcionalidad "${a}" está desactivada; no se puede ${o}. Actívala en ⚙ Funcionalidades.`);Zo(this,"featureId");this.name="FeatureDeshabilitadaError",this.featureId=a}}let Qt=null;function Cs(t){const e=Qt;return Qt=t,()=>{Qt=e}}function La(t){return Qt?Qt(t):!0}function ka(t,e){if(!La(t))throw new Ms(t,e)}const Ba=[];function Ne(){const t=new Map,e=new WeakMap;let a=1,o=0,n=0;const s=l=>{if(!l||typeof l!="object")return 0;const u=e.get(l);if(u)return u;const b=a++;return e.set(l,b),b},i=l=>l.map(u=>[u._id,u.capital,u.tin,u.meses,u.fechaInicio,u.comisionAmort||0,u.comisionApertura||0,u.diaPago||"",u.activo?1:0,u.cuenta||"",(u.amortizaciones||[]).map(b=>`${b.fecha}:${b.cantidad}:${b.tipo||""}`).sort().join(",")].join("|")).join(";");function r(l){const u=[i(l.loans),s(l.expenses),s(l.accounts),s(l.nominas),s(l.inflacionPeriodos),l.config.dashboardStart,l.config.dashboardEnd,l.config.fechaReferencia||"",l.config.usarInflacion?1:0,(l.filtroAccounts||[]).join(",")].join("#"),b=t.get(u);if(b)return n++,b;o++;const p=Jt(l);return t.set(u,p),p}return{statement:r,stats:()=>({hits:n,misses:o}),clear:()=>t.clear()}}function Oe(t,e,a,o,n={},s=Ne()){ka("optimizador","calcular el plan de amortizaciones");const{frecuencia:i=1,mesesHorizonte:r=36,minAmortizable:l=500,tipoAmort:u="plazo",fechaPrimeraAmort:b=null,loanIds:p=null,nominas:d=Ba,sourceAccountId:h=null,selectedMarginIds:y=null,hoy:I=new Date}=n,A=V(I),f=Math.min(120,Math.max(1,r)),g=a.filter(N=>N.activo),m=g.map(N=>N._id),$=g.find(N=>N.esCuentaPrincipal)||g[0],v=h&&m.includes(h)?g.find(N=>N._id===h):$,x=v==null?void 0:v._id,S=t.filter(N=>N.activo&&!N.simulacion&&(!p||p.includes(N._id))).sort((N,H)=>H.tin-N.tin),w=!!y&&y.length>0,C=(o.margenesSeguridad||[]).filter(N=>N.activo!==!1).filter(N=>!N.cuentas||N.cuentas.length===0||N.cuentas.includes(x)).filter(N=>!w||y.includes(N._id));if(S.length===0)return{plan:[],margenesAplicados:C.length,totalAmortizado:0,totalComisiones:0,totalAhorroIntereses:0,resumenPorLoan:[]};const z={};for(const N of S)z[N._id]=[];const E=[];function F(N){const H=new Date(I.getFullYear(),I.getMonth()+N,1),U=H.getFullYear(),W=H.getMonth(),K=`${U}-${String(W+1).padStart(2,"0")}`,st=V(new Date(U,W,Math.min(15,new Date(U,W+1,0).getDate())));return{label:K,dia15:st}}function M(N,H){const U=[...N.amortizaciones||[],...z[N._id]],{tabla:W}=at({...N,amortizaciones:U}),K=W.filter(nt=>nt.fecha<=H);if(K.length>0)return K[K.length-1].capitalPendiente;const st=U.filter(nt=>nt.fecha<=H).reduce((nt,vt)=>nt+vt.cantidad,0);return Math.max(0,N.capital-st)}function P(N){const H=t.map(it=>({...it,amortizaciones:[...it.amortizaciones||[],...z[it._id]||[]]})),U={...o,dashboardStart:A,dashboardEnd:N},W=s.statement({loans:H,expenses:e,accounts:a,config:U,filtroAccounts:null,nominas:d}),K=g.reduce((it,Gt)=>it+rt(Gt),0),st=v?rt(v):0,nt=K>0?st/K:1;let vt=st,re=K;for(const it of W){const Gt=it.delta??(it.tipo==="ingreso"?Math.abs(it.cuantia):-Math.abs(it.cuantia));it.cuenta===x?vt+=Gt:m.includes(it.cuenta)||(vt+=Gt*nt),re=it.saldoAcum}return{source:vt,total:re}}function T(N){const{source:H}=P(N);if(H<=0)return H;let U=0;for(const W of C){const K=pe(W,e,o,t,N,!0,I);K>U&&(U=K)}return H-U}const R=2;let O=0;if(b){for(let N=0;N<f;N++)if(F(N).dia15>=b){O=N;break}}for(let N=0;N<f;N++){if((N-O)%i!==0||N<O)continue;const{label:H,dia15:U}=F(N);if(U<A)continue;const W=T(U)-R;if(W<l)continue;let K=W,st=0;for(const nt of S){if(K<l)break;const vt=M(nt,U);if(vt<1)continue;const re=nt.comisionAmort||0,it=1+re/100,Gt=Math.floor(K/it),Ko=Math.min(Gt,vt);if(Ko<l)continue;const le=Math.min(Math.floor(Ko),Math.floor(vt)),Xo=+(le*re/100).toFixed(2),la=le+Xo;la>K||(z[nt._id].push({_id:`opt_${H}_${nt._id}`,fecha:U,cantidad:le,tipo:u,simulacion:!0}),st+=la,E.push({mes:H,fechaAmort:U,loanId:nt._id,loanNombre:nt.nombre,tin:nt.tin,capitalAntes:vt,cantidadAmort:le,comision:Xo,capitalDespues:Math.max(0,vt-le),saldoDisponible:W+R,excedente:W,saldoDespues:W+R-st,tipoAmort:u}),K-=la)}}const _=E.reduce((N,H)=>N+H.cantidadAmort,0),k=E.reduce((N,H)=>N+H.comision,0),L=S.map(N=>{const H=z[N._id];if(!H.length)return null;const U=at(N),W=at({...N,amortizaciones:[...N.amortizaciones||[],...H]});return{loanId:N._id,nombre:N.nombre,tin:N.tin,fechaFinSin:U.fechaFin,fechaFinCon:W.fechaFin,mesesAhorrados:U.mesesReales-W.mesesReales,interesesSin:U.totalIntereses,interesesCon:W.totalIntereses,ahorroIntereses:U.totalIntereses-W.totalIntereses,numAmortizaciones:H.length,totalAmortizado:H.reduce((K,st)=>K+st.cantidad,0)}}).filter(N=>N!==null),B=L.reduce((N,H)=>N+H.ahorroIntereses,0);return{plan:E,margenesAplicados:C.length,totalAmortizado:_,totalComisiones:k,totalAhorroIntereses:B,resumenPorLoan:L}}function Ha(t,e,a,o,n={},s){ka("comparador-frecuencias","comparar frecuencias de amortización");const{horizonte:i=60,minAmortizable:r=500,tipoAmort:l="plazo",fechaObjetivo:u=null,frecuencias:b=[1,2,3,6,12],fechaPrimeraAmort:p=null,loanIds:d=null,nominas:h=Ba,sourceAccountId:y=null,selectedMarginIds:I=null,hoy:A=new Date}=n,f=s??Ne(),g=V(A),m=u||V(new Date(A.getFullYear(),A.getMonth()+i,1));function $(S){const w=t.map(F=>({...F,amortizaciones:[...F.amortizaciones||[],...S[F._id]||[]]})),C={...o,dashboardStart:g,dashboardEnd:m},z=f.statement({loans:w,expenses:e,accounts:a,config:C,filtroAccounts:null,nominas:h});if(z.length===0)return a.filter(F=>F.activo).reduce((F,M)=>F+rt(M),0);const E=z.filter(F=>F.fecha<=m);return E.length>0?E[E.length-1].saldoAcum:z[0].saldoAcum}const v=$({}),x=b.map(S=>{const w=Oe(t,e,a,o,{frecuencia:S,mesesHorizonte:i,minAmortizable:r,tipoAmort:l,fechaPrimeraAmort:p,loanIds:d,nominas:h,sourceAccountId:y,selectedMarginIds:I,hoy:A},f),C={};for(const E of t)C[E._id]=[];for(const E of w.plan)C[E.loanId].push({_id:E.mes+"_"+E.loanId,fecha:E.fechaAmort,cantidad:E.cantidadAmort,tipo:l,simulacion:!0});const z=$(C);return{frecuencia:S,label:S===1?"Mensual":`Cada ${S} meses`,numAmortizaciones:w.plan.length,totalAmortizado:w.totalAmortizado,totalComisiones:w.totalComisiones,ahorroIntereses:w.totalAhorroIntereses,saldoObjetivo:z,gananciaSaldo:z-v,valorTotal:w.totalAhorroIntereses+(z-v),plan:w.plan,resumenPorLoan:w.resumenPorLoan}}).filter(S=>S.numAmortizaciones>0);if(x.length>0){const S=Math.max(...x.map(z=>z.ahorroIntereses)),w=Math.max(...x.map(z=>z.saldoObjetivo)),C=Math.max(...x.map(z=>z.valorTotal));x.forEach(z=>{z.esMejorIntereses=z.ahorroIntereses===S,z.esMejorSaldo=z.saldoObjetivo===w,z.esMejorValor=z.valorTotal===C})}return{resultados:x,saldoBase:v,fechaObjetivo:m}}const js=Object.freeze(Object.defineProperty({__proto__:null,compararFrecuencias:Ha,createStatementMemo:Ne,defaultHoyISO:J,optimizarAmortizaciones:Oe},Symbol.toStringTag,{value:"Module"})),zs=30.44*864e5;function Ga(t){const e=t.getFullYear(),a=t.getMonth();return{desde:V(new Date(e,a,1)),hasta:V(new Date(e,a,Se(e,a)))}}function Va(t){const[e,a]=t.split("-").map(Number);return Ga(new Date(e,a-1,1))}function Es(t,e){return Math.max(1,(G(e).getTime()-G(t).getTime())/zs)}const Fs=t=>t.filter(e=>e.sourceType!=="transfer-out"&&e.sourceType!=="transfer-in"),wt=t=>t.reduce((e,a)=>e+Math.abs(a.cuantia),0);function _s(t,e){const a=new Map(e.map(s=>[s._id,s.clasificacion]));let o=0,n=0;for(const s of t){if(s.tipo!=="gasto"||s.sourceType!=="expense")continue;const i=a.get(s.sourceId??"");i!==null&&(i==="deseo"?n+=Math.abs(s.cuantia):o+=Math.abs(s.cuantia))}return{basicos:o,deseo:n}}function Ps(t,e){const a=e.entreMeses&&e.entreMeses>0?e.entreMeses:1,o=d=>d.sourceType==="loan"&&d.tipo==="gasto",n=e.loanIdsIniciados,s=wt(t.filter(d=>d.tipo==="ingreso")),i=wt(t.filter(d=>o(d)&&(!n||n.has(d.sourceId??"")))),r=wt(t.filter(d=>o(d)&&e.hipotecaIds.has(d.sourceId??""))),l=wt(t.filter(d=>d.sourceType==="loan-amort")),u=wt(t.filter(d=>d.sourceType==="account-interest")),{basicos:b,deseo:p}=_s(t,e.expenses);return{ingresos:s/a,cuotas:i/a,cuotasHipoteca:r/a,amortizaciones:l/a,gastosBasicos:b/a,gastosDeseo:p/a,gastosTotales:(i+b+p)/a,intereses:u/a}}function Ua(t,e){return t.reduce((a,o)=>{const n=at(o).tabla.filter(s=>!s.esAmortizacion&&s.fecha<=e);return a+(n.length>0?n[n.length-1].capitalPendiente:o.capital||0)},0)}function Ts(t,e,a,o){const n=t.filter(u=>u.activo&&!u.simulacion&&(u.fechaInicio||"")<=a),s=n.reduce((u,b)=>{if((b.amortizaciones||[]).filter(y=>y.fecha>=e&&y.fecha<=a).length===0)return u;const d=at(b).totalIntereses,h=at({...b,amortizaciones:(b.amortizaciones||[]).filter(y=>y.fecha<e||y.fecha>a)}).totalIntereses;return u+Math.max(0,h-d)},0),i=n.filter(u=>u.mostrarFechaFinEnDashboard!==!1).map(u=>({loan:u,fechaFin:at(u).fechaFin})).filter(u=>!!u.fechaFin&&u.fechaFin>=e&&u.fechaFin<=a),r=n.map(u=>at(u).tabla),l=u=>{const{desde:b,hasta:p}=Va(u);return r.reduce((d,h)=>{const y=h.find(I=>!I.esAmortizacion&&I.fecha>=b&&I.fecha<=p);return d+(y?y.cuota:0)},0)};return{deudaInicio:Ua(n,e),deudaFin:Ua(n,a),ahorroIntereses:s,ahorroInteresesMes:o>0?s/o:0,cuotasInicio:l(e.slice(0,7)),cuotasFin:l(a.slice(0,7)),finEnPeriodo:i}}function Ds(t,e){return e.filter(a=>a.activo&&(a.interes??0)>0).map(a=>({nombre:a.nombre,interes:a.interes,total:wt(t.filter(o=>o.sourceType==="account-interest"&&o.sourceId===a._id))})).filter(a=>a.total>0).sort((a,o)=>o.total-a.total)}function Ya(t,e=new Set,a="desglosado"){if(e.size===0)return Na(t,"gasto");const o=new Map;for(const n of t){if(n.tipo!=="gasto")continue;const s=n.tags||[],i=s.filter(u=>e.has(u)),r=s.filter(u=>!e.has(u)),l=a==="porgrupos"&&i.length>0?i:r;for(const u of l)o.set(u,(o.get(u)||0)+Math.abs(n.cuantia))}return o}function Rs(t,e={}){const a=e.activos,o=e.entreMeses&&e.entreMeses>0?e.entreMeses:1;return[...Ya(t,e.grupoTags,e.modo).entries()].filter(([n])=>!a||a.size===0||a.has(n)).map(([n,s])=>({tag:n,total:s/o})).sort((n,s)=>s.total-n.total)}function Ns(t,e){const a=e.reduce((o,n)=>o+rt(n),0);return{saldoBase:a,saldoFinal:t.length>0?t[t.length-1].saldoAcum??a:a,totalGastos:wt(t.filter(o=>o.tipo==="gasto")),totalIngresos:wt(t.filter(o=>o.tipo==="ingreso")),tags:[...new Set(t.flatMap(o=>o.tags||[]))]}}function Os(t,e){return t.filter(a=>a.activo&&(!e||e.length===0||e.includes(a._id)))}function qs(t,e="hipoteca"){return new Set(t.filter(a=>(a.tags||[]).includes(e)).map(a=>a._id))}function Ls(t,e){return new Set(t.filter(a=>(a.fechaInicio||"")<=e).map(a=>a._id))}function ks(t,e){if(t.length===0)return[];const a=u=>e==="mes"?u.slice(0,7):u.slice(0,4),o=u=>e==="mes"?`${u}-01`:`${u}-01-01`,n=t[0],s=n.delta??(n.tipo==="ingreso"?Math.abs(n.cuantia):-Math.abs(n.cuantia));let i=(n.saldoAcum??0)-s;const r=[];let l=null;for(const u of t){const b=a(u.fecha),p=u.saldoAcum??i;(!l||l.periodo!==b)&&(l&&(i=l.cierre),l={periodo:b,inicio:o(b),apertura:i,cierre:p,maximo:Math.max(i,p),minimo:Math.min(i,p),eventos:0},r.push(l)),l.cierre=p,p>l.maximo&&(l.maximo=p),p<l.minimo&&(l.minimo=p),l.eventos+=1}return r}const Bs=Object.freeze(Object.defineProperty({__proto__:null,agruparOHLC:ks,cuentasVisibles:Os,gastoPorTagOrdenado:Rs,idsHipoteca:qs,idsPrestamosIniciados:Ls,interesesPorCuenta:Ds,mesesDelPeriodo:Es,metricasFlujo:Ps,rangoMes:Va,rangoMesDe:Ga,resumenPrestamosPeriodo:Ts,sinTransferencias:Fs,sumarGastosPorTag:Ya,totalesPeriodo:Ns},Symbol.toStringTag,{value:"Module"}));function Hs(t,e,a){const o=t||[];if(!o.length)return e;const n=o.find(i=>i.año===a);if(n)return n.tramos;const s=o.filter(i=>i.año<a).sort((i,r)=>r.año-i.año);return s.length?s[0].tramos:e}function bt(t,e){return a=>Hs(t,e,a)}const Kt=8,Ja=[[0,19],[12450,24],[20200,30],[35200,37],[6e4,45],[3e5,47]],Wa=[[0,19],[6e3,21],[5e4,23],[2e5,27],[3e5,28]];function qe(t){return{_id:"default",nombre:"Default",descripcion:"Cuenta principal",saldo:0,saldoInicial:0,fechaInicialSaldo:t,historicoSaldos:[],interes:0,periodoCobro:"mensual",activo:!0,simulacion:!1,esCuentaPrincipal:!0,modeloFondo:"cuenta",aportaciones:[],planAportaciones:[],escenarioIds:[]}}function Qa(t,e){return{dashboardStart:t,dashboardEnd:e,fechaReferencia:t,colchonMeses:6,colchonTipo:"meses",colchonFijo:0,colchonPuntos:[],showColchon:!0,margenesSeguridad:[],usarInflacion:!1,tramos_irpf:Ja,tramosGananciasCapital:Wa,showExecSummary:!0,showCriticos:!0,showHistorico:!0,histCuenta:"",analisisCollapsed:!1,activeTagsFilter:[],tagCategorias:[],tagGrupos:[],saludUmbralAhorroVerde:20,saludUmbralAhorroAmarillo:10,saludUmbralDTIVerde:30,saludUmbralDTIAmarillo:40,saludRegla:[50,30,20],saludExcluirHipoteca:!1,saludTagHipoteca:"hipoteca",storageMode:"local",autoSave:!1,autoSaveInterval:15,autoLogoutMinutos:0,onboardingDone:!1,escenarioActivo:null,features:{}}}function Gs(t,e){return{loans:[],expenses:[],accounts:[qe(t)],nominas:[],goals:[],planes:[],transacciones:[],puntosControl:[],inflacion:[],tramosIRPFHistorico:[],tramosGananciasCapitalHistorico:[],escenarios:[],config:Qa(t,e)}}const ht=t=>Array.isArray(t)?t:[],Vs=t=>t&&typeof t=="object"&&!Array.isArray(t)?t:{};function Xt(t){if(Array.isArray(t.escenarioIds))return t;const e=t.escenarioId?[t.escenarioId]:[],{escenarioId:a,...o}=t;return{...o,escenarioIds:e}}function Ka(t){if(!t||typeof t!="string")return"";if(t.startsWith("dia:")||t.startsWith("nthweekday:"))return t;if(t==="ultimo")return"dia:ultimo";if(t==="primer-lunes")return"nthweekday:1:1";const e=parseInt(t);return isNaN(e)?"":`dia:${e}`}function Le(t){const{varianza:e,inflacion:a,...o}=t;return o}function Us(t,e){const{hoyISO:a,finISO:o}=e,n={...t},s=Vs(t.config),r={...Qa(a,o)};for(const[b,p]of Object.entries(s))p!=null&&(r[b]=p);delete r.saldoInicial,delete r.saldoInicialFecha,delete r.inflacionGlobal,delete r.showMC,delete r.mcIteraciones,(!Array.isArray(r.tramos_irpf)||r.tramos_irpf.length===0)&&(r.tramos_irpf=Ja),(!Array.isArray(r.tramosGananciasCapital)||r.tramosGananciasCapital.length===0)&&(r.tramosGananciasCapital=Wa),(!Array.isArray(r.saludRegla)||r.saludRegla.length!==3)&&(r.saludRegla=[50,30,20]),(typeof r.features!="object"||r.features===null||Array.isArray(r.features))&&(r.features={}),n.config=r;let l=ht(t.accounts).map(b=>{const p={saldoInicial:0,fechaInicialSaldo:a,historicoSaldos:[],interes:0,periodoCobro:"mensual",activo:!0,simulacion:!1,esCuentaPrincipal:!1,aportaciones:[],planAportaciones:[],bloqueoMeses:120,impuestoRetirada:0,grupoNomina:"",...b};return p.modeloFondo||(p.modeloFondo=p.esFondoPension?"pension":"cuenta"),delete p.esFondoPension,Array.isArray(p.historicoSaldos)||(p.historicoSaldos=[]),Xt(p)});l.length===0&&(l=[qe(a)]);const u=l.filter(b=>b.esCuentaPrincipal);if(u.length===0){const b=l.find(p=>p._id==="default")||l[0];l=l.map(p=>({...p,esCuentaPrincipal:p._id===b._id}))}else if(u.length>1){let b=!1;l=l.map(p=>p.esCuentaPrincipal?b?{...p,esCuentaPrincipal:!1}:(b=!0,p):p)}return n.accounts=l,n.expenses=ht(t.expenses).map(b=>{const p={basico:!1,activo:!0,tags:[],historialPrecios:[],...b};return Array.isArray(p.tags)||(p.tags=[]),Array.isArray(p.historialPrecios)||(p.historialPrecios=[]),p.diaPago=Ka(p.diaPago),Le(Xt(p))}),n.loans=ht(t.loans).map(b=>{const p={tipoTasa:"fijo",mostrarFechaFinEnDashboard:!0,basico:!0,tags:[],activo:!0,amortizaciones:[],...b};return Array.isArray(p.tags)||(p.tags=[]),p.diaPago=Ka(p.diaPago),p.amortizaciones=ht(p.amortizaciones).map(d=>Xt(d)),Le(Xt(p))}),n.nominas=ht(t.nominas).map(b=>{const p={activo:!0,nPagas:12,irpfModo:"auto",irpfPct:0,bruto:0,representacion:"detallado",tags:[],fechaFin:null,cuenta:"default",grupoNomina:"",mesActualizacionIPC:null,retribucionFlexible:[],...b};return Array.isArray(p.tags)||(p.tags=[]),Array.isArray(p.retribucionFlexible)||(p.retribucionFlexible=[]),Le(Xt(p))}),n.goals=ht(t.goals).map((b,p)=>{const d=Array.isArray(b.cuentaIds)?b.cuentaIds:b.cuentaId?[b.cuentaId]:[],{cuentaId:h,...y}=b;return{prioridad:p+1,completado:!1,usarColchon:!0,targetAmount:0,...y,cuentaIds:d}}),n.inflacion=ht(t.inflacion),n.tramosIRPFHistorico=ht(t.tramosIRPFHistorico),n.tramosGananciasCapitalHistorico=ht(t.tramosGananciasCapitalHistorico),n.escenarios=ht(t.escenarios).map(({inversiones:b,...p})=>p),n}const Nt=t=>Array.isArray(t)?t:[];let ke=0;function Ys(t){return ke+=1,`${t}_${ke.toString(36)}`}const Js=t=>typeof t=="string"&&/^\d{4}-\d{2}-\d{2}$/.test(t),Ws=t=>typeof t=="number"&&Number.isFinite(t);function Qs(t,e){const a={...t};ke=0;const o=Nt(t.transacciones),n=Nt(t.puntosControl),s=[...n],i=new Set(n.map(u=>`${u.cuentaId}|${u.fecha}`)),r=(u,b,p,d)=>{if(!Js(b)||!Ws(p))return;const h=`${u}|${b}`;i.has(h)||(i.add(h),s.push({_id:Ys("pc"),fecha:b,cuentaId:u,saldoCts:It(p),...typeof d=="string"&&d?{nota:d}:{}}))};for(const u of Nt(t.accounts)){const b=typeof u._id=="string"?u._id:null;if(b)for(const p of Nt(u.historicoSaldos))r(b,p.fecha,p.saldo,p.nota)}const l=Nt(t.history);if(l.length>0){const u=Nt(t.accounts),b=u.find(d=>d.esCuentaPrincipal)||u.find(d=>d.activo)||u[0],p=typeof(b==null?void 0:b._id)=="string"?b._id:"default";for(const d of l){const h=typeof d.cuenta=="string"?d.cuenta:typeof d.cuentaId=="string"?d.cuentaId:p;r(h,d.fecha,d.saldo,d.nota)}}return delete a.history,a.transacciones=o,a.puntosControl=s.sort((u,b)=>String(u.fecha).localeCompare(String(b.fecha))),a}const Be=t=>Array.isArray(t)?t:[],Ks=t=>typeof t=="string"&&/^\d{4}-\d{2}-\d{2}$/.test(t),Xs=t=>typeof t=="number"&&Number.isFinite(t)&&t>0;let He=0;function Zs(){return He+=1,`tx_hp_${He.toString(36)}`}function tn(t,e){const a={...t};He=0;const o=[...Be(t.transacciones)],n=new Set(o.map(i=>`${i.estimacionId}|${i.fecha}|${i.importeCts}`)),s=Be(t.expenses).map(i=>{const r=Be(i.historialPrecios),l=typeof i._id=="string"?i._id:null,u=typeof i.cuenta=="string"&&i.cuenta?i.cuenta:"default",b=i.tipo==="ingreso"?"ingreso":"gasto",p=Array.isArray(i.tags)?i.tags.filter(y=>typeof y=="string"):[];if(l)for(const y of r){if(!y||!Ks(y.fecha)||!Xs(y.cuantia))continue;const I=b==="ingreso"?It(y.cuantia):-It(y.cuantia),A=`${l}|${y.fecha}|${I}`;n.has(A)||(n.add(A),o.push({_id:Zs(),fecha:y.fecha,cuentaId:u,importeCts:I,concepto:typeof i.concepto=="string"?i.concepto:"Movimiento",tags:p,estimacionId:l,tipo:b,origen:"importado",nota:typeof y.nota=="string"&&y.nota?y.nota:"Importado del historial de precios"}))}const{historialPrecios:d,...h}=i;return h});return a.expenses=s,a.transacciones=o.sort((i,r)=>String(i.fecha).localeCompare(String(r.fecha))),a}const Xa=t=>Array.isArray(t)?t:[],Mt=(t,e="")=>typeof t=="string"&&t.trim()?t:e,Ot=(t,e=0)=>typeof t=="number"&&Number.isFinite(t)?t:e,en=t=>typeof t=="string"&&/^\d{4}-\d{2}/.test(t)?t.slice(0,7):null;function an(t,e){var b;const a={...t};if(Array.isArray(a.planes))return a;const o=Xa(a.goals),n=Xa(a.accounts),s=n.map(p=>{const d=Ot(p.bloqueoMeses,0);return{_id:`veh_${Mt(p._id,"x")}`,nombre:Mt(p.nombre,"Cuenta"),rentabilidadRealAnual:Ot(p.interes,0)/100,liquidez:p.modeloFondo==="pension"?"BLOQUEADA_HASTA_JUBILACION":d>0?"MEDIA":"INMEDIATA",fiscalidadRetirada:Ot(p.impuestoRetirada,0)/100,topeAportacionAnual:p.modeloFondo==="pension"?It(1500):null,riesgo:p.modeloFondo==="pension"?"MEDIO":"NULO",cuentaId:Mt(p._id,""),prestamoId:null,esDeuda:!1,revisarRentabilidad:Ot(p.interes,0)>0}}),i=new Map(n.map((p,d)=>[Mt(p._id,""),s[d]._id])),r=((b=s[0])==null?void 0:b._id)??"",l=o.map((p,d)=>{const h=Array.isArray(p.cuentaIds)?p.cuentaIds.map(I=>Mt(I,"")):[],y=en(p.targetDate);return{_id:Mt(p._id,`obj_mig_${d}`),nombre:Mt(p.nombre,`Objetivo ${d+1}`),tipo:"AHORRO_OBJETIVO",importeObjetivo:It(Ot(p.targetAmount,0)),fechaLimite:y,prioridad:Ot(p.prioridad,d+1),modoAsignacion:y?"CUOTA_POR_FECHA":"ABSORBE_TODO",vehiculoId:i.get(h[0])??r,saldoActual:0,estado:p.completado===!0?"COMPLETADO":"PENDIENTE",notas:Mt(p.notas,"")}}),u={_id:"plan_base",nombre:"Plan base",fechaInicio:e.hoyISO.slice(0,7),horizonteMeses:480,pctDisfrute:0,notas:o.length>0?"Creado al migrar los objetivos de ahorro anteriores. Revisa los saldos de partida y las rentabilidades reales.":"",activo:!0,perfil:{netoMensual:0,gastosFijosMensuales:0,manual:!1},vehiculos:s,objetivos:l,eventos:[],creadoEn:e.hoyISO};return a.planes=[u],a}const on=[{version:5,describe:"Formaliza el esquema; limpia restos de features eliminadas; añade config.features",migrate:Us},{version:6,describe:"Contabilidad real: crea transacciones y puntosControl (importa historicoSaldos y la clave history)",migrate:Qs},{version:7,describe:"Retira historialPrecios: cada entrada pasa a ser una transacción real enlazada a su estimación",migrate:tn},{version:8,describe:"Gestor de objetivos: absorbe `goals` dentro de un Plan, con un vehículo por cuenta",migrate:an}],sn=["history"];function Za(t,e,a){let o=t;const n=[];for(const s of[...on].sort((i,r)=>i.version-r.version))(e??0)>=s.version||(o=s.migrate(o,a),n.push(s.version));return{state:o,applied:n}}const me="state_",Ge="state__schemaVersion",to="financeapp_",eo="state__modificadoEn";function nn(t=localStorage,e=to){const a=o=>`${e}${o}`;return{get(o){try{const n=t.getItem(a(o));return n===null?null:JSON.parse(n)}catch{return null}},set(o,n){try{t.setItem(a(o),JSON.stringify(n)),o!==eo&&t.setItem(a(eo),JSON.stringify(Date.now()))}catch(s){console.error("No se pudo guardar en localStorage:",o,s)}},remove(o){try{t.removeItem(a(o))}catch{}},keys(){const o=[];for(let n=0;n<t.length;n++){const s=t.key(n);s!=null&&s.startsWith(e)&&o.push(s.slice(e.length))}return o}}}function rn(t=localStorage,e=to){const a=[];for(let n=0;n<t.length;n++){const s=t.key(n);s!=null&&s.startsWith(me)&&!s.startsWith(e)&&a.push(s)}const o=[];for(const n of a)try{const s=t.getItem(n);s!==null&&t.getItem(`${e}${n}`)===null&&(t.setItem(`${e}${n}`,s),o.push(n)),t.removeItem(n)}catch{}return o}function ln(t){return V(new Date(t.getFullYear()+1,t.getMonth(),t.getDate()))}function cn({adapter:t,hoy:e=new Date}){const a=V(e),o=ln(e);let n=Gs(a,o);const s=new Set;let i=[];function r(C){for(const z of s)z(C)}function l(C){t.set(`${me}${C}`,n[C])}function u(){const C={};for(const M of Object.keys(n)){const P=t.get(`${me}${M}`);P!==null&&(C[M]=P)}for(const M of sn){const P=t.get(`${me}${M}`);P!==null&&(C[M]=P)}const z=t.get(Ge),{state:E,applied:F}=Za(C,z,{hoyISO:a,finISO:o});if(n=E,b(),F.length>0){for(const M of Object.keys(n))l(M);t.set(Ge,Kt)}return i=F,{applied:F}}function b(){if(!Array.isArray(n.accounts)||n.accounts.length===0){n.accounts=[qe(a)],l("accounts");return}const C=n.accounts.filter(z=>z.esCuentaPrincipal);if(C.length===0)n.accounts=n.accounts.map((z,E)=>E===0?{...z,esCuentaPrincipal:!0}:z),l("accounts");else if(C.length>1){let z=!1;n.accounts=n.accounts.map(E=>E.esCuentaPrincipal?z?{...E,esCuentaPrincipal:!1}:(z=!0,E):E),l("accounts")}}function p(C){return n[C]}function d(C,z){n[C]=z,l(C),r(C)}function h(C){d("config",{...n.config,...C})}function y(C){return s.add(C),()=>s.delete(C)}function I(){return Date.now().toString(36)+Math.random().toString(36).slice(2,7)}function A(C,z){const E=[...n[C]],F={...z,_id:I()};return E.push(F),d(C,E),F}function f(C,z,E){const F=n[C].map(M=>M._id===z?{...M,...E}:M);d(C,F)}function g(C,z){const E=n[C].filter(F=>F._id!==z);d(C,E)}function m(){const C=n.accounts||[],z=C.find(E=>E.esCuentaPrincipal&&E.activo)||C.find(E=>E.activo);return z?z._id:"default"}function $(C){var z;return((z=n.accounts.find(E=>E._id===C))==null?void 0:z.nombre)??C}function v(){return bt(n.tramosIRPFHistorico,n.config.tramos_irpf)}function x(){return bt(n.tramosGananciasCapitalHistorico,n.config.tramosGananciasCapital)}function S(){return structuredClone(n)}function w(C,z=null){const{state:E,applied:F}=Za(C,z,{hoyISO:a,finISO:o});n=E,b();for(const M of Object.keys(n))l(M);t.set(Ge,Kt);for(const M of Object.keys(n))r(M);return{applied:F}}return{load:u,get:p,set:d,patchConfig:h,subscribe:y,addItem:A,updateItem:f,removeItem:g,getPrincipalAccountId:m,accountName:$,resolverTramosIRPF:v,resolverTramosGanancias:x,snapshot:S,replaceAll:w,get schemaVersion(){return Kt},get migrationsApplied(){return[...i]},get today(){return a||J()}}}const X={nucleo:"Esenciales",dinero:"Mi dinero",planificacion:"Planificación",analisis:"Análisis del dashboard",datos:"Datos y sincronización"},Ct=[{id:"dashboard",nombre:"Dashboard",descripcion:"Saldo actual, extracto proyectado y evolución. No se puede desactivar.",grupo:X.nucleo,porDefecto:!0,nucleo:!0},{id:"expenses",nombre:"Gastos e ingresos",descripcion:"Estimaciones recurrentes y extraordinarias, transferencias entre cuentas y etiquetas.",grupo:X.dinero,porDefecto:!0},{id:"loans",nombre:"Préstamos",descripcion:"Tablas de amortización, TAE y amortizaciones anticipadas.",grupo:X.dinero,porDefecto:!0},{id:"nominas",nombre:"Nóminas",descripcion:"Salarios con IRPF por tramos, pagas extra y retribución flexible.",grupo:X.dinero,porDefecto:!0},{id:"accounts",nombre:"Cuentas y ahorro",descripcion:"Cuentas, fondos de inversión, planes de pensiones y puntos de control de saldo.",grupo:X.dinero,porDefecto:!0},{id:"goals",nombre:"Objetivos de ahorro (antiguos)",descripcion:"Solo lectura: la copia previa al planificador. Los objetivos se gestionan en «Objetivos financieros». Apagada de fábrica; enciéndela si quieres revisar los antiguos antes de descartarlos.",grupo:X.dinero,porDefecto:!1,dependencias:["accounts"]},{id:"contabilidad",nombre:"Contabilidad real",descripcion:"Registro de gastos e ingresos reales y análisis de precisión de las estimaciones.",grupo:X.dinero,porDefecto:!0,dependencias:["accounts"]},{id:"supuestos",nombre:"Supuestos",descripcion:"Puntos de guardado sobre los que probar cambios, con biblioteca revisitable.",grupo:X.planificacion,porDefecto:!0},{id:"inflacion",nombre:"Inflación",descripcion:"Tasas anuales de IPC que encarecen los gastos y erosionan el ahorro.",grupo:X.planificacion,porDefecto:!1},{id:"fiscalidad",nombre:"Fiscalidad",descripcion:"Simulador de la declaración de la renta y tablas de tramos por ejercicio.",grupo:X.planificacion,porDefecto:!1},{id:"margenes",nombre:"Márgenes de seguridad",descripcion:"Umbrales mínimos de saldo por cuenta, con avisos al cruzarlos.",grupo:X.planificacion,porDefecto:!1},{id:"planner",nombre:"Objetivos financieros",descripcion:"Plan a largo plazo: objetivos que compiten por el flujo mensual y se encadenan al completarse.",grupo:X.planificacion,porDefecto:!0},{id:"optimizador",nombre:"Optimizador de amortizaciones",descripcion:"Planifica amortizaciones anticipadas con el excedente disponible cada mes.",grupo:X.planificacion,porDefecto:!1,dependencias:["loans"]},{id:"comparador-frecuencias",nombre:"Comparador de frecuencias",descripcion:"Compara amortizar cada mes, cada trimestre, etc. por ahorro de intereses.",grupo:X.planificacion,porDefecto:!1,dependencias:["optimizador"]},{id:"resumen-ejecutivo",nombre:"Resumen ejecutivo",descripcion:"Titulares del periodo: ingresos, gastos, ahorro y saldo final estimado.",grupo:X.analisis,porDefecto:!0},{id:"velas-saldo",nombre:"Velas del saldo",descripcion:"Apertura, cierre, máximo y mínimo del saldo por mes o por año.",grupo:X.analisis,porDefecto:!0},{id:"graficos-etiquetas",nombre:"Gráficos por etiqueta",descripcion:"Reparto y media mensual del gasto por etiqueta, con grupos de etiquetas.",grupo:X.analisis,porDefecto:!0},{id:"puntos-criticos",nombre:"Puntos críticos",descripcion:"Avisos de saldo negativo o por debajo del colchón en la proyección.",grupo:X.analisis,porDefecto:!0},{id:"precision-estimaciones",nombre:"Precisión de estimaciones",descripcion:"Acierto de cada estimación frente al gasto real, con ajuste sugerido.",grupo:X.analisis,porDefecto:!0,dependencias:["contabilidad","expenses"]},{id:"sync-nube",nombre:"Sincronización en la nube",descripcion:"Copia cifrada en Firebase o Dropbox, además del almacenamiento local.",grupo:X.datos,porDefecto:!0},{id:"autoguardado",nombre:"Autoguardado",descripcion:"Sube una copia a la nube cada cierto intervalo automáticamente.",grupo:X.datos,porDefecto:!1,dependencias:["sync-nube"]}],dn=new Map(Ct.map(t=>[t.id,t]));function Zt(t){return dn.get(t)}function ao(t){return Ct.filter(e=>(e.dependencias||[]).includes(t))}function Ve(){const t={};for(const e of Ct)t[e.id]=e.porDefecto;return t}function oo(){const t=[],e=new Map;for(const a of Ct)e.has(a.grupo)||(e.set(a.grupo,[]),t.push(a.grupo)),e.get(a.grupo).push(a);return t.map(a=>({grupo:a,features:e.get(a)}))}function un(t){function e(){return{...Ve(),...t.get("config").features||{}}}function a(p){t.patchConfig({features:p})}function o(p,d=e(),h=new Set){const y=Zt(p);if(!y)return!1;if(y.nucleo)return!0;if(d[p]===!1)return!1;if(h.has(p))return!0;h.add(p);for(const I of y.dependencias||[])if(!o(I,d,h))return!1;return!0}function n(p,d=e()){const h=Zt(p);return h?(h.dependencias||[]).filter(y=>!o(y,d)):[]}function s(p,d){var m;const h=Zt(p);if(!h)return{cambiadas:[]};if(h.nucleo)return{cambiadas:[],motivo:"nucleo-inmutable"};const y=e(),I=new Map(Ct.map($=>[$.id,o($.id,y)])),A={...y,[p]:d};let f;if(d){const $=[...h.dependencias||[]];for(;$.length;){const v=$.pop();A[v]===!1&&(A[v]=!0,f="dependencias-activadas"),$.push(...((m=Zt(v))==null?void 0:m.dependencias)||[])}}else{const $=ao(p).map(v=>v.id);for(;$.length;){const v=$.pop();A[v]!==!1&&(A[v]=!1,f="cascada-apagado"),$.push(...ao(v).map(x=>x.id))}}return a(A),{cambiadas:Ct.filter($=>o($.id,A)!==I.get($.id)).map($=>$.id),motivo:f}}function i(){const p=e();return Ct.map(d=>{const h=n(d.id,p);return{...d,activa:o(d.id,p),...h.length>0&&p[d.id]!==!1?{bloqueadaPor:h}:{}}})}function r(){const p=e();return oo().map(({grupo:d,features:h})=>({grupo:d,features:h.map(y=>{const I=n(y.id,p);return{...y,activa:o(y.id,p),...I.length>0&&p[y.id]!==!1?{bloqueadaPor:I}:{}}})}))}function l(){a(Ve())}function u(p){return{_app:"financeapp",_tipo:"feature-profile",_v:1,...p?{nombre:p}:{},features:e()}}function b(p){const d=p,h=d&&typeof d=="object"&&d.features&&typeof d.features=="object"?d.features:null;if(!h)throw new Error('El perfil no tiene una sección "features" válida');const y=Ve(),I=[],A=[];for(const[f,g]of Object.entries(h)){if(!Zt(f)){A.push(f);continue}if(typeof g!="boolean"){A.push(f);continue}y[f]=g,I.push(f)}return a(y),{aplicadas:I,ignoradas:A}}return{isEnabled:p=>o(p),setEnabled:s,estado:i,estadoPorGrupo:r,reset:l,exportProfile:u,importProfile:b,bloqueadaPor:p=>n(p)}}const te=t=>t.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;");function qt(t,e,a="ok"){if(t.notify)return t.notify(e,a);const o=globalThis.UI;if(o!=null&&o.toast)return o.toast(e,a);console.info("[FinanceApp]",e)}function pn(t){var n,s;const a=(((n=t.bloqueadaPor)==null?void 0:n.length)??0)>0?`<div style="font-size:11px;color:var(--yellow);margin-top:3px">Requiere: ${(s=t.bloqueadaPor)==null?void 0:s.map(te).join(", ")}</div>`:"",o=t.nucleo?'<span style="font-size:10px;color:var(--text3);border:1px solid var(--border2);border-radius:3px;padding:1px 5px;margin-left:6px">siempre activa</span>':"";return`
    ...
    </div>`}function Sn(t,e,a){D(t,"[data-sugerir]",o=>{const n=o.dataset.sugerir,s=Je(e).find(l=>l.analisis.estimacionId===n);if(!(s!=null&&s.sugerencia))return;const i=s.sugerencia,r=`${i.concepto}
...
¿Continuar?`))return;const{aplicadas:s,errores:i}=e.adjuster.aplicarTodas(o,{hoy:e.hoy()});q(i.length>0?`${s.length} ajustadas, ${i.length} con error`:`${s.length} estimaciones ajustadas`,i.length>0?"warn":"ok"),e.onDatosCambiados(),a()})}const wn=[";",",","	","|"],Mn={fecha:["fecha","f. valor","fecha valor","fecha operacion","date","f.operacion","f. operacion"],concepto:["concepto","descripcion","detalle","movimiento","referencia","description","observaciones"],importe:["importe","cantidad","amount","euros","import"],debe:["debe","cargo","salida","pago","debito"],haber:["haber","abono","entrada","ingreso","credito"]};function fe(t){return t.normalize("NFD").replace(/[̀-ͯ]/g,"").toLowerCase().trim()}function ve(t,e){const a=[];let o="",n=!1;for(let s=0;s<t.length;s++){const i=t[s];n?i==='"'?t[s+1]==='"'?(o+='"',s++):n=!1:o+=i:i==='"'?n=!0:i===e?(a.push(o.trim()),o=""):o+=i}return a.push(o.trim()),a}function Cn(t){let e=";",a=-1;for(const o of wn){const n=t.slice(0,20).map(l=>ve(l,o).length),s=Math.max(...n);if(s<2)continue;const r=n.filter(l=>l===s).length*10+s;r>a&&(a=r,e=o)}return e}function ee(t){let e=(t??"").trim();if(!e)return null;let a=!1;if(/^\(.*\)$/.test(e)&&(a=!0,e=e.slice(1,-1).trim()),e.endsWith("-")&&(a=!0,e=e.slice(0,-1).trim()),e.startsWith("-")&&(a=!0,e=e.slice(1).trim()),e.startsWith("+")&&(e=e.slice(1).trim()),e=e.replace(/[€$£\s  ]/g,""),!e)return null;const o=e.lastIndexOf(","),n=e.lastIndexOf(".");let s="";o>=0&&n>=0?s=o>n?",":".":o>=0?s=/,\d{3}$/.test(e)&&e.replace(/,/g,"").length>3?"":",":n>=0&&(s=/\.\d{3}$/.test(e)&&e.replace(/\./g,"").length>3?"":".");let i,r="0";if(s){const b=s===","?o:n;i=e.slice(0,b).replace(/[.,]/g,""),r=e.slice(b+1).replace(/[.,]/g,"")}else i=e.replace(/[.,]/g,"");if(!/^\d*$/.test(i)||!/^\d*$/.test(r)||i===""&&r==="")return null;const l=(r+"00").slice(0,2),u=Number(i||"0")*100+Number(l);return Number.isFinite(u)?a?-u:u:null}function We(t){const e=(t??"").trim();if(!e)return null;let a=e.match(/^(\d{4})[-/](\d{1,2})[-/](\d{1,2})/);if(a)return co(Number(a[1]),Number(a[2]),Number(a[3]));if(a=e.match(/^(\d{1,2})[-/.](\d{1,2})[-/.](\d{2,4})/),a){let o=Number(a[3]);return o<100&&(o+=o<70?2e3:1900),co(o,Number(a[2]),Number(a[1]))}return null}function co(t,e,a){if(e<1||e>12||a<1||a>31)return null;const o=new Date(t,e-1,a);return o.getFullYear()!==t||o.getMonth()!==e-1||o.getDate()!==a?null:`${t}-${String(e).padStart(2,"0")}-${String(a).padStart(2,"0")}`}function uo(t){const e=t.filter(a=>a.trim());return e.length===0?0:e.filter(a=>We(a)!==null).length/e.length}function po(t){const e=t.filter(a=>a.trim());return e.length===0?0:e.filter(a=>ee(a)!==null).length/e.length}function jn(t,e){const a={fecha:-1,concepto:-1,importe:-1,debe:-1,haber:-1},o=new Set,n=s=>e.map(i=>i[s]??"");for(const s of["fecha","importe","debe","haber","concepto"])for(let i=0;i<t.length;i++){if(o.has(i))continue;const r=fe(t[i]);if(r&&Mn[s].some(l=>r===l||r.startsWith(l)||r.includes(l))){if(s==="importe"&&fe(t[i]).includes("saldo"))continue;a[s]=i,o.add(i);break}}if(a.fecha<0){let s=-1,i=.6;for(let r=0;r<t.length;r++){if(o.has(r))continue;const l=uo(n(r));l>i&&(i=l,s=r)}s>=0&&(a.fecha=s,o.add(s))}if(a.importe<0&&a.debe<0&&a.haber<0){let s=-1,i=.6;for(let r=0;r<t.length;r++){if(o.has(r)||fe(t[r]).includes("saldo"))continue;const l=po(n(r));l>i&&(i=l,s=r)}s>=0&&(a.importe=s,o.add(s))}if(a.concepto<0){let s=-1,i=0;for(let r=0;r<t.length;r++){if(o.has(r))continue;const l=n(r);if(po(l)>.5||uo(l)>.5)continue;const u=l.reduce((b,p)=>b+p.length,0)/Math.max(1,l.length);u>i&&(i=u,s=r)}s>=0&&(a.concepto=s)}return a}function zn(t){const e=t.replace(/^﻿/,"").split(/\r\n|\n|\r/).filter(b=>b.trim()!=="");if(e.length===0)return{separador:";",cabeceras:[],filas:[],lineaCabecera:0,mapeo:{fecha:-1,concepto:-1,importe:-1,debe:-1,haber:-1}};const a=Cn(e),o=e.map(b=>ve(b,a).length),n=Math.max(...o);let s=o.findIndex(b=>b===n);s<0&&(s=0);const i=ve(e[s],a);let r=e.slice(s+1).map(b=>ve(b,a));const l=We(i[0]??"")!==null||i.some(b=>ee(b)!==null&&/\d/.test(b));l&&(r=[i,...r]);const u=jn(l?i.map(()=>""):i,r.slice(0,40));return{separador:a,cabeceras:l?i.map((b,p)=>`Columna ${p+1}`):i,filas:r,lineaCabecera:s+1,mapeo:u}}function mo(t,e,a){return`${t}|${e}|${fe(a).replace(/\s+/g," ")}`}function En(t,e,a=[]){const o=new Set(a.map(s=>mo(s.fecha,s.importeCts,s.concepto))),n=new Set;return t.filas.map((s,i)=>{const r=[],l=e.fecha>=0?We(s[e.fecha]??""):null;e.fecha<0?r.push("sin columna de fecha"):l||r.push(`fecha ilegible: «${s[e.fecha]??""}»`);let u=null;if(e.importe>=0)u=ee(s[e.importe]??""),u===null&&r.push(`importe ilegible: «${s[e.importe]??""}»`);else if(e.debe>=0||e.haber>=0){const d=e.debe>=0?ee(s[e.debe]??""):null,h=e.haber>=0?ee(s[e.haber]??""):null;d===null&&h===null?r.push("sin importe en Debe ni en Haber"):d!==null&&d!==0?u=-Math.abs(d):h!==null&&h!==0?u=Math.abs(h):u=0}else r.push("sin columna de importe");u===0&&r.push("importe cero");const b=(e.concepto>=0?s[e.concepto]??"":"").trim()||"Movimiento importado";let p=!1;if(l&&u!==null){const d=mo(l,u,b);p=o.has(d)||n.has(d),n.add(d)}return{linea:t.lineaCabecera+1+i,fecha:l,concepto:b,importeCts:u,errores:r,duplicada:p}})}function Fn(t,e){const a=t.filter(n=>n.errores.length===0&&(e||!n.duplicada)),o=a.map(n=>n.fecha).filter(n=>!!n).sort();return{total:t.length,importables:a.length,conError:t.filter(n=>n.errores.length>0).length,duplicadas:t.filter(n=>n.duplicada).length,sumaCts:a.reduce((n,s)=>n+(s.importeCts??0),0),desde:o[0]??null,hasta:o[o.length-1]??null}}function ge(){return{abierto:!1,nombreFichero:"",analisis:null,mapeo:null,filas:[],cuentaId:"",incluirDuplicadas:!1,error:""}}const _n=[{clave:"fecha",etiqueta:"Fecha"},{clave:"concepto",etiqueta:"Concepto"},{clave:"importe",etiqueta:"Importe (con signo)"},{clave:"debe",etiqueta:"Debe (salidas)"},{clave:"haber",etiqueta:"Haber (entradas)"}];function Qe(t,e){if(!e.analisis||!e.mapeo){e.filas=[];return}const a=t.ledger.transacciones(e.cuentaId?{cuentaId:e.cuentaId}:{}).map(o=>({fecha:o.fecha,importeCts:o.importeCts,concepto:o.concepto}));e.filas=En(e.analisis,e.mapeo,a)}function Pn(t,e){const a=t.accounts().filter(n=>n.activo);if(!e.abierto)return`
    ...
    <div class="card">
      ...
      ${e.analisis&&e.mapeo?Dn(e,e.analisis,e.mapeo):Tn()}
    ...
    <div class="text-sm" style="color:var(--text3);line-height:1.7">
      ...
      antes de importar.
    </div>`}function Dn(t,e,a){const o=Fn(t.filas,t.incluirDuplicadas),n=r=>`<option value="-1"${r<0?" selected":""}>— ninguna —</option>`+e.cabeceras.map((l,u)=>`<option value="${u}"${u===r?" selected":""}>${c(l||`Columna ${u+1}`)}</option>`).join(""),s=t.filas.filter(r=>r.errores.length>0),i=t.filas.slice(0,12);return`
    ...
    ${t.cuentaId?"":'<div class="text-sm mt-8" style="color:var(--yellow);text-align:right">Elige antes la cuenta de destino.</div>'}`}function Rn(t,e,a,o){D(t,"[data-imp-abrir]",()=>{const s=e.accounts().filter(i=>i.activo);Object.assign(a,ge(),{abierto:!0,cuentaId:s.length===1?s[0]._id:""}),o()}),D(t,"[data-imp-cerrar]",()=>{Object.assign(a,ge()),o()}),Y(t,"#imp-cuenta",s=>{a.cuentaId=s.value,Qe(e,a),o()}),Y(t,"#imp-duplicadas",s=>{a.incluirDuplicadas=s.checked,o()}),Y(t,"[data-imp-col]",s=>{const i=s,r=i.dataset.impCol;a.mapeo&&(a.mapeo[r]=Number(i.value),Qe(e,a),o())});const n=t.querySelector("#imp-fichero");n==null||n.addEventListener("change",()=>{var i;const s=(i=n.files)==null?void 0:i[0];s&&Nn(s).then(r=>{const l=zn(r);a.nombreFichero=s.name,a.error=l.filas.length===0?"El fichero no tiene ninguna línea de datos reconocible.":"",a.analisis=l,a.mapeo={...l.mapeo},Qe(e,a),o()}).catch(r=>{a.error=`No se ha podido leer el fichero: ${r.message}`,o()})}),D(t,"[data-imp-confirmar]",()=>{if(!a.cuentaId)return;const s=a.filas.filter(i=>i.errores.length===0&&(a.incluirDuplicadas||!i.duplicada));if(s.length!==0){for(const i of s)e.ledger.registrar({fecha:i.fecha,cuentaId:a.cuentaId,importe:Math.abs(et(i.importeCts)),tipo:i.importeCts<0?"gasto":"ingreso",concepto:i.concepto,origen:"importado"});q(`${s.length} movimiento${s.length!==1?"s":""} importado${s.length!==1?"s":""}`),Object.assign(a,ge()),e.onDatosCambiados(),o()}})}function Nn(t){return t.arrayBuffer().then(e=>{const a=new TextDecoder("utf-8").decode(e);if(!a.includes("�"))return a;try{return new TextDecoder("iso-8859-1").decode(e)}catch{return a}})}function On(t,e){if(t===0)return e===0?100:0;const a=Math.abs(e-t)/Math.abs(t);return Math.max(0,Math.min(100,(1-a)*100))}function qn(t,e){const a=G(t),o=[];for(let n=1;n<=e;n++){const s=new Date(a.getFullYear(),a.getMonth()-n,1);o.push(`${s.getFullYear()}-${String(s.getMonth()+1).padStart(2,"0")}`)}return o.reverse()}function Ln(t){const[e,a]=t.split("-").map(Number),o=new Date(e,a,0);return{inicio:`${t}-01`,fin:`${t}-${String(o.getDate()).padStart(2,"0")}`}}function fo(t,e){const{inicio:a,fin:o}=Ln(e);return Yt([t],{start:a,end:o}).reduce((s,i)=>s+Math.abs(i.cuantia),0)}function kn(t){function e(n,s={}){var $;const{mesesHistorial:i=12,mesesMedia:r=3,hoy:l=J()}=s,u=t.transacciones({estimacionId:n._id}),p=u.length===0&&((($=n.tags)==null?void 0:$.length)??0)>0?t.transacciones({tags:n.tags}):u,d=new Map;for(const v of p){const x=v.fecha.slice(0,7);d.set(x,(d.get(x)??0)+Math.abs(v.importeCts)/100)}const h=[];for(const v of qn(l,i)){const x=d.get(v);if(x===void 0)continue;const S=Q(fo(n,v));h.push({mes:v,estimado:S,real:Q(x),desviacion:Q(x-S),precision:On(S,x)})}const y=Q(h.reduce((v,x)=>v+x.estimado,0)),I=Q(h.reduce((v,x)=>v+x.real,0)),A=h.reduce((v,x)=>v+Math.abs(x.estimado),0),f=h.length===0?null:A>0?h.reduce((v,x)=>v+x.precision*Math.abs(x.estimado),0)/A:h.reduce((v,x)=>v+x.precision,0)/h.length,g=h.slice(-r),m=g.length>0?Q(g.reduce((v,x)=>v+x.real,0)/g.length):null;return{estimacionId:n._id,concepto:n.concepto,tags:n.tags??[],meses:h,estimadoTotal:y,realTotal:I,desviacionTotal:Q(I-y),precision:f,mediaRealReciente:m,infraestimada:I>y}}function a(n,s={}){return n.filter(i=>i.tipo!=="transferencia").map(i=>e(i,s)).sort((i,r)=>i.precision===null&&r.precision===null?i.concepto.localeCompare(r.concepto):i.precision===null?1:r.precision===null?-1:i.precision-r.precision)}function o(n){const s=new Map;for(const i of n)if(i.precision!==null)for(const r of i.tags.length>0?i.tags:["sin_tag"]){const l=s.get(r)??{estimado:0,real:0,pesoPrecision:0,peso:0,n:0};l.estimado+=i.estimadoTotal,l.real+=i.realTotal,l.pesoPrecision+=i.precision*Math.abs(i.estimadoTotal),l.peso+=Math.abs(i.estimadoTotal),l.n+=1,s.set(r,l)}return[...s.entries()].map(([i,r])=>({tag:i,estimadoTotal:Q(r.estimado),realTotal:Q(r.real),desviacionTotal:Q(r.real-r.estimado),precision:r.peso>0?r.pesoPrecision/r.peso:null,estimaciones:r.n})).sort((i,r)=>(i.precision??101)-(r.precision??101))}return{analizarEstimacion:e,analizarTodas:a,analizarPorTag:o}}function Bn(t){const[e,a]=t.split("-").map(Number),o=new Date(e,a,0).getDate();return{desde:`${t}-01`,hasta:`${t}-${String(o).padStart(2,"0")}`}}function Hn(t){const[e,a]=t.slice(0,7).split("-").map(Number),o=new Date(e,a-2,1);return`${o.getFullYear()}-${String(o.getMonth()+1).padStart(2,"0")}`}function Gn(t){return t.normalize("NFD").replace(/[̀-ͯ]/g,"").toLowerCase().replace(/\d+/g,"").replace(/\s+/g," ").trim()}function Vn(t,e,a){const o=new Map(e.map(s=>[s._id,[]])),n=e.filter(s=>{var i;return!a(s._id)&&(((i=s.tags)==null?void 0:i.length)??0)>0});for(const s of t){if(s.estimacionId&&o.has(s.estimacionId)){o.get(s.estimacionId).push(s);continue}if(s.estimacionId)continue;let i=null,r=0;for(const l of n){const u=(l.tags??[]).filter(b=>s.tags.includes(b)).length;u!==0&&(u>r||u===r&&i&&l._id<i._id)&&(i=l,r=u)}i&&o.get(i._id).push(s)}return o}function Un(t,e,a,o={}){const{desde:n,hasta:s}=Bn(a),i=t.transacciones({desde:n,hasta:s}),r=i.filter(m=>m.importeCts<0),l=i.filter(m=>m.importeCts>0),u=e.filter(m=>m.tipo==="gasto"&&m.activo!==!1),b=new Map((o.analisis??[]).map(m=>[m.estimacionId,m])),p=new Set(u.filter(m=>t.transacciones({estimacionId:m._id}).length>0).map(m=>m._id)),d=Vn(r,u,m=>p.has(m)),h=new Set,y=u.map(m=>{const $=d.get(m._id)??[];for(const w of $)h.add(w._id);const v=Q($.reduce((w,C)=>w+Math.abs(C.importeCts)/100,0)),x=Q(fo(m,a)),S=b.get(m._id);return{estimacionId:m._id,concepto:m.concepto,tags:m.tags??[],estimado:x,real:v,desviacion:Q(v-x),sinMovimiento:$.length===0,sugerencia:S?Ye(S,m.cuantia,{hoy:o.hoy}):null}}),I=new Map;for(const m of r){if(h.has(m._id))continue;const $=Gn(m.concepto),v=I.get($)??{concepto:m.concepto,total:0,movimientos:0};v.total=Q(v.total+Math.abs(m.importeCts)/100),v.movimientos+=1,I.set($,v)}const A=[...I.values()].sort((m,$)=>$.total-m.total),f=Q(y.reduce((m,$)=>m+$.estimado,0)),g=Q(r.reduce((m,$)=>m+Math.abs($.importeCts)/100,0));return{mes:a,estimado:f,real:g,desviacion:Q(g-f),ingresosReales:Q(l.reduce((m,$)=>m+$.importeCts/100,0)),filas:y.sort((m,$)=>Math.abs($.desviacion)-Math.abs(m.desviacion)),sinEstimacion:A,totalSinEstimacion:Q(A.reduce((m,$)=>m+$.total,0)),vacio:i.length===0}}function vo(t){const e=new Set;for(const a of t.transacciones())e.add(a.fecha.slice(0,7));return[...e].sort().reverse()}function Yn(){return{mes:""}}function Ke(t,e){if(e.mes)return e.mes;const a=vo(t.ledger),o=Hn((t.hoy??J)());return a.includes(o)?o:a[0]??o}function Xe(t,e){const a=(t.hoy??J)(),o=t.estimaciones(),n=t.precision.analizarTodas(o,{hoy:a});return Un(t.ledger,o,e,{analisis:n,hoy:a})}function Jn(t,e){const a=Ke(t,e),o=vo(t.ledger);o.includes(a)||o.unshift(a);const n=Xe(t,a),s=`
    ...
    <div class="card">
      ...
      ${Wn(n)}
      ${Qn(n)}
    </div>`}function Wn(t){const e=t.filas.filter(o=>o.estimado>0||o.real>0);if(e.length===0)return'<div class="text-sm" style="color:var(--text3)">No tienes estimaciones de gasto activas para este mes.</div>';const a=e.filter(o=>o.sugerencia);return`
    ...
    ${a.length>0?`<div class="flex justify-between items-center mb-12" style="gap:10px;flex-wrap:wrap">
           ...
           </div>`:""}`}function Qn(t){return t.sinEstimacion.length===0?`<div class="alert-card alert-info">
    ...
    ${t.sinEstimacion.length>10?`<div class="text-sm mt-8" style="color:var(--text3)">…y ${t.sinEstimacion.length-10} concepto(s) más.</div>`:""}`}function Kn(t,e,a,o){Y(t,"#cie-mes",n=>{a.mes=n.value,o()}),D(t,"[data-cie-ajustar]",n=>{const s=n.dataset.cieAjustar,r=Xe(e,Ke(e,a)).filas.find(l=>l.estimacionId===s);r!=null&&r.sugerencia&&(e.adjuster.aplicar(r.sugerencia.estimacionId,r.sugerencia.cuantiaSugerida,{hoy:(e.hoy??J)()}),q(`«${r.concepto}» ajustada a ${j(r.sugerencia.cuantiaSugerida)}`),e.onDatosCambiados(),o())}),D(t,"[data-cie-ajustar-todas]",()=>{const s=Xe(e,Ke(e,a)).filas.map(l=>l.sugerencia).filter(l=>l!==null);if(s.length===0)return;const{aplicadas:i,errores:r}=e.adjuster.aplicarTodas(s,{hoy:(e.hoy??J)()});q(`${i.length} estimación${i.length!==1?"es":""} ajustada${i.length!==1?"s":""}`+(r.length>0?` · ${r.length} con error`:"")),e.onDatosCambiados(),o()})}const Xn="M20 4H4c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 14H4V8h16v10zM6 10h5v2H6v-2zm0 4h8v2H6v-2z";function Zn(t){const e={cuentaId:"",mes:(t.hoy??J)().slice(0,7),filtroTexto:""},a=ge(),o=Yn(),n=()=>{var p;return(p=t.onDatosCambiados)==null?void 0:p.call(t)},s=t.hoy??J,i={ledger:t.ledger,accounts:t.accounts,estimaciones:t.estimaciones,tagsConocidas:()=>t.tags.todas(),onDatosCambiados:n,hoy:s},r={ledger:t.ledger,accounts:t.accounts,onDatosCambiados:n},l={ledger:t.ledger,precision:t.precision,adjuster:t.adjuster,estimaciones:t.estimaciones,onDatosCambiados:n,hoy:s},u={precision:t.precision,adjuster:t.adjuster,estimaciones:t.estimaciones,onDatosCambiados:n,hoy:s};function b(p){const d=t.ledger.saldoTotal(s()),h=t.ledger.ultimaFecha(),y=t.ledger.transacciones().length;p.innerHTML=`
      ...
      <div id="acc-precision" data-feature="precision-estimaciones"></div>`;const I=p.querySelector("#acc-importar"),A=p.querySelector("#acc-cierre"),f=p.querySelector("#acc-transacciones"),g=p.querySelector("#acc-precision");I.innerHTML=Pn(r,a),A.innerHTML=Jn(l,o),f.innerHTML=xn(i,e),g.innerHTML=An(u);const m=()=>b(p);Rn(I,r,a,m),Kn(A,l,o,m),$n(f,i,e,m),Sn(g,u,m)}return{id:"contabilidad",route:"contabilidad",nombre:"Contabilidad",flagId:"contabilidad",seccion:1,iconoPath:Xn,mount:b}}const ti="M12 1L3 5v6c0 5.55 3.84 10.74 9 12 5.16-1.26 9-6.45 9-12V5l-9-4zm0 4l5 2.18V11c0 3.5-2.33 6.79-5 7.93-2.67-1.14-5-4.43-5-7.93V7.18L12 5z";function Ze(){return Date.now().toString(36)+Math.random().toString(36).slice(2,6)}function ei(t){const{store:e}=t,a=t.hoy??J,o=()=>G(a()),n=()=>e.get("config").margenesSeguridad??[];function s(h){var y;e.patchConfig({margenesSeguridad:h}),(y=t.onDatosCambiados)==null||y.call(t)}function i(h,y){const I=n().map(f=>({...f,puntos:(f.puntos??[]).map(g=>({...g}))})),A=I.find(f=>f._id===h);A&&(y(A),s(I))}function r(h){const y=e.get("config"),I=pe(h,e.get("expenses"),y,e.get("loans"),a(),!1,o());return j(I)}function l(h,y,I){const A=y.tipo==="fijo",f=A?"":`<span class="text-sm" style="color:var(--text3)">${c(j((y.meses??0)*I))}</span>`;return`
      ...
      </div>`}function p(h,y){const I=document.getElementById("modal-overlay"),A=document.getElementById("modal-content");!I||!A||(b(A,h),I.classList.remove("hidden"),Y(A,".mg-acc-chip",f=>{const g=f,m=A.querySelector(`[data-chip="${g.value}"]`);m&&(m.style.cssText=`cursor:pointer;${g.checked?"border-color:var(--accent);color:var(--accent)":""}`)}),Y(A,"#mg-p-tipo",f=>{const g=f.value==="fijo",m=A.querySelector("#mg-p-importe-wrap"),$=A.querySelector("#mg-p-meses-wrap");m&&(m.style.display=g?"":"none"),$&&($.style.display=g?"none":"")}),D(A,"[data-cerrar-form]",()=>I.classList.add("hidden")),D(A,"[data-guardar-margen]",f=>{var x,S,w,C,z;const g=f.getAttribute("data-guardar-margen")||"",m=((x=A.querySelector("#mg-nombre"))==null?void 0:x.value.trim())??"";if(!m)return q("El nombre es obligatorio","err");const $=[...A.querySelectorAll(".mg-acc-chip:checked")].map(E=>E.value),v=n().map(E=>({...E}));if(g){const E=v.findIndex(F=>F._id===g);if(E===-1)return q("Margen no encontrado","err");v[E]={...v[E],nombre:m,cuentas:$}}else{const E=((S=A.querySelector("#mg-p-tipo"))==null?void 0:S.value)??"fijo",F={_id:Ze(),fecha:((w=A.querySelector("#mg-p-fecha"))==null?void 0:w.value)||J(),tipo:E,importe:parseFloat(((C=A.querySelector("#mg-p-importe"))==null?void 0:C.value)??"0")||0,meses:parseFloat(((z=A.querySelector("#mg-p-meses"))==null?void 0:z.value)??"1")||1};v.push({_id:Ze(),nombre:m,activo:!0,cuentas:$,puntos:[F]})}s(v),q(g?"Margen actualizado":"Margen creado"),I.classList.add("hidden"),y()}))}function d(h){const y=n(),I=e.get("accounts"),A=Wt(e.get("expenses"),o());h.innerHTML=`
      <div class="page-header">
        <div>
      ...
      ${y.length===0?`<div class="card" style="padding:24px;text-align:center">
             ...
             </div>`:y.map(g=>u(g,I,A)).join("")}`;const f=()=>d(h);D(h,"[data-nuevo-margen]",()=>p(null,f)),D(h,"[data-editar-margen]",g=>p(g.getAttribute("data-editar-margen"),f)),D(h,"[data-borrar-margen]",g=>{Z("¿Eliminar este margen de seguridad?")&&(s(n().filter(m=>m._id!==g.getAttribute("data-borrar-margen"))),q("Margen eliminado"),f())}),Y(h,"[data-toggle-margen]",g=>{const m=g.getAttribute("data-toggle-margen");i(m,$=>{$.activo=g.checked}),f()}),D(h,"[data-add-punto]",g=>{const m=g.getAttribute("data-add-punto");i(m,$=>{$.puntos=[...$.puntos??[],{_id:Ze(),fecha:J(),tipo:"fijo",importe:0,meses:1}]}),f()}),D(h,"[data-borrar-punto]",g=>{const m=g.closest("[data-punto]");if(!m)return;const $=m.dataset.margen,v=m.dataset.punto;i($,x=>{x.puntos=(x.puntos??[]).filter(S=>S._id!==v)}),f()}),Y(h,"[data-campo]",g=>{const m=g.closest("[data-punto]");if(!m)return;const $=g.getAttribute("data-campo"),v=g.value;i(m.dataset.margen,x=>{const S=(x.puntos??[]).find(w=>w._id===m.dataset.punto);S&&($==="fecha"?S.fecha=v:$==="tipo"?S.tipo=v:$==="importe"?S.importe=parseFloat(v)||0:S.meses=parseFloat(v)||0)}),f()})}return{id:"margenes",route:"margenes",nombre:"Márgenes de seguridad",flagId:"margenes",seccion:2,iconoPath:ti,mount:d}}const ai="https://api.worldbank.org/v2/country/ES/indicator/FP.CPI.TOTL.ZG?format=json&mrv=65&per_page=65";function oi(t){const e=Array.isArray(t)?t[1]??[]:[];return Array.isArray(e)?e.filter(a=>a&&a.value!==null&&a.value!==void 0&&Number.isFinite(Number(a.value))).map(a=>({year:parseInt(a.date),tasa:parseFloat(Number(a.value).toFixed(2))})).filter(a=>Number.isFinite(a.year)).sort((a,o)=>a.year-o.year):[]}function si({fetchImpl:t,url:e=ai}={}){let a=null,o=!1;async function n(s=!1){if(a&&!s)return a;if(o)return null;o=!0;try{const r=await(t??fetch)(e);if(!r.ok)throw new Error(`HTTP ${r.status}`);return a=oi(await r.json()),a}catch(i){return console.error("[inflacion] No se pudo cargar el IPC del Banco Mundial:",i),null}finally{o=!1}}return{obtener:n,invalidar:()=>{a=null},get enCache(){return a}}}const ni="M16 6l2.29 2.29-4.88 4.88-4-4L2 16.59 3.41 18l6-6 4 4 6.3-6.29L22 12V6z";function ii(t){return t>5?"var(--red)":t>2.5?"var(--yellow)":"var(--accent)"}function ri(t){const{store:e}=t,a=t.ipc??si(),o=()=>e.get("inflacion")??[];function n(){var p;(p=t.onDatosCambiados)==null||p.call(t)}function s(p,d){if(!p||p.length===0)return`
        ...
        <div style="display:grid;grid-template-columns:20px 60px 80px 1fr;gap:10px;align-items:center;padding:5px 0;border-bottom:1px solid var(--border)">
          ...
          <span style="font-family:var(--font-mono);font-weight:600;color:${ii(g.tasa)}">${g.tasa.toFixed(2)}%</span>
      ...
      </div>`,d.classList.remove("hidden");const y=(A,f)=>{const g=document.getElementById("ipc-body");g&&(g.innerHTML=s(A,f))},I=await a.obtener();y(I,i(I)),D(h,"[data-ipc-cerrar]",()=>d.classList.add("hidden")),Y(h,"#ipc-desde",A=>{y(a.enCache,parseInt(A.value))}),D(h,"[data-ipc-recargar]",()=>{a.invalidar();const A=document.getElementById("ipc-body");A&&(A.innerHTML='<div style="text-align:center;padding:20px;color:var(--text3)">Recargando…</div>'),a.obtener(!0).then(f=>y(f,i(f)))}),D(h,"[data-ipc-importar]",()=>{const A=[...h.querySelectorAll(".ipc-chk:checked:not(:disabled)")];if(A.length===0)return q("Nada seleccionado","err");const f=new Set(o().map(m=>m.year));let g=0;for(const m of A){const $=parseInt(m.dataset.year??""),v=parseFloat(m.dataset.tasa??"");!Number.isFinite($)||!Number.isFinite(v)||f.has($)||(e.addItem("inflacion",{year:$,tasa:v}),f.add($),g++)}d.classList.add("hidden"),q(`${g} periodo${g!==1?"s":""} importado${g!==1?"s":""} correctamente`),n(),p()})}function l(p,d){var f;const h=document.getElementById("modal-overlay"),y=document.getElementById("modal-content");if(!h||!y)return;const I=p?o().find(g=>g._id===p):null;y.innerHTML=`
      ...
      </div>`,h.classList.remove("hidden");const A=()=>{var x;const g=parseFloat(((x=y.querySelector("#inf-tasa"))==null?void 0:x.value)??""),m=y.querySelector("#inf-preview");if(!m)return;if(!Number.isFinite(g)||g<=0){m.innerHTML="";return}const $=(Math.pow(1+g/100,1/12)-1)*100,v=Math.pow(1+g/100,5);m.innerHTML=`Con un ${g}% anual: <strong>${$.toFixed(3)}%/mes</strong> · factor acumulado a 5 años: <strong>×${v.toFixed(3)}</strong> (+${((v-1)*100).toFixed(1)}%)`};(f=y.querySelector("#inf-tasa"))==null||f.addEventListener("input",A),A(),D(y,"[data-inf-cerrar]",()=>h.classList.add("hidden")),D(y,"[data-inf-guardar]",g=>{const m=g.getAttribute("data-inf-guardar")||"",$=parseInt(y.querySelector("#inf-year").value),v=parseFloat(y.querySelector("#inf-tasa").value);if(!Number.isFinite($)||$<1900||$>2200)return q("Año inválido","err");if(!Number.isFinite(v)||v<0||v>100)return q("Tasa inválida (0–100%)","err");if(o().filter(S=>S._id!==m).some(S=>S.year===$))return q("Ya existe un periodo para ese año","err");m?(e.updateItem("inflacion",m,{year:$,tasa:v}),q("Periodo actualizado")):(e.addItem("inflacion",{year:$,tasa:v}),q("Periodo añadido")),h.classList.add("hidden"),n(),d()})}function u(p,d){const h=(Math.pow(1+p.tasa/100,.08333333333333333)-1)*100,y=`${p.year}-12-31`,I=y>d?pt([p],d,y):null;return`
      ...
      </div>`}function b(p){const d=o(),h=e.get("config").usarInflacion||!1,y=[...d].sort((x,S)=>S.year-x.year),I=J(),A=new Date().getFullYear(),f=V(new Date(A+5,0,1)),g=V(new Date(A+10,0,1)),m=h&&d.length>0?pt(d,I,f):null,$=h&&d.length>0?pt(d,I,g):null;p.innerHTML=`
      <div class="page-header">
      ...
      </div>`;const v=()=>b(p);Y(p,"[data-toggle-inflacion]",x=>{const S=x.checked;e.patchConfig({usarInflacion:S}),q(S?"Estimaciones de inflación activadas":"Estimaciones de inflación desactivadas"),n(),v()}),D(p,"[data-nuevo-periodo]",()=>l(null,v)),D(p,"[data-editar-periodo]",x=>l(x.getAttribute("data-editar-periodo"),v)),D(p,"[data-importar-ipc]",()=>void r(v)),D(p,"[data-borrar-periodo]",x=>{Z("¿Eliminar este periodo de inflación?")&&(e.removeItem("inflacion",x.getAttribute("data-borrar-periodo")),q("Periodo eliminado"),n(),v())})}return{id:"inflacion",route:"inflacion",nombre:"Inflación",flagId:"inflacion",seccion:2,iconoPath:ni,mount:b}}const li=[...Array.from({length:31},(t,e)=>String(e+1)),"ultimo"],ci=[["1","1º"],["2","2º"],["3","3º"],["4","4º"],["5","5º"],["-1","Último"]],di=[["1","lunes"],["2","martes"],["3","miércoles"],["4","jueves"],["5","viernes"],["6","sábado"],["0","domingo"]];function ui(t){const e=t||"";if(e.startsWith("dia:"))return{modo:"dia",dia:e.slice(4)||"1",nth:"1",wd:"1"};if(e.startsWith("nthweekday:")){const[,a="1",o="1"]=e.split(":");return{modo:"nthweekday",dia:"1",nth:a,wd:o}}return{modo:"none",dia:"1",nth:"1",wd:"1"}}const ta=(t,e)=>t.map(([a,o])=>`<option value="${c(a)}"${a===e?" selected":""}>${c(o)}</option>`).join("");function go(t,e="dp"){const{modo:a,dia:o,nth:n,wd:s}=ui(t),i=ta(li.map(r=>[r,r==="ultimo"?"Último día":r]),o);return`<div class="form-group" data-diapago="${c(e)}">
    ...
    <div class="flex gap-8 items-center" style="flex-wrap:wrap;row-gap:6px">
      ...
      </div>`}function d(f){const g=(f==null?void 0:f.tipo)==="transferencia",m=t.store.get("escenarios"),$=(f==null?void 0:f.escenarioIds)||[],v=(x,S,w,C,z="")=>`<div class="form-group"><label class="form-label">${c(S)}</label>
       <input class="form-input" type="${w}" id="${x}" value="${c(C)}" placeholder="${c(z)}"/></div>`;return`
      <div class="grid-2">
      ...
      <div class="grid-3 mt-8">
        ...
        <div class="form-group"><label class="form-label">Tipo frecuencia</label>
          <select class="form-select" id="ef-tipo-frec">
            ${mi.map(([x,S])=>`<option value="${x}"${((f==null?void 0:f.tipoFrecuencia)??"mensual")===x?" selected":""}>${c(S)}</option>`).join("")}
          </select>
        </div>
      </div>
      ...
      </div>`}function h(f){var $;const g=(($=f.querySelector("#ef-tipo"))==null?void 0:$.value)??"gasto",m=(v,x)=>{const S=f.querySelector(v);S&&(S.style.display=x?"":"none")};m("#ef-destino-wrap",g==="transferencia"),m("#ef-basico-wrap",g!=="transferencia"),m("#ef-irpf-wrap",g==="ingreso"),m("#ef-clasificacion-wrap",g==="gasto")}function y(f,g,m){const $=document.getElementById("modal-overlay"),v=document.getElementById("modal-content");!$||!v||(v.innerHTML=`<div class="modal-title">${c(g)}</div>${d(f)}`,$.classList.remove("hidden"),Y(v,"#ef-tipo",()=>h(v)),Y(v,"[data-dp-modo]",()=>bo(v)),D(v,"[data-cancelar]",()=>$.classList.add("hidden")),D(v,"[data-guardar]",x=>{I(v,x.getAttribute("data-guardar")||"")&&($.classList.add("hidden"),m())}))}function I(f,g){const m=E=>{var F;return((F=f.querySelector(E))==null?void 0:F.value)??""},$=E=>{var F;return!!((F=f.querySelector(E))!=null&&F.checked)},v=m("#ef-tipo")||"gasto",x=v==="transferencia",S=m("#ef-concepto").trim(),w=parseFloat(m("#ef-cuantia"));if(!S||!Number.isFinite(w))return q("Concepto y cuantía obligatorios","err"),!1;const C=m("#ef-clasificacion"),z={concepto:S,tipo:v,cuantia:w,frecuencia:parseInt(m("#ef-frecuencia"),10)||1,tipoFrecuencia:m("#ef-tipo-frec")||"mensual",fechaInicio:m("#ef-fecha-ini"),fechaFin:m("#ef-fecha-fin")||null,diaPago:ho(f),cuenta:m("#ef-cuenta"),cuentaDestino:x?m("#ef-cuenta-dest")||"default":void 0,activo:$("#ef-activo"),basico:!x&&$("#ef-basico"),sujetoIRPF:!x&&$("#ef-sujetoIRPF"),clasificacion:v==="gasto"?C||null:void 0,tags:x?["transferencia"]:m("#ef-tags").split(",").map(E=>E.trim()).filter(Boolean),escenarioIds:[...f.querySelectorAll(".ef-escenario:checked")].map(E=>E.value)};return g?(t.store.updateItem("expenses",g,z),q("Actualizado")):(t.store.addItem("expenses",z),q("Creado")),o(),!0}function A(f,g){const m=f.querySelector("[data-busqueda]");let $;m==null||m.addEventListener("input",()=>{clearTimeout($),$=setTimeout(()=>{a.busqueda=m.value,g();const v=f.querySelector("[data-busqueda]");v==null||v.focus(),v==null||v.setSelectionRange(v.value.length,v.value.length)},250)}),Y(f,"[data-expirados]",v=>{a.mostrarExpirados=v.checked,g()}),Y(f,"[data-f-tipo]",v=>{a.tipo=v.value,g()}),Y(f,"[data-f-cuenta]",v=>{a.cuenta=v.value,g()}),Y(f,"[data-f-desde]",v=>{a.desde=v.value,g()}),Y(f,"[data-f-hasta]",v=>{a.hasta=v.value,g()}),D(f,"[data-limpiar]",()=>{a.tipo="",a.cuenta="",a.desde="",a.hasta="",a.busqueda="",a.tags=new Set,g()}),D(f,"[data-limpiar-tags]",()=>{a.tags=new Set,g()}),D(f,"[data-tag]",v=>{const x=v.getAttribute("data-tag");a.tags.has(x)?a.tags.delete(x):a.tags.add(x),g()}),D(f,"[data-orden]",v=>{const x=v.getAttribute("data-orden");a.orden===x?a.sentido=a.sentido===1?-1:1:(a.orden=x,a.sentido=1),g()}),D(f,"[data-nuevo]",()=>y(null,"Nuevo gasto/ingreso",g)),D(f,"[data-editar]",v=>{const x=t.store.get("expenses").find(S=>S._id===v.getAttribute("data-editar"));x&&y(x,"Editar",g)}),D(f,"[data-duplicar]",v=>{const x=t.store.get("expenses").find(C=>C._id===v.getAttribute("data-duplicar"));if(!x)return;const{_id:S,...w}=x;y({...w,concepto:`${x.concepto} (copia)`},"Duplicar movimiento",g)}),D(f,"[data-borrar]",v=>{Z("¿Eliminar?")&&(t.store.removeItem("expenses",v.getAttribute("data-borrar")),q("Eliminado"),o(),g())}),Y(f,"[data-activo]",v=>{const x=v;t.store.updateItem("expenses",x.getAttribute("data-activo"),{activo:x.checked}),o(),g()})}return{id:"expenses",route:"expenses",nombre:"Gastos e Ingresos",flagId:"expenses",seccion:1,iconoPath:pi,mount(f){const g=()=>p(f);p(f),f.dataset.wired!=="1"&&(A(f,g),f.dataset.wired="1")}}}function be(t,e,a){return t.reduce((o,n)=>{if(n.esAmortizacion)return o;const s=pt(e,a,n.fecha);return o+(s>0?n.interes/s:n.interes)},0)}function yo(t,e,a,o){return t.reduce((n,s)=>{const i=pt(e,a,s.fecha),r=s.esAmortizacion?s.amortizacion+s.comisionAmort:s.cuota;return n+(i>0?r/i:r)},0)+o}function vi(t,e,a){const o=t.amortizaciones||[];return o.map((n,s)=>{const i=at({...t,amortizaciones:o.slice(0,s)}),r=at({...t,amortizaciones:o.slice(0,s+1)});return{nominal:i.totalIntereses-r.totalIntereses,real:be(i.tabla,e,a)-be(r.tabla,e,a)}})}const ea=(t,e,a="",o="")=>`<div class="stat-card">
     <div class="stat-label">${c(t)}</div>
     <div class="stat-value ${o}">${e}</div>
     ${a}
   </div>`;function gi(t,e){const a=va(t),o=(t.amortizaciones||[]).length>0,n=e.periodos.length>0,s=e.usarInflacion&&n,i=n?ga(e.periodos,t.fechaInicio||e.hoy,a.fechaFin||e.hoy,0):0,r=n?ba(t.tin||0,i):null,l=o&&n?vi(t,e.periodos,e.hoy):[],u=l.length?be(a.sinAmort.tabla,e.periodos,e.hoy)-be(a.tabla,e.periodos,e.hoy):null,b=u===null?null:u-a.costeTotalAmort,p=s?yo(a.tabla,e.periodos,e.hoy,a.comAp):null,d=s&&o?yo(a.sinAmort.tabla,e.periodos,e.hoy,a.comAp):null;return`<div class="loan-card" style="${e.completado?"opacity:0.65":""}">
    ...
    <div class="loan-card-body" data-body-loan="${c(t._id)}">
      ...
      <div class="table-wrap"><table>
        ...
        <tbody>${a.tabla.map(h=>hi(h,s,e)).join("")}</tbody>
      </table></div>

      ${o?`<div class="card-title mt-12">Amortizaciones programadas</div>
             ${(t.amortizaciones||[]).map((h,y)=>yi(t._id,h,l[y]??null,e)).join("")}`:""}
    </div>
  </div>`}function bi(t,e,a,o){const n=t.tipoTasa==="variable"?'<div class="text-sm mt-8" style="color:var(--text3)">⚠ Tipo variable: el beneficio real dependerá de cómo evolucione el índice de referencia.</div>':"";if(o!==null){const r=o-a,l=r>=0;return`<div class="card mb-12" style="background:var(--bg3);padding:12px">
    ...
    ${n}
  </div>`}function hi(t,e,a){let o="";if(e&&!t.esAmortizacion){const n=pt(a.periodos,a.hoy,t.fecha);o=c(j(n>0?t.cuota/n:t.cuota))}return`<tr ${t.esAmortizacion?'style="background:var(--yellow-dim)"':""}>
  ...
  </tr>`}function yi(t,e,a,o){const n=(e.escenarioIds||[]).map(s=>`<span class="badge badge-yellow">🔭 ${c(o.nombreEscenario(s))}</span>`).join("");return`<div class="amort-item" style="flex-wrap:wrap">
   ...
   ${o?`<span class="text-sm" style="margin-left:6px">${c(o)}</span>`:""}`;function oe(t,e,a){return t.length===0?"":`<div class="form-group mt-8"><label class="form-label">Supuestos</label>
    ...
    </div></div>`}const xi=(t,e)=>t.filter(a=>a.activo!==!1).map(a=>`<option value="${c(a._id)}"${a._id===e?" selected":""}>${c(a.nombre)}</option>`).join("");function $i(t,e,a,o=J()){return`
    <div class="grid-2">
      ...
      <div class="form-advanced-body">
        <div class="grid-2 mt-8">
          <div class="form-group"><label class="form-label">Cuenta bancaria</label>
            <select class="form-select" id="f-cuenta">${xi(e,(t==null?void 0:t.cuenta)??"default")}</select></div>
    ...
    </div>`}function Ii(t,e,a,o=J()){return`
    <div class="grid-2">
    ...
    <div class="flex gap-8 mt-16" style="justify-content:flex-end">
      ...
      <div class="flex gap-8 mt-16" style="justify-content:flex-end;flex-wrap:wrap">
        ...
        <button class="btn-primary" data-opt-calcular>Calcular plan manual</button>
      </div>`);w&&(b(w),Y(w,".opt-acc-radio",()=>b(w)),D(w,"[data-opt-todos]",()=>{const E=[...w.querySelectorAll(".opt-loan-check")],F=E.every(M=>M.checked);E.forEach(M=>M.checked=!F)}),D(w,"[data-cancelar]",i),D(w,"[data-opt-calcular]",()=>y(w)),D(w,"[data-opt-comparar]",()=>I(w)))}function b(m){var w;const $=(w=m.querySelector(".opt-acc-radio:checked"))==null?void 0:w.value,x=(t.config().margenesSeguridad||[]).filter(C=>C.activo!==!1).filter(C=>!C.cuentas||C.cuentas.length===0||$&&C.cuentas.includes($)),S=m.querySelector("#opt-margenes-wrap");S&&(S.innerHTML=x.length===0?'<span class="text-sm" style="color:var(--yellow)">Sin márgenes configurados para esta cuenta. Define límites en <strong>Márgenes de seguridad</strong>.</span>':x.map(C=>`<label style="display:flex;align-items:center;gap:8px;padding:5px 8px;border-radius:6px;cursor:pointer;background:var(--bg2)">
              ...
              </label>`).join(""))}function p(m){var S,w,C,z;const $=(E,F,M=0)=>{var T;const P=parseFloat(((T=m.querySelector(E))==null?void 0:T.value)??"");return Number.isFinite(P)?Math.max(M,P):F},v=[...m.querySelectorAll(".opt-loan-check")],x=v.filter(E=>E.checked).map(E=>E.value);return{horizonte:Math.round($("#opt-horizonte",60,1)),frecuencia:Math.round($("#opt-frecuencia",1,1)),minAmortizable:$("#opt-min",500),tipoAmort:((S=m.querySelector("#opt-tipo"))==null?void 0:S.value)||"plazo",fechaObjetivo:((w=m.querySelector("#opt-fecha-obj"))==null?void 0:w.value)||null,fechaPrimeraAmort:((C=m.querySelector("#opt-fecha-primera"))==null?void 0:C.value)||null,loanIds:v.length===0||x.length===v.length?null:x,sourceAccountId:((z=m.querySelector(".opt-acc-radio:checked"))==null?void 0:z.value)??null,selectedMarginIds:[...m.querySelectorAll(".opt-margin-check:checked")].map(E=>E.value)}}const d=()=>({loans:t.loans(),expenses:t.expenses(),accounts:t.accounts(),config:t.config(),nominas:t.nominas()});function h(m,$=""){const v=s("Sin resultados",`<div style="text-align:center;padding:20px">
      ...
      </div>`);v&&(D(v,"[data-opt-volver]",u),D(v,"[data-cancelar]",i))}function y(m){const $=p(m);r()&&q("Plan anterior eliminado, recalculando…");const{loans:v,expenses:x,accounts:S,config:w,nominas:C}=d(),z=l(()=>Oe(v,x,S,w,{frecuencia:$.frecuencia,mesesHorizonte:$.horizonte,minAmortizable:$.minAmortizable,tipoAmort:$.tipoAmort,fechaPrimeraAmort:$.fechaPrimeraAmort,loanIds:$.loanIds,nominas:C,sourceAccountId:$.sourceAccountId,selectedMarginIds:$.selectedMarginIds}));if(!z)return;if(z.plan.length===0){h(`No hay excedente suficiente respetando los ${z.margenesAplicados} márgenes de seguridad activos en los próximos ${$.horizonte} meses para generar amortizaciones por encima del mínimo de ${j($.minAmortizable)}.`,"Prueba a revisar los márgenes de seguridad, reducir el mínimo de amortización, o ampliar el horizonte.");return}a={plan:z.plan,tipoAmort:$.tipoAmort};const E=`✨ Plan de optimización · ${$.frecuencia===1?"Mensual":`Cada ${$.frecuencia} meses`} · ${$.horizonte}m`,F=s(E,`
      ...
      <div style="max-height:300px;overflow-y:auto">
        <table class="table-wrap" style="width:100%">
          ...
          <tbody>${z.plan.map(M=>Io(M,!0)).join("")}</tbody>
        </table>
      </div>
      ...
      </div>`);F&&(D(F,"[data-opt-volver]",u),D(F,"[data-cancelar]",i),D(F,"[data-opt-aplicar]",()=>{a&&f(a.plan,a.tipoAmort)}))}function I(m){const $=p(m);r();const{loans:v,expenses:x,accounts:S,config:w,nominas:C}=d(),z=l(()=>Ha(v,x,S,w,{horizonte:$.horizonte,minAmortizable:$.minAmortizable,tipoAmort:$.tipoAmort,fechaObjetivo:$.fechaObjetivo,frecuencias:[1,2,3,6,12],fechaPrimeraAmort:$.fechaPrimeraAmort,loanIds:$.loanIds,nominas:C,sourceAccountId:$.sourceAccountId,selectedMarginIds:$.selectedMarginIds}));if(!z)return;if(z.resultados.length===0){h("No hay excedente suficiente en ninguna frecuencia.");return}e=z;const{resultados:E,saldoBase:F,fechaObjetivo:M}=z,P=E.map(R=>{const O=[R.esMejorIntereses&&"💰 +intereses",R.esMejorSaldo&&"🏦 +saldo",R.esMejorValor&&"⭐ +valor total"].filter(Boolean).join(" ");return`<tr style="${R.esMejorValor?"background:rgba(46,230,168,0.06);":""}">
      ...
      <div class="auth-hint mb-12">
        Saldo base sin amortizaciones a ${c(M)}: <strong>${c(j(F))}</strong>.
      ...
      <div class="flex gap-8 mt-16" style="justify-content:flex-end">
        <button class="btn-secondary" data-opt-volver>← Cambiar parámetros</button>
        <button class="btn-secondary" data-cancelar>Cerrar</button>
      </div>`);T&&(D(T,"[data-opt-volver]",u),D(T,"[data-cancelar]",i),D(T,"[data-opt-usar]",R=>A(Number(R.getAttribute("data-opt-usar")))))}function A(m){var v;const $=e==null?void 0:e.resultados.find(x=>x.frecuencia===m);$&&(r(),f($.plan,((v=$.plan[0])==null?void 0:v.tipoAmort)||"plazo",{titulo:`✨ Plan ${$.label} · aplicado`,resumen:$,fechaObjetivo:e==null?void 0:e.fechaObjetivo}))}function f(m,$,v){if(m.length===0)return;const x=new Map;for(const w of m){const C=x.get(w.loanId)??[];C.push({_id:`${xo}${w.mes}_${w.loanId}`,fecha:w.fechaAmort,cantidad:w.cantidadAmort,tipo:$,simulacion:!0}),x.set(w.loanId,C)}let S=0;for(const w of t.loans()){const C=x.get(w._id);if(!C)continue;const z=(w.amortizaciones||[]).filter(E=>!$o(E._id));t.guardarAmortizaciones(w._id,[...z,...C]),S+=1}q(`Plan aplicado: ${m.length} amortizaciones en ${S} préstamo${S!==1?"s":""} (simulación)`),v?g(v):i(),t.refrescar([...x.keys()])}function g({titulo:m,resumen:$,fechaObjetivo:v}){const x=s(m,`
      <div class="grid-4 mb-14" style="gap:10px">
      ...
      <div style="max-height:260px;overflow-y:auto">
        <table class="table-wrap" style="width:100%">
          ...
          <tbody>${$.plan.map(S=>Io(S,!1)).join("")}</tbody>
        </table>
      </div>
      ...
      <div class="flex gap-8 mt-12" style="justify-content:flex-end">
        <button class="btn-secondary" data-cancelar>Cerrar</button>
      </div>`);x&&D(x,"[data-cancelar]",i)}return{abrir:u,get planManual(){return a},get comparativa(){return e}}}function Io(t,e){const a=t.comision>0?`<br><span style="font-size:9px;color:var(--text3)">+${c(j(t.comision))} com.</span>`:"";return`<tr>
    ...
    <div class="grid-4" style="gap:8px;font-size:12px">
  ...
  </div>`}const Si="M11.8 10.9c-2.27-.59-3-1.2-3-2.15 0-1.09 1.01-1.85 2.7-1.85 1.78 0 2.44.85 2.5 2.1h2.21c-.07-1.72-1.12-3.3-3.21-3.81V3h-3v2.16c-1.94.42-3.5 1.68-3.5 3.61 0 2.31 1.91 3.46 4.7 4.13 2.5.6 3 1.48 3 2.41 0 .69-.49 1.79-2.7 1.79-2.06 0-2.87-.92-2.98-2.1h-2.2c.12 2.19 1.76 3.42 3.68 3.83V21h3v-2.15c1.95-.37 3.5-1.5 3.5-3.55 0-2.84-2.43-3.81-4.7-4.4z";function wi(t){const e=t.hoy??J;let a=!1;const o=new Set;let n=null;const s=()=>{var v;return(v=t.onDatosCambiados)==null?void 0:v.call(t)},i=()=>t.store.get("escenarios"),r=v=>{var x;return((x=i().find(S=>S._id===v))==null?void 0:x.nombre)??v};function l(v){if(!v.activo||v.simulacion)return!1;const x=at(v).tabla.filter(S=>!S.esAmortizacion);return x.length===0?!0:x[x.length-1].fecha<e()}function u(v,x){const S=e(),w=S.slice(0,7),C=new Map;let z=0;for(const E of v){if(!E.activo||E.simulacion||x.has(E._id)||(E.fechaInicio||"")>S)continue;const F=at(E).tabla.filter(P=>!P.esAmortizacion&&P.fecha.startsWith(w)),M=F.length>0?F[0].cuota:0;C.set(E._id,M),z+=M}return{porLoan:C,total:z,activos:[...C.values()].filter(E=>E>0).length}}function b(v){const x=t.store.get("config"),S=x.dashboardStart,w=x.dashboardEnd,C=Math.max(1,(G(w).getTime()-G(S).getTime())/(30.44*864e5));let z=0;for(const E of v)!E.activo||E.simulacion||(z+=at(E).tabla.filter(F=>!F.esAmortizacion&&F.fecha>=S&&F.fecha<=w).reduce((F,M)=>F+M.cuota,0));return{media:z/C,desde:S,hasta:w}}function p(v){const x=[...t.store.get("loans")].sort((P,T)=>T.tin-P.tin),S=new Set(x.filter(l).map(P=>P._id)),w=a?x:x.filter(P=>!S.has(P._id)),C=u(x,S),z=b(x),E=t.store.get("config"),F=t.store.get("inflacion"),M=new Date(G(e())).toLocaleDateString("es-ES",{month:"long",year:"numeric"});v.innerHTML=`
      <div class="page-header">
      ...
      <div id="loans-list">
        ${w.length===0?'<div class="text-sm" style="text-align:center;padding:40px 0">Sin préstamos.</div>':w.map(P=>gi(P,{periodos:F,usarInflacion:!!E.usarInflacion,hoy:e(),cuotaMes:C.porLoan.get(P._id)??0,completado:S.has(P._id),nombreEscenario:r})).join("")}
      </div>`;for(const P of v.querySelectorAll("[data-body-loan]"))o.has(P.dataset.bodyLoan??"")&&P.classList.add("open")}const d=()=>document.getElementById("modal-overlay"),h=()=>document.getElementById("modal-content"),y=()=>{var v;return(v=d())==null?void 0:v.classList.add("hidden")};function I(v,x){const S=d(),w=h();return!S||!w?null:(w.innerHTML=`<div class="modal-title">${c(v)}</div>${x}`,S.classList.remove("hidden"),D(w,"[data-cancelar]",y),w)}function A(v,x){const S=v?t.store.get("loans").find(C=>C._id===v)??null:null,w=I(v?"Editar préstamo":"Nuevo préstamo",$i(S,t.store.get("accounts"),i(),e()));w&&(w.addEventListener("change",C=>{var z;(z=C.target)!=null&&z.matches("[data-dp-modo]")&&bo(w)}),D(w,"[data-guardar-loan]",C=>{f(w,C.getAttribute("data-guardar-loan")||"")&&(y(),x())}))}function f(v,x){const S=P=>{var T;return((T=v.querySelector(P))==null?void 0:T.value)??""},w=P=>{var T;return!!((T=v.querySelector(P))!=null&&T.checked)},C=S("#f-nombre").trim(),z=parseFloat(S("#f-capital")),E=parseFloat(S("#f-tin")),F=parseInt(S("#f-meses"),10);if(!C||!Number.isFinite(z)||!Number.isFinite(E)||!Number.isFinite(F))return q("Completa los campos obligatorios","err"),!1;const M={nombre:C,capital:z,tin:E,meses:F,fechaInicio:S("#f-fecha"),comisionApertura:parseFloat(S("#f-com-ap"))||0,comisionAmort:parseFloat(S("#f-com-am"))||0,diaPago:ho(v),cuenta:S("#f-cuenta"),simulacion:w("#f-sim"),activo:w("#f-activo"),mostrarFechaFinEnDashboard:w("#f-mostrar-fin"),tipoTasa:S("#f-tipo-tasa"),basico:w("#f-basico"),tags:S("#f-tags").split(",").map(P=>P.trim()).filter(Boolean),escenarioIds:[...v.querySelectorAll(".loan-escenario:checked")].map(P=>P.value)};return x?(t.store.updateItem("loans",x,M),q("Préstamo actualizado")):(t.store.addItem("loans",{...M,amortizaciones:[]}),q("Préstamo creado")),s(),!0}function g(v,x,S){const w=t.store.get("loans").find(E=>E._id===v);if(!w)return;const C=x?(w.amortizaciones||[]).find(E=>E._id===x)??null:null,z=I(x?"Editar amortización":"Añadir amortización",Ii(v,C,i(),e()));z&&D(z,"[data-guardar-amort]",E=>{const[F,M]=(E.getAttribute("data-guardar-amort")||"").split("|");m(z,F,M)&&(y(),S([F]))})}function m(v,x,S){var T;const w=R=>{var O;return((O=v.querySelector(R))==null?void 0:O.value)??""},C=w("#am-fecha"),z=parseFloat(w("#am-cant"));if(!C||!Number.isFinite(z)||z<=0)return q("Fecha y cantidad requeridas","err"),!1;const E=t.store.get("loans").find(R=>R._id===x);if(!E)return!1;const F={fecha:C,cantidad:z,tipo:w("#am-tipo"),simulacion:!!((T=v.querySelector("#am-sim"))!=null&&T.checked),escenarioIds:[...v.querySelectorAll(".amort-escenario:checked")].map(R=>R.value)},M=E.amortizaciones||[],P=S?M.map(R=>R._id===S?{...R,...F}:R):[...M,{_id:Date.now().toString(36),...F}];return t.store.updateItem("loans",x,{amortizaciones:P}),q(S?"Amortización actualizada":"Amortización añadida"),s(),!0}function $(v,x,S){D(v,"[data-toggle-finalizados]",()=>{a=!a,x()}),D(v,"[data-nuevo-loan]",()=>A(null,x)),D(v,"[data-optimizar]",()=>S.abrir()),D(v,"[data-toggle-loan]",(w,C)=>{var M;if((M=C.target)!=null&&M.closest("button"))return;const z=w.getAttribute("data-toggle-loan"),E=[...v.querySelectorAll("[data-body-loan]")].find(P=>P.dataset.bodyLoan===z);(E==null?void 0:E.classList.toggle("open"))?o.add(z):o.delete(z)}),D(v,"[data-editar-loan]",w=>A(w.getAttribute("data-editar-loan"),x)),D(v,"[data-borrar-loan]",w=>{if(!Z("¿Eliminar préstamo?"))return;const C=w.getAttribute("data-borrar-loan");t.store.removeItem("loans",C),o.delete(C),q("Eliminado"),s(),x()}),D(v,"[data-amort-loan]",w=>{const C=w.getAttribute("data-amort-loan");o.add(C),g(C,null,x)}),D(v,"[data-editar-amort]",w=>{const[C,z]=(w.getAttribute("data-editar-amort")||"").split("|");o.add(C),g(C,z,x)}),D(v,"[data-borrar-amort]",w=>{const[C,z]=(w.getAttribute("data-borrar-amort")||"").split("|"),E=t.store.get("loans").find(F=>F._id===C);E&&(t.store.updateItem("loans",C,{amortizaciones:(E.amortizaciones||[]).filter(F=>F._id!==z)}),q("Amortización eliminada"),s(),x([C]))})}return{id:"loans",route:"loans",nombre:"Préstamos",flagId:"loans",seccion:1,iconoPath:Si,mount(v){const x=(S=[])=>{for(const w of S)o.add(w);p(v)};n??(n=Ai({loans:()=>t.store.get("loans"),expenses:()=>t.store.get("expenses"),accounts:()=>t.store.get("accounts"),nominas:()=>t.store.get("nominas"),config:()=>t.store.get("config"),guardarAmortizaciones:(S,w)=>{t.store.updateItem("loans",S,{amortizaciones:w}),s()},hoy:e,refrescar:x})),p(v),v.dataset.wired!=="1"&&($(v,x,n),v.dataset.wired="1")}}}const Mi={transporte:125,restaurante:220,otros:null},Ci={transporte:"Transporte",restaurante:"Restaurante",otros:"Otros"},ji=["Enero","Febrero","Marzo","Abril","Mayo","Junio","Julio","Agosto","Septiembre","Octubre","Noviembre","Diciembre"],kt=(t,e,a,o,n="")=>`<div class="form-group"><label class="form-label">${c(e)}</label>
   <input class="form-input" type="${a}" id="${t}" value="${c(o)}" placeholder="${c(n)}"/></div>`,zi=(t,e)=>t.filter(a=>a.activo!==!1).map(a=>`<option value="${c(a._id)}"${a._id===e?" selected":""}>${c(a.nombre)}</option>`).join("");function Ei(t,e){const a=t.map((s,i)=>{const r=e.find(b=>b._id===s.cuenta),l=Mi[s.tipo],u=l!=null&&s.importe>l;return`<div class="flex gap-8 items-center" style="padding:5px 0;border-bottom:1px solid var(--border)">
    ...
    <button class="btn-secondary btn-sm mt-6" data-flex-anadir>+ Añadir componente</button>`}function Fi(t,e){const a=e.hoy??J(),o=(t==null?void 0:t.nPagas)??12,n=[12,14,16].includes(o);return`
    <div class="grid-2">
    ...
    <div class="grid-2 mt-8">
      ...
      <div class="form-group"><label class="form-label">Cuenta</label>
        <select class="form-select" id="nf-cuenta">${zi(e.accounts,(t==null?void 0:t.cuenta)??e.cuentaPrincipal)}</select></div>
    </div>
        ...
        <div class="grid-2 mt-8">
          ...
          <div class="form-group"><label class="form-label">Mes actualización IPC (opcional)</label>
            <select class="form-select" id="nf-mes-ipc">
              ...
              ${ji.map((s,i)=>`<option value="${i+1}"${(t==null?void 0:t.mesActualizacionIPC)===i+1?" selected":""}>${c(s)} (${i+1})</option>`).join("")}
            </select>
          </div>
        </div>
        <div class="grid-2 mt-8">
    ...
    <div style="margin-top:8px;display:grid;grid-template-columns:1fr 1fr;gap:4px">
    ...
    </div>${I}`}function Pi(t,e,a,o){const n=()=>{const r=t.querySelector("#flex-comp-container");r&&(r.innerHTML=Ei(e,a.accounts))},s=()=>{const r=t.querySelector("#nf-preview");r&&(r.innerHTML=_i(t,e,a,o))},i=()=>{var l,u;const r=(b,p)=>{const d=t.querySelector(b);d&&(d.style.display=p?"":"none")};r("#nf-custom-pagas-wrap",((l=t.querySelector("#nf-npagas"))==null?void 0:l.value)==="custom"),r("#nf-irpfpct-wrap",((u=t.querySelector("#nf-irpfmodo"))==null?void 0:u.value)==="manual"),s()};t.addEventListener("input",r=>{var l;(l=r.target)!=null&&l.closest("#nf-bruto, #nf-irpfpct, #nf-npagas-custom, #nf-grupo, #nf-sspct")&&s()}),Y(t,"#nf-npagas, #nf-irpfmodo, #nf-representacion",i),D(t,"[data-flex-anadir]",()=>{var u,b,p;const r=((u=t.querySelector("#fc-tipo"))==null?void 0:u.value)||"transporte",l=parseFloat(((b=t.querySelector("#fc-importe"))==null?void 0:b.value)??"")||0;if(!l)return q("Importe requerido","err");e.push({_id:Date.now().toString(36),tipo:r,importe:l,cuenta:((p=t.querySelector("#fc-cuenta"))==null?void 0:p.value)||""}),n(),s()}),D(t,"[data-flex-borrar]",r=>{e.splice(Number(r.getAttribute("data-flex-borrar")),1),n(),s()}),n(),s()}const wo=t=>t.slice(0,3).map(([,e])=>`${e}%`).join(" · ")+(t.length>3?" …":"");function Ti(t){let e=null,a=[];const o=()=>document.getElementById("modal-overlay"),n=()=>document.getElementById("modal-content"),s=()=>{var d;return(d=o())==null?void 0:d.classList.add("hidden")},i=()=>t.store.get("config").tramos_irpf??gt;function r(d,h){const y=o(),I=n();return!y||!I?null:(I.innerHTML=`<div class="modal-title">${c(d)}</div>${h}`,y.classList.remove("hidden"),D(I,"[data-cerrar]",s),I)}function l(){e=null;const d=[...t.store.get("tramosIRPFHistorico")].sort((I,A)=>I.año-A.año),h="display:grid;grid-template-columns:90px 1fr auto;gap:0;padding:10px 12px;border-top:1px solid var(--border);align-items:center",y=r("Tramos IRPF por ejercicio",`
      <div class="text-sm mb-12" style="color:var(--text2)">
      ...
      <div style="border:1px solid var(--border);border-radius:var(--radius);overflow:hidden;margin-bottom:14px">
        ...
        <div style="${h}">
          ...
          <span class="text-sm" style="color:var(--text2)">${c(wo(i()))}</span>
        ...
        ${d.map(I=>`<div style="${h}">
              ...
              <span class="text-sm" style="color:var(--text2)">${c(wo(I.tramos))}</span>
      ...
      </div>`);if(!A)return;const f=()=>{const m=A.querySelector("#irpf-tramos-rows");m&&(m.innerHTML=u())};D(A,"[data-volver]",l),D(A,"[data-tr-anadir]",()=>{b(A),a.push([0,0]),f()}),D(A,"[data-tr-borrar]",m=>{b(A),a.splice(Number(m.getAttribute("data-tr-borrar")),1),f()}),D(A,"[data-tr-guardar]",()=>{b(A);const m=[...a].sort(($,v)=>$[0]-v[0]);if(m.length===0)return q("Añade al menos un tramo","err");e==="default"?(t.store.patchConfig({tramos_irpf:m}),q("Tabla por defecto guardada")):(t.store.set("tramosIRPFHistorico",t.store.get("tramosIRPFHistorico").map($=>$.año===e?{...$,tramos:m}:$)),q(`Tabla ${e} guardada`)),t.onDatosCambiados(),l()})}return{abrir:l}}const Mo=1500,_t=(t,e,a,o,n="")=>`<div class="form-group"><label class="form-label">${c(e)}</label>
   <input class="form-input" type="${a}" id="${t}" value="${c(o)}" placeholder="${c(n)}"/></div>`,Di=(t,e,a,o)=>`<div class="form-group"><label class="form-label">${c(e)}</label>
   <select class="form-select" id="${t}">
     ${a.map(([n,s])=>`<option value="${c(n)}"${n===o?" selected":""}>${c(s)}</option>`).join("")}
   </select></div>`,Ri=t=>(t.modeloFondo||"cuenta")==="pension";function Ni(t,e,a,o){return t.length===0?`<div class="card text-sm" style="padding:24px;text-align:center;color:var(--text2)">
      Sin planes de pensiones. Crea uno con el botón "+ Nuevo plan de pensiones".
    </div>`:`<div class="grid-3">${t.map(n=>Oi(n,e,a,o)).join("")}</div>`}function Oi(t,e,a,o){const n=ue(t);if(!n)return"";const s=_e(t,e,a),i=o.slice(0,4),r=(t.aportaciones||[]).filter(u=>u.fecha>=`${i}-01-01`).reduce((u,b)=>u+b.cantidad,0),l=Math.min(r,Mo)*(s/100);return`<div class="card">
    ...
    <div style="margin-top:10px;padding:8px;background:var(--bg3);border-radius:var(--radius);border:1px solid var(--border)">
      ...
      <div class="flex justify-between mb-4"><span class="text-sm" style="color:var(--text2)">Aportado</span><span class="num ${r>Mo?"neg":""}">${c(j(r))}</span></div>
  ...
  </div>`}function qi(t){return`<div>${t.map((a,o)=>`<div class="flex gap-8 items-center" style="padding:4px 0;border-bottom:1px solid var(--border)">
    ...
    <button class="btn-secondary btn-sm mt-6" data-aport-anadir>+ Añadir aportación</button>`}function Li(t,e){const a=[...(t==null?void 0:t.historicoSaldos)??[]].sort((i,r)=>r.fecha.localeCompare(i.fecha)),o=a[0]?a[0].saldo:(t==null?void 0:t.saldo)??0,n=[...new Set(e.nominas.filter(i=>i.grupoNomina).map(i=>i.grupoNomina))],s=!!(t!=null&&t.grupoNomina);return`
    <div class="grid-2">
    ...
    <div class="grid-2 mt-8">
      ...
      ${Di("pen-periodo","Capitalización",[["diario","Diario"],["mensual","Mensual"],["anual","Anual"]],(t==null?void 0:t.periodoCobro)??"mensual")}
    </div>
    <div class="grid-2 mt-8">
    ...
    <div class="flex gap-8 mt-16" style="justify-content:flex-end">
    ...
    </div>`}const s=A=>{var f;return((f=t.store.get("accounts").find(g=>g._id===(A||"default")))==null?void 0:f.nombre)??(A||"default")};function i(A,f,g){const m=f.reduce((x,S)=>x+(S.bruto||0),0),$=ds(f,g),v=m>0?$/m*100:0;return`<div style="margin-bottom:16px">
    ...
    </div>`}function r(A){const f=o(),g=[...t.store.get("nominas")].sort((S,w)=>(w.bruto||0)-(S.bruto||0)),{grupos:m,sueltas:$}=ps(g),v=t.store.get("accounts").filter(Ri),x=g.filter(S=>S.activo!==!1);A.innerHTML=`
      <div class="page-header">
      ...
      <div>${Ni(v,x,f,e())}</div>`}const l=()=>document.getElementById("modal-overlay"),u=()=>document.getElementById("modal-content"),b=()=>{var A;return(A=l())==null?void 0:A.classList.add("hidden")};function p(A,f){const g=l(),m=u();return!g||!m?null:(m.innerHTML=`<div class="modal-title">${c(A)}</div>${f}`,g.classList.remove("hidden"),D(m,"[data-cancelar]",b),m)}function d(A,f){const g=A?t.store.get("nominas").find(x=>x._id===A)??null:null,m=[...(g==null?void 0:g.retribucionFlexible)??[]].map(x=>({...x})),$={accounts:t.store.get("accounts"),escenarios:t.store.get("escenarios"),nominas:t.store.get("nominas"),cuentaPrincipal:t.store.getPrincipalAccountId(),tramos:o(),hoy:e()},v=p(A?"Editar nómina":"Nueva nómina",Fi(g,$));v&&(Pi(v,m,$,A??""),D(v,"[data-guardar-nomina]",x=>{const S=So(v,m);if(!S.nombre||S.bruto<=0)return q("Nombre y bruto anual son obligatorios","err");const w=x.getAttribute("data-guardar-nomina")||"",C={...S,activo:!0,tags:["nomina"]};w?(t.store.updateItem("nominas",w,C),q("Nómina actualizada")):(t.store.addItem("nominas",C),q("Nómina creada")),a(),b(),f()}))}function h(A,f){const g=A?t.store.get("accounts").find(v=>v._id===A)??null:null,m=[...(g==null?void 0:g.planAportaciones)??[]].map(v=>({...v})),$=p(A?"Editar plan de pensiones":"Nuevo plan de pensiones",Li(g,{nominas:t.store.get("nominas"),escenarios:t.store.get("escenarios"),hoy:e()}));$&&(ki($,m,e()),D($,"[data-guardar-pension]",v=>{const{datos:x,error:S}=Bi($,m,g,e());if(S)return q(S,"err");const w=v.getAttribute("data-guardar-pension")||"";w?(t.store.updateItem("accounts",w,x),q("Plan actualizado")):(t.store.addItem("accounts",x),q("Plan creado")),a(),b(),f()}))}function y(A,f,g){D(A,"[data-nueva-nomina]",()=>d(null,f)),D(A,"[data-editar-nom]",m=>d(m.getAttribute("data-editar-nom"),f)),D(A,"[data-borrar-nom]",m=>{Z("¿Eliminar esta nómina?")&&(t.store.removeItem("nominas",m.getAttribute("data-borrar-nom")),q("Eliminada"),a(),f())}),Y(A,"[data-activo-nom]",m=>{const $=m;t.store.updateItem("nominas",$.getAttribute("data-activo-nom"),{activo:$.checked}),a(),f()}),D(A,"[data-tramos]",()=>g.abrir()),D(A,"[data-nueva-pension]",()=>h(null,f)),D(A,"[data-editar-pension]",m=>h(m.getAttribute("data-editar-pension"),f)),D(A,"[data-borrar-pension]",m=>{Z("¿Eliminar este plan de pensiones?")&&(t.store.removeItem("accounts",m.getAttribute("data-borrar-pension")),q("Plan eliminado"),a(),f())})}let I=null;return{id:"nominas",route:"nominas",nombre:"Nóminas",flagId:"nominas",seccion:1,iconoPath:Hi,mount(A){const f=()=>r(A);I??(I=Ti({store:t.store,onDatosCambiados:()=>{a(),f()},año:()=>Number(e().slice(0,4))})),r(A),A.dataset.wired!=="1"&&(y(A,f,I),A.dataset.wired="1")}}}const Vi="M3 17.25V21h3.75L17.81 9.94l-3.75-3.75L3 17.25zM20.71 7.04c.39-.39.39-1.02 0-1.41l-2.34-2.34c-.39-.39-1.02-.39-1.41 0l-1.83 1.83 3.75 3.75 1.83-1.83z",Ui="M13 3c-4.97 0-9 4.03-9 9H1l3.89 3.89.07.14L9 12H6c0-3.87 3.13-7 7-7s7 3.13 7 7-3.13 7-7 7c-1.93 0-3.68-.79-4.94-2.06l-1.42 1.42C8.27 19.99 10.51 21 13 21c4.97 0 9-4.03 9-9s-4.03-9-9-9zm-1 5v5l4.28 2.54.72-1.21-3.5-2.08V8H12z",Co={transporte:{label:"Transporte",limiteAnual:1500},restaurante:{label:"Restaurante",limiteAnual:2640},otros:{label:"Otros",limiteAnual:null}},Yi={entradas:[],salidas:[],totalAportaciones:0,totalReembolsos:0,retencion:0};function Ji(t,e){const a=t.filter(l=>l.activo&&mt(l)==="inversion");if(a.length===0)return"";let o=0,n=0,s=0,i=0;for(const l of a){const u=Rt(l,e);u&&(o+=u.saldo,n+=u.costBase,s+=u.plusvalia,i+=u.impuesto)}const r=n>0?(s/n*100).toFixed(1):"0";return`
    ...
    </div>`}function Wi(t,e){if(!t.activo||!t.interes||t.interes<=0)return"";const{dashboardStart:a,dashboardEnd:o}=e.config,n=Math.max(1,(G(o).getTime()-G(a).getTime())/(30.44*864e5)),s=Vt(t,a),i=s*(Math.pow(1+t.interes/100,n/12)-1);let r="";if(e.config.usarInflacion&&e.inflacion.length>0){const l=s*(pt(e.inflacion,a,o)-1),u=i-l;r=`
  ...
  </div>`}function Qi(t,e){const a=Co[t.tipoBeneficio??""]??{label:"Beneficio",limiteAnual:null},{limiteAnual:o}=a,n=e.nominas.flatMap(h=>(h.retribucionFlexible??[]).filter(y=>y.cuenta===t._id).map(y=>({nomina:h,importe:y.importe}))),s=n.reduce((h,y)=>h+y.importe,0),i=s*12,r=o!==null&&i>o,l=o!==null?Math.min(i,o):i,u=t.grupoNomina?e.nominas.filter(h=>(h.grupoNomina||"")===t.grupoNomina&&h.activo!==!1):n.slice(0,1).map(h=>h.nomina),b=Sa(u,e.tramosIRPF),p=l*b/100,d=t.grupoNomina?`grupo "${t.grupoNomina}", tipo marginal ${b}%`:`tipo marginal ${b}%`;return`<div style="margin-top:10px;padding:10px;background:var(--bg3);border-radius:var(--radius);border:1px solid rgba(99,214,160,0.35)">
  ...
  </div>`}function Ki(t){const e=ue(t);return e?`<div style="margin-top:10px;padding:10px;background:var(--bg3);border-radius:var(--radius);border:1px solid var(--yellow-dark, #7a6010)">
  ...
  </div>`:""}function Xi(t,e){const a=Rt(t,e.tramosGanancias);if(!a)return"";const o=e.config,n=e.flujos(t._id),s=G(o.dashboardStart),i=G(o.dashboardEnd),r=Math.max(0,(i.getTime()-s.getTime())/(30.44*864e5)),l=a.saldo+n.totalAportaciones-n.totalReembolsos,u=t.interes>0?Math.pow(1+t.interes/100,1/12)-1:0,b=l>0&&r>0?Math.max(0,l*Math.pow(1+u,r)):Math.max(0,l),p=a.costBase+n.totalAportaciones,d=Math.max(0,b-p),h=Fe(d,e.tramosGanancias),y=d>0?(h/d*100).toFixed(1):"0",I=t.interes>0?`${t.interes}% anual`:"sin rentabilidad",A=a.saldo>0?(a.plusvalia/a.saldo*100).toFixed(1):"0",f=(S,w,C)=>S.map(z=>`<div class="flex justify-between mt-4">
          <span class="text-sm" style="color:var(--text2)">${w} ${c(z.contraparte)}: ${c(z.concepto)}</span>
    ...
    <div class="flex justify-between items-center mb-12">
      ...
      <div class="flex gap-8">
        ...
        <button class="btn-icon" data-hist-acc="${c(t._id)}" title="Histórico de saldos"><svg viewBox="0 0 24 24"><path d="${Ui}"/></svg></button>
        <button class="btn-icon" data-editar-acc="${c(t._id)}" title="Editar"><svg viewBox="0 0 24 24"><path d="${Vi}"/></svg></button>
    ...
    <button class="btn-secondary btn-sm mt-6" data-aport-anadir>+ Añadir aportación</button>`}function ar(t,e){const a=t?mt(t):"cuenta",o=[...new Set(e.nominas.filter(s=>s.grupoNomina).map(s=>s.grupoNomina))],n=s=>s?"":' style="display:none"';return`
    <div class="grid-2">
      ${tt("ac-nombre","Nombre","text",(t==null?void 0:t.nombre)??"","Ej: Cuenta ING, Fondo Vanguard")}
      ${Lt("ac-modelo","Tipo",tr,a)}
    </div>
    <div class="grid-2 mt-8">
    ...
    <div class="flex gap-8 mt-12" style="justify-content:flex-end">
    ...
    </div>`}const jo=t=>t.slice(0,3).map(([,e])=>`${e}%`).join(" · ")+(t.length>3?" …":"");function ir(t){let e=null,a=[];const o=()=>document.getElementById("modal-overlay"),n=()=>document.getElementById("modal-content"),s=()=>{var d;return(d=o())==null?void 0:d.classList.add("hidden")},i=()=>t.store.get("config").tramosGananciasCapital??jt;function r(d,h){const y=o(),I=n();return!y||!I?null:(I.innerHTML=`<div class="modal-title">${c(d)}</div>${h}`,y.classList.remove("hidden"),D(I,"[data-cerrar]",s),I)}function l(){e=null;const d=[...t.store.get("tramosGananciasCapitalHistorico")].sort((I,A)=>I.año-A.año),h="display:grid;grid-template-columns:90px 1fr auto;gap:0;padding:10px 12px;border-top:1px solid var(--border);align-items:center",y=r("Tramos — Ganancias de capital",`
      <div class="text-sm mb-12" style="color:var(--text2)">
      ...
      </div>`);if(!I)return;const A=()=>{const g=I.querySelector("#tg-rows");g&&(g.innerHTML=u())};D(I,"[data-volver-tg]",l),D(I,"[data-tg-anadir]",()=>{b(I),a.push([0,0]),A()}),D(I,"[data-tg-borrar]",g=>{b(I),a.splice(Number(g.getAttribute("data-tg-borrar")),1),A()}),D(I,"[data-tg-guardar]",()=>{b(I);const g=[...a].sort((m,$)=>m[0]-$[0]);if(g.length===0)return q("Añade al menos un tramo","err");e==="default"?(t.store.patchConfig({tramosGananciasCapital:g}),q("Tabla por defecto guardada")):(t.store.set("tramosGananciasCapitalHistorico",t.store.get("tramosGananciasCapitalHistorico").map(m=>m.año===e?{...m,tramos:g}:m)),q(`Tabla ${e} guardada`)),t.onDatosCambiados(),l()})}return{abrir:l}}function rr(t){function e(){if(t.navegar)return t.navegar("planner");const s=globalThis.Router;s==null||s.navigate("planner")}function a(s,i,r){const l=ha(s,i,r),u=s.targetAmount||0,b=u>0?Math.min(100,l/u*100):0;return`
      ...
      </div>`}function n(s,i){D(s,"[data-ir-planner]",()=>e()),D(s,"[data-descartar-goals]",()=>{const r=t.store.get("goals").length;if(Z(`Se van a borrar ${r} objetivo${r!==1?"s":""} de ahorro antiguos. ¿Seguro?`)){for(const l of[...t.store.get("goals")])t.store.removeItem("goals",l._id);q("Objetivos antiguos descartados"),t.onDatosCambiados(),i()}})}return{render:o,wire:n}}const lr="M11.8 10.9c-2.27-.59-3-1.2-3-2.15 0-1.09 1.01-1.85 2.7-1.85 1.78 0 2.44.85 2.5 2.1h2.21c-.07-1.72-1.12-3.3-3.21-3.81V3h-3v2.16c-1.94.42-3.5 1.68-3.5 3.61 0 2.31 1.91 3.46 4.7 4.13 2.5.6 3 1.48 3 2.41 0 .69-.49 1.79-2.7 1.79-2.06 0-2.87-.92-2.98-2.1h-2.2c.12 2.19 1.76 3.42 3.68 3.83V21h3v-2.15c1.95-.37 3.5-1.5 3.5-3.55 0-2.84-2.43-3.81-4.7-4.4z",cr=120;function dr(t){const e=t.hoy??J,a=()=>{var F;return(F=t.onDatosCambiados)==null?void 0:F.call(t)},o=t.mostrarObjetivos??(()=>!0),n=new Map,s=()=>t.store.get("config"),i=()=>t.store.get("escenarios"),r=F=>{var M;return((M=i().find(P=>P._id===F))==null?void 0:M.nombre)??F},l=F=>{var M;return((M=t.store.get("accounts").find(P=>P._id===F))==null?void 0:M.nombre)??F},u=()=>bt(t.store.get("tramosIRPFHistorico"),s().tramos_irpf??gt)(Number(e().slice(0,4))),b=()=>bt(t.store.get("tramosGananciasCapitalHistorico"),s().tramosGananciasCapital??jt),p=()=>b()(Number(e().slice(0,4))),d=F=>qa(t.store.get("expenses"),s(),t.store.get("loans"),F);function h(){const F=s(),M=t.store.get("accounts"),P=Jt({loans:[],expenses:t.store.get("expenses").filter(k=>k.tipo==="transferencia"),accounts:M,config:{dashboardStart:F.dashboardStart,dashboardEnd:F.dashboardEnd,fechaReferencia:F.dashboardStart},nominas:[],resolverTramosGanancias:b()}),T=new Map,R=k=>{let L=T.get(k);return L||(L={entradas:[],salidas:[],totalAportaciones:0,totalReembolsos:0,retencion:0},T.set(k,L)),L},O=(k,L)=>{const B=`${L.sourceId}`,N=k.find(U=>U.concepto===B),H=N??{concepto:B,contraparte:"",total:0,ocurrencias:0};H.total+=Math.abs(L.cuantia),H.ocurrencias+=1,N||k.push(H)};for(const k of P){if(!k.cuenta)continue;const L=R(k.cuenta);k.sourceType==="transfer-in"||k.sourceType==="traspaso-in"?(L.totalAportaciones+=Math.abs(k.cuantia),O(L.entradas,k)):k.sourceType==="transfer-out"||k.sourceType==="traspaso-out"?(L.totalReembolsos+=Math.abs(k.cuantia),O(L.salidas,k)):k.sourceType==="investment-tax"&&(L.retencion+=Math.abs(k.cuantia))}const _=t.store.get("expenses");for(const k of T.values())for(const[L,B]of[[k.entradas,"cuenta"],[k.salidas,"cuentaDestino"]])for(const N of L){const H=_.find(U=>U._id===N.concepto);N.contraparte=l((H==null?void 0:H[B])??"default"),N.concepto=(H==null?void 0:H.concepto)||(B==="cuenta"?"Aportación":"Reembolso")}return T}function y(){const F=new Map,M=s(),P=e(),T=new Date(Number(P.slice(0,4)),Number(P.slice(5,7))-1+cr+1,0),R=`${T.getFullYear()}-${String(T.getMonth()+1).padStart(2,"0")}-${String(T.getDate()).padStart(2,"0")}`;return O=>{const _=F.get(O._id);if(_)return _;const k=Jt({loans:t.store.get("loans"),expenses:t.store.get("expenses"),accounts:t.store.get("accounts"),config:{...M,dashboardStart:P,dashboardEnd:R,fechaReferencia:P},filtroAccounts:[O._id],nominas:t.store.get("nominas"),inflacionPeriodos:t.store.get("inflacion"),resolverTramosIRPF:bt(t.store.get("tramosIRPFHistorico"),M.tramos_irpf??gt),resolverTramosGanancias:b()}).map(L=>({fecha:L.fecha,saldoAcum:L.saldoAcum}));return F.set(O._id,k),k}}const I=rr({store:t.store,colchonEnFecha:d,extractoCuenta:F=>A(F),hoy:e,onDatosCambiados:a});let A=y();function f(F){A=y();const P=t.store.get("accounts").filter(_=>mt(_)!=="pension"),T=h(),R={config:s(),inflacion:t.store.get("inflacion"),nominas:t.store.get("nominas"),tramosIRPF:u(),tramosGanancias:p(),nombreEscenario:r,flujos:_=>T.get(_)??Yi,invModo:_=>n.get(_)??"proyeccion"};F.innerHTML=`
      <div class="page-header">
      ...
      ${Ji(P,R.tramosGanancias)}
      <div class="grid-3">${P.map(_=>Zi(_,R)).join("")}</div>
      ${o()?'<div class="card mt-14" id="goals-section"></div>':""}`;const O=F.querySelector("#goals-section");O&&I.render(O)}const g=()=>document.getElementById("modal-overlay"),m=()=>document.getElementById("modal-content"),$=()=>{var F;return(F=g())==null?void 0:F.classList.add("hidden")};function v(F,M){const P=g(),T=m();return!P||!T?null:(T.innerHTML=F?`<div class="modal-title">${c(F)}</div>${M}`:M,P.classList.remove("hidden"),D(T,"[data-cancelar]",$),T)}function x(F,M){const P=F?t.store.get("accounts").find(_=>_._id===F)??null:null,T=[...(P==null?void 0:P.planAportaciones)??[]].map(_=>({..._})),R=P?S(P):null,O=v(F?"Editar cuenta / fondo":"Nueva cuenta / fondo",ar(P,{escenarios:i(),nominas:t.store.get("nominas"),hoy:e(),saldoActual:R??0}));O&&(or(O,T,e()),D(O,"[data-guardar-acc]",_=>{const k=_.getAttribute("data-guardar-acc")||"",{datos:L,punto:B,error:N}=sr(O,T,P,R,e());if(N)return q(N,"err");let H=k;k?t.store.updateItem("accounts",k,L):H=t.store.addItem("accounts",L)._id,B&&t.ledger.registrarPuntoControl(H,B.fecha,B.saldo,B.nota),q(k?"Actualizada":"Cuenta / fondo creado"),a(),$(),M()}))}function S(F){const M=t.ledger.puntosControl(F._id);return M.length>0?aa(M)[0].saldo:F.saldo??null}function w(F,M){const P=t.store.get("accounts").find(O=>O._id===F);if(!P)return;const T=v("Histórico de saldos",nr(P.nombre,F,aa(t.ledger.puntosControl(F)),P.saldoInicial||0,e()));if(!T)return;const R=()=>{M(),w(F,M)};D(T,"[data-hist-anadir]",()=>{var L,B,N;const O=((L=T.querySelector("#hi-fecha"))==null?void 0:L.value)??"",_=parseFloat(((B=T.querySelector("#hi-saldo"))==null?void 0:B.value)??""),k=((N=T.querySelector("#hi-nota"))==null?void 0:N.value.trim())??"";if(!O||!Number.isFinite(_))return q("Fecha y saldo requeridos","err");t.ledger.registrarPuntoControl(F,O,_,k||void 0),q("Punto añadido"),a(),R()}),D(T,"[data-hist-borrar]",O=>{const[,_]=(O.getAttribute("data-hist-borrar")||"").split("|");t.ledger.eliminarPuntoControl(_),q("Eliminado"),a(),R()}),D(T,"[data-hist-inicial]",O=>{const[_,k]=(O.getAttribute("data-hist-inicial")||"").split("|"),L=t.ledger.puntosControl(_).find(N=>N._id===k);if(!L)return;const B=aa([L])[0].saldo;t.store.updateItem("accounts",_,{saldoInicial:B,fechaInicialSaldo:L.fecha}),q(`Punto inicial → ${L.fecha} (${j(B)})`),a(),R()})}function C(F){const M=t.store.get("accounts").filter(R=>R.activo);if(M.length===0)return q("No hay cuentas activas","err");const P=e(),T=M.map(R=>`• ${R.nombre}: ${j(S(R)??R.saldoInicial??0)}`).join(`
`);if(Z(`¿Actualizar el saldo inicial de estas cuentas a su saldo actual (${P})?

${T}

Esto recalibra el punto de arranque del dashboard.`)){for(const R of M)t.store.updateItem("accounts",R._id,{saldoInicial:S(R)??R.saldoInicial??0,fechaInicialSaldo:P});q("Saldo base actualizado"),a(),F()}}function z(F,M,P){D(F,"[data-nueva-acc]",()=>x(null,M)),D(F,"[data-editar-acc]",T=>x(T.getAttribute("data-editar-acc"),M)),D(F,"[data-tramos-ganancias]",()=>P.abrir()),D(F,"[data-reset-base]",()=>C(M)),D(F,"[data-hist-acc]",T=>w(T.getAttribute("data-hist-acc"),M)),D(F,"[data-principal-acc]",T=>{const R=T.getAttribute("data-principal-acc");t.store.set("accounts",t.store.get("accounts").map(O=>({...O,esCuentaPrincipal:O._id===R}))),q("Cuenta marcada como principal"),a(),M()}),D(F,"[data-borrar-acc]",T=>{const R=T.getAttribute("data-borrar-acc");if(t.store.get("accounts").length<=1)return q("Debe existir al menos una cuenta","err");if(!Z("¿Eliminar cuenta?"))return;t.store.removeItem("accounts",R);const _=t.store.get("accounts");_.length>0&&!_.some(k=>k.esCuentaPrincipal)&&t.store.set("accounts",_.map((k,L)=>L===0?{...k,esCuentaPrincipal:!0}:k)),q("Cuenta eliminada"),a(),M()}),D(F,"[data-inv-modo]",T=>{const[R,O]=(T.getAttribute("data-inv-modo")||"").split("|");n.set(R,O==="real"?"real":"proyeccion"),M()}),I.wire(F,M)}let E=null;return{id:"accounts",route:"accounts",nombre:"Cuentas y ahorro",flagId:"accounts",seccion:1,iconoPath:lr,mount(F){const M=()=>f(F);E??(E=ir({store:t.store,onDatosCambiados:()=>{a(),M()},año:()=>Number(e().slice(0,4))})),f(F),F.dataset.wired!=="1"&&(z(F,M,E),F.dataset.wired="1")}}}const ot=(t,e,a="var(--text)",o=!1)=>`<tr>
  ...
  </div>`;function ur(t){const e=t.extras,a=t.nominas.length===0?`<div class="auth-hint mb-12" style="border-color:var(--yellow)">
  ...
  </table>`}const pr=(t,e,a)=>`<div class="card" style="text-align:center;padding:48px">
    ...
    </div>`}function fr(t){const{nominas:e,planes:a,tramos:o}=t,n=h=>h.grupoNomina?e.filter(y=>(y.grupoNomina||"")===h.grupoNomina):null,s=e.map(h=>({n:h,d:De(h,n(h),o)})),i=s.reduce((h,y)=>h+y.d.brutoAnual,0),r=s.reduce((h,y)=>h+y.d.irpfAnual,0),l=s.reduce((h,y)=>h+y.d.ssAnual,0),u=s.length===0?'<div class="text-sm" style="color:var(--text3);padding:12px 0">Sin nóminas activas. Configúralas en el módulo <strong>Nóminas</strong>.</div>':s.map(({n:h,d:y})=>`
        <div class="card">
    ...
    </div>`}const Fo=[["declaracion","Declaración Renta"],["mobiliario","Capital Mobiliario"],["trabajo","Rendimientos del Trabajo"],["inmobiliario","Capital Inmobiliario"]],gr="M14 2H6c-1.1 0-2 .9-2 2v16c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V8l-6-6zm4 18H6V4h7v5h5v11zM8 15h8v2H8v-2zm0-4h8v2H8v-2zm0-4h4v2H8V7z";function br(t){const e=t.hoy??J;let a="declaracion",o={};const n=()=>t.store.get("config"),s=()=>Number(e().slice(0,4)),i=()=>t.store.get("nominas").filter(g=>g.activo),r=()=>t.store.get("accounts").filter(g=>(g.modeloFondo||"cuenta")==="pension"),l=g=>{var m;return((m=t.store.get("escenarios").find($=>$._id===g))==null?void 0:m.nombre)??g},u=()=>bt(t.store.get("tramosIRPFHistorico"),n().tramos_irpf??gt)(s()),b=()=>bt(t.store.get("tramosGananciasCapitalHistorico"),n().tramosGananciasCapital??jt)(s());function p(){const g=`${s()}-01-01`,m=t.store.get("nominas").filter(x=>x.activo&&!x.simulacion),$=r().reduce((x,S)=>x+(S.aportaciones||[]).filter(w=>w.fecha>=g).reduce((w,C)=>w+C.cantidad,0),0),v=t.store.get("expenses").filter(x=>x.activo&&x.sujetoIRPF&&x.tipo==="ingreso").reduce((x,S)=>x+wa(S),0);return Ca({nominas:m,aportacionesPension:$,otrosIngresos:v,extras:o,tramosGeneral:u(),tramosAhorro:b()})}function d(){const g=u(),m=i(),$=M=>M.grupoNomina?m.filter(P=>(P.grupoNomina||"")===M.grupoNomina):null,v=m.map(M=>De(M,$(M),g)),x=v.reduce((M,P)=>M+P.brutoAnual,0),S=v.reduce((M,P)=>M+P.irpfAnual,0),w=v.reduce((M,P)=>M+P.ssAnual,0),C=t.store.get("accounts").filter(M=>(M.modeloFondo||"cuenta")==="inversion");let z=0,E=0;for(const M of C){const P=Rt(M,b());P&&(z+=P.plusvalia,E+=P.impuesto)}if(x<=0&&C.length===0)return"";const F=(M,P,T)=>`<div class="exec-item"><div class="exec-item-label">${c(M)}</div><div class="exec-item-val ${T}">${c(P)}</div></div>`;return`<div class="exec-summary mb-14">
      ${x>0?F("IRPF trabajo",`${j(S)}/año`,"neg"):""}
      ${x>0?F("Neto trabajo",`${j(x-w-S)}/año`,"pos"):""}
      ${C.length>0?F("Plusvalía latente",j(z),z>=0?"pos":"neg"):""}
      ${C.length>0?F("Imp. potencial (inversión)",j(E),"neg"):""}
    </div>`}function h(){return a==="mobiliario"?mr(t.store.get("accounts"),b(),l):a==="trabajo"?fr({nominas:i(),planes:r(),tramos:u(),hoy:e()}):a==="inmobiliario"?vr():ur({año:s(),extras:o,declaracion:p(),nominas:i().map(g=>({nombre:g.nombre,bruto:g.bruto||0})),planes:r().map(g=>g.nombre)})}function y(g,m){const $=a===g;return`<button data-tab-fisc="${g}" style="
    ...
    ">${c(m)}</button>`}function I(g){const m=g.querySelector("#fisc-tabs"),$=g.querySelector("#fisc-tab-content");m&&(m.innerHTML=Fo.map(([v,x])=>y(v,x)).join("")),$&&($.innerHTML=h())}function A(g){g.innerHTML=`
      ...
      <div id="fisc-tab-content">${h()}</div>`}function f(g){D(g,"[data-tab-fisc]",m=>{a=m.getAttribute("data-tab-fisc")||"declaracion",I(g)}),g.addEventListener("input",m=>{var S;if(!((S=m.target)==null?void 0:S.closest("[data-rex]")))return;const v=w=>{var C;return((C=g.querySelector(`#${w}`))==null?void 0:C.value)??"0"};o={capInmobiliario:parseFloat(v("rex-inmobiliario"))||0,capMobiliario:parseFloat(v("rex-mobiliario"))||0,gananciasFondos:parseFloat(v("rex-ganancias"))||0,otrasCorto:parseFloat(v("rex-otras"))||0,retCapital:parseFloat(v("rex-ret-cap"))||0};const x=g.querySelector("#renta-cuadro");x&&(x.innerHTML=zo(p()))})}return{id:"fiscalidad",route:"rentas",nombre:"Fiscalidad",flagId:"fiscalidad",seccion:2,iconoPath:gr,mount(g){A(g),g.dataset.wired!=="1"&&(f(g),g.dataset.wired="1")}}}const _o=()=>globalThis.Chart??null;function hr(t,e){const a=_o();if(!a)return null;const o=e.map(n=>({label:n.label,data:n.puntos.map(s=>({x:s.x,y:s.y})),borderColor:n.esBase?"#6b7280":n.color,backgroundColor:n.esBase?"transparent":`${n.color}18`,borderWidth:n.esBase?1.5:2,...n.esBase?{borderDash:[4,3]}:{fill:!1},pointRadius:2,tension:.3}));return new a(t,{type:"line",data:{datasets:o},options:{responsive:!0,interaction:{mode:"index",intersect:!1},plugins:{legend:{labels:{color:"var(--text2)",font:{size:11}}},tooltip:{callbacks:{label:n=>`${n.dataset.label}: ${j(n.parsed.y)}`}}},scales:{x:{type:"time",time:{unit:"month",displayFormats:{month:"MMM yy"}},ticks:{color:"var(--text3)",maxTicksLimit:12},grid:{color:"rgba(255,255,255,0.04)"}},y:{ticks:{color:"var(--text3)",callback:n=>j(n)},grid:{color:"rgba(255,255,255,0.04)"}}}}})}const yr=()=>_o()!==null,Pt=["#6366f1","#f59e0b","#10b981","#ef4444","#8b5cf6","#06b6d4","#f97316","#ec4899"],xr="M17 8C8 10 5.9 16.17 3.82 21h2.24c.38-1.35.86-2.63 1.47-3.8C9.44 16.16 12.05 15 16 15c-.02 3.31-.02 6 0 9h2V9l-1-1zm-4.5 3.5l-1.5 1.5L12.5 14H10v-2.5L8.5 10 10 8.5V6h2.5l1.5-1.5L15.5 6H18v2.5L19.5 10 18 11.5V14h-2.5l-1-1z";function $r(t){const e=()=>{var x;return(x=t.onDatosCambiados)==null?void 0:x.call(t)},a=new Set;let o=null;const n=()=>t.store.get("config"),s=()=>t.store.get("escenarios"),i=x=>{var S;return x?((S=s().find(w=>w._id===x))==null?void 0:S.nombre)??x:"Base"};function r(x){const S=n(),w=xa({loans:t.store.get("loans"),expenses:t.store.get("expenses"),nominas:t.store.get("nominas"),accounts:t.store.get("accounts")},(x==null?void 0:x._id)??null),C=a.size>0?w.accounts.filter(M=>!a.has(M._id)):w.accounts,z=a.size>0?C.map(M=>M._id):null,E=x!=null&&x.fechaFin&&x.fechaFin>S.dashboardEnd?x.fechaFin:S.dashboardEnd;return{eventos:Jt({loans:w.loans,expenses:w.expenses,accounts:C,config:{...S,dashboardEnd:E},filtroAccounts:z,nominas:w.nominas,inflacionPeriodos:t.store.get("inflacion"),resolverTramosIRPF:bt(t.store.get("tramosIRPFHistorico"),S.tramos_irpf??gt),resolverTramosGanancias:bt(t.store.get("tramosGananciasCapitalHistorico"),S.tramosGananciasCapital??jt)}),horizonte:E}}function l(x){const S=t.store.get("loans"),w=F=>(F.escenarioIds||[]).includes(x),C=[[S.filter(w).length,"préstamo","préstamos"],[S.flatMap(F=>F.amortizaciones||[]).filter(w).length,"amortización","amortizaciones"],[t.store.get("expenses").filter(w).length,"gasto","gastos"],[t.store.get("accounts").filter(w).length,"cuenta","cuentas"],[t.store.get("nominas").filter(w).length,"nómina","nóminas"]],z=C.reduce((F,[M])=>F+M,0),E=C.filter(([F])=>F>0).map(([F,M,P])=>`${F} ${F===1?M:P}`).join(" · ");return{total:z,texto:E}}function u(x,S){const w=S===x._id,C=x.color||Pt[0],{total:z,texto:E}=l(x._id);return`<div class="card mb-12" style="border-left:3px solid ${c(C)};padding:14px 16px">
    ...
    </div>`}function b(x){const S=n().dashboardEnd,w=ze(r(null).eventos,S);return`
      ...
      <table style="width:100%;font-size:13px;border-collapse:collapse">
        ...
        <tbody>${x.map(z=>{const{eventos:E}=r(z),F=z.fechaFin||S,M=ze(E,F),P=M!==null&&w!==null?M-w:null;return`<tr>
    ...
    </div>`}function d(){if(o){try{o.destroy()}catch{}o=null}}function h(x){const S=n(),w=r(null),C=[{label:"Base (sin supuesto)",color:"#6b7280",esBase:!0,puntos:je(w.eventos,S.dashboardStart,S.dashboardEnd)}];return x.forEach((z,E)=>{const{eventos:F,horizonte:M}=r(z);C.push({label:z.nombre,color:z.color||Pt[E%Pt.length],puntos:je(F,S.dashboardStart,M)})}),C}function y(x,S){d();const w=x.querySelector("#chart-comparacion");w&&(o=hr(w,h(S)))}function I(x){d();const S=new Set(t.store.get("accounts").map(z=>z._id));for(const z of[...a])S.has(z)||a.delete(z);const w=s(),C=n().escenarioActivo||null;x.innerHTML=`
      <div class="page-header">
      ...
      ${w.length===0?`<div class="card mb-14" style="padding:20px 24px">
             ...
             </div>`:`<div>${w.map(z=>u(z,C)).join("")}</div>
             <div class="card-title mt-24" style="margin-bottom:12px">Comparativa de supuestos</div>
             <div class="card" style="padding:16px">
               <div id="esc-pastillas">${p()}</div>
               ${yr()?'<canvas id="chart-comparacion" height="160"></canvas>':'<div class="text-sm" style="color:var(--text3);padding:12px 0">El gráfico necesita Chart.js, que no se ha podido cargar. La tabla de abajo tiene los mismos datos.</div>'}
             </div>
             <div class="card mt-12" style="padding:14px" id="esc-comparativa">${b(w)}</div>`}`,w.length>0&&y(x,w)}const A=()=>document.getElementById("modal-overlay"),f=()=>document.getElementById("modal-content"),g=()=>{var x;return(x=A())==null?void 0:x.classList.add("hidden")};function m(x,S){const w=x?s().find(F=>F._id===x)??null:null,C=A(),z=f();if(!C||!z)return;const E=(w==null?void 0:w.color)||Pt[0];z.innerHTML=`
      ...
      </div>`,C.classList.remove("hidden"),D(z,"[data-cancelar]",g),D(z,"[data-color-esc]",F=>{const M=F.getAttribute("data-color-esc");z.querySelector("#esc-color").value=M;for(const P of z.querySelectorAll("[data-color-esc]"))P.style.border=P.getAttribute("data-color-esc")===M?"2px solid white":"2px solid transparent"}),D(z,"[data-guardar-esc]",F=>{const M=z.querySelector("#esc-nombre").value.trim();if(!M)return q("El nombre es obligatorio","err");const P={nombre:M,fechaFin:z.querySelector("#esc-fecha-fin").value||null,color:z.querySelector("#esc-color").value||Pt[0],descripcion:z.querySelector("#esc-desc").value.trim()},T=F.getAttribute("data-guardar-esc")||"";T?(t.store.updateItem("escenarios",T,P),q("Escenario actualizado")):(t.store.addItem("escenarios",P),q("Escenario creado")),e(),g(),S()})}function $(x,S){if(!Z("¿Eliminar este escenario? Los elementos asignados perderán esta asignación."))return;const w=C=>C.map(z=>({...z,escenarioIds:(z.escenarioIds||[]).filter(E=>E!==x)}));t.store.set("loans",w(t.store.get("loans")).map(C=>({...C,amortizaciones:w(C.amortizaciones||[])}))),t.store.set("expenses",w(t.store.get("expenses"))),t.store.set("nominas",w(t.store.get("nominas"))),t.store.set("accounts",w(t.store.get("accounts"))),n().escenarioActivo===x&&t.store.patchConfig({escenarioActivo:null}),t.store.removeItem("escenarios",x),q("Escenario eliminado"),e(),S()}function v(x,S){D(x,"[data-nuevo-esc]",()=>m(null,S)),D(x,"[data-editar-esc]",w=>m(w.getAttribute("data-editar-esc"),S)),D(x,"[data-borrar-esc]",w=>$(w.getAttribute("data-borrar-esc"),S)),D(x,"[data-activar-esc]",w=>{const C=w.getAttribute("data-activar-esc");t.store.patchConfig({escenarioActivo:C}),q(`Escenario "${i(C)}" activado`),e(),S()}),D(x,"[data-desactivar-esc]",()=>{t.store.patchConfig({escenarioActivo:null}),q("Volviendo a la realidad base"),e(),S()}),D(x,"[data-toggle-cuenta]",w=>{const C=w.getAttribute("data-toggle-cuenta");a.has(C)?a.delete(C):a.add(C);const z=x.querySelector("#esc-pastillas");z&&(z.innerHTML=p());const E=s(),F=x.querySelector("#esc-comparativa");F&&(F.innerHTML=b(E)),y(x,E)})}return{id:"escenarios",route:"escenarios",nombre:"Supuestos",flagId:"supuestos",seccion:2,iconoPath:xr,mount(x){const S=()=>I(x);I(x),x.dataset.wired!=="1"&&(v(x,S),x.dataset.wired="1")},unmount(){d()}}}const Ir=1e-12,Po=t=>Math.abs(t)<Ir,To=t=>t/12;function Ar(t,e,a,o){if(a<=0)return Math.max(0,Math.ceil(t-e));const n=t-e;if(n<=0)return 0;const s=To(o);if(Po(s))return Math.ceil(n/a);const i=Math.pow(1+s,a),r=(t-e*i)*s/(i-1);return r<=0?0:Math.ceil(r)}function Sr(t,e){const a=To(e);return Po(a)?0:Math.round(t*a)}function Do({rentaNetaMensual:t,tasaRetiroSeguro:e,tipoFiscalEfectivo:a}){if(e<=0)throw new RangeError("La tasa de retiro seguro tiene que ser mayor que cero.");if(a>=1)throw new RangeError("El tipo fiscal efectivo no puede llegar al 100 %.");const o=Math.round(t*12/(1-a));return{retiroBrutoAnual:o,capitalNecesario:Math.round(o/e)}}function Ro(t,e){const[a,o]=t.split("-").map(Number),n=a*12+(o-1)+e,s=Math.floor(n/12),i=n%12+1;return`${s}-${String(i).padStart(2,"0")}`}function sa(t,e){const[a,o]=t.split("-").map(Number),[n,s]=e.split("-").map(Number);return(n-a)*12+(s-o)}const No=t=>Number(t.slice(0,4));function ye(t){return t.rentaDeseada?Do(t.rentaDeseada).capitalNecesario:t.importeObjetivo??0}const wr={_id:"__sin_vehiculo__"};function xe(t){var g,m,$;const e=Math.max(0,Math.floor(t.horizonteMeses)),a=new Map(t.vehiculos.map(v=>[v._id,v])),o=[...t.objetivos].sort((v,x)=>v.prioridad-x.prioridad).map(v=>({def:v,objetivo:ye(v),saldo:v.saldoActual,estado:ye(v)>0&&v.saldoActual>=ye(v)&&v.modoAsignacion!=="ABSORBE_RESIDUAL"?"COMPLETADO":"PENDIENTE",vehiculo:a.get(v.vehiculoId),aportadoEnAño:0,añoEnCurso:No(t.fechaInicio),ultimaSolicitud:0,solicitadoAcumulado:0,mesesReclamando:0})),n=new Map;for(const v of t.eventos){const x=n.get(v.fecha)??[];x.push(v),n.set(v.fecha,x)}const s=[],i=[],r=[];let l=t.perfil.netoMensual,u=t.perfil.gastosFijosMensuales,b=0,p=0;const d=[];for(let v=0;v<e;v++){const x=Ro(t.fechaInicio,v),S=No(x);for(const _ of n.get(x)??[])if(_.tipo==="CAMBIO_INGRESOS")l=_.importe;else if(_.tipo==="CAMBIO_GASTOS_FIJOS")u=_.importe;else if(_.tipo==="NUEVA_DEUDA")u+=_.importe;else if(_.tipo==="INYECCION_CAPITAL"){const k=_.objetivoDestinoId?o.find(L=>L.def._id===_.objetivoDestinoId):void 0;k?k.saldo+=_.importe:l+=_.importe}for(const _ of o)_.añoEnCurso!==S&&(_.añoEnCurso=S,_.aportadoEnAño=0);const w=Math.max(0,l-u),C=Math.round(w*Mr(t.pctDisfrute));let z=w-C;const E=z,F=o.filter(_=>_.estado!=="COMPLETADO"),M=[];let P=0;const T=F.filter(_=>_.def.modoAsignacion==="ABSORBE_RESIDUAL"),R=F.filter(_=>_.def.modoAsignacion!=="ABSORBE_RESIDUAL");for(const _ of R){const k=Cr(_,x,v,t);_.ultimaSolicitud=k,k>0&&(_.solicitadoAcumulado+=k,_.mesesReclamando+=1),(_.def.modoAsignacion==="CUOTA_POR_FECHA"||_.def.modoAsignacion==="FIJO")&&(P+=k);const L=Math.max(0,Math.min(k,z));z-=L,_.saldo+=L,_.aportadoEnAño+=L,b+=L,L>0&&_.estado==="PENDIENTE"&&(_.estado="EN_CURSO"),M.push({objetivoId:_.def._id,asignado:L,solicitado:k,saldoTrasMes:_.saldo})}if(T.length>0&&z>0){const _=T.map(B=>Math.max(0,B.def.pesoResidual??1)),k=_.reduce((B,N)=>B+N,0)||T.length;let L=0;T.forEach((B,N)=>{const H=N===T.length-1?z-L:Math.floor(z*_[N]/k);L+=H,B.saldo+=H,B.aportadoEnAño+=H,b+=H,H>0&&B.estado==="PENDIENTE"&&(B.estado="EN_CURSO"),M.push({objetivoId:B.def._id,asignado:H,solicitado:0,saldoTrasMes:B.saldo})}),z-=L}else for(const _ of T)M.push({objetivoId:_.def._id,asignado:0,solicitado:0,saldoTrasMes:_.saldo});P>E&&d.push({mes:x,deficit:P-E});for(const _ of o)_.saldo<=0||(_.saldo+=Sr(_.saldo,((g=_.vehiculo)==null?void 0:g.rentabilidadRealAnual)??0));for(const _ of o)_.estado!=="COMPLETADO"&&(_.def.modoAsignacion==="ABSORBE_RESIDUAL"&&_.objetivo<=0||_.objetivo>0&&_.saldo>=_.objetivo&&(_.estado="COMPLETADO",i.push({objetivoId:_.def._id,nombre:_.def.nombre,mes:x,indice:v,importeFinal:_.saldo,cuotaLiberada:_.ultimaSolicitud})));for(const _ of o)M.some(k=>k.objetivoId===_.def._id)||M.push({objetivoId:_.def._id,asignado:0,solicitado:0,saldoTrasMes:_.saldo});const O=o.reduce((_,k)=>_+k.saldo,0);if(p+=C,s.push({indice:v,mes:x,netoMensual:l,gastosFijos:u,sobrante:w,disfrute:C,disponible:E,sinAsignar:z,asignaciones:M.sort((_,k)=>Oo(o,_.objetivoId)-Oo(o,k.objetivoId)),patrimonioTotal:O}),o.length>0&&o.every(_=>_.estado==="COMPLETADO"))break}const h=[];if(d.length>0){const v=Math.round(d.reduce((x,S)=>x+S.deficit,0)/d.length);r.push({severidad:"error",codigo:"INVIABLE",mensaje:`El plan no cabe en el flujo de caja durante ${d.length} mes${d.length!==1?"es":""} (desde ${d[0].mes}). Déficit medio: ${(v/100).toFixed(2)} €/mes.`,mes:d[0].mes,deficitMensual:v});for(const x of o)x.estado!=="COMPLETADO"&&x.def.fechaLimite&&x.def.modoAsignacion==="CUOTA_POR_FECHA"&&(x.estado="INVIABLE");h.push(...zr(o,t,v))}for(const v of o){const x=(m=v.vehiculo)==null?void 0:m.topeAportacionAnual;x&&v.def.modoAsignacion==="FIJO"&&(v.def.importeFijoMensual??0)*12>x&&r.push({severidad:"atencion",codigo:"TOPE_FISCAL",objetivoId:v.def._id,mensaje:`«${v.def.nombre}» pide ${((v.def.importeFijoMensual??0)/100).toFixed(2)} €/mes, que supera el tope anual de ${(x/100).toFixed(2)} €. Se aporta hasta el tope y se reanuda en enero.`})}for(const v of o)v.estado!=="COMPLETADO"&&v.objetivo>0&&v.def.modoAsignacion!=="ABSORBE_RESIDUAL"&&r.push({severidad:"atencion",codigo:"NUNCA_COMPLETADO",objetivoId:v.def._id,mensaje:`«${v.def.nombre}» no se completa dentro del horizonte de ${e} meses.`});const y=o.find(v=>v.def.tipo==="INVERSION_PERPETUA"),I=y?i.find(v=>v.objetivoId===y.def._id):void 0,A={};for(const v of o){const x=(($=v.vehiculo)==null?void 0:$._id)??wr._id;A[x]=(A[x]??0)+v.saldo}const f={};for(const v of o)f[v.def._id]=v.estado;return{viable:d.length===0,mesesSimulados:s.length,serieMensual:s,hitos:i,fases:jr(s,i),avisos:r,propuestas:h,estadoFinal:f,resumen:{patrimonioFinal:o.reduce((v,x)=>v+x.saldo,0),patrimonioPorVehiculo:A,totalAportado:b,totalDisfrute:p,mesIndependencia:(I==null?void 0:I.mes)??null}}}const Mr=t=>Number.isFinite(t)?Math.min(1,Math.max(0,t)):0,Oo=(t,e)=>t.findIndex(a=>a.def._id===e);function Cr(t,e,a,o){var s,i;const n=Math.max(0,t.objetivo-t.saldo);switch(t.def.modoAsignacion){case"ABSORBE_TODO":return n;case"FIJO":{const r=t.def.importeFijoMensual??0,l=(s=t.vehiculo)==null?void 0:s.topeAportacionAnual;if(!l)return t.objetivo>0?Math.min(r,n):r;const u=Math.max(0,l-t.aportadoEnAño),b=Math.min(r,u);return t.objetivo>0?Math.min(b,n):b}case"CUOTA_POR_FECHA":{if(n<=0)return 0;const r=t.def.fechaLimite?sa(e,t.def.fechaLimite):o.horizonteMeses-a;return Ar(t.objetivo,t.saldo,Math.max(0,r),((i=t.vehiculo)==null?void 0:i.rentabilidadRealAnual)??0)}default:return 0}}function jr(t,e){if(t.length===0)return[];const o=[0,...[...new Set(e.map(s=>s.indice))].sort((s,i)=>s-i).map(s=>s+1)].filter((s,i,r)=>r.indexOf(s)===i&&s<t.length),n=[];for(let s=0;s<o.length;s++){const i=o[s],r=(s+1<o.length?o[s+1]:t.length)-1;if(r<i)continue;const l=new Set;for(let u=i;u<=r;u++)for(const b of t[u].asignaciones)b.asignado>0&&l.add(b.objetivoId);n.push({desde:t[i].mes,hasta:t[r].mes,meses:r-i+1,objetivosActivos:[...l]})}return n}function zr(t,e,a){const o=[],n=Math.max(0,e.perfil.netoMensual-e.perfil.gastosFijosMensuales);if(n>0&&e.pctDisfrute>0){const l=Math.ceil(Math.min(e.pctDisfrute,a/n)*100);if(l>0){const u=Math.round(e.pctDisfrute*100);o.push({clase:"REDUCIR_DISFRUTE",magnitud:l,mensaje:`Bajar el disfrute ${l} punto${l!==1?"s":""} (del ${u} % al ${Math.max(0,u-l)} %) libera ${(Math.min(a,n*e.pctDisfrute)/100).toFixed(0)} €/mes.`})}}const s=t.filter(l=>l.def.modoAsignacion==="CUOTA_POR_FECHA"&&l.def.fechaLimite&&l.estado!=="COMPLETADO"),i=l=>l.mesesReclamando>0?l.solicitadoAcumulado/l.mesesReclamando:0,r=[...s].sort((l,u)=>i(u)-i(l))[0];if(r){const l=Math.max(0,r.objetivo-r.saldo),u=i(r),b=Math.max(1,sa(e.fechaInicio,r.def.fechaLimite)),p=Math.max(1,u-a),d=Math.ceil(l/p),h=Math.max(1,d-b);o.push({clase:"RETRASAR_FECHA",objetivoId:r.def._id,magnitud:h,mensaje:`Retrasar «${r.def.nombre}» ${h} mes${h!==1?"es":""}, hasta ${Ro(r.def.fechaLimite,h)}, baja su cuota a lo que cabe en el flujo.`});const y=Math.min(Math.round(a*b),Math.max(0,r.objetivo-1));y>0&&o.push({clase:"REDUCIR_IMPORTE",objetivoId:r.def._id,magnitud:y,mensaje:`O reducir «${r.def.nombre}» en ${(y/100).toFixed(0)} €, de ${(r.objetivo/100).toFixed(0)} € a ${((r.objetivo-y)/100).toFixed(0)} €.`})}return s.length>1&&o.push({clase:"REORDENAR",magnitud:s.length,mensaje:`Hay ${s.length} objetivos con fecha compitiendo a la vez. Escalonarlos reparte la carga en vez de acumularla.`}),o.length===0&&o.push({clase:"REDUCIR_IMPORTE",magnitud:a,mensaje:`Faltan ${(a/100).toFixed(0)} €/mes. Hay que recortar aportaciones fijas, subir ingresos o bajar gastos por esa cantidad.`}),o}const Er=()=>globalThis.Chart??null,$e=["#2ee6a8","#4d9fff","#a855f7","#f97316","#eab308","#22d3ee","#fb7185","#34d399"],qo=new WeakMap;function Fr(t,e,a){const o=Er();if(!o)return null;const n=qo.get(t);if(n)try{n.destroy()}catch{}const s=new Map,i=new Map(e.objetivos.map(h=>[h._id,h.vehiculoId])),r=new Set(e.objetivos.map(h=>h.vehiculoId));for(const h of r)s.set(h,[]);for(const h of a.serieMensual){const y=new Map;for(const I of h.asignaciones){const A=i.get(I.objetivoId);A&&y.set(A,(y.get(A)??0)+I.saldoTrasMes)}for(const I of r)s.get(I).push((y.get(I)??0)/100)}const l=h=>{var y;return((y=e.vehiculos.find(I=>I._id===h))==null?void 0:y.nombre)??"Sin vehículo"},u=[...r],b=u.map((h,y)=>a.serieMensual.map((I,A)=>u.slice(0,y+1).reduce((f,g)=>f+(s.get(g)[A]??0),0))),p=u.map((h,y)=>({label:l(h),data:b[y],borderColor:$e[y%$e.length],backgroundColor:`${$e[y%$e.length]}33`,fill:y===0?"origin":"-1",borderWidth:1.5,pointRadius:0,tension:.25})),d=new o(t,{type:"line",data:{labels:a.serieMensual.map(h=>h.mes),datasets:p},options:{responsive:!0,maintainAspectRatio:!1,interaction:{mode:"index",intersect:!1},plugins:{legend:{labels:{color:"#a9b6cc",font:{size:11},boxWidth:12}},tooltip:{backgroundColor:"#111a28",borderColor:"rgba(255,255,255,0.12)",borderWidth:1,titleColor:"#a9b6cc",bodyColor:"#eef3fb",callbacks:{label:h=>{const y=h.datasetIndex>0?h.chart.data.datasets[h.datasetIndex-1].data[h.dataIndex]??0:0;return` ${h.dataset.label}: ${j(h.parsed.y-y)}`}}}},scales:{x:{ticks:{color:"#6b7b96",maxTicksLimit:12},grid:{display:!1}},y:{ticks:{color:"#6b7b96",callback:h=>j(h)},grid:{color:"rgba(255,255,255,0.07)"}}}}});return qo.set(t,d),d}const na=t=>j(t/100),_r={CUOTA_POR_FECHA:"Cuota para llegar a la fecha",ABSORBE_TODO:"Se lleva todo lo disponible",ABSORBE_RESIDUAL:"Recibe lo que sobre",FIJO:"Importe fijo al mes"},Pr={CUOTA_POR_FECHA:"Se recalcula cada mes con el saldo real: si un mes va sobrado, el siguiente pide menos.",ABSORBE_TODO:"Reclama todo el capital disponible hasta completarse. Es el modo típico de amortizar deuda.",ABSORBE_RESIDUAL:"No reclama nada; recoge lo que quede tras servir a los de prioridad superior.",FIJO:"Aporta siempre lo mismo, respetando el tope anual del vehículo si lo tiene."},Lo={COMPLETADO:"var(--accent)",EN_CURSO:"var(--text)",PENDIENTE:"var(--text3)",INVIABLE:"var(--red)"};function Tr(t,e){if(t.objetivos.length===0)return`<div class="card" style="text-align:center;padding:34px 20px">
    ...
    ${a.map(s=>{var i;return Dr(s,e,o,(i=n(s.vehiculoId))==null?void 0:i.nombre)}).join("")}`}function Dr(t,e,a,o){const n=ye(t),s=e.estadoFinal[t._id]??t.estado,i=a==null?void 0:a.asignaciones.find(p=>p.objetivoId===t._id),r=(i==null?void 0:i.solicitado)??0,l=e.hitos.find(p=>p.objetivoId===t._id),u=n>0?Math.min(100,t.saldoActual/n*100):0,b=e.avisos.filter(p=>p.objetivoId===t._id);return`
      ...
      <div style="display:flex;justify-content:space-between;align-items:flex-start;gap:12px;flex-wrap:wrap">
        <div style="flex:1;min-width:220px">
          <div style="display:flex;align-items:center;gap:8px;flex-wrap:wrap">
            ...
            <span class="badge" style="font-size:10px;background:var(--bg3);color:var(--text2)">${c(_r[t.modoAsignacion])}</span>
          ...
          <div class="text-sm" style="color:var(--text3);margin-top:4px">${c(Pr[t.modoAsignacion])}</div>
        </div>
    ...
    ${e.length===0?`<div class="card" style="text-align:center;padding:30px 20px">
             ...
             ${e.map(o=>Hr(o,t,a(o.objetivoDestinoId))).join("")}
           </div>`}`}function Hr(t,e,a){const o=sa(e.fechaInicio,t.fecha),n=o<0?"antes del inicio del plan":o===0?"en el primer mes":`dentro de ${o} mes${o!==1?"es":""}`,s=o<0||o>=e.horizonteMeses;return`
    <div style="display:flex;gap:12px;align-items:flex-start;padding:10px 0;border-bottom:1px solid var(--border)">
      ...
      <div style="flex:1;min-width:0">
        ...
        <div style="font-size:12px;margin-top:3px">${c(Nr(t,a))}</div>
    ...
    </div>`}function Gr(t,e,a,o){const n=t.campos.map(i=>{const r=o[i.id];return`<div class="form-group">
    ...
    </div>`}function Bo(t,e){var o;const a={};for(const n of e.campos){const s=((o=t.querySelector(`#ev-${n.id}`))==null?void 0:o.value)??"",i=parseFloat(String(s).replace(",","."));a[n.id]=Number.isFinite(i)?Math.round(i*100):0}return a}const Vr=(t,e)=>Lr(t.calcular(e)),Ur=[-2,-1,0,1,2],Yr=[-10,0,10],Jr=[-20,0,20];function Ho(t){return t.hitos.length===0?null:Math.max(...t.hitos.map(e=>e.indice))}function Wr(t,e,a,o,n){const s={};for(const l of o.hitos)s[l.objetivoId]=l.mes;const i=Ho(o),r=n?Ho(n):i;return{etiqueta:t,delta:e,esBase:a,viable:o.viable,hitos:s,desplazamientoMeses:i!==null&&r!==null?i-r:null,patrimonioFinal:o.resumen.patrimonioFinal}}function Qr(t,e,a){if(a===0)return t;switch(e){case"rentabilidad":return{...t,vehiculos:t.vehiculos.map(o=>({...o,rentabilidadRealAnual:Math.max(0,o.rentabilidadRealAnual+a/100)}))};case"disfrute":return{...t,pctDisfrute:Math.min(1,Math.max(0,t.pctDisfrute+a/100))};case"ingresos":return{...t,perfil:{...t.perfil,netoMensual:Math.max(0,Math.round(t.perfil.netoMensual*(1+a/100)))}}}}const Kr=t=>t>0?`+${t}`:String(t);function ia(t,e,a,o,n,s){const i=xe(t),r=n.map(l=>Wr(l===0?"Plan actual":`${Kr(l)} ${s}`,l,l===0,l===0?i:xe(Qr(t,e,l)),i));return{palanca:e,titulo:a,descripcion:o,variantes:r}}function Xr(t){return[ia(t,"rentabilidad","Rentabilidad de los vehículos","Mueve la rentabilidad real de todos los vehículos a la vez. Es la palanca que menos controlas.",Ur,"puntos"),ia(t,"disfrute","Porcentaje de disfrute","Lo que apartas para gastar en vez de asignar a objetivos. Es la palanca que más controlas.",Yr,"puntos"),ia(t,"ingresos","Ingresos","Un ascenso, un cambio de trabajo o una reducción de jornada.",Jr,"%")]}function Zr(t){if(t===null)return"no comparable";if(t===0)return"sin cambio";const e=Math.abs(t),a=Math.floor(e/12),o=e%12,n=[a>0?`${a} año${a!==1?"s":""}`:"",o>0?`${o} mes${o!==1?"es":""}`:""].filter(Boolean).join(" y ");return t<0?`${n} antes`:`${n} más tarde`}const Go=t=>j(t/100);function tl(t,e,a){return`
    ${el(t,e)}
    ${t.length>1?al(t):""}
    ${ol(a)}`}function el(t,e){return`<div class="card mb-14">
  ...
  </div>`}function al(t){const e=t.slice(0,3),a=e.map(r=>({plan:r,res:xe(r)})),o=qr(a.map(({plan:r,res:l})=>({nombre:r.nombre,hitos:l.hitos}))),n=["Hito",...e.map(r=>r.nombre)].map((r,l)=>`<th style="text-align:${l===0?"left":"right"};padding:6px 8px;font-size:11px;color:var(--text3)">${c(r)}</th>`).join(""),s=o.map(r=>`<tr>
  ...
  </div>`}function ol(t){return t?`<div class="card">
    <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:12px;flex-wrap:wrap;gap:8px">
    ...
    </div>`}function sl(t){return`<div style="margin-bottom:18px">
    ...
    ${t.variantes.map(e=>{const a=e.desplazamientoMeses,o=a===null?"var(--text3)":a===0?"var(--text2)":a<0?"var(--accent)":"var(--red)";return`<div style="display:flex;justify-content:space-between;align-items:center;gap:10px;padding:5px 0;font-size:12px;${e.esBase?"border-top:1px solid var(--border);border-bottom:1px solid var(--border);":""}">
        ...
        <span style="display:flex;gap:14px;align-items:baseline">
          <span style="color:${o};font-size:11px">${c(Zr(a))}</span>
    ...
    ${ll(e)}
    ${cl(t,e)}
    ${dl(t,e,a)}`}function il(t){if(t.avisos.length===0&&t.propuestas.length===0)return"";const e={error:"var(--red)",atencion:"var(--yellow)",info:"var(--text2)"},a=t.avisos.map(i=>`<div style="display:flex;gap:8px;font-size:12px;line-height:1.6;margin-bottom:5px">
    ...
    ${a}${o}
  </div>`}function rl(t,e){const a=(n,s,i="")=>`<div class="stat-card">
  ...
  </div>`}function ll(t){return t.hitos.length===0?`<div class="card mb-14"><div class="card-title mb-8">Hitos</div>
  ...
  </div>`}function cl(t,e){if(e.fases.length<=1)return"";const a=o=>{var n;return((n=t.objetivos.find(s=>s._id===o))==null?void 0:n.nombre)??o};return`<div class="card mb-14">
...
`)}const Bt=t=>{const e=typeof t=="number"?t:parseFloat(String(t).replace(",","."));return Number.isFinite(e)?Math.round(e*100):0},ie=t=>(t/100).toFixed(2),Vo=t=>(t*100).toFixed(2),Ht=t=>{const e=parseFloat(String(t).replace(",","."));return Number.isFinite(e)?e/100:0},pl=[["AHORRO_OBJETIVO","Ahorrar una cantidad"],["AMORTIZAR_DEUDA","Amortizar deuda"],["INVERSION_PERPETUA","Independencia económica"],["APORTACION_FIJA","Aportación periódica"]],ml=[["CUOTA_POR_FECHA","Cuota para llegar a la fecha"],["ABSORBE_TODO","Se lleva todo lo disponible"],["ABSORBE_RESIDUAL","Recibe lo que sobre"],["FIJO","Importe fijo al mes"]],fl=[["INMEDIATA","Inmediata"],["MEDIA","Media (con preaviso o penalización)"],["BLOQUEADA_HASTA_JUBILACION","Bloqueada hasta la jubilación"]],vl=[["NULO","Nulo"],["BAJO","Bajo"],["MEDIO","Medio"],["ALTO","Alto"]],Uo={AHORRO_OBJETIVO:"CUOTA_POR_FECHA",AMORTIZAR_DEUDA:"ABSORBE_TODO",INVERSION_PERPETUA:"ABSORBE_RESIDUAL",APORTACION_FIJA:"FIJO"},lt=(t,e,a,o,n="",s="")=>`<div class="form-group">
    ...
    ${n?`<div class="text-sm mt-4" style="color:var(--text3)">${n}</div>`:""}
  </div>`;function gl(t,e,a){var l,u,b;const o=t===null,n=(t==null?void 0:t.tipo)??"AHORRO_OBJETIVO",s=(t==null?void 0:t.modoAsignacion)??Uo[n],i=!!(t!=null&&t.rentaDeseada),r=e.length>0?e.map(p=>[p._id,p.nombre]):[["","— no hay vehículos: crea uno primero —"]];return`
    <div class="grid-2" style="gap:10px">
    ...
    <div class="grid-2" style="gap:10px">
      ${Tt("ob-tipo","Tipo",pl,n)}
      ${Tt("ob-modo","Cómo pide dinero",ml,s)}
    </div>
    ...
    </div>`}function bl(t,e,a){var u;const o=b=>{var p;return((p=t.querySelector(`#${b}`))==null?void 0:p.value)??""},n=o("ob-nombre").trim();if(!n)return null;const s=o("ob-tipo"),i=o("ob-modo"),r=((u=t.querySelector('input[name="ob-derivar"]:checked'))==null?void 0:u.value)==="renta",l=s==="INVERSION_PERPETUA"&&r;return{_id:(e==null?void 0:e._id)??`obj_${Date.now().toString(36)}${Math.random().toString(36).slice(2,6)}`,nombre:n,tipo:s,importeObjetivo:l?null:Bt(o("ob-importe")),fechaLimite:o("ob-fecha")||null,prioridad:Math.max(1,Number(o("ob-prioridad"))||a),modoAsignacion:i,vehiculoId:o("ob-vehiculo"),saldoActual:Bt(o("ob-saldo")),estado:(e==null?void 0:e.estado)??"PENDIENTE",notas:o("ob-notas"),...i==="FIJO"?{importeFijoMensual:Bt(o("ob-fijo"))}:{},...i==="ABSORBE_RESIDUAL"?{pesoResidual:Math.max(0,Number(o("ob-peso"))||1)}:{},...l?{rentaDeseada:{rentaNetaMensual:Bt(o("ob-renta")),tasaRetiroSeguro:Ht(o("ob-swr")),tipoFiscalEfectivo:Ht(o("ob-fiscal"))}}:{rentaDeseada:null}}}function hl(t){const e=a=>{var o;return((o=t.querySelector(`#${a}`))==null?void 0:o.value)??""};try{const{capitalNecesario:a}=Do({rentaNetaMensual:Bt(e("ob-renta")),tasaRetiroSeguro:Ht(e("ob-swr")),tipoFiscalEfectivo:Ht(e("ob-fiscal"))});return`${(a/100).toLocaleString("es-ES",{minimumFractionDigits:0,maximumFractionDigits:0})} €`}catch{return"no calculable con esos parámetros"}}function yl(t,e,a){const o=t===null,n=!!(t!=null&&t.esDeuda),s=[["","— ninguna —"],...e.map(r=>[r._id,r.nombre])],i=[["","— ninguno —"],...a.map(r=>[r._id,`${r.nombre} (${r.tin} % TIN)`])];return`
    ...
    <div class="grid-2" style="gap:10px">
      ${Tt("ve-liquidez","Liquidez",fl,(t==null?void 0:t.liquidez)??"INMEDIATA")}
      ${Tt("ve-riesgo","Riesgo",vl,(t==null?void 0:t.riesgo)??"NULO")}
    </div>
    ...
    <div class="flex gap-8 mt-16" style="justify-content:flex-end;flex-wrap:wrap">
    ...
    </div>`}function xl(t,e){var i;const a=r=>{var l;return((l=t.querySelector(`#${r}`))==null?void 0:l.value)??""},o=a("ve-nombre").trim();if(!o)return null;const n=((i=t.querySelector("#ve-deuda"))==null?void 0:i.checked)??!1,s=a("ve-tope").trim();return{_id:(e==null?void 0:e._id)??`veh_${Date.now().toString(36)}${Math.random().toString(36).slice(2,6)}`,nombre:o,rentabilidadRealAnual:Ht(a("ve-rent")),liquidez:a("ve-liquidez"),fiscalidadRetirada:Ht(a("ve-fiscal")),topeAportacionAnual:s?Bt(s):null,riesgo:a("ve-riesgo"),cuentaId:a("ve-cuenta")||null,prestamoId:n&&a("ve-prestamo")||null,esDeuda:n}}const $l={CUOTA_POR_FECHA:"Cada mes calcula lo que hace falta para llegar a la fecha, con el saldo que lleva. Si un mes va sobrado, el siguiente pide menos.",ABSORBE_TODO:"Reclama todo lo disponible hasta completarse. Los de menor prioridad no reciben nada mientras tanto.",ABSORBE_RESIDUAL:"No reclama nada: recoge lo que quede tras servir a los de arriba. Es el modo del cubo de largo plazo.",FIJO:"Aporta siempre lo mismo. Si el vehículo tiene tope anual, se aporta hasta agotarlo y se reanuda en enero."},Il="M3 3v18h18v-2H5V3H3zm4 12h2v-5H7v5zm4 0h2V7h-2v8zm4 0h2v-3h-2v3z",Yo=t=>{const e=parseFloat(String(t).replace(",","."));return Number.isFinite(e)?Math.round(e*100):0},Ie=t=>(t/100).toFixed(2);function Al(t){const e=t.hoy??J;let a="config",o=null,n=0,s=null;function i(){const M=t.store.get("planes");return M.find(P=>P.activo)??M[0]??null}function r(){const M=i();return M||t.store.addItem("planes",{nombre:"Plan base",fechaInicio:e().slice(0,7),horizonteMeses:480,pctDisfrute:0,activo:!0,perfil:{netoMensual:0,gastosFijosMensuales:0,manual:!1},vehiculos:[],objetivos:[],eventos:[],creadoEn:e()})}function l(M){var T;const P=i();P&&(t.store.updateItem("planes",P._id,M),s=null,o=null,(T=t.onDatosCambiados)==null||T.call(t))}function u(){const P=t.store.get("nominas").filter(O=>O.activo).reduce((O,_)=>O+(_.bruto||0),0),T=Math.round(P*.75/12),R=t.store.get("expenses").filter(O=>O.activo&&O.basico&&O.tipo==="gasto").reduce((O,_)=>O+(_.cuantia||0),0);return{neto:Math.round(T*100),gastos:Math.round(R*100)}}function b(M){return s||(s=xe(M)),s}function p(M){const P=u(),T=Math.max(0,M.perfil.netoMensual-M.perfil.gastosFijosMensuales),R=Math.round(M.pctDisfrute*100);return`
      <div class="card mb-14">
        ...
        <div class="form-group mt-8">
          ...
          <div class="text-sm mt-4" style="color:var(--text3)">
            ...
            quedan <strong id="pl-disponible">${c(j(T*(1-M.pctDisfrute)/100))}</strong>/mes para los objetivos.
          </div>
        </div>
      ...
      </div>`}const h=()=>document.getElementById("modal-overlay"),y=()=>document.getElementById("modal-content"),I=()=>{var M;return(M=h())==null?void 0:M.classList.add("hidden")};function A(M,P){const T=h(),R=y();return!T||!R?null:(R.innerHTML=`<div class="modal-title">${c(M)}</div>${P}`,T.classList.remove("hidden"),R)}function f(M){l({objetivos:M})}function g(M,P){const T=i();if(!T)return;const R=P?T.objetivos.find(B=>B._id===P)??null:null,O=T.objetivos.reduce((B,N)=>Math.max(B,N.prioridad),0)+1,_=A(R?`Editar «${R.nombre}»`:"Nuevo objetivo",gl(R,T.vehiculos,O));if(!_)return;const k=()=>{var U;const B=(U=_.querySelector("#ob-modo"))==null?void 0:U.value,N=_.querySelector("#ob-modo-ayuda");N&&B&&(N.textContent=$l[B]);const H=(W,K)=>{const st=_.querySelector(W);st&&(st.style.display=K?"block":"none")};H("#ob-bloque-fijo",B==="FIJO"),H("#ob-bloque-residual",B==="ABSORBE_RESIDUAL")};k();const L=()=>{const B=_.querySelector("#ob-capital-derivado");B&&(B.textContent=hl(_))};L(),Y(_,"#ob-modo",k),Y(_,"#ob-tipo",()=>{const B=_.querySelector("#ob-tipo").value,N=_.querySelector("#ob-modo");N&&(N.value=Uo[B]);const H=_.querySelector("#ob-bloque-perpetua");H&&(H.style.display=B==="INVERSION_PERPETUA"?"block":"none"),k()}),Y(_,'input[name="ob-derivar"]',()=>{var U;const B=((U=_.querySelector('input[name="ob-derivar"]:checked'))==null?void 0:U.value)==="renta",N=_.querySelector("#ob-renta-campos"),H=_.querySelector("#ob-bloque-importe");N&&(N.style.display=B?"block":"none"),H&&(H.style.display=B?"none":"block"),L()}),Y(_,"#ob-renta, #ob-swr, #ob-fiscal",L),D(_,"[data-ob-cancelar]",I),D(_,"[data-ob-guardar]",()=>{const B=bl(_,R,O);if(!B){q("El objetivo necesita un nombre","err");return}if(!B.vehiculoId){q("Crea antes un vehículo donde meter el dinero","err");return}const N=T.objetivos.filter(H=>H._id!==B._id);f([...N,B]),I(),q(R?"Objetivo actualizado":`Objetivo «${B.nombre}» creado`),E(M)}),D(_,"[data-ob-borrar]",()=>{R&&Z(`¿Borrar «${R.nombre}»? Esto no se puede deshacer.`)&&(f(T.objetivos.filter(B=>B._id!==R._id)),I(),q("Objetivo borrado"),E(M))})}function m(M,P){const T=i();if(!T)return;const R=P?T.vehiculos.find(L=>L._id===P)??null:null,O=t.store.get("accounts").filter(L=>L.activo).map(L=>({_id:L._id,nombre:L.nombre})),_=t.store.get("loans").filter(L=>L.activo&&!L.simulacion).map(L=>({_id:L._id,nombre:L.nombre,tin:L.tin})),k=A(R?`Editar «${R.nombre}»`:"Nuevo vehículo",yl(R,O,_));k&&(Y(k,"#ve-deuda",()=>{const L=k.querySelector("#ve-deuda").checked,B=k.querySelector("#ve-bloque-prestamo");B&&(B.style.display=L?"block":"none")}),Y(k,"#ve-prestamo",()=>{const L=k.querySelector("#ve-prestamo").value,B=_.find(U=>U._id===L);if(!B)return;const N=k.querySelector("#ve-rent"),H=k.querySelector("#ve-nombre");N&&(N.value=String(B.tin)),H&&!H.value.trim()&&(H.value=`Amortizar ${B.nombre}`)}),D(k,"[data-ve-cancelar]",I),D(k,"[data-ve-guardar]",()=>{const L=xl(k,R);if(!L){q("El vehículo necesita un nombre","err");return}const B=T.vehiculos.filter(N=>N._id!==L._id);l({vehiculos:[...B,L]}),I(),q(R?"Vehículo actualizado":`Vehículo «${L.nombre}» creado`),E(M)}),D(k,"[data-ve-borrar]",()=>{if(!R)return;const L=T.objetivos.filter(B=>B.vehiculoId===R._id);if(L.length>0){q(`No se puede borrar: lo usan ${L.length} objetivo${L.length!==1?"s":""}`,"err");return}Z(`¿Borrar el vehículo «${R.nombre}»?`)&&(l({vehiculos:T.vehiculos.filter(B=>B._id!==R._id)}),I(),q("Vehículo borrado"),E(M))}))}function $(M,P,T){const R=i();if(!R||P===T)return;const O=[...R.objetivos].sort((B,N)=>B.prioridad-N.prioridad),_=O.findIndex(B=>B._id===P),k=O.findIndex(B=>B._id===T);if(_<0||k<0)return;const[L]=O.splice(_,1);O.splice(k,0,L),f(O.map((B,N)=>({...B,prioridad:N+1}))),E(M)}function v(M){return M.vehiculos.length===0?`<div class="card mb-14" style="padding:12px 16px;background:rgba(255,209,102,0.06);border-color:rgba(255,209,102,0.28)">
        <div class="text-sm" style="color:var(--text2);line-height:1.7">
      ...
      <div style="display:flex;gap:8px;flex-wrap:wrap">
        ${M.vehiculos.map(P=>{const T=M.objetivos.filter(R=>R.vehiculoId===P._id).length;return`<button class="btn-secondary btn-sm" data-pl-editar-vehiculo="${c(P._id)}"
    ...
    </div>`}function x(M,P,T){const R=i(),O=Rr(P);if(!R||!O)return;const _=T?R.eventos.find(N=>N._id===T)??null:null,k={};O.id==="hijo"&&(k.actuales=R.perfil.gastosFijosMensuales),O.id==="subida-sueldo"&&(k.actual=R.perfil.netoMensual);const L=A(_?`Editar evento · ${O.nombre}`:O.nombre,Gr(O,_,R,k));if(!L)return;const B=()=>{const N=L.querySelector("#ev-resultado");N&&(N.textContent=Vr(O,Bo(L,O)))};B();for(const N of O.campos)Y(L,`#ev-${N.id}`,B);D(L,"[data-ev-cancelar]",I),D(L,"[data-ev-guardar]",()=>{var W,K;const N=((W=L.querySelector("#ev-fecha"))==null?void 0:W.value)??"";if(!N){q("El evento necesita un mes","err");return}const H=Bo(L,O),U={_id:(_==null?void 0:_._id)??`ev_${Date.now().toString(36)}${Math.random().toString(36).slice(2,6)}`,fecha:N,tipo:O.tipo,importe:O.calcular(H),objetivoDestinoId:((K=L.querySelector("#ev-destino"))==null?void 0:K.value)||null,notas:O.resumir(H)};l({eventos:[...R.eventos.filter(st=>st._id!==U._id),U]}),I(),q(_?"Evento actualizado":"Evento añadido"),E(M)}),D(L,"[data-ev-borrar]",()=>{!_||!Z("¿Borrar este evento?")||(l({eventos:R.eventos.filter(N=>N._id!==_._id)}),I(),q("Evento borrado"),E(M))})}function S(M){var P;switch(M.tipo){case"CAMBIO_GASTOS_FIJOS":return"hijo";case"CAMBIO_INGRESOS":return"subida-sueldo";case"NUEVA_DEUDA":return"nueva-hipoteca";case"INYECCION_CAPITAL":return(P=M.notas)!=null&&P.includes("hipoteca")?"venta-vivienda":"inyeccion"}}function w(){const M=i();if(!M)return;const P=new Blob([JSON.stringify(M,null,2)],{type:"application/json"}),T=URL.createObjectURL(P),R=document.createElement("a");R.href=T,R.download=`plan-${M.nombre.replace(/[^\w-]+/g,"_")}-${e()}.json`,R.click(),URL.revokeObjectURL(T),q("Plan exportado")}function C(M){const P=document.createElement("input");P.type="file",P.accept="application/json,.json",P.addEventListener("change",async()=>{var R,O;const T=(R=P.files)==null?void 0:R[0];if(T)try{const _=JSON.parse(await T.text());if(!_||!Array.isArray(_.objetivos)||!Array.isArray(_.vehiculos)||!_.perfil){q("Ese fichero no es un plan de objetivos","err");return}const k=`${_.nombre??"Importado"} (importado)`,L=t.store.addItem("planes",{..._,nombre:k,activo:!1,creadoEn:e()});s=null,o=null,(O=t.onDatosCambiados)==null||O.call(t),q(`Plan «${L.nombre}» importado`),E(M)}catch(_){console.error("[Planner] Importación fallida:",_),q("No se ha podido leer el fichero","err")}}),P.click()}function z(M,P){switch(a){case"config":return p(M);case"objetivos":return Tr(M,P);case"simulacion":return nl(M,P,n);case"eventos":return Br(M);case"escenarios":return tl(t.store.get("planes"),M._id,o)}}function E(M){const P=r(),T=b(P),R=(_,k)=>`<button class="period-btn ${a===_?"active":""}" data-pl-tab="${_}">${k}</button>`,O=T.viable?'<span class="badge badge-green">Plan viable</span>':'<span class="badge badge-red">No cabe en el flujo</span>';if(M.innerHTML=`
      <div class="page-header">
      ...
      <div id="pl-cuerpo">${z(P,T)}</div>`,a==="simulacion"){const _=M.querySelector("#pl-chart");_&&Fr(_,P,T)}F(M)}function F(M){D(M,"[data-pl-tab]",T=>{a=T.dataset.plTab,E(M)}),Y(M,"#pl-disfrute",T=>{const R=Number(T.value)/100,O=M.querySelector("#pl-pct-val");O&&(O.textContent=`${Math.round(R*100)} %`);const _=i();if(!_)return;const k=Math.max(0,_.perfil.netoMensual-_.perfil.gastosFijosMensuales)*(1-R),L=M.querySelector("#pl-disponible");L&&(L.textContent=j(k/100))}),D(M,"[data-pl-usar-sugerido]",()=>{const T=u(),R=M.querySelector("#pl-neto"),O=M.querySelector("#pl-gastos");R&&(R.value=Ie(T.neto)),O&&(O.value=Ie(T.gastos))}),D(M,"[data-pl-guardar]",()=>{const T=R=>{var O;return((O=M.querySelector(R))==null?void 0:O.value)??""};l({perfil:{netoMensual:Yo(T("#pl-neto")),gastosFijosMensuales:Yo(T("#pl-gastos")),manual:!0},pctDisfrute:Math.min(1,Math.max(0,Number(T("#pl-disfrute"))/100)),fechaInicio:T("#pl-inicio")||e().slice(0,7),horizonteMeses:Math.min(600,Math.max(1,Number(T("#pl-horizonte"))||480))}),q("Plan guardado"),E(M)}),D(M,"[data-pl-plantilla]",T=>x(M,T.dataset.plPlantilla??"",null)),D(M,"[data-pl-editar-evento]",T=>{var _;const R=T.dataset.plEditarEvento??"",O=(_=i())==null?void 0:_.eventos.find(k=>k._id===R);O&&x(M,S(O),R)}),D(M,"[data-pl-duplicar]",()=>{var _;const T=i();if(!T)return;const R=window.prompt("Nombre del plan nuevo:",`${T.nombre} (copia)`);if(!(R!=null&&R.trim()))return;const O=Or(T,R.trim(),`plan_${Date.now().toString(36)}`,e());t.store.addItem("planes",O),(_=t.onDatosCambiados)==null||_.call(t),q(`Plan «${O.nombre}» creado. Actívalo para editarlo.`),E(M)}),D(M,"[data-pl-activar]",T=>{var O;const R=T.dataset.plActivar;if(R){for(const _ of t.store.get("planes"))t.store.updateItem("planes",_._id,{activo:_._id===R});s=null,o=null,(O=t.onDatosCambiados)==null||O.call(t),q("Plan activo cambiado"),E(M)}}),D(M,"[data-pl-renombrar]",T=>{var k;const R=T.dataset.plRenombrar,O=t.store.get("planes").find(L=>L._id===R);if(!O)return;const _=window.prompt("Nuevo nombre:",O.nombre);_!=null&&_.trim()&&(t.store.updateItem("planes",O._id,{nombre:_.trim()}),(k=t.onDatosCambiados)==null||k.call(t),E(M))}),D(M,"[data-pl-borrar-plan]",T=>{var k;const R=T.dataset.plBorrarPlan,O=t.store.get("planes").find(L=>L._id===R);if(!O||!Z(`¿Borrar el plan «${O.nombre}» con sus ${O.objetivos.length} objetivos? No se puede deshacer.`))return;t.store.removeItem("planes",O._id);const _=t.store.get("planes");O.activo&&_.length>0&&t.store.updateItem("planes",_[0]._id,{activo:!0}),s=null,o=null,(k=t.onDatosCambiados)==null||k.call(t),q("Plan borrado"),E(M)}),D(M,"[data-pl-sensibilidad]",()=>{const T=i();T&&(o=Xr(T),E(M))}),D(M,"[data-pl-pagina]",T=>{n=Number(T.dataset.plPagina)||0,E(M)}),D(M,"[data-pl-exportar]",w),D(M,"[data-pl-importar]",()=>C(M)),D(M,"[data-pl-nuevo-objetivo]",()=>g(M,null)),D(M,"[data-pl-nuevo-vehiculo]",()=>m(M,null)),D(M,"[data-pl-editar-vehiculo]",T=>m(M,T.dataset.plEditarVehiculo??null)),D(M,"[data-pl-editar-objetivo]",T=>g(M,T.dataset.plEditarObjetivo??null));let P=null;M.querySelectorAll("[data-pl-objetivo]").forEach(T=>{T.addEventListener("dragstart",()=>{P=T.dataset.plObjetivo??null,T.style.opacity="0.45"}),T.addEventListener("dragend",()=>{T.style.opacity="",M.querySelectorAll("[data-pl-objetivo]").forEach(R=>R.style.borderTop="")}),T.addEventListener("dragover",R=>{R.preventDefault(),P&&T.dataset.plObjetivo!==P&&(T.style.borderTop="2px solid var(--accent)")}),T.addEventListener("dragleave",()=>{T.style.borderTop=""}),T.addEventListener("drop",R=>{R.preventDefault(),T.style.borderTop="";const O=T.dataset.plObjetivo;P&&O&&$(M,P,O),P=null})}),D(M,"[data-pl-csv]",()=>{const T=i();if(!T||!s)return;const R=new Blob(["\uFEFF"+ul(T,s)],{type:"text/csv;charset=utf-8"}),O=URL.createObjectURL(R),_=document.createElement("a");_.href=O,_.download=`plan-${T.nombre.replace(/[^\w-]+/g,"_")}-${e()}.csv`,_.click(),URL.revokeObjectURL(O),q(`CSV exportado (${s.serieMensual.length} meses)`)}),D(M,"[data-pl-guardar-notas]",()=>{var T;l({notas:((T=M.querySelector("#pl-notas"))==null?void 0:T.value)??""}),q("Notas guardadas")})}return{id:"planner",route:"planner",nombre:"Objetivos financieros",seccion:2,iconoPath:Il,mount:E}}function Jo(t,e,a=!1){const o=Math.abs(It(e));return t==="ingreso"?o:t==="gasto"||a?-o:o}function Sl(t){function e(m){return`${m}_${Date.now().toString(36)}${Math.random().toString(36).slice(2,7)}`}function a(m={}){var v;const $=(v=m.texto)==null?void 0:v.trim().toLowerCase();return t.get("transacciones").filter(x=>!(m.cuentaId&&x.cuentaId!==m.cuentaId||m.desde&&x.fecha<m.desde||m.hasta&&x.fecha>m.hasta||m.tipo&&x.tipo!==m.tipo||m.estimacionId&&x.estimacionId!==m.estimacionId||m.tags&&m.tags.length>0&&!m.tags.some(S=>x.tags.includes(S))||$&&!x.concepto.toLowerCase().includes($))).sort((x,S)=>x.fecha.localeCompare(S.fecha)||x._id.localeCompare(S._id))}function o(m){const $={_id:e("tx"),fecha:m.fecha,cuentaId:m.cuentaId,importeCts:Jo(m.tipo,m.importe,m.negativo),concepto:m.concepto,tags:m.tags??[],estimacionId:m.estimacionId??null,tipo:m.tipo,origen:m.origen??"manual",...m.nota?{nota:m.nota}:{}};return t.set("transacciones",[...t.get("transacciones"),$]),$}function n(m,$){t.set("transacciones",t.get("transacciones").map(v=>{if(v._id!==m)return v;const{importe:x,...S}=$,w={...v,...S};return x!==void 0&&(w.importeCts=Jo(w.tipo,x,w.importeCts<0)),w}))}function s(m){t.set("transacciones",t.get("transacciones").filter($=>$._id!==m))}function i(m,$){n(m,{estimacionId:$})}function r(m){return t.get("puntosControl").filter($=>!m||$.cuentaId===m).sort(($,v)=>$.fecha.localeCompare(v.fecha))}function l(m,$,v,x){const S={_id:e("pc"),fecha:$,cuentaId:m,saldoCts:It(v),...x?{nota:x}:{}},w=t.get("puntosControl").filter(C=>!(C.cuentaId===m&&C.fecha===$));return t.set("puntosControl",[...w,S].sort((C,z)=>C.fecha.localeCompare(z.fecha))),b(m),S}function u(m){const $=t.get("puntosControl").find(v=>v._id===m);t.set("puntosControl",t.get("puntosControl").filter(v=>v._id!==m)),$&&b($.cuentaId)}function b(m){const $=r(m),v=t.get("accounts");v.some(x=>x._id===m)&&t.set("accounts",v.map(x=>x._id===m?{...x,historicoSaldos:$.map(S=>({_id:S._id,fecha:S.fecha,saldo:et(S.saldoCts),...S.nota?{nota:S.nota}:{}}))}:x))}function p(m,$=J()){const v=r(m).filter(C=>C.fecha<=$).pop(),x=v==null?void 0:v.fecha,S=(v==null?void 0:v.saldoCts)??0;return t.get("transacciones").filter(C=>C.cuentaId===m&&C.fecha<=$&&(x===void 0||C.fecha>x)).reduce((C,z)=>C+z.importeCts,S)}function d(m,$){return et(p(m,$))}function h(m=J(),$){const v=$??t.get("accounts").filter(x=>x.activo).map(x=>x._id);return et(v.reduce((x,S)=>x+p(S,m),0))}function y(){return t.get("transacciones").length>0||t.get("puntosControl").length>0}function I(){const m=[...t.get("transacciones").map($=>$.fecha),...t.get("puntosControl").map($=>$.fecha)];return m.length>0?m.sort().pop()??null:null}function A(m={}){return et(a(m).reduce(($,v)=>$+v.importeCts,0))}function f(m={}){const $=new Map;for(const v of a(m)){const x=v.fecha.slice(0,7);$.set(x,($.get(x)??0)+v.importeCts)}return new Map([...$.entries()].sort(([v],[x])=>v.localeCompare(x)).map(([v,x])=>[v,et(x)]))}function g(m={}){const $=new Map;for(const v of a(m))for(const x of v.tags.length>0?v.tags:["sin_tag"])$.set(x,($.get(x)??0)+v.importeCts);return new Map([...$.entries()].map(([v,x])=>[v,et(x)]))}return{transacciones:a,registrar:o,actualizar:n,eliminar:s,asignarEstimacion:i,puntosControl:r,registrarPuntoControl:l,eliminarPuntoControl:u,saldoCuenta:d,saldoCuentaCts:p,saldoTotal:h,tieneDatos:y,ultimaFecha:I,total:A,totalPorMes:f,totalPorTag:g}}function xt(t){return t.trim().toLowerCase()}function wl(t){function e(){const u=new Map,b=(p,d)=>{const h=xt(p);if(!h)return;const y=u.get(h)??{tag:h,estimaciones:0,reales:0,total:0};y[d]+=1,y.total+=1,u.set(h,y)};for(const p of t.get("expenses"))for(const d of p.tags??[])b(d,"estimaciones");for(const p of t.get("transacciones"))for(const d of p.tags??[])b(d,"reales");return[...u.values()].sort((p,d)=>d.total-p.total||p.tag.localeCompare(d.tag))}function a(){return e().map(u=>u.tag)}function o(u){return e().filter(b=>u==="estimaciones"?b.reales===0:b.estimaciones===0).map(b=>b.tag)}function n(u,b,p){const d=xt(b),h=(u??[]).map(xt);if(!h.includes(d))return u??[];const y=h.filter(I=>I!==d);return p===null?[...new Set(y)]:[...new Set([...y,xt(p)])]}function s(u,b){const p=xt(b);if(!p)throw new Error("El nuevo nombre de la etiqueta no puede estar vacío");return l(u,p)}function i(u,b){let p=0;for(const d of u)xt(d)!==xt(b)&&(p+=l(d,xt(b)).cambiados);return{cambiados:p}}function r(u){return l(u,null)}function l(u,b){let p=0;const d=t.get("expenses").map(S=>{const w=n(S.tags,u,b);return w!==S.tags&&(p+=1),w===S.tags?S:{...S,tags:w}});t.set("expenses",d);const h=t.get("transacciones").map(S=>{const w=n(S.tags,u,b);return w!==S.tags&&(p+=1),w===S.tags?S:{...S,tags:w}});t.set("transacciones",h);const y=t.get("loans").map(S=>{const w=n(S.tags,u,b);return w!==S.tags&&(p+=1),w===S.tags?S:{...S,tags:w}});t.set("loans",y);const I=t.get("nominas").map(S=>{const w=n(S.tags,u,b);return w!==S.tags&&(p+=1),w===S.tags?S:{...S,tags:w}});t.set("nominas",I);const A=t.get("config"),f=xt(u),g=S=>{const w=(S??[]).map(xt);if(!w.includes(f))return S??[];const C=w.filter(z=>z!==f);return b===null?[...new Set(C)]:[...new Set([...C,b])]},m={},$=g(A.activeTagsFilter),v=g(A.tagCategorias),x=g(A.tagGrupos);return $!==A.activeTagsFilter&&(m.activeTagsFilter=$),v!==A.tagCategorias&&(m.tagCategorias=v),x!==A.tagGrupos&&(m.tagGrupos=x),Object.keys(m).length>0&&t.patchConfig(m),{cambiados:p}}return{uso:e,todas:a,soloEn:o,renombrar:s,fusionar:i,eliminar:r}}const ra="financeapp_session",Ml=["local","dropbox","firebase"];function Cl(t){if(!t)return null;try{const e=JSON.parse(t);if(!e||!Ml.includes(e.modo))return null;const a=Number(e.creadaEn),o=Number(e.ultimoUso);return!Number.isFinite(a)||!Number.isFinite(o)?null:{modo:e.modo,...typeof e.email=="string"?{email:e.email}:{},...typeof e.passphrase=="string"?{passphrase:e.passphrase}:{},creadaEn:a,ultimoUso:o}}catch{return null}}function jl({storage:t,autoLogoutMinutos:e=()=>0,ahora:a=()=>Date.now()}={}){const o=()=>t??(typeof localStorage<"u"?localStorage:null);function n(d){const h=o();if(h)try{d?h.setItem(ra,JSON.stringify(d)):h.removeItem(ra)}catch{}}function s(){const d=o();if(!d)return null;try{return Cl(d.getItem(ra))}catch{return null}}function i(){const d=s();return d?(a()-d.ultimoUso)/6e4:null}function r(){const d=e();if(!Number.isFinite(d)||d<=0)return!1;const h=i();return h!==null&&h>=d}function l(){const d=s();return d?r()?(n(null),null):d:null}function u(d){const h=a(),y={modo:d.modo,...d.email?{email:d.email}:{},...d.passphrase?{passphrase:d.passphrase}:{},creadaEn:h,ultimoUso:h};return n(y),y}function b(){const d=s();d&&n({...d,ultimoUso:a()})}function p(){n(null)}return{abrir:u,leer:l,tocar:b,cerrar:p,caducada:r,inactividadMinutos:i,get activa(){return l()!==null}}}const Wo=["pointerdown","keydown","visibilitychange"];function zl({sesion:t,onCaducada:e,intervaloMs:a=3e4,setIntervalImpl:o=setInterval,clearIntervalImpl:n=clearInterval,target:s=typeof document<"u"?document:void 0}){let i=!0;const r=()=>{i&&t.tocar()};for(const b of Wo)s==null||s.addEventListener(b,r);const l=o(()=>{i&&t.caducada()&&(u(),t.cerrar(),e())},a);function u(){if(i){i=!1,n(l);for(const b of Wo)s==null||s.removeEventListener(b,r)}}return u}const El=[{minutos:0,etiqueta:"Nunca (solo manualmente)"},{minutos:15,etiqueta:"Tras 15 minutos de inactividad"},{minutos:60,etiqueta:"Tras 1 hora de inactividad"},{minutos:480,etiqueta:"Tras 8 horas de inactividad"},{minutos:10080,etiqueta:"Tras 7 días de inactividad"}];function Qo(){if(typeof localStorage<"u"){const d=rn();d.length>0&&console.info(`[FinanceApp] Recuperadas claves escritas fuera del espacio de nombres: ${d.join(", ")}`)}const t=cn({adapter:nn()}),{applied:e}=t.load();e.length>0&&console.info(`[FinanceApp] Migraciones aplicadas: ${e.join(", ")} (esquema v${Kt})`);const a=un(t);Cs(d=>a.isEnabled(d));const o=jl({autoLogoutMinutos:()=>{var h,y;const d=(y=(h=globalThis.State)==null?void 0:h.get)==null?void 0:y.call(h,"config");return Number((d==null?void 0:d.autoLogoutMinutos)??t.get("config").autoLogoutMinutos??0)}}),n=Sl(t),s=wl(t),i=kn(n),r=In(t),l=bn({isEnabled:d=>a.isEnabled(d)}),u=gn({flags:a,rutasExtra:()=>l.flagPorRuta()}),b=vn({flags:a,onChange:()=>{var d,h;l.attachToShell(),u.apply(),(h=(d=globalThis.Router)==null?void 0:d.rerender)==null||h.call(d)}}),p=()=>{var h,y,I,A,f,g;const d=globalThis;if((y=(h=d.State)==null?void 0:h.load)==null||y.call(h),((A=(I=d.Router)==null?void 0:I.current)==null?void 0:A.call(I))==="dashboard")try{(g=(f=d.DashboardModule)==null?void 0:f.render)==null||g.call(f)}catch(m){console.error("[FinanceApp] No se ha podido repintar el cuadro de mando tras el cambio:",m)}};return l.register(fi({store:t,onDatosCambiados:p})),l.register(wi({store:t,onDatosCambiados:p})),l.register(Gi({store:t,onDatosCambiados:p})),l.register(dr({store:t,ledger:n,mostrarObjetivos:()=>a.isEnabled("goals"),onDatosCambiados:p})),l.register(Zn({ledger:n,tags:s,precision:i,adjuster:r,accounts:()=>t.get("accounts"),estimaciones:()=>t.get("expenses"),onDatosCambiados:p})),l.register(Al({store:t,onDatosCambiados:p})),l.register($r({store:t,onDatosCambiados:p})),l.register(ri({store:t,onDatosCambiados:p})),l.register(br({store:t})),l.register(ei({store:t,onDatosCambiados:p})),{version:Kt,core:fs,engine:{generarExtracto:Jt,recomputarSaldoAcum:bs,saldoHoy:hs,sumarPorTags:Na,providers:{proyectarGastos:Yt,proyectarPrestamos:ja,proyectarTransferencias:za,proyectarNominas:Pa,proyectarInteresesCuentas:Fa,proyectarAportaciones:Ea,proyectarRetencionesFiscales:_a,proyectarInflacionGastos:Ta,proyectarPerdidaAhorro:Da},analysis:Is,margins:ws,optimizer:js,dashboard:Bs},store:t,flags:a,featureRegistry:{all:Ct,porGrupo:oo},ui:{openFeatures:b.open,applyGating:u.apply,watchGating:()=>u.observar()},app:l,session:Object.assign(o,{vigilar:d=>zl({sesion:o,onCaducada:d}),opciones:El}),accounting:{ledger:n,tags:s,precision:i,adjuster:r,sugerirAjuste:Ye}}}function Fl(){try{const t=Qo();return window.FinanceApp=t,t}catch(t){const e=t;return window.FinanceAppError={mensaje:(e==null?void 0:e.message)??String(t),stack:e==null?void 0:e.stack},console.error("[FinanceApp] El paquete nuevo no pudo arrancar:",t),null}}const Ae=typeof window<"u"?Fl():null;if(Ae){let t=!1;const e=()=>{Ae.app.attachToShell(),Ae.ui.applyGating(),t||(t=!0,Ae.ui.watchGating())};document.readyState==="loading"?document.addEventListener("DOMContentLoaded",e,{once:!0}):e(),document.addEventListener("click",a=>{const o=a.target;o!=null&&o.closest(".nav-btn[data-view]")&&setTimeout(e,0)})}return $t.bootstrap=Qo,Object.defineProperty($t,Symbol.toStringTag,{value:"Module"}),$t}({});
