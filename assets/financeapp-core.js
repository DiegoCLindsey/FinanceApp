var FinanceAppBundle=function(Ie){"use strict";function W(t){const e=t.getFullYear(),a=String(t.getMonth()+1).padStart(2,"0"),o=String(t.getDate()).padStart(2,"0");return`${e}-${a}-${o}`}function O(t){const[e,a,o]=t.split("-").map(Number);return new Date(e,a-1,o)}function K(){return W(new Date)}function Ce(t,e){return new Date(t,e+1,0).getDate()}function ua(t,e,a){return W(new Date(t,e,Math.min(a,Ce(t,e))))}function ie(t,e,a){if(!a)return null;if(a.startsWith("dia:")){const o=a.slice(4);if(o==="ultimo")return W(new Date(t,e+1,0));const n=parseInt(o);if(!isNaN(n))return ua(t,e,n)}if(a.startsWith("nthweekday:")){const o=a.split(":"),n=parseInt(o[1]),s=parseInt(o[2]);if(n===-1){const r=new Date(t,e+1,0);for(;r.getDay()!==s;)r.setDate(r.getDate()-1);return W(r)}const i=new Date(t,e,1);for(;i.getDay()!==s;)i.setDate(i.getDate()+1);return i.setDate(i.getDate()+(n-1)*7),i.getMonth()!==e&&i.setDate(i.getDate()-7),W(i)}return null}function pa(t,e){if(!e)return t;const a=O(t);return ie(a.getFullYear(),a.getMonth(),e)??t}const en=["domingo","lunes","martes","miércoles","jueves","viernes","sábado"],an={"-1":"último",1:"1º",2:"2º",3:"3º",4:"4º",5:"5º"};function Se(t){if(!t)return"";if(t.startsWith("dia:")){const e=t.slice(4);return e==="ultimo"?"Último día del mes":`Día ${e} del mes`}if(t.startsWith("nthweekday:")){const e=t.split(":"),a=e[1],o=parseInt(e[2]);return`${an[a]||a+"º"} ${en[o]} del mes`}return t}function Ht(t,e){const a=Date.UTC(t.getFullYear(),t.getMonth(),t.getDate()),o=Date.UTC(e.getFullYear(),e.getMonth(),e.getDate());return Math.round((o-a)/864e5)}function Gt(t){const e=O(t),a=e.getDay()===0?0:7-e.getDay();return e.setDate(e.getDate()+a),W(e)}function ma(t,e){const a=O(t);return a.setDate(a.getDate()+e),W(a)}function _t(t,e,a){const o=Math.max(1,a),n=t.getFullYear(),s=t.getMonth(),i=(e.getFullYear()-n)*12+(e.getMonth()-s);if(i<=0)return{year:n,month:s};const r=s+Math.floor(i/o)*o;return{year:n+Math.floor(r/12),month:r%12}}function it(t){return Math.sign(t)*Math.round(Math.abs(t)*100)}function J(t){return t/100}function G(t){return J(it(t))}function P(t){return new Intl.NumberFormat("es-ES",{style:"currency",currency:"EUR"}).format(t||0)}function fa(t){return(t||0).toFixed(2)+"%"}function Ct(t,e,a){const o=e/100/12;return o===0?t/a:t*o*Math.pow(1+o,a)/(Math.pow(1+o,a)-1)}function ga(t,e,a,o=0){const n=Ct(t,e,a),s=t*(1-o/100);let i=e/100/12;for(let r=0;r<200;r++){const l=n*(1-Math.pow(1+i,-a))/i-s,m=n*(a*Math.pow(1+i,-(a+1))/i-(1-Math.pow(1+i,-a))/(i*i)),d=i-l/m;if(Math.abs(d-i)<1e-10){i=d;break}i=d}return(Math.pow(1+i,12)-1)*100}function va(t,e,a,o,n=0,s=[],i={}){const r=[];let c=t;const l=O(o),m=e/100/12;let d=a,u=Ct(c,e,d);const v=[...s].sort((b,x)=>b.fecha.localeCompare(x.fecha));let g=0;for(let b=1;b<=a*2&&c>.01;b++){const x=new Date(l);l.setMonth(l.getMonth()+1);const f=pa(W(x),i.diaPago||"");for(;g<v.length&&v[g].fecha<=f;){const C=v[g],w=C.cantidad*(n/100);if(c-=C.cantidad,c=Math.max(0,c),C.tipo==="plazo"?d=Math.ceil(-Math.log(1-c*m/u)/Math.log(1+m)):(d=a-b+1,u=Ct(c,e,d)),r.push({mes:"AMORT",fecha:C.fecha,cuota:0,interes:0,amortizacion:C.cantidad,comisionAmort:w,capitalPendiente:c,esAmortizacion:!0,simulacion:C.simulacion||!1}),g++,c<.01)break}if(c<.01)break;const h=c*m,S=Math.min(u-h,c);if(c-=S,c<.01&&(c=0),r.push({mes:b,fecha:f,cuota:u,interes:h,amortizacion:S,comisionAmort:0,capitalPendiente:c,esAmortizacion:!1,simulacion:!1}),d--,d<=0||c<.01)break}return r}const ba=new Map;function X(t){var x;const e=t.amortizaciones||[],a=`${t.capital}|${t.tin}|${t.meses}|${t.fechaInicio}|${t.comisionAmort||0}|${t.comisionApertura||0}|${t.diaPago||""}|${e.slice().sort((f,h)=>`${f.fecha}|${f.cantidad}|${f.tipo||""}`.localeCompare(`${h.fecha}|${h.cantidad}|${h.tipo||""}`)).map(f=>`${f.fecha}:${f.cantidad}:${f.tipo||""}`).join(";")}`,o=ba.get(a);if(o)return o;const{capital:n,tin:s,meses:i,fechaInicio:r,comisionAmort:c,comisionApertura:l}=t,m=va(n,s,i,r,c||0,e,t),d=m.reduce((f,h)=>f+h.interes,0),u=m.reduce((f,h)=>f+h.comisionAmort,0),v=n*((l||0)/100),g=m.filter(f=>!f.esAmortizacion),b={cuota:Ct(n,s,i),totalIntereses:d,tae:ga(n,s,i,l||0),costoTotal:d+u+v,comAp:v,totalComAm:u,fechaFin:((x=g.slice(-1)[0])==null?void 0:x.fecha)||"",mesesReales:g.length,tabla:m};return ba.set(a,b),b}function ha(t){const e=X(t),a=X({...t,amortizaciones:[]}),o=a.totalIntereses-e.totalIntereses,n=a.mesesReales-e.mesesReales,s=e.totalComAm;return{...e,sinAmort:a,ahorroIntereses:o,ahorroTiempo:n,costeTotalAmort:s,ahorroNeto:o-s,totalPagado:t.capital+e.totalIntereses+e.comAp+e.totalComAm}}function gt(t,e,a){if(!t||t.length===0)return 1;const o=O(e),n=O(a);if(n<=o)return 1;const s=[...t].sort((c,l)=>c.year-l.year);let i=1,r=new Date(o);for(;r<n;){const c=r.getFullYear(),l=s.filter(b=>b.year<=c),m=l.length>0?l[l.length-1]:s[0],d=(m?m.tasa:0)/100,u=new Date(c+1,0,1),v=u<n?u:n,g=Ht(r,v);i*=Math.pow(1+d,g/365.25),r=v}return i}function ya(t,e,a,o=0){const n=O(e),s=O(a);if(s<=n)return o;const i=Ht(n,s),r=t?[...t].sort((m,d)=>m.year-d.year):[];let c=0,l=new Date(n);for(;l<s;){const m=l.getFullYear(),d=new Date(m+1,0,1),u=d<s?d:s,v=Ht(l,u),g=r.filter(f=>f.year<=m),b=g.length>0?g[g.length-1]:null,x=b!==null?b.tasa:o;c+=x*v,l=u}return i>0?c/i:o}function $a(t,e){return((1+t/100)/(1+e/100)-1)*100}function on(t,e,a,o){const n=gt(e,a,o);return n>0?t/n:t}function nn(t,e){const a=e.saludUmbralAhorroVerde??20,o=e.saludUmbralAhorroAmarillo??10,n=e.saludUmbralDTIVerde??30,s=e.saludUmbralDTIAmarillo??40,i=e.saludRegla||[50,30,20],r=e.saludExcluirHipoteca||!1,{ingresos:c=0,cuotas:l=0,cuotasHipoteca:m=0,gastosBasicos:d=0,gastosOtros:u=0,amortizaciones:v=0}=t,g=c-l-v-d-u,b=g,x=c>0?b/c*100:null,f=r?l-m:l,h=c>0?f/c*100:null,S=c>0?l/c*100:null,C=c>0?(d+l+v)/c*100:null,w=c>0?u/c*100:null,$=(_,I,y)=>_===null?"neutral":_>=I?"verde":_>=y?"amarillo":"rojo",M=(_,I,y)=>_===null?"neutral":_<=I?"verde":_<=y?"amarillo":"rojo";return{ingresos:c,cuotas:l,cuotasHipoteca:m,gastosBasicos:d,gastosOtros:u,amortizaciones:v,ahorroBruto:g,ahorroReal:b,tasaAhorro:x,dti:h,dtiTotal:S,excluyeHipoteca:r,pctNecesidades:C,pctDeseos:w,semAhorro:$(x,a,o),semDTI:M(h,n,s),semNecesidades:M(C,i[0],i[0]+15),semDeseos:M(w,i[1],i[1]+10),semAhorroRegla:$(x,i[2],i[2]*.5),umbralAhorroVerde:a,umbralAhorroAmarillo:o,umbralDTIVerde:n,umbralDTIAmarillo:s,regla:i}}function rt(t){return(t==null?void 0:t.modeloFondo)||(t!=null&&t.esFondoPension?"pension":"cuenta")}function vt(t){const e=[...t.historicoSaldos||[]].sort((a,o)=>o.fecha.localeCompare(a.fecha));return e.length>0?e[0].saldo:t.saldoInicial||0}function Vt(t,e){const a=Ae(t,e);return a?a.saldo:e>=(t.fechaInicialSaldo||"")&&t.saldoInicial||0}function Ae(t,e){const a=t.fechaInicialSaldo||"";if(!a||e>=a){const o=[];return a&&o.push({fecha:a,saldo:t.saldoInicial||0,prioridad:-1}),(t.historicoSaldos||[]).forEach((n,s)=>{n.fecha>=a&&o.push({...n,prioridad:s})}),o.sort((n,s)=>s.fecha.localeCompare(n.fecha)||s.prioridad-n.prioridad),o.find(n=>n.fecha<=e)??null}else return[...t.historicoSaldos||[]].sort((n,s)=>s.fecha.localeCompare(n.fecha)).find(n=>n.fecha<=e)??null}function xa(t,e){let a="";for(const o of t){const n=Ae(o,e);n&&n.fecha>a&&(a=n.fecha)}return a}function sn(t){const e=a=>!a.simulacion;return{loans:t.loans.filter(e).map(a=>({...a,amortizaciones:(a.amortizaciones||[]).filter(e)})),expenses:t.expenses.filter(e),nominas:t.nominas.filter(e),accounts:t.accounts.filter(e)}}function rn(t){const e=a=>!!a.simulacion;return t.loans.some(a=>e(a)||(a.amortizaciones||[]).some(e))||t.expenses.some(e)||t.nominas.some(e)||t.accounts.some(e)}function re(t){var e,a;return((e=t.find(o=>o.esPorDefecto))==null?void 0:e._id)??((a=t[0])==null?void 0:a._id)??"default"}function cn(t,e){if(e<=0)return[];const a=t<0?-1:1,o=Math.abs(t),n=Math.floor(o/e),s=o-n*e;return Array.from({length:e},(i,r)=>a*(n+(r<s?1:0)))}function ln(t,e,a,o){if(a===0)return{ids:t,cts:e};const n=t.indexOf(o);if(n>=0){const s=[...e];return s[n]+=a,{ids:t,cts:s}}return{ids:[...t,o],cts:[...e,a]}}function Pt(t,e,a){const o=it(t);if(!e||e.participantes.length===0)return[{personaId:a,importe:J(o)}];const n=e.participantes.map(d=>d.personaId);if(e.modo==="partesIguales"){const d=cn(o,n.length);return n.map((u,v)=>({personaId:u,importe:J(d[v])}))}const s=e.participantes.map(d=>{const u=Math.max(0,d.valor??0);return e.modo==="porcentaje"?Math.round(o*u/100):it(u)}),i=s.reduce((d,u)=>d+u,0);if(Math.abs(i)>Math.abs(o)&&i!==0){const d=o/i,u=s.map(g=>Math.round(g*d)),v=u.reduce((g,b)=>g+b,0);return u.length>0&&(u[0]+=o-v),n.map((g,b)=>({personaId:g,importe:J(u[b])}))}const c=o-i,{ids:l,cts:m}=ln(n,s,c,a);return l.map((d,u)=>({personaId:d,importe:J(m[u])}))}function Me(t,e){return t.find(a=>a._id===e||e.startsWith(`${a._id}_`))}function dn(t,e,a){const o=re(a),n=new Map,s=i=>{let r=n.get(i);return r||(r={personaId:i,pago:0,consumo:0,ingresos:0},n.set(i,r)),r};for(const i of a)s(i._id);for(const i of t){const r=Math.abs(i.cuantia);if(r!==0){if(i.sourceType==="expense"&&i.tipo==="gasto"){const c=Me(e.expenses,i.sourceId);for(const l of Pt(r,c==null?void 0:c.repartoPago,o))s(l.personaId).pago+=l.importe;for(const l of Pt(r,c==null?void 0:c.repartoConsumo,o))s(l.personaId).consumo+=l.importe}else if(i.sourceType==="loan"){const c=Me(e.loans,i.sourceId);for(const l of Pt(r,c==null?void 0:c.repartoPago,o))s(l.personaId).pago+=l.importe;for(const l of Pt(r,c==null?void 0:c.repartoConsumo,o))s(l.personaId).consumo+=l.importe}else if(i.sourceType==="nomina"&&i.tipo==="ingreso"){const c=Me(e.nominas,i.sourceId);for(const l of Pt(r,c==null?void 0:c.repartoConsumo,o))s(l.personaId).ingresos+=l.importe}}}return[...n.values()]}function Ee(t,e,a){const o=n=>!n||n.participantes.length===0?[a]:n.participantes.map(s=>s.personaId);return new Set([...o(t),...o(e)])}const bt=[[0,19],[12450,24],[20200,30],[35200,37],[6e4,45],[3e5,47]];function lt(t,e){const a=[...e].sort((s,i)=>s[0]-i[0]);let o=0,n=t;for(let s=a.length-1;s>=0;s--){const[i,r]=a[s];n<=i||(o+=(n-i)*(r/100),n=i)}return o}function wa(t,e){const a=Math.max(0,t-(e||0)),o=t*.0635,n=Math.min(2e3,a),s=Math.max(0,a-o-n),i=s<=15876?7302:s<=21622?Math.max(0,7302-1.75*(s-15876)):0;return{baseIRPF:a,cotizSS:o,gastosArt19:n,RNT:s,reducArt20:i,baseImponible:Math.max(0,s-i)}}function ht(t,e){return wa(t,e).baseImponible}function Ia(t,e){return lt(t,e)/12}const Ut=[[0,19],[6e3,21],[5e4,23],[2e5,27],[3e5,28]];function _e(t,e){if(!t||t<=0)return 0;const a=e||Ut;let o=0,n=t;for(let s=0;s<a.length;s++){const[i,r]=a[s],c=s<a.length-1?a[s+1][0]:1/0,l=Math.min(n,c-i);if(!(l<=0)&&(o+=l*(r/100),n-=l,n<=0))break}return o}function ce(t,e){if(rt(t)!=="inversion")return null;const a=vt(t),o=(t.aportaciones||[]).reduce((i,r)=>i+r.cantidad,0)||t.saldoInicial||0,n=Math.max(0,a-o),s=_e(n,e);return{saldo:a,costBase:o,plusvalia:n,impuesto:s,neto:a-s}}function Pe(t,e=new Date){var u;if(rt(t)!=="pension")return null;const a=t.bloqueoMeses||120,o=vt(t),n=W(new Date(e.getFullYear(),e.getMonth()-a,e.getDate())),s=[...t.aportaciones||[]].sort((v,g)=>v.fecha.localeCompare(g.fecha));let i=0;const r=s.reduce((v,g)=>v+g.cantidad,0);for(const v of s)v.fecha<=n&&(i+=v.cantidad);const c=Math.max(0,o-r),l=r>0?i/r:0,m=Math.min(o,i+c*l),d=Math.max(0,o-m);return{saldo:o,disponible:m,bloqueado:d,costBase:r,beneficio:c,numAportaciones:s.length,proxDesbloqueo:((u=s.find(v=>v.fecha>n))==null?void 0:u.fecha)||null}}function Ca(t,e,a){const o=a!==void 0?a:t.impuestoRetirada;if(rt(t)!=="pension"||!o)return 0;const n=vt(t);if(n<=0)return 0;const s=(t.aportaciones||[]).reduce((l,m)=>l+m.cantidad,0),i=Math.max(0,n-s);if(i<=0)return 0;const r=i/n;return+(e*r*o/100).toFixed(2)}function Fe(t,e,a){var c;const o=t.grupoNomina;if(!o)return t.impuestoRetirada||0;const s=(e||[]).filter(l=>(l.grupoNomina||"")===o&&l.activo!==!1).reduce((l,m)=>l+(m.bruto||0)*(m.nPagas||12),0),i=[...a||[]].sort((l,m)=>l[0]-m[0]);let r=((c=i[0])==null?void 0:c[1])||19;for(const[l,m]of i)if(s>=l)r=m;else break;return r}const un=Object.freeze(Object.defineProperty({__proto__:null,TRAMOS_AHORRO_DEFAULT:Ut,TRAMOS_IRPF_DEFAULT:bt,agregarPorPersona:dn,ajustarFechaPago:pa,ajustarPrecioReal:on,arranqueMensual:_t,calcBaseImponibleTrabajo:ht,calcFactorInflacion:gt,calcFondoInversion:ce,calcFondosPension:Pe,calcGananciasCapital:_e,calcIRPF:lt,calcImpuestoPension:Ca,calcInflacionMediaAnual:ya,calcSaludFinanciera:nn,calcTAE:ga,calcTipoMarginalPension:Fe,calcTipoRealFisher:$a,calcularReparto:Pt,clampedDate:ua,cuotaMensual:Ct,desgloseBaseTrabajo:wa,diasEntre:Ht,entradaSaldo:Ae,fechaUltimoSaldoConocido:xa,finDeSemana:Gt,formatEUR:P,formatLocalDate:W,formatPct:fa,fromCents:J,haySimulaciones:rn,idPersonaPorDefecto:re,labelDiaPago:Se,lastDayOfMonth:Ce,modeloFondoDe:rt,parseLocalDate:O,personasImplicadas:Ee,resolverDiaEfectivo:ie,resumenPrestamo:X,resumenPrestamoConAhorro:ha,retencionMensual:Ia,roundMoney:G,saldoEnFecha:Vt,saldoRealCuenta:vt,sinSimulaciones:sn,sumarDias:ma,tablaAmortizacion:va,toCents:it,todayISO:K},Symbol.toStringTag,{value:"Module"}));function Yt(t,e,a=null){const o=[],n=O(e.start),s=O(e.end);for(const i of t){if(!i.activo||a&&a.length>0&&!a.includes(i.cuenta||"default"))continue;const r=O(i.fechaInicio||e.start),c=i.fechaFin?O(i.fechaFin):s,l=i.cuantia,m=d=>o.push({fecha:d,concepto:i.concepto,cuantia:l,tipo:i.tipo,tags:i.tags||[],cuenta:i.cuenta||"default",sourceId:i._id,sourceType:"expense"});if(i.tipoFrecuencia==="extraordinario")r>=n&&r<=s&&r<=c&&m(i.fechaInicio);else if(i.tipoFrecuencia==="mensual"){const d=Math.max(1,i.frecuencia||1);let{year:u,month:v}=_t(r,n,d);const g=Math.ceil(240/d)+2;for(let b=0;b<g;b++){const x=ie(u,v,i.diaPago||"")||(()=>{const h=r.getDate(),S=new Date(u,v+1,0).getDate();return W(new Date(u,v,Math.min(h,S)))})(),f=O(x);if(f>s||f>c)break;f>=n&&f>=r&&m(x),v+=d,v>=12&&(u+=Math.floor(v/12),v=v%12)}}else if(i.tipoFrecuencia==="diaria"){const d=Math.max(1,i.frecuencia||1)*864e5;let u=new Date(Math.max(r.getTime(),n.getTime()));if(r<n){const v=Math.ceil((n.getTime()-r.getTime())/d);u=new Date(r.getTime()+v*d)}for(;u<=s&&u<=c;)m(W(u)),u=new Date(u.getTime()+d)}}return o}function De(t,e,a=null){const o=[];for(const n of t){if(!n.activo||a&&a.length>0&&!a.includes(n.cuenta||"default"))continue;const{tabla:s}=X(n);for(const i of s)i.fecha>=e.start&&i.fecha<=e.end&&(i.esAmortizacion?o.push({fecha:i.fecha,concepto:`Amort. ${n.nombre}`,cuantia:-(i.amortizacion+i.comisionAmort),tipo:"gasto",tags:["amortizacion",...n.tags||[]],cuenta:n.cuenta||"default",sourceId:n._id,sourceType:"loan-amort",simulacion:i.simulacion||!1}):o.push({fecha:i.fecha,concepto:`Cuota ${n.nombre}`,cuantia:-i.cuota,tipo:"gasto",tags:["prestamo",...n.tags||[]],cuenta:n.cuenta||"default",sourceId:n._id,sourceType:"loan",simulacion:n.simulacion||!1}))}return o}function Sa(t,e,a=null,o={accounts:[]}){const n=[],s=O(e.start),i=O(e.end),r=o.accounts||[],c=o.nominas||[],l=o.resolverTramosIRPF||(()=>bt),m=o.resolverTramosGanancias||(()=>Ut),d=u=>{var v;return((v=r.find(g=>g._id===u))==null?void 0:v.nombre)??u};for(const u of t){if(!u.activo||u.tipo!=="transferencia"||a&&a.length>0&&!(a.includes(u.cuenta||"default")||a.includes(u.cuentaDestino||"default")))continue;const v=O(u.fechaInicio||e.start),g=u.fechaFin?O(u.fechaFin):i,b=x=>{const f=r.find(E=>E._id===(u.cuenta||"default")),h=r.find(E=>E._id===(u.cuentaDestino||"default")),S=rt(f),C=rt(h),w=S==="inversion"&&C==="inversion"||S==="pension"&&C==="pension",$=["transferencia",...w?["traspaso"]:[],...u.tags||[]],M=w?"traspaso-out":"transfer-out",_=w?"traspaso-in":"transfer-in",I=!a||a.length===0||a.includes(u.cuenta||"default"),y=!a||a.length===0||a.includes(u.cuentaDestino||"default");if(I&&n.push({fecha:x,concepto:`Transf. → ${d(u.cuentaDestino||"default")}: ${u.concepto}`,cuantia:u.cuantia,tipo:"gasto",tags:$,cuenta:u.cuenta||"default",sourceId:u._id,sourceType:M}),y&&n.push({fecha:x,concepto:`Transf. ← ${d(u.cuenta||"default")}: ${u.concepto}`,cuantia:u.cuantia,tipo:"ingreso",tags:$,cuenta:u.cuentaDestino||"default",sourceId:u._id,sourceType:_}),I&&!w&&f){if(S==="inversion"){const E=parseInt(x.slice(0,4)),A=ce(f,m(E));if(A&&A.saldo>0&&A.plusvalia>0){const F=Math.min(1,u.cuantia/A.saldo),D=A.plusvalia*F*.19;D>.01&&n.push({fecha:x,concepto:`Retención IRPF reembolso ${f.nombre} (19% s/plusvalía)`,cuantia:D,tipo:"gasto",tags:["impuesto","capital-mobiliario","retencion"],cuenta:u.cuenta||"default",sourceId:u._id,sourceType:"investment-tax"})}}else if(S==="pension"){const E=l(parseInt(x.slice(0,4))),A=Fe(f,c,E),F=Ca(f,u.cuantia,A||void 0);if(F>0){const z=f.grupoNomina?`IRPF rescate ${f.nombre} (tipo marginal grupo "${f.grupoNomina}": ${A}%)`:`Retención rescate ${f.nombre} (${f.impuestoRetirada}% s/beneficio)`;n.push({fecha:x,concepto:z,cuantia:F,tipo:"gasto",tags:["impuesto","rendimientos-trabajo","pension"],cuenta:u.cuenta||"default",sourceId:u._id,sourceType:"pension-tax"})}}}};if(u.tipoFrecuencia==="extraordinario")v>=s&&v<=i&&v<=g&&b(u.fechaInicio);else if(u.tipoFrecuencia==="mensual"){const x=Math.max(1,u.frecuencia||1);let{year:f,month:h}=_t(v,s,x);const S=Math.ceil(240/x)+2;for(let C=0;C<S;C++){const w=ie(f,h,u.diaPago||"")||(()=>{const M=v.getDate(),_=new Date(f,h+1,0).getDate();return W(new Date(f,h,Math.min(M,_)))})(),$=O(w);if($>i||$>g)break;$>=s&&$>=v&&b(w),h+=x,h>=12&&(f+=Math.floor(h/12),h=h%12)}}else if(u.tipoFrecuencia==="diaria"){const x=Math.max(1,u.frecuencia||1)*864e5;let f=new Date(Math.max(v.getTime(),s.getTime()));if(v<s){const h=Math.ceil((s.getTime()-v.getTime())/x);f=new Date(v.getTime()+h*x)}for(;f<=i&&f<=g;)b(W(f)),f=new Date(f.getTime()+x)}}return n}function Aa(t,e,a=null){const o=[],n=O(e.start),s=O(e.end);for(const i of t){const r=rt(i);if(r==="cuenta"||!i.activo)continue;const c=i.planAportaciones||[];for(const l of c){if(!l.importe||l.importe<=0)continue;const m=O(l.fechaInicio||e.start),d=l.fechaFin?O(l.fechaFin):s,u=l.cuentaOrigen||"default",v=!a||!a.length||a.includes(u),g=!a||!a.length||a.includes(i._id),b=r==="pension"?"pension":"capital-mobiliario",x=w=>{v&&o.push({fecha:w,concepto:`Aportación → ${i.nombre}`,cuantia:l.importe,tipo:"gasto",tags:["aportacion","transferencia",b],cuenta:u,sourceId:l._id,sourceType:"aportacion-out"}),g&&o.push({fecha:w,concepto:`Aportación ${i.nombre} (${l.periodicidad||"mensual"})`,cuantia:l.importe,tipo:"ingreso",tags:["aportacion","transferencia",b],cuenta:i._id,sourceId:l._id,sourceType:"aportacion-in"})},f={mensual:1,trimestral:3,semestral:6,anual:12}[l.periodicidad||"mensual"]||1;let{year:h,month:S}=_t(m,n,f);const C=Math.ceil(240/f)+2;for(let w=0;w<C;w++){const $=new Date(h,S+1,0).getDate(),M=W(new Date(h,S,Math.min(m.getDate(),$))),_=O(M);if(_>s||_>d)break;_>=n&&_>=m&&x(M),S+=f,S>=12&&(h+=Math.floor(S/12),S=S%12)}}}return o}function Ma(t,e,a=null,o=[]){const n=[];for(const s of t){if(!s.activo||!s.interes||s.interes<=0||a&&a.length>0&&!a.includes(s._id))continue;const i=O(e.start),r=O(e.end),c=s.periodoCobro||"mensual",l=c==="mensual",m=l?null:{diario:864e5,semanal:7*864e5}[c]||864e5,d=l?1/12:m/(365.25*864e5);let u=Vt(s,e.start);const v=o.filter(x=>x.cuenta===s._id).map(x=>({fecha:x.fecha,delta:x.tipo==="ingreso"?Math.abs(x.cuantia):-Math.abs(x.cuantia)})).sort((x,f)=>x.fecha.localeCompare(f.fecha));let g=0,b=new Date(i);for(;b<=r;){const x=l?new Date(b.getFullYear(),b.getMonth()+1,b.getDate()):new Date(b.getTime()+m),f=new Date(Math.min(x.getTime(),r.getTime()+1)),h=W(f);let S=0;for(;g<v.length&&v[g].fecha<h;)S+=v[g].delta,g++;const C=u,w=u+S,$=Math.max(0,(C+w)/2);u=w;const M=l?d:(f.getTime()-b.getTime())/(365.25*864e5),_=$*(Math.pow(1+s.interes/100,M)-1);_>.001&&n.push({fecha:W(b),concepto:`Interés ${s.nombre}`,cuantia:_,tipo:"ingreso",tags:["interes","cuenta"],cuenta:s._id,sourceId:s._id,sourceType:"account-interest"}),b=x}}return n}function Ea(t,e,a,o=null){const n=[],s=e||bt;for(const i of t){if(!i.activo||i.tipo!=="ingreso"||!i.sujetoIRPF)continue;const r=i.cuantia*(i.tipoFrecuencia==="mensual"?12:1),c=Ia(r,s),l={...i,_id:i._id+"_irpf",concepto:`IRPF salario ${i.concepto}`,tipo:"gasto",cuantia:c,tags:["irpf","fiscal"]};n.push(...Yt([l],a,o))}return n}const pn=[5,11,2,8],mn={transporte:"Transporte",restaurante:"Restaurante",otros:"Beneficio"};function Te(t,e,a=null,o=[],n=()=>bt){const s=[],i=O(e.start),r=O(e.end),c=o.length>0,l={};for(const u of t){const v=u.grupoNomina||"";l[v]||(l[v]=[]),l[v].push(u)}for(const u of Object.keys(l))l[u].sort((v,g)=>(g.bruto||0)-(v.bruto||0));function m(u,v){if(!c||!u.mesActualizacionIPC)return u.bruto||0;const g=u.fechaInicio||e.start,b=O(g),x=O(v);let f=0;for(let S=b.getFullYear();S<=x.getFullYear();S++){const C=new Date(S,u.mesActualizacionIPC-1,1);C>b&&C<=x&&f++}if(f===0)return u.bruto||0;const h=W(new Date(b.getFullYear()+f,0,1));return(u.bruto||0)*gt(o,g,h)}function d(u,v){const g=m(u,v),b=(u.retribucionFlexible||[]).reduce((E,A)=>E+(A.importe||0)*12,0),x=Math.max(0,g-b);if(u.irpfModo==="manual")return x*((u.irpfPct||0)/100);const f=n(parseInt(v.slice(0,4))),h=u.grupoNomina||"";if(!h)return lt(ht(g,b),f);const S=l[h].filter(E=>E.activo),C=S.reduce((E,A)=>E+m(A,v),0),w=S.reduce((E,A)=>E+(A.retribucionFlexible||[]).reduce((F,z)=>F+(z.importe||0)*12,0),0),$=Math.max(0,C-w),M=ht(C,w),_=Math.max(0,g-b),I=$>0?M*(_/$):0,y=S.filter(E=>E._id!==u._id&&(E.bruto||0)>(u.bruto||0)).reduce((E,A)=>{const F=(A.retribucionFlexible||[]).reduce((D,T)=>D+(T.importe||0)*12,0),z=Math.max(0,m(A,v)-F);return E+($>0?M*(z/$):0)},0);return lt(y+I,f)-lt(y,f)}for(const u of t){if(!u.activo)continue;const v=u.cuenta||"default";if(a&&a.length>0&&!a.includes(v))continue;const g=Math.max(1,u.nPagas||12),b=O(u.fechaInicio||e.start),x=u.fechaFin?O(u.fechaFin):r,f=h=>{const S=m(u,h),C=d(u,h),w=(u.retribucionFlexible||[]).reduce((F,z)=>F+(z.importe||0)*12,0),$=Math.max(0,S-w),M=(u.ssPct??6.35)/100,_=$*M,I=$/g,y=C/g,E=_/g,A=u.representacion==="simplificado"?I-E-y:I;s.push({fecha:h,concepto:u.nombre,cuantia:A,tipo:"ingreso",cuenta:v,tags:u.tags||[],sourceId:u._id,sourceType:"nomina"}),u.representacion==="detallado"&&(E>0&&s.push({fecha:h,concepto:`SS ${u.nombre}`,cuantia:E,tipo:"gasto",cuenta:v,tags:["seguridad-social","fiscal"],sourceId:u._id+"_ss",sourceType:"nomina"}),y>0&&s.push({fecha:h,concepto:`IRPF ${u.nombre}`,cuantia:y,tipo:"gasto",cuenta:v,tags:["irpf","fiscal"],sourceId:u._id+"_irpf",sourceType:"nomina"}));for(const F of u.retribucionFlexible||[])!F.cuenta||!(F.importe>0)||a&&a.length>0&&!a.includes(F.cuenta)||s.push({fecha:h,concepto:`${u.nombre} — ${mn[F.tipo]||F.tipo}`,cuantia:F.importe,tipo:"ingreso",cuenta:F.cuenta,tags:["retribucion-flexible",F.tipo],sourceId:`${u._id}_flex_${F._id||F.tipo}`,sourceType:"nomina"})};if(g<=12){const h=g===12?1:Math.round(12/g),S=b.getDate();let{year:C,month:w}=_t(b,i,h);for(let $=0;$<300;$++){const M=new Date(C,w+1,0).getDate(),_=new Date(C,w,Math.min(S,M));if(_>r||_>x)break;_>=i&&_>=b&&f(W(_)),w+=h,w>=12&&(C+=Math.floor(w/12),w=w%12)}}else{const h=g-12,S=b.getDate();let{year:C,month:w}=_t(b,i,1);for(let _=0;_<300;_++){const I=new Date(C,w+1,0).getDate(),y=new Date(C,w,Math.min(S,I));if(y>r||y>x)break;y>=i&&y>=b&&f(W(y)),w++,w>=12&&(C++,w=0)}const $=Math.max(b.getFullYear(),i.getFullYear()),M=Math.min((u.fechaFin?x:r).getFullYear(),r.getFullYear());for(let _=$;_<=M;_++)for(const I of pn.slice(0,h)){const y=new Date(_,I,15);y>=i&&y<=r&&y>=b&&y<=x&&f(W(y))}}}return s}function _a(t,e,a,o=null,n="default"){const s=[];if(!e||e.length===0)return s;const i=O(a.start),r=O(a.end),c=K(),l=t.filter(d=>d.activo&&d.tipo==="gasto"&&d.tipoFrecuencia==="mensual");let m=new Date(i.getFullYear(),i.getMonth(),1);for(;m<=r;){const d=m.getFullYear(),u=m.getMonth(),v=d+"-"+String(u+1).padStart(2,"0"),g=v+"-01",b=W(new Date(d,u+1,0)),x=W(new Date(d,u,15));let f=0;for(const h of l){if(o&&o.length>0&&!o.includes(h.cuenta||"default")||h.fechaInicio&&h.fechaInicio>b||h.fechaFin&&h.fechaFin<g)continue;const S=h.fechaInicio||c,C=gt(e,S,x);if(C<=1)continue;const w=Math.max(1,h.frecuencia||1);f+=h.cuantia*(C-1)/w}f>.01&&s.push({fecha:x,concepto:"Incremento coste de vida",cuantia:f,tipo:"gasto",tags:["inflacion"],cuenta:n,sourceId:"inflacion_vida_"+v,sourceType:"inflacion"}),m=new Date(d,u+1,1)}return s}function Pa(t,e,a,o="default"){const n=[];if(!e||e.length===0||t<=0)return n;const s=O(a.start),i=O(a.end),r=[...e].sort((l,m)=>l.year-m.year);let c=new Date(s.getFullYear(),s.getMonth(),1);for(;c<=i;){const l=c.getFullYear(),m=c.getMonth(),d=l+"-"+String(m+1).padStart(2,"0"),u=W(new Date(l,m,15)),v=r.filter(h=>h.year<=l),g=v.length>0?v[v.length-1]:r[0],b=g?g.tasa/100:0,x=Math.pow(1+b,1/12)-1,f=t*x;f>.01&&n.push({fecha:u,concepto:"Pérdida ahorro por inflación",cuantia:f,tipo:"gasto",tags:["inflacion"],cuenta:o,sourceId:"inflacion_ahorro_"+d,sourceType:"inflacion"}),c=new Date(l,m+1,1)}return n}function Fa(t,e){const a=e.fechaReferencia||e.dashboardStart,o=a<e.dashboardStart?e.dashboardStart:a>e.dashboardEnd?e.dashboardEnd:a,n=t.reduce((i,r)=>i+Vt(r,o),0),s=xa(t,o);return{fecha:s&&s<o?s:o,saldo:n,pedida:o}}function Da(t,e,a){const{fecha:o,saldo:n}=Fa(e,a),s=t.filter(m=>m.fecha<o),i=t.filter(m=>m.fecha>=o),r=[];let c=n;for(const m of[...s].reverse()){const d=m.tipo==="ingreso"?Math.abs(m.cuantia):-Math.abs(m.cuantia);r.unshift({...m,delta:d,saldoAcum:c}),c-=d}const l=[];c=n;for(const m of i){const d=m.tipo==="ingreso"?Math.abs(m.cuantia):-Math.abs(m.cuantia);c+=d,l.push({...m,delta:d,saldoAcum:c})}return[...r,...l]}function fn(t,e,a,o=null){const n=e.filter(s=>s.activo&&(!o||o.length===0||o.includes(s._id)));return Da([...t].sort((s,i)=>s.fecha.localeCompare(i.fecha)),n,a)}function Ta(t){const{loans:e,expenses:a,accounts:o,config:n}=t,s=t.filtroAccounts??null,i=t.nominas??[],r=t.inflacionPeriodos??[],c=o.filter(x=>x.activo&&(!s||s.length===0||s.includes(x._id))),l=Fa(c,n),m={start:l.fecha<n.dashboardStart?l.fecha:n.dashboardStart,end:n.dashboardEnd},d=a.filter(x=>x.tipo!=="transferencia"),u=a.filter(x=>x.tipo==="transferencia"),v={accounts:o,nominas:i,resolverTramosIRPF:t.resolverTramosIRPF,resolverTramosGanancias:t.resolverTramosGanancias};let g=[];g=g.concat(Yt(d,m,s)),g=g.concat(De(e,m,s)),g=g.concat(Sa(u,m,s,v)),g=g.concat(Aa(o,m,s));const b=Ma(o,m,s,g);if(g=g.concat(b),g=g.concat(Ea(a,n.tramos_irpf,m,s)),g=g.concat(Te(i,m,s,r,t.resolverTramosIRPF)),n.usarInflacion&&r.length>0){const x=(o.find(S=>S.activo&&S.esCuentaPrincipal)||o.find(S=>S.activo)||{_id:"default"})._id;g=g.concat(_a(d,r,m,s,x));const h=o.filter(S=>S.activo&&(!s||s.length===0||s.includes(S._id))).reduce((S,C)=>S+Vt(C,n.dashboardStart),0);g=g.concat(Pa(h,r,m,x))}return g.sort((x,f)=>x.fecha.localeCompare(f.fecha)),Da(g,c,n).filter(x=>x.fecha>=n.dashboardStart)}function gn(t,e,a=null){const o=K(),s=e.filter(r=>r.activo&&(!a||a.length===0||a.includes(r._id))).reduce((r,c)=>r+vt(c),0),i=t.filter(r=>r.fecha<=o);return i.length===0?s:i[i.length-1].saldoAcum}function za(t,e){const a=new Map;for(const o of t)if(o.tipo===e&&!(o.sourceType==="transfer-out"||o.sourceType==="transfer-in"||o.sourceType==="loan-amort"))for(const n of o.tags||["sin_tag"])a.set(n,(a.get(n)||0)+Math.abs(o.cuantia));return a}function vn(t,e){const a=[];let o=!1;for(let n=0;n<t.length;n++){const s=t[n],i=s.saldoAcum;i<0&&(n===0||t[n-1].saldoAcum>=0)&&a.push({tipo:"saldo_negativo",fecha:s.fecha,saldo:i,mensaje:`Saldo negativo (${P(i)}) a partir del ${s.fecha}`}),e>0&&(i<e&&!o?(o=!0,a.push({tipo:"bajo_colchon",fecha:s.fecha,saldo:i,mensaje:`Saldo por debajo del colchón (${P(i)} < ${P(e)}) desde ${s.fecha}`})):i>=e&&o&&(o=!1,a.push({tipo:"recuperacion_colchon",fecha:s.fecha,saldo:i,mensaje:`Recuperación del colchón el ${s.fecha} (${P(i)})`})))}return a}function bn(t,e){const a=t.filter(i=>i.tipo==="gasto"&&i.sourceType!=="loan-amort").reduce((i,r)=>i+Math.abs(r.cuantia),0),o=O(e.dashboardStart),n=O(e.dashboardEnd),s=Math.max(1,(n.getTime()-o.getTime())/(30.44*864e5));return a/s}function hn(t,e,a=K()){const o=new Set,n=e.map(r=>{const c=r.fechaInicialSaldo||"",l={};c&&c<=a&&(l[c]=r.saldoInicial||0);for(const m of r.historicoSaldos||[])m.fecha<=a&&(!c||m.fecha>=c)&&(l[m.fecha]=m.saldo);return Object.keys(l).forEach(m=>o.add(m)),l}),s={};for(const r of[...o].sort()){let c=0;for(let l=0;l<e.length;l++){const m=Object.entries(n[l]).filter(([d])=>d<=r);m.length>0?(m.sort(([d],[u])=>u.localeCompare(d)),c+=m[0][1]):c+=e[l].saldoInicial||0}s[r]=c}const i=[];for(const[r,c]of Object.entries(s).sort(([l],[m])=>l.localeCompare(m))){const l=t.filter(v=>v.fecha<=r),m=l.length>0?l[l.length-1].saldoAcum:null;if(m===null)continue;const d=c-m,u=m!==0?d/Math.abs(m)*100:0;i.push({cuenta:"Total",fecha:r,estimado:m,real:c,desv:d,pct:u})}return i}const yn=Object.freeze(Object.defineProperty({__proto__:null,calcDesviacion:hn,detectarPuntosCriticos:vn,mediaMensualGastos:bn},Symbol.toStringTag,{value:"Module"}));function Wt(t,e=new Date){const a=W(e),o=new Date(e);o.setMonth(o.getMonth()+1);const n=W(o),s=t.filter(r=>r.basico&&r.activo&&r.tipo==="gasto");return Yt(s,{start:a,end:n}).reduce((r,c)=>r+Math.abs(c.cuantia),0)}function $n(t){return(t||[]).filter(e=>e.basico&&e.activo&&!e.simulacion).reduce((e,a)=>e+Ct(a.capital,a.tin,a.meses),0)}function xn(t,e){return X(t).tabla.filter(a=>!a.esAmortizacion&&a.fecha>=e).length}function ja(t,e,a){return(t||[]).filter(o=>o.basico&&o.activo&&!o.simulacion).reduce((o,n)=>o+Ct(n.capital,n.tin,n.meses)*Math.min(e,xn(n,a)),0)}function qa(t,e,a,o=new Date){if(e.colchonTipo==="fijo"&&(e.colchonFijo||0)>0)return e.colchonFijo;const n=Wt(t,o),s=e.colchonMeses||6;return n*s+ja(a,s,W(o))}function wn(t,e,a,o,n){const i=[...e.colchonPuntos||[]].sort((l,m)=>l.fecha.localeCompare(m.fecha)).filter(l=>l.fecha<=o).pop();if(!i)return qa(t,e,a,n);if(i.tipo==="fijo")return i.importe||0;const r=Wt(t,n),c=i.meses||6;return r*c+ja(a,c,o)}function ze(t,e,a,o,n,s=!1,i){const r=[...t.puntos||[]].sort((m,d)=>m.fecha.localeCompare(d.fecha)),c=r.filter(m=>m.fecha<=n).pop()||(s?r[0]:null);return c?c.tipo==="fijo"?c.importe||0:(Wt(e,i)+$n(o))*(c.meses||1):0}function In(t){return typeof t.delta=="number"?t.delta:t.tipo==="ingreso"?Math.abs(t.cuantia):-Math.abs(t.cuantia)}function Cn(t,e){const a={};for(const o of e)a[o._id]=vt(o);return t.map(o=>(o.cuenta&&a[o.cuenta]!==void 0&&(a[o.cuenta]+=In(o)),{fecha:o.fecha,saldos:{...a}}))}function Sn(t,e,a,o,n,s,i){const r=[];for(const c of(t||[]).filter(l=>l.activo!==!1)){let l=!1;for(let m=0;m<e.length;m++){const d=e[m],u=ze(c,o,n,s,d.fecha,!1,i);if(u<=0){l=!1;continue}const v=!c.cuentas||c.cuentas.length===0?d.saldoAcum:c.cuentas.reduce((g,b)=>{var x,f;return g+(((f=(x=a[m])==null?void 0:x.saldos)==null?void 0:f[b])||0)},0);v<u&&!l?(l=!0,r.push({tipo:"bajo_margen",fecha:d.fecha,saldo:v,target:u,nombre:c.nombre,mensaje:`⚠ ${c.nombre}: ${P(v)} < ${P(u)} desde ${d.fecha}`})):v>=u&&l&&(l=!1,r.push({tipo:"recuperacion_margen",fecha:d.fecha,saldo:v,target:u,nombre:c.nombre,mensaje:`✓ ${c.nombre}: recuperado el ${d.fecha}`}))}}return r}const An=Object.freeze(Object.defineProperty({__proto__:null,calcColchon:qa,calcColchonEnFecha:wn,calcGastoBasicoMensual:Wt,calcMargenEnFecha:ze,detectarCrucesMargenes:Sn,saldosPorCuentaEnExtracto:Cn},Symbol.toStringTag,{value:"Module"}));function Mn(t){if(!t||t.showColchon===!1)return null;const e=t.colchonPuntos??[];return e.length>0?{nombre:"Colchón",puntos:[...e]}:t.colchonTipo==="fijo"&&(t.colchonFijo||0)>0?{nombre:"Colchón",puntos:[{fecha:"1970-01-01",tipo:"fijo",importe:t.colchonFijo}]}:{nombre:"Colchón",puntos:[{fecha:"1970-01-01",tipo:"meses",meses:t.colchonMeses||6}]}}function Ra(t,e){return Ht(O(t),O(e))}const En=["enero","febrero","marzo","abril","mayo","junio","julio","agosto","septiembre","octubre","noviembre","diciembre"];function Na(t,e){const[a,o,n]=t.split("-").map(Number),s=t.slice(0,4)===e.slice(0,4);return`${n} de ${En[o-1]}${s?"":` de ${a}`}`}function La(t){return t<=0?"hoy":t===1?"mañana":t<7?`en ${t} días`:t<14?"en una semana":t<31?`en ${Math.round(t/7)} semanas`:t<45?"en un mes":`en ${Math.round(t/30)} meses`}function _n(t,e={}){const{hoy:a=K(),horizonteCritico:o=365,horizonteAviso:n=120,maximo:s=4,incertidumbre:i}=e,r=[];for(const d of t.puntosCriticos??[])d.tipo==="saldo_negativo"?r.push({id:"saldo-negativo",gravedad:"critico",fecha:d.fecha,distancia:Math.abs(d.saldo),titulo:u=>u?"Podrías quedarte en números rojos":"Te quedas en números rojos",detalle:u=>`El ${u} el saldo proyectado baja a ${P(d.saldo)}.`}):d.tipo==="bajo_colchon"&&r.push({id:"bajo-colchon",gravedad:"aviso",fecha:d.fecha,distancia:Math.abs(d.saldo),titulo:u=>u?"Podrías bajar de tu colchón":"Bajas de tu colchón",detalle:u=>`El ${u} el saldo queda en ${P(d.saldo)}, por debajo del colchón.`});for(const d of t.crucesMargenes??[])d.tipo==="bajo_margen"&&r.push({id:`margen:${d.nombre}`,gravedad:"aviso",fecha:d.fecha,distancia:Math.max(0,d.target-d.saldo),titulo:u=>u?`Podrías bajar de «${d.nombre}»`:`Bajas de «${d.nombre}»`,detalle:u=>`El ${u} tendrías ${P(d.saldo)}, y el margen pide ${P(d.target)}.`});const c=new Map;for(const d of r){const u=c.get(d.id);(!u||d.fecha<u.fecha)&&c.set(d.id,d)}const l=[];for(const d of c.values()){const u=Ra(a,d.fecha);if(u<0||u>(d.gravedad==="critico"?o:n))continue;const v=i?i(u):0,g=v>0&&d.distancia<v;l.push({id:d.id,gravedad:d.gravedad,fecha:d.fecha,dias:u,plazo:La(u),titulo:d.titulo(g),detalle:d.detalle(Na(d.fecha,a)),incierto:g})}const m={critico:0,aviso:1};return l.sort((d,u)=>d.fecha.localeCompare(u.fecha)||m[d.gravedad]-m[u.gravedad]),l.slice(0,s)}const Pn=Object.freeze(Object.defineProperty({__proto__:null,colchonComoMargen:Mn,construirAvisos:_n,describirPlazo:La,diasEntreISO:Ra,fechaEnPalabras:Na},Symbol.toStringTag,{value:"Module"})),Fn=30.44*864e5;function Oa(t){const e=t.getFullYear(),a=t.getMonth();return{desde:W(new Date(e,a,1)),hasta:W(new Date(e,a,Ce(e,a)))}}function ka(t){const[e,a]=t.split("-").map(Number);return Oa(new Date(e,a-1,1))}function Dn(t,e){return Math.max(1,(O(e).getTime()-O(t).getTime())/Fn)}const Tn=t=>t.filter(e=>e.sourceType!=="transfer-out"&&e.sourceType!=="transfer-in"),yt=t=>t.reduce((e,a)=>e+Math.abs(a.cuantia),0);function zn(t,e){const a=new Map(e.map(s=>[s._id,s.clasificacion]));let o=0,n=0;for(const s of t){if(s.tipo!=="gasto"||s.sourceType!=="expense")continue;const i=a.get(s.sourceId??"");i!==null&&(i==="deseo"?n+=Math.abs(s.cuantia):o+=Math.abs(s.cuantia))}return{basicos:o,deseo:n}}function jn(t,e){const a=e.entreMeses&&e.entreMeses>0?e.entreMeses:1,o=u=>u.sourceType==="loan"&&u.tipo==="gasto",n=e.loanIdsIniciados,s=yt(t.filter(u=>u.tipo==="ingreso")),i=yt(t.filter(u=>o(u)&&(!n||n.has(u.sourceId??"")))),r=yt(t.filter(u=>o(u)&&e.hipotecaIds.has(u.sourceId??""))),c=yt(t.filter(u=>u.sourceType==="loan-amort")),l=yt(t.filter(u=>u.sourceType==="account-interest")),{basicos:m,deseo:d}=zn(t,e.expenses);return{ingresos:s/a,cuotas:i/a,cuotasHipoteca:r/a,amortizaciones:c/a,gastosBasicos:m/a,gastosDeseo:d/a,gastosTotales:(i+m+d)/a,intereses:l/a}}function Ba(t,e){return t.reduce((a,o)=>{const n=X(o).tabla.filter(s=>!s.esAmortizacion&&s.fecha<=e);return a+(n.length>0?n[n.length-1].capitalPendiente:o.capital||0)},0)}function qn(t,e,a,o){const n=t.filter(l=>l.activo&&!l.simulacion&&(l.fechaInicio||"")<=a),s=n.reduce((l,m)=>{if((m.amortizaciones||[]).filter(g=>g.fecha>=e&&g.fecha<=a).length===0)return l;const u=X(m).totalIntereses,v=X({...m,amortizaciones:(m.amortizaciones||[]).filter(g=>g.fecha<e||g.fecha>a)}).totalIntereses;return l+Math.max(0,v-u)},0),i=n.filter(l=>l.mostrarFechaFinEnDashboard!==!1).map(l=>({loan:l,fechaFin:X(l).fechaFin})).filter(l=>!!l.fechaFin&&l.fechaFin>=e&&l.fechaFin<=a),r=n.map(l=>X(l).tabla),c=l=>{const{desde:m,hasta:d}=ka(l);return r.reduce((u,v)=>{const g=v.find(b=>!b.esAmortizacion&&b.fecha>=m&&b.fecha<=d);return u+(g?g.cuota:0)},0)};return{deudaInicio:Ba(n,e),deudaFin:Ba(n,a),ahorroIntereses:s,ahorroInteresesMes:o>0?s/o:0,cuotasInicio:c(e.slice(0,7)),cuotasFin:c(a.slice(0,7)),finEnPeriodo:i}}function Rn(t,e){return e.filter(a=>a.activo&&(a.interes??0)>0).map(a=>({nombre:a.nombre,interes:a.interes,total:yt(t.filter(o=>o.sourceType==="account-interest"&&o.sourceId===a._id))})).filter(a=>a.total>0).sort((a,o)=>o.total-a.total)}function Ha(t,e=new Set,a="desglosado"){if(e.size===0)return za(t,"gasto");const o=new Map;for(const n of t){if(n.tipo!=="gasto")continue;const s=n.tags||[],i=s.filter(l=>e.has(l)),r=s.filter(l=>!e.has(l)),c=a==="porgrupos"&&i.length>0?i:r;for(const l of c)o.set(l,(o.get(l)||0)+Math.abs(n.cuantia))}return o}function Nn(t,e={}){const a=e.activos,o=e.entreMeses&&e.entreMeses>0?e.entreMeses:1;return[...Ha(t,e.grupoTags,e.modo).entries()].filter(([n])=>!a||a.size===0||a.has(n)).map(([n,s])=>({tag:n,total:s/o})).sort((n,s)=>s.total-n.total)}function Ln(t,e){const a=e.reduce((o,n)=>o+vt(n),0);return{saldoBase:a,saldoFinal:t.length>0?t[t.length-1].saldoAcum??a:a,totalGastos:yt(t.filter(o=>o.tipo==="gasto")),totalIngresos:yt(t.filter(o=>o.tipo==="ingreso")),tags:[...new Set(t.flatMap(o=>o.tags||[]))]}}function On(t,e){return t.filter(a=>a.activo&&(!e||e.length===0||e.includes(a._id)))}function kn(t,e="hipoteca"){return new Set(t.filter(a=>(a.tags||[]).includes(e)).map(a=>a._id))}function Bn(t,e){return new Set(t.filter(a=>(a.fechaInicio||"")<=e).map(a=>a._id))}function Hn(t,e){if(t.length===0)return[];const a=l=>e==="mes"?l.slice(0,7):l.slice(0,4),o=l=>e==="mes"?`${l}-01`:`${l}-01-01`,n=t[0],s=n.delta??(n.tipo==="ingreso"?Math.abs(n.cuantia):-Math.abs(n.cuantia));let i=(n.saldoAcum??0)-s;const r=[];let c=null;for(const l of t){const m=a(l.fecha),d=l.saldoAcum??i;(!c||c.periodo!==m)&&(c&&(i=c.cierre),c={periodo:m,inicio:o(m),apertura:i,cierre:d,maximo:Math.max(i,d),minimo:Math.min(i,d),eventos:0},r.push(c)),c.cierre=d,d>c.maximo&&(c.maximo=d),d<c.minimo&&(c.minimo=d),c.eventos+=1}return r}const Gn=Object.freeze(Object.defineProperty({__proto__:null,agruparOHLC:Hn,cuentasVisibles:On,gastoPorTagOrdenado:Nn,idsHipoteca:kn,idsPrestamosIniciados:Bn,interesesPorCuenta:Rn,mesesDelPeriodo:Dn,metricasFlujo:jn,rangoMes:ka,rangoMesDe:Oa,resumenPrestamosPeriodo:qn,sinTransferencias:Tn,sumarGastosPorTag:Ha,totalesPeriodo:Ln},Symbol.toStringTag,{value:"Module"}));function Vn(t,e,a){const o=t||[];if(!o.length)return e;const n=o.find(i=>i.año===a);if(n)return n.tramos;const s=o.filter(i=>i.año<a).sort((i,r)=>r.año-i.año);return s.length?s[0].tramos:e}function Ft(t,e){return a=>Vn(t,e,a)}const Kt=10,Ga=[[0,19],[12450,24],[20200,30],[35200,37],[6e4,45],[3e5,47]],Va=[[0,19],[6e3,21],[5e4,23],[2e5,27],[3e5,28]];function je(t){return{_id:"default",nombre:"Default",descripcion:"Cuenta principal",saldo:0,saldoInicial:0,fechaInicialSaldo:t,historicoSaldos:[],interes:0,periodoCobro:"mensual",activo:!0,simulacion:!1,esCuentaPrincipal:!0,modeloFondo:"cuenta",aportaciones:[],planAportaciones:[]}}const Ua="default";function Ya(){return{_id:Ua,nombre:"Yo",esPorDefecto:!0,activo:!0}}function Wa(t,e){return{dashboardStart:t,dashboardEnd:e,fechaReferencia:t,colchonMeses:6,colchonTipo:"meses",colchonFijo:0,colchonPuntos:[],showColchon:!0,margenesSeguridad:[],usarInflacion:!1,tramos_irpf:Ga,tramosGananciasCapital:Va,showExecSummary:!0,showCriticos:!0,showHistorico:!0,histCuenta:"",analisisCollapsed:!1,activeTagsFilter:[],cierreOmitidos:[],tagCategorias:[],tagGrupos:[],saludUmbralAhorroVerde:20,saludUmbralAhorroAmarillo:10,saludUmbralDTIVerde:30,saludUmbralDTIAmarillo:40,saludRegla:[50,30,20],saludExcluirHipoteca:!1,saludTagHipoteca:"hipoteca",storageMode:"local",autoSave:!1,autoSaveInterval:15,autoLogoutMinutos:0,onboardingDone:!1,features:{}}}function Ka(t,e){return{loans:[],expenses:[],accounts:[je(t)],nominas:[],transacciones:[],puntosControl:[],inflacion:[],tramosIRPFHistorico:[],tramosGananciasCapitalHistorico:[],personas:[Ya()],config:Wa(t,e)}}const dt=t=>Array.isArray(t)?t:[],Un=t=>t&&typeof t=="object"&&!Array.isArray(t)?t:{};function Jt(t){if(Array.isArray(t.escenarioIds))return t;const e=t.escenarioId?[t.escenarioId]:[],{escenarioId:a,...o}=t;return{...o,escenarioIds:e}}function Ja(t){if(!t||typeof t!="string")return"";if(t.startsWith("dia:")||t.startsWith("nthweekday:"))return t;if(t==="ultimo")return"dia:ultimo";if(t==="primer-lunes")return"nthweekday:1:1";const e=parseInt(t);return isNaN(e)?"":`dia:${e}`}function qe(t){const{varianza:e,inflacion:a,...o}=t;return o}function Yn(t,e){const{hoyISO:a,finISO:o}=e,n={...t},s=Un(t.config),r={...Wa(a,o)};for(const[m,d]of Object.entries(s))d!=null&&(r[m]=d);delete r.saldoInicial,delete r.saldoInicialFecha,delete r.inflacionGlobal,delete r.showMC,delete r.mcIteraciones,(!Array.isArray(r.tramos_irpf)||r.tramos_irpf.length===0)&&(r.tramos_irpf=Ga),(!Array.isArray(r.tramosGananciasCapital)||r.tramosGananciasCapital.length===0)&&(r.tramosGananciasCapital=Va),(!Array.isArray(r.saludRegla)||r.saludRegla.length!==3)&&(r.saludRegla=[50,30,20]),(typeof r.features!="object"||r.features===null||Array.isArray(r.features))&&(r.features={}),n.config=r;let c=dt(t.accounts).map(m=>{const d={saldoInicial:0,fechaInicialSaldo:a,historicoSaldos:[],interes:0,periodoCobro:"mensual",activo:!0,simulacion:!1,esCuentaPrincipal:!1,aportaciones:[],planAportaciones:[],bloqueoMeses:120,impuestoRetirada:0,grupoNomina:"",...m};return d.modeloFondo||(d.modeloFondo=d.esFondoPension?"pension":"cuenta"),delete d.esFondoPension,Array.isArray(d.historicoSaldos)||(d.historicoSaldos=[]),Jt(d)});c.length===0&&(c=[je(a)]);const l=c.filter(m=>m.esCuentaPrincipal);if(l.length===0){const m=c.find(d=>d._id==="default")||c[0];c=c.map(d=>({...d,esCuentaPrincipal:d._id===m._id}))}else if(l.length>1){let m=!1;c=c.map(d=>d.esCuentaPrincipal?m?{...d,esCuentaPrincipal:!1}:(m=!0,d):d)}return n.accounts=c,n.expenses=dt(t.expenses).map(m=>{const d={basico:!1,activo:!0,tags:[],historialPrecios:[],...m};return Array.isArray(d.tags)||(d.tags=[]),Array.isArray(d.historialPrecios)||(d.historialPrecios=[]),d.diaPago=Ja(d.diaPago),qe(Jt(d))}),n.loans=dt(t.loans).map(m=>{const d={tipoTasa:"fijo",mostrarFechaFinEnDashboard:!0,basico:!0,tags:[],activo:!0,amortizaciones:[],...m};return Array.isArray(d.tags)||(d.tags=[]),d.diaPago=Ja(d.diaPago),d.amortizaciones=dt(d.amortizaciones).map(u=>Jt(u)),qe(Jt(d))}),n.nominas=dt(t.nominas).map(m=>{const d={activo:!0,nPagas:12,irpfModo:"auto",irpfPct:0,bruto:0,representacion:"detallado",tags:[],fechaFin:null,cuenta:"default",grupoNomina:"",mesActualizacionIPC:null,retribucionFlexible:[],...m};return Array.isArray(d.tags)||(d.tags=[]),Array.isArray(d.retribucionFlexible)||(d.retribucionFlexible=[]),qe(Jt(d))}),n.goals=dt(t.goals).map((m,d)=>{const u=Array.isArray(m.cuentaIds)?m.cuentaIds:m.cuentaId?[m.cuentaId]:[],{cuentaId:v,...g}=m;return{prioridad:d+1,completado:!1,usarColchon:!0,targetAmount:0,...g,cuentaIds:u}}),n.inflacion=dt(t.inflacion),n.tramosIRPFHistorico=dt(t.tramosIRPFHistorico),n.tramosGananciasCapitalHistorico=dt(t.tramosGananciasCapitalHistorico),n.escenarios=dt(t.escenarios).map(({inversiones:m,...d})=>d),n}const Dt=t=>Array.isArray(t)?t:[];let Re=0;function Wn(t){return Re+=1,`${t}_${Re.toString(36)}`}const Kn=t=>typeof t=="string"&&/^\d{4}-\d{2}-\d{2}$/.test(t),Jn=t=>typeof t=="number"&&Number.isFinite(t);function Qn(t,e){const a={...t};Re=0;const o=Dt(t.transacciones),n=Dt(t.puntosControl),s=[...n],i=new Set(n.map(l=>`${l.cuentaId}|${l.fecha}`)),r=(l,m,d,u)=>{if(!Kn(m)||!Jn(d))return;const v=`${l}|${m}`;i.has(v)||(i.add(v),s.push({_id:Wn("pc"),fecha:m,cuentaId:l,saldoCts:it(d),...typeof u=="string"&&u?{nota:u}:{}}))};for(const l of Dt(t.accounts)){const m=typeof l._id=="string"?l._id:null;if(m)for(const d of Dt(l.historicoSaldos))r(m,d.fecha,d.saldo,d.nota)}const c=Dt(t.history);if(c.length>0){const l=Dt(t.accounts),m=l.find(u=>u.esCuentaPrincipal)||l.find(u=>u.activo)||l[0],d=typeof(m==null?void 0:m._id)=="string"?m._id:"default";for(const u of c){const v=typeof u.cuenta=="string"?u.cuenta:typeof u.cuentaId=="string"?u.cuentaId:d;r(v,u.fecha,u.saldo,u.nota)}}return delete a.history,a.transacciones=o,a.puntosControl=s.sort((l,m)=>String(l.fecha).localeCompare(String(m.fecha))),a}const Ne=t=>Array.isArray(t)?t:[],Xn=t=>typeof t=="string"&&/^\d{4}-\d{2}-\d{2}$/.test(t),Zn=t=>typeof t=="number"&&Number.isFinite(t)&&t>0;let Le=0;function ts(){return Le+=1,`tx_hp_${Le.toString(36)}`}function es(t,e){const a={...t};Le=0;const o=[...Ne(t.transacciones)],n=new Set(o.map(i=>`${i.estimacionId}|${i.fecha}|${i.importeCts}`)),s=Ne(t.expenses).map(i=>{const r=Ne(i.historialPrecios),c=typeof i._id=="string"?i._id:null,l=typeof i.cuenta=="string"&&i.cuenta?i.cuenta:"default",m=i.tipo==="ingreso"?"ingreso":"gasto",d=Array.isArray(i.tags)?i.tags.filter(g=>typeof g=="string"):[];if(c)for(const g of r){if(!g||!Xn(g.fecha)||!Zn(g.cuantia))continue;const b=m==="ingreso"?it(g.cuantia):-it(g.cuantia),x=`${c}|${g.fecha}|${b}`;n.has(x)||(n.add(x),o.push({_id:ts(),fecha:g.fecha,cuentaId:l,importeCts:b,concepto:typeof i.concepto=="string"?i.concepto:"Movimiento",tags:d,estimacionId:c,tipo:m,origen:"importado",nota:typeof g.nota=="string"&&g.nota?g.nota:"Importado del historial de precios"}))}const{historialPrecios:u,...v}=i;return v});return a.expenses=s,a.transacciones=o.sort((i,r)=>String(i.fecha).localeCompare(String(r.fecha))),a}const Qa=t=>Array.isArray(t)?t:[],$t=(t,e="")=>typeof t=="string"&&t.trim()?t:e,Tt=(t,e=0)=>typeof t=="number"&&Number.isFinite(t)?t:e,as=t=>typeof t=="string"&&/^\d{4}-\d{2}/.test(t)?t.slice(0,7):null;function os(t,e){var m;const a={...t};if(Array.isArray(a.planes))return a;const o=Qa(a.goals),n=Qa(a.accounts),s=n.map(d=>{const u=Tt(d.bloqueoMeses,0);return{_id:`veh_${$t(d._id,"x")}`,nombre:$t(d.nombre,"Cuenta"),rentabilidadRealAnual:Tt(d.interes,0)/100,liquidez:d.modeloFondo==="pension"?"BLOQUEADA_HASTA_JUBILACION":u>0?"MEDIA":"INMEDIATA",fiscalidadRetirada:Tt(d.impuestoRetirada,0)/100,topeAportacionAnual:d.modeloFondo==="pension"?it(1500):null,riesgo:d.modeloFondo==="pension"?"MEDIO":"NULO",cuentaId:$t(d._id,""),prestamoId:null,esDeuda:!1,revisarRentabilidad:Tt(d.interes,0)>0}}),i=new Map(n.map((d,u)=>[$t(d._id,""),s[u]._id])),r=((m=s[0])==null?void 0:m._id)??"",c=o.map((d,u)=>{const v=Array.isArray(d.cuentaIds)?d.cuentaIds.map(b=>$t(b,"")):[],g=as(d.targetDate);return{_id:$t(d._id,`obj_mig_${u}`),nombre:$t(d.nombre,`Objetivo ${u+1}`),tipo:"AHORRO_OBJETIVO",importeObjetivo:it(Tt(d.targetAmount,0)),fechaLimite:g,prioridad:Tt(d.prioridad,u+1),modoAsignacion:g?"CUOTA_POR_FECHA":"ABSORBE_TODO",vehiculoId:i.get(v[0])??r,saldoActual:0,estado:d.completado===!0?"COMPLETADO":"PENDIENTE",notas:$t(d.notas,"")}}),l={_id:"plan_base",nombre:"Plan base",fechaInicio:e.hoyISO.slice(0,7),horizonteMeses:480,pctDisfrute:0,notas:o.length>0?"Creado al migrar los objetivos de ahorro anteriores. Revisa los saldos de partida y las rentabilidades reales.":"",activo:!0,perfil:{netoMensual:0,gastosFijosMensuales:0,manual:!1},vehiculos:s,objetivos:c,eventos:[],creadoEn:e.hoyISO};return a.planes=[l],a}function ns(t,e){const a={...t},o=Array.isArray(a.personas)?a.personas:[];return o.some(n=>(n==null?void 0:n._id)===Ua)||(a.personas=[Ya(),...o]),a}const Qt=t=>Array.isArray(t)?t:[];function le(t){const{escenarioIds:e,...a}=t;return Array.isArray(a.amortizaciones)&&(a.amortizaciones=a.amortizaciones.map(o=>{const{escenarioIds:n,...s}=o;return s})),a}function ss(t){return t._id!=="plan_base"?!0:Array.isArray(t.objetivos)&&t.objetivos.length>0}function is(t,e){const a={...t};if(a.escenarios===void 0&&a.planes===void 0&&a.goals===void 0)return a;if(a.loans=Qt(a.loans).map(le),a.expenses=Qt(a.expenses).map(le),a.nominas=Qt(a.nominas).map(le),a.accounts=Qt(a.accounts).map(le),delete a.escenarios,a.config&&typeof a.config=="object"){const{escenarioActivo:n,...s}=a.config;a.config=s}delete a.goals;const o=Qt(a.planes).filter(ss);return o.length>0&&(console.warn(`[migración 010] Se archivan ${o.length} plan(es) del planificador retirado en _migracion010_planesArchivados.`),a._migracion010_planesArchivados=o),delete a.planes,a}const rs=[{version:5,describe:"Formaliza el esquema; limpia restos de features eliminadas; añade config.features",migrate:Yn},{version:6,describe:"Contabilidad real: crea transacciones y puntosControl (importa historicoSaldos y la clave history)",migrate:Qn},{version:7,describe:"Retira historialPrecios: cada entrada pasa a ser una transacción real enlazada a su estimación",migrate:es},{version:8,describe:"Gestor de objetivos: absorbe `goals` dentro de un Plan, con un vehículo por cuenta",migrate:os},{version:9,describe:"Personas: siembra la persona por defecto («Yo») donde ya caía todo implícitamente",migrate:ns},{version:10,describe:"Simplificación: retira escenarios/supuestos, objetivos de ahorro antiguos y el planificador financiero",migrate:is}],cs=["history"];function Xa(t,e,a){let o=t;const n=[];for(const s of[...rs].sort((i,r)=>i.version-r.version))(e??0)>=s.version||(o=s.migrate(o,a),n.push(s.version));return{state:o,applied:n}}const xt="state_",de="state__schemaVersion",zt="financeapp_",Oe="state__modificadoEn";function Za(t=localStorage,e=zt){const a=o=>`${e}${o}`;return{get(o){try{const n=t.getItem(a(o));return n===null?null:JSON.parse(n)}catch{return null}},set(o,n){try{t.setItem(a(o),JSON.stringify(n)),o!==Oe&&t.setItem(a(Oe),JSON.stringify(Date.now()))}catch(s){console.error("No se pudo guardar en localStorage:",o,s)}},remove(o){try{t.removeItem(a(o))}catch{}},keys(){const o=[];for(let n=0;n<t.length;n++){const s=t.key(n);s!=null&&s.startsWith(e)&&o.push(s.slice(e.length))}return o}}}function ls(t=localStorage,e=zt){const a=[];for(let n=0;n<t.length;n++){const s=t.key(n);s!=null&&s.startsWith(xt)&&!s.startsWith(e)&&a.push(s)}const o=[];for(const n of a)try{const s=t.getItem(n);s!==null&&t.getItem(`${e}${n}`)===null&&(t.setItem(`${e}${n}`,s),o.push(n)),t.removeItem(n)}catch{}return o}function ds({ventanaMs:t=15e3,ahora:e=()=>Date.now()}={}){let a=null;function o(){return a?e()-a.cuando>t?(a=null,null):a:null}return{registrar(n){a={...n,cuando:e()}},pendiente:o,tomar(){const n=o();return a=null,n},limpiar(){a=null}}}const us={expenses:{articulo:"El",que:"gasto"},accounts:{articulo:"La",que:"cuenta"},loans:{articulo:"El",que:"préstamo"},nominas:{articulo:"La",que:"nómina"},inflacion:{articulo:"El",que:"periodo de inflación"},transacciones:{articulo:"El",que:"movimiento"},puntosControl:{articulo:"El",que:"punto de control"}};function ps(t,e){const a=us[t]??{articulo:"El",que:"elemento"},o=e.concepto??e.nombre??e.titulo??(e.year!==void 0?String(e.year):null);return o?`${a.articulo} ${a.que} «${String(o)}»`:`${a.articulo} ${a.que}`}function ms(t){return W(new Date(t.getFullYear()+1,t.getMonth(),t.getDate()))}function fs({adapter:t,hoy:e=new Date}){const a=W(e),o=ms(e);let n=Ka(a,o);const s=new Set;let i=[];const r=ds();function c(A){for(const F of s)F(A)}function l(A){t.set(`${xt}${A}`,n[A])}function m(){const A={};for(const T of Object.keys(n)){const N=t.get(`${xt}${T}`);N!==null&&(A[T]=N)}for(const T of cs){const N=t.get(`${xt}${T}`);N!==null&&(A[T]=N)}const F=t.get(de),{state:z,applied:D}=Xa(A,F,{hoyISO:a,finISO:o});if(n=z,d(),D.length>0){for(const T of Object.keys(n))l(T);t.set(de,Kt)}return i=D,{applied:D}}function d(){if(!Array.isArray(n.accounts)||n.accounts.length===0){n.accounts=[je(a)],l("accounts");return}const A=n.accounts.filter(F=>F.esCuentaPrincipal);if(A.length===0)n.accounts=n.accounts.map((F,z)=>z===0?{...F,esCuentaPrincipal:!0}:F),l("accounts");else if(A.length>1){let F=!1;n.accounts=n.accounts.map(z=>z.esCuentaPrincipal?F?{...z,esCuentaPrincipal:!1}:(F=!0,z):z),l("accounts")}}function u(A){return n[A]}function v(A,F){n[A]=F,l(A),c(A)}function g(A){v("config",{...n.config,...A})}function b(A){return s.add(A),()=>s.delete(A)}function x(){return Date.now().toString(36)+Math.random().toString(36).slice(2,7)}function f(A,F){const z=[...n[A]],D={...F,_id:x()};return z.push(D),v(A,z),D}function h(A,F,z){const D=n[A].map(T=>T._id===F?{...T,...z}:T);v(A,D)}function S(A,F){const z=n[A],D=z.findIndex(T=>T._id===F);D<0||(r.registrar({col:A,item:z[D],indice:D}),v(A,z.filter((T,N)=>N!==D)))}function C(){const A=r.tomar();if(!A)return null;const F=[...n[A.col]];return F.splice(Math.min(A.indice,F.length),0,A.item),v(A.col,F),A}function w(){return r.pendiente()}function $(){const A=n.accounts||[],F=A.find(z=>z.esCuentaPrincipal&&z.activo)||A.find(z=>z.activo);return F?F._id:"default"}function M(A){var F;return((F=n.accounts.find(z=>z._id===A))==null?void 0:F.nombre)??A}function _(){return Ft(n.tramosIRPFHistorico,n.config.tramos_irpf)}function I(){return Ft(n.tramosGananciasCapitalHistorico,n.config.tramosGananciasCapital)}function y(){return structuredClone(n)}function E(A,F=null){const{state:z,applied:D}=Xa(A,F,{hoyISO:a,finISO:o});n=z,d();for(const T of Object.keys(n))l(T);t.set(de,Kt);for(const T of Object.keys(n))c(T);return{applied:D}}return{load:m,get:u,set:v,patchConfig:g,subscribe:b,addItem:f,updateItem:h,removeItem:S,deshacerBorrado:C,borradoPendiente:w,getPrincipalAccountId:$,accountName:M,resolverTramosIRPF:_,resolverTramosGanancias:I,snapshot:y,replaceAll:E,get schemaVersion(){return Kt},get migrationsApplied(){return[...i]},get today(){return a||K()}}}function gs(){let t=0,e=null;const a=new Set;function o(n){t+=1,e=n;for(const s of a)try{s(t,n)}catch(i){console.error("[cambios] un suscriptor ha fallado:",i)}return t}return{revision:()=>t,ultimoOrigen:()=>e,marcar:o,suscribir(n){return a.add(n),()=>a.delete(n)},crearMarca(n){let s=t;return{nombre:n,pendiente:()=>t>s,alDia:i=>{s=Math.max(s,i??t)},vista:()=>s}}}}const St=Object.keys(Ka("1970-01-01","1970-01-01"));function to(t){const e={};for(const a of St){const o=t.get(`${xt}${a}`);o!=null&&(e[a]=o)}return e}function vs(t,e){const a=[];for(const o of St){const n=e[o];n!=null&&(t(`${xt}${o}`,n),a.push(o))}return a}function bs(t){return St.filter(e=>t[e]===void 0||t[e]===null)}function hs(t){var i;const e=r=>{const c=t[r];return Array.isArray(c)?c:[]};if(!St.filter(r=>r!=="config"&&r!=="accounts"&&r!=="personas").every(r=>e(r).length===0))return!1;const o=e("personas");return o.length===0||o.length===1&&((i=o[0])==null?void 0:i._id)==="default"?e("accounts").every(r=>r._id==="default"&&!(typeof r.saldoInicial=="number"&&r.saldoInicial!==0)&&!(Array.isArray(r.historicoSaldos)&&r.historicoSaldos.length>0)):!1}const eo=`${zt}meta_proyectos`,ao=`${zt}meta_proyectoActivo`,At="default",ys="Mis finanzas";function ke(){return Date.now().toString(36)+Math.random().toString(36).slice(2,7)}function Xt(t){return t===At?zt:`${zt}p_${t}_`}function oo(){return[...St.map(t=>`${xt}${t}`),de,Oe]}function $s(t=localStorage){function e(){try{const d=t.getItem(eo);if(!d)return[];const u=JSON.parse(d);return Array.isArray(u)?u:[]}catch{return[]}}function a(d){t.setItem(eo,JSON.stringify(d))}function o(){const d=e();if(d.some(g=>g._id===At))return d;const u=Date.now(),v=[{_id:At,nombre:ys,creadoEn:u,actualizadoEn:u},...d];return a(v),v}function n(){try{const d=t.getItem(ao);if(!d)return At;const u=JSON.parse(d);return typeof u=="string"&&u?u:At}catch{return At}}function s(d){t.setItem(ao,JSON.stringify(d))}function i(d){const u=d.trim()||"Proyecto sin nombre",v=Date.now(),g={_id:ke(),nombre:u,creadoEn:v,actualizadoEn:v};return a([...o(),g]),g}function r(d,u){const v=u.trim();v&&a(o().map(g=>g._id===d?{...g,nombre:v,actualizadoEn:Date.now()}:g))}function c(d,u){const v=o().find(f=>f._id===d);if(!v)throw new Error("Proyecto no encontrado.");const g=Xt(d),b={_id:ke(),nombre:(u==null?void 0:u.trim())||`${v.nombre} (copia)`,creadoEn:Date.now(),actualizadoEn:Date.now()},x=Xt(b._id);for(const f of oo()){const h=t.getItem(`${g}${f}`);h!==null&&t.setItem(`${x}${f}`,h)}return a([...o(),b]),b}function l(d){if(d===At)throw new Error("No se puede eliminar el proyecto original.");if(d===n())throw new Error("No se puede eliminar el proyecto activo. Cambia a otro primero.");const u=o();if(!u.some(g=>g._id===d))return;const v=Xt(d);for(const g of oo())t.removeItem(`${v}${g}`);a(u.filter(g=>g._id!==d))}function m(d){const u=new Map(o().map(g=>[g._id,g]));for(const g of d){if(!g||typeof g._id!="string")continue;const b=u.get(g._id);(!b||(g.actualizadoEn??0)>b.actualizadoEn)&&u.set(g._id,g)}const v=[...u.values()];return a(v),v}return{listar:o,activo:n,establecerActivo:s,crear:i,renombrar:r,duplicar:c,eliminar:l,fusionarRemotos:m}}function xs(t,e,a){const o=Za(t,Xt(e)),n={};for(const s of a){const i=o.get(`${xt}${s}`);n[s]=Array.isArray(i)?i:[]}return n}function ws(t){const e=new Map;for(const n of Object.values(t))for(const s of n){const i=s==null?void 0:s._id;typeof i=="string"&&!e.has(i)&&e.set(i,ke())}function a(n){if(typeof n=="string")return e.get(n)??n;if(Array.isArray(n))return n.map(a);if(n&&typeof n=="object"){const s={};for(const[i,r]of Object.entries(n))s[i]=a(r);return s}return n}const o={};for(const[n,s]of Object.entries(t))o[n]=s.map(a);return o}const at={nucleo:"Esenciales",dinero:"Mi dinero",planificacion:"Planificación",analisis:"Análisis del dashboard",datos:"Datos y sincronización"},wt=[{id:"dashboard",nombre:"Dashboard",descripcion:"Saldo actual, extracto proyectado y evolución. No se puede desactivar.",grupo:at.nucleo,porDefecto:!0,nucleo:!0},{id:"expenses",nombre:"Gastos e ingresos",descripcion:"Estimaciones recurrentes y extraordinarias, transferencias entre cuentas y etiquetas.",grupo:at.dinero,porDefecto:!0},{id:"loans",nombre:"Préstamos",descripcion:"Tablas de amortización, TAE y amortizaciones anticipadas.",grupo:at.dinero,porDefecto:!0},{id:"nominas",nombre:"Nóminas",descripcion:"Salarios con IRPF por tramos, pagas extra y retribución flexible.",grupo:at.dinero,porDefecto:!0},{id:"accounts",nombre:"Cuentas y contabilidad",descripcion:"Cuentas, fondos de inversión, planes de pensiones, puntos de control de saldo, registro de movimientos reales, importación de extractos y análisis de precisión de las estimaciones.",grupo:at.dinero,porDefecto:!0},{id:"margenes",nombre:"Márgenes de seguridad",descripcion:"Umbrales mínimos de saldo por cuenta, con avisos al cruzarlos.",grupo:at.planificacion,porDefecto:!1},{id:"resumen-ejecutivo",nombre:"Resumen ejecutivo",descripcion:"Titulares del periodo: ingresos, gastos, ahorro y saldo final estimado.",grupo:at.analisis,porDefecto:!0},{id:"velas-saldo",nombre:"Velas del saldo",descripcion:"Apertura, cierre, máximo y mínimo del saldo por mes o por año.",grupo:at.analisis,porDefecto:!0},{id:"graficos-etiquetas",nombre:"Gráficos por etiqueta",descripcion:"Reparto y media mensual del gasto por etiqueta, con grupos de etiquetas.",grupo:at.analisis,porDefecto:!0},{id:"puntos-criticos",nombre:"Puntos críticos",descripcion:"Avisos de saldo negativo o por debajo del colchón en la proyección.",grupo:at.analisis,porDefecto:!0},{id:"precision-estimaciones",nombre:"Precisión de estimaciones",descripcion:"Acierto de cada estimación frente al gasto real, con ajuste sugerido.",grupo:at.analisis,porDefecto:!0,dependencias:["accounts","expenses"]},{id:"sync-nube",nombre:"Sincronización en la nube",descripcion:"Copia cifrada en Firebase o Dropbox, además del almacenamiento local.",grupo:at.datos,porDefecto:!0},{id:"autoguardado",nombre:"Autoguardado",descripcion:"Sube una copia a la nube cada cierto intervalo automáticamente.",grupo:at.datos,porDefecto:!1,dependencias:["sync-nube"]}],Is=new Map(wt.map(t=>[t.id,t]));function Zt(t){return Is.get(t)}function no(t){return wt.filter(e=>(e.dependencias||[]).includes(t))}function Be(){const t={};for(const e of wt)t[e.id]=e.porDefecto;return t}function so(){const t=[],e=new Map;for(const a of wt)e.has(a.grupo)||(e.set(a.grupo,[]),t.push(a.grupo)),e.get(a.grupo).push(a);return t.map(a=>({grupo:a,features:e.get(a)}))}function Cs(t){function e(){return{...Be(),...t.get("config").features||{}}}function a(d){t.patchConfig({features:d})}function o(d,u=e(),v=new Set){const g=Zt(d);if(!g)return!1;if(g.nucleo)return!0;if(u[d]===!1)return!1;if(v.has(d))return!0;v.add(d);for(const b of g.dependencias||[])if(!o(b,u,v))return!1;return!0}function n(d,u=e()){const v=Zt(d);return v?(v.dependencias||[]).filter(g=>!o(g,u)):[]}function s(d,u){var S;const v=Zt(d);if(!v)return{cambiadas:[]};if(v.nucleo)return{cambiadas:[],motivo:"nucleo-inmutable"};const g=e(),b=new Map(wt.map(C=>[C.id,o(C.id,g)])),x={...g,[d]:u};let f;if(u){const C=[...v.dependencias||[]];for(;C.length;){const w=C.pop();x[w]===!1&&(x[w]=!0,f="dependencias-activadas"),C.push(...((S=Zt(w))==null?void 0:S.dependencias)||[])}}else{const C=no(d).map(w=>w.id);for(;C.length;){const w=C.pop();x[w]!==!1&&(x[w]=!1,f="cascada-apagado"),C.push(...no(w).map($=>$.id))}}return a(x),{cambiadas:wt.filter(C=>o(C.id,x)!==b.get(C.id)).map(C=>C.id),motivo:f}}function i(){const d=e();return wt.map(u=>{const v=n(u.id,d);return{...u,activa:o(u.id,d),...v.length>0&&d[u.id]!==!1?{bloqueadaPor:v}:{}}})}function r(){const d=e();return so().map(({grupo:u,features:v})=>({grupo:u,features:v.map(g=>{const b=n(g.id,d);return{...g,activa:o(g.id,d),...b.length>0&&d[g.id]!==!1?{bloqueadaPor:b}:{}}})}))}function c(){a(Be())}function l(d){return{_app:"financeapp",_tipo:"feature-profile",_v:1,...d?{nombre:d}:{},features:e()}}function m(d){const u=d,v=u&&typeof u=="object"&&u.features&&typeof u.features=="object"?u.features:null;if(!v)throw new Error('El perfil no tiene una sección "features" válida');const g=Be(),b=[],x=[];for(const[f,h]of Object.entries(v)){if(!Zt(f)){x.push(f);continue}if(typeof h!="boolean"){x.push(f);continue}g[f]=h,b.push(f)}return a(g),{aplicadas:b,ignoradas:x}}return{isEnabled:d=>o(d),setEnabled:s,estado:i,estadoPorGrupo:r,reset:c,exportProfile:l,importProfile:m,bloqueadaPor:d=>n(d)}}const te=t=>t.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;");function jt(t,e,a="ok"){if(t.notify)return t.notify(e,a);const o=globalThis.UI;if(o!=null&&o.toast)return o.toast(e,a);console.info("[FinanceApp]",e)}function Ss(t){var n,s;const a=(((n=t.bloqueadaPor)==null?void 0:n.length)??0)>0?`<div style="font-size:11px;color:var(--yellow);margin-top:3px">Requiere: ${(s=t.bloqueadaPor)==null?void 0:s.map(te).join(", ")}</div>`:"",o=t.nucleo?'<span style="font-size:10px;color:var(--text3);border:1px solid var(--border2);border-radius:3px;padding:1px 5px;margin-left:6px">siempre activa</span>':"";return`
    ...
    </div>`}function zs(t,e,a){const o=t.filter(i=>i._id!==e);if(o.length===0)return"";const n=o.map(i=>`<option value="${ut(i._id)}">${ut(i.nombre)}</option>`).join(""),s=a.map(i=>`
      <label style="display:flex;align-items:center;gap:8px;font-size:12px;color:var(--text2);padding:4px 0">
        <input type="checkbox" data-proyecto-import-col="${ut(i)}"/> ${ut(io(i))}
      </label>`).join("");return`
    ...
    <div class="dm-section">
    ...
    </div>`}function qs(t){const e=t.document??document,{proyectos:a}=t;function o(){const r=a.listar(),c=a.activo()._id;return`
      ...
      ${js()}
      ${zs(r,c,a.colecciones)}`}function n(r){r.innerHTML=`<div class="modal-title">Proyectos</div>${o()}`,s(r)}function s(r){var c,l;r.querySelectorAll("[data-proyecto-accion]").forEach(m=>{m.addEventListener("click",()=>{const d=m.dataset.proyectoId,u=m.dataset.proyectoAccion,v=a.listar().find(g=>g._id===d);if(v){if(u==="cambiar"){if(!ro(t,`¿Cambiar a "${v.nombre}"? Se recargará la página.`))return;a.cambiarA(d),Ps(t);return}if(u==="renombrar"){const g=typeof prompt=="function"?prompt("Nuevo nombre",v.nombre):null;if(!g||!g.trim())return;a.renombrar(d,g.trim()),mt(t,"Proyecto renombrado"),n(r);return}if(u==="duplicar"){const g=`${v.nombre} (copia)`,b=typeof prompt=="function"?prompt("Nombre de la copia",g):g;if(b===null)return;const x=a.duplicar(d,b.trim()||g);mt(t,`"${x.nombre}" creado como copia de "${v.nombre}" ✓`),n(r);return}if(u==="eliminar"){if(!ro(t,`¿Eliminar "${v.nombre}"? Se borran todos sus datos y no se puede deshacer.`))return;try{a.eliminar(d),mt(t,`"${v.nombre}" eliminado`),n(r)}catch(g){mt(t,g.message,"err")}}}})}),(c=r.querySelector("#proyecto-nuevo-btn"))==null||c.addEventListener("click",()=>{const m=r.querySelector("#proyecto-nuevo-nombre"),d=m==null?void 0:m.value.trim();if(!d){mt(t,"Ponle un nombre al proyecto","warn");return}const u=a.crear(d);mt(t,`"${u.nombre}" creado ✓`),n(r)}),(l=r.querySelector("#proyecto-import-btn"))==null||l.addEventListener("click",()=>{var v;const m=(v=r.querySelector("#proyecto-import-origen"))==null?void 0:v.value;if(!m)return;const d=[...r.querySelectorAll("[data-proyecto-import-col]:checked")].map(g=>g.dataset.proyectoImportCol);if(d.length===0){mt(t,"Elige al menos una colección para importar","warn");return}const{importadas:u}=a.importarDesde(m,d);if(u.length===0){mt(t,"El proyecto de origen no tenía nada en esas colecciones","warn");return}mt(t,`Importado: ${u.map(io).join(", ")} ✓`),Fs(),n(r)})}function i(){const r=Ds(e);n(r.content),r.overlay.classList.remove("hidden")}return{open:i,renderInto:n}}const ue=["#2ee6a8","#6366f1","#f59e0b","#ef4444","#8b5cf6","#06b6d4","#f97316","#ec4899"],Mt=t=>String(t??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;");function qt(t,e,a="ok"){if(t.notify)return t.notify(e,a);const o=globalThis.UI;if(o!=null&&o.toast)return o.toast(e,a);console.info("[FinanceApp]",e)}function Rs(t,e){if(t.confirmar)return t.confirmar(e);const a=globalThis.UI;return a!=null&&a.confirm?a.confirm(e):typeof confirm=="function"?confirm(e):!0}function Ns(t){var n;const e=t.getElementById("modal-overlay"),a=t.getElementById("modal-content");if(e&&a)return{overlay:e,content:a};let o=t.getElementById("fa-personas-overlay");return o||(o=t.createElement("div"),o.id="fa-personas-overlay",o.className="modal-overlay",o.innerHTML='<div class="modal-box"><button class="modal-close" data-personas-close>×</button><div id="fa-personas-content"></div></div>',t.body.appendChild(o),o.addEventListener("click",s=>{s.target===o&&(o==null||o.classList.add("hidden"))}),(n=o.querySelector("[data-personas-close]"))==null||n.addEventListener("click",()=>o==null?void 0:o.classList.add("hidden"))),{overlay:o,content:t.getElementById("fa-personas-content")}}function Ls(t){const e=t.color||ue[0];return`
    ...
    <div class="dm-section">
    ...
    </div>`}function ks(t){const e=t.document??document,{store:a}=t;function o(){return`
      <div style="font-size:12px;color:var(--text2);line-height:1.6;margin-bottom:14px">
      ...
      ${g.length===0?`<div class="card" style="padding:24px;text-align:center">
             ...
             </div>`:g.map(h=>l(h,b,x)).join("")}`;const f=()=>u(v);j(v,"[data-nuevo-margen]",()=>d(null,f)),j(v,"[data-editar-margen]",h=>d(h.getAttribute("data-editar-margen"),f)),j(v,"[data-borrar-margen]",h=>{ot("¿Eliminar este margen de seguridad?")&&(s(n().filter(S=>S._id!==h.getAttribute("data-borrar-margen"))),R("Margen eliminado"),f())}),U(v,"[data-toggle-margen]",h=>{const S=h.getAttribute("data-toggle-margen");i(S,C=>{C.activo=h.checked}),f()}),j(v,"[data-add-punto]",h=>{const S=h.getAttribute("data-add-punto");i(S,C=>{C.puntos=[...C.puntos??[],{_id:Ge(),fecha:K(),tipo:"fijo",importe:0,meses:1}]}),f()}),j(v,"[data-borrar-punto]",h=>{const S=h.closest("[data-punto]");if(!S)return;const C=S.dataset.margen,w=S.dataset.punto;i(C,$=>{$.puntos=($.puntos??[]).filter(M=>M._id!==w)}),f()}),U(v,"[data-campo]",h=>{const S=h.closest("[data-punto]");if(!S)return;const C=h.getAttribute("data-campo"),w=h.value;i(S.dataset.margen,$=>{const M=($.puntos??[]).find(_=>_._id===S.dataset.punto);M&&(C==="fecha"?M.fecha=w:C==="tipo"?M.tipo=w:C==="importe"?M.importe=parseFloat(w)||0:M.meses=parseFloat(w)||0)}),f()})}return{id:"margenes",route:"margenes",nombre:"Márgenes de seguridad",flagId:"margenes",seccion:2,iconoPath:Zs,mount:u}}const ei=[...Array.from({length:31},(t,e)=>String(e+1)),"ultimo"],ai=[["1","1º"],["2","2º"],["3","3º"],["4","4º"],["5","5º"],["-1","Último"]],oi=[["1","lunes"],["2","martes"],["3","miércoles"],["4","jueves"],["5","viernes"],["6","sábado"],["0","domingo"]];function ni(t){const e=t||"";if(e.startsWith("dia:"))return{modo:"dia",dia:e.slice(4)||"1",nth:"1",wd:"1"};if(e.startsWith("nthweekday:")){const[,a="1",o="1"]=e.split(":");return{modo:"nthweekday",dia:"1",nth:a,wd:o}}return{modo:"none",dia:"1",nth:"1",wd:"1"}}const Ve=(t,e)=>t.map(([a,o])=>`<option value="${p(a)}"${a===e?" selected":""}>${p(o)}</option>`).join("");function go(t,e="dp"){const{modo:a,dia:o,nth:n,wd:s}=ni(t),i=Ve(ei.map(r=>[r,r==="ultimo"?"Último día":r]),o);return`<div class="form-group" data-diapago="${p(e)}">
    ...
    <div class="flex gap-8 items-center" style="flex-wrap:wrap;row-gap:6px">
      ...
      <span data-dp-nth class="flex gap-8 items-center"${a!=="nthweekday"?' style="display:none"':""}>
        el
        <select class="form-select" data-dp-n style="width:auto;min-width:72px">${Ve(ai,n)}</select>
        <select class="form-select" data-dp-wd style="width:auto;min-width:105px">${Ve(oi,s)}</select>
        del mes
      </span>
    </div>
  </div>`}function vo(t){var o,n,s;const e=t.querySelector("[data-diapago]");if(!e)return;const a=((o=e.querySelector("[data-dp-modo]"))==null?void 0:o.value)??"none";(n=e.querySelector("[data-dp-dia]"))==null||n.style.setProperty("display",a==="dia"?"":"none"),(s=e.querySelector("[data-dp-nth]"))==null||s.style.setProperty("display",a==="nthweekday"?"":"none")}function bo(t){const e=t.querySelector("[data-diapago]");if(!e)return"";const a=n=>{var s;return((s=e.querySelector(n))==null?void 0:s.value)??""},o=a("[data-dp-modo]");return o==="dia"?`dia:${a("[data-dp-dnum]")}`:o==="nthweekday"?`nthweekday:${a("[data-dp-n]")}:${a("[data-dp-wd]")}`:""}const si={partesIguales:"partes iguales",porcentaje:"%",importe:"€ exactos"};function ii(t,e){const a=new Set(((e==null?void 0:e.participantes)??[]).map(o=>o.personaId));return t.filter(o=>o.activo||a.has(o._id))}function Rt(t,e,a,o){if(a.filter(c=>c.activo).length<2)return"";const n=(e==null?void 0:e.modo)??"",s=new Map(((e==null?void 0:e.participantes)??[]).map(c=>[c.personaId,c.valor])),i=n==="porcentaje"||n==="importe",r=c=>{const l=s.has(c._id),m=s.get(c._id);return`<label style="display:flex;align-items:center;gap:8px;font-size:12px;color:var(--text2);padding:3px 0">
    ...
    <div data-reparto-participantes="${p(o)}" style="margin-top:6px;${n?"":"display:none"}">
      ...
      <div class="grid-3 mt-8">
        ...
        <div class="form-group"><label class="form-label">Tipo frecuencia</label>
          <select class="form-select" id="ef-tipo-frec">
            ${ci.map(([w,$])=>`<option value="${w}"${((f==null?void 0:f.tipoFrecuencia)??"mensual")===w?" selected":""}>${p($)}</option>`).join("")}
          </select>
        </div>
      </div>
      ...
      <details class="form-advanced mt-12"${f!=null&&f._id?" open":""}>
        ...
        <div class="form-advanced-body">
          ...
          ${h?"":`${Rt("Reparto de consumo",f==null?void 0:f.repartoConsumo,S,"consumo")}
                 ${Rt("Reparto de pago",f==null?void 0:f.repartoPago,S,"pago")}`}
        </div>
      </details>
    ...
    <div class="loan-card-header" data-toggle-loan="${p(t._id)}">
      <div class="flex gap-8 items-center" style="flex-wrap:wrap">
        ...
        ${(()=>{const v=Ue(t.repartoConsumo,t.repartoPago,e.personas);return v?`<span class="badge" style="background:rgba(139,92,246,0.12);color:#a78bfa" title="${p(v)}">👥 reparto</span>`:""})()}
    ...
    <div class="loan-card-body" data-body-loan="${p(t._id)}">
      ...
      <div class="grid-4 mb-12">
        ${Ye("Cuota mensual",p(P(a.cuota)),e.cuotaMes>0?`<div class="stat-sub" style="color:var(--accent)">Este mes: ${p(P(e.cuotaMes))}</div>`:"")}
        ${Ye("Total intereses",p(P(a.totalIntereses)),o?`<div class="stat-sub" style="text-decoration:line-through;color:var(--text3)" title="Sin amortizaciones">${p(P(a.sinAmort.totalIntereses))}</div>`:"","neg")}
        <div class="stat-card">
        ...
        ${Ye("Total pagado",p(P(a.totalPagado)),t.capital?`<div class="stat-sub">Capital: ${p(P(t.capital))}</div>`:"","neg")}
      </div>

      <div class="grid-2 mb-12" style="gap:10px">
        <div class="stat-card" style="display:flex;gap:16px;align-items:center;flex-wrap:wrap">
          <div><div class="stat-label">TAE</div><div class="stat-value">${p(fa(a.tae))}</div></div>
        ...
        <div class="stat-card" style="display:flex;gap:16px;align-items:center;flex-wrap:wrap">
          ...
          ${t.diaPago?`<div><div class="stat-label">Día de cobro</div><div class="stat-value" style="font-size:14px">${p(Se(t.diaPago))}</div></div>`:""}
        </div>
      </div>
      ...
      <div class="table-wrap"><table>
        ...
        <tbody>${a.tabla.map(v=>mi(v,s,e)).join("")}</tbody>
      </table></div>

      ${o?`<div class="card-title mt-12">Amortizaciones programadas</div>
             ${(t.amortizaciones||[]).map((v,g)=>fi(t._id,v,c[g]??null)).join("")}`:""}
    </div>
  </div>`}function pi(t,e,a,o){const n=t.tipoTasa==="variable"?'<div class="text-sm mt-8" style="color:var(--text3)">⚠ Tipo variable: el beneficio real dependerá de cómo evolucione el índice de referencia.</div>':"";if(o!==null){const r=o-a,c=r>=0;return`<div class="card mb-12" style="background:var(--bg3);padding:12px">
    ...
    ${n}
  </div>`}function mi(t,e,a){let o="";if(e&&!t.esAmortizacion){const n=gt(a.periodos,a.hoy,t.fecha);o=p(P(n>0?t.cuota/n:t.cuota))}return`<tr ${t.esAmortizacion?'style="background:var(--yellow-dim)"':""}>
  ...
  </tr>`}function fi(t,e,a){return`<div class="amort-item" style="flex-wrap:wrap">
   ...
   ${o?`<span class="text-sm" style="margin-left:6px">${p(o)}</span>`:""}`,gi=(t,e)=>t.filter(a=>a.activo!==!1).map(a=>`<option value="${p(a._id)}"${a._id===e?" selected":""}>${p(a.nombre)}</option>`).join("");function vi(t,e,a,o=K()){return`
    <div class="grid-2">
      ...
      <div class="form-advanced-body">
        <div class="grid-2 mt-8">
          <div class="form-group"><label class="form-label">Cuenta bancaria</label>
            <select class="form-select" id="f-cuenta">${gi(e,(t==null?void 0:t.cuenta)??"default")}</select></div>
        ...
        ${Rt("Reparto de consumo",t==null?void 0:t.repartoConsumo,a,"consumo")}
        ${Rt("Reparto de pago",t==null?void 0:t.repartoPago,a,"pago")}
    ...
    </div>`}function bi(t,e,a=K()){return`
    <div class="grid-2">
    ...
    <div class="flex gap-8 mt-16" style="justify-content:flex-end">
    ...
    </div>`}const hi="M11.8 10.9c-2.27-.59-3-1.2-3-2.15 0-1.09 1.01-1.85 2.7-1.85 1.78 0 2.44.85 2.5 2.1h2.21c-.07-1.72-1.12-3.3-3.21-3.81V3h-3v2.16c-1.94.42-3.5 1.68-3.5 3.61 0 2.31 1.91 3.46 4.7 4.13 2.5.6 3 1.48 3 2.41 0 .69-.49 1.79-2.7 1.79-2.06 0-2.87-.92-2.98-2.1h-2.2c.12 2.19 1.76 3.42 3.68 3.83V21h3v-2.15c1.95-.37 3.5-1.5 3.5-3.55 0-2.84-2.43-3.81-4.7-4.4z";function yi(t){const e=t.hoy??K;let a=!1;const o=new Set;let n=null;const s=()=>{var $;return($=t.onDatosCambiados)==null?void 0:$.call(t)};function i($){const M=$.filter(I=>I.activo);if(M.length<2)return"";const _=(I,y)=>`<button class="btn-secondary btn-sm" data-persona-tab="${I===null?"":p(I)}"
      ...
      <div id="loans-list">
        ${A.length===0?'<div class="text-sm" style="text-align:center;padding:40px 0">Sin préstamos.</div>':A.map(q=>ui(q,{periodos:N,usarInflacion:!!T.usarInflacion,hoy:e(),cuotaMes:F.porLoan.get(q._id)??0,completado:E.has(q._id),personas:M})).join("")}
      </div>`;for(const q of $.querySelectorAll("[data-body-loan]"))o.has(q.dataset.bodyLoan??"")&&q.classList.add("open")}const v=()=>document.getElementById("modal-overlay"),g=()=>document.getElementById("modal-content"),b=()=>{var $;return($=v())==null?void 0:$.classList.add("hidden")};function x($,M){const _=v(),I=g();return!_||!I?null:(I.innerHTML=`<div class="modal-title">${p($)}</div>${M}`,_.classList.remove("hidden"),j(I,"[data-cancelar]",b),I)}function f($,M){const _=$?t.store.get("loans").find(y=>y._id===$)??null:null,I=x($?"Editar préstamo":"Nuevo préstamo",vi(_,t.store.get("accounts"),t.store.get("personas"),e()));I&&(I.addEventListener("change",y=>{const E=y.target;E!=null&&E.matches("[data-dp-modo]")&&vo(I),E!=null&&E.matches('[data-reparto-modo="consumo"]')&&Nt(I,"consumo"),E!=null&&E.matches('[data-reparto-modo="pago"]')&&Nt(I,"pago")}),j(I,"[data-guardar-loan]",y=>{h(I,y.getAttribute("data-guardar-loan")||"")&&(b(),M())}))}function h($,M){const _=D=>{var T;return((T=$.querySelector(D))==null?void 0:T.value)??""},I=D=>{var T;return!!((T=$.querySelector(D))!=null&&T.checked)},y=_("#f-nombre").trim(),E=parseFloat(_("#f-capital")),A=parseFloat(_("#f-tin")),F=parseInt(_("#f-meses"),10);if(!y||!Number.isFinite(E)||!Number.isFinite(A)||!Number.isFinite(F))return R("Completa los campos obligatorios","err"),!1;const z={nombre:y,capital:E,tin:A,meses:F,fechaInicio:_("#f-fecha"),comisionApertura:parseFloat(_("#f-com-ap"))||0,comisionAmort:parseFloat(_("#f-com-am"))||0,diaPago:bo($),cuenta:_("#f-cuenta"),simulacion:I("#f-sim"),activo:I("#f-activo"),mostrarFechaFinEnDashboard:I("#f-mostrar-fin"),tipoTasa:_("#f-tipo-tasa"),basico:I("#f-basico"),tags:_("#f-tags").split(",").map(D=>D.trim()).filter(Boolean),repartoConsumo:Lt($,"consumo"),repartoPago:Lt($,"pago")};return M?(t.store.updateItem("loans",M,z),R("Préstamo actualizado")):(t.store.addItem("loans",{...z,amortizaciones:[]}),R("Préstamo creado")),s(),!0}function S($,M,_){const I=t.store.get("loans").find(A=>A._id===$);if(!I)return;const y=M?(I.amortizaciones||[]).find(A=>A._id===M)??null:null,E=x(M?"Editar amortización":"Añadir amortización",bi($,y,e()));E&&j(E,"[data-guardar-amort]",A=>{const[F,z]=(A.getAttribute("data-guardar-amort")||"").split("|");C(E,F,z)&&(b(),_([F]))})}function C($,M,_){var T;const I=N=>{var H;return((H=$.querySelector(N))==null?void 0:H.value)??""},y=I("#am-fecha"),E=parseFloat(I("#am-cant"));if(!y||!Number.isFinite(E)||E<=0)return R("Fecha y cantidad requeridas","err"),!1;const A=t.store.get("loans").find(N=>N._id===M);if(!A)return!1;const F={fecha:y,cantidad:E,tipo:I("#am-tipo"),simulacion:!!((T=$.querySelector("#am-sim"))!=null&&T.checked)},z=A.amortizaciones||[],D=_?z.map(N=>N._id===_?{...N,...F}:N):[...z,{_id:Date.now().toString(36),...F}];return t.store.updateItem("loans",M,{amortizaciones:D}),R(_?"Amortización actualizada":"Amortización añadida"),s(),!0}function w($,M){j($,"[data-toggle-finalizados]",()=>{a=!a,M()}),j($,"[data-persona-tab]",_=>{n=_.getAttribute("data-persona-tab")||null,M()}),j($,"[data-nuevo-loan]",()=>f(null,M)),j($,"[data-toggle-loan]",(_,I)=>{var F;if((F=I.target)!=null&&F.closest("button"))return;const y=_.getAttribute("data-toggle-loan"),E=[...$.querySelectorAll("[data-body-loan]")].find(z=>z.dataset.bodyLoan===y);(E==null?void 0:E.classList.toggle("open"))?o.add(y):o.delete(y)}),j($,"[data-editar-loan]",_=>f(_.getAttribute("data-editar-loan"),M)),j($,"[data-borrar-loan]",_=>{if(!ot("¿Eliminar préstamo?"))return;const I=_.getAttribute("data-borrar-loan");t.store.removeItem("loans",I),o.delete(I),R("Eliminado"),s(),M()}),j($,"[data-amort-loan]",_=>{const I=_.getAttribute("data-amort-loan");o.add(I),S(I,null,M)}),j($,"[data-editar-amort]",_=>{const[I,y]=(_.getAttribute("data-editar-amort")||"").split("|");o.add(I),S(I,y,M)}),j($,"[data-borrar-amort]",_=>{const[I,y]=(_.getAttribute("data-borrar-amort")||"").split("|"),E=t.store.get("loans").find(A=>A._id===I);E&&(t.store.updateItem("loans",I,{amortizaciones:(E.amortizaciones||[]).filter(A=>A._id!==y)}),R("Amortización eliminada"),s(),M([I]))})}return{id:"loans",route:"loans",nombre:"Préstamos",flagId:"loans",seccion:1,iconoPath:hi,mount($){const M=(_=[])=>{for(const I of _)o.add(I);u($)};u($),$.dataset.wired!=="1"&&(w($,M),$.dataset.wired="1")}}}const We=6.35;function Ot(t){return(t.retribucionFlexible||[]).reduce((e,a)=>e+(a.importe||0)*12,0)}function $o(t){return Math.max(0,(t.bruto||0)-Ot(t))}function $i(t){return[...t].sort((e,a)=>(a.bruto||0)-(e.bruto||0)||String(e._id).localeCompare(String(a._id)))}function xi(t){const e=t.reduce((i,r)=>i+(r.bruto||0),0),a=t.reduce((i,r)=>i+Ot(r),0),o=Math.max(0,e-a),n=ht(e,a),s=new Map;for(const i of t)s.set(i._id,o>0?n*($o(i)/o):0);return s}function xo(t,e,a){if(t.irpfModo==="manual")return $o(t)*((t.irpfPct||0)/100);if(!e||e.length===0)return lt(ht(t.bruto||0,Ot(t)),a);const o=$i(e.filter(i=>i.irpfModo!=="manual")),n=xi(e);let s=0;for(const i of o){const r=n.get(i._id)??0;if(i._id===t._id)return lt(s+r,a)-lt(s,a);s+=r}return lt(ht(t.bruto||0,Ot(t)),a)}function wi(t,e){return t.reduce((a,o)=>a+xo(o,t,e),0)}function Ii(t,e){var n;const a=[...e||[]].sort((s,i)=>s[0]-i[0]);let o=((n=a[0])==null?void 0:n[1])??19;for(const[s,i]of a)if(t>=s)o=i;else break;return o}function Ci(t,e){if(!t||t.length===0)return 0;const a=t.reduce((n,s)=>n+(s.bruto||0),0),o=t.reduce((n,s)=>n+Ot(s),0);return Ii(ht(a,o),e)}function Si(t,e,a){const o=t.bruto||0,n=Ot(t),s=Math.max(0,o-n),i=t.nPagas||12,r=t.ssPct??We,c=s*(r/100),l=xo(t,e,a);return{brutoAnual:o,flexAnual:n,baseDineraria:s,nPagas:i,ssPct:r,ssAnual:c,irpfAnual:l,irpfPct:s>0?l/s*100:0,netoPorPaga:(s-c-l)/i}}function Ai(t){const e=new Map,a=[];for(const o of t){const n=o.grupoNomina||"";if(!n){a.push(o);continue}const s=e.get(n)??[];s.push(o),e.set(n,s)}return{grupos:e,sueltas:a}}const Mi={transporte:125,restaurante:220,otros:null},Ei={transporte:"Transporte",restaurante:"Restaurante",otros:"Otros"},_i=["Enero","Febrero","Marzo","Abril","Mayo","Junio","Julio","Agosto","Septiembre","Octubre","Noviembre","Diciembre"],kt=(t,e,a,o,n="")=>`<div class="form-group"><label class="form-label">${p(e)}</label>
   <input class="form-input" type="${a}" id="${t}" value="${p(o)}" placeholder="${p(n)}"/></div>`,Pi=(t,e)=>t.filter(a=>a.activo!==!1).map(a=>`<option value="${p(a._id)}"${a._id===e?" selected":""}>${p(a.nombre)}</option>`).join("");function Fi(t,e){const a=t.map((s,i)=>{const r=e.find(m=>m._id===s.cuenta),c=Mi[s.tipo],l=c!=null&&s.importe>c;return`<div class="flex gap-8 items-center" style="padding:5px 0;border-bottom:1px solid var(--border)">
        <span class="badge badge-blue" style="min-width:88px;text-align:center">${p(Ei[s.tipo]??s.tipo)}</span>
    ...
    <button class="btn-secondary btn-sm mt-6" data-flex-anadir>+ Añadir componente</button>`}function Di(t,e){const a=e.hoy??K(),o=(t==null?void 0:t.nPagas)??12,n=[12,14,16].includes(o);return`
    <div class="grid-2">
    ...
    <div class="grid-2 mt-8">
      ...
      <div class="form-group"><label class="form-label">Cuenta</label>
        <select class="form-select" id="nf-cuenta">${Pi(e.accounts,(t==null?void 0:t.cuenta)??e.cuentaPrincipal)}</select></div>
    </div>
    ...
    <details class="form-advanced mt-12"${t!=null&&t._id?" open":""}>
      ...
      <div class="form-advanced-body">
        ...
        <div class="grid-2 mt-8">
          ...
          <div class="form-group"><label class="form-label">Mes actualización IPC (opcional)</label>
            <select class="form-select" id="nf-mes-ipc">
              ...
              ${_i.map((s,i)=>`<option value="${i+1}"${(t==null?void 0:t.mesActualizacionIPC)===i+1?" selected":""}>${p(s)} (${i+1})</option>`).join("")}
            </select>
          </div>
        </div>
        <div class="grid-2 mt-8">
        ...
        ${Rt("Reparto de consumo",t==null?void 0:t.repartoConsumo,e.personas,"consumo")}
        ${Rt("Reparto de pago",t==null?void 0:t.repartoPago,e.personas,"pago")}
      </div>
    </details>
    ...
    </div>`}function wo(t,e){const a=i=>{var r;return((r=t.querySelector(i))==null?void 0:r.value)??""},o=(i,r=0)=>{const c=parseFloat(a(i));return Number.isFinite(c)?c:r},n=a("#nf-npagas"),s=n==="custom"?parseInt(a("#nf-npagas-custom"),10)||12:parseInt(n,10)||12;return{nombre:a("#nf-nombre").trim(),bruto:o("#nf-bruto"),nPagas:s,irpfModo:a("#nf-irpfmodo")||"auto",irpfPct:o("#nf-irpfpct"),ssPct:o("#nf-sspct",We),representacion:a("#nf-representacion")||"detallado",fechaInicio:a("#nf-fecha-ini"),fechaFin:a("#nf-fecha-fin")||null,cuenta:a("#nf-cuenta"),grupoNomina:a("#nf-grupo").trim(),mesActualizacionIPC:parseInt(a("#nf-mes-ipc"),10)||null,retribucionFlexible:e,repartoConsumo:Lt(t,"consumo"),repartoPago:Lt(t,"pago")}}function Ti(t,e,a,o){const n=wo(t,e),s=e.reduce((f,h)=>f+(h.importe||0)*12,0),i=Math.max(0,n.bruto-s),r=i*(n.ssPct/100),c=n.irpfModo==="manual"?i*(n.irpfPct/100):lt(ht(n.bruto,s),a.tramos),l=i-r-c,m=i/n.nPagas,d=r/n.nPagas,u=c/n.nPagas,v=m-d-u,g=n.grupoNomina?a.nominas.filter(f=>f.grupoNomina===n.grupoNomina&&f._id!==o):[],b=g.length>0?`<div style="margin-top:6px;color:var(--yellow);font-size:11px">⚡ En el grupo "${p(n.grupoNomina)}" con ${p(g.map(f=>f.nombre).join(", "))} — el IRPF final se calculará al tipo marginal del grupo.</div>`:"",x=s>0?`<span style="color:var(--text2)">Retrib. flexible:</span><span style="color:var(--accent)">-${p(P(s))}/año (exento IRPF y SS)</span>
    ...
    <div style="margin-top:8px;display:grid;grid-template-columns:1fr 1fr;gap:4px">
      ...
      <div style="border:1px solid var(--border);border-radius:var(--radius);overflow:hidden;margin-bottom:14px">
        ...
        <div style="${v}">
          ...
          <span class="text-sm" style="color:var(--text2)">${p(Io(i()))}</span>
        ...
        ${u.map(b=>`<div style="${v}">
              ...
              <span class="text-sm" style="color:var(--text2)">${p(Io(b.tramos))}</span>
   ...
   <select class="form-select" id="${t}">
    ...
    </div>`:`<div class="grid-3">${t.map(n=>Li(n,e,a,o)).join("")}</div>`}function Li(t,e,a,o){const n=Pe(t);if(!n)return"";const s=Fe(t,e,a),i=o.slice(0,4),r=(t.aportaciones||[]).filter(l=>l.fecha>=`${i}-01-01`).reduce((l,m)=>l+m.cantidad,0),c=Math.min(r,Co)*(s/100);return`<div class="card">
    ...
    <div style="margin-top:10px;padding:8px;background:var(--bg3);border-radius:var(--radius);border:1px solid var(--border)">
      ...
      <div class="flex justify-between mb-4"><span class="text-sm" style="color:var(--text2)">Aportado</span><span class="num ${r>Co?"neg":""}">${p(P(r))}</span></div>
  ...
  </div>`}function Oi(t){return`<div>${t.map((a,o)=>`<div class="flex gap-8 items-center" style="padding:4px 0;border-bottom:1px solid var(--border)">
    ...
    <div class="flex gap-8 mt-16" style="justify-content:flex-end">
    ...
    </div>`}const r=h=>{var S;return((S=t.store.get("accounts").find(C=>C._id===(h||"default")))==null?void 0:S.nombre)??(h||"default")};function c(h,S,C){const w=S.reduce((_,I)=>_+(I.bruto||0),0),$=wi(S,C),M=w>0?$/w*100:0;return`<div style="margin-bottom:16px">
    ...
    </div>`}function l(h){const S=s(),C=t.store.get("personas"),w=re(C),$=[...t.store.get("nominas")].sort((A,F)=>(F.bruto||0)-(A.bruto||0)),M=o?$.filter(A=>Ee(A.repartoConsumo,A.repartoPago,w).has(o)):$,{grupos:_,sueltas:I}=Ai(M),y=t.store.get("accounts").filter(Ri),E=$.filter(A=>A.activo!==!1);h.innerHTML=`
      <div class="page-header">
      ...
      <div>${Ni(y,E,S,e())}</div>`}const m=()=>document.getElementById("modal-overlay"),d=()=>document.getElementById("modal-content"),u=()=>{var h;return(h=m())==null?void 0:h.classList.add("hidden")};function v(h,S){const C=m(),w=d();return!C||!w?null:(w.innerHTML=`<div class="modal-title">${p(h)}</div>${S}`,C.classList.remove("hidden"),j(w,"[data-cancelar]",u),w)}function g(h,S){const C=h?t.store.get("nominas").find(_=>_._id===h)??null:null,w=[...(C==null?void 0:C.retribucionFlexible)??[]].map(_=>({..._})),$={accounts:t.store.get("accounts"),nominas:t.store.get("nominas"),personas:t.store.get("personas"),cuentaPrincipal:t.store.getPrincipalAccountId(),tramos:s(),hoy:e()},M=v(h?"Editar nómina":"Nueva nómina",Di(C,$));M&&(zi(M,w,$,h??""),j(M,"[data-guardar-nomina]",_=>{const I=wo(M,w);if(!I.nombre||I.bruto<=0)return R("Nombre y bruto anual son obligatorios","err");const y=_.getAttribute("data-guardar-nomina")||"",E={...I,activo:!0,tags:["nomina"]};y?(t.store.updateItem("nominas",y,E),R("Nómina actualizada")):(t.store.addItem("nominas",E),R("Nómina creada")),a(),u(),S()}))}function b(h,S){const C=h?t.store.get("accounts").find(M=>M._id===h)??null:null,w=[...(C==null?void 0:C.planAportaciones)??[]].map(M=>({...M})),$=v(h?"Editar plan de pensiones":"Nuevo plan de pensiones",ki(C,{nominas:t.store.get("nominas"),hoy:e()}));$&&(Bi($,w,e()),j($,"[data-guardar-pension]",M=>{const{datos:_,error:I}=Hi($,w,C,e());if(I)return R(I,"err");const y=M.getAttribute("data-guardar-pension")||"";y?(t.store.updateItem("accounts",y,_),R("Plan actualizado")):(t.store.addItem("accounts",_),R("Plan creado")),a(),u(),S()}))}function x(h,S,C){j(h,"[data-persona-tab]",w=>{o=w.getAttribute("data-persona-tab")||null,S()}),j(h,"[data-nueva-nomina]",()=>g(null,S)),j(h,"[data-editar-nom]",w=>g(w.getAttribute("data-editar-nom"),S)),j(h,"[data-borrar-nom]",w=>{ot("¿Eliminar esta nómina?")&&(t.store.removeItem("nominas",w.getAttribute("data-borrar-nom")),R("Eliminada"),a(),S())}),U(h,"[data-activo-nom]",w=>{const $=w;t.store.updateItem("nominas",$.getAttribute("data-activo-nom"),{activo:$.checked}),a(),S()}),j(h,"[data-tramos]",()=>C.abrir()),j(h,"[data-nueva-pension]",()=>b(null,S)),j(h,"[data-editar-pension]",w=>b(w.getAttribute("data-editar-pension"),S)),j(h,"[data-borrar-pension]",w=>{ot("¿Eliminar este plan de pensiones?")&&(t.store.removeItem("accounts",w.getAttribute("data-borrar-pension")),R("Plan eliminado"),a(),S())})}let f=null;return{id:"nominas",route:"nominas",nombre:"Nóminas",flagId:"nominas",seccion:1,iconoPath:Gi,mount(h){const S=()=>l(h);f??(f=ji({store:t.store,onDatosCambiados:()=>{a(),S()},año:()=>Number(e().slice(0,4))})),l(h),h.dataset.wired!=="1"&&(x(h,S,f),h.dataset.wired="1")}}}const Ui="M3 17.25V21h3.75L17.81 9.94l-3.75-3.75L3 17.25zM20.71 7.04c.39-.39.39-1.02 0-1.41l-2.34-2.34c-.39-.39-1.02-.39-1.41 0l-1.83 1.83 3.75 3.75 1.83-1.83z",Yi="M13 3c-4.97 0-9 4.03-9 9H1l3.89 3.89.07.14L9 12H6c0-3.87 3.13-7 7-7s7 3.13 7 7-3.13 7-7 7c-1.93 0-3.68-.79-4.94-2.06l-1.42 1.42C8.27 19.99 10.51 21 13 21c4.97 0 9-4.03 9-9s-4.03-9-9-9zm-1 5v5l4.28 2.54.72-1.21-3.5-2.08V8H12z",So={transporte:{label:"Transporte",limiteAnual:1500},restaurante:{label:"Restaurante",limiteAnual:2640},otros:{label:"Otros",limiteAnual:null}},Wi={entradas:[],salidas:[],totalAportaciones:0,totalReembolsos:0,retencion:0};function Ki(t,e){const a=t.filter(c=>c.activo&&rt(c)==="inversion");if(a.length===0)return"";let o=0,n=0,s=0,i=0;for(const c of a){const l=ce(c,e);l&&(o+=l.saldo,n+=l.costBase,s+=l.plusvalia,i+=l.impuesto)}const r=n>0?(s/n*100).toFixed(1):"0";return`
    ...
    </div>`}function Ji(t,e){if(!t.activo||!t.interes||t.interes<=0)return"";const{dashboardStart:a,dashboardEnd:o}=e.config,n=Math.max(1,(O(o).getTime()-O(a).getTime())/(30.44*864e5)),s=Vt(t,a),i=s*(Math.pow(1+t.interes/100,n/12)-1);let r="";if(e.config.usarInflacion&&e.inflacion.length>0){const c=s*(gt(e.inflacion,a,o)-1),l=i-c;r=`
  ...
  </div>`}function Qi(t,e){const a=So[t.tipoBeneficio??""]??{label:"Beneficio",limiteAnual:null},{limiteAnual:o}=a,n=e.nominas.flatMap(v=>(v.retribucionFlexible??[]).filter(g=>g.cuenta===t._id).map(g=>({nomina:v,importe:g.importe}))),s=n.reduce((v,g)=>v+g.importe,0),i=s*12,r=o!==null&&i>o,c=o!==null?Math.min(i,o):i,l=t.grupoNomina?e.nominas.filter(v=>(v.grupoNomina||"")===t.grupoNomina&&v.activo!==!1):n.slice(0,1).map(v=>v.nomina),m=Ci(l,e.tramosIRPF),d=c*m/100,u=t.grupoNomina?`grupo "${t.grupoNomina}", tipo marginal ${m}%`:`tipo marginal ${m}%`;return`<div style="margin-top:10px;padding:10px;background:var(--bg3);border-radius:var(--radius);border:1px solid rgba(99,214,160,0.35)">
  ...
  </div>`}function Xi(t){const e=Pe(t);return e?`<div style="margin-top:10px;padding:10px;background:var(--bg3);border-radius:var(--radius);border:1px solid var(--yellow-dark, #7a6010)">
  ...
  </div>`:""}function Zi(t,e){const a=ce(t,e.tramosGanancias);if(!a)return"";const o=e.config,n=e.flujos(t._id),s=O(o.dashboardStart),i=O(o.dashboardEnd),r=Math.max(0,(i.getTime()-s.getTime())/(30.44*864e5)),c=a.saldo+n.totalAportaciones-n.totalReembolsos,l=t.interes>0?Math.pow(1+t.interes/100,1/12)-1:0,m=c>0&&r>0?Math.max(0,c*Math.pow(1+l,r)):Math.max(0,c),d=a.costBase+n.totalAportaciones,u=Math.max(0,m-d),v=_e(u,e.tramosGanancias),g=u>0?(v/u*100).toFixed(1):"0",b=t.interes>0?`${t.interes}% anual`:"sin rentabilidad",x=a.saldo>0?(a.plusvalia/a.saldo*100).toFixed(1):"0",f=(M,_,I)=>M.map(y=>`<div class="flex justify-between mt-4">
    ...
    <div class="flex justify-between items-center mb-12">
      ...
      <div class="flex gap-8">
        ...
        <button class="btn-icon" data-hist-acc="${p(t._id)}" title="Histórico de saldos"><svg viewBox="0 0 24 24"><path d="${Yi}"/></svg></button>
        <button class="btn-icon" data-editar-acc="${p(t._id)}" title="Editar"><svg viewBox="0 0 24 24"><path d="${Ui}"/></svg></button>
    ...
    <button class="btn-secondary btn-sm mt-6" data-aport-anadir>+ Añadir aportación</button>`}function or(t,e){const a=t?rt(t):"cuenta",o=[...new Set(e.nominas.filter(s=>s.grupoNomina).map(s=>s.grupoNomina))],n=s=>s?"":' style="display:none"';return`
    <div class="grid-2">
      ${tt("ac-nombre","Nombre","text",(t==null?void 0:t.nombre)??"","Ej: Cuenta ING, Fondo Vanguard")}
      ${ae("ac-modelo","Tipo",er,a)}
    </div>
    <div class="grid-2 mt-8">
    ...
    <div class="flex gap-8 mt-12" style="justify-content:flex-end">
      ...
      <div style="border:1px solid var(--border);border-radius:var(--radius);overflow:hidden;margin-bottom:14px">
        ...
        <div style="${v}">
          <span style="font-weight:600;font-size:13px">Por defecto</span>
          <span class="text-sm" style="color:var(--text2)">${p(Ao(i()))}</span>
          <button class="btn-secondary btn-sm" data-editar-tg="default">Editar</button>
        </div>
        ${u.map(b=>`<div style="${v}">
              <span style="font-weight:600;font-size:13px">${b.año}</span>
              <span class="text-sm" style="color:var(--text2)">${p(Ao(b.tramos))}</span>
              <div class="flex gap-6">
      ...
      </div>`);if(!b)return;const x=()=>{const h=b.querySelector("#tg-rows");h&&(h.innerHTML=l())};j(b,"[data-volver-tg]",c),j(b,"[data-tg-anadir]",()=>{m(b),a.push([0,0]),x()}),j(b,"[data-tg-borrar]",h=>{m(b),a.splice(Number(h.getAttribute("data-tg-borrar")),1),x()}),j(b,"[data-tg-guardar]",()=>{m(b);const h=[...a].sort((S,C)=>S[0]-C[0]);if(h.length===0)return R("Añade al menos un tramo","err");e==="default"?(t.store.patchConfig({tramosGananciasCapital:h}),R("Tabla por defecto guardada")):(t.store.set("tramosGananciasCapitalHistorico",t.store.get("tramosGananciasCapitalHistorico").map(S=>S.año===e?{...S,tramos:h}:S)),R(`Tabla ${e} guardada`)),t.onDatosCambiados(),c()})}return{abrir:c}}const cr=[{id:"cuentas",etiqueta:"Cuentas"},{id:"movimientos",etiqueta:"Movimientos"},{id:"importar",etiqueta:"Importar CSV"},{id:"cierre",etiqueta:"Cierre y precisión"}];function lr(t){return`<div class="flex gap-6 mb-14 flex-wrap" data-cuentas-tabs>
    ${cr.map(e=>`<button class="btn-secondary btn-sm" data-cuentas-tab="${e.id}" style="${e.id===t?"background:var(--accent);color:#04120c;border-color:var(--accent)":""}">${e.etiqueta}</button>`).join("")}
  </div>`}function dr(t,e){if(t===0)return e===0?100:0;const a=Math.abs(e-t)/Math.abs(t);return Math.max(0,Math.min(100,(1-a)*100))}function Mo(t,e){const a=O(t),o=[];for(let n=1;n<=e;n++){const s=new Date(a.getFullYear(),a.getMonth()-n,1);o.push(`${s.getFullYear()}-${String(s.getMonth()+1).padStart(2,"0")}`)}return o.reverse()}function ur(t,e,a){const o=Mo(a,1)[0],n=e.slice(0,7)<o?e.slice(0,7):o,s=[];let[i,r]=t.slice(0,7).split("-").map(Number);for(;`${i}-${String(r).padStart(2,"0")}`<=n;)s.push(`${i}-${String(r).padStart(2,"0")}`),++r>12&&(r=1,i++);return s}function Eo(t){const[e,a]=t.split("-").map(Number),o=new Date(e,a,0);return{inicio:`${t}-01`,fin:`${t}-${String(o.getDate()).padStart(2,"0")}`}}function pr(t,e){const{inicio:a,fin:o}=Eo(e);return Je(t,a,o)}function Je(t,e,a){return Yt([t],{start:e,end:a}).reduce((n,s)=>n+Math.abs(s.cuantia),0)}function mr(t){function e(n,s={}){var _;const{mesesHistorial:i=12,mesesMedia:r=3,hoy:c=K(),desde:l,hasta:m}=s,d=t.transacciones({estimacionId:n._id}),v=d.length===0&&(((_=n.tags)==null?void 0:_.length)??0)>0?t.transacciones({tags:n.tags}):d,g=l&&m?ur(l,m,c):Mo(c,i),b=new Map(g.map(I=>{const{inicio:y,fin:E}=Eo(I);return[I,{inicio:l&&l>y?l:y,fin:m&&m<E?m:E}]})),x=new Map;for(const I of v){const y=b.get(I.fecha.slice(0,7));if(!y||I.fecha<y.inicio||I.fecha>y.fin)continue;const E=I.fecha.slice(0,7);x.set(E,(x.get(E)??0)+Math.abs(I.importeCts)/100)}const f=[];for(const I of g){const y=x.get(I);if(y===void 0)continue;const E=b.get(I),A=G(Je(n,E.inicio,E.fin));f.push({mes:I,estimado:A,real:G(y),desviacion:G(y-A),precision:dr(A,y)})}const h=G(f.reduce((I,y)=>I+y.estimado,0)),S=G(f.reduce((I,y)=>I+y.real,0)),C=f.reduce((I,y)=>I+Math.abs(y.estimado),0),w=f.length===0?null:C>0?f.reduce((I,y)=>I+y.precision*Math.abs(y.estimado),0)/C:f.reduce((I,y)=>I+y.precision,0)/f.length,$=f.slice(-r),M=$.length>0?G($.reduce((I,y)=>I+y.real,0)/$.length):null;return{estimacionId:n._id,concepto:n.concepto,tags:n.tags??[],meses:f,estimadoTotal:h,realTotal:S,desviacionTotal:G(S-h),precision:w,mediaRealReciente:M,infraestimada:S>h}}function a(n,s={}){return n.filter(i=>i.tipo!=="transferencia").map(i=>e(i,s)).sort((i,r)=>i.precision===null&&r.precision===null?i.concepto.localeCompare(r.concepto):i.precision===null?1:r.precision===null?-1:i.precision-r.precision)}function o(n){const s=new Map;for(const i of n)if(i.precision!==null)for(const r of i.tags.length>0?i.tags:["sin_tag"]){const c=s.get(r)??{estimado:0,real:0,pesoPrecision:0,peso:0,n:0};c.estimado+=i.estimadoTotal,c.real+=i.realTotal,c.pesoPrecision+=i.precision*Math.abs(i.estimadoTotal),c.peso+=Math.abs(i.estimadoTotal),c.n+=1,s.set(r,c)}return[...s.entries()].map(([i,r])=>({tag:i,estimadoTotal:G(r.estimado),realTotal:G(r.real),desviacionTotal:G(r.real-r.estimado),precision:r.peso>0?r.pesoPrecision/r.peso:null,estimaciones:r.n})).sort((i,r)=>(i.precision??101)-(r.precision??101))}return{analizarEstimacion:e,analizarTodas:a,analizarPorTag:o}}function fr(t){const[e,a]=t.split("-").map(Number);return`${t}-${String(new Date(e,a,0).getDate()).padStart(2,"0")}`}function gr(t,e){const a=[];let[o,n]=t.slice(0,7).split("-").map(Number);const[s,i]=e.slice(0,7).split("-").map(Number);for(;o<s||o===s&&n<=i;)a.push(`${o}-${String(n).padStart(2,"0")}`),n+=1,n>12&&(n=1,o+=1);return a}function vr(t,e,a,o){const n=r=>e.filter(c=>c.tipo===r&&c.activo!==!1),s=n("gasto"),i=n("ingreso");return gr(a,o).map(r=>{const c={desde:`${r}-01`,hasta:fr(r)},l=b=>G(t.transacciones({...c,tipo:b}).reduce((x,f)=>x+Math.abs(f.importeCts)/100,0)),m=b=>G(b.reduce((x,f)=>x+pr(f,r),0)),d=m(s),u=l("gasto"),v=m(i),g=l("ingreso");return{mes:r,estimado:d,real:u,ingresosEstimados:v,ingresosReales:g,netoEstimado:G(v-d),netoReal:G(g-u)}})}const ge=640,Bt=200,Q={top:14,right:16,bottom:26,left:54};function br(t){return me(t).slice(0,3)}const hr={gasto:t=>({estimado:t.estimado,real:t.real}),ingreso:t=>({estimado:t.ingresosEstimados,real:t.ingresosReales}),neto:t=>({estimado:t.netoEstimado,real:t.netoReal})};function yr(t,e="gasto"){if(t.length===0)return'<div class="text-sm" style="color:var(--text3)">Sin meses que mostrar en este intervalo.</div>';const a=hr[e],o=t.flatMap(x=>[a(x).estimado,a(x).real]),n=ge-Q.left-Q.right,s=Bt-Q.top-Q.bottom,i=Math.max(1,...o),r=Math.min(0,...o),c=i-r||1,l=x=>Q.left+(t.length===1?n/2:x/(t.length-1)*n),m=x=>Q.top+s-(x-r)/c*s,d=t.map((x,f)=>`${l(f)},${m(a(x).estimado)}`).join(" "),u=t.map((x,f)=>`${l(f)},${m(a(x).real)}`).join(" "),v=r<0?`<line x1="${Q.left}" y1="${m(0).toFixed(1)}" x2="${ge-Q.right}" y2="${m(0).toFixed(1)}" stroke="var(--border)" stroke-width="1" stroke-dasharray="2,3"/>`:"",g=t.map((x,f)=>`<circle cx="${l(f).toFixed(1)}" cy="${m(a(x).real).toFixed(1)}" r="3" fill="var(--accent)"><title>${p(me(x.mes))}: ${p(P(a(x).real))}</title></circle>`).join(""),b=t.map((x,f)=>`<text x="${l(f).toFixed(1)}" y="${Bt-8}" font-size="9" text-anchor="middle" fill="var(--text3)" font-family="var(--font-mono)">${p(br(x.mes))}</text>`).join("");return`
    ...
    </div>`}const _o={gasto:"Gasto",ingreso:"Ingreso",ajuste:"Ajuste",transferencia:"Transferencia propia"};function $r(t){return{cuentaId:"",mes:t,filtroTexto:"",vista:"mensual",periodoDesde:Po(t,5),periodoHasta:t,detalleAbierto:new Set,intervaloDesde:ne(Po(t,5)).desde,intervaloHasta:ne(t).hasta,comparativa:"neto"}}function Qe(t,e,a,o){const n=t===e?"background:var(--accent);color:#04120c;border-color:var(--accent)":"";return`<button class="btn-secondary btn-sm" data-acc-comparativa="${t}" title="${p(o)}" style="${n}">${p(a)}</button>`}function ne(t){const[e,a]=t.split("-").map(Number),o=new Date(e,a,0).getDate();return{desde:`${t}-01`,hasta:`${t}-${String(o).padStart(2,"0")}`}}function Po(t,e){const[a,o]=t.split("-").map(Number),n=new Date(a,o-1-e,1);return`${n.getFullYear()}-${String(n.getMonth()+1).padStart(2,"0")}`}function Xe(t,e){const[a,o]=t<=e?[t,e]:[e,t];return{desde:ne(a).desde,hasta:ne(o).hasta}}function xr(t,e){return t<=e?{desde:t,hasta:e}:{desde:e,hasta:t}}function Ze(t){const e=new Map;for(const a of t){const o=a.concepto.trim(),n=e.get(o);n?n.push(a):e.set(o,[a])}return[...e.entries()].filter(([,a])=>a.length>1).map(([a,o])=>{const n=new Set(o.map(s=>s.estimacionId??null));return{concepto:a,movimientos:o.slice().sort((s,i)=>s.fecha.localeCompare(i.fecha)),total:o.reduce((s,i)=>s+i.importeCts,0),estimacionComun:n.size===1?n.values().next().value??null:null,tagsComunes:[...new Set(o.flatMap(s=>s.tags))].sort()}}).sort((a,o)=>o.movimientos.length-a.movimientos.length||a.concepto.localeCompare(o.concepto))}function wr(t,e){if(t.tagsComunes.length===0)return null;const a=new Set(t.movimientos.map(s=>s._id)),o=e.filter(s=>!a.has(s._id)&&s.tipo==="gasto"&&s.tags.some(i=>t.tagsComunes.includes(i))).reduce((s,i)=>s+Math.abs(i.importeCts),0),n=Math.abs(t.total);return{tags:t.tagsComunes,transferidoCts:n,gastadoCts:o,diferenciaCts:o-n}}function Ir(t){if(!t)return'<div class="text-sm" style="color:var(--text3)">Añade etiquetas para comparar lo traspasado con el gasto real que cubre.</div>';const e=t.diferenciaCts===0?"var(--text2)":t.diferenciaCts>0?"var(--red)":"var(--accent)",a=t.diferenciaCts>0?"+":"";return`
    <div style="display:flex;gap:16px;flex-wrap:wrap;font-size:12px">
      ...
      <tr data-tx="${p(y._id)}" style="border-bottom:1px solid var(--border)${y.tipo==="transferencia"?";opacity:0.7":""}">
        ...
        <td style="padding:7px 8px">${mo(y.tags)}</td>
      ...
      </tr>`}).join(""),w=i?vr(a,d,r,c):[],$=s?a.transacciones({desde:r,hasta:c}):[],_=(s?Ze(m):[]).map(y=>{const E=e.detalleAbierto.has(y.concepto),A=E?`<tr style="background:var(--bg2);border-bottom:1px solid var(--border)">
    ...
    <div class="grid-2 mb-14" style="align-items:start">
        ...
        ${s?`<div class="text-sm mb-8" style="color:var(--text3)">Conceptos idénticos repetidos entre ${p(e.periodoDesde)} y ${p(e.periodoHasta)}. Cambia la estimación de la fila para asignarla a todos los movimientos del grupo a la vez.</div>
               ...
               ${i?`<div class="divider"></div>
                      <div class="flex justify-between items-center flex-wrap mb-8" style="gap:8px">
                        ...
                        <div class="flex gap-6">
                          ${Qe("neto",e.comparativa,"Neto","Ingresos menos gastos: no se descuadra por un traspaso entre tus cuentas")}
                          ${Qe("gasto",e.comparativa,"Gasto","Solo el gasto")}
                          ${Qe("ingreso",e.comparativa,"Ingresos","Solo lo que entra")}
                        </div>
                      </div>
                      ${yr(w,e.comparativa)}`:""}`}
      </div>
      ...
      <tr style="border-bottom:1px solid var(--border)">
        ...
        <td style="padding:7px 8px;text-align:right">${Qs(c.precision)}</td>
    ...
    </div>`}function _r(t,e,a){j(t,"#ajustar-todas",()=>{const o=Fo(e).map(r=>r.sugerencia).filter(r=>r!==null);if(o.length===0)return;const n=o.map(r=>`• ${r.concepto}: ${P(r.cuantiaActual)} → ${P(r.cuantiaSugerida)}`).join(`
`);if(!ot(`Se van a ajustar ${o.length} estimaciones:

${n}

¿Continuar?`))return;const{aplicadas:s,errores:i}=e.adjuster.aplicarTodas(o,{hoy:e.hoy()});R(i.length>0?`${s.length} ajustadas, ${i.length} con error`:`${s.length} estimaciones ajustadas`,i.length>0?"warn":"ok"),e.onDatosCambiados(),a()})}const Pr=[";",",","	","|"],Fr={fecha:["fecha","f. valor","fecha valor","fecha operacion","date","f.operacion","f. operacion"],concepto:["concepto","descripcion","detalle","movimiento","referencia","description","observaciones"],importe:["importe","cantidad","amount","euros","import"],debe:["debe","cargo","salida","pago","debito"],haber:["haber","abono","entrada","ingreso","credito"]};function ve(t){return t.normalize("NFD").replace(/[̀-ͯ]/g,"").toLowerCase().trim()}function be(t,e){const a=[];let o="",n=!1;for(let s=0;s<t.length;s++){const i=t[s];n?i==='"'?t[s+1]==='"'?(o+='"',s++):n=!1:o+=i:i==='"'?n=!0:i===e?(a.push(o.trim()),o=""):o+=i}return a.push(o.trim()),a}function Dr(t){let e=";",a=-1;for(const o of Pr){const n=t.slice(0,20).map(c=>be(c,o).length),s=Math.max(...n);if(s<2)continue;const r=n.filter(c=>c===s).length*10+s;r>a&&(a=r,e=o)}return e}function se(t){let e=(t??"").trim();if(!e)return null;let a=!1;if(/^\(.*\)$/.test(e)&&(a=!0,e=e.slice(1,-1).trim()),e.endsWith("-")&&(a=!0,e=e.slice(0,-1).trim()),e.startsWith("-")&&(a=!0,e=e.slice(1).trim()),e.startsWith("+")&&(e=e.slice(1).trim()),e=e.replace(/[€$£\s  ]/g,""),!e)return null;const o=e.lastIndexOf(","),n=e.lastIndexOf(".");let s="";o>=0&&n>=0?s=o>n?",":".":o>=0?s=/,\d{3}$/.test(e)&&e.replace(/,/g,"").length>3?"":",":n>=0&&(s=/\.\d{3}$/.test(e)&&e.replace(/\./g,"").length>3?"":".");let i,r="0";if(s){const m=s===","?o:n;i=e.slice(0,m).replace(/[.,]/g,""),r=e.slice(m+1).replace(/[.,]/g,"")}else i=e.replace(/[.,]/g,"");if(!/^\d*$/.test(i)||!/^\d*$/.test(r)||i===""&&r==="")return null;const c=(r+"00").slice(0,2),l=Number(i||"0")*100+Number(c);return Number.isFinite(l)?a?-l:l:null}function ea(t){const e=(t??"").trim();if(!e)return null;let a=e.match(/^(\d{4})[-/](\d{1,2})[-/](\d{1,2})/);if(a)return Do(Number(a[1]),Number(a[2]),Number(a[3]));if(a=e.match(/^(\d{1,2})[-/.](\d{1,2})[-/.](\d{2,4})/),a){let o=Number(a[3]);return o<100&&(o+=o<70?2e3:1900),Do(o,Number(a[2]),Number(a[1]))}return null}function Do(t,e,a){if(e<1||e>12||a<1||a>31)return null;const o=new Date(t,e-1,a);return o.getFullYear()!==t||o.getMonth()!==e-1||o.getDate()!==a?null:`${t}-${String(e).padStart(2,"0")}-${String(a).padStart(2,"0")}`}function To(t){const e=t.filter(a=>a.trim());return e.length===0?0:e.filter(a=>ea(a)!==null).length/e.length}function zo(t){const e=t.filter(a=>a.trim());return e.length===0?0:e.filter(a=>se(a)!==null).length/e.length}function Tr(t,e){const a={fecha:-1,concepto:-1,importe:-1,debe:-1,haber:-1},o=new Set,n=s=>e.map(i=>i[s]??"");for(const s of["fecha","importe","debe","haber","concepto"])for(let i=0;i<t.length;i++){if(o.has(i))continue;const r=ve(t[i]);if(r&&Fr[s].some(c=>r===c||r.startsWith(c)||r.includes(c))){if(s==="importe"&&ve(t[i]).includes("saldo"))continue;a[s]=i,o.add(i);break}}if(a.fecha<0){let s=-1,i=.6;for(let r=0;r<t.length;r++){if(o.has(r))continue;const c=To(n(r));c>i&&(i=c,s=r)}s>=0&&(a.fecha=s,o.add(s))}if(a.importe<0&&a.debe<0&&a.haber<0){let s=-1,i=.6;for(let r=0;r<t.length;r++){if(o.has(r)||ve(t[r]).includes("saldo"))continue;const c=zo(n(r));c>i&&(i=c,s=r)}s>=0&&(a.importe=s,o.add(s))}if(a.concepto<0){let s=-1,i=0;for(let r=0;r<t.length;r++){if(o.has(r))continue;const c=n(r);if(zo(c)>.5||To(c)>.5)continue;const l=c.reduce((m,d)=>m+d.length,0)/Math.max(1,c.length);l>i&&(i=l,s=r)}s>=0&&(a.concepto=s)}return a}function zr(t){const e=t.replace(/^﻿/,"").split(/\r\n|\n|\r/).filter(m=>m.trim()!=="");if(e.length===0)return{separador:";",cabeceras:[],filas:[],lineaCabecera:0,mapeo:{fecha:-1,concepto:-1,importe:-1,debe:-1,haber:-1}};const a=Dr(e),o=e.map(m=>be(m,a).length),n=Math.max(...o);let s=o.findIndex(m=>m===n);s<0&&(s=0);const i=be(e[s],a);let r=e.slice(s+1).map(m=>be(m,a));const c=ea(i[0]??"")!==null||i.some(m=>se(m)!==null&&/\d/.test(m));c&&(r=[i,...r]);const l=Tr(c?i.map(()=>""):i,r.slice(0,40));return{separador:a,cabeceras:c?i.map((m,d)=>`Columna ${d+1}`):i,filas:r,lineaCabecera:s+1,mapeo:l}}function jo(t,e,a){return`${t}|${e}|${ve(a).replace(/\s+/g," ")}`}function jr(t,e,a=[]){const o=new Set(a.map(s=>jo(s.fecha,s.importeCts,s.concepto))),n=new Set;return t.filas.map((s,i)=>{const r=[],c=e.fecha>=0?ea(s[e.fecha]??""):null;e.fecha<0?r.push("sin columna de fecha"):c||r.push(`fecha ilegible: «${s[e.fecha]??""}»`);let l=null;if(e.importe>=0)l=se(s[e.importe]??""),l===null&&r.push(`importe ilegible: «${s[e.importe]??""}»`);else if(e.debe>=0||e.haber>=0){const u=e.debe>=0?se(s[e.debe]??""):null,v=e.haber>=0?se(s[e.haber]??""):null;u===null&&v===null?r.push("sin importe en Debe ni en Haber"):u!==null&&u!==0?l=-Math.abs(u):v!==null&&v!==0?l=Math.abs(v):l=0}else r.push("sin columna de importe");l===0&&r.push("importe cero");const m=(e.concepto>=0?s[e.concepto]??"":"").trim()||"Movimiento importado";let d=!1;if(c&&l!==null){const u=jo(c,l,m);d=o.has(u)||n.has(u),n.add(u)}return{linea:t.lineaCabecera+1+i,fecha:c,concepto:m,importeCts:l,errores:r,duplicada:d}})}function qr(t,e){const a=t.filter(n=>n.errores.length===0&&(e||!n.duplicada)),o=a.map(n=>n.fecha).filter(n=>!!n).sort();return{total:t.length,importables:a.length,conError:t.filter(n=>n.errores.length>0).length,duplicadas:t.filter(n=>n.duplicada).length,sumaCts:a.reduce((n,s)=>n+(s.importeCts??0),0),desde:o[0]??null,hasta:o[o.length-1]??null}}function he(){return{abierto:!1,nombreFichero:"",analisis:null,mapeo:null,filas:[],cuentaId:"",incluirDuplicadas:!1,error:""}}const Rr=[{clave:"fecha",etiqueta:"Fecha"},{clave:"concepto",etiqueta:"Concepto"},{clave:"importe",etiqueta:"Importe (con signo)"},{clave:"debe",etiqueta:"Debe (salidas)"},{clave:"haber",etiqueta:"Haber (entradas)"}];function aa(t,e){if(!e.analisis||!e.mapeo){e.filas=[];return}const a=t.ledger.transacciones(e.cuentaId?{cuentaId:e.cuentaId}:{}).map(o=>({fecha:o.fecha,importeCts:o.importeCts,concepto:o.concepto}));e.filas=jr(e.analisis,e.mapeo,a)}function Nr(t,e){const a=t.accounts().filter(n=>n.activo);if(!e.abierto)return`
      <div class="card">
        <div class="flex justify-between items-center" style="gap:10px;flex-wrap:wrap">
          <div>
    ...
    <div class="card">
      ...
      ${e.analisis&&e.mapeo?Or(e,e.analisis,e.mapeo):Lr()}
    </div>`}function Lr(){return`
    <div class="text-sm" style="color:var(--text3);line-height:1.7">
      ...
      antes de importar.
    </div>`}function Or(t,e,a){const o=qr(t.filas,t.incluirDuplicadas),n=r=>`<option value="-1"${r<0?" selected":""}>— ninguna —</option>`+e.cabeceras.map((c,l)=>`<option value="${l}"${l===r?" selected":""}>${p(c||`Columna ${l+1}`)}</option>`).join(""),s=t.filas.filter(r=>r.errores.length>0),i=t.filas.slice(0,12);return`
    <div class="divider"></div>
    ...
    ${t.cuentaId?"":'<div class="text-sm mt-8" style="color:var(--yellow);text-align:right">Elige antes la cuenta de destino.</div>'}`}function kr(t,e,a,o){j(t,"[data-imp-sincronizar]",()=>{const s=e.ledger.sincronizarHistoricoImportado();if(s.length===0)return R("Nada que sincronizar: no hay movimientos importados todavía");const i=m=>{var d;return((d=e.accounts().find(u=>u._id===m))==null?void 0:d.nombre)??m},r=s.reduce((m,d)=>m+d.eliminados,0),c=s.reduce((m,d)=>m+d.semanales,0),l=s.map(m=>`${i(m.cuentaId)} (${m.semanales})`).join(", ");R(`Histórico al día: ${c} punto${c!==1?"s":""} semanal${c!==1?"es":""} · ${l}`+(r>0?` · ${r} manual${r!==1?"es":""} sustituido${r!==1?"s":""}`:"")),e.onDatosCambiados(),o()}),j(t,"[data-imp-abrir]",()=>{const s=e.accounts().filter(i=>i.activo);Object.assign(a,he(),{abierto:!0,cuentaId:s.length===1?s[0]._id:""}),o()}),j(t,"[data-imp-cerrar]",()=>{Object.assign(a,he()),o()}),U(t,"#imp-cuenta",s=>{a.cuentaId=s.value,aa(e,a),o()}),U(t,"#imp-duplicadas",s=>{a.incluirDuplicadas=s.checked,o()}),U(t,"[data-imp-col]",s=>{const i=s,r=i.dataset.impCol;a.mapeo&&(a.mapeo[r]=Number(i.value),aa(e,a),o())});const n=t.querySelector("#imp-fichero");n==null||n.addEventListener("change",()=>{var i;const s=(i=n.files)==null?void 0:i[0];s&&Br(s).then(r=>{const c=zr(r);a.nombreFichero=s.name,a.error=c.filas.length===0?"El fichero no tiene ninguna línea de datos reconocible.":"",a.analisis=c,a.mapeo={...c.mapeo},aa(e,a),o()}).catch(r=>{a.error=`No se ha podido leer el fichero: ${r.message}`,o()})}),j(t,"[data-imp-confirmar]",()=>{if(!a.cuentaId)return;const s=a.filas.filter(l=>l.errores.length===0&&(a.incluirDuplicadas||!l.duplicada));if(s.length===0)return;for(const l of s)e.ledger.registrar({fecha:l.fecha,cuentaId:a.cuentaId,importe:Math.abs(J(l.importeCts)),tipo:l.importeCts<0?"gasto":"ingreso",concepto:l.concepto,origen:"importado"});const i=s.map(l=>l.fecha).sort(),r=e.ledger.eliminarPuntosControlEnRango(a.cuentaId,i[0],i[i.length-1]),c=e.ledger.generarPuntosSemanales(a.cuentaId);R(`${s.length} movimiento${s.length!==1?"s":""} importado${s.length!==1?"s":""} · histórico con ${c} punto${c!==1?"s":""} semanal${c!==1?"es":""}`+(r>0?` · ${r} punto${r!==1?"s":""} de control manual sustituido${r!==1?"s":""}`:"")),Object.assign(a,he()),e.onDatosCambiados(),o()})}function Br(t){return t.arrayBuffer().then(e=>{const a=new TextDecoder("utf-8").decode(e);if(!a.includes("�"))return a;try{return new TextDecoder("iso-8859-1").decode(e)}catch{return a}})}function Hr(t,e){if(e<t)return 0;let a=0,[o,n]=t.slice(0,7).split("-").map(Number);for(;`${o}-${String(n).padStart(2,"0")}`<=e.slice(0,7);){const s=new Date(o,n,0).getDate(),i=`${o}-${String(n).padStart(2,"0")}-01`,r=`${o}-${String(n).padStart(2,"0")}-${String(s).padStart(2,"0")}`,c=t>i?t:i,l=e<r?e:r,m=(O(l).getTime()-O(c).getTime())/864e5+1;a+=m/s,++n>12&&(n=1,o++)}return a}function Gr(t){const[e,a]=t.split("-").map(Number),o=new Date(e,a,0).getDate();return{desde:`${t}-01`,hasta:`${t}-${String(o).padStart(2,"0")}`}}function Vr(t){const[e,a]=t.slice(0,7).split("-").map(Number),o=new Date(e,a-2,1);return`${o.getFullYear()}-${String(o.getMonth()+1).padStart(2,"0")}`}function oa(t){return t.normalize("NFD").replace(/[̀-ͯ]/g,"").toLowerCase().replace(/\d+/g,"").replace(/\s+/g," ").trim()}function qo(t,e,a){const o=new Map(e.map(s=>[s._id,[]])),n=e.filter(s=>{var i;return!a(s._id)&&(((i=s.tags)==null?void 0:i.length)??0)>0});for(const s of t){if(s.estimacionId&&o.has(s.estimacionId)){o.get(s.estimacionId).push(s);continue}if(s.estimacionId)continue;let i=null,r=0;for(const c of n){const l=(c.tags??[]).filter(m=>s.tags.includes(m)).length;l!==0&&(l>r||l===r&&i&&c._id<i._id)&&(i=c,r=l)}i&&o.get(i._id).push(s)}return o}function Ro(t,e,a,o={}){const s=t.filter(c=>c.tipo!=="transferencia"&&c.activo!==!1).map(c=>({_id:c._id,concepto:c.concepto,tipo:c.tipo==="ingreso"?"ingreso":"gasto",tags:c.tags??[],estimado:G(Je(c,e,a)),origen:"estimacion",cuantia:c.cuantia})),i=(o.nominas??[]).filter(c=>c.activo!==!1);if(i.length>0){const c=Te(i,{start:e,end:a},null,[],o.resolverTramosIRPF);for(const l of i){const d=c.filter(u=>u.sourceId===l._id||u.sourceId.startsWith(`${l._id}_`)).reduce((u,v)=>u+(v.tipo==="ingreso"?Math.abs(v.cuantia):-Math.abs(v.cuantia)),0);s.push({_id:l._id,concepto:l.nombre,tipo:"ingreso",tags:l.tags??[],estimado:G(d),origen:"nomina"})}}const r=(o.loans??[]).filter(c=>c.activo!==!1);if(r.length>0){const c=De(r,{start:e,end:a});for(const l of r){const m=c.filter(d=>d.sourceId===l._id);m.length!==0&&s.push({_id:l._id,concepto:`Cuota ${l.nombre}`,tipo:"gasto",tags:l.tags??[],estimado:G(m.reduce((d,u)=>d+Math.abs(u.cuantia),0)),origen:"prestamo"})}}return s}function Ur(t,e,a,o={}){const{desde:n,hasta:s}=Gr(a);return{...No(t,e,n,s,o),mes:a}}function No(t,e,a,o,n={}){const s=t.transacciones({desde:a,hasta:o}),i=new Set(n.omitidos??[]),r=D=>D.tipo!=="transferencia"&&!i.has(oa(D.concepto)),c=s.filter(D=>r(D)&&D.importeCts<0),l=s.filter(D=>r(D)&&D.importeCts>0),m=s.filter(D=>D.tipo!=="transferencia"&&i.has(oa(D.concepto))),d=new Map((n.analisis??[]).map(D=>[D.estimacionId,D])),u=Ro(e,a,o,n),v=D=>new Set(D.filter(T=>t.transacciones({estimacionId:T._id}).length>0).map(T=>T._id)),g=u.filter(D=>D.tipo==="gasto"),b=u.filter(D=>D.tipo==="ingreso"),x=qo(c,g,D=>v(g).has(D)),f=qo(l,b,D=>v(b).has(D)),h=new Set,S=new Set,C=(D,T,N)=>{for(const k of T)N.add(k._id);const H=G(T.reduce((k,L)=>k+Math.abs(L.importeCts)/100,0)),q=D.origen==="estimacion"?d.get(D._id):void 0;return{estimacionId:D._id,concepto:D.concepto,tipo:D.tipo,origen:D.origen,tags:D.tags,estimado:D.estimado,real:H,desviacion:G(H-D.estimado),sinMovimiento:T.length===0,sugerencia:q?ta(q,D.cuantia??0,{hoy:n.hoy}):null}},w=g.map(D=>C(D,x.get(D._id)??[],h)),$=b.map(D=>C(D,f.get(D._id)??[],S)),M=(D,T)=>{const N=new Map;for(const H of D){if(T.has(H._id))continue;const q=oa(H.concepto),k=N.get(q)??{concepto:H.concepto,clave:q,total:0,movimientos:0,ids:[]};k.total=G(k.total+Math.abs(H.importeCts)/100),k.movimientos+=1,k.ids.push(H._id),N.set(q,k)}return[...N.values()].sort((H,q)=>q.total-H.total)},_=M(c,h),I=M(l,S),y=M(m,new Set),E=G(w.reduce((D,T)=>D+T.estimado,0)),A=G(c.reduce((D,T)=>D+Math.abs(T.importeCts)/100,0)),F=G($.reduce((D,T)=>D+T.estimado,0)),z=G(l.reduce((D,T)=>D+T.importeCts/100,0));return{mes:a.slice(0,7),desde:a,hasta:o,estimado:E,real:A,desviacion:G(A-E),ingresosEstimados:F,ingresosReales:z,desviacionIngresos:G(z-F),netoEstimado:G(F-E),netoReal:G(z-A),desviacionNeta:G(z-A-(F-E)),filas:[...w,...$].sort((D,T)=>Math.abs(T.desviacion)-Math.abs(D.desviacion)),sinEstimacion:_,totalSinEstimacion:G(_.reduce((D,T)=>D+T.total,0)),ingresosSinPrever:I,totalIngresosSinPrever:G(I.reduce((D,T)=>D+T.total,0)),porTag:Yr(g,c),meses:Hr(a,o),omitidos:y,totalOmitido:G(y.reduce((D,T)=>D+T.total,0)),vacio:s.length===0}}function Yr(t,e){const a=new Map,o=(n,s,i)=>{for(const r of n.length>0?n:["sin etiqueta"]){const c=a.get(r)??{estimado:0,real:0};c[s]+=i,a.set(r,c)}};for(const n of t)o(n.tags,"estimado",n.estimado);for(const n of e)o(n.tags,"real",Math.abs(n.importeCts)/100);return[...a.entries()].map(([n,s])=>({tag:n,estimado:G(s.estimado),real:G(s.real),desviacion:G(s.real-s.estimado)})).filter(n=>n.estimado>0||n.real>0).sort((n,s)=>s.real-n.real||s.estimado-n.estimado)}function Lo(t){const e=new Set;for(const a of t.transacciones())e.add(a.fecha.slice(0,7));return[...e].sort().reverse()}const ye=26,na=7,sa=(ye+na)*2,Oo=2*Math.PI*ye,ko=12;function Wr(t){if(t.estimado<=0)return t.real>0?{color:"var(--yellow)",fraccion:1,etiqueta:["sin","prever"]}:{color:"var(--text3)",fraccion:0,etiqueta:["—"]};const e=t.real/t.estimado*100;return{color:e>110?"var(--red)":e>100?"var(--yellow)":"var(--accent)",fraccion:Math.min(1,t.real/t.estimado),etiqueta:[`${Math.round(e)}%`]}}function Kr(t){const{color:e,fraccion:a,etiqueta:o}=Wr(t),n=sa/2,s=`${t.tag}: real ${P(t.real)} de ${P(t.estimado)} previsto (${t.desviacion>=0?"+":""}${P(t.desviacion)})`;return`
    <div style="text-align:center;min-width:96px">
      <svg viewBox="0 0 ${sa} ${sa}" style="width:78px;height:78px" role="img" aria-label="${p(s)}">
        <title>${p(s)}</title>
        <circle cx="${n}" cy="${n}" r="${ye}" fill="none" stroke="var(--bg3)" stroke-width="${na}"/>
        <circle cx="${n}" cy="${n}" r="${ye}" fill="none" stroke="${e}" stroke-width="${na}"
                stroke-linecap="round" stroke-dasharray="${(Oo*a).toFixed(2)} ${Oo.toFixed(2)}"
    ...
    </div>`}function Jr(t){if(t.length===0)return'<div class="text-sm" style="color:var(--text3)">Sin gasto etiquetado en este periodo.</div>';const e=t.slice(0,ko),a=t.slice(ko),o=a.reduce((n,s)=>n+s.real,0);return`
    ...
    </div>`}function Qr(){return{mes:"",modo:"mes"}}function Bo(t,e){if(e.mes)return e.mes;const a=Lo(t.ledger),o=Vr((t.hoy??K)());return a.includes(o)?o:a[0]??o}function $e(t,e){var i;const a=(t.hoy??K)(),o=t.estimaciones(),n={hoy:a,nominas:t.nominas(),loans:t.loans(),resolverTramosIRPF:(i=t.resolverTramosIRPF)==null?void 0:i.call(t),omitidos:t.omitidos()};if(e.modo==="periodo"){const{desde:r,hasta:c}=t.periodo(),l=t.precision.analizarTodas(o,{hoy:a,desde:r,hasta:c});return No(t.ledger,o,r,c,{...n,analisis:l})}const s=t.precision.analizarTodas(o,{hoy:a});return Ur(t.ledger,o,Bo(t,e),{...n,analisis:s})}function Ho(t){var n;const e=(t.hoy??K)(),a=Ro(t.estimaciones(),e,e,{nominas:t.nominas(),loans:t.loans(),resolverTramosIRPF:(n=t.resolverTramosIRPF)==null?void 0:n.call(t)}),o=s=>a.filter(i=>i.tipo===s).map(i=>`<option value="${p(i._id)}">${p(i.concepto)}</option>`).join("");return{gasto:o("gasto"),ingreso:o("ingreso")}}function ft(t,e){return e<=0?"—":`${p(P(t/e))}/mes`}function Go(t,e,a,o){const n=e?"background:var(--accent);color:#04120c;border-color:var(--accent)":"";return`<button class="btn-secondary btn-sm" data-cie-modo="${t}" title="${p(o)}" style="${n}">${p(a)}</button>`}function Xr(t,e){const a=e.modo==="periodo",o=Bo(t,e),n=Lo(t.ledger);n.includes(o)||n.unshift(o);const s=$e(t,e),i=a?"Cierre del periodo":"Cierre de mes",r=a?`del ${p(s.desde)} al ${p(s.hasta)}`:p(me(o)),c=`
    <div class="flex gap-6 items-center flex-wrap">
      ${Go("mes",!a,"Mes","Cierra un mes natural completo")}
      ${Go("periodo",a,"Periodo del header","Cierra el intervalo configurado arriba, aunque cruce varios meses o corte uno por la mitad")}
    ...
    <div class="card mb-14">
      ...
      ${Jr(s.porTag)}
    </div>`}function Zr(t){const e=t.filas.filter(o=>o.estimado>0||o.real>0);if(e.length===0)return'<div class="text-sm" style="color:var(--text3)">No tienes estimaciones de gasto activas en este periodo.</div>';const a=e.filter(o=>o.sugerencia);return`
    ...
    ${a.length>0?`<div class="flex justify-between items-center mb-12" style="gap:10px;flex-wrap:wrap">
           ...
           </div>`:""}`}function Vo(t,e,a,o){return`<tr>
  ...
  <th style="cursor:default"></th>
</tr></thead>`;function tc(t,e){return t.sinEstimacion.length===0?`<div class="alert-card alert-info">
    ...
    <div class="table-wrap">
      <table style="min-width:520px">
        ${Uo}
        <tbody>
          ${t.sinEstimacion.slice(0,10).map(a=>Vo(a,t.meses,e.gasto,"var(--yellow)")).join("")}
        </tbody>
      </table>
    </div>
    ${t.sinEstimacion.length>10?`<div class="text-sm mt-8" style="color:var(--text3)">…y ${t.sinEstimacion.length-10} concepto(s) más.</div>`:""}`}function ec(t){return t.omitidos.length===0?"":`
    ...
    </div>`}function ac(t,e){return t.ingresosSinPrever.length===0?"":`
    ...
    <div class="table-wrap">
      <table style="min-width:520px">
        ${Uo}
        <tbody>
          ${t.ingresosSinPrever.slice(0,10).map(a=>Vo(a,t.meses,e.ingreso,"var(--accent)")).join("")}
        </tbody>
      </table>
    </div>
    ${t.ingresosSinPrever.length>10?`<div class="text-sm mt-8" style="color:var(--text3)">…y ${t.ingresosSinPrever.length-10} concepto(s) más.</div>`:""}`}function oc(t,e,a,o){U(t,"#cie-mes",n=>{a.mes=n.value,o()}),j(t,"[data-cie-modo]",n=>{a.modo=n.getAttribute("data-cie-modo")||"mes",o()}),j(t,"[data-cie-omitir]",n=>{const s=n.getAttribute("data-cie-omitir"),i=e.omitidos();i.includes(s)||(e.setOmitidos([...i,s]),R("Concepto omitido: deja de contar en el cierre"),o())}),j(t,"[data-cie-restaurar]",n=>{const s=n.getAttribute("data-cie-restaurar");e.setOmitidos(e.omitidos().filter(i=>i!==s)),o()}),U(t,"[data-cie-asignar]",n=>{const s=n,i=s.getAttribute("data-cie-asignar"),r=s.value;if(!r)return;const c=$e(e,a),l=[...c.sinEstimacion,...c.ingresosSinPrever].find(m=>m.clave===i);if(l){if(!ot(`Se van a asignar ${l.movimientos} movimiento(s) de «${l.concepto}». ¿Continuar?`)){s.value="";return}for(const m of l.ids)e.ledger.asignarEstimacion(m,r);R(`${l.movimientos} movimiento(s) asignados`),e.onDatosCambiados(),o()}}),j(t,"[data-cie-ajustar]",n=>{const s=n.dataset.cieAjustar,r=$e(e,a).filas.find(c=>c.estimacionId===s);r!=null&&r.sugerencia&&(e.adjuster.aplicar(r.sugerencia.estimacionId,r.sugerencia.cuantiaSugerida,{hoy:(e.hoy??K)()}),R(`«${r.concepto}» ajustada a ${P(r.sugerencia.cuantiaSugerida)}`),e.onDatosCambiados(),o())}),j(t,"[data-cie-ajustar-todas]",()=>{const s=$e(e,a).filas.map(c=>c.sugerencia).filter(c=>c!==null);if(s.length===0)return;const{aplicadas:i,errores:r}=e.adjuster.aplicarTodas(s,{hoy:(e.hoy??K)()});R(`${i.length} estimación${i.length!==1?"es":""} ajustada${i.length!==1?"s":""}`+(r.length>0?` · ${r.length} con error`:"")),e.onDatosCambiados(),o()})}const nc="M11.8 10.9c-2.27-.59-3-1.2-3-2.15 0-1.09 1.01-1.85 2.7-1.85 1.78 0 2.44.85 2.5 2.1h2.21c-.07-1.72-1.12-3.3-3.21-3.81V3h-3v2.16c-1.94.42-3.5 1.68-3.5 3.61 0 2.31 1.91 3.46 4.7 4.13 2.5.6 3 1.48 3 2.41 0 .69-.49 1.79-2.7 1.79-2.06 0-2.87-.92-2.98-2.1h-2.2c.12 2.19 1.76 3.42 3.68 3.83V21h3v-2.15c1.95-.37 3.5-1.5 3.5-3.55 0-2.84-2.43-3.81-4.7-4.4z";function sc(t){const e=t.hoy??K,a=()=>{var T;return(T=t.onDatosCambiados)==null?void 0:T.call(t)},o=new Map;let n="cuentas";const s=$r(e().slice(0,7)),i=he(),r=Qr(),c=()=>t.store.get("expenses"),l=()=>t.store.get("accounts"),m={ledger:t.ledger,accounts:l,estimaciones:c,loans:()=>t.store.get("loans"),nominas:()=>t.store.get("nominas"),tagsConocidas:()=>t.tags.todas(),onDatosCambiados:a,hoy:e},d={ledger:t.ledger,accounts:l,onDatosCambiados:a},u=()=>t.store.get("config"),v=()=>({desde:u().dashboardStart,hasta:u().dashboardEnd}),g={ledger:t.ledger,precision:t.precision,adjuster:t.adjuster,estimaciones:c,nominas:()=>t.store.get("nominas"),loans:()=>t.store.get("loans"),resolverTramosIRPF:()=>Ft(t.store.get("tramosIRPFHistorico"),u().tramos_irpf??bt),omitidos:()=>u().cierreOmitidos??[],setOmitidos:T=>t.store.patchConfig({cierreOmitidos:T}),onDatosCambiados:a,periodo:v,hoy:e},b={precision:t.precision,adjuster:t.adjuster,estimaciones:c,onDatosCambiados:a,rango:()=>r.modo==="periodo"?v():null,hoy:e},x=T=>{var N;return((N=t.store.get("accounts").find(H=>H._id===T))==null?void 0:N.nombre)??T},f=()=>Ft(t.store.get("tramosIRPFHistorico"),u().tramos_irpf??bt)(Number(e().slice(0,4))),h=()=>Ft(t.store.get("tramosGananciasCapitalHistorico"),u().tramosGananciasCapital??Ut),S=()=>h()(Number(e().slice(0,4)));function C(){const T=u(),N=t.store.get("accounts"),H=Ta({loans:[],expenses:t.store.get("expenses").filter(B=>B.tipo==="transferencia"),accounts:N,config:{dashboardStart:T.dashboardStart,dashboardEnd:T.dashboardEnd,fechaReferencia:T.dashboardStart},nominas:[],resolverTramosGanancias:h()}),q=new Map,k=B=>{let V=q.get(B);return V||(V={entradas:[],salidas:[],totalAportaciones:0,totalReembolsos:0,retencion:0},q.set(B,V)),V},L=(B,V)=>{const Z=`${V.sourceId}`,et=B.find(da=>da.concepto===Z),nt=et??{concepto:Z,contraparte:"",total:0,ocurrencias:0};nt.total+=Math.abs(V.cuantia),nt.ocurrencias+=1,et||B.push(nt)};for(const B of H){if(!B.cuenta)continue;const V=k(B.cuenta);B.sourceType==="transfer-in"||B.sourceType==="traspaso-in"?(V.totalAportaciones+=Math.abs(B.cuantia),L(V.entradas,B)):B.sourceType==="transfer-out"||B.sourceType==="traspaso-out"?(V.totalReembolsos+=Math.abs(B.cuantia),L(V.salidas,B)):B.sourceType==="investment-tax"&&(V.retencion+=Math.abs(B.cuantia))}const Y=t.store.get("expenses");for(const B of q.values())for(const[V,Z]of[[B.entradas,"cuenta"],[B.salidas,"cuentaDestino"]])for(const et of V){const nt=Y.find(da=>da._id===et.concepto);et.contraparte=x((nt==null?void 0:nt[Z])??"default"),et.concepto=(nt==null?void 0:nt.concepto)||(Z==="cuenta"?"Aportación":"Reembolso")}return q}function w(T){const N=n==="cuentas"?`<div class="page-actions">
        ...
        </div>`:"";let H;if(n==="cuentas"){const L=t.store.get("accounts").filter(V=>rt(V)!=="pension"),Y=C(),B={config:u(),inflacion:t.store.get("inflacion"),nominas:t.store.get("nominas"),tramosIRPF:f(),tramosGanancias:S(),flujos:V=>Y.get(V)??Wi,invModo:V=>o.get(V)??"proyeccion"};H=`${Ki(L,B.tramosGanancias)}<div class="grid-3">${L.map(V=>tr(V,B)).join("")}</div>`}else n==="movimientos"?H='<div id="acc-tx"></div>':n==="importar"?H='<div id="acc-import"></div>':H='<div id="acc-cierre"></div><div id="acc-precision" data-feature="precision-estimaciones"></div>';T.innerHTML=`
      <div class="page-header">
        <h1 class="page-title">Cuentas y <span>Contabilidad</span></h1>
        ${N}
      </div>
      ${lr(n)}
      ${H}`;const q=()=>w(T);if(n==="movimientos"){const k=T.querySelector("#acc-tx");k.innerHTML=Cr(m,s),Sr(k,m,s,q)}else if(n==="importar"){const k=T.querySelector("#acc-import");k.innerHTML=Nr(d,i),kr(k,d,i,q)}else if(n==="cierre"){const k=T.querySelector("#acc-cierre"),L=T.querySelector("#acc-precision");k.innerHTML=Xr(g,r),L.innerHTML=Er(b),oc(k,g,r,q),_r(L,b,q)}}const $=()=>document.getElementById("modal-overlay"),M=()=>document.getElementById("modal-content"),_=()=>{var T;return(T=$())==null?void 0:T.classList.add("hidden")};function I(T,N){const H=$(),q=M();return!H||!q?null:(q.innerHTML=T?`<div class="modal-title">${p(T)}</div>${N}`:N,H.classList.remove("hidden"),j(q,"[data-cancelar]",_),q)}function y(T,N){const H=T?t.store.get("accounts").find(Y=>Y._id===T)??null:null,q=[...(H==null?void 0:H.planAportaciones)??[]].map(Y=>({...Y})),k=H?E(H):null,L=I(T?"Editar cuenta / fondo":"Nueva cuenta / fondo",or(H,{nominas:t.store.get("nominas"),hoy:e(),saldoActual:k??0}));L&&(nr(L,q,e()),j(L,"[data-guardar-acc]",Y=>{const B=Y.getAttribute("data-guardar-acc")||"",{datos:V,punto:Z,error:et}=sr(L,q,H,k,e());if(et)return R(et,"err");let nt=B;B?t.store.updateItem("accounts",B,V):nt=t.store.addItem("accounts",V)._id,Z&&t.ledger.registrarPuntoControl(nt,Z.fecha,Z.saldo,Z.nota),R(B?"Actualizada":"Cuenta / fondo creado"),a(),_(),N()}))}function E(T){const N=t.ledger.puntosControl(T._id);return N.length>0?Ke(N)[0].saldo:T.saldo??null}function A(T,N){const H=t.store.get("accounts").find(L=>L._id===T);if(!H)return;const q=I("Histórico de saldos",ir(H.nombre,T,Ke(t.ledger.puntosControl(T)),H.saldoInicial||0,e()));if(!q)return;const k=()=>{N(),A(T,N)};j(q,"[data-hist-anadir]",()=>{var V,Z,et;const L=((V=q.querySelector("#hi-fecha"))==null?void 0:V.value)??"",Y=parseFloat(((Z=q.querySelector("#hi-saldo"))==null?void 0:Z.value)??""),B=((et=q.querySelector("#hi-nota"))==null?void 0:et.value.trim())??"";if(!L||!Number.isFinite(Y))return R("Fecha y saldo requeridos","err");t.ledger.registrarPuntoControl(T,L,Y,B||void 0),R("Punto añadido"),a(),k()}),j(q,"[data-hist-borrar]",L=>{const[,Y]=(L.getAttribute("data-hist-borrar")||"").split("|");t.ledger.eliminarPuntoControl(Y),R("Eliminado"),a(),k()}),j(q,"[data-hist-semanal]",L=>{const Y=L.getAttribute("data-hist-semanal"),B=t.ledger.generarPuntosSemanales(Y);R(B>0?`Histórico con ${B} punto${B!==1?"s":""} semanal${B!==1?"es":""}`:"Sin movimientos con los que calcular el histórico"),a(),k()}),j(q,"[data-hist-inicial]",L=>{const[Y,B]=(L.getAttribute("data-hist-inicial")||"").split("|"),V=t.ledger.puntosControl(Y).find(et=>et._id===B);if(!V)return;const Z=Ke([V])[0].saldo;t.store.updateItem("accounts",Y,{saldoInicial:Z,fechaInicialSaldo:V.fecha}),R(`Punto inicial → ${V.fecha} (${P(Z)})`),a(),k()})}function F(T){const N=t.store.get("accounts").filter(k=>k.activo);if(N.length===0)return R("No hay cuentas activas","err");const H=e(),q=N.map(k=>`• ${k.nombre}: ${P(E(k)??k.saldoInicial??0)}`).join(`
`);if(ot(`¿Actualizar el saldo inicial de estas cuentas a su saldo actual (${H})?

${q}

Esto recalibra el punto de arranque del dashboard.`)){for(const k of N)t.store.updateItem("accounts",k._id,{saldoInicial:E(k)??k.saldoInicial??0,fechaInicialSaldo:H});R("Saldo base actualizado"),a(),T()}}function z(T,N,H){j(T,"[data-cuentas-tab]",q=>{n=q.getAttribute("data-cuentas-tab")||"cuentas",N()}),j(T,"[data-nueva-acc]",()=>y(null,N)),j(T,"[data-editar-acc]",q=>y(q.getAttribute("data-editar-acc"),N)),j(T,"[data-tramos-ganancias]",()=>H.abrir()),j(T,"[data-reset-base]",()=>F(N)),j(T,"[data-hist-acc]",q=>A(q.getAttribute("data-hist-acc"),N)),j(T,"[data-principal-acc]",q=>{const k=q.getAttribute("data-principal-acc");t.store.set("accounts",t.store.get("accounts").map(L=>({...L,esCuentaPrincipal:L._id===k}))),R("Cuenta marcada como principal"),a(),N()}),j(T,"[data-borrar-acc]",q=>{const k=q.getAttribute("data-borrar-acc");if(t.store.get("accounts").length<=1)return R("Debe existir al menos una cuenta","err");if(!ot("¿Eliminar cuenta?"))return;t.store.removeItem("accounts",k);const Y=t.store.get("accounts");Y.length>0&&!Y.some(B=>B.esCuentaPrincipal)&&t.store.set("accounts",Y.map((B,V)=>V===0?{...B,esCuentaPrincipal:!0}:B)),R("Cuenta eliminada"),a(),N()}),j(T,"[data-inv-modo]",q=>{const[k,L]=(q.getAttribute("data-inv-modo")||"").split("|");o.set(k,L==="real"?"real":"proyeccion"),N()})}let D=null;return{id:"accounts",route:"accounts",nombre:"Cuentas y contabilidad",flagId:"accounts",seccion:1,iconoPath:nc,mount(T){const N=()=>w(T);D??(D=rr({store:t.store,onDatosCambiados:()=>{a(),N()},año:()=>Number(e().slice(0,4))})),w(T),T.dataset.wired!=="1"&&(z(T,N,D),T.dataset.wired="1")}}}function Yo(t,e,a=!1){const o=Math.abs(it(e));return t==="ingreso"?o:t==="gasto"||a?-o:o}function ic(t){function e(I){return`${I}_${Date.now().toString(36)}${Math.random().toString(36).slice(2,7)}`}function a(I={}){var E;const y=(E=I.texto)==null?void 0:E.trim().toLowerCase();return t.get("transacciones").filter(A=>!(I.cuentaId&&A.cuentaId!==I.cuentaId||I.desde&&A.fecha<I.desde||I.hasta&&A.fecha>I.hasta||I.tipo&&A.tipo!==I.tipo||I.estimacionId&&A.estimacionId!==I.estimacionId||I.tags&&I.tags.length>0&&!I.tags.some(F=>A.tags.includes(F))||y&&!A.concepto.toLowerCase().includes(y))).sort((A,F)=>A.fecha.localeCompare(F.fecha)||A._id.localeCompare(F._id))}function o(I){const y={_id:e("tx"),fecha:I.fecha,cuentaId:I.cuentaId,importeCts:Yo(I.tipo,I.importe,I.negativo),concepto:I.concepto,tags:I.tags??[],estimacionId:I.estimacionId??null,tipo:I.tipo,origen:I.origen??"manual",...I.nota?{nota:I.nota}:{}};return t.set("transacciones",[...t.get("transacciones"),y]),y}function n(I,y){t.set("transacciones",t.get("transacciones").map(E=>{if(E._id!==I)return E;const{importe:A,...F}=y,z={...E,...F};return A!==void 0&&(z.importeCts=Yo(z.tipo,A,z.importeCts<0)),z}))}function s(I){t.set("transacciones",t.get("transacciones").filter(y=>y._id!==I))}function i(I,y){n(I,{estimacionId:y})}function r(I){return t.get("puntosControl").filter(y=>!I||y.cuentaId===I).sort((y,E)=>y.fecha.localeCompare(E.fecha))}function c(I){return r(I).filter(y=>y.origen!=="derivado")}function l(I,y,E,A){const F={_id:e("pc"),fecha:y,cuentaId:I,saldoCts:it(E),...A?{nota:A}:{}},z=t.get("puntosControl").filter(D=>!(D.cuentaId===I&&D.fecha===y));return t.set("puntosControl",[...z,F].sort((D,T)=>D.fecha.localeCompare(T.fecha))),u(I),F}function m(I){const y=t.get("puntosControl").find(E=>E._id===I);t.set("puntosControl",t.get("puntosControl").filter(E=>E._id!==I)),y&&(y.origen==="derivado"?x(y.cuentaId):u(y.cuentaId))}function d(I,y,E){const A=z=>z.cuentaId===I&&z.origen!=="derivado"&&z.fecha>=y&&z.fecha<=E,F=t.get("puntosControl").filter(A).length;return F===0?0:(t.set("puntosControl",t.get("puntosControl").filter(z=>!A(z))),x(I),F)}function u(I){var q,k;const y=c(I),E=t.get("transacciones").filter(L=>L.cuentaId===I).sort((L,Y)=>L.fecha.localeCompare(Y.fecha)),A=(q=E[0])==null?void 0:q.fecha,F=(k=E[E.length-1])==null?void 0:k.fecha,z=t.get("puntosControl").filter(L=>!(L.cuentaId===I&&L.origen==="derivado"));if(!A)return t.set("puntosControl",z),x(I),0;const D=[];for(let L=Gt(A);L<=F;L=Gt(ma(L,1)))D.push(L);D[D.length-1]!==F&&D.push(F);const T=new Set(y.map(L=>Gt(L.fecha))),N=L=>{const Y=y.filter(B=>B.fecha<=L).pop();return E.filter(B=>B.fecha<=L&&(!Y||B.fecha>Y.fecha)).reduce((B,V)=>B+V.importeCts,(Y==null?void 0:Y.saldoCts)??0)},H=D.filter(L=>!T.has(Gt(L))).map(L=>({_id:e("pcd"),fecha:L,cuentaId:I,saldoCts:N(L),origen:"derivado"}));return t.set("puntosControl",[...z,...H].sort((L,Y)=>L.fecha.localeCompare(Y.fecha))),v(I,A,N(A)),x(I),H.length}function v(I,y,E){const A=t.get("accounts"),F=A.find(z=>z._id===I);!F||F.fechaInicialSaldo&&F.fechaInicialSaldo<=y||t.set("accounts",A.map(z=>z._id===I?{...z,saldoInicial:J(E),fechaInicialSaldo:y}:z))}function g(I){return(I??[...new Set(t.get("transacciones").map(E=>E.cuentaId))]).reduce((E,A)=>E+u(A),0)}function b(I){const y=t.get("transacciones").filter(F=>F.origen==="importado"&&(!I||F.cuentaId===I)),E=new Map;for(const F of y){const z=E.get(F.cuentaId);z?z.push(F.fecha):E.set(F.cuentaId,[F.fecha])}const A=[];for(const[F,z]of E){z.sort();const D=d(F,z[0],z[z.length-1]);A.push({cuentaId:F,eliminados:D,semanales:u(F)})}return A}function x(I){const y=r(I),E=t.get("accounts");E.some(A=>A._id===I)&&t.set("accounts",E.map(A=>A._id===I?{...A,historicoSaldos:y.map(F=>({_id:F._id,fecha:F.fecha,saldo:J(F.saldoCts),...F.nota?{nota:F.nota}:{}}))}:A))}function f(I,y=K()){const E=c(I).filter(D=>D.fecha<=y).pop(),A=E==null?void 0:E.fecha,F=(E==null?void 0:E.saldoCts)??0;return t.get("transacciones").filter(D=>D.cuentaId===I&&D.fecha<=y&&(A===void 0||D.fecha>A)).reduce((D,T)=>D+T.importeCts,F)}function h(I,y){return J(f(I,y))}function S(I=K(),y){const E=y??t.get("accounts").filter(A=>A.activo).map(A=>A._id);return J(E.reduce((A,F)=>A+f(F,I),0))}function C(){return t.get("transacciones").length>0||t.get("puntosControl").length>0}function w(){const I=[...t.get("transacciones").map(y=>y.fecha),...t.get("puntosControl").map(y=>y.fecha)];return I.length>0?I.sort().pop()??null:null}function $(I={}){return J(a(I).reduce((y,E)=>y+E.importeCts,0))}function M(I={}){const y=new Map;for(const E of a(I)){const A=E.fecha.slice(0,7);y.set(A,(y.get(A)??0)+E.importeCts)}return new Map([...y.entries()].sort(([E],[A])=>E.localeCompare(A)).map(([E,A])=>[E,J(A)]))}function _(I={}){const y=new Map;for(const E of a(I))for(const A of E.tags.length>0?E.tags:["sin_tag"])y.set(A,(y.get(A)??0)+E.importeCts);return new Map([...y.entries()].map(([E,A])=>[E,J(A)]))}return{transacciones:a,registrar:o,actualizar:n,eliminar:s,asignarEstimacion:i,puntosControl:r,registrarPuntoControl:l,eliminarPuntoControl:m,eliminarPuntosControlEnRango:d,sincronizarHistoricoImportado:b,generarPuntosSemanales:u,generarPuntosSemanalesTodas:g,saldoCuenta:h,saldoCuentaCts:f,saldoTotal:S,tieneDatos:C,ultimaFecha:w,total:$,totalPorMes:M,totalPorTag:_}}function pt(t){return t.trim().toLowerCase()}function rc(t){function e(){const l=new Map,m=(d,u)=>{const v=pt(d);if(!v)return;const g=l.get(v)??{tag:v,estimaciones:0,reales:0,total:0};g[u]+=1,g.total+=1,l.set(v,g)};for(const d of t.get("expenses"))for(const u of d.tags??[])m(u,"estimaciones");for(const d of t.get("transacciones"))for(const u of d.tags??[])m(u,"reales");return[...l.values()].sort((d,u)=>u.total-d.total||d.tag.localeCompare(u.tag))}function a(){return e().map(l=>l.tag)}function o(l){return e().filter(m=>l==="estimaciones"?m.reales===0:m.estimaciones===0).map(m=>m.tag)}function n(l,m,d){const u=pt(m),v=(l??[]).map(pt);if(!v.includes(u))return l??[];const g=v.filter(b=>b!==u);return d===null?[...new Set(g)]:[...new Set([...g,pt(d)])]}function s(l,m){const d=pt(m);if(!d)throw new Error("El nuevo nombre de la etiqueta no puede estar vacío");return c(l,d)}function i(l,m){let d=0;for(const u of l)pt(u)!==pt(m)&&(d+=c(u,pt(m)).cambiados);return{cambiados:d}}function r(l){return c(l,null)}function c(l,m){let d=0;const u=t.get("expenses").map(M=>{const _=n(M.tags,l,m);return _!==M.tags&&(d+=1),_===M.tags?M:{...M,tags:_}});t.set("expenses",u);const v=t.get("transacciones").map(M=>{const _=n(M.tags,l,m);return _!==M.tags&&(d+=1),_===M.tags?M:{...M,tags:_}});t.set("transacciones",v);const g=t.get("loans").map(M=>{const _=n(M.tags,l,m);return _!==M.tags&&(d+=1),_===M.tags?M:{...M,tags:_}});t.set("loans",g);const b=t.get("nominas").map(M=>{const _=n(M.tags,l,m);return _!==M.tags&&(d+=1),_===M.tags?M:{...M,tags:_}});t.set("nominas",b);const x=t.get("config"),f=pt(l),h=M=>{const _=(M??[]).map(pt);if(!_.includes(f))return M??[];const I=_.filter(y=>y!==f);return m===null?[...new Set(I)]:[...new Set([...I,m])]},S={},C=h(x.activeTagsFilter),w=h(x.tagCategorias),$=h(x.tagGrupos);return C!==x.activeTagsFilter&&(S.activeTagsFilter=C),w!==x.tagCategorias&&(S.tagCategorias=w),$!==x.tagGrupos&&(S.tagGrupos=$),Object.keys(S).length>0&&t.patchConfig(S),{cambiados:d}}return{uso:e,todas:a,soloEn:o,renombrar:s,fusionar:i,eliminar:r}}const cc=3;function Wo(t){return t<.005?0:t}function lc(t){if(t.length<2)return null;const e=t.reduce((o,n)=>o+n,0)/t.length,a=t.reduce((o,n)=>o+(n-e)**2,0)/(t.length-1);return Math.sqrt(a)}function dc(t){const e=[],a=[],o=[];for(const i of t){if(i.meses.length<cc)continue;const r=lc(i.meses.map(c=>c.desviacion));r!==null&&(e.push(r),a.push(r/Math.sqrt(i.meses.length)),o.push(i.meses.length))}if(e.length===0)return{sigmaMensual:0,sigmaDeriva:0,estimaciones:0,mesesMinimos:0,mesesMaximos:0,fiable:!1};const n=Math.sqrt(e.reduce((i,r)=>i+r*r,0)),s=Math.sqrt(a.reduce((i,r)=>i+r*r,0));return{sigmaMensual:Wo(n),sigmaDeriva:Wo(s),estimaciones:e.length,mesesMinimos:Math.min(...o),mesesMaximos:Math.max(...o),fiable:!0}}function Ko(t,e,a=1,o=0){if(e<=0)return 0;const n=Math.max(0,t)*Math.sqrt(e),s=Math.max(0,o)*e;return n===0&&s===0?0:G(a*Math.hypot(n,s))}function uc(t,e,a={}){if(!e.fiable||t.length===0)return[];const{z:o=1}=a,n=a.desde??t[0].fecha,[s,i]=n.slice(0,7).split("-").map(Number);return t.map(r=>{const[c,l]=r.fecha.slice(0,7).split("-").map(Number),m=Math.max(0,(c-s)*12+(l-i)),d=Ko(e.sigmaMensual,m,o,e.sigmaDeriva);return{fecha:r.fecha,saldo:r.saldoAcum,arriba:G(r.saldoAcum+d),abajo:G(r.saldoAcum-d)}})}function pc(t,e=1){if(!t.fiable)return"Necesita al menos 3 meses de contabilidad real para medir cuánto se desvían tus estimaciones.";if(t.sigmaMensual===0)return"Sin margen de error: tus estimaciones se desvían siempre lo mismo, así que no hay incertidumbre que dibujar. Si se desvían de forma sistemática, ajústalas desde el cierre de mes.";const a=e>=2?"95 %":"68 %",o=t.mesesMinimos===t.mesesMaximos?`${t.mesesMinimos}`:`${t.mesesMinimos}–${t.mesesMaximos}`;return`Banda de ±${e} desviación${e!==1?"es":""} típica${e!==1?"s":""} (${a} de los casos), medida sobre ${t.estimaciones} estimación${t.estimaciones!==1?"es":""} con ${o} mes${t.mesesMaximos!==1?"es":""} de datos reales. Se ensancha con el tiempo, y tanto más deprisa cuanto menos historial haya: tu gasto medio también es una estimación.`}const ia="financeapp_session",mc=["local","dropbox","firebase"];function fc(t){if(!t)return null;try{const e=JSON.parse(t);if(!e||!mc.includes(e.modo))return null;const a=Number(e.creadaEn),o=Number(e.ultimoUso);return!Number.isFinite(a)||!Number.isFinite(o)?null:{modo:e.modo,...typeof e.email=="string"?{email:e.email}:{},...typeof e.passphrase=="string"?{passphrase:e.passphrase}:{},creadaEn:a,ultimoUso:o}}catch{return null}}function gc({storage:t,autoLogoutMinutos:e=()=>0,ahora:a=()=>Date.now(),graciaActiva:o=()=>!1}={}){const n=()=>t??(typeof localStorage<"u"?localStorage:null);function s(v){const g=n();if(g)try{v?g.setItem(ia,JSON.stringify(v)):g.removeItem(ia)}catch{}}function i(){const v=n();if(!v)return null;try{return fc(v.getItem(ia))}catch{return null}}function r(){const v=i();return v?(a()-v.ultimoUso)/6e4:null}function c(){const v=e();if(!Number.isFinite(v)||v<=0||o())return!1;const g=r();return g!==null&&g>=v}function l(){const v=i();return v?c()?(s(null),null):v:null}function m(v){const g=a(),b={modo:v.modo,...v.email?{email:v.email}:{},...v.passphrase?{passphrase:v.passphrase}:{},creadaEn:g,ultimoUso:g};return s(b),b}function d(){const v=i();v&&s({...v,ultimoUso:a()})}function u(){s(null)}return{abrir:m,leer:l,tocar:d,cerrar:u,caducada:c,inactividadMinutos:r,get activa(){return l()!==null}}}const Jo=["pointerdown","keydown","visibilitychange"];function vc({sesion:t,onCaducada:e,intervaloMs:a=3e4,setIntervalImpl:o=setInterval,clearIntervalImpl:n=clearInterval,target:s=typeof document<"u"?document:void 0}){let i=!0;const r=()=>{i&&t.tocar()};for(const m of Jo)s==null||s.addEventListener(m,r);const c=o(()=>{i&&t.caducada()&&(l(),t.cerrar(),e())},a);function l(){if(i){i=!1,n(c);for(const m of Jo)s==null||s.removeEventListener(m,r)}}return l}const bc=[{minutos:0,etiqueta:"Nunca (solo manualmente)"},{minutos:15,etiqueta:"Tras 15 minutos de inactividad"},{minutos:60,etiqueta:"Tras 1 hora de inactividad"},{minutos:480,etiqueta:"Tras 8 horas de inactividad"},{minutos:10080,etiqueta:"Tras 7 días de inactividad"}],hc="FinanceApp",yc=new TextEncoder().encode("financeapp-bio-passphrase-v1");function Qo(t){return new Uint8Array(new ArrayBuffer(t))}const ra="financeapp_bio_credencial",ca="financeapp_bio_secreto",la="financeapp_bio_ultimo_desbloqueo",Xo="financeapp_bio_gracia_min",$c=5;function xc(){return{create:t=>navigator.credentials.create(t),get:t=>navigator.credentials.get(t),async disponiblePlataforma(){if(typeof window>"u"||!window.PublicKeyCredential)return!1;try{return await PublicKeyCredential.isUserVerifyingPlatformAuthenticatorAvailable()}catch{return!1}}}}function xe(t){const e=t instanceof Uint8Array?t:new Uint8Array(t);let a="";for(const o of e)a+=String.fromCharCode(o);return btoa(a)}function we(t){const e=atob(t),a=Qo(e.length);for(let o=0;o<e.length;o++)a[o]=e.charCodeAt(o);return a}function wc(t){return xe(t).replace(/\+/g,"-").replace(/\//g,"_").replace(/=+$/,"")}function Ic(t){const e=t.replace(/-/g,"+").replace(/_/g,"/")+"=".repeat((4-t.length%4)%4);return we(e)}function Zo(t){return t.getClientExtensionResults()}function Cc(t={}){const e=t.webauthn??xc(),a=t.subtle??(typeof crypto<"u"?crypto.subtle:void 0),o=t.storage??(typeof localStorage<"u"?localStorage:void 0),n=t.ahora??(()=>Date.now()),s=t.randomBytes??(w=>crypto.getRandomValues(Qo(w)));function i(){if(!o)throw new Error("No hay almacenamiento local disponible.");return o}function r(){return e.disponiblePlataforma()}function c(){const w=o==null?void 0:o.getItem(ra);if(!w)return null;try{const $=JSON.parse(w);return typeof $.credencialId!="string"||typeof $.salt!="string"?null:$}catch{return null}}function l(){return c()!==null}async function m(w){const $=await a.importKey("raw",w,"HKDF",!1,["deriveKey"]);return a.deriveKey({name:"HKDF",hash:"SHA-256",salt:new Uint8Array(0),info:yc},$,{name:"AES-GCM",length:256},!1,["encrypt","decrypt"])}async function d(w,$){const M=s(12),_=await a.encrypt({name:"AES-GCM",iv:M},w,new TextEncoder().encode($));return`${xe(M)}:${xe(_)}`}async function u(w,$){const[M,_]=$.split(":"),I=we(M),y=we(_),E=await a.decrypt({name:"AES-GCM",iv:I},w,y);return new TextDecoder().decode(E)}async function v(w,$){var N,H;if(!w)throw new Error("No hay clave de cifrado que envolver.");const M=s(32),_=s(32),I=s(16),y=await e.create({publicKey:{challenge:_,rp:{name:hc},user:{id:I,name:"financeapp-local",displayName:"FinanceApp en este dispositivo"},pubKeyCredParams:[{type:"public-key",alg:-7},{type:"public-key",alg:-257}],authenticatorSelection:{authenticatorAttachment:"platform",userVerification:"required",residentKey:"required"},extensions:{prf:{eval:{first:M}}},timeout:6e4}});if(!y)throw new Error("No se ha podido crear la credencial biométrica.");const E=Zo(y);if(!((N=E.prf)!=null&&N.enabled))throw new Error("Este dispositivo o navegador no admite desbloqueo con huella (falta soporte de la extensión PRF).");let A=((H=E.prf.results)==null?void 0:H.first)??null;if(A||(A=await g(y.rawId,M)),!A)throw new Error("El sensor no ha devuelto material de cifrado.");const F=await m(A),z=await d(F,w),D={credencialId:wc(y.rawId),salt:xe(M),modo:$,creadaEn:n()},T=i();T.setItem(ra,JSON.stringify(D)),T.setItem(ca,z)}async function g(w,$){var _,I;const M=await e.get({publicKey:{challenge:s(32),allowCredentials:[{id:w,type:"public-key"}],userVerification:"required",extensions:{prf:{eval:{first:$}}},timeout:6e4}});return M?((I=(_=Zo(M).prf)==null?void 0:_.results)==null?void 0:I.first)??null:null}async function b(){const w=c();if(!w)throw new Error("No hay huella configurada en este dispositivo.");const $=o==null?void 0:o.getItem(ca);if(!$)throw new Error("No hay clave guardada. Vuelve a activar el desbloqueo con huella.");const M=await g(Ic(w.credencialId).buffer,we(w.salt));if(!M)throw new Error("No se ha podido leer la huella. Inténtalo de nuevo o usa la clave.");const _=await m(M),I=await u(_,$);return f(),I}function x(){o==null||o.removeItem(ra),o==null||o.removeItem(ca),o==null||o.removeItem(la)}function f(){o==null||o.setItem(la,String(n()))}function h(){const w=o==null?void 0:o.getItem(Xo);if(w==null)return $c;const $=Number(w);return Number.isFinite($)&&$>0?$:0}function S(w){o==null||o.setItem(Xo,String(Math.max(0,Math.floor(w)||0)))}function C(){if(!l())return!1;const w=h();if(w<=0)return!1;const $=o==null?void 0:o.getItem(la),M=$?Number($):NaN;return Number.isFinite(M)?n()-M<w*6e4:!1}return{disponible:r,registrada:l,leerCredencial:c,registrar:v,desbloquear:b,olvidar:x,marcarDesbloqueo:f,dentroDeGracia:C,graciaMinutos:h,configurarGracia:S}}function tn(){if(typeof localStorage<"u"){const $=ls();$.length>0&&console.info(`[FinanceApp] Recuperadas claves escritas fuera del espacio de nombres: ${$.join(", ")}`)}const t=$s(),e=t.activo(),a=Xt(e),o=Za(localStorage,a),n=fs({adapter:o}),s=gs(),{applied:i}=n.load();i.length>0&&console.info(`[FinanceApp] Migraciones aplicadas: ${i.join(", ")} (esquema v${Kt})`),n.subscribe($=>s.marcar($));function r(){var M,_,I,y,E;const $=globalThis;(_=(M=$.FirebaseService)==null?void 0:M.isConnected)!=null&&_.call(M)&&((E=(y=(I=$.FirebaseService).uploadRegistroProyectos)==null?void 0:y.call(I))==null||E.catch(A=>console.warn("[FinanceApp] No se ha podido subir la lista de proyectos:",A instanceof Error?A.message:A)))}const c={listar:()=>t.listar(),activo:()=>t.listar().find($=>$._id===e)??t.listar()[0],colecciones:St.filter($=>$!=="config"),crear:$=>{const M=t.crear($);return r(),M},renombrar:($,M)=>{t.renombrar($,M),r()},duplicar:($,M)=>{const _=t.duplicar($,M);return r(),_},eliminar:$=>{t.eliminar($),r()},cambiarA:$=>t.establecerActivo($),fusionarRemotos:$=>t.fusionarRemotos($),importarDesde:($,M)=>{const _=xs(localStorage,$,M),I=ws(_),y=[];for(const E of M){const A=I[E];if(!Array.isArray(A)||A.length===0)continue;const F=n.get(E);n.set(E,[...F,...A]),y.push(E)}return y.length>0&&s.marcar("importado-de-otro-proyecto"),{importadas:y}}},l=Cs(n),m=Cc(),d=gc({autoLogoutMinutos:()=>{var M,_;const $=(_=(M=globalThis.State)==null?void 0:M.get)==null?void 0:_.call(M,"config");return Number(($==null?void 0:$.autoLogoutMinutos)??n.get("config").autoLogoutMinutos??0)},graciaActiva:()=>m.dentroDeGracia()}),u=ic(n),v=rc(n),g=mr(u),b=Ar(n),x=Js({isEnabled:$=>l.isEnabled($)}),f=Bs({flags:l,rutasExtra:()=>x.flagPorRuta()}),h=Es({flags:l,onChange:()=>{var $,M;x.attachToShell(),f.apply(),(M=($=globalThis.Router)==null?void 0:$.rerender)==null||M.call($)}}),S=qs({proyectos:c}),C=()=>{var M,_,I,y,E,A;const $=globalThis;if((_=(M=$.State)==null?void 0:M.load)==null||_.call(M),((y=(I=$.Router)==null?void 0:I.current)==null?void 0:y.call(I))==="dashboard")try{(A=(E=$.DashboardModule)==null?void 0:E.render)==null||A.call(E)}catch(F){console.error("[FinanceApp] No se ha podido repintar el cuadro de mando tras el cambio:",F)}},w=ks({store:n,onDatosCambiados:C});return x.register(li({store:n,onDatosCambiados:C})),x.register(yi({store:n,onDatosCambiados:C})),x.register(Vi({store:n,onDatosCambiados:C})),x.register(sc({store:n,ledger:u,tags:v,precision:g,adjuster:b,onDatosCambiados:C})),x.register(ti({store:n,onDatosCambiados:C})),{version:Kt,core:un,engine:{generarExtracto:Ta,recomputarSaldoAcum:fn,saldoHoy:gn,sumarPorTags:za,providers:{proyectarGastos:Yt,proyectarPrestamos:De,proyectarTransferencias:Sa,proyectarNominas:Te,proyectarInteresesCuentas:Ma,proyectarAportaciones:Aa,proyectarRetencionesFiscales:Ea,proyectarInflacionGastos:_a,proyectarPerdidaAhorro:Pa},analysis:yn,margins:An,avisos:Pn,dashboard:Gn},store:n,flags:l,featureRegistry:{all:wt,porGrupo:so},ui:{openFeatures:h.open,openProyectos:S.open,openPersonas:w.open,applyGating:f.apply,watchGating:()=>f.observar(),instalarDeshacer:()=>Gs({store:n,rerender:()=>{var M,_,I,y;const $=globalThis;(_=(M=$.State)==null?void 0:M.load)==null||_.call(M),(y=(I=$.Router)==null?void 0:I.rerender)==null||y.call(I)}}),avisoGuardado:null,instalarBuscador:()=>Ws({estado:()=>({accounts:n.get("accounts"),expenses:n.get("expenses"),loans:n.get("loans"),nominas:n.get("nominas"),transacciones:n.get("transacciones")}),rutasDisponibles:()=>x.routes(),navegar:$=>{var M,_;return(_=(M=globalThis.Router)==null?void 0:M.navigate)==null?void 0:_.call(M,$)}})},app:x,session:Object.assign(d,{vigilar:$=>vc({sesion:d,onCaducada:$}),opciones:bc}),biometria:m,cambios:s,datos:{colecciones:St,snapshot:()=>to(o),aplicar:($,{sellar:M=!0}={})=>{const I=vs(M?(y,E)=>o.set(y,E):(y,E)=>{const A=globalThis.StorageAdapter;A!=null&&A.setRestaurando?A.setRestaurando(y,E):o.set(y,E)},$);return n.load(),s.marcar("copia-restaurada"),I},faltantes:$=>bs($),esVacioOPorDefecto:()=>hs(to(o)),recargar:()=>{n.load(),s.marcar("recarga-externa")}},proyectos:c,accounting:{ledger:u,tags:v,precision:g,adjuster:b,sugerirAjuste:ta,medirVariabilidad:dc,bandaDeConfianza:uc,bandaAcumulada:Ko,describirBanda:pc}}}function Sc(){try{const t=tn();return window.FinanceApp=t,t}catch(t){const e=t;return window.FinanceAppError={mensaje:(e==null?void 0:e.message)??String(t),stack:e==null?void 0:e.stack},console.error("[FinanceApp] El paquete nuevo no pudo arrancar:",t),null}}const st=typeof window<"u"?Sc():null;if(st){let t=!1;const e=()=>{var a,o;if(st.app.attachToShell(),st.ui.applyGating(),!t){t=!0,st.ui.watchGating(),st.ui.instalarDeshacer(),st.ui.instalarBuscador();const n=globalThis,s=()=>{var c,l,m,d;return(l=(c=n.FirebaseService)==null?void 0:c.isConnected)!=null&&l.call(c)?n.FirebaseService:(d=(m=n.DropboxService)==null?void 0:m.isConnected)!=null&&d.call(m)?n.DropboxService:null};st.ui.avisoGuardado=Ks({cambios:st.cambios,hayDestino:()=>s()!==null,guardar:async()=>{const c=s();if(!(c!=null&&c.uploadBackup))throw new Error("No hay ningún destino de copia conectado.");await c.uploadBackup()}});const i=document.getElementById("sidebar-proyecto-activo"),r=document.getElementById("sidebar-proyecto-activo-nombre");i&&r&&(r.textContent=st.proyectos.activo().nombre,i.classList.remove("hidden"),i.addEventListener("click",()=>st.ui.openProyectos())),(a=document.getElementById("btn-proyectos"))==null||a.addEventListener("click",()=>st.ui.openProyectos()),(o=document.getElementById("btn-personas"))==null||o.addEventListener("click",()=>st.ui.openPersonas())}};document.readyState==="loading"?document.addEventListener("DOMContentLoaded",e,{once:!0}):e(),document.addEventListener("click",a=>{const o=a.target;o!=null&&o.closest(".nav-btn[data-view]")&&setTimeout(e,0)})}return Ie.bootstrap=tn,Object.defineProperty(Ie,Symbol.toStringTag,{value:"Module"}),Ie}({});
