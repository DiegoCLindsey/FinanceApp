var FinanceAppBundle=function(yt){"use strict";var vi=Object.defineProperty;var gi=(yt,L,q)=>L in yt?vi(yt,L,{enumerable:!0,configurable:!0,writable:!0,value:q}):yt[L]=q;var io=(yt,L,q)=>gi(yt,typeof L!="symbol"?L+"":L,q);function L(t){const e=t.getFullYear(),a=String(t.getMonth()+1).padStart(2,"0"),o=String(t.getDate()).padStart(2,"0");return`${e}-${a}-${o}`}function q(t){const[e,a,o]=t.split("-").map(Number);return new Date(e,a-1,o)}function V(){return L(new Date)}function ia(t,e){return new Date(t,e+1,0).getDate()}function Na(t,e,a){return L(new Date(t,e,Math.min(a,ia(t,e))))}function Qt(t,e,a){if(!a)return null;if(a.startsWith("dia:")){const o=a.slice(4);if(o==="ultimo")return L(new Date(t,e+1,0));const s=parseInt(o);if(!isNaN(s))return Na(t,e,s)}if(a.startsWith("nthweekday:")){const o=a.split(":"),s=parseInt(o[1]),n=parseInt(o[2]);if(s===-1){const d=new Date(t,e+1,0);for(;d.getDay()!==n;)d.setDate(d.getDate()-1);return L(d)}const i=new Date(t,e,1);for(;i.getDay()!==n;)i.setDate(i.getDate()+1);return i.setDate(i.getDate()+(s-1)*7),i.getMonth()!==e&&i.setDate(i.getDate()-7),L(i)}return null}function qa(t,e){if(!e)return t;const a=q(t);return Qt(a.getFullYear(),a.getMonth(),e)??t}const ro=["domingo","lunes","martes","miércoles","jueves","viernes","sábado"],co={"-1":"último",1:"1º",2:"2º",3:"3º",4:"4º",5:"5º"};function ra(t){if(!t)return"";if(t.startsWith("dia:")){const e=t.slice(4);return e==="ultimo"?"Último día del mes":`Día ${e} del mes`}if(t.startsWith("nthweekday:")){const e=t.split(":"),a=e[1],o=parseInt(e[2]);return`${co[a]||a+"º"} ${ro[o]} del mes`}return t}function Zt(t,e){const a=Date.UTC(t.getFullYear(),t.getMonth(),t.getDate()),o=Date.UTC(e.getFullYear(),e.getMonth(),e.getDate());return Math.round((o-a)/864e5)}function At(t){return Math.sign(t)*Math.round(Math.abs(t)*100)}function et(t){return t/100}function ot(t){return et(At(t))}function z(t){return new Intl.NumberFormat("es-ES",{style:"currency",currency:"EUR"}).format(t||0)}function La(t){return(t||0).toFixed(2)+"%"}function Ft(t,e,a){const o=e/100/12;return o===0?t/a:t*o*Math.pow(1+o,a)/(Math.pow(1+o,a)-1)}function ka(t,e,a,o=0){const s=Ft(t,e,a),n=t*(1-o/100);let i=e/100/12;for(let d=0;d<200;d++){const r=s*(1-Math.pow(1+i,-a))/i-n,x=s*(a*Math.pow(1+i,-(a+1))/i-(1-Math.pow(1+i,-a))/(i*i)),f=i-r/x;if(Math.abs(f-i)<1e-10){i=f;break}i=f}return(Math.pow(1+i,12)-1)*100}function Oa(t,e,a,o,s=0,n=[],i={}){const d=[];let u=t;const r=q(o),x=e/100/12;let f=a,c=Ft(u,e,f);const b=[...n].sort(($,A)=>$.fecha.localeCompare(A.fecha));let g=0;for(let $=1;$<=a*2&&u>.01;$++){const A=new Date(r);r.setMonth(r.getMonth()+1);const p=qa(L(A),i.diaPago||"");for(;g<b.length&&b[g].fecha<=p;){const I=b[g],y=I.cantidad*(s/100);if(u-=I.cantidad,u=Math.max(0,u),I.tipo==="plazo"?f=Math.ceil(-Math.log(1-u*x/c)/Math.log(1+x)):(f=a-$+1,c=Ft(u,e,f)),d.push({mes:"AMORT",fecha:I.fecha,cuota:0,interes:0,amortizacion:I.cantidad,comisionAmort:y,capitalPendiente:u,esAmortizacion:!0,simulacion:I.simulacion||!1}),g++,u<.01)break}if(u<.01)break;const m=u*x,v=Math.min(c-m,u);if(u-=v,u<.01&&(u=0),d.push({mes:$,fecha:p,cuota:c,interes:m,amortizacion:v,comisionAmort:0,capitalPendiente:u,esAmortizacion:!1,simulacion:!1}),f--,f<=0||u<.01)break}return d}const Ba=new Map;function Z(t){var A;const e=t.amortizaciones||[],a=`${t.capital}|${t.tin}|${t.meses}|${t.fechaInicio}|${t.comisionAmort||0}|${t.comisionApertura||0}|${t.diaPago||""}|${e.slice().sort((p,m)=>`${p.fecha}|${p.cantidad}|${p.tipo||""}`.localeCompare(`${m.fecha}|${m.cantidad}|${m.tipo||""}`)).map(p=>`${p.fecha}:${p.cantidad}:${p.tipo||""}`).join(";")}`,o=Ba.get(a);if(o)return o;const{capital:s,tin:n,meses:i,fechaInicio:d,comisionAmort:u,comisionApertura:r}=t,x=Oa(s,n,i,d,u||0,e,t),f=x.reduce((p,m)=>p+m.interes,0),c=x.reduce((p,m)=>p+m.comisionAmort,0),b=s*((r||0)/100),g=x.filter(p=>!p.esAmortizacion),$={cuota:Ft(s,n,i),totalIntereses:f,tae:ka(s,n,i,r||0),costoTotal:f+c+b,comAp:b,totalComAm:c,fechaFin:((A=g.slice(-1)[0])==null?void 0:A.fecha)||"",mesesReales:g.length,tabla:x};return Ba.set(a,$),$}function Ha(t){const e=Z(t),a=Z({...t,amortizaciones:[]}),o=a.totalIntereses-e.totalIntereses,s=a.mesesReales-e.mesesReales,n=e.totalComAm;return{...e,sinAmort:a,ahorroIntereses:o,ahorroTiempo:s,costeTotalAmort:n,ahorroNeto:o-n,totalPagado:t.capital+e.totalIntereses+e.comAp+e.totalComAm}}function lt(t,e,a){if(!t||t.length===0)return 1;const o=q(e),s=q(a);if(s<=o)return 1;const n=[...t].sort((u,r)=>u.year-r.year);let i=1,d=new Date(o);for(;d<s;){const u=d.getFullYear(),r=n.filter($=>$.year<=u),x=r.length>0?r[r.length-1]:n[0],f=(x?x.tasa:0)/100,c=new Date(u+1,0,1),b=c<s?c:s,g=Zt(d,b);i*=Math.pow(1+f,g/365.25),d=b}return i}function Ga(t,e,a,o=0){const s=q(e),n=q(a);if(n<=s)return o;const i=Zt(s,n),d=t?[...t].sort((x,f)=>x.year-f.year):[];let u=0,r=new Date(s);for(;r<n;){const x=r.getFullYear(),f=new Date(x+1,0,1),c=f<n?f:n,b=Zt(r,c),g=d.filter(p=>p.year<=x),$=g.length>0?g[g.length-1]:null,A=$!==null?$.tasa:o;u+=A*b,r=c}return i>0?u/i:o}function Va(t,e){return((1+t/100)/(1+e/100)-1)*100}function lo(t,e,a,o){const s=lt(e,a,o);return s>0?t/s:t}function uo(t,e){const a=e.saludUmbralAhorroVerde??20,o=e.saludUmbralAhorroAmarillo??10,s=e.saludUmbralDTIVerde??30,n=e.saludUmbralDTIAmarillo??40,i=e.saludRegla||[50,30,20],d=e.saludExcluirHipoteca||!1,{ingresos:u=0,cuotas:r=0,cuotasHipoteca:x=0,gastosBasicos:f=0,gastosOtros:c=0,amortizaciones:b=0}=t,g=u-r-b-f-c,$=g,A=u>0?$/u*100:null,p=d?r-x:r,m=u>0?p/u*100:null,v=u>0?r/u*100:null,I=u>0?(f+r+b)/u*100:null,y=u>0?c/u*100:null,h=(S,M,C)=>S===null?"neutral":S>=M?"verde":S>=C?"amarillo":"rojo",w=(S,M,C)=>S===null?"neutral":S<=M?"verde":S<=C?"amarillo":"rojo";return{ingresos:u,cuotas:r,cuotasHipoteca:x,gastosBasicos:f,gastosOtros:c,amortizaciones:b,ahorroBruto:g,ahorroReal:$,tasaAhorro:A,dti:m,dtiTotal:v,excluyeHipoteca:d,pctNecesidades:I,pctDeseos:y,semAhorro:h(A,a,o),semDTI:w(m,s,n),semNecesidades:w(I,i[0],i[0]+15),semDeseos:w(y,i[1],i[1]+10),semAhorroRegla:h(A,i[2],i[2]*.5),umbralAhorroVerde:a,umbralAhorroAmarillo:o,umbralDTIVerde:s,umbralDTIAmarillo:n,regla:i}}function dt(t){return(t==null?void 0:t.modeloFondo)||(t!=null&&t.esFondoPension?"pension":"cuenta")}function it(t){const e=[...t.historicoSaldos||[]].sort((a,o)=>o.fecha.localeCompare(a.fecha));return e.length>0?e[0].saldo:t.saldoInicial||0}function Nt(t,e){const a=t.fechaInicialSaldo||"";if(!a||e>=a){const o=[];a&&o.push({fecha:a,saldo:t.saldoInicial||0});for(const n of t.historicoSaldos||[])n.fecha>=a&&o.push(n);o.sort((n,i)=>i.fecha.localeCompare(n.fecha));const s=o.find(n=>n.fecha<=e);return s?s.saldo:t.saldoInicial||0}else{const s=[...t.historicoSaldos||[]].sort((n,i)=>i.fecha.localeCompare(n.fecha)).find(n=>n.fecha<=e);return s?s.saldo:0}}function ca(t,e){const a=t.cuentaIds&&t.cuentaIds.length>0?t.cuentaIds:null;return a?e.filter(o=>a.includes(o._id)):e.filter(o=>o.activo&&!o.simulacion)}function Ua(t,e,a=0){const o=ca(t,e).reduce((s,n)=>s+it(n),0);return t.usarColchon!==!1?Math.max(0,o-a):o}function Ya(t,e,a){if(!t.targetAmount||t.targetAmount<=0)return null;const o=ca(t,e);if(o.length===0)return null;const s=a.hoy??new Date,n=a.horizonteMeses??120,i=t.usarColchon!==!1,d=o.map(u=>({acc:u,eventos:a.extractoCuenta(u),cursor:0,saldo:it(u)}));for(let u=1;u<=n;u++){const r=new Date(s.getFullYear(),s.getMonth()+u,1),x=`${r.getFullYear()}-${String(r.getMonth()+1).padStart(2,"0")}`,f=L(new Date(r.getFullYear(),r.getMonth()+1,0));let c=0;for(const g of d){for(;g.cursor<g.eventos.length&&g.eventos[g.cursor].fecha<=f;)g.saldo=g.eventos[g.cursor].saldoAcum??g.saldo,g.cursor++;c+=g.saldo}const b=i?a.colchonEnFecha(f):0;if(c-b>=t.targetAmount)return x}return null}function Wa(t,e){const a=t.escenarioIds||[];return a.length===0?!0:!!e&&a.includes(e)}function Ja(t,e){const a=o=>Wa(o,e);return{loans:t.loans.filter(a).map(o=>({...o,amortizaciones:(o.amortizaciones||[]).filter(a)})),expenses:t.expenses.filter(a),nominas:t.nominas.filter(a),accounts:t.accounts.filter(a)}}const la=t=>t.slice(0,7);function po(t){const[e,a]=t.split("-").map(Number);return`${a===12?e+1:e}-${String(a===12?1:a+1).padStart(2,"0")}`}function da(t,e,a){if(t.length===0)return[];const o=new Map;for(const r of t)r.saldoAcum!==void 0&&o.set(la(r.fecha),r.saldoAcum);const s=t[0];let n=(s.saldoAcum??0)-(s.delta??0);const i=la(e||s.fecha),d=la(a||t[t.length-1].fecha);if(d<i)return[];const u=[];for(let r=i;r<=d;r=po(r)){const x=o.get(r);x!==void 0&&(n=x);const[f,c]=r.split("-").map(Number);u.push({x:q(L(new Date(f,c-1,15))).getTime(),mes:r,y:n})}return u}function ua(t,e){let a=null;for(const o of t){if(o.fecha>e)break;o.saldoAcum!==void 0&&(a=o.saldoAcum)}return a}function mo(t){const e=a=>!a.simulacion;return{loans:t.loans.filter(e).map(a=>({...a,amortizaciones:(a.amortizaciones||[]).filter(e)})),expenses:t.expenses.filter(e),nominas:t.nominas.filter(e),accounts:t.accounts.filter(e)}}function fo(t){const e=a=>!!a.simulacion;return t.loans.some(a=>e(a)||(a.amortizaciones||[]).some(e))||t.expenses.some(e)||t.nominas.some(e)||t.accounts.some(e)}const ft=[[0,19],[12450,24],[20200,30],[35200,37],[6e4,45],[3e5,47]];function ct(t,e){const a=[...e].sort((n,i)=>n[0]-i[0]);let o=0,s=t;for(let n=a.length-1;n>=0;n--){const[i,d]=a[n];s<=i||(o+=(s-i)*(d/100),s=i)}return o}function pa(t,e){const a=Math.max(0,t-(e||0)),o=t*.0635,s=Math.min(2e3,a),n=Math.max(0,a-o-s),i=n<=15876?7302:n<=21622?Math.max(0,7302-1.75*(n-15876)):0;return{baseIRPF:a,cotizSS:o,gastosArt19:s,RNT:n,reducArt20:i,baseImponible:Math.max(0,n-i)}}function xt(t,e){return pa(t,e).baseImponible}function Ka(t,e){return ct(t,e)/12}const wt=[[0,19],[6e3,21],[5e4,23],[2e5,27],[3e5,28]];function ma(t,e){if(!t||t<=0)return 0;const a=e||wt;let o=0,s=t;for(let n=0;n<a.length;n++){const[i,d]=a[n],u=n<a.length-1?a[n+1][0]:1/0,r=Math.min(s,u-i);if(!(r<=0)&&(o+=r*(d/100),s-=r,s<=0))break}return o}function Pt(t,e){if(dt(t)!=="inversion")return null;const a=it(t),o=(t.aportaciones||[]).reduce((i,d)=>i+d.cantidad,0)||t.saldoInicial||0,s=Math.max(0,a-o),n=ma(s,e);return{saldo:a,costBase:o,plusvalia:s,impuesto:n,neto:a-n}}function ta(t,e=new Date){var c;if(dt(t)!=="pension")return null;const a=t.bloqueoMeses||120,o=it(t),s=L(new Date(e.getFullYear(),e.getMonth()-a,e.getDate())),n=[...t.aportaciones||[]].sort((b,g)=>b.fecha.localeCompare(g.fecha));let i=0;const d=n.reduce((b,g)=>b+g.cantidad,0);for(const b of n)b.fecha<=s&&(i+=b.cantidad);const u=Math.max(0,o-d),r=d>0?i/d:0,x=Math.min(o,i+u*r),f=Math.max(0,o-x);return{saldo:o,disponible:x,bloqueado:f,costBase:d,beneficio:u,numAportaciones:n.length,proxDesbloqueo:((c=n.find(b=>b.fecha>s))==null?void 0:c.fecha)||null}}function Xa(t,e,a){const o=a!==void 0?a:t.impuestoRetirada;if(dt(t)!=="pension"||!o)return 0;const s=it(t);if(s<=0)return 0;const n=(t.aportaciones||[]).reduce((r,x)=>r+x.cantidad,0),i=Math.max(0,s-n);if(i<=0)return 0;const d=i/s;return+(e*d*o/100).toFixed(2)}function fa(t,e,a){var u;const o=t.grupoNomina;if(!o)return t.impuestoRetirada||0;const n=(e||[]).filter(r=>(r.grupoNomina||"")===o&&r.activo!==!1).reduce((r,x)=>r+(x.bruto||0)*(x.nPagas||12),0),i=[...a||[]].sort((r,x)=>r[0]-x[0]);let d=((u=i[0])==null?void 0:u[1])||19;for(const[r,x]of i)if(n>=r)d=x;else break;return d}const va=6.35;function St(t){return(t.retribucionFlexible||[]).reduce((e,a)=>e+(a.importe||0)*12,0)}function Qa(t){return Math.max(0,(t.bruto||0)-St(t))}function vo(t){return[...t].sort((e,a)=>(a.bruto||0)-(e.bruto||0)||String(e._id).localeCompare(String(a._id)))}function go(t){const e=t.reduce((i,d)=>i+(d.bruto||0),0),a=t.reduce((i,d)=>i+St(d),0),o=Math.max(0,e-a),s=xt(e,a),n=new Map;for(const i of t)n.set(i._id,o>0?s*(Qa(i)/o):0);return n}function ga(t,e,a){if(t.irpfModo==="manual")return Qa(t)*((t.irpfPct||0)/100);if(!e||e.length===0)return ct(xt(t.bruto||0,St(t)),a);const o=vo(e.filter(i=>i.irpfModo!=="manual")),s=go(e);let n=0;for(const i of o){const d=s.get(i._id)??0;if(i._id===t._id)return ct(n+d,a)-ct(n,a);n+=d}return ct(xt(t.bruto||0,St(t)),a)}function bo(t,e){return t.reduce((a,o)=>a+ga(o,t,e),0)}function ho(t,e){var s;const a=[...e||[]].sort((n,i)=>n[0]-i[0]);let o=((s=a[0])==null?void 0:s[1])??19;for(const[n,i]of a)if(t>=n)o=i;else break;return o}function Za(t,e){if(!t||t.length===0)return 0;const a=t.reduce((s,n)=>s+(n.bruto||0),0),o=t.reduce((s,n)=>s+St(n),0);return ho(xt(a,o),e)}function ba(t,e,a){const o=t.bruto||0,s=St(t),n=Math.max(0,o-s),i=t.nPagas||12,d=t.ssPct??va,u=n*(d/100),r=ga(t,e,a);return{brutoAnual:o,flexAnual:s,baseDineraria:n,nPagas:i,ssPct:d,ssAnual:u,irpfAnual:r,irpfPct:n>0?r/n*100:0,netoPorPaga:(n-u-r)/i}}function yo(t){const e=new Map,a=[];for(const o of t){const s=o.grupoNomina||"";if(!s){a.push(o);continue}const n=e.get(s)??[];n.push(o),e.set(s,n)}return{grupos:e,sueltas:a}}const Mt=1500;function te(t){const e=t.cuantia||0,a=Math.max(1,t.frecuencia||1);return t.tipoFrecuencia==="mensual"?e*12/a:t.tipoFrecuencia==="diaria"?e*365.25/a:e}const qt=t=>{const e=typeof t=="number"?t:parseFloat(String(t??""));return Number.isFinite(e)?e:0};function xo(t,e){const a=t.grupoNomina||"";return a?e.filter(o=>(o.grupoNomina||"")===a):null}function ae(t,e){return t.reduce((a,o)=>a+ga(o,xo(o,t),e),0)}function ee(t){const{nominas:e,tramosGeneral:a,tramosAhorro:o}=t,s=t.extras??{},n=e.reduce((S,M)=>S+(M.bruto||0),0),i=e.reduce((S,M)=>S+St(M),0),d=pa(n,i),u=t.aportacionesPension,r=Mt,x=Math.min(u,r),f=Math.max(0,d.RNT-d.reducArt20-x),c=qt(s.capInmobiliario),b=qt(s.capMobiliario),g=qt(s.gananciasFondos),$=qt(s.otrasCorto),A=qt(s.retCapital),p=Math.max(0,f+t.otrosIngresos+c+$),m=Math.max(0,b+g),v=ct(p,a),I=ct(m,o),y=v+I,h=ae(e,a),w=h+A;return{brutoTotal:n,flexTotal:i,brutoIRPF:d.baseIRPF,cotizSS:d.cotizSS,gastosArt19:d.gastosArt19,RNT:d.RNT,reducArt20:d.reducArt20,aportPP:u,limPP:r,deducPP:x,RNTred:f,otrosIngresos:t.otrosIngresos,capInmobiliario:c,capMobiliario:b,gananciasFondos:g,otrasCorto:$,baseGeneral:p,baseAhorro:m,cuotaGen:v,cuotaAho:I,cuotaIntegra:y,retNomina:h,retCapital:A,totalRet:w,resultado:y-w}}const $o=Object.freeze(Object.defineProperty({__proto__:null,LIMITE_APORTACION_PENSION:Mt,TRAMOS_AHORRO_DEFAULT:wt,TRAMOS_IRPF_DEFAULT:ft,ajustarFechaPago:qa,ajustarPrecioReal:lo,calcBaseImponibleTrabajo:xt,calcFactorInflacion:lt,calcFondoInversion:Pt,calcFondosPension:ta,calcGananciasCapital:ma,calcIRPF:ct,calcImpuestoPension:Xa,calcInflacionMediaAnual:Ga,calcSaludFinanciera:uo,calcTAE:ka,calcTipoMarginalPension:fa,calcTipoRealFisher:Va,calcularDeclaracion:ee,clampedDate:Na,cuentasDelObjetivo:ca,cuotaMensual:Ft,desgloseBaseTrabajo:pa,diasEntre:Zt,filtrarPorEscenario:Ja,formatEUR:z,formatLocalDate:L,formatPct:La,fromCents:et,haySimulaciones:fo,ingresoAnual:te,labelDiaPago:ra,lastDayOfMonth:ia,modeloFondoDe:dt,parseLocalDate:q,proyectarFechaCumplimiento:Ya,resolverDiaEfectivo:Qt,resumenPrestamo:Z,resumenPrestamoConAhorro:Ha,retencionMensual:Ka,retencionesNomina:ae,roundMoney:ot,saldoEnFecha:Nt,saldoEnFechaExtracto:ua,saldoParaObjetivo:Ua,saldoRealCuenta:it,serieMensual:da,sinSimulaciones:mo,tablaAmortizacion:Oa,toCents:At,todayISO:V,visibleEnEscenario:Wa},Symbol.toStringTag,{value:"Module"}));function Lt(t,e,a=null){const o=[],s=q(e.start),n=q(e.end);for(const i of t){if(!i.activo||a&&a.length>0&&!a.includes(i.cuenta||"default"))continue;const d=q(i.fechaInicio||e.start),u=i.fechaFin?q(i.fechaFin):n,r=i.cuantia,x=f=>o.push({fecha:f,concepto:i.concepto,cuantia:r,tipo:i.tipo,tags:i.tags||[],cuenta:i.cuenta||"default",sourceId:i._id,sourceType:"expense"});if(i.tipoFrecuencia==="extraordinario")d>=s&&d<=n&&d<=u&&x(i.fechaInicio);else if(i.tipoFrecuencia==="mensual"){const f=Math.max(1,i.frecuencia||1);let c=d.getFullYear(),b=d.getMonth();const g=Math.ceil(240/f)+2;for(let $=0;$<g;$++){const A=Qt(c,b,i.diaPago||"")||(()=>{const m=d.getDate(),v=new Date(c,b+1,0).getDate();return L(new Date(c,b,Math.min(m,v)))})(),p=q(A);if(p>n||p>u)break;p>=s&&p>=d&&x(A),b+=f,b>=12&&(c+=Math.floor(b/12),b=b%12)}}else if(i.tipoFrecuencia==="diaria"){const f=Math.max(1,i.frecuencia||1)*864e5;let c=new Date(Math.max(d.getTime(),s.getTime()));if(d<s){const b=Math.ceil((s.getTime()-d.getTime())/f);c=new Date(d.getTime()+b*f)}for(;c<=n&&c<=u;)x(L(c)),c=new Date(c.getTime()+f)}}return o}function oe(t,e,a=null){const o=[];for(const s of t){if(!s.activo||a&&a.length>0&&!a.includes(s.cuenta||"default"))continue;const{tabla:n}=Z(s);for(const i of n)i.fecha>=e.start&&i.fecha<=e.end&&(i.esAmortizacion?o.push({fecha:i.fecha,concepto:`Amort. ${s.nombre}`,cuantia:-(i.amortizacion+i.comisionAmort),tipo:"gasto",tags:["amortizacion",...s.tags||[]],cuenta:s.cuenta||"default",sourceId:s._id,sourceType:"loan-amort",simulacion:i.simulacion||!1}):o.push({fecha:i.fecha,concepto:`Cuota ${s.nombre}`,cuantia:-i.cuota,tipo:"gasto",tags:["prestamo",...s.tags||[]],cuenta:s.cuenta||"default",sourceId:s._id,sourceType:"loan",simulacion:s.simulacion||!1}))}return o}function se(t,e,a=null,o={accounts:[]}){const s=[],n=q(e.start),i=q(e.end),d=o.accounts||[],u=o.nominas||[],r=o.resolverTramosIRPF||(()=>ft),x=o.resolverTramosGanancias||(()=>wt),f=c=>{var b;return((b=d.find(g=>g._id===c))==null?void 0:b.nombre)??c};for(const c of t){if(!c.activo||c.tipo!=="transferencia"||a&&a.length>0&&!(a.includes(c.cuenta||"default")||a.includes(c.cuentaDestino||"default")))continue;const b=q(c.fechaInicio||e.start),g=c.fechaFin?q(c.fechaFin):i,$=A=>{const p=d.find(P=>P._id===(c.cuenta||"default")),m=d.find(P=>P._id===(c.cuentaDestino||"default")),v=dt(p),I=dt(m),y=v==="inversion"&&I==="inversion"||v==="pension"&&I==="pension",h=["transferencia",...y?["traspaso"]:[],...c.tags||[]],w=y?"traspaso-out":"transfer-out",S=y?"traspaso-in":"transfer-in",M=!a||a.length===0||a.includes(c.cuenta||"default"),C=!a||a.length===0||a.includes(c.cuentaDestino||"default");if(M&&s.push({fecha:A,concepto:`Transf. → ${f(c.cuentaDestino||"default")}: ${c.concepto}`,cuantia:c.cuantia,tipo:"gasto",tags:h,cuenta:c.cuenta||"default",sourceId:c._id,sourceType:w}),C&&s.push({fecha:A,concepto:`Transf. ← ${f(c.cuenta||"default")}: ${c.concepto}`,cuantia:c.cuantia,tipo:"ingreso",tags:h,cuenta:c.cuentaDestino||"default",sourceId:c._id,sourceType:S}),M&&!y&&p){if(v==="inversion"){const P=parseInt(A.slice(0,4)),F=Pt(p,x(P));if(F&&F.saldo>0&&F.plusvalia>0){const T=Math.min(1,c.cuantia/F.saldo),R=F.plusvalia*T*.19;R>.01&&s.push({fecha:A,concepto:`Retención IRPF reembolso ${p.nombre} (19% s/plusvalía)`,cuantia:R,tipo:"gasto",tags:["impuesto","capital-mobiliario","retencion"],cuenta:c.cuenta||"default",sourceId:c._id,sourceType:"investment-tax"})}}else if(v==="pension"){const P=r(parseInt(A.slice(0,4))),F=fa(p,u,P),T=Xa(p,c.cuantia,F||void 0);if(T>0){const j=p.grupoNomina?`IRPF rescate ${p.nombre} (tipo marginal grupo "${p.grupoNomina}": ${F}%)`:`Retención rescate ${p.nombre} (${p.impuestoRetirada}% s/beneficio)`;s.push({fecha:A,concepto:j,cuantia:T,tipo:"gasto",tags:["impuesto","rendimientos-trabajo","pension"],cuenta:c.cuenta||"default",sourceId:c._id,sourceType:"pension-tax"})}}}};if(c.tipoFrecuencia==="extraordinario")b>=n&&b<=i&&b<=g&&$(c.fechaInicio);else if(c.tipoFrecuencia==="mensual"){const A=Math.max(1,c.frecuencia||1);let p=b.getFullYear(),m=b.getMonth();const v=Math.ceil(240/A)+2;for(let I=0;I<v;I++){const y=Qt(p,m,c.diaPago||"")||(()=>{const w=b.getDate(),S=new Date(p,m+1,0).getDate();return L(new Date(p,m,Math.min(w,S)))})(),h=q(y);if(h>i||h>g)break;h>=n&&h>=b&&$(y),m+=A,m>=12&&(p+=Math.floor(m/12),m=m%12)}}else if(c.tipoFrecuencia==="diaria"){const A=Math.max(1,c.frecuencia||1)*864e5;let p=new Date(Math.max(b.getTime(),n.getTime()));if(b<n){const m=Math.ceil((n.getTime()-b.getTime())/A);p=new Date(b.getTime()+m*A)}for(;p<=i&&p<=g;)$(L(p)),p=new Date(p.getTime()+A)}}return s}function ne(t,e,a=null){const o=[],s=q(e.start),n=q(e.end);for(const i of t){const d=dt(i);if(d==="cuenta"||!i.activo)continue;const u=i.planAportaciones||[];for(const r of u){if(!r.importe||r.importe<=0)continue;const x=q(r.fechaInicio||e.start),f=r.fechaFin?q(r.fechaFin):n,c=r.cuentaOrigen||"default",b=!a||!a.length||a.includes(c),g=!a||!a.length||a.includes(i._id),$=d==="pension"?"pension":"capital-mobiliario",A=y=>{b&&o.push({fecha:y,concepto:`Aportación → ${i.nombre}`,cuantia:r.importe,tipo:"gasto",tags:["aportacion","transferencia",$],cuenta:c,sourceId:r._id,sourceType:"aportacion-out"}),g&&o.push({fecha:y,concepto:`Aportación ${i.nombre} (${r.periodicidad||"mensual"})`,cuantia:r.importe,tipo:"ingreso",tags:["aportacion","transferencia",$],cuenta:i._id,sourceId:r._id,sourceType:"aportacion-in"})},p={mensual:1,trimestral:3,semestral:6,anual:12}[r.periodicidad||"mensual"]||1;let m=x.getFullYear(),v=x.getMonth();const I=Math.ceil(240/p)+2;for(let y=0;y<I;y++){const h=new Date(m,v+1,0).getDate(),w=L(new Date(m,v,Math.min(x.getDate(),h))),S=q(w);if(S>n||S>f)break;S>=s&&S>=x&&A(w),v+=p,v>=12&&(m+=Math.floor(v/12),v=v%12)}}}return o}function ie(t,e,a=null,o=[]){const s=[];for(const n of t){if(!n.activo||!n.interes||n.interes<=0||a&&a.length>0&&!a.includes(n._id))continue;const i=q(e.start),d=q(e.end),u=n.periodoCobro||"mensual",r=u==="mensual",x=r?null:{diario:864e5,semanal:7*864e5}[u]||864e5,f=r?1/12:x/(365.25*864e5);let c=Nt(n,e.start);const b=o.filter(A=>A.cuenta===n._id).map(A=>({fecha:A.fecha,delta:A.tipo==="ingreso"?Math.abs(A.cuantia):-Math.abs(A.cuantia)})).sort((A,p)=>A.fecha.localeCompare(p.fecha));let g=0,$=new Date(i);for(;$<=d;){const A=r?new Date($.getFullYear(),$.getMonth()+1,$.getDate()):new Date($.getTime()+x),p=new Date(Math.min(A.getTime(),d.getTime()+1)),m=L(p);let v=0;for(;g<b.length&&b[g].fecha<m;)v+=b[g].delta,g++;const I=c,y=c+v,h=Math.max(0,(I+y)/2);c=y;const w=r?f:(p.getTime()-$.getTime())/(365.25*864e5),S=h*(Math.pow(1+n.interes/100,w)-1);S>.001&&s.push({fecha:L($),concepto:`Interés ${n.nombre}`,cuantia:S,tipo:"ingreso",tags:["interes","cuenta"],cuenta:n._id,sourceId:n._id,sourceType:"account-interest"}),$=A}}return s}function re(t,e,a,o=null){const s=[],n=e||ft;for(const i of t){if(!i.activo||i.tipo!=="ingreso"||!i.sujetoIRPF)continue;const d=i.cuantia*(i.tipoFrecuencia==="mensual"?12:1),u=Ka(d,n),r={...i,_id:i._id+"_irpf",concepto:`IRPF salario ${i.concepto}`,tipo:"gasto",cuantia:u,tags:["irpf","fiscal"]};s.push(...Lt([r],a,o))}return s}const Io=[5,11,2,8],Ao={transporte:"Transporte",restaurante:"Restaurante",otros:"Beneficio"};function ce(t,e,a=null,o=[],s=()=>ft){const n=[],i=q(e.start),d=q(e.end),u=o.length>0,r={};for(const c of t){const b=c.grupoNomina||"";r[b]||(r[b]=[]),r[b].push(c)}for(const c of Object.keys(r))r[c].sort((b,g)=>(g.bruto||0)-(b.bruto||0));function x(c,b){if(!u||!c.mesActualizacionIPC)return c.bruto||0;const g=c.fechaInicio||e.start,$=q(g),A=q(b);let p=0;for(let v=$.getFullYear();v<=A.getFullYear();v++){const I=new Date(v,c.mesActualizacionIPC-1,1);I>$&&I<=A&&p++}if(p===0)return c.bruto||0;const m=L(new Date($.getFullYear()+p,0,1));return(c.bruto||0)*lt(o,g,m)}function f(c,b){const g=x(c,b),$=(c.retribucionFlexible||[]).reduce((P,F)=>P+(F.importe||0)*12,0),A=Math.max(0,g-$);if(c.irpfModo==="manual")return A*((c.irpfPct||0)/100);const p=s(parseInt(b.slice(0,4))),m=c.grupoNomina||"";if(!m)return ct(xt(g,$),p);const v=r[m].filter(P=>P.activo),I=v.reduce((P,F)=>P+x(F,b),0),y=v.reduce((P,F)=>P+(F.retribucionFlexible||[]).reduce((T,j)=>T+(j.importe||0)*12,0),0),h=Math.max(0,I-y),w=xt(I,y),S=Math.max(0,g-$),M=h>0?w*(S/h):0,C=v.filter(P=>P._id!==c._id&&(P.bruto||0)>(c.bruto||0)).reduce((P,F)=>{const T=(F.retribucionFlexible||[]).reduce((R,N)=>R+(N.importe||0)*12,0),j=Math.max(0,x(F,b)-T);return P+(h>0?w*(j/h):0)},0);return ct(C+M,p)-ct(C,p)}for(const c of t){if(!c.activo)continue;const b=c.cuenta||"default";if(a&&a.length>0&&!a.includes(b))continue;const g=Math.max(1,c.nPagas||12),$=q(c.fechaInicio||e.start),A=c.fechaFin?q(c.fechaFin):d,p=m=>{const v=x(c,m),I=f(c,m),y=(c.retribucionFlexible||[]).reduce((T,j)=>T+(j.importe||0)*12,0),h=Math.max(0,v-y),w=(c.ssPct??6.35)/100,S=h*w,M=h/g,C=I/g,P=S/g,F=c.representacion==="simplificado"?M-P-C:M;n.push({fecha:m,concepto:c.nombre,cuantia:F,tipo:"ingreso",cuenta:b,tags:c.tags||[],sourceId:c._id,sourceType:"nomina"}),c.representacion==="detallado"&&(P>0&&n.push({fecha:m,concepto:`SS ${c.nombre}`,cuantia:P,tipo:"gasto",cuenta:b,tags:["seguridad-social","fiscal"],sourceId:c._id+"_ss",sourceType:"nomina"}),C>0&&n.push({fecha:m,concepto:`IRPF ${c.nombre}`,cuantia:C,tipo:"gasto",cuenta:b,tags:["irpf","fiscal"],sourceId:c._id+"_irpf",sourceType:"nomina"}));for(const T of c.retribucionFlexible||[])!T.cuenta||!(T.importe>0)||a&&a.length>0&&!a.includes(T.cuenta)||n.push({fecha:m,concepto:`${c.nombre} — ${Ao[T.tipo]||T.tipo}`,cuantia:T.importe,tipo:"ingreso",cuenta:T.cuenta,tags:["retribucion-flexible",T.tipo],sourceId:`${c._id}_flex_${T._id||T.tipo}`,sourceType:"nomina"})};if(g<=12){const m=g===12?1:Math.round(12/g),v=$.getDate();let I=$.getFullYear(),y=$.getMonth();for(let h=0;h<300;h++){const w=new Date(I,y+1,0).getDate(),S=new Date(I,y,Math.min(v,w));if(S>d||S>A)break;S>=i&&S>=$&&p(L(S)),y+=m,y>=12&&(I+=Math.floor(y/12),y=y%12)}}else{const m=g-12,v=$.getDate();let I=$.getFullYear(),y=$.getMonth();for(let S=0;S<300;S++){const M=new Date(I,y+1,0).getDate(),C=new Date(I,y,Math.min(v,M));if(C>d||C>A)break;C>=i&&C>=$&&p(L(C)),y++,y>=12&&(I++,y=0)}const h=Math.max($.getFullYear(),i.getFullYear()),w=Math.min((c.fechaFin?A:d).getFullYear(),d.getFullYear());for(let S=h;S<=w;S++)for(const M of Io.slice(0,m)){const C=new Date(S,M,15);C>=i&&C<=d&&C>=$&&C<=A&&p(L(C))}}}return n}function le(t,e,a,o=null,s="default"){const n=[];if(!e||e.length===0)return n;const i=q(a.start),d=q(a.end),u=V(),r=t.filter(f=>f.activo&&f.tipo==="gasto"&&f.tipoFrecuencia==="mensual");let x=new Date(i.getFullYear(),i.getMonth(),1);for(;x<=d;){const f=x.getFullYear(),c=x.getMonth(),b=f+"-"+String(c+1).padStart(2,"0"),g=b+"-01",$=L(new Date(f,c+1,0)),A=L(new Date(f,c,15));let p=0;for(const m of r){if(o&&o.length>0&&!o.includes(m.cuenta||"default")||m.fechaInicio&&m.fechaInicio>$||m.fechaFin&&m.fechaFin<g)continue;const v=m.fechaInicio||u,I=lt(e,v,A);if(I<=1)continue;const y=Math.max(1,m.frecuencia||1);p+=m.cuantia*(I-1)/y}p>.01&&n.push({fecha:A,concepto:"Incremento coste de vida",cuantia:p,tipo:"gasto",tags:["inflacion"],cuenta:s,sourceId:"inflacion_vida_"+b,sourceType:"inflacion"}),x=new Date(f,c+1,1)}return n}function de(t,e,a,o="default"){const s=[];if(!e||e.length===0||t<=0)return s;const n=q(a.start),i=q(a.end),d=[...e].sort((r,x)=>r.year-x.year);let u=new Date(n.getFullYear(),n.getMonth(),1);for(;u<=i;){const r=u.getFullYear(),x=u.getMonth(),f=r+"-"+String(x+1).padStart(2,"0"),c=L(new Date(r,x,15)),b=d.filter(m=>m.year<=r),g=b.length>0?b[b.length-1]:d[0],$=g?g.tasa/100:0,A=Math.pow(1+$,1/12)-1,p=t*A;p>.01&&s.push({fecha:c,concepto:"Pérdida ahorro por inflación",cuantia:p,tipo:"gasto",tags:["inflacion"],cuenta:o,sourceId:"inflacion_ahorro_"+f,sourceType:"inflacion"}),u=new Date(r,x+1,1)}return s}function ue(t,e,a){const o=a.fechaReferencia||a.dashboardStart,s=o<a.dashboardStart?a.dashboardStart:o>a.dashboardEnd?a.dashboardEnd:o,n=e.reduce((f,c)=>f+Nt(c,s),0),i=t.filter(f=>f.fecha<s),d=t.filter(f=>f.fecha>=s),u=[];let r=n;for(const f of[...i].reverse()){const c=f.tipo==="ingreso"?Math.abs(f.cuantia):-Math.abs(f.cuantia);u.unshift({...f,delta:c,saldoAcum:r}),r-=c}const x=[];r=n;for(const f of d){const c=f.tipo==="ingreso"?Math.abs(f.cuantia):-Math.abs(f.cuantia);r+=c,x.push({...f,delta:c,saldoAcum:r})}return[...u,...x]}function wo(t,e,a,o=null){const s=e.filter(n=>n.activo&&(!o||o.length===0||o.includes(n._id)));return ue([...t].sort((n,i)=>n.fecha.localeCompare(i.fecha)),s,a)}function kt(t){const{loans:e,expenses:a,accounts:o,config:s}=t,n=t.filtroAccounts??null,i=t.nominas??[],d=t.inflacionPeriodos??[],u={start:s.dashboardStart,end:s.dashboardEnd},r=a.filter($=>$.tipo!=="transferencia"),x=a.filter($=>$.tipo==="transferencia"),f={accounts:o,nominas:i,resolverTramosIRPF:t.resolverTramosIRPF,resolverTramosGanancias:t.resolverTramosGanancias};let c=[];c=c.concat(Lt(r,u,n)),c=c.concat(oe(e,u,n)),c=c.concat(se(x,u,n,f)),c=c.concat(ne(o,u,n));const b=ie(o,u,n,c);if(c=c.concat(b),c=c.concat(re(a,s.tramos_irpf,u,n)),c=c.concat(ce(i,u,n,d,t.resolverTramosIRPF)),s.usarInflacion&&d.length>0){const $=(o.find(m=>m.activo&&m.esCuentaPrincipal)||o.find(m=>m.activo)||{_id:"default"})._id;c=c.concat(le(r,d,u,n,$));const p=o.filter(m=>m.activo&&(!n||n.length===0||n.includes(m._id))).reduce((m,v)=>m+Nt(v,s.dashboardStart),0);c=c.concat(de(p,d,u,$))}c.sort(($,A)=>$.fecha.localeCompare(A.fecha));const g=o.filter($=>$.activo&&(!n||n.length===0||n.includes($._id)));return ue(c,g,s)}function So(t,e,a=null){const o=V(),n=e.filter(d=>d.activo&&(!a||a.length===0||a.includes(d._id))).reduce((d,u)=>d+it(u),0),i=t.filter(d=>d.fecha<=o);return i.length===0?n:i[i.length-1].saldoAcum}function pe(t,e){const a=new Map;for(const o of t)if(o.tipo===e&&!(o.sourceType==="transfer-out"||o.sourceType==="transfer-in"||o.sourceType==="loan-amort"))for(const s of o.tags||["sin_tag"])a.set(s,(a.get(s)||0)+Math.abs(o.cuantia));return a}function Mo(t,e){const a=[];let o=!1;for(let s=0;s<t.length;s++){const n=t[s],i=n.saldoAcum;i<0&&(s===0||t[s-1].saldoAcum>=0)&&a.push({tipo:"saldo_negativo",fecha:n.fecha,saldo:i,mensaje:`Saldo negativo (${z(i)}) a partir del ${n.fecha}`}),e>0&&(i<e&&!o?(o=!0,a.push({tipo:"bajo_colchon",fecha:n.fecha,saldo:i,mensaje:`Saldo por debajo del colchón (${z(i)} < ${z(e)}) desde ${n.fecha}`})):i>=e&&o&&(o=!1,a.push({tipo:"recuperacion_colchon",fecha:n.fecha,saldo:i,mensaje:`Recuperación del colchón el ${n.fecha} (${z(i)})`})))}return a}function Co(t,e){const a=t.filter(i=>i.tipo==="gasto"&&i.sourceType!=="loan-amort").reduce((i,d)=>i+Math.abs(d.cuantia),0),o=q(e.dashboardStart),s=q(e.dashboardEnd),n=Math.max(1,(s.getTime()-o.getTime())/(30.44*864e5));return a/n}function zo(t,e,a=V()){const o=new Set,s=e.map(d=>{const u=d.fechaInicialSaldo||"",r={};u&&u<=a&&(r[u]=d.saldoInicial||0);for(const x of d.historicoSaldos||[])x.fecha<=a&&(!u||x.fecha>=u)&&(r[x.fecha]=x.saldo);return Object.keys(r).forEach(x=>o.add(x)),r}),n={};for(const d of[...o].sort()){let u=0;for(let r=0;r<e.length;r++){const x=Object.entries(s[r]).filter(([f])=>f<=d);x.length>0?(x.sort(([f],[c])=>c.localeCompare(f)),u+=x[0][1]):u+=e[r].saldoInicial||0}n[d]=u}const i=[];for(const[d,u]of Object.entries(n).sort(([r],[x])=>r.localeCompare(x))){const r=t.filter(b=>b.fecha<=d),x=r.length>0?r[r.length-1].saldoAcum:null;if(x===null)continue;const f=u-x,c=x!==0?f/Math.abs(x)*100:0;i.push({cuenta:"Total",fecha:d,estimado:x,real:u,desv:f,pct:c})}return i}const Fo=Object.freeze(Object.defineProperty({__proto__:null,calcDesviacion:zo,detectarPuntosCriticos:Mo,mediaMensualGastos:Co},Symbol.toStringTag,{value:"Module"}));function Ot(t,e=new Date){const a=L(e),o=new Date(e);o.setMonth(o.getMonth()+1);const s=L(o),n=t.filter(d=>d.basico&&d.activo&&d.tipo==="gasto");return Lt(n,{start:a,end:s}).reduce((d,u)=>d+Math.abs(u.cuantia),0)}function ha(t){return(t||[]).filter(e=>e.basico&&e.activo&&!e.simulacion).reduce((e,a)=>e+Ft(a.capital,a.tin,a.meses),0)}function me(t,e,a,o){return e.colchonTipo==="fijo"&&(e.colchonFijo||0)>0?e.colchonFijo:(Ot(t,o)+ha(a))*(e.colchonMeses||6)}function fe(t,e,a,o,s){const i=[...e.colchonPuntos||[]].sort((u,r)=>u.fecha.localeCompare(r.fecha)).filter(u=>u.fecha<=o).pop();return i?i.tipo==="fijo"?i.importe||0:(Ot(t,s)+ha(a))*(i.meses||6):me(t,e,a,s)}function aa(t,e,a,o,s,n=!1,i){const d=[...t.puntos||[]].sort((x,f)=>x.fecha.localeCompare(f.fecha)),u=d.filter(x=>x.fecha<=s).pop()||(n?d[0]:null);return u?u.tipo==="fijo"?u.importe||0:(Ot(e,i)+ha(o))*(u.meses||1):0}function Po(t,e){const a={};for(const o of e)a[o._id]=it(o);return t.map(o=>(o.cuenta&&a[o.cuenta]!==void 0&&(a[o.cuenta]+=o.cuantia),{fecha:o.fecha,saldos:{...a}}))}function To(t,e,a,o,s,n,i){const d=[];for(const u of(t||[]).filter(r=>r.activo!==!1)){let r=!1;for(let x=0;x<e.length;x++){const f=e[x],c=aa(u,o,s,n,f.fecha,!1,i);if(c<=0){r=!1;continue}const b=!u.cuentas||u.cuentas.length===0?f.saldoAcum:u.cuentas.reduce((g,$)=>{var A,p;return g+(((p=(A=a[x])==null?void 0:A.saldos)==null?void 0:p[$])||0)},0);b<c&&!r?(r=!0,d.push({tipo:"bajo_margen",fecha:f.fecha,saldo:b,target:c,nombre:u.nombre,mensaje:`⚠ ${u.nombre}: ${z(b)} < ${z(c)} desde ${f.fecha}`})):b>=c&&r&&(r=!1,d.push({tipo:"recuperacion_margen",fecha:f.fecha,saldo:b,target:c,nombre:u.nombre,mensaje:`✓ ${u.nombre}: recuperado el ${f.fecha}`}))}}return d}const _o=Object.freeze(Object.defineProperty({__proto__:null,calcColchon:me,calcColchonEnFecha:fe,calcGastoBasicoMensual:Ot,calcMargenEnFecha:aa,detectarCrucesMargenes:To,saldosPorCuentaEnExtracto:Po},Symbol.toStringTag,{value:"Module"}));class jo extends Error{constructor(a,o){super(`La funcionalidad "${a}" está desactivada; no se puede ${o}. Actívala en ⚙ Funcionalidades.`);io(this,"featureId");this.name="FeatureDeshabilitadaError",this.featureId=a}}let Bt=null;function Eo(t){const e=Bt;return Bt=t,()=>{Bt=e}}function ve(t){return Bt?Bt(t):!0}function ge(t,e){if(!ve(t))throw new jo(t,e)}const be=[];function ya(){const t=new Map,e=new WeakMap;let a=1,o=0,s=0;const n=u=>{if(!u||typeof u!="object")return 0;const r=e.get(u);if(r)return r;const x=a++;return e.set(u,x),x},i=u=>u.map(r=>[r._id,r.capital,r.tin,r.meses,r.fechaInicio,r.comisionAmort||0,r.comisionApertura||0,r.diaPago||"",r.activo?1:0,r.cuenta||"",(r.amortizaciones||[]).map(x=>`${x.fecha}:${x.cantidad}:${x.tipo||""}`).sort().join(",")].join("|")).join(";");function d(u){const r=[i(u.loans),n(u.expenses),n(u.accounts),n(u.nominas),n(u.inflacionPeriodos),u.config.dashboardStart,u.config.dashboardEnd,u.config.fechaReferencia||"",u.config.usarInflacion?1:0,(u.filtroAccounts||[]).join(",")].join("#"),x=t.get(r);if(x)return s++,x;o++;const f=kt(u);return t.set(r,f),f}return{statement:d,stats:()=>({hits:s,misses:o}),clear:()=>t.clear()}}function xa(t,e,a,o,s={},n=ya()){ge("optimizador","calcular el plan de amortizaciones");const{frecuencia:i=1,mesesHorizonte:d=36,minAmortizable:u=500,tipoAmort:r="plazo",fechaPrimeraAmort:x=null,loanIds:f=null,nominas:c=be,sourceAccountId:b=null,selectedMarginIds:g=null,hoy:$=new Date}=s,A=L($),p=Math.min(120,Math.max(1,d)),m=a.filter(D=>D.activo),v=m.map(D=>D._id),I=m.find(D=>D.esCuentaPrincipal)||m[0],y=b&&v.includes(b)?m.find(D=>D._id===b):I,h=y==null?void 0:y._id,w=t.filter(D=>D.activo&&!D.simulacion&&(!f||f.includes(D._id))).sort((D,O)=>O.tin-D.tin),S=!!g&&g.length>0,M=(o.margenesSeguridad||[]).filter(D=>D.activo!==!1).filter(D=>!D.cuentas||D.cuentas.length===0||D.cuentas.includes(h)).filter(D=>!S||g.includes(D._id));if(w.length===0)return{plan:[],margenesAplicados:M.length,totalAmortizado:0,totalComisiones:0,totalAhorroIntereses:0,resumenPorLoan:[]};const C={};for(const D of w)C[D._id]=[];const P=[];function F(D){const O=new Date($.getFullYear(),$.getMonth()+D,1),U=O.getFullYear(),J=O.getMonth(),X=`${U}-${String(J+1).padStart(2,"0")}`,pt=L(new Date(U,J,Math.min(15,new Date(U,J+1,0).getDate())));return{label:X,dia15:pt}}function T(D,O){const U=[...D.amortizaciones||[],...C[D._id]],{tabla:J}=Z({...D,amortizaciones:U}),X=J.filter(st=>st.fecha<=O);if(X.length>0)return X[X.length-1].capitalPendiente;const pt=U.filter(st=>st.fecha<=O).reduce((st,mt)=>st+mt.cantidad,0);return Math.max(0,D.capital-pt)}function j(D){const O=t.map(nt=>({...nt,amortizaciones:[...nt.amortizaciones||[],...C[nt._id]||[]]})),U={...o,dashboardStart:A,dashboardEnd:D},J=n.statement({loans:O,expenses:e,accounts:a,config:U,filtroAccounts:null,nominas:c}),X=m.reduce((nt,Rt)=>nt+it(Rt),0),pt=y?it(y):0,st=X>0?pt/X:1;let mt=pt,Kt=X;for(const nt of J){const Rt=nt.delta??(nt.tipo==="ingreso"?Math.abs(nt.cuantia):-Math.abs(nt.cuantia));nt.cuenta===h?mt+=Rt:v.includes(nt.cuenta)||(mt+=Rt*st),Kt=nt.saldoAcum}return{source:mt,total:Kt}}function R(D){const{source:O}=j(D);if(O<=0)return O;let U=0;for(const J of M){const X=aa(J,e,o,t,D,!0,$);X>U&&(U=X)}return O-U}const N=2;let B=0;if(x){for(let D=0;D<p;D++)if(F(D).dia15>=x){B=D;break}}for(let D=0;D<p;D++){if((D-B)%i!==0||D<B)continue;const{label:O,dia15:U}=F(D);if(U<A)continue;const J=R(U)-N;if(J<u)continue;let X=J,pt=0;for(const st of w){if(X<u)break;const mt=T(st,U);if(mt<1)continue;const Kt=st.comisionAmort||0,nt=1+Kt/100,Rt=Math.floor(X/nt),so=Math.min(Rt,mt);if(so<u)continue;const Xt=Math.min(Math.floor(so),Math.floor(mt)),no=+(Xt*Kt/100).toFixed(2),Ra=Xt+no;Ra>X||(C[st._id].push({_id:`opt_${O}_${st._id}`,fecha:U,cantidad:Xt,tipo:r,simulacion:!0}),pt+=Ra,P.push({mes:O,fechaAmort:U,loanId:st._id,loanNombre:st.nombre,tin:st.tin,capitalAntes:mt,cantidadAmort:Xt,comision:no,capitalDespues:Math.max(0,mt-Xt),saldoDisponible:J+N,excedente:J,saldoDespues:J+N-pt,tipoAmort:r}),X-=Ra)}}const G=P.reduce((D,O)=>D+O.cantidadAmort,0),k=P.reduce((D,O)=>D+O.comision,0),H=w.map(D=>{const O=C[D._id];if(!O.length)return null;const U=Z(D),J=Z({...D,amortizaciones:[...D.amortizaciones||[],...O]});return{loanId:D._id,nombre:D.nombre,tin:D.tin,fechaFinSin:U.fechaFin,fechaFinCon:J.fechaFin,mesesAhorrados:U.mesesReales-J.mesesReales,interesesSin:U.totalIntereses,interesesCon:J.totalIntereses,ahorroIntereses:U.totalIntereses-J.totalIntereses,numAmortizaciones:O.length,totalAmortizado:O.reduce((X,pt)=>X+pt.cantidad,0)}}).filter(D=>D!==null),Q=H.reduce((D,O)=>D+O.ahorroIntereses,0);return{plan:P,margenesAplicados:M.length,totalAmortizado:G,totalComisiones:k,totalAhorroIntereses:Q,resumenPorLoan:H}}function he(t,e,a,o,s={},n){ge("comparador-frecuencias","comparar frecuencias de amortización");const{horizonte:i=60,minAmortizable:d=500,tipoAmort:u="plazo",fechaObjetivo:r=null,frecuencias:x=[1,2,3,6,12],fechaPrimeraAmort:f=null,loanIds:c=null,nominas:b=be,sourceAccountId:g=null,selectedMarginIds:$=null,hoy:A=new Date}=s,p=n??ya(),m=L(A),v=r||L(new Date(A.getFullYear(),A.getMonth()+i,1));function I(w){const S=t.map(F=>({...F,amortizaciones:[...F.amortizaciones||[],...w[F._id]||[]]})),M={...o,dashboardStart:m,dashboardEnd:v},C=p.statement({loans:S,expenses:e,accounts:a,config:M,filtroAccounts:null,nominas:b});if(C.length===0)return a.filter(F=>F.activo).reduce((F,T)=>F+it(T),0);const P=C.filter(F=>F.fecha<=v);return P.length>0?P[P.length-1].saldoAcum:C[0].saldoAcum}const y=I({}),h=x.map(w=>{const S=xa(t,e,a,o,{frecuencia:w,mesesHorizonte:i,minAmortizable:d,tipoAmort:u,fechaPrimeraAmort:f,loanIds:c,nominas:b,sourceAccountId:g,selectedMarginIds:$,hoy:A},p),M={};for(const P of t)M[P._id]=[];for(const P of S.plan)M[P.loanId].push({_id:P.mes+"_"+P.loanId,fecha:P.fechaAmort,cantidad:P.cantidadAmort,tipo:u,simulacion:!0});const C=I(M);return{frecuencia:w,label:w===1?"Mensual":`Cada ${w} meses`,numAmortizaciones:S.plan.length,totalAmortizado:S.totalAmortizado,totalComisiones:S.totalComisiones,ahorroIntereses:S.totalAhorroIntereses,saldoObjetivo:C,gananciaSaldo:C-y,valorTotal:S.totalAhorroIntereses+(C-y),plan:S.plan,resumenPorLoan:S.resumenPorLoan}}).filter(w=>w.numAmortizaciones>0);if(h.length>0){const w=Math.max(...h.map(C=>C.ahorroIntereses)),S=Math.max(...h.map(C=>C.saldoObjetivo)),M=Math.max(...h.map(C=>C.valorTotal));h.forEach(C=>{C.esMejorIntereses=C.ahorroIntereses===w,C.esMejorSaldo=C.saldoObjetivo===S,C.esMejorValor=C.valorTotal===M})}return{resultados:h,saldoBase:y,fechaObjetivo:v}}const Do=Object.freeze(Object.defineProperty({__proto__:null,compararFrecuencias:he,createStatementMemo:ya,defaultHoyISO:V,optimizarAmortizaciones:xa},Symbol.toStringTag,{value:"Module"})),Ro=30.44*864e5;function ye(t){const e=t.getFullYear(),a=t.getMonth();return{desde:L(new Date(e,a,1)),hasta:L(new Date(e,a,ia(e,a)))}}function xe(t){const[e,a]=t.split("-").map(Number);return ye(new Date(e,a-1,1))}function No(t,e){return Math.max(1,(q(e).getTime()-q(t).getTime())/Ro)}const qo=t=>t.filter(e=>e.sourceType!=="transfer-out"&&e.sourceType!=="transfer-in"),$t=t=>t.reduce((e,a)=>e+Math.abs(a.cuantia),0);function Lo(t,e){const a=new Map(e.map(n=>[n._id,n.clasificacion]));let o=0,s=0;for(const n of t){if(n.tipo!=="gasto"||n.sourceType!=="expense")continue;const i=a.get(n.sourceId??"");i!==null&&(i==="deseo"?s+=Math.abs(n.cuantia):o+=Math.abs(n.cuantia))}return{basicos:o,deseo:s}}function ko(t,e){const a=e.entreMeses&&e.entreMeses>0?e.entreMeses:1,o=c=>c.sourceType==="loan"&&c.tipo==="gasto",s=e.loanIdsIniciados,n=$t(t.filter(c=>c.tipo==="ingreso")),i=$t(t.filter(c=>o(c)&&(!s||s.has(c.sourceId??"")))),d=$t(t.filter(c=>o(c)&&e.hipotecaIds.has(c.sourceId??""))),u=$t(t.filter(c=>c.sourceType==="loan-amort")),r=$t(t.filter(c=>c.sourceType==="account-interest")),{basicos:x,deseo:f}=Lo(t,e.expenses);return{ingresos:n/a,cuotas:i/a,cuotasHipoteca:d/a,amortizaciones:u/a,gastosBasicos:x/a,gastosDeseo:f/a,gastosTotales:(i+x+f)/a,intereses:r/a}}function $e(t,e){return t.reduce((a,o)=>{const s=Z(o).tabla.filter(n=>!n.esAmortizacion&&n.fecha<=e);return a+(s.length>0?s[s.length-1].capitalPendiente:o.capital||0)},0)}function Oo(t,e,a,o){const s=t.filter(r=>r.activo&&!r.simulacion&&(r.fechaInicio||"")<=a),n=s.reduce((r,x)=>{if((x.amortizaciones||[]).filter(g=>g.fecha>=e&&g.fecha<=a).length===0)return r;const c=Z(x).totalIntereses,b=Z({...x,amortizaciones:(x.amortizaciones||[]).filter(g=>g.fecha<e||g.fecha>a)}).totalIntereses;return r+Math.max(0,b-c)},0),i=s.filter(r=>r.mostrarFechaFinEnDashboard!==!1).map(r=>({loan:r,fechaFin:Z(r).fechaFin})).filter(r=>!!r.fechaFin&&r.fechaFin>=e&&r.fechaFin<=a),d=s.map(r=>Z(r).tabla),u=r=>{const{desde:x,hasta:f}=xe(r);return d.reduce((c,b)=>{const g=b.find($=>!$.esAmortizacion&&$.fecha>=x&&$.fecha<=f);return c+(g?g.cuota:0)},0)};return{deudaInicio:$e(s,e),deudaFin:$e(s,a),ahorroIntereses:n,ahorroInteresesMes:o>0?n/o:0,cuotasInicio:u(e.slice(0,7)),cuotasFin:u(a.slice(0,7)),finEnPeriodo:i}}function Bo(t,e){return e.filter(a=>a.activo&&(a.interes??0)>0).map(a=>({nombre:a.nombre,interes:a.interes,total:$t(t.filter(o=>o.sourceType==="account-interest"&&o.sourceId===a._id))})).filter(a=>a.total>0).sort((a,o)=>o.total-a.total)}function Ie(t,e=new Set,a="desglosado"){if(e.size===0)return pe(t,"gasto");const o=new Map;for(const s of t){if(s.tipo!=="gasto")continue;const n=s.tags||[],i=n.filter(r=>e.has(r)),d=n.filter(r=>!e.has(r)),u=a==="porgrupos"&&i.length>0?i:d;for(const r of u)o.set(r,(o.get(r)||0)+Math.abs(s.cuantia))}return o}function Ho(t,e={}){const a=e.activos,o=e.entreMeses&&e.entreMeses>0?e.entreMeses:1;return[...Ie(t,e.grupoTags,e.modo).entries()].filter(([s])=>!a||a.size===0||a.has(s)).map(([s,n])=>({tag:s,total:n/o})).sort((s,n)=>n.total-s.total)}function Go(t,e){const a=e.reduce((o,s)=>o+it(s),0);return{saldoBase:a,saldoFinal:t.length>0?t[t.length-1].saldoAcum??a:a,totalGastos:$t(t.filter(o=>o.tipo==="gasto")),totalIngresos:$t(t.filter(o=>o.tipo==="ingreso")),tags:[...new Set(t.flatMap(o=>o.tags||[]))]}}function Vo(t,e){return t.filter(a=>a.activo&&(!e||e.length===0||e.includes(a._id)))}function Uo(t,e="hipoteca"){return new Set(t.filter(a=>(a.tags||[]).includes(e)).map(a=>a._id))}function Yo(t,e){return new Set(t.filter(a=>(a.fechaInicio||"")<=e).map(a=>a._id))}function Wo(t,e){if(t.length===0)return[];const a=r=>e==="mes"?r.slice(0,7):r.slice(0,4),o=r=>e==="mes"?`${r}-01`:`${r}-01-01`,s=t[0],n=s.delta??(s.tipo==="ingreso"?Math.abs(s.cuantia):-Math.abs(s.cuantia));let i=(s.saldoAcum??0)-n;const d=[];let u=null;for(const r of t){const x=a(r.fecha),f=r.saldoAcum??i;(!u||u.periodo!==x)&&(u&&(i=u.cierre),u={periodo:x,inicio:o(x),apertura:i,cierre:f,maximo:Math.max(i,f),minimo:Math.min(i,f),eventos:0},d.push(u)),u.cierre=f,f>u.maximo&&(u.maximo=f),f<u.minimo&&(u.minimo=f),u.eventos+=1}return d}const Jo=Object.freeze(Object.defineProperty({__proto__:null,agruparOHLC:Wo,cuentasVisibles:Vo,gastoPorTagOrdenado:Ho,idsHipoteca:Uo,idsPrestamosIniciados:Yo,interesesPorCuenta:Bo,mesesDelPeriodo:No,metricasFlujo:ko,rangoMes:xe,rangoMesDe:ye,resumenPrestamosPeriodo:Oo,sinTransferencias:qo,sumarGastosPorTag:Ie,totalesPeriodo:Go},Symbol.toStringTag,{value:"Module"}));function Ko(t,e,a){const o=t||[];if(!o.length)return e;const s=o.find(i=>i.año===a);if(s)return s.tramos;const n=o.filter(i=>i.año<a).sort((i,d)=>d.año-i.año);return n.length?n[0].tramos:e}function vt(t,e){return a=>Ko(t,e,a)}const Ht=7,Ae=[[0,19],[12450,24],[20200,30],[35200,37],[6e4,45],[3e5,47]],we=[[0,19],[6e3,21],[5e4,23],[2e5,27],[3e5,28]];function $a(t){return{_id:"default",nombre:"Default",descripcion:"Cuenta principal",saldo:0,saldoInicial:0,fechaInicialSaldo:t,historicoSaldos:[],interes:0,periodoCobro:"mensual",activo:!0,simulacion:!1,esCuentaPrincipal:!0,modeloFondo:"cuenta",aportaciones:[],planAportaciones:[],escenarioIds:[]}}function Se(t,e){return{dashboardStart:t,dashboardEnd:e,fechaReferencia:t,colchonMeses:6,colchonTipo:"meses",colchonFijo:0,colchonPuntos:[],showColchon:!0,margenesSeguridad:[],usarInflacion:!1,tramos_irpf:Ae,tramosGananciasCapital:we,showExecSummary:!0,showCriticos:!0,showHistorico:!0,histCuenta:"",analisisCollapsed:!1,activeTagsFilter:[],tagCategorias:[],tagGrupos:[],saludUmbralAhorroVerde:20,saludUmbralAhorroAmarillo:10,saludUmbralDTIVerde:30,saludUmbralDTIAmarillo:40,saludRegla:[50,30,20],saludExcluirHipoteca:!1,saludTagHipoteca:"hipoteca",storageMode:"local",autoSave:!1,autoSaveInterval:15,autoLogoutMinutos:0,onboardingDone:!1,escenarioActivo:null,features:{}}}function Xo(t,e){return{loans:[],expenses:[],accounts:[$a(t)],nominas:[],goals:[],transacciones:[],puntosControl:[],inflacion:[],tramosIRPFHistorico:[],tramosGananciasCapitalHistorico:[],escenarios:[],config:Se(t,e)}}const gt=t=>Array.isArray(t)?t:[],Qo=t=>t&&typeof t=="object"&&!Array.isArray(t)?t:{};function Gt(t){if(Array.isArray(t.escenarioIds))return t;const e=t.escenarioId?[t.escenarioId]:[],{escenarioId:a,...o}=t;return{...o,escenarioIds:e}}function Me(t){if(!t||typeof t!="string")return"";if(t.startsWith("dia:")||t.startsWith("nthweekday:"))return t;if(t==="ultimo")return"dia:ultimo";if(t==="primer-lunes")return"nthweekday:1:1";const e=parseInt(t);return isNaN(e)?"":`dia:${e}`}function Ia(t){const{varianza:e,inflacion:a,...o}=t;return o}function Zo(t,e){const{hoyISO:a,finISO:o}=e,s={...t},n=Qo(t.config),d={...Se(a,o)};for(const[x,f]of Object.entries(n))f!=null&&(d[x]=f);delete d.saldoInicial,delete d.saldoInicialFecha,delete d.inflacionGlobal,delete d.showMC,delete d.mcIteraciones,(!Array.isArray(d.tramos_irpf)||d.tramos_irpf.length===0)&&(d.tramos_irpf=Ae),(!Array.isArray(d.tramosGananciasCapital)||d.tramosGananciasCapital.length===0)&&(d.tramosGananciasCapital=we),(!Array.isArray(d.saludRegla)||d.saludRegla.length!==3)&&(d.saludRegla=[50,30,20]),(typeof d.features!="object"||d.features===null||Array.isArray(d.features))&&(d.features={}),s.config=d;let u=gt(t.accounts).map(x=>{const f={saldoInicial:0,fechaInicialSaldo:a,historicoSaldos:[],interes:0,periodoCobro:"mensual",activo:!0,simulacion:!1,esCuentaPrincipal:!1,aportaciones:[],planAportaciones:[],bloqueoMeses:120,impuestoRetirada:0,grupoNomina:"",...x};return f.modeloFondo||(f.modeloFondo=f.esFondoPension?"pension":"cuenta"),delete f.esFondoPension,Array.isArray(f.historicoSaldos)||(f.historicoSaldos=[]),Gt(f)});u.length===0&&(u=[$a(a)]);const r=u.filter(x=>x.esCuentaPrincipal);if(r.length===0){const x=u.find(f=>f._id==="default")||u[0];u=u.map(f=>({...f,esCuentaPrincipal:f._id===x._id}))}else if(r.length>1){let x=!1;u=u.map(f=>f.esCuentaPrincipal?x?{...f,esCuentaPrincipal:!1}:(x=!0,f):f)}return s.accounts=u,s.expenses=gt(t.expenses).map(x=>{const f={basico:!1,activo:!0,tags:[],historialPrecios:[],...x};return Array.isArray(f.tags)||(f.tags=[]),Array.isArray(f.historialPrecios)||(f.historialPrecios=[]),f.diaPago=Me(f.diaPago),Ia(Gt(f))}),s.loans=gt(t.loans).map(x=>{const f={tipoTasa:"fijo",mostrarFechaFinEnDashboard:!0,basico:!0,tags:[],activo:!0,amortizaciones:[],...x};return Array.isArray(f.tags)||(f.tags=[]),f.diaPago=Me(f.diaPago),f.amortizaciones=gt(f.amortizaciones).map(c=>Gt(c)),Ia(Gt(f))}),s.nominas=gt(t.nominas).map(x=>{const f={activo:!0,nPagas:12,irpfModo:"auto",irpfPct:0,bruto:0,representacion:"detallado",tags:[],fechaFin:null,cuenta:"default",grupoNomina:"",mesActualizacionIPC:null,retribucionFlexible:[],...x};return Array.isArray(f.tags)||(f.tags=[]),Array.isArray(f.retribucionFlexible)||(f.retribucionFlexible=[]),Ia(Gt(f))}),s.goals=gt(t.goals).map((x,f)=>{const c=Array.isArray(x.cuentaIds)?x.cuentaIds:x.cuentaId?[x.cuentaId]:[],{cuentaId:b,...g}=x;return{prioridad:f+1,completado:!1,usarColchon:!0,targetAmount:0,...g,cuentaIds:c}}),s.inflacion=gt(t.inflacion),s.tramosIRPFHistorico=gt(t.tramosIRPFHistorico),s.tramosGananciasCapitalHistorico=gt(t.tramosGananciasCapitalHistorico),s.escenarios=gt(t.escenarios).map(({inversiones:x,...f})=>f),s}const Tt=t=>Array.isArray(t)?t:[];let Aa=0;function ts(t){return Aa+=1,`${t}_${Aa.toString(36)}`}const as=t=>typeof t=="string"&&/^\d{4}-\d{2}-\d{2}$/.test(t),es=t=>typeof t=="number"&&Number.isFinite(t);function os(t,e){const a={...t};Aa=0;const o=Tt(t.transacciones),s=Tt(t.puntosControl),n=[...s],i=new Set(s.map(r=>`${r.cuentaId}|${r.fecha}`)),d=(r,x,f,c)=>{if(!as(x)||!es(f))return;const b=`${r}|${x}`;i.has(b)||(i.add(b),n.push({_id:ts("pc"),fecha:x,cuentaId:r,saldoCts:At(f),...typeof c=="string"&&c?{nota:c}:{}}))};for(const r of Tt(t.accounts)){const x=typeof r._id=="string"?r._id:null;if(x)for(const f of Tt(r.historicoSaldos))d(x,f.fecha,f.saldo,f.nota)}const u=Tt(t.history);if(u.length>0){const r=Tt(t.accounts),x=r.find(c=>c.esCuentaPrincipal)||r.find(c=>c.activo)||r[0],f=typeof(x==null?void 0:x._id)=="string"?x._id:"default";for(const c of u){const b=typeof c.cuenta=="string"?c.cuenta:typeof c.cuentaId=="string"?c.cuentaId:f;d(b,c.fecha,c.saldo,c.nota)}}return delete a.history,a.transacciones=o,a.puntosControl=n.sort((r,x)=>String(r.fecha).localeCompare(String(x.fecha))),a}const wa=t=>Array.isArray(t)?t:[],ss=t=>typeof t=="string"&&/^\d{4}-\d{2}-\d{2}$/.test(t),ns=t=>typeof t=="number"&&Number.isFinite(t)&&t>0;let Sa=0;function is(){return Sa+=1,`tx_hp_${Sa.toString(36)}`}function rs(t,e){const a={...t};Sa=0;const o=[...wa(t.transacciones)],s=new Set(o.map(i=>`${i.estimacionId}|${i.fecha}|${i.importeCts}`)),n=wa(t.expenses).map(i=>{const d=wa(i.historialPrecios),u=typeof i._id=="string"?i._id:null,r=typeof i.cuenta=="string"&&i.cuenta?i.cuenta:"default",x=i.tipo==="ingreso"?"ingreso":"gasto",f=Array.isArray(i.tags)?i.tags.filter(g=>typeof g=="string"):[];if(u)for(const g of d){if(!g||!ss(g.fecha)||!ns(g.cuantia))continue;const $=x==="ingreso"?At(g.cuantia):-At(g.cuantia),A=`${u}|${g.fecha}|${$}`;s.has(A)||(s.add(A),o.push({_id:is(),fecha:g.fecha,cuentaId:r,importeCts:$,concepto:typeof i.concepto=="string"?i.concepto:"Movimiento",tags:f,estimacionId:u,tipo:x,origen:"importado",nota:typeof g.nota=="string"&&g.nota?g.nota:"Importado del historial de precios"}))}const{historialPrecios:c,...b}=i;return b});return a.expenses=n,a.transacciones=o.sort((i,d)=>String(i.fecha).localeCompare(String(d.fecha))),a}const cs=[{version:5,describe:"Formaliza el esquema; limpia restos de features eliminadas; añade config.features",migrate:Zo},{version:6,describe:"Contabilidad real: crea transacciones y puntosControl (importa historicoSaldos y la clave history)",migrate:os},{version:7,describe:"Retira historialPrecios: cada entrada pasa a ser una transacción real enlazada a su estimación",migrate:rs}],ls=["history"];function Ce(t,e,a){let o=t;const s=[];for(const n of[...cs].sort((i,d)=>i.version-d.version))(e??0)>=n.version||(o=n.migrate(o,a),s.push(n.version));return{state:o,applied:s}}const ea="state_",Ma="state__schemaVersion",ze="financeapp_",Fe="state__modificadoEn";function ds(t=localStorage,e=ze){const a=o=>`${e}${o}`;return{get(o){try{const s=t.getItem(a(o));return s===null?null:JSON.parse(s)}catch{return null}},set(o,s){try{t.setItem(a(o),JSON.stringify(s)),o!==Fe&&t.setItem(a(Fe),JSON.stringify(Date.now()))}catch(n){console.error("No se pudo guardar en localStorage:",o,n)}},remove(o){try{t.removeItem(a(o))}catch{}},keys(){const o=[];for(let s=0;s<t.length;s++){const n=t.key(s);n!=null&&n.startsWith(e)&&o.push(n.slice(e.length))}return o}}}function us(t=localStorage,e=ze){const a=[];for(let s=0;s<t.length;s++){const n=t.key(s);n!=null&&n.startsWith(ea)&&!n.startsWith(e)&&a.push(n)}const o=[];for(const s of a)try{const n=t.getItem(s);n!==null&&t.getItem(`${e}${s}`)===null&&(t.setItem(`${e}${s}`,n),o.push(s)),t.removeItem(s)}catch{}return o}function ps(t){return L(new Date(t.getFullYear()+1,t.getMonth(),t.getDate()))}function ms({adapter:t,hoy:e=new Date}){const a=L(e),o=ps(e);let s=Xo(a,o);const n=new Set;let i=[];function d(M){for(const C of n)C(M)}function u(M){t.set(`${ea}${M}`,s[M])}function r(){const M={};for(const T of Object.keys(s)){const j=t.get(`${ea}${T}`);j!==null&&(M[T]=j)}for(const T of ls){const j=t.get(`${ea}${T}`);j!==null&&(M[T]=j)}const C=t.get(Ma),{state:P,applied:F}=Ce(M,C,{hoyISO:a,finISO:o});if(s=P,x(),F.length>0){for(const T of Object.keys(s))u(T);t.set(Ma,Ht)}return i=F,{applied:F}}function x(){if(!Array.isArray(s.accounts)||s.accounts.length===0){s.accounts=[$a(a)],u("accounts");return}const M=s.accounts.filter(C=>C.esCuentaPrincipal);if(M.length===0)s.accounts=s.accounts.map((C,P)=>P===0?{...C,esCuentaPrincipal:!0}:C),u("accounts");else if(M.length>1){let C=!1;s.accounts=s.accounts.map(P=>P.esCuentaPrincipal?C?{...P,esCuentaPrincipal:!1}:(C=!0,P):P),u("accounts")}}function f(M){return s[M]}function c(M,C){s[M]=C,u(M),d(M)}function b(M){c("config",{...s.config,...M})}function g(M){return n.add(M),()=>n.delete(M)}function $(){return Date.now().toString(36)+Math.random().toString(36).slice(2,7)}function A(M,C){const P=[...s[M]],F={...C,_id:$()};return P.push(F),c(M,P),F}function p(M,C,P){const F=s[M].map(T=>T._id===C?{...T,...P}:T);c(M,F)}function m(M,C){const P=s[M].filter(F=>F._id!==C);c(M,P)}function v(){const M=s.accounts||[],C=M.find(P=>P.esCuentaPrincipal&&P.activo)||M.find(P=>P.activo);return C?C._id:"default"}function I(M){var C;return((C=s.accounts.find(P=>P._id===M))==null?void 0:C.nombre)??M}function y(){return vt(s.tramosIRPFHistorico,s.config.tramos_irpf)}function h(){return vt(s.tramosGananciasCapitalHistorico,s.config.tramosGananciasCapital)}function w(){return structuredClone(s)}function S(M,C=null){const{state:P,applied:F}=Ce(M,C,{hoyISO:a,finISO:o});s=P,x();for(const T of Object.keys(s))u(T);t.set(Ma,Ht);for(const T of Object.keys(s))d(T);return{applied:F}}return{load:r,get:f,set:c,patchConfig:b,subscribe:g,addItem:A,updateItem:p,removeItem:m,getPrincipalAccountId:v,accountName:I,resolverTramosIRPF:y,resolverTramosGanancias:h,snapshot:w,replaceAll:S,get schemaVersion(){return Ht},get migrationsApplied(){return[...i]},get today(){return a||V()}}}const W={nucleo:"Esenciales",dinero:"Mi dinero",planificacion:"Planificación",analisis:"Análisis del dashboard",datos:"Datos y sincronización"},It=[{id:"dashboard",nombre:"Dashboard",descripcion:"Saldo actual, extracto proyectado y evolución. No se puede desactivar.",grupo:W.nucleo,porDefecto:!0,nucleo:!0},{id:"expenses",nombre:"Gastos e ingresos",descripcion:"Estimaciones recurrentes y extraordinarias, transferencias entre cuentas y etiquetas.",grupo:W.dinero,porDefecto:!0},{id:"loans",nombre:"Préstamos",descripcion:"Tablas de amortización, TAE y amortizaciones anticipadas.",grupo:W.dinero,porDefecto:!0},{id:"nominas",nombre:"Nóminas",descripcion:"Salarios con IRPF por tramos, pagas extra y retribución flexible.",grupo:W.dinero,porDefecto:!0},{id:"accounts",nombre:"Cuentas y ahorro",descripcion:"Cuentas, fondos de inversión, planes de pensiones y puntos de control de saldo.",grupo:W.dinero,porDefecto:!0},{id:"goals",nombre:"Objetivos de ahorro",descripcion:"Metas con importe y fecha, con proyección de cumplimiento.",grupo:W.dinero,porDefecto:!0,dependencias:["accounts"]},{id:"contabilidad",nombre:"Contabilidad real",descripcion:"Registro de gastos e ingresos reales y análisis de precisión de las estimaciones.",grupo:W.dinero,porDefecto:!0,dependencias:["accounts"]},{id:"supuestos",nombre:"Supuestos",descripcion:"Puntos de guardado sobre los que probar cambios, con biblioteca revisitable.",grupo:W.planificacion,porDefecto:!0},{id:"inflacion",nombre:"Inflación",descripcion:"Tasas anuales de IPC que encarecen los gastos y erosionan el ahorro.",grupo:W.planificacion,porDefecto:!1},{id:"fiscalidad",nombre:"Fiscalidad",descripcion:"Simulador de la declaración de la renta y tablas de tramos por ejercicio.",grupo:W.planificacion,porDefecto:!1},{id:"margenes",nombre:"Márgenes de seguridad",descripcion:"Umbrales mínimos de saldo por cuenta, con avisos al cruzarlos.",grupo:W.planificacion,porDefecto:!1},{id:"optimizador",nombre:"Optimizador de amortizaciones",descripcion:"Planifica amortizaciones anticipadas con el excedente disponible cada mes.",grupo:W.planificacion,porDefecto:!1,dependencias:["loans"]},{id:"comparador-frecuencias",nombre:"Comparador de frecuencias",descripcion:"Compara amortizar cada mes, cada trimestre, etc. por ahorro de intereses.",grupo:W.planificacion,porDefecto:!1,dependencias:["optimizador"]},{id:"resumen-ejecutivo",nombre:"Resumen ejecutivo",descripcion:"Titulares del periodo: ingresos, gastos, ahorro y saldo final estimado.",grupo:W.analisis,porDefecto:!0},{id:"velas-saldo",nombre:"Velas del saldo",descripcion:"Apertura, cierre, máximo y mínimo del saldo por mes o por año.",grupo:W.analisis,porDefecto:!0},{id:"graficos-etiquetas",nombre:"Gráficos por etiqueta",descripcion:"Reparto y media mensual del gasto por etiqueta, con grupos de etiquetas.",grupo:W.analisis,porDefecto:!0},{id:"puntos-criticos",nombre:"Puntos críticos",descripcion:"Avisos de saldo negativo o por debajo del colchón en la proyección.",grupo:W.analisis,porDefecto:!0},{id:"precision-estimaciones",nombre:"Precisión de estimaciones",descripcion:"Acierto de cada estimación frente al gasto real, con ajuste sugerido.",grupo:W.analisis,porDefecto:!0,dependencias:["contabilidad","expenses"]},{id:"sync-nube",nombre:"Sincronización en la nube",descripcion:"Copia cifrada en Firebase o Dropbox, además del almacenamiento local.",grupo:W.datos,porDefecto:!0},{id:"autoguardado",nombre:"Autoguardado",descripcion:"Sube una copia a la nube cada cierto intervalo automáticamente.",grupo:W.datos,porDefecto:!1,dependencias:["sync-nube"]}],fs=new Map(It.map(t=>[t.id,t]));function Vt(t){return fs.get(t)}function Pe(t){return It.filter(e=>(e.dependencias||[]).includes(t))}function Ca(){const t={};for(const e of It)t[e.id]=e.porDefecto;return t}function Te(){const t=[],e=new Map;for(const a of It)e.has(a.grupo)||(e.set(a.grupo,[]),t.push(a.grupo)),e.get(a.grupo).push(a);return t.map(a=>({grupo:a,features:e.get(a)}))}function vs(t){function e(){return{...Ca(),...t.get("config").features||{}}}function a(f){t.patchConfig({features:f})}function o(f,c=e(),b=new Set){const g=Vt(f);if(!g)return!1;if(g.nucleo)return!0;if(c[f]===!1)return!1;if(b.has(f))return!0;b.add(f);for(const $ of g.dependencias||[])if(!o($,c,b))return!1;return!0}function s(f,c=e()){const b=Vt(f);return b?(b.dependencias||[]).filter(g=>!o(g,c)):[]}function n(f,c){var v;const b=Vt(f);if(!b)return{cambiadas:[]};if(b.nucleo)return{cambiadas:[],motivo:"nucleo-inmutable"};const g=e(),$=new Map(It.map(I=>[I.id,o(I.id,g)])),A={...g,[f]:c};let p;if(c){const I=[...b.dependencias||[]];for(;I.length;){const y=I.pop();A[y]===!1&&(A[y]=!0,p="dependencias-activadas"),I.push(...((v=Vt(y))==null?void 0:v.dependencias)||[])}}else{const I=Pe(f).map(y=>y.id);for(;I.length;){const y=I.pop();A[y]!==!1&&(A[y]=!1,p="cascada-apagado"),I.push(...Pe(y).map(h=>h.id))}}return a(A),{cambiadas:It.filter(I=>o(I.id,A)!==$.get(I.id)).map(I=>I.id),motivo:p}}function i(){const f=e();return It.map(c=>{const b=s(c.id,f);return{...c,activa:o(c.id,f),...b.length>0&&f[c.id]!==!1?{bloqueadaPor:b}:{}}})}function d(){const f=e();return Te().map(({grupo:c,features:b})=>({grupo:c,features:b.map(g=>{const $=s(g.id,f);return{...g,activa:o(g.id,f),...$.length>0&&f[g.id]!==!1?{bloqueadaPor:$}:{}}})}))}function u(){a(Ca())}function r(f){return{_app:"financeapp",_tipo:"feature-profile",_v:1,...f?{nombre:f}:{},features:e()}}function x(f){const c=f,b=c&&typeof c=="object"&&c.features&&typeof c.features=="object"?c.features:null;if(!b)throw new Error('El perfil no tiene una sección "features" válida');const g=Ca(),$=[],A=[];for(const[p,m]of Object.entries(b)){if(!Vt(p)){A.push(p);continue}if(typeof m!="boolean"){A.push(p);continue}g[p]=m,$.push(p)}return a(g),{aplicadas:$,ignoradas:A}}return{isEnabled:f=>o(f),setEnabled:n,estado:i,estadoPorGrupo:d,reset:u,exportProfile:r,importProfile:x,bloqueadaPor:f=>s(f)}}const Ut=t=>t.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;");function _t(t,e,a="ok"){if(t.notify)return t.notify(e,a);const o=globalThis.UI;if(o!=null&&o.toast)return o.toast(e,a);console.info("[FinanceApp]",e)}function gs(t){var s,n;const a=(((s=t.bloqueadaPor)==null?void 0:s.length)??0)>0?`<div style="font-size:11px;color:var(--yellow);margin-top:3px">Requiere: ${(n=t.bloqueadaPor)==null?void 0:n.map(Ut).join(", ")}</div>`:"",o=t.nucleo?'<span style="font-size:10px;color:var(--text3);border:1px solid var(--border2);border-radius:3px;padding:1px 5px;margin-left:6px">siempre activa</span>':"";return`
    ...
    <input type="file" data-feature-file accept=".json" style="display:none"/>`}function hs(t){var s;const e=t.getElementById("modal-overlay"),a=t.getElementById("modal-content");if(e&&a)return{overlay:e,content:a,cerrar:()=>e.classList.add("hidden")};let o=t.getElementById("fa-features-overlay");return o||(o=t.createElement("div"),o.id="fa-features-overlay",o.className="modal-overlay",o.innerHTML='<div class="modal-box"><button class="modal-close" data-feature-close>×</button><div id="fa-features-content"></div></div>',t.body.appendChild(o),o.addEventListener("click",n=>{n.target===o&&(o==null||o.classList.add("hidden"))}),(s=o.querySelector("[data-feature-close]"))==null||s.addEventListener("click",()=>o==null?void 0:o.classList.add("hidden"))),{overlay:o,content:t.getElementById("fa-features-content"),cerrar:()=>o==null?void 0:o.classList.add("hidden")}}function ys(t){const e=t.document??document,{flags:a}=t;function o(i){i.innerHTML=`<div class="modal-title">Funcionalidades</div>${bs(a)}`,s(i)}function s(i){var u,r,x;i.querySelectorAll("[data-feature-toggle]").forEach(f=>{f.addEventListener("change",()=>{var g;const c=f.dataset.featureToggle,b=a.setEnabled(c,f.checked);b.motivo==="dependencias-activadas"&&_t(t,"Se han activado también las funcionalidades necesarias"),b.motivo==="cascada-apagado"&&_t(t,"Se han desactivado las funcionalidades que dependían de esta","warn"),(g=t.onChange)==null||g.call(t,b.cambiadas),o(i)})});const d=i.querySelector("[data-feature-file]");(u=i.querySelector('[data-feature-action="export"]'))==null||u.addEventListener("click",()=>{const f=a.exportProfile(),c=new Blob([JSON.stringify(f,null,2)],{type:"application/json"}),b=URL.createObjectURL(c),g=e.createElement("a");g.href=b,g.download=`financeapp-funcionalidades-${new Date().toISOString().slice(0,10)}.json`,g.click(),URL.revokeObjectURL(b),_t(t,"Perfil de funcionalidades guardado")}),(r=i.querySelector('[data-feature-action="import"]'))==null||r.addEventListener("click",()=>d==null?void 0:d.click()),d==null||d.addEventListener("change",async()=>{var c,b;const f=(c=d.files)==null?void 0:c[0];if(f)try{const{aplicadas:g,ignoradas:$}=a.importProfile(JSON.parse(await f.text()));_t(t,$.length>0?`Perfil cargado (${g.length} aplicadas, ${$.length} ignoradas por ser de otra versión)`:`Perfil cargado (${g.length} funcionalidades)`),(b=t.onChange)==null||b.call(t,g),o(i)}catch(g){_t(t,"No se pudo cargar el perfil: "+g.message,"err")}finally{d.value=""}}),(x=i.querySelector('[data-feature-action="reset"]'))==null||x.addEventListener("click",()=>{var f;a.reset(),_t(t,"Funcionalidades restablecidas"),(f=t.onChange)==null||f.call(t,[]),o(i)})}function n(){const i=hs(e);o(i.content),i.overlay.classList.remove("hidden")}return{open:n,renderInto:o}}const _e={expenses:"expenses",loans:"loans",nominas:"nominas",accounts:"accounts",supuestos:"escenarios",inflacion:"inflacion",fiscalidad:"rentas",margenes:"margenes"};function je(t,e){t.querySelectorAll("[data-feature]").forEach(a=>{const o=a.dataset.feature;if(!o)return;const s=e(o);a.style.display=s?"":"none",s?(a.removeAttribute("aria-hidden"),"disabled"in a&&(a.disabled=!1)):(a.setAttribute("aria-hidden","true"),"disabled"in a&&(a.disabled=!0))})}function xs({flags:t,document:e=document,router:a,rutasExtra:o}){function s(){const d=e.querySelector(".nav-btn.active[data-view]");return(d==null?void 0:d.dataset.view)??null}function n(){let d=!1;const u=Object.entries((o==null?void 0:o())??{}).map(([r,x])=>[x,r]);for(const[r,x]of[...Object.entries(_e),...u]){const f=t.isEnabled(r),c=e.querySelector(`.nav-btn[data-view="${x}"]`);c&&(c.style.display=f?"":"none"),!f&&s()===x&&(d=!0)}if(e.querySelectorAll(".nav-section").forEach(r=>{const x=[...r.querySelectorAll(".nav-btn[data-view]")];if(x.length===0)return;const f=x.some(c=>c.style.display!=="none");r.style.display=f?"":"none"}),je(e,r=>t.isEnabled(r)),d){const r=a??globalThis.Router;r==null||r.navigate("dashboard")}}function i(d=e.body){if(typeof MutationObserver>"u")return()=>{};let u=!1;const r=new MutationObserver(()=>{if(!u){u=!0;try{je(e,x=>t.isEnabled(x))}finally{u=!1}}});return r.observe(d,{childList:!0,subtree:!0}),()=>r.disconnect()}return{apply:n,observar:i,vistaPara:d=>_e[d]}}function $s({document:t=document,isEnabled:e}={}){const a=new Map;let o=null;function s(g){return`view-${g}`}function n(g){const $=t.getElementById(s(g.route));if($)return $;const A=t.querySelector(".view-container");if(!A)return null;const p=t.createElement("div");return p.id=s(g.route),p.className="view hidden",A.appendChild(p),p}function i(g){if(t.querySelector(`.nav-btn[data-view="${g.route}"]`))return;const $=t.querySelectorAll(".nav-section"),A=$[g.seccion??Math.max(0,$.length-1)];if(!A)return;const p=t.createElement("button");p.className="nav-btn",p.dataset.view=g.route,p.innerHTML=`${g.iconoPath?`<svg viewBox="0 0 24 24"><path d="${g.iconoPath}"/></svg>`:""}<span>${g.nombre}</span>`,A.appendChild(p),p.addEventListener("click",()=>{const m=globalThis.Router;m==null||m.navigate(g.route)})}function d(g){a.set(g.route,g),n(g),i(g)}function u(){return[...a.keys()].filter(g=>{const $=a.get(g);return!e||e($.flagId??$.id)})}function r(g){return u().includes(g)}function x(g){const $=a.get(g);if(!$||e&&!e($.flagId??$.id))return!1;const A=n($);if(!A)return!1;if(o&&o!==g){const p=a.get(o),m=t.getElementById(s(o));p!=null&&p.unmount&&m&&p.unmount(m)}return $.mount(A),o=g,!0}function f(){o&&x(o)}function c(){const g={};for(const[$,A]of a)g[$]=A.flagId??A.id;return g}function b(){for(const g of a.values())n(g),i(g)}return{register:d,routes:u,has:r,mount:x,rerender:f,flagPorRuta:c,attachToShell:b,get activa(){return o}}}function l(t){return String(t??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function jt(t){return`<span style="color:${t<0?"var(--red)":t>0?"var(--accent)":"var(--text2)"}">${l(z(t))}</span>`}function Ee(t){return t===null?'<span style="color:var(--text3);font-size:12px">sin datos</span>':`<span style="color:${t>=90?"var(--accent)":t>=70?"var(--yellow)":"var(--red)"};font-weight:600">${t.toFixed(1)}%</span>`}function De(t){return t.length===0?'<span style="color:var(--text3);font-size:11px">—</span>':t.map(e=>`<span class="tag">${l(e)}</span>`).join(" ")}const Is=["enero","febrero","marzo","abril","mayo","junio","julio","agosto","septiembre","octubre","noviembre","diciembre"];function As(t){const[e,a]=t.split("-").map(Number);return`${Is[a-1]} ${e}`}function E(t,e="ok"){const a=globalThis.UI;if(a!=null&&a.toast)return a.toast(t,e);console.info("[FinanceApp]",t)}function tt(t){const e=globalThis.UI;return e!=null&&e.confirm?e.confirm(t):typeof confirm=="function"?confirm(t):!0}function _(t,e,a){t.addEventListener("click",o=>{var n;const s=(n=o.target)==null?void 0:n.closest(e);s&&t.contains(s)&&a(s,o)})}function Y(t,e,a){t.addEventListener("change",o=>{var n;const s=(n=o.target)==null?void 0:n.closest(e);s&&t.contains(s)&&a(s,o)})}function ut(t,e){var a;return((a=t.querySelector(e))==null?void 0:a.value)??""}function Re(t,e){const a=parseFloat(ut(t,e));return Number.isFinite(a)?a:0}function ws(t){const[e,a]=t.split("-").map(Number),o=new Date(e,a,0).getDate();return{desde:`${t}-01`,hasta:`${t}-${String(o).padStart(2,"0")}`}}function Ss(t,e){const{ledger:a}=t,o=(t.hoy??V)(),s=t.accounts().filter(m=>m.activo),{desde:n,hasta:i}=ws(e.mes),d={cuentaId:e.cuentaId||void 0,desde:n,hasta:i,texto:e.filtroTexto||void 0},u=a.transacciones(d),r=t.estimaciones().filter(m=>m.tipo!=="transferencia"),x=u.filter(m=>m.importeCts<0).reduce((m,v)=>m+v.importeCts,0),f=u.filter(m=>m.importeCts>0).reduce((m,v)=>m+v.importeCts,0),c=e.cuentaId?a.saldoCuenta(e.cuentaId,i):a.saldoTotal(i),b=e.cuentaId?a.puntosControl(e.cuentaId):a.puntosControl(),g=s.map(m=>`<option value="${l(m._id)}"${m._id===e.cuentaId?" selected":""}>${l(m.nombre)}</option>`).join(""),$=m=>'<option value="">— sin asignar —</option>'+r.map(v=>`<option value="${l(v._id)}"${v._id===m?" selected":""}>${l(v.concepto)} (${l(z(v.cuantia))})</option>`).join(""),A=u.map(m=>{var v;return`
      <tr data-tx="${l(m._id)}" style="border-bottom:1px solid var(--border)">
        ...
        <td style="padding:7px 8px">${De(m.tags)}</td>
    ...
    <div class="grid-2 mb-14" style="align-items:start">
      ...
      </div>`;const n=a.map(({analisis:u,estimacion:r,sugerencia:x})=>{const f=u.meses.slice(-6).map(c=>`${As(c.mes)}: ${z(c.estimado)} → ${z(c.real)} (${c.precision.toFixed(0)}%)`).join(" · ");return`
      <tr style="border-bottom:1px solid var(--border)">
        <td style="padding:8px">
          <div style="font-size:13px;color:var(--text)">${l(r.concepto)}</div>
          <div style="margin-top:3px">${De(u.tags)}</div>
        ...
        <td style="padding:8px;text-align:right;white-space:nowrap">${Ee(u.precision)}</td>
      ...
      <tr style="border-bottom:1px solid var(--border)">
        ...
        <td style="padding:7px 8px;text-align:right">${Ee(u.precision)}</td>
    ...
    </div>`}function Fs(t,e,a){_(t,"[data-sugerir]",o=>{const s=o.dataset.sugerir,n=za(e).find(u=>u.analisis.estimacionId===s);if(!(n!=null&&n.sugerencia))return;const i=n.sugerencia,d=`${i.concepto}
...
¿Continuar?`))return;const{aplicadas:n,errores:i}=e.adjuster.aplicarTodas(o,{hoy:e.hoy()});E(i.length>0?`${n.length} ajustadas, ${i.length} con error`:`${n.length} estimaciones ajustadas`,i.length>0?"warn":"ok"),e.onDatosCambiados(),a()})}const Ps="M20 4H4c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 14H4V8h16v10zM6 10h5v2H6v-2zm0 4h8v2H6v-2z";function Ts(t){const e={cuentaId:"",mes:(t.hoy??V)().slice(0,7),filtroTexto:""},a=()=>{var d;return(d=t.onDatosCambiados)==null?void 0:d.call(t)},o=t.hoy??V,s={ledger:t.ledger,accounts:t.accounts,estimaciones:t.estimaciones,tagsConocidas:()=>t.tags.todas(),onDatosCambiados:a,hoy:o},n={precision:t.precision,adjuster:t.adjuster,estimaciones:t.estimaciones,onDatosCambiados:a,hoy:o};function i(d){const u=t.ledger.saldoTotal(o()),r=t.ledger.ultimaFecha(),x=t.ledger.transacciones().length;d.innerHTML=`
      ...
      <div id="acc-precision" data-feature="precision-estimaciones"></div>`;const f=d.querySelector("#acc-transacciones"),c=d.querySelector("#acc-precision");f.innerHTML=Ss(s,e),c.innerHTML=zs(n);const b=()=>i(d);Ms(f,s,e,b),Fs(c,n,b)}return{id:"contabilidad",route:"contabilidad",nombre:"Contabilidad",flagId:"contabilidad",seccion:1,iconoPath:Ps,mount:i}}const _s="M12 1L3 5v6c0 5.55 3.84 10.74 9 12 5.16-1.26 9-6.45 9-12V5l-9-4zm0 4l5 2.18V11c0 3.5-2.33 6.79-5 7.93-2.67-1.14-5-4.43-5-7.93V7.18L12 5z";function Fa(){return Date.now().toString(36)+Math.random().toString(36).slice(2,6)}function js(t){const{store:e}=t,a=t.hoy??V,o=()=>q(a()),s=()=>e.get("config").margenesSeguridad??[];function n(b){var g;e.patchConfig({margenesSeguridad:b}),(g=t.onDatosCambiados)==null||g.call(t)}function i(b,g){const $=s().map(p=>({...p,puntos:(p.puntos??[]).map(m=>({...m}))})),A=$.find(p=>p._id===b);A&&(g(A),n($))}function d(b){const g=e.get("config"),$=aa(b,e.get("expenses"),g,e.get("loans"),a(),!1,o());return z($)}function u(b,g,$){const A=g.tipo==="fijo",p=A?"":`<span class="text-sm" style="color:var(--text3)">${l(z((g.meses??0)*$))}</span>`;return`
      ...
      ${g.length===0?`<div class="card" style="padding:24px;text-align:center">
             ...
             </div>`:g.map(m=>r(m,$,A)).join("")}`;const p=()=>c(b);_(b,"[data-nuevo-margen]",()=>f(null,p)),_(b,"[data-editar-margen]",m=>f(m.getAttribute("data-editar-margen"),p)),_(b,"[data-borrar-margen]",m=>{tt("¿Eliminar este margen de seguridad?")&&(n(s().filter(v=>v._id!==m.getAttribute("data-borrar-margen"))),E("Margen eliminado"),p())}),Y(b,"[data-toggle-margen]",m=>{const v=m.getAttribute("data-toggle-margen");i(v,I=>{I.activo=m.checked}),p()}),_(b,"[data-add-punto]",m=>{const v=m.getAttribute("data-add-punto");i(v,I=>{I.puntos=[...I.puntos??[],{_id:Fa(),fecha:V(),tipo:"fijo",importe:0,meses:1}]}),p()}),_(b,"[data-borrar-punto]",m=>{const v=m.closest("[data-punto]");if(!v)return;const I=v.dataset.margen,y=v.dataset.punto;i(I,h=>{h.puntos=(h.puntos??[]).filter(w=>w._id!==y)}),p()}),Y(b,"[data-campo]",m=>{const v=m.closest("[data-punto]");if(!v)return;const I=m.getAttribute("data-campo"),y=m.value;i(v.dataset.margen,h=>{const w=(h.puntos??[]).find(S=>S._id===v.dataset.punto);w&&(I==="fecha"?w.fecha=y:I==="tipo"?w.tipo=y:I==="importe"?w.importe=parseFloat(y)||0:w.meses=parseFloat(y)||0)}),p()})}return{id:"margenes",route:"margenes",nombre:"Márgenes de seguridad",flagId:"margenes",seccion:2,iconoPath:_s,mount:c}}const Es="https://api.worldbank.org/v2/country/ES/indicator/FP.CPI.TOTL.ZG?format=json&mrv=65&per_page=65";function Ds(t){const e=Array.isArray(t)?t[1]??[]:[];return Array.isArray(e)?e.filter(a=>a&&a.value!==null&&a.value!==void 0&&Number.isFinite(Number(a.value))).map(a=>({year:parseInt(a.date),tasa:parseFloat(Number(a.value).toFixed(2))})).filter(a=>Number.isFinite(a.year)).sort((a,o)=>a.year-o.year):[]}function Rs({fetchImpl:t,url:e=Es}={}){let a=null,o=!1;async function s(n=!1){if(a&&!n)return a;if(o)return null;o=!0;try{const d=await(t??fetch)(e);if(!d.ok)throw new Error(`HTTP ${d.status}`);return a=Ds(await d.json()),a}catch(i){return console.error("[inflacion] No se pudo cargar el IPC del Banco Mundial:",i),null}finally{o=!1}}return{obtener:s,invalidar:()=>{a=null},get enCache(){return a}}}const Ns="M16 6l2.29 2.29-4.88 4.88-4-4L2 16.59 3.41 18l6-6 4 4 6.3-6.29L22 12V6z";function qs(t){return t>5?"var(--red)":t>2.5?"var(--yellow)":"var(--accent)"}function Ls(t){const{store:e}=t,a=t.ipc??Rs(),o=()=>e.get("inflacion")??[];function s(){var f;(f=t.onDatosCambiados)==null||f.call(t)}function n(f,c){if(!f||f.length===0)return`
        ...
        <div style="display:grid;grid-template-columns:20px 60px 80px 1fr;gap:10px;align-items:center;padding:5px 0;border-bottom:1px solid var(--border)">
          ...
          <span style="font-family:var(--font-mono);font-weight:600;color:${qs(m.tasa)}">${m.tasa.toFixed(2)}%</span>
      ...
      </div>`;const y=()=>x(f);Y(f,"[data-toggle-inflacion]",h=>{const w=h.checked;e.patchConfig({usarInflacion:w}),E(w?"Estimaciones de inflación activadas":"Estimaciones de inflación desactivadas"),s(),y()}),_(f,"[data-nuevo-periodo]",()=>u(null,y)),_(f,"[data-editar-periodo]",h=>u(h.getAttribute("data-editar-periodo"),y)),_(f,"[data-importar-ipc]",()=>void d(y)),_(f,"[data-borrar-periodo]",h=>{tt("¿Eliminar este periodo de inflación?")&&(e.removeItem("inflacion",h.getAttribute("data-borrar-periodo")),E("Periodo eliminado"),s(),y())})}return{id:"inflacion",route:"inflacion",nombre:"Inflación",flagId:"inflacion",seccion:2,iconoPath:Ns,mount:x}}const ks=[...Array.from({length:31},(t,e)=>String(e+1)),"ultimo"],Os=[["1","1º"],["2","2º"],["3","3º"],["4","4º"],["5","5º"],["-1","Último"]],Bs=[["1","lunes"],["2","martes"],["3","miércoles"],["4","jueves"],["5","viernes"],["6","sábado"],["0","domingo"]];function Hs(t){const e=t||"";if(e.startsWith("dia:"))return{modo:"dia",dia:e.slice(4)||"1",nth:"1",wd:"1"};if(e.startsWith("nthweekday:")){const[,a="1",o="1"]=e.split(":");return{modo:"nthweekday",dia:"1",nth:a,wd:o}}return{modo:"none",dia:"1",nth:"1",wd:"1"}}const Pa=(t,e)=>t.map(([a,o])=>`<option value="${l(a)}"${a===e?" selected":""}>${l(o)}</option>`).join("");function qe(t,e="dp"){const{modo:a,dia:o,nth:s,wd:n}=Hs(t),i=Pa(ks.map(d=>[d,d==="ultimo"?"Último día":d]),o);return`<div class="form-group" data-diapago="${l(e)}">
    ...
    <div class="flex gap-8 items-center" style="flex-wrap:wrap;row-gap:6px">
      ...
      <div class="grid-3 mt-8">
        ...
        <div class="form-group"><label class="form-label">Tipo frecuencia</label>
          <select class="form-select" id="ef-tipo-frec">
            ${Vs.map(([h,w])=>`<option value="${h}"${((p==null?void 0:p.tipoFrecuencia)??"mensual")===h?" selected":""}>${l(w)}</option>`).join("")}
          </select>
        </div>
      </div>
      ...
      <details class="form-advanced mt-12"${p!=null&&p._id?" open":""}>
        ...
        <div class="form-advanced-body">
          ...
          <div class="mt-8">${qe(p==null?void 0:p.diaPago,"exp")}</div>
    ...
    <div class="loan-card-body" data-body-loan="${l(t._id)}">
      ...
      <div class="grid-4 mb-12">
        ${Ta("Cuota mensual",l(z(a.cuota)),e.cuotaMes>0?`<div class="stat-sub" style="color:var(--accent)">Este mes: ${l(z(e.cuotaMes))}</div>`:"")}
        ${Ta("Total intereses",l(z(a.totalIntereses)),o?`<div class="stat-sub" style="text-decoration:line-through;color:var(--text3)" title="Sin amortizaciones">${l(z(a.sinAmort.totalIntereses))}</div>`:"","neg")}
        <div class="stat-card">
        ...
        ${Ta("Total pagado",l(z(a.totalPagado)),t.capital?`<div class="stat-sub">Capital: ${l(z(t.capital))}</div>`:"","neg")}
      </div>

      <div class="grid-2 mb-12" style="gap:10px">
        <div class="stat-card" style="display:flex;gap:16px;align-items:center;flex-wrap:wrap">
          <div><div class="stat-label">TAE</div><div class="stat-value">${l(La(a.tae))}</div></div>
        ...
        <div class="stat-card" style="display:flex;gap:16px;align-items:center;flex-wrap:wrap">
          ...
          ${t.diaPago?`<div><div class="stat-label">Día de cobro</div><div class="stat-value" style="font-size:14px">${l(ra(t.diaPago))}</div></div>`:""}
        </div>
      </div>
      ...
      <div class="table-wrap"><table>
        ...
        <tbody>${a.tabla.map(b=>Ks(b,n,e)).join("")}</tbody>
      </table></div>

      ${o?`<div class="card-title mt-12">Amortizaciones programadas</div>
             ${(t.amortizaciones||[]).map((b,g)=>Xs(t._id,b,u[g]??null,e)).join("")}`:""}
    </div>
  </div>`}function Js(t,e,a,o){const s=t.tipoTasa==="variable"?'<div class="text-sm mt-8" style="color:var(--text3)">⚠ Tipo variable: el beneficio real dependerá de cómo evolucione el índice de referencia.</div>':"";if(o!==null){const d=o-a,u=d>=0;return`<div class="card mb-12" style="background:var(--bg3);padding:12px">
    ...
    ${s}
  </div>`}function Ks(t,e,a){let o="";if(e&&!t.esAmortizacion){const s=lt(a.periodos,a.hoy,t.fecha);o=l(z(s>0?t.cuota/s:t.cuota))}return`<tr ${t.esAmortizacion?'style="background:var(--yellow-dim)"':""}>
  ...
  </tr>`}function Xs(t,e,a,o){const s=(e.escenarioIds||[]).map(n=>`<span class="badge badge-yellow">🔭 ${l(o.nombreEscenario(n))}</span>`).join("");return`<div class="amort-item" style="flex-wrap:wrap">
   ...
   ${o?`<span class="text-sm" style="margin-left:6px">${l(o)}</span>`:""}`;function Wt(t,e,a){return t.length===0?"":`<div class="form-group mt-8"><label class="form-label">Escenarios</label>
    ...
    </div></div>`}const Qs=(t,e)=>t.filter(a=>a.activo!==!1).map(a=>`<option value="${l(a._id)}"${a._id===e?" selected":""}>${l(a.nombre)}</option>`).join("");function Zs(t,e,a,o=V()){return`
    <div class="grid-2">
      ...
      <div class="form-advanced-body">
        <div class="grid-2 mt-8">
          <div class="form-group"><label class="form-label">Cuenta bancaria</label>
            <select class="form-select" id="f-cuenta">${Qs(e,(t==null?void 0:t.cuenta)??"default")}</select></div>
          ${qe(t==null?void 0:t.diaPago,"loan")}
        </div>
        <div class="mt-8">
    ...
    </div>`}function tn(t,e,a,o=V()){return`
    <div class="grid-2">
    ...
    <div class="flex gap-8 mt-16" style="justify-content:flex-end">
      ...
      <div style="max-height:300px;overflow-y:auto">
        <table class="table-wrap" style="width:100%">
          ...
          <tbody>${C.plan.map(T=>Ge(T,!0)).join("")}</tbody>
        </table>
      </div>
      ...
      <div style="max-height:260px;overflow-y:auto">
        <table class="table-wrap" style="width:100%">
          ...
          <tbody>${I.plan.map(w=>Ge(w,!1)).join("")}</tbody>
        </table>
      </div>
      ...
      <div class="flex gap-8 mt-12" style="justify-content:flex-end">
        <button class="btn-secondary" data-cancelar>Cerrar</button>
      </div>`);h&&_(h,"[data-cancelar]",i)}return{abrir:r,get planManual(){return a},get comparativa(){return e}}}function Ge(t,e){const a=t.comision>0?`<br><span style="font-size:9px;color:var(--text3)">+${l(z(t.comision))} com.</span>`:"";return`<tr>
  ...
  </tr>`}function Ve(t){return`<div class="card mb-8" style="padding:12px">
   ...
   <input class="form-input" type="${a}" id="${t}" value="${l(o)}" placeholder="${l(s)}"/></div>`,cn=(t,e)=>t.filter(a=>a.activo!==!1).map(a=>`<option value="${l(a._id)}"${a._id===e?" selected":""}>${l(a.nombre)}</option>`).join("");function ln(t,e){const a=t.map((n,i)=>{const d=e.find(x=>x._id===n.cuenta),u=sn[n.tipo],r=u!=null&&n.importe>u;return`<div class="flex gap-8 items-center" style="padding:5px 0;border-bottom:1px solid var(--border)">
    ...
    <button class="btn-secondary btn-sm mt-6" data-flex-anadir>+ Añadir componente</button>`}function dn(t,e){const a=e.hoy??V(),o=(t==null?void 0:t.nPagas)??12,s=[12,14,16].includes(o);return`
    <div class="grid-2">
    ...
    <div class="grid-2 mt-8">
      ...
      <div class="form-group"><label class="form-label">Cuenta</label>
        <select class="form-select" id="nf-cuenta">${cn(e.accounts,(t==null?void 0:t.cuenta)??e.cuentaPrincipal)}</select></div>
    </div>
      ...
      <div class="form-advanced-body">
        ...
        <div class="grid-2 mt-8">
          ...
          <div class="form-group"><label class="form-label">Mes actualización IPC (opcional)</label>
            <select class="form-select" id="nf-mes-ipc">
              ...
              ${rn.map((n,i)=>`<option value="${i+1}"${(t==null?void 0:t.mesActualizacionIPC)===i+1?" selected":""}>${l(n)} (${i+1})</option>`).join("")}
            </select>
          </div>
        </div>
        <div class="grid-2 mt-8">
        ...
        <div class="grid-3 mt-8">
          ...
          <div class="form-group"><label class="form-label">Cotización SS empleado (%)</label>
            <input class="form-input" type="number" id="nf-sspct" value="${((t==null?void 0:t.ssPct)??va).toFixed(2)}" min="0" max="50" step="0.01" placeholder="6.35"/>
    ...
    </div>`}function Ue(t,e){const a=i=>{var d;return((d=t.querySelector(i))==null?void 0:d.value)??""},o=(i,d=0)=>{const u=parseFloat(a(i));return Number.isFinite(u)?u:d},s=a("#nf-npagas"),n=s==="custom"?parseInt(a("#nf-npagas-custom"),10)||12:parseInt(s,10)||12;return{nombre:a("#nf-nombre").trim(),bruto:o("#nf-bruto"),nPagas:n,irpfModo:a("#nf-irpfmodo")||"auto",irpfPct:o("#nf-irpfpct"),ssPct:o("#nf-sspct",va),representacion:a("#nf-representacion")||"detallado",fechaInicio:a("#nf-fecha-ini"),fechaFin:a("#nf-fecha-fin")||null,cuenta:a("#nf-cuenta"),grupoNomina:a("#nf-grupo").trim(),mesActualizacionIPC:parseInt(a("#nf-mes-ipc"),10)||null,escenarioIds:[...t.querySelectorAll(".nom-escenario:checked")].map(i=>i.value),retribucionFlexible:e}}function un(t,e,a,o){const s=Ue(t,e),n=e.reduce((p,m)=>p+(m.importe||0)*12,0),i=Math.max(0,s.bruto-n),d=i*(s.ssPct/100),u=s.irpfModo==="manual"?i*(s.irpfPct/100):ct(xt(s.bruto,n),a.tramos),r=i-d-u,x=i/s.nPagas,f=d/s.nPagas,c=u/s.nPagas,b=x-f-c,g=s.grupoNomina?a.nominas.filter(p=>p.grupoNomina===s.grupoNomina&&p._id!==o):[],$=g.length>0?`<div style="margin-top:6px;color:var(--yellow);font-size:11px">⚡ En el grupo "${l(s.grupoNomina)}" con ${l(g.map(p=>p.nombre).join(", "))} — el IRPF final se calculará al tipo marginal del grupo.</div>`:"",A=n>0?`<span style="color:var(--text2)">Retrib. flexible:</span><span style="color:var(--accent)">-${l(z(n))}/año (exento IRPF y SS)</span>
    ...
    <div style="margin-top:8px;display:grid;grid-template-columns:1fr 1fr;gap:4px">
    ...
    </div>${$}`}function pn(t,e,a,o){const s=()=>{const d=t.querySelector("#flex-comp-container");d&&(d.innerHTML=ln(e,a.accounts))},n=()=>{const d=t.querySelector("#nf-preview");d&&(d.innerHTML=un(t,e,a,o))},i=()=>{var u,r;const d=(x,f)=>{const c=t.querySelector(x);c&&(c.style.display=f?"":"none")};d("#nf-custom-pagas-wrap",((u=t.querySelector("#nf-npagas"))==null?void 0:u.value)==="custom"),d("#nf-irpfpct-wrap",((r=t.querySelector("#nf-irpfmodo"))==null?void 0:r.value)==="manual"),n()};t.addEventListener("input",d=>{var u;(u=d.target)!=null&&u.closest("#nf-bruto, #nf-irpfpct, #nf-npagas-custom, #nf-grupo, #nf-sspct")&&n()}),Y(t,"#nf-npagas, #nf-irpfmodo, #nf-representacion",i),_(t,"[data-flex-anadir]",()=>{var r,x,f;const d=((r=t.querySelector("#fc-tipo"))==null?void 0:r.value)||"transporte",u=parseFloat(((x=t.querySelector("#fc-importe"))==null?void 0:x.value)??"")||0;if(!u)return E("Importe requerido","err");e.push({_id:Date.now().toString(36),tipo:d,importe:u,cuenta:((f=t.querySelector("#fc-cuenta"))==null?void 0:f.value)||""}),s(),n()}),_(t,"[data-flex-borrar]",d=>{e.splice(Number(d.getAttribute("data-flex-borrar")),1),s(),n()}),s(),n()}const Ye=t=>t.slice(0,3).map(([,e])=>`${e}%`).join(" · ")+(t.length>3?" …":"");function mn(t){let e=null,a=[];const o=()=>document.getElementById("modal-overlay"),s=()=>document.getElementById("modal-content"),n=()=>{var c;return(c=o())==null?void 0:c.classList.add("hidden")},i=()=>t.store.get("config").tramos_irpf??ft;function d(c,b){const g=o(),$=s();return!g||!$?null:($.innerHTML=`<div class="modal-title">${l(c)}</div>${b}`,g.classList.remove("hidden"),_($,"[data-cerrar]",n),$)}function u(){e=null;const c=[...t.store.get("tramosIRPFHistorico")].sort(($,A)=>$.año-A.año),b="display:grid;grid-template-columns:90px 1fr auto;gap:0;padding:10px 12px;border-top:1px solid var(--border);align-items:center",g=d("Tramos IRPF por ejercicio",`
      ...
      <div style="border:1px solid var(--border);border-radius:var(--radius);overflow:hidden;margin-bottom:14px">
        ...
        <div style="${b}">
          ...
          <span class="text-sm" style="color:var(--text2)">${l(Ye(i()))}</span>
        ...
        ${c.map($=>`<div style="${b}">
              ...
              <span class="text-sm" style="color:var(--text2)">${l(Ye($.tramos))}</span>
      ...
      </div>`);if(!A)return;const p=()=>{const v=A.querySelector("#irpf-tramos-rows");v&&(v.innerHTML=r())};_(A,"[data-volver]",u),_(A,"[data-tr-anadir]",()=>{x(A),a.push([0,0]),p()}),_(A,"[data-tr-borrar]",v=>{x(A),a.splice(Number(v.getAttribute("data-tr-borrar")),1),p()}),_(A,"[data-tr-guardar]",()=>{x(A);const v=[...a].sort((I,y)=>I[0]-y[0]);if(v.length===0)return E("Añade al menos un tramo","err");e==="default"?(t.store.patchConfig({tramos_irpf:v}),E("Tabla por defecto guardada")):(t.store.set("tramosIRPFHistorico",t.store.get("tramosIRPFHistorico").map(I=>I.año===e?{...I,tramos:v}:I)),E(`Tabla ${e} guardada`)),t.onDatosCambiados(),u()})}return{abrir:u}}const We=1500,Ct=(t,e,a,o,s="")=>`<div class="form-group"><label class="form-label">${l(e)}</label>
   <input class="form-input" type="${a}" id="${t}" value="${l(o)}" placeholder="${l(s)}"/></div>`,fn=(t,e,a,o)=>`<div class="form-group"><label class="form-label">${l(e)}</label>
   <select class="form-select" id="${t}">
     ${a.map(([s,n])=>`<option value="${l(s)}"${s===o?" selected":""}>${l(n)}</option>`).join("")}
   </select></div>`,vn=t=>(t.modeloFondo||"cuenta")==="pension";function gn(t,e,a,o){return t.length===0?`<div class="card text-sm" style="padding:24px;text-align:center;color:var(--text2)">
      Sin planes de pensiones. Crea uno con el botón "+ Nuevo plan de pensiones".
    </div>`:`<div class="grid-3">${t.map(s=>bn(s,e,a,o)).join("")}</div>`}function bn(t,e,a,o){const s=ta(t);if(!s)return"";const n=fa(t,e,a),i=o.slice(0,4),d=(t.aportaciones||[]).filter(r=>r.fecha>=`${i}-01-01`).reduce((r,x)=>r+x.cantidad,0),u=Math.min(d,We)*(n/100);return`<div class="card">
    ...
    <div style="margin-top:10px;padding:8px;background:var(--bg3);border-radius:var(--radius);border:1px solid var(--border)">
      ...
      <div class="flex justify-between mb-4"><span class="text-sm" style="color:var(--text2)">Aportado</span><span class="num ${d>We?"neg":""}">${l(z(d))}</span></div>
  ...
  </div>`}function hn(t){return`<div>${t.map((a,o)=>`<div class="flex gap-8 items-center" style="padding:4px 0;border-bottom:1px solid var(--border)">
    ...
    <button class="btn-secondary btn-sm mt-6" data-aport-anadir>+ Añadir aportación</button>`}function yn(t,e){const a=[...(t==null?void 0:t.historicoSaldos)??[]].sort((i,d)=>d.fecha.localeCompare(i.fecha)),o=a[0]?a[0].saldo:(t==null?void 0:t.saldo)??0,s=[...new Set(e.nominas.filter(i=>i.grupoNomina).map(i=>i.grupoNomina))],n=!!(t!=null&&t.grupoNomina);return`
    <div class="grid-2">
    ...
    <div class="grid-2 mt-8">
      ...
      ${fn("pen-periodo","Capitalización",[["diario","Diario"],["mensual","Mensual"],["anual","Anual"]],(t==null?void 0:t.periodoCobro)??"mensual")}
    </div>
    <div class="grid-2 mt-8">
    ...
    <div class="flex gap-8 mt-16" style="justify-content:flex-end">
    ...
    </div>`}const n=A=>{var p;return((p=t.store.get("accounts").find(m=>m._id===(A||"default")))==null?void 0:p.nombre)??(A||"default")};function i(A,p,m){const v=p.reduce((h,w)=>h+(w.bruto||0),0),I=bo(p,m),y=v>0?I/v*100:0;return`<div style="margin-bottom:16px">
    ...
    </div>`}function d(A){const p=o(),m=[...t.store.get("nominas")].sort((w,S)=>(S.bruto||0)-(w.bruto||0)),{grupos:v,sueltas:I}=yo(m),y=t.store.get("accounts").filter(vn),h=m.filter(w=>w.activo!==!1);A.innerHTML=`
      <div class="page-header">
      ...
      <div>${gn(y,h,p,e())}</div>`}const u=()=>document.getElementById("modal-overlay"),r=()=>document.getElementById("modal-content"),x=()=>{var A;return(A=u())==null?void 0:A.classList.add("hidden")};function f(A,p){const m=u(),v=r();return!m||!v?null:(v.innerHTML=`<div class="modal-title">${l(A)}</div>${p}`,m.classList.remove("hidden"),_(v,"[data-cancelar]",x),v)}function c(A,p){const m=A?t.store.get("nominas").find(h=>h._id===A)??null:null,v=[...(m==null?void 0:m.retribucionFlexible)??[]].map(h=>({...h})),I={accounts:t.store.get("accounts"),escenarios:t.store.get("escenarios"),nominas:t.store.get("nominas"),cuentaPrincipal:t.store.getPrincipalAccountId(),tramos:o(),hoy:e()},y=f(A?"Editar nómina":"Nueva nómina",dn(m,I));y&&(pn(y,v,I,A??""),_(y,"[data-guardar-nomina]",h=>{const w=Ue(y,v);if(!w.nombre||w.bruto<=0)return E("Nombre y bruto anual son obligatorios","err");const S=h.getAttribute("data-guardar-nomina")||"",M={...w,activo:!0,tags:["nomina"]};S?(t.store.updateItem("nominas",S,M),E("Nómina actualizada")):(t.store.addItem("nominas",M),E("Nómina creada")),a(),x(),p()}))}function b(A,p){const m=A?t.store.get("accounts").find(y=>y._id===A)??null:null,v=[...(m==null?void 0:m.planAportaciones)??[]].map(y=>({...y})),I=f(A?"Editar plan de pensiones":"Nuevo plan de pensiones",yn(m,{nominas:t.store.get("nominas"),escenarios:t.store.get("escenarios"),hoy:e()}));I&&(xn(I,v,e()),_(I,"[data-guardar-pension]",y=>{const{datos:h,error:w}=$n(I,v,m,e());if(w)return E(w,"err");const S=y.getAttribute("data-guardar-pension")||"";S?(t.store.updateItem("accounts",S,h),E("Plan actualizado")):(t.store.addItem("accounts",h),E("Plan creado")),a(),x(),p()}))}function g(A,p,m){_(A,"[data-nueva-nomina]",()=>c(null,p)),_(A,"[data-editar-nom]",v=>c(v.getAttribute("data-editar-nom"),p)),_(A,"[data-borrar-nom]",v=>{tt("¿Eliminar esta nómina?")&&(t.store.removeItem("nominas",v.getAttribute("data-borrar-nom")),E("Eliminada"),a(),p())}),Y(A,"[data-activo-nom]",v=>{const I=v;t.store.updateItem("nominas",I.getAttribute("data-activo-nom"),{activo:I.checked}),a(),p()}),_(A,"[data-tramos]",()=>m.abrir()),_(A,"[data-nueva-pension]",()=>b(null,p)),_(A,"[data-editar-pension]",v=>b(v.getAttribute("data-editar-pension"),p)),_(A,"[data-borrar-pension]",v=>{tt("¿Eliminar este plan de pensiones?")&&(t.store.removeItem("accounts",v.getAttribute("data-borrar-pension")),E("Plan eliminado"),a(),p())})}let $=null;return{id:"nominas",route:"nominas",nombre:"Nóminas",flagId:"nominas",seccion:1,iconoPath:In,mount(A){const p=()=>d(A);$??($=mn({store:t.store,onDatosCambiados:()=>{a(),p()},año:()=>Number(e().slice(0,4))})),d(A),A.dataset.wired!=="1"&&(g(A,p,$),A.dataset.wired="1")}}}const wn="M3 17.25V21h3.75L17.81 9.94l-3.75-3.75L3 17.25zM20.71 7.04c.39-.39.39-1.02 0-1.41l-2.34-2.34c-.39-.39-1.02-.39-1.41 0l-1.83 1.83 3.75 3.75 1.83-1.83z",Sn="M13 3c-4.97 0-9 4.03-9 9H1l3.89 3.89.07.14L9 12H6c0-3.87 3.13-7 7-7s7 3.13 7 7-3.13 7-7 7c-1.93 0-3.68-.79-4.94-2.06l-1.42 1.42C8.27 19.99 10.51 21 13 21c4.97 0 9-4.03 9-9s-4.03-9-9-9zm-1 5v5l4.28 2.54.72-1.21-3.5-2.08V8H12z",Je={transporte:{label:"Transporte",limiteAnual:1500},restaurante:{label:"Restaurante",limiteAnual:2640},otros:{label:"Otros",limiteAnual:null}},Mn={entradas:[],salidas:[],totalAportaciones:0,totalReembolsos:0,retencion:0};function Cn(t,e){const a=t.filter(u=>u.activo&&dt(u)==="inversion");if(a.length===0)return"";let o=0,s=0,n=0,i=0;for(const u of a){const r=Pt(u,e);r&&(o+=r.saldo,s+=r.costBase,n+=r.plusvalia,i+=r.impuesto)}const d=s>0?(n/s*100).toFixed(1):"0";return`
    ...
    </div>`}function zn(t,e){if(!t.activo||!t.interes||t.interes<=0)return"";const{dashboardStart:a,dashboardEnd:o}=e.config,s=Math.max(1,(q(o).getTime()-q(a).getTime())/(30.44*864e5)),n=Nt(t,a),i=n*(Math.pow(1+t.interes/100,s/12)-1);let d="";if(e.config.usarInflacion&&e.inflacion.length>0){const u=n*(lt(e.inflacion,a,o)-1),r=i-u;d=`
  ...
  </div>`}function Fn(t,e){const a=Je[t.tipoBeneficio??""]??{label:"Beneficio",limiteAnual:null},{limiteAnual:o}=a,s=e.nominas.flatMap(b=>(b.retribucionFlexible??[]).filter(g=>g.cuenta===t._id).map(g=>({nomina:b,importe:g.importe}))),n=s.reduce((b,g)=>b+g.importe,0),i=n*12,d=o!==null&&i>o,u=o!==null?Math.min(i,o):i,r=t.grupoNomina?e.nominas.filter(b=>(b.grupoNomina||"")===t.grupoNomina&&b.activo!==!1):s.slice(0,1).map(b=>b.nomina),x=Za(r,e.tramosIRPF),f=u*x/100,c=t.grupoNomina?`grupo "${t.grupoNomina}", tipo marginal ${x}%`:`tipo marginal ${x}%`;return`<div style="margin-top:10px;padding:10px;background:var(--bg3);border-radius:var(--radius);border:1px solid rgba(99,214,160,0.35)">
  ...
  </div>`}function Pn(t){const e=ta(t);return e?`<div style="margin-top:10px;padding:10px;background:var(--bg3);border-radius:var(--radius);border:1px solid var(--yellow-dark, #7a6010)">
  ...
  </div>`:""}function Tn(t,e){const a=Pt(t,e.tramosGanancias);if(!a)return"";const o=e.config,s=e.flujos(t._id),n=q(o.dashboardStart),i=q(o.dashboardEnd),d=Math.max(0,(i.getTime()-n.getTime())/(30.44*864e5)),u=a.saldo+s.totalAportaciones-s.totalReembolsos,r=t.interes>0?Math.pow(1+t.interes/100,1/12)-1:0,x=u>0&&d>0?Math.max(0,u*Math.pow(1+r,d)):Math.max(0,u),f=a.costBase+s.totalAportaciones,c=Math.max(0,x-f),b=ma(c,e.tramosGanancias),g=c>0?(b/c*100).toFixed(1):"0",$=t.interes>0?`${t.interes}% anual`:"sin rentabilidad",A=a.saldo>0?(a.plusvalia/a.saldo*100).toFixed(1):"0",p=(w,S,M)=>w.map(C=>`<div class="flex justify-between mt-4">
    ...
    <div class="flex justify-between items-center mb-12">
      ...
      <div class="flex gap-8">
        ...
        <button class="btn-icon" data-hist-acc="${l(t._id)}" title="Histórico de saldos"><svg viewBox="0 0 24 24"><path d="${Sn}"/></svg></button>
        <button class="btn-icon" data-editar-acc="${l(t._id)}" title="Editar"><svg viewBox="0 0 24 24"><path d="${wn}"/></svg></button>
  ...
  </div>`}const jn=[["cuenta","Cuenta bancaria"],["inversion","Fondo de inversión"],["beneficio","Tarjeta beneficio"]];function En(t){return`<div>${t.map((a,o)=>`<div class="flex gap-8 items-center" style="padding:4px 0;border-bottom:1px solid var(--border)">
        <span style="min-width:70px;font-size:12px">${l(a.fechaInicio||"—")}</span>
        <span style="flex:1;font-size:12px">${l(z(a.importe))} / ${l(a.periodicidad)}</span>
        <span style="min-width:70px;font-size:12px;color:var(--text3)">${l(a.fechaFin||"indefinido")}</span>
        <button class="btn-danger btn-sm" data-aport-borrar="${o}">✕</button>
    ...
    <button class="btn-secondary btn-sm mt-6" data-aport-anadir>+ Añadir aportación</button>`}function Dn(t,e){const a=t?dt(t):"cuenta",o=[...new Set(e.nominas.filter(n=>n.grupoNomina).map(n=>n.grupoNomina))],s=n=>n?"":' style="display:none"';return`
    <div class="grid-2">
      ${K("ac-nombre","Nombre","text",(t==null?void 0:t.nombre)??"","Ej: Cuenta ING, Fondo Vanguard")}
      ${Et("ac-modelo","Tipo",jn,a)}
    </div>
    <div class="grid-2 mt-8">
    ...
    <div class="flex gap-8 mt-12" style="justify-content:flex-end">
    ...
    </div>`}const Ke=t=>t.slice(0,3).map(([,e])=>`${e}%`).join(" · ")+(t.length>3?" …":"");function Ln(t){let e=null,a=[];const o=()=>document.getElementById("modal-overlay"),s=()=>document.getElementById("modal-content"),n=()=>{var c;return(c=o())==null?void 0:c.classList.add("hidden")},i=()=>t.store.get("config").tramosGananciasCapital??wt;function d(c,b){const g=o(),$=s();return!g||!$?null:($.innerHTML=`<div class="modal-title">${l(c)}</div>${b}`,g.classList.remove("hidden"),_($,"[data-cerrar]",n),$)}function u(){e=null;const c=[...t.store.get("tramosGananciasCapitalHistorico")].sort(($,A)=>$.año-A.año),b="display:grid;grid-template-columns:90px 1fr auto;gap:0;padding:10px 12px;border-top:1px solid var(--border);align-items:center",g=d("Tramos — Ganancias de capital",`
      <div class="text-sm mb-12" style="color:var(--text2)">
      ...
      <div style="border:1px solid var(--border);border-radius:var(--radius);overflow:hidden;margin-bottom:14px">
        ...
        <div style="${b}">
          <span style="font-weight:600;font-size:13px">Por defecto</span>
          <span class="text-sm" style="color:var(--text2)">${l(Ke(i()))}</span>
          <button class="btn-secondary btn-sm" data-editar-tg="default">Editar</button>
        </div>
        ${c.map($=>`<div style="${b}">
              <span style="font-weight:600;font-size:13px">${$.año}</span>
              <span class="text-sm" style="color:var(--text2)">${l(Ke($.tramos))}</span>
              <div class="flex gap-6">
      ...
      <div class="flex justify-between items-center mb-8">
        ...
        <div class="flex gap-8">
          ...
          <button class="btn-icon" data-editar-goal="${l(r._id)}" title="Editar"><svg viewBox="0 0 24 24"><path d="${kn}"/></svg></button>
...
Esto recalibra el punto de arranque del dashboard.`)){for(const N of T)t.store.updateItem("accounts",N._id,{saldoInicial:w(N)??N.saldoInicial??0,fechaInicialSaldo:j});E("Saldo base actualizado"),a(),F()}}function C(F,T,j){_(F,"[data-nueva-acc]",()=>h(null,T)),_(F,"[data-editar-acc]",R=>h(R.getAttribute("data-editar-acc"),T)),_(F,"[data-tramos-ganancias]",()=>j.abrir()),_(F,"[data-reset-base]",()=>M(T)),_(F,"[data-hist-acc]",R=>S(R.getAttribute("data-hist-acc"),T)),_(F,"[data-principal-acc]",R=>{const N=R.getAttribute("data-principal-acc");t.store.set("accounts",t.store.get("accounts").map(B=>({...B,esCuentaPrincipal:B._id===N}))),E("Cuenta marcada como principal"),a(),T()}),_(F,"[data-borrar-acc]",R=>{const N=R.getAttribute("data-borrar-acc");if(t.store.get("accounts").length<=1)return E("Debe existir al menos una cuenta","err");if(!tt("¿Eliminar cuenta?"))return;t.store.removeItem("accounts",N);const G=t.store.get("accounts");G.length>0&&!G.some(k=>k.esCuentaPrincipal)&&t.store.set("accounts",G.map((k,H)=>H===0?{...k,esCuentaPrincipal:!0}:k)),E("Cuenta eliminada"),a(),T()}),_(F,"[data-inv-modo]",R=>{const[N,B]=(R.getAttribute("data-inv-modo")||"").split("|");s.set(N,B==="real"?"real":"proyeccion"),T()}),$.wire(F,T)}let P=null;return{id:"accounts",route:"accounts",nombre:"Cuentas y ahorro",flagId:"accounts",seccion:1,iconoPath:Bn,mount(F){const T=()=>p(F);P??(P=Ln({store:t.store,onDatosCambiados:()=>{a(),T()},año:()=>Number(e().slice(0,4))})),p(F),F.dataset.wired!=="1"&&(C(F,T,P),F.dataset.wired="1")}}}const at=(t,e,a="var(--text)",o=!1)=>`<tr>
  ...
  </tr>`,Ea=t=>`<tr><td colspan="2" style="padding:12px 10px 4px;font-size:11px;font-weight:700;color:var(--text3);letter-spacing:.5px;border-top:1px solid var(--border)">${l(t)}</td></tr>`;function Xe(t){const a=t.capMobiliario!==0||t.gananciasFondos!==0?`${at("Capital mobiliario (dividendos, intereses)",t.capMobiliario,"var(--text)",!0)}
  ...
  </div>`;function Vn(t){const e=t.extras,a=t.nominas.length===0?`<div class="auth-hint mb-12" style="border-color:var(--yellow)">
    ...
    <div class="grid-2" style="gap:16px;align-items:start">
      ...
      <div class="card" style="padding:16px">
        ...
        <div id="renta-cuadro">${Xe(t.declaracion)}</div>
      </div>
    </div>`}function Qe(t){return`<table style="border-collapse:collapse;min-width:280px">
  ...
  </table>`}const Un=(t,e,a)=>`<div class="card" style="text-align:center;padding:48px">
  ...
  </div>`,rt=(t,e,a="")=>`<div class="stat-card"><div class="stat-label">${l(t)}</div><div class="stat-value ${a}">${l(e)}</div></div>`,bt=(t,e,a="")=>`<div class="flex justify-between mb-5"><span class="text-sm" style="color:var(--text2)">${l(t)}</span><span class="num ${a}">${l(e)}</span></div>`;function Yn(t,e,a){const o=t.filter(u=>(u.modeloFondo||"cuenta")==="inversion");if(o.length===0)return Un("📈","Sin fondos de inversión",'Ve a <strong>Cuentas y Ahorro</strong> y crea una cuenta de tipo "Fondo de inversión" para ver aquí su análisis fiscal.');let s=0,n=0,i=0;const d=o.map(u=>{const r=Pt(u,e);if(!r)return"";s+=r.saldo,n+=r.costBase,i+=r.impuesto;const x=r.costBase>0?r.plusvalia/r.costBase*100:0,f=(u.escenarioIds||[]).map(c=>`<span class="badge badge-yellow">🔭 ${l(a(c))}</span>`).join("");return`
    ...
    </div>`}function Wn(t){const{nominas:e,planes:a,tramos:o}=t,s=b=>b.grupoNomina?e.filter(g=>(g.grupoNomina||"")===b.grupoNomina):null,n=e.map(b=>({n:b,d:ba(b,s(b),o)})),i=n.reduce((b,g)=>b+g.d.brutoAnual,0),d=n.reduce((b,g)=>b+g.d.irpfAnual,0),u=n.reduce((b,g)=>b+g.d.ssAnual,0),r=n.length===0?'<div class="text-sm" style="color:var(--text3);padding:12px 0">Sin nóminas activas. Configúralas en el módulo <strong>Nóminas</strong>.</div>':n.map(({n:b,d:g})=>`
        <div class="card">
    ...
    </div>`}const sa=(t,e)=>`<div style="padding:12px;background:var(--bg2);border-radius:var(--radius);border:1px solid var(--border)">
    ...
    <div class="card" style="text-align:center;padding:56px 32px;border:2px dashed var(--border)">
      ...
      <div class="grid-2" style="max-width:480px;margin:0 auto;gap:12px;text-align:left">
        ${sa("Rendimientos íntegros","Alquileres, subarriendos y cesión de derechos sobre inmuebles")}
        ${sa("Gastos deducibles","IBI, seguros, reparaciones, amortización (3 %/año sobre el valor de construcción) y financiación")}
        ${sa("Reducción del 60 %","Arrendamiento de vivienda habitual del inquilino (art. 23.2 LIRPF)")}
        ${sa("Base general del IRPF","Tributa a tramos ordinarios, no en la base del ahorro. Sin diferimiento fiscal.")}
      </div>
    </div>`}const Ze=[["declaracion","Declaración Renta"],["mobiliario","Capital Mobiliario"],["trabajo","Rendimientos del Trabajo"],["inmobiliario","Capital Inmobiliario"]],Kn="M14 2H6c-1.1 0-2 .9-2 2v16c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V8l-6-6zm4 18H6V4h7v5h5v11zM8 15h8v2H8v-2zm0-4h8v2H8v-2zm0-4h4v2H8V7z";function Xn(t){const e=t.hoy??V;let a="declaracion",o={};const s=()=>t.store.get("config"),n=()=>Number(e().slice(0,4)),i=()=>t.store.get("nominas").filter(m=>m.activo),d=()=>t.store.get("accounts").filter(m=>(m.modeloFondo||"cuenta")==="pension"),u=m=>{var v;return((v=t.store.get("escenarios").find(I=>I._id===m))==null?void 0:v.nombre)??m},r=()=>vt(t.store.get("tramosIRPFHistorico"),s().tramos_irpf??ft)(n()),x=()=>vt(t.store.get("tramosGananciasCapitalHistorico"),s().tramosGananciasCapital??wt)(n());function f(){const m=`${n()}-01-01`,v=t.store.get("nominas").filter(h=>h.activo&&!h.simulacion),I=d().reduce((h,w)=>h+(w.aportaciones||[]).filter(S=>S.fecha>=m).reduce((S,M)=>S+M.cantidad,0),0),y=t.store.get("expenses").filter(h=>h.activo&&h.sujetoIRPF&&h.tipo==="ingreso").reduce((h,w)=>h+te(w),0);return ee({nominas:v,aportacionesPension:I,otrosIngresos:y,extras:o,tramosGeneral:r(),tramosAhorro:x()})}function c(){const m=r(),v=i(),I=T=>T.grupoNomina?v.filter(j=>(j.grupoNomina||"")===T.grupoNomina):null,y=v.map(T=>ba(T,I(T),m)),h=y.reduce((T,j)=>T+j.brutoAnual,0),w=y.reduce((T,j)=>T+j.irpfAnual,0),S=y.reduce((T,j)=>T+j.ssAnual,0),M=t.store.get("accounts").filter(T=>(T.modeloFondo||"cuenta")==="inversion");let C=0,P=0;for(const T of M){const j=Pt(T,x());j&&(C+=j.plusvalia,P+=j.impuesto)}if(h<=0&&M.length===0)return"";const F=(T,j,R)=>`<div class="exec-item"><div class="exec-item-label">${l(T)}</div><div class="exec-item-val ${R}">${l(j)}</div></div>`;return`<div class="exec-summary mb-14">
    ...
    </div>`}function b(){return a==="mobiliario"?Yn(t.store.get("accounts"),x(),u):a==="trabajo"?Wn({nominas:i(),planes:d(),tramos:r(),hoy:e()}):a==="inmobiliario"?Jn():Vn({año:n(),extras:o,declaracion:f(),nominas:i().map(m=>({nombre:m.nombre,bruto:m.bruto||0})),planes:d().map(m=>m.nombre)})}function g(m,v){const I=a===m;return`<button data-tab-fisc="${m}" style="
    ...
    ">${l(v)}</button>`}function $(m){const v=m.querySelector("#fisc-tabs"),I=m.querySelector("#fisc-tab-content");v&&(v.innerHTML=Ze.map(([y,h])=>g(y,h)).join("")),I&&(I.innerHTML=b())}function A(m){m.innerHTML=`
    ...
    </div>`}function x(h){const w=s().dashboardEnd,S=ua(d(null).eventos,w);return`
      ...
      <table style="width:100%;font-size:13px;border-collapse:collapse">
        ...
        <tbody>${h.map(C=>{const{eventos:P}=d(C),F=C.fechaFin||w,T=ua(P,F),j=T!==null&&S!==null?T-S:null;return`<tr>
    ...
    </div>`}function c(){if(o){try{o.destroy()}catch{}o=null}}function b(h){const w=s(),S=d(null),M=[{label:"Base (sin escenario)",color:"#6b7280",esBase:!0,puntos:da(S.eventos,w.dashboardStart,w.dashboardEnd)}];return h.forEach((C,P)=>{const{eventos:F,horizonte:T}=d(C);M.push({label:C.nombre,color:C.color||zt[P%zt.length],puntos:da(F,w.dashboardStart,T)})}),M}function g(h,w){c();const S=h.querySelector("#chart-comparacion");S&&(o=Qn(S,b(w)))}function $(h){c();const w=new Set(t.store.get("accounts").map(C=>C._id));for(const C of[...a])w.has(C)||a.delete(C);const S=n(),M=s().escenarioActivo||null;h.innerHTML=`
      <div class="page-header">
      ...
      ${S.length===0?`<div class="card mb-14" style="padding:20px 24px">
             ...
             <div class="card" style="padding:16px">
               ...
               ${Zn()?'<canvas id="chart-comparacion" height="160"></canvas>':'<div class="text-sm" style="color:var(--text3);padding:12px 0">El gráfico necesita Chart.js, que no se ha podido cargar. La tabla de abajo tiene los mismos datos.</div>'}
             </div>
