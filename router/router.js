...
const Router = (() => {
  const views=['dashboard','loans','expenses','accounts','nominas','rentas','calendar','inflacion','escenarios'];
  const mods={ dashboard:DashboardModule, loans:LoansModule, expenses:ExpensesModule, accounts:AccountsModule, nominas:NominasModule, rentas:RentasModule, calendar:CalendarModule, inflacion:InflacionModule, escenarios:EscenariosModule };
