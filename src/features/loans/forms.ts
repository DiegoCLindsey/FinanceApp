...
import type { Account, Loan, Persona } from '@/state/schema';
...
export function formularioPrestamo(loan: Loan | null, accounts: Account[], personas: Persona[], hoy = todayISO()): string {
  return `
    <div class="grid-2">
...
export function formularioAmortizacion(loanId: string, am: AmortizacionLoan | null, hoy = todayISO()): string {
  return `
    <div class="grid-2">
